...
Questo esempio è simile all'esempio 1, ma usa un ID risorsa per fare riferimento alla rete WAN virtuale necessaria per creare l'hub virtuale.
...
Quanto sopra creerà un gruppo di risorse "testRG", una WAN virtuale e un hub virtuale in West US nel gruppo di risorse in Azure. L'hub virtuale avrà lo spazio indirizzo "10.0.1.0/24" e una tabella di route allegata.

Questo esempio è simile all'esempio 2, ma allega anche una tabella di route all'hub virtuale.

## PARAMETRI

### -AddressPrefix
Stringa dello spazio indirizzo per questo hub virtuale.
...
### -HubVnetConnection
Connessioni di rete virtuali Hub associate a questo hub virtuale.
...
### -RouteTable
Tabella route associata a questo hub virtuale.
...
### -VirtualWan
L'oggetto WAN virtuale a cui è collegato l'hub.
