...
Prima di tutto creiamo un oggetto Route hub virtuale e lo usiamo per creare una risorsa tabella route hub virtuale. Impostiamo quindi la risorsa della tabella di route nell'hub virtuale usando il comando Set-AzVirtualHub.
...
### -RouteTable
Tabelle route associate a questo hub virtuale.
