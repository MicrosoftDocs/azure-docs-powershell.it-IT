...
## Sinossi
Reimposta la RoutingState di una risorsa VirtualHub.
...
## Descrizione
Reimposta lo stato di routing di una risorsa VirtualHub esistente solo se non viene effettuato il provisioning dello stato di routing dell'hub virtuale.
...
Reimposta lo stato di routing dell'hub virtuale usando il relativo ResourceGroupName e il resourceName.
...
Reimposta lo stato di routing dell'hub virtuale usando il relativo ResourceId.
...
Reimposta lo stato di routing dell'hub virtuale usando un oggetto di input. L'oggetto di input è di tipo PSVirtualHub.
...
Un oggetto hub virtuale esistente può essere recuperato e quindi passato come oggetto di input a Reset-AzHubRouter.
