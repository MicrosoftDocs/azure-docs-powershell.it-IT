...
## Descrizione
**Il cmdlet New-AzApplicationGatewayRewriteRuleSet** crea un set di regole di riscrittura per un gateway dell'applicazione Azure.
...
Questo comando crea un set di regole di riscrittura denominato RuleSet1 e archivia il risultato nella variabile denominata $ruleset.
