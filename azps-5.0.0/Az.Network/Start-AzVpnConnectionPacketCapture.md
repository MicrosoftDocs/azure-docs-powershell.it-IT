...
## Sinossi
Avvia l'operazione di acquisizione di pacchetti in una connessione VPN.
...
### -FilterData
Opzioni di filtro per avviare l'acquisizione di pacchetti in connessione VPN.
...
### -Nome
Il nome della connessione VPN in cui è possibile avviare l'acquisizione di pacchetti.
...
### -ParentResourceName
Il nome dell'elemento padre vpngateway.
