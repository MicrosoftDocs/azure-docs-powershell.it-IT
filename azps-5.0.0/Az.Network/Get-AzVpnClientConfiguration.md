...
## Descrizione
Il Get-AzVpnClientConfiguration restituisce l'URL in cui è possibile scaricare il client VPN.
...
Ottiene l'URL per scaricare un profilo VpnClient che in precedenza è stato generato tramite il comando New-AzVpnClientConfiguration.
