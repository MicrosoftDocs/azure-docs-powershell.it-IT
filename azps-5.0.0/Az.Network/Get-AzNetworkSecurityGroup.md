...
## Descrizione
Il cmdlet **Get-AzNetworkSecurityGroup** ottiene un gruppo di sicurezza di rete Azure.
...
### Esempio 2: elencare i gruppi di sicurezza di rete esistenti tramite filtri
```powershell
...
Questo comando restituisce il contenuto dei gruppi di sicurezza di rete di Azure che iniziano con "NSG"
