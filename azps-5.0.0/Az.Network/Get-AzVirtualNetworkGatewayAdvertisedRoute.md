...
Per il gateway di Azure denominato GatewayName nel gruppo di risorse resourceGroupName, recupera un elenco di route pubblicizzate nel peer BGP con IP 10.0.0.254
