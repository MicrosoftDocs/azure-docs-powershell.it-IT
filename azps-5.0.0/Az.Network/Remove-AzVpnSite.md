...
Dopo aver creato il sito, viene immediatamente rimosso tramite il comando Remove-AzVpnSite.
...
Come l'esempio 1, ma qui la rimozione avviene usando l'output tramite pipe di Get-AzVpnSite.
...
### -ResourceId
ID risorsa di Azure per l'vpnSite da eliminare.
