...
### -FilterData
Opzioni di filtro per avviare l'acquisizione di pacchetti sulla connessione gateway di rete virtuale.
...
### -Nome
Il nome della connessione del gateway di rete virtuale in cui avviare l'acquisizione di pacchetti.
