...
Il precedente creerà un gruppo di risorse, una WAN virtuale, una rete virtuale, un hub virtuale negli Stati Uniti centrali nel gruppo di risorse in Azure. Viene creata anche una connessione di rete virtuale che consente di peer la rete virtuale all'hub virtuale. Questa connessione di rete virtuale viene quindi aggiornata per abilitare la sicurezza Internet.
