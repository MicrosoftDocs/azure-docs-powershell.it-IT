...
## Descrizione
Il cmdlet **Get-AzLoadBalancer** ottiene uno o più gruppi di bilanciamento del carico di Azure contenuti in un gruppo di risorse.
...
### Esempio 2: elenco di bilanciamento del carico tramite filtro
```
...
Questo comando ottiene tutti i bilanciatori di carico con un nome che inizia con "MyLoadBalancer"
