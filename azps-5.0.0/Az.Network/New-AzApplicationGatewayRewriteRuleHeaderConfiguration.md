...
## Descrizione
**Il cmdlet AzApplicationGatewayRewriteRuleHeaderConfiguration** crea un set di azioni di riscrittura regola per un gateway dell'applicazione Azure.
...
Questo comando crea una configurazione dell'intestazione della regola di riscrittura e archivia il risultato nella variabile denominata $hc.
...
### -HeaderValue
Valore di intestazione per il set per il nome di intestazione indicato.
L'intestazione verrà eliminata se omessa
