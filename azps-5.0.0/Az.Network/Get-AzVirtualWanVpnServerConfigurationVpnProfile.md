...
Il comando precedente genererà e restituirà l'URL SAS per il cliente per scaricare il profilo VPN a livello di VirtualWan-VpnServerConfiguration per la configurazione di Point to site client.
...
ID dell'oggetto configurazione del server VPN a cui verrà associata la WAN virtuale.
