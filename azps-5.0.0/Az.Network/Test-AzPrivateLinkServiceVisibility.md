...
## Descrizione
Verificare se un servizio di collegamento privato è visibile per l'uso corrente.

## ESEMPI

### Esempio 1: verificare se contoso.cloudapp.azure.com è disponibile per l'uso.
```
