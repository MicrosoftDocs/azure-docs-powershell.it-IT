...
```
### Esempio 3
Esempio di acquisizione di pacchetti per l'acquisizione di tutti i pacchetti interni ed esterni
```powershell
...
### -FilterData
Opzioni di filtro per avviare l'acquisizione di pacchetti nel gateway di rete virtuale.
...
### -Nome
Il nome del gateway di rete virtuale in cui deve essere avviata l'acquisizione di pacchetti.
