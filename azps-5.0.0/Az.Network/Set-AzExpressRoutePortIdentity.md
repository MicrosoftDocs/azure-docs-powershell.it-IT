...
## Descrizione
Il cmdlet **set-AzExpressRoutePortIdentity** aggiorna un oggetto ExpressRoutePort Azure locale. USA **set-AzExpressRoutePort** per assegnarlo a ExpressRoutePort.
