...
## Sinossi
Interrompe l'operazione di acquisizione di pacchetti in un gateway VPN.
...
## Descrizione
Interrompe l'operazione di acquisizione di pacchetti in un gateway VPN e carica il risultato in un contenitore di archiviazione specifico SasUrl.
...
### -InputObject
Oggetto gateway VPN in cui è possibile avviare l'acquisizione di pacchetti.
...
### -Nome
Il nome del gateway VPN in cui avviare l'acquisizione di pacchetti.
...
### -ResourceId
ID risorsa di Azure della VpnGateway in cui è possibile avviare l'acquisizione di pacchetti.
...
### -SasUrl
Acquisizione di pacchetti di URL SAS nel gateway VPN.
