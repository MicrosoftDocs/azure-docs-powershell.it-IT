...
## Descrizione
Il cmdlet **set-AzApplicationGatewayUrlPathMapConfig** imposta la configurazione per una matrice di mapping dei percorsi URL a un pool di server back-end.
...
Il secondo comando Aggiorna il mapping del percorso URL denominato map01 nel gateway dell'applicazione.
Il terzo comando Aggiorna il gateway dell'applicazione.

## PARAMETRI

### -ApplicationGateway
Specifica il gateway dell'applicazione a cui questo cmdlet imposta una configurazione della mappa percorso URL.
...
### -Nome
Specifica il nome della mappa percorso URL in cui questo cmdlet imposta la configurazione.
