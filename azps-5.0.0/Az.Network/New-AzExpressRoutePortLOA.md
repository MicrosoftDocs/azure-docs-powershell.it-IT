...
## Sinossi
Download della lettera di autorizzazione del documento per una porta di route espressa.
...
## Descrizione
New-AzExpressRoutePortLOA cmdlet Scarica il documento di una lettera di autorizzazione in formato PDF per una porta di route espressa.
...
Scaricare il documento di autorizzazione per la porta della route espressa "porta" e archiviarlo nel file "loa.pdf".
...
### -CustomerName
Nome del cliente a cui è assegnata la porta di Route Express.
...
### -Destinazione
FilePath di output in cui archiviare la lettera di autorizzazione.
...
### -ExpressRoutePort
Risorsa della porta di route espressa.
...
### -PortName
Nome della porta Route espressa.
...
### -ResourceGroupName
Nome del gruppo di risorse della porta di route espressa.
