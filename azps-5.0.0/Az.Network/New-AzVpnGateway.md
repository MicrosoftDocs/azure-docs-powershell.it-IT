...
New-AzVpnGateway crea un gateway VPN scalabile. Questa è la connettività definita dal software per le connessioni al sito all'interno del VirtualHub. 

Questo gateway viene ridimensionato e ridimensionato in base all'unità di scala specificata in questo o nel cmdlet Set-AzVpnGateway. 

Una connessione viene configurata da un ramo/sito noto come VPNSite al gateway scalabile. Ogni connessione è costituita da due tunnel Active-Active.

Il VpnGateway sarà nella stessa posizione della VirtualHub a cui si fa riferimento.
...
### -VirtualHubId
ID dell'VirtualHub a cui deve essere associato questo VpnGateway.
