...
## Descrizione
Il cmdlet **Disconnect-AzP2sVpnGatewayVpnConnection** consente di disconnettere il punto corrente alla connessione del sito da P2SVpnGateway.
...
### -ResourceId
ID risorsa gateway di rete virtuale P2S
