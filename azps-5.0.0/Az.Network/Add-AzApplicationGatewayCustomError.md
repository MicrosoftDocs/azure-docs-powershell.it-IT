...
## Descrizione
Il cmdlet **Add-AzApplicationGatewayCustomError** aggiunge un errore personalizzato a un gateway dell'applicazione.

## ESEMPI

### Esempio 1: aggiunge un errore personalizzato al livello del gateway dell'applicazione
```powershell
...
Questo comando aggiunge un errore personalizzato del codice di stato HTTP 502 al gateway dell'applicazione $appgw e restituisce il gateway aggiornato.

### Esempio 2: aggiunge un errore personalizzato al livello del listener del gateway dell'applicazione
```powershell
...
Questo comando aggiunge un errore personalizzato del codice di stato HTTP 502 al gateway dell'applicazione $appgw a livello di listener e restituisce il gateway aggiornato.
