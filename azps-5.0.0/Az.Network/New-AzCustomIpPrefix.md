...
Questo comando crea una nuova risorsa CustomIpPrefix con il nome $prefixName nel gruppo di risorse $rgName con un CIDR di 40.40.40.0/24 in westus
...
### -CIDR
La notazione CIDR CustomIpPrefix.
...
### -Posizione
La posizione di CustomIpPrefix.
