...
## Descrizione
Crea un pool di indirizzi back-end in un LoadBalancer. Consente di specifica una matrice di PSLoadBalancerBackendAddress. 
## ESEMPI
...
### -ResourceGroupName
Nome del gruppo di risorse del bilanciamento del carico.
