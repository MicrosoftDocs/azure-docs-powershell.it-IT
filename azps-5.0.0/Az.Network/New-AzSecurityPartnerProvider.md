...
## Descrizione
Il cmdlet **New-AzSecurityPartnerProvider** crea un SecurityPartnerProvider di Azure
...
### -VirtualHub
ID hub virtuale a cui è associato il provider del partner di sicurezza
