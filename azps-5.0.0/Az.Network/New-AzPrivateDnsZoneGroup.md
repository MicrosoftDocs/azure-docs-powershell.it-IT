...
## Descrizione
Il cmdlet **New-AzPrivateDnsZoneGroup** consente di creare un nuovo gruppo di aree DNS private.
...
Una volta creato endpoint privato `test-pr-endpoint` , sopra l'esempio viene creato il gruppo di zone DNS in tale endpoint privato.
