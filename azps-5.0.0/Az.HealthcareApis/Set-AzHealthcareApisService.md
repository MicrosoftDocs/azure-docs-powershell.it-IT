...
### Esempio 2: aggiorna il servizio healthcareapis esistente denominato servizio nel gruppo di risorse MyResourceGroup con il cosmosdb OfferThroughput = 500.
...
### -CorsHeader
Elenco dei servizi di HealthcareApis Fhir dell'intestazione di CORS. Specifica le intestazioni HTTP che possono essere usate durante la richiesta. Usare * per qualsiasi intestazione.
...
### -CorsMaxAge
HealthcareApis Fhir Service CORS max age. Specificare per quanto tempo un risultato di una richiesta può essere memorizzato nella cache in pochi secondi. Esempio: 600 significa 10 minuti.
...
### -CorsOrigin
HealthcareApis FhirService elenco delle origini di CORS. Elenco dei servizi di HealthcareApis Fhir di origine CORS. Specifica gli URL dei siti di origine che possono accedere a questa API o usa * per consentire l'accesso da qualsiasi sito.
