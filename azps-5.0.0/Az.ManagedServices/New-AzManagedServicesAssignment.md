...
Crea un'assegnazione di registrazione nell'ambito predefinito usando l'identificatore della definizione di registrazione.
...
Crea un'assegnazione di registrazione con un oggetto definizione di registrazione come input.
...
Aggiorna un'assegnazione di registrazione con un nome e un identificatore di definizione della registrazione.
...
ID risorsa completo della definizione di registrazione.
