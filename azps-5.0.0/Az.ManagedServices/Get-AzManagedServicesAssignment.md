...
Ottiene un'assegnazione di registrazione per nome senza dettagli sulla definizione di registrazione.
...
Ottiene un'assegnazione di registrazione per nome con i dettagli della definizione di registrazione.
...
Ottiene tutte le assegnazioni di registrazione in base a un ambito specifico.
...
### -Nome
Nome univoco dell'assegnazione di registrazione.
...
### -Ambito
Ambito in cui è stata creata l'assegnazione di registrazione.
