...
## Descrizione
Il cmdlet **Get-AzDataShareInvitation** ottiene le informazioni sugli inviti aggiunti nella condivisione dati. Se specifichi il nome dell'invito, questo cmdlet ottiene le informazioni sull'invito. Se non specifichi un nome, questo cmdlet riceverà informazioni su tutti gli inviti di una condivisione.
...
Questo comando fornisce informazioni sull'invito AdsInvitation presente in condivisione dati AdsShare.
...
### -Nome
Nome dell'invito della condivisione dati di Azure
...
### -ResourceId
ID risorsa dell'invito di condivisione dati di Azure
