...
## Descrizione
Il cmdlet **Get-AzDataShareSynchronizationDetail** fornisce informazioni dettagliate sulla sincronizzazione avviata per una condivisione.
...
Questo comando fornisce informazioni sui dettagli della sincronizzazione di tutti i set di dati corrispondenti all'ID di sincronizzazione specificato.
...
### -ResourceId
ID risorsa condivisione dati di Azure
...
### -SynchronizationId
ID sincronizzazione della sincronizzazione delle condivisioni
