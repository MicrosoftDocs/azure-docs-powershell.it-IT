...
### Esempio 1: aggiungere nuove proprietà regionali per gli Stati Uniti del centro ovest

```
Add-AzMlWebServiceRegionalProperty -ResourceGroupName "myresourcegroup" -Name "mywebservicename" -Region westcentralus
```

Questo comando di esempio crea una proprietà Region per un servizio Web nell'area "West Central US".
...
### -Area geografica
Area geografica in cui creare le proprietà del servizio Web.
...
### -ResourceGroupName
Gruppo di risorse in cui appartiene il servizio Web.
