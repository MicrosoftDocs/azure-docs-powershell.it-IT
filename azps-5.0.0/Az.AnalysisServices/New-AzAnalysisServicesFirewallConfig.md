...
## Descrizione
La New-AzAnalysisServicesFirewallConfig crea un nuovo oggetto di configurazione del firewall
...
Crea un oggetto di configurazione firewall con due regole, consentendo anche l'accesso dal servizio Power BI.
