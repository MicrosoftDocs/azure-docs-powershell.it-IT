...
### Esempio 1: elencare i membri di blockchain
```powershell
...
Questo comando elenca i membri di blockchain in un abbonamento.

### Esempio 2: elencare i membri di blockchain
```powershell
...
Questo comando elenca i membri di blockchain in un gruppo di risorse.

### Esempio 3: ottenere un membro di blockchain
```powershell
...
Questo comando ottiene un membro di blockchain in un gruppo di risorse.

### Esempio 4: ottenere un membro di blockchain
```powershell
