...
Ottiene il systemAssignedIdentity disponibile sotto l'ambito RP specificato.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Descrizione per ottenere i tasti funzione per una funzione in un sito Web o uno slot di distribuzione.
...
Descrizione per ottiene le impostazioni e lo stato delle app di riferimento per la configurazione di un'app

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
La descrizione di questo problema è consentire la chiamata tramite PowerShell e il modello ARM.
...
### [Move-AZ](Move-Az.md)
Descrizione per il trasferimento di risorse tra gruppi di risorse.
...
### [Sincronizzazione-AzWebAppFunctionSlot](Sync-AzWebAppFunctionSlot.md)
Descrizione per i metadati di trigger della funzione syncs per il database di gestione

### [Test-AZ](Test-Az.md)
Descrizione per la convalida se una risorsa può essere creata.
