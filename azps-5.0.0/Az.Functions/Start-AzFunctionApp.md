...
### Esempio 1: ottenere un'app di funzione per nome e avviarla.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Questo comando consente di ottenere un'app di funzione per nome e di avviarla.

### Esempio 2: avviare un'app di funzione per nome.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Questo comando avvia un'app di funzione per nome.
