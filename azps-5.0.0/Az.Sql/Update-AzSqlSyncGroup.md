...
## Descrizione
Il cmdlet **Update-AzSqlSyncGroup** modifica le proprietà di un gruppo di sincronizzazione di database SQL di Azure.
...
Se usare una connessione di collegamento privato quando si esegue la connessione all'hub di questo gruppo di sincronizzazione.
