...
## Descrizione
Il cmdlet Remove-AzSqlDatabaseSensitivityClassification consente di rimuovere i tipi di informazioni e le etichette di sensitività delle colonne nel database.

## ESEMPI

### Esempio 1: rimuovere il tipo di informazioni e l'etichetta di sensitività di una colonna in un database SQL di Azure.
```powershell
...
### Esempio 2: rimuovere i tipi di informazioni correnti e le etichette di sensitività delle colonne in un database SQL di Azure tramite piping.
```powershell
...
### Esempio 3: rimuovere il tipo di informazioni e l'etichetta di sensitività di una colonna in un database SQL di Azure tramite piping.
```powershell
...
Oggetto che rappresenta una classificazione di sensitivity del database SQL.
