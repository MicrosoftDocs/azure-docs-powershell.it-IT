...
Questo comando consente di ottenere i criteri di conservazione a breve termine per tutti i database eliminati denominati Database01 tramite piping in un oggetto di database eliminato.
