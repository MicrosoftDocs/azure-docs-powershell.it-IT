...
## Descrizione
Il cmdlet **complete-AzSqlInstanceDatabaseLogReplay** completa il servizio di riproduzione del log nel database specifico.
...
Questo comando completa il servizio di riproduzione del log per il database dato dopo che viene ripristinato l'ultimo backup.
