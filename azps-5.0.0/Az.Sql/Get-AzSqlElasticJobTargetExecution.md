...
## Descrizione
Il cmdlet Get-AzSqlElasticJobTargetExecution ottiene una o più esecuzioni di destinazione processo da un'esecuzione del processo

## ESEMPI

### Esempio 1: ottiene una o più esecuzioni di destinazione dei processi da un'esecuzione di processi
```powershell
...
### Esempio 2: ottiene una o più esecuzioni di destinazione processo da un processo di esecuzione-filtro in base al nome del passaggio
```powershell
PS C:\> $je = Get-AzSqlElasticJobExecution -ResourceGroupName rg -ServerName elasticjobserver -AgentName agent -JobName job1 -JobExecutionId 3bcfc912-20b2-411d-a2b7-6265d13fe272
...
### -Conteggio
Count restituisce il numero di esecuzioni principali.
...
### -CreateTimeMin
Filtrare per creare il tempo min
...
### -ParentObject
L'oggetto di esecuzione del processo.
...
### -ParentResourceId
ID risorsa di esecuzione processo.
