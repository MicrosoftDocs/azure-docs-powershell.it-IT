...
## Descrizione
Il cmdlet **Get-AzSqlServerAdvisor** ottiene uno o più consulenti di SQL Server di Azure per un server SQL di Azure.
...
### Esempio 5: elencare tutti i consulenti per il server tramite filtro
```
...
Questo comando consente di ottenere un elenco di tutti gli Advisor per il server denominato Wi-Runner-Australia-Est che appartiene al gruppo di risorse denominato WIRunnersProd che inizia con la lettera "d".
