...
## Descrizione
Il cmdlet New-AzAvailabilityGroupListener crea un nuovo listener del gruppo di disponibilità.
...
Crea un nuovo listener del gruppo di disponibilità AgListener01 per il gruppo di disponibilità AvailabilityGroup01 nel gruppo SQL Virtual Machine SqlVmGroup01.
...
ID di bilanciamento del carico
...
### -Porta
Numero di porta del listener di AG. Il valore predefinito è 1433.
...
ID risorsa indirizzo IP pubblico
