...
### Esempio 1: ottenere un'area di lavoro databricks con il nome
```powershell
...
Questo comando consente di ottenere un'area di lavoro databricks in un gruppo di risorse.

### Esempio 2: elencare tutte le aree di lavoro di databricks in una sottoscrizione
```powershell
...
Questo comando elenca tutte le aree di lavoro databricks in un abbonamento.

### Esempio 3: elencare tutte le aree di lavoro databricks in un gruppo di risorse
```powershell
...
Questo comando elenca tutte le aree di lavoro databricks in un gruppo di risorse.
