...
### ResourceGroupAndNameParameterSet (impostazione predefinita)
```
...
## Descrizione
**Remove-AzUserAssignedIdentity** Elimina l'identità assegnata dall'utente specificato.
...
Questo cmdlet di esempio Elimina l'identità **ID1** in gruppo risorse **PSRG**.
True
