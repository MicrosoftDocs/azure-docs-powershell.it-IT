...
### -AcceptLanguage
Intestazione della richiesta standard.
Usato da Service per rispondere al client in una lingua appropriata.
...
### -MigrateProjectName
Nome del progetto di migrazione di Azure.
...
### -ResourceGroupName
Il nome del gruppo di risorse di Azure in cui viene eseguita la migrazione di Project fa parte.
...
### -Strumento
Ottiene o imposta lo strumento da registrare.
