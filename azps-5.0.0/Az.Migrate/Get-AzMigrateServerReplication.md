...
### Esempio 2: elenca tutto in Project per ID.
```powershell
...
### Esempio 2: elenca tutto in Project per nome.
```powershell
...
### -ProjectName
Specifica il progetto di migrazione di Azure nell'abbonamento corrente.
