...
**Nota** : quando questo cmdlet viene usato con [set-AzActivityLogAlert](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azactivitylogalert) , almeno uno di questi oggetti, passati come parametri, deve avere il relativo campo uguale a "Category". In caso contrario, il backend risponde con una 400 (BadRequest.)
