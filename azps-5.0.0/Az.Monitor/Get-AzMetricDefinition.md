...
## Descrizione
Il cmdlet **Get-AzMetricDefinition** ottiene le definizioni metriche.

## ESEMPI

### Esempio 1: ottenere definizioni metriche per una risorsa
```
...
Questo comando consente di ottenere le definizioni metriche per la risorsa specificata.

### Esempio 2: ottenere definizioni metriche con l'output dettagliato
```
...
Questo comando ottiene le definizioni metriche per WebSite2.
L'output è dettagliato.

### Esempio 3: ottenere le definizioni metriche per nome
```
...
Questo comando ottiene le definizioni per le metriche BytesSent e CpuTime.
L'output è dettagliato.
...
### -DetailedOutput
Indica che questa operazione include l'output dettagliato.
Se non specifichi questo parametro, l'output viene riepilogato.
...
### -MetricNamespace
Specifica lo spazio dei nomi Metric per le definizioni metriche della query.
