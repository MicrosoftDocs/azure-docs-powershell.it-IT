...
### Esempio 1: creare una nuova regola del firewall del server PostgreSql
```powershell
...
Questo cmdlet crea una regola del firewall del server PostgreSql.

### Esempio 2: creare una nuova regola del firewall PostgreSql usando-ClientIPAddress.
```powershell
...
Questo cmdlet crea una regola del firewall PostgreSql usando-ClientIPAddress.

### Esempio 3: creare una nuova regola del firewall PostgreSql per consentire tutti gli IPs
```powershell
...
Questo cmdlet crea una nuova regola del firewall PostgreSql per consentire tutti gli IPs.
