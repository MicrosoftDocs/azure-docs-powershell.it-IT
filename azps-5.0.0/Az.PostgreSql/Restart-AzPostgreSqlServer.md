...
### Esempio 1: riavviare il server PostgreSql per il gruppo di risorse e il nome del server
```powershell
...
### Esempio 2: riavviare il server PostgreSql per identità
```powershell
...
Questi cmdlet riavviano il server PostgreSql per identità.
