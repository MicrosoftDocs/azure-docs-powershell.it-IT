...
### Esempio 1: aggiornare la regola di rete virtuale PostgreSql per nome
```powershell
...
Questo cmdlet aggiorna la regola di rete virtuale PostgreSql per nome.

### Esempio 2: aggiornare la regola di rete virtuale PostgreSql per identità.
```powershell
...
Questi cmdlet aggiornano la regola della rete virtuale PostgreSql per identità.
