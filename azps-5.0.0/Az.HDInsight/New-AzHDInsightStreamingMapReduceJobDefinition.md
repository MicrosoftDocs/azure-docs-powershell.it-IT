...
## Descrizione
Il cmdlet **New-AzHDInsightStreamingMapReduceJobDefinition** definisce un oggetto processo in streaming MapReduce da usare con un cluster di Azure HDInsight.

## ESEMPI

### Esempio 1: creare una definizione di processo di flusso MapReduce
```
PS C:\># Cluster info
...
Questo comando crea una definizione di processo di flusso MapReduce.
...
### -CommandEnvironment
Specifica una matrice di variabili di ambiente della riga di comando da impostare quando un processo viene eseguito sui nodi di lavoro.
...
### -Mapper
Specifica un nome di file di Mapper.
...
### -Riduttore
Specifica un nome di file del riduttore.
