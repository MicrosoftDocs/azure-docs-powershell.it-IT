...
### Esempio 1: aggiungere il profilo di sicurezza all'oggetto di configurazione del cluster
```
...
Questo comando aggiunge un valore del profilo di sicurezza al cluster denominato your-Hadoop-001.
...
### -DomainResourceId
ID risorsa di dominio Active Directory per il cluster.
