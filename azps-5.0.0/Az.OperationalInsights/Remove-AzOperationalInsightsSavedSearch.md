...
## Descrizione
Il cmdlet **Remove-AzOperationalInsightsSavedSearch** rimuove una ricerca salvata dall'area di lavoro.

## ESEMPI

### Esempio 1: rimuovere una ricerca salvata
```
...
Questo comando rimuove una ricerca salvata dall'area di lavoro.
