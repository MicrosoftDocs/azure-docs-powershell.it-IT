...
### Esempio 1: aggiunta di una risorsa alla raccolta Move.
```powershell
...
Aggiunta di una risorsa alla raccolta di mosse all'interno della sottoscrizione specificata.
...
### -DependsOnOverride
Ottiene o imposta l'override delle dipendenze delle risorse di trasferimento.
Per costruire, vedere la sezione Note per le proprietà di DEPENDSONOVERRIDE e creare una tabella hash.
...
### -ExistingTargetId
Ottiene o imposta l'ID del braccio di destinazione esistente della risorsa.
...
### -SourceId
Ottiene o imposta l'ID del braccio di origine della risorsa.
...
DEPENDSONOVERRIDE <IMoveResourceDependencyOverride [] >: Ottiene o imposta gli override delle dipendenze della risorsa di trasferimento.
  - `[Id <String>]`: Ottiene o imposta l'ID ARM della risorsa dipendente.
  - `[TargetId <String>]`: Ottiene o imposta l'ID ARM della risorsa di MoveResource o dell'ID ARM della risorsa della risorsa dipendente.
