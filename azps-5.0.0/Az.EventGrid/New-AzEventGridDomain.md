...
## Descrizione
Crea un nuovo dominio della griglia di eventi di Azure. Dopo aver creato il dominio, un'applicazione può pubblicare gli eventi nell'endpoint dell'argomento.

## ESEMPI

### Esempio 1

Crea un dominio della griglia eventi \` dominio1 \` nella posizione geografica specificata \` westus2 \` , nel gruppo risorse \` MyResourceGroupName \` .
...
Crea un dominio della griglia eventi \` dominio1 \` nella posizione geografica specificata \` westus2 \` , nel gruppo risorse \` MyResourceGroupName \` con i tag specificati "reparto" e "ambiente".
