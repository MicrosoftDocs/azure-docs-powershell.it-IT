...
## Sinossi
Ottenere una o più offerte di uno store privato.
...
## Descrizione
Ottenere una o più offerte di un archivio privato con i piani public + private aggiunti in ambito tenant. Se l'ID abbonamento è presente, ottenere una o più offerte private Store con piani privati solo in ambito abbonamento
## ESEMPI
...
Ottenere le offerte dell'archivio privato con i piani privati + pubblici aggiunti in ambito tenant.
...
Ottenere le offerte dell'archivio privato con piani privati aggiunti in ambito abbonamento.
...
Ottenere l'offerta dell'archivio privato con i piani privati + pubblici aggiunti in ambito tenant.
...
Ottenere l'offerta dell'archivio privato con piani privati solo che è stato aggiunto in ambito tenant.
...
### -Idofferta
Offerta privateStore di Azure Marketplace necessaria
...
### -PrivateStoreId
Offerte di Azure Marketplace privateStore richieste
...
### -SubscriptionId
ID abbonamento a Azure Marketplace
