...
## Descrizione
Il cmdlet **Remove-AzDiskAccess** rimuove una risorsa di Access su disco.

## ESEMPI

### Esempio 1: rimuovere l'accesso al disco usando il set di parametri predefinito
```
PS C:\> Remove-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
```

Questo comando rimuove l'accesso al disco denominato "DiskAccess01" nel gruppo di risorse "ResourceGroup01"

### Esempio 2: rimuovere l'accesso al disco tramite ID risorsa
```
...
Questo comando rimuove l'accesso al disco tramite ID risorsa

### Esempio 3: rimuovere l'accesso al disco usando l'oggetto di input
```
PS C:\> $myDiskAccess = Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01"
PS C:\> Remove-AzDiskAccess -InputObject $myDiskAccess
```

Questo comando rimuove l'accesso al disco da InputObject

### Esempio 4: rimuovere l'accesso al disco tramite l'oggetto di input piping
```
PS C:\> Get-AzDiskAccess -ResourceGroupName "ResourceGroup01" -Name "DiskAccess01" | Remove-AzDiskAccess 
```

Questo comando rimuove l'accesso al disco eseguendo il piping di InputObject
...
### -InputObject
Oggetto di Access su disco di PowerShell
