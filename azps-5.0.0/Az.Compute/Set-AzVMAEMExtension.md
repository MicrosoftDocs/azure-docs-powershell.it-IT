...
### -InstallNewExtension
Installare la nuova estensione VM per SAP.
...
Imposta l'accesso dell'identità VM alle singole risorse, ad esempio i dischi di dati anziché il gruppo di risorse completo.
