...
### -HostGroupId
Specifica il gruppo host dedicato a cui si trova la macchina virtuale.
...
### -VmssId
ID della scala della macchina virtuale impostata per la quale questa VM sarà associata
