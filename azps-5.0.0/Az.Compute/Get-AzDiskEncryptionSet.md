...
Ottenere il set di crittografia del disco ' ENC1'
...
Ottenere tutti i set di crittografia disco nel gruppo di risorse "RG1".
...
Ottenere tutti i set di crittografia disco in abbonamento.
