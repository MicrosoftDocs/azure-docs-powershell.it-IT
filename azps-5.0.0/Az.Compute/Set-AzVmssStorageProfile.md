...
## Descrizione
Il cmdlet **set-AzVmssStorageProfile** imposta le proprietà del profilo di archiviazione per il set di scale della macchina virtuale (VMSS).
...
Per ottenere l'oggetto, usa l'oggetto New-AzVmssConfig.
