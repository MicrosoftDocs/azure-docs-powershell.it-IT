...
## Descrizione
Il cmdlet **Get-AzStorageAccount** ottiene un account di archiviazione specificato o tutti gli account di archiviazione in un gruppo di risorse o nell'abbonamento.
...
### Esempio 4: ottenere un account di archiviazione con lo stato di ripristino BLOB
```
...
Questo comando ottiene un account di archiviazione con lo stato di ripristino BLOB e Mostra lo stato di ripristino BLOB.
...
Ottenere il BlobRestoreStatus dell'account di archiviazione.
...
Ottenere il GeoReplicationStats dell'account di archiviazione.
