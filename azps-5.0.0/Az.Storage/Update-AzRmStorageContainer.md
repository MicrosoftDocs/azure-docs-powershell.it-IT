...
## Descrizione
Il cmdlet **Update-AzRmStorageContainer** modifica un contenitore di BLOB di archiviazione

## ESEMPI

### Esempio 1: modifica i metadati di un contenitore BLOB di archiviazione e l'accesso pubblico con il nome dell'account di archiviazione e il nome del contenitore
```
...
Questo comando modifica i metadati di un contenitore BLOB di archiviazione e l'accesso pubblico con il nome dell'account di archiviazione e il nome del contenitore.
