...
## Descrizione
Il cmdlet **set-AzStorageObjectReplicationPolicy** crea o aggiorna i criteri di replica degli oggetti specificati in un account di archiviazione.

## ESEMPI

### Esempio 1: impostare i criteri di replica degli oggetti sia per l'account di destinazione che per quello di origine.
```
...
Questo comando imposta i criteri di replica degli oggetti sia per l'account di destinazione che per quello di origine.
Prima di tutto creare due regole dei criteri di replica degli oggetti e impostare i criteri con l'account di destinazione 2 regole. Imposta quindi il criterio di replica degli oggetti dall'account di destinazione all'account di origine.
...
### -DestinationAccount
Criteri di replica degli oggetti DestinationAccount.
...
### -InputObject
Oggetto Criteri di replica degli oggetti da impostare sull'account specificato.
...
### -PolicyId
ID criterio di replica degli oggetti. Dovrebbe essere un GUID o "default".
Se non viene inserito il PolicyId, verrà usato "default", che significa creare un nuovo criterio e l'ID del nuovo criterio verrà restituito nel criterio creato.
...
### -Regola
Regole dei criteri di replica degli oggetti.
...
### -SourceAccount
Criteri di replica degli oggetti SourceAccount.
