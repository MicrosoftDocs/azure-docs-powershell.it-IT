...
### Esempio 1: aggiornare un kubernetes connesso
```powershell
...
Questo comando aggiorna un kubernetes connesso.

### Esempio 2: aggiornare un kubernetes connesso per oggetto
```powershell
...
Questo comando aggiorna un kubernetes connesso per oggetto.
