...
### ByVirtualNetworkRule (impostazione predefinita)
```
...
## Descrizione
Creare un oggetto regola di rete nella sessione corrente di PowerShell.
...
Creare un set di regole virtualnetwork.

## PARAMETRI

### -Azione
Azione della regola di rete.
...
### -IPAddressOrRange
Specifica l'intervallo IP o IP in formato CIDR.
È consentito solo l'indirizzo IPV4.
...
ID risorsa di una subnet, ad esempio:/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{vnetName}/subnets/{subnetName}.
...
### -VirtualNetworkRule
Indicare per creare VirtualNetworkRule.
