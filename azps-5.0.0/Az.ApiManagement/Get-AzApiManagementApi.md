...
## Descrizione
Il cmdlet **Get-AzApiManagementApi** ottiene una o più API di gestione delle API di Azure.
...
Questo comando ottiene l'API per l'oggetto GatewayId specificato.
...
### -GatewayId
Se specificato cercherà di ottenere tutte le API del gateway.
