...
### -ApiRevision
Identificatore della revisione API. Questo parametro è facoltativo. Se non specificato, l'operazione verrà rimossa dalla revisione API attualmente attiva.
