...
### Esempio 1: rimuove le impostazioni del provider di identità di Facebook dal servizio ApiManagement
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementIdentityProvider -Context $apimContext -Type 'Facebook' -PassThru
```

Elimina la configurazione relativa alla configurazione del provider di identità di Facebook.
...
### -PassThru
Indica che questo cmdlet restituisce un valore di $True se l'operazione viene eseguita correttamente o $False in caso contrario.
