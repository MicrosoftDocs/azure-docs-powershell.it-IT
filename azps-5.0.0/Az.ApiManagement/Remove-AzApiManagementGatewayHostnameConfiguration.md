...
## Descrizione
Il cmdlet **Remove-AzApiManagementGatewayHostnameConfiguration** rimuove una configurazione hostname dal gateway esistente.

## ESEMPI

### Esempio 1: rimuovere una configurazione del nome host del gateway esistente
```powershell
...
Questo comando rimuove una configurazione del nome host del gateway esistente e non chiede conferma all'utente.
...
Identificatore della configurazione del nome host del gateway esistente.
Questo parametro è obbligatorio.
...
### -InputObject
Istanza di PsApiManagementGatewayHostnameConfiguration. Questo parametro è obbligatorio.
...
### -ResourceId
ResourceId ARM di GatewayHostnameConfiguration. Questo parametro è obbligatorio.
