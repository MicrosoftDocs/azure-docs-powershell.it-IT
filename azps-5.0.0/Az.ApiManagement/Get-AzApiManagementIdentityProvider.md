...
## Descrizione
Ottenere i dettagli della configurazione del provider di identità.
ClientSecret non verrà incluso nei dettagli dei risultati. Per ottenere il segreto del client, USA **Get-AzApiManagementIdentityProviderClientSecret**.
...
### Esempio 2: ottenere il provider di identità di tipo AAD
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### Esempio 3: ottenere il provider di identità di tipo AAD B2C
```powershell
