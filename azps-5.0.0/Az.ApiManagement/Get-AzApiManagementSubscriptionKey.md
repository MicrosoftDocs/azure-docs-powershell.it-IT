...
## Descrizione
Il cmdlet **Get-AzApiManagementSubscriptionKey** ottiene le chiavi di un abbonamento specificato.

## ESEMPI

### Esempio 1: ottenere una chiave di sottoscrizione con un ID specificato
```
