...
## Descrizione
Il cmdlet Get-AzIotSecurityAnalytics restituisce un set di analisi della sicurezza di una soluzione di sicurezza molto specifica
...
Ottenere gli deafult Security Analytics per la soluzione di sicurezza "soluzione" nel gruppo risorse "MyResourceGroup"

## PARAMETRI

### -Impostazione predefinita
Se presente, ottenere il set di analisi predefinito, in caso contrario, ottenere l'elenco di tutti i set di analisi.
