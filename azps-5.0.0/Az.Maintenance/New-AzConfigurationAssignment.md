...
## Descrizione
Registrare la configurazione della manutenzione per la risorsa.
...
Configurazione della manutenzione della registrazione per host dedicato.
...
Il nome dell'assegnazione di configurazione deve corrispondere a MaintenanceConfigurationName.
...
### -Posizione
Posizione senza spazi per la risorsa.
...
MaintenanceConfiguration completo.
