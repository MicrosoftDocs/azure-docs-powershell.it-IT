...
### Esempio 1: rimuovere il servizio cloud primaverile in base al nome.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Rimuovere il servizio cloud primaverile in base al nome.

### Esempio 2: rimuovere il servizio cloud primaverile dalla pipe.
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Rimuovere il servizio cloud primaverile dalla pipe.
