...
Key Vault auto rigenera e commuta la chiave attiva in base al periodo di rigenerazione. Vedere l' [account di archiviazione gestita di Azure Key Vault-PowerShell](https://docs.microsoft.com/azure/key-vault/key-vault-overview-storage-keys-powershell) per una panoramica di questa caratteristica.
