...
Eseguire il backup dei dati del dominio di sicurezza di un HSM gestito per il ripristino.
...
Definizioni dei ruoli di elenco di un HSM gestito specifico in un ambito specifico.
...
### [Ripristinare-AzKeyVaultCertificate](Restore-AzKeyVaultCertificate.md)
...
### [Ripristinare-AzKeyVaultManagedStorageAccount](Restore-AzKeyVaultManagedStorageAccount.md)
...
### [Ripristinare-AzManagedHsm](Restore-AzManagedHsm.md)
Ripristina completamente un HSM gestito da backup.

### [Ripristinare-AzManagedHsmKey](Restore-AzManagedHsmKey.md)
Crea una chiave in un HSM gestito da un tasto di backup.

### [Ripristinare-AzManagedHsmSecurityDomain](Restore-AzManagedHsmSecurityDomain.md)
Ripristina i dati del dominio di sicurezza di backup precedenti in un HSM gestito.
