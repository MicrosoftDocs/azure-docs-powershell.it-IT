...
## Sinossi
Aggiorna un provider di risorse personalizzato esistente.
L'unico valore che può essere aggiornato tramite PATCH è attualmente i tag.
...
### Esempio 1: aggiungere tag a un provider personalizzato
```powershell
...
Aggiornare i tag di un provider personalizzato.

### Esempio 2: aggiornare un provider personalizzato con piping
```powershell
...
Aggiornare un provider personalizzato tramite piping.
