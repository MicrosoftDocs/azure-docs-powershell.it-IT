...
### Esempio 1: elencare tutte le estensioni di lingua impostate per un cluster
```powershell
...
Il comando precedente restituisce un elenco di estensioni di lingua che possono essere eseguite in query KQL.
