...
### Esempio 1: creare un nuovo database di Kusto per nome
```powershell
...
Il comando precedente crea un nuovo database di Kusto denominato "mykustodatabase" nel cluster esistente "testnewkustocluster" disponibile nel gruppo di risorse "testrg".
