...
### Esempio 1: creare un database di cluster kusto principalAssignment
```powershell
...
Il comando precedente crea un database di cluster kusto principalAssignment
...
### -PrincipalId
ID entità assegnato all'entità di database.
Può essere un nome di posta elettronica, di ID applicazione o di gruppo di sicurezza per l'utente.
