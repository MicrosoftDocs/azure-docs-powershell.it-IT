...
### Esempio 1: elenco delle entità di database del cluster e del database kusto specificati
```powershell
...
Il comando precedente restituisce un elenco di entità di database del cluster e del database kusto specificati
