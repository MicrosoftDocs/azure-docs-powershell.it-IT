...
## Descrizione
Aggiungere l'estensione VM al tipo di nodo. In questo modo si aggiungerà l'estensione alla risorsa set di scala della macchina virtuale underliying.
...
Questo comando aggiunge un'estensione con le impostazioni e le impostazioni protette al tipo di nodo.
...
Questo può usare il cmdlet Get-AzVMImagePublisher per ottenere il Publisher.
...
Puoi usare il cmdlet Get-AzVMExtensionImageType per ottenere il tipo di estensione.
