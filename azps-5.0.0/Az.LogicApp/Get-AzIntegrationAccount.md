...
## Descrizione
Il cmdlet **Get-AzIntegrationAccount** ottiene gli account di integrazione da un gruppo di risorse. Specificare il nome di un account di integrazione e il nome del gruppo di risorse.
...
### Esempio 1: ottenere un account di integrazione per nome
```
...
Questo comando ottiene un account di integrazione denominato IntegrationAccount31 dal gruppo di risorse specificato.

### Esempio 2: ottenere gli account di integrazione in un gruppo di risorse
```
...
Questo comando ottiene gli account di integrazione da un gruppo di risorse denominato ResourceGroup11.
...
Questo comando consente di ottenere tutti gli account di integrazione nell'abbonamento a Azure.
