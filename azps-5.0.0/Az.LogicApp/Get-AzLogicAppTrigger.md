...
## Descrizione
Il cmdlet **Get-AzLogicAppTrigger** ottiene trigger da un'app logica.
...
### Esempio 1: ottenere un trigger di un'app logica
```
...
Questo comando ottiene il trigger denominato Trigger01 dall'app logica denominata LogicApp05.

### Esempio 2: ottenere tutti i trigger di un'app logica
```
...
Questo comando consente di ottenere i trigger dell'app logica denominata LogicApp07.
...
### -Nome
Specifica il nome dell'app logica da cui questo cmdlet ottiene un trigger.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse in cui questo cmdlet ottiene un trigger.
...
### -Triggername
Specifica il nome del trigger ottenuto da questo cmdlet.
