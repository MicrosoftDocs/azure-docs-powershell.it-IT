...
## Descrizione
Il cmdlet **Get-AzConsumptionPriceSheet** ottiene i fogli di prezzo dell'abbonamento.

## ESEMPI

### Esempio 1: ottenere i fogli di prezzo
```powershell
...
### Esempio 2: ottenere i fogli di prezzo con l'espansione di MeterDetails
```powershell
...
### Esempio 3: ottenere fogli di prezzo di BillingPeriodName
```powershell
...
### Esempio 4: ottenere i primi 5 record dei fogli di prezzo
```powershell
...
### -BillingPeriodName
Nome di un periodo di fatturazione specifico per ottenere i fogli di prezzo con cui si associa.
...
### -ExpandMeterDetail
Espandere i fogli di prezzo in base a MeterDetails.
...
### Microsoft. Azure. Commands. consume. Models. PSPriceSheet
