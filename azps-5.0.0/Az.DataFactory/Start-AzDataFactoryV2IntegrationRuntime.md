...
## Descrizione
Il cmdlet **Start-AzDataFactoryV2IntegrationRuntime** avvia un runtime di Integration dedicato gestito. La risorsa viene provisionata e dopo l'operazione lo stato è "iniziato".
