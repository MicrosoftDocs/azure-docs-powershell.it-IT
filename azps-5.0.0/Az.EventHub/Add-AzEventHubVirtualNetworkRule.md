...
Aggiunge la subnet specificata e IgnoreMissingVnetServiceEndpoint (VirtualNetworkRule) a NetworkRuleSet per lo spazio dei nomi specifico
...
Aggiunge la $virtualruleset da 1 a NetworkRuleSet per lo spazio dei nomi specifico
