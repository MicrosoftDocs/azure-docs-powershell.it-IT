...
### -Operator
Operatore da usare per la corrispondenza del selettore, EqualsAny significa nessun selettore (tutte le variabili di corrispondenza del tipo specificato)
...
### -Selector
Modello di selezione in base all'operatore (se l'operatore non è EqualsAny)
...
### -Variabile
Associa variabile. I valori possibili sono RequestHeaderNames, RequestCookieNames, QueryStringArgNames, RequestBodyPostArgNames.
Ad esempio, QueryStringArgNames è un'esclusione dei parametri GET che corrispondono al selettore con l'operatore indicato.
