...
Eliminare l'hub degli altri collegamenti "myiothub" in un servizio di provisioning del dispositivo hub Azure molto.
...
Eliminare l'hub degli altri collegamenti "myiothub" in un servizio di provisioning del dispositivo hub di Azure molto usando pipeline.
...
### -LinkedHubName
Nome host dell'hub degli Stati Uniti
