...
Elenca tutti gli hub degli elenchi collegati in "myiotdps".
...
Mostra i dettagli dell'hub collegato "myiothub1" in un servizio di provisioning del dispositivo hub Azure molto.
