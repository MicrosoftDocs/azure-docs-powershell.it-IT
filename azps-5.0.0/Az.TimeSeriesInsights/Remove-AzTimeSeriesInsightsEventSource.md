...
### Esempio 1: rimuovere un'origine eventi specificata per nome
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEventSource -EnvironmentName tsitest001 -Name iots001 -ResourceGroupName testgroup

```

In questo modo viene rimossa una specifica origine eventi.

### Esempio 2: rimuovere un'origine eventi specificata per oggetto
```powershell
