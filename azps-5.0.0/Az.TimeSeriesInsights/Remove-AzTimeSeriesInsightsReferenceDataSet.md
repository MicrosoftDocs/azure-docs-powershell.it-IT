...
### Esempio 1: rimuovere i dati di riferimento specificati impostati per nome
```powershell
PS C:\> Remove-AzTimeSeriesInsightsReferenceDataSet -EnvironmentName tsitest001 -Name dstest001 -ResourceGroupName testgroup

```

Questo comando rimuove un set di dati di riferimento specificato.

### Esempio 2: rimuovere un set di dati di riferimento specificato da un oggetto
```powershell
