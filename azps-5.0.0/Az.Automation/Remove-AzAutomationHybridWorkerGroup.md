...
## Descrizione
Il cmdlet Remove-AzAutomationHybridWorkerGroup rimuove un gruppo di lavoro ibrido dall'automazione.

## ESEMPI

### Esempio 1
Questo comando rimuove un lavoratore ibrido per nome.
...
### -Nome
Nome del gruppo di lavoratori ibridi.
