...
## Descrizione
Ottiene i servizi di peering per un abbonamento
...
Ottiene un servizio peering per un gruppo di risorse
...
Ottiene un servizio peering per un gruppo di risorse e un nome
...
Ottiene un servizio peering tramite ID risorsa
