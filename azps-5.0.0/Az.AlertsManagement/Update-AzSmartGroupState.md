...
## Descrizione
**Update-AzSmartGroupState** cmdlet aggiorna lo stato dello Smart Group.
...
Questo cmdlet aggiorna lo stato del gruppo smart in acknowleged.
...
### -SmartGroupId
Identificatore univoco di Smart Group/ResourceId di Smart Group.
