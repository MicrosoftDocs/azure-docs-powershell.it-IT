...
## Descrizione
Il cmdlet Get-AzMapsAccountKey ottiene le chiavi API per un account di mappe di Azure con provisioning.
Un account di Azure Maps include due chiavi API: primaria e secondaria.
I tasti consentono l'interazione con l'endpoint dell'account di Azure maps.
USA New-AzMapsAccountKey (New-AzMapsAccountKey. MD) per rigenerare una chiave.
...
Restituisce le chiavi dell'account Azure Maps specificato.
...
### -InputObject
L'account di Maps viene inviato tramite pipe da Get-AzMapsAccount.
