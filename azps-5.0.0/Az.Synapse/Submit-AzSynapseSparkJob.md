...
## Descrizione
Il cmdlet **Submit-AzSynapseSparkJob** Invia un processo Spark analisi sinapsi.
...
Questo comando Invia un processo Spark analisi sinapsi.
...
Questo comando Invia un processo di Spark .NET di analisi sinapsi.
...
Questo comando Invia un processo di analisi di PySpark di sinapsi.
...
### -MainClassName
L'identificatore completo o la classe Main che si trova nel file di definizione principale.
Obbligatorio per il processo Spark e Spark di .NET.
