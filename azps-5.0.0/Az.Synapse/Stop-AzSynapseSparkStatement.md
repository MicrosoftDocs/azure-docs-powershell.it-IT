...
## Descrizione
Il cmdlet **Stop-AzSynapseSparkStatement** Annulla un'istruzione Spark di analisi sinapsi.
...
Questo comando Annulla l'istruzione Spark con l'ID Livio specificato.
...
Questo comando Annulla l'istruzione Spark con l'ID Livio specificato tramite pipeline.
