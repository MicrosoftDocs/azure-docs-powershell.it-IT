...
## Descrizione
Il cmdlet **Get-AzSynapseIntegrationRuntimeMetric** ottiene i dati metrici relativi a Integration Runtime in un'area di lavoro.
...
Questo comando Visualizza i dati metrici relativi al runtime di integrazione denominato "test-SelfHost-IR" nell'area di lavoro denominata ContosoWorkspace.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSIntegrationRuntimeMetrics
