...
## Descrizione
Il cmdlet **Get-AzSynapseRoleDefinition** ottiene una definizione del ruolo di analisi di Azure sinapsi.
Se non specifichi un nome di ruolo o un ID ruolo, questo cmdlet ottiene tutte le definizioni di ruolo.
...
Questo comando consente di ottenere tutte le definizioni dei ruoli in un'area di lavoro.
...
Questo comando ottiene la definizione di ruolo in area di lavoro ContosoWorkspace con nome ContosoRole.
...
Questo comando consente di ottenere tutte le definizioni dei ruoli in un'area di lavoro tramite pipeline.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSSynapseRole
