...
## Descrizione
Il cmdlet **Get-AzSynapseIntegrationRuntimeNode** ottiene le informazioni dettagliate di un nodo runtime di Integration.
...
Il cmdlet ottiene le informazioni del nodo denominato "Node_1" in self-hosted Integration Runtime "test-SelfHost-IR" nell'area di lavoro ContosoWorkspace.
...
Il cmdlet ottiene le informazioni del nodo denominato "Node_1" in self-hosted Integration Runtime "test-SelfHost-IR" nell'area di lavoro "test-DF-EU2", incluso l'indirizzo IP.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSManagedIntegrationRuntimeNode

### Microsoft. Azure. Commands. sinapsi. Models. PSSelfHostedIntegrationRuntimeNode
