...
## Descrizione
Il cmdlet **Update-AzSynapseSparkPool** aggiorna un pool di Spark di analisi di Azure sinapsi.
...
Questo comando aggiorna un pool di Spark di analisi di Azure sinapsi.
...
Questo comando aggiorna un pool di Spark di analisi di Azure sinapsi tramite pipeline.
...
Questo comando aggiorna un pool di Spark di analisi di Azure sinapsi con ID risorsa.
...
Questo comando consente di abilitare la scala automatica per un pool di analisi di Azure sinapsi.
...
Questo comando Disabilita la scala automatica per un pool di analisi delle sinapsi di Azure.
...
Questo comando Abilita la pausa automatica per un pool di analisi di Azure sinapsi.
...
Questo comando Disabilita la pausa automatica per un pool di analisi delle sinapsi di Azure.
...
Numero di minuti di inattività. Questo parametro deve essere specificato quando è abilitata la pausa automatica.
...
Numero massimo di nodi da allocare nel pool di scintille specificato.
Questo parametro deve essere specificato quando è abilitata la scala automatica.
...
Numero minimo di nodi da allocare nel pool di scintille specificato.
Questo parametro deve essere specificato quando è abilitata la scala automatica.
...
### -EnableAutoPause
Indica se deve essere abilitata la pausa automatica.
...
### -EnableAutoScale
Indica se la scala automatica deve essere abilitata
...
File di configurazione dell'ambiente (output "Freeze PIP").
...
### -NodeCount
Numero di nodi da allocare nel pool di scintille specificato.
...
### -NodeSize
Numero di core e memoria da usare per i nodi allocati nel pool di scintille specificato.
Questo parametro deve essere specificato quando la scala automatica è disabilitata
...
### -SparkVersion
Versione Spark di Apache.
Valori consentiti: 2,4
