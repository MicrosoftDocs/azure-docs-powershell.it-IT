...
### ExportByName (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Export-AzSynapseNotebook** esporta un blocco appunti di Azure sinapsi in un file di blocco appunti (ipynb). Il nome del blocco appunti diventa il nome del file esportato. Se specifichi il nome di un blocco appunti, il cmdlet Esporta il blocco appunti. Se non si specifica un nome, il cmdlet Esporta tutti i blocchi appunti nell'area di lavoro.
...
Esporta tutti i blocchi appunti nell'area di lavoro ContosoWorkspace nella cartella "C:\Notebook".
...
Esporta un singolo blocco appunti denominato ContosoNotebook nell'area di lavoro ContosoWorkspace nella cartella "C:\Notebook".
...
Esporta un singolo blocco appunti denominato ContosoNotebook nell'area di lavoro ContosoWorkspace nella cartella "C:\Notebook" tramite pipeline.
...
### -CartellaOutput
Cartella in cui deve essere posizionato il blocco appunti.
