...
### Esempio 1: abilitare la crittografia dei dati dell'app conifguration Store per identità gestita assegnata dal sistema
```powershell
...
### Esempio 2: abilitare la crittografia dei dati dell'app conifguration Store per identità gestita assegnata dall'utente
```powershell
PS C:\> $key = Add-AzKeyVaultKey -VaultName kv-Name -Name key-Name -Destination 'Software'
...
### Esempio 3: disabilitare la crittografia di un archivio di app conifguration.
```powershell
...
Questo comando Disabilita la crittografia di un archivio di app conifguration.

### Esempio 3: aggiornare SKU e tag di un'app conifguration Store per pipeline.
```powershell
...
Questo comando Aggiorna SKU e tag di un'app conifguration Store per pipeline.
