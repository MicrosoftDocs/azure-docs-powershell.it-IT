...
## Sinossi
Ottiene il database MongoDB di CosmosDB
...
## Descrizione
Il cmdlet **Get-AzCosmosDBMongoDBDatabase** ottiene il database MongoDB CosmosDB.
...
Oggetto Resource contiene _rid, _ts, _etag proprietà.
