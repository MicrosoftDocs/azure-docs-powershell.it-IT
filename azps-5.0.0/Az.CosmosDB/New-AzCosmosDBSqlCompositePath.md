...
## Sinossi
Crea un nuovo oggetto di tipo PSCompositePath. Può essere passato come valore di parametro per set-AzCosmosDBSqlContainer.
...
## Descrizione
Oggetto che corrisponde al CompositePath dell'API SQL.
...
### -Ordine
Ottiene o imposta l'ordine di ordinamento per i percorsi compositi.
...
### -Path
Percorso a cui si applica il comportamento di indicizzazione.
I percorsi di indice in genere iniziano con radice e terminano con caratteri jolly (/path/*)
