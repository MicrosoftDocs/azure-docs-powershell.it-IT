...
Oggetto ConflictResolutionPolicy di tipo PSConflictResolutionPolicy, se specificato, viene impostato come ConflictResolutionPolicy del contenitore.
...
### -IndexingPolicy
Oggetto Criteri di indicizzazione di tipo Microsoft. Azure. Commands. CosmosDB. PSIndexingPolicy.
...
### -Throughput
La velocità effettiva del grafico Gremlin (RU/s).
...
### -UniqueKeyPolicy
Oggetto UniqueKeyPolicy di tipo Microsoft. Azure. Commands. CosmosDB. PSUniqueKeyPolicy.
