...
## Descrizione
Il cmdlet **Remove-AzCosmosDBSqlUserDefinedFunction** Elimina il CosmosDB SQL che corrisponde alla ResourceGroupName specificata, AccountName e DatabaseName.
...
### -InputObject
Oggetto funzione definito dall'utente SQL
...
### -Nome
Nome della funzione definita dall'utente.
