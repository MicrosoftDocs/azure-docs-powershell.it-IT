...
## Descrizione
Il cmdlet **Stop-AzCdnEndpoint** arresta l'endpoint della rete di distribuzione del contenuto di Azure (CDN).
...
### -CdnEndpoint
Specifica l'oggetto endpoint che questo cmdlet si arresta.
...
### -EndpointName
Specifica il nome dell'endpoint interrotto da questo cmdlet.
