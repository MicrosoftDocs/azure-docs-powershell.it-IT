...
## Descrizione
Remove-AzCdnOrigin eliminerà un'origine CDN dall'endpoint indicato. Se l'origine è l'unica origine all'interno dell'endpoint specificato, l'eliminazione avrà esito negativo perché è necessaria almeno 1 origine. 
...
```
Questo cmdlet rimuoverà l'origine specificata dall'endpoint specificato. 
...
### -PassThru
Restituisce l'oggetto se specificato.
...
### -ResourceId
ID risorsa dell'origine della rete CDN di Azure.
