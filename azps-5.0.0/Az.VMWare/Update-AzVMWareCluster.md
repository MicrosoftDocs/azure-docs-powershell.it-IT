...
### Esempio 1: aggiornare le dimensioni del cluster per nome
```powershell
...
Aggiornare le dimensioni del cluster per nome

### Esempio 2: aggiornare le dimensioni del cluster per l'oggetto di input
```powershell
...
Aggiornare la dimensione del cluster per oggetto di input
