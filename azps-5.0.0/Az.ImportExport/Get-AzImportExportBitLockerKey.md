...
## Sinossi
Restituisce le chiavi di BitLocker per tutte le unità nel processo specificato.
...
### Esempio 1: elencare tutte le chiavi di BitLocker nel processo di ImportExport specificato
```powershell
...
Questo cmdlet elenca tutte le chiavi di BitLocker in un processo di ImportExport specificato.
