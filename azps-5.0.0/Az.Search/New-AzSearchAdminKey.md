...
## Descrizione
Il cmdlet **New-AzSearchAdminKey** rigenera una chiave di amministratore del servizio di ricerca di Azure.
...
L'esempio rigenera la chiave primaria del servizio di ricerca di Azure.
...
### -Tipi di tipo
Tipo di chiave di amministrazione del servizio di ricerca (primario/secondario).
