...
## Descrizione
Il cmdlet **set-AzHpcCacheStorageTarget** aggiorna una destinazione di archiviazione associata alla cache di Azure HPC.
...
### -ResourceGroupName
Nome del gruppo di risorse in cui si vuole aggiornare la destinazione dello spazio di archiviazione.
