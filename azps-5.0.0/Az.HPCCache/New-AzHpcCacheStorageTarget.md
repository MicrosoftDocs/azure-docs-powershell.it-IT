...
### ClfsParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **New-AzHpcCacheStorageTarget** aggiunge una destinazione di archiviazione alla cache di Azure HPC.
...
### -CLFS
Aggiornare il tipo di destinazione di archiviazione CLFS.
...
### -Force
Indica che il cmdlet non chiede conferma. Per impostazione predefinita, questo cmdlet richiede di confermare che si vuole svuotare la cache.
...
### -NFS
Aggiornare il tipo di destinazione di archiviazione NFS.
...
### -ResourceGroupName
"Nome del gruppo di risorse in cui si vuole creare la destinazione di archiviazione per la cache specificata.
