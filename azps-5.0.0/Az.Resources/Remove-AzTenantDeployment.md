...
## Descrizione
Il cmdlet **Remove-AzTenantDeployment** rimuove una distribuzione di Azure nell'ambito del tenant corrente e in tutte le operazioni associate.
...
Questo comando rimuove la distribuzione "RolesDeployment" nell'ambito del tenant corrente.
...
Questo comando ottiene la distribuzione "RolesDeployment" nell'ambito del tenant corrente e la rimuove.
