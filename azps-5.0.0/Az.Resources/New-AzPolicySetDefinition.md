...
### Esempio 1: creare una definizione di set di criteri con i metadati tramite un file di set di criteri
```
[
   {
...
Questo comando crea una definizione di set di criteri con parametri denominata VMPolicySetDefinition che contiene le definizioni di criteri specificate in C:\VMPolicy.jsattivato. Il contenuto di esempio della VMPolicy.jsattivata è disponibile sopra.

### Esempio 3: creare una definizione di set di criteri con i gruppi di definizione dei criteri
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Questo comando crea una definizione di set di criteri denominata VMPolicySetDefinition con il raggruppamento di definizioni di criteri specificato in C:\VMPolicy.jsattivato. Il contenuto di esempio della VMPolicy.jsattivata è disponibile sopra.
...
### -GroupDefinition
Gruppi di definizione dei criteri per la nuova definizione di set di criteri. Può essere un percorso di un file contenente i gruppi o i gruppi come stringa JSON.
...
### -ManagementGroupName
Nome del gruppo di gestione della nuova definizione di set di criteri.
...
### -Metadata
Metadati per la definizione del set di criteri. Può essere un percorso per un nome di file contenente i metadati o i metadati come stringa JSON.
...
### Parametro-
Dichiarazione Parameters per la definizione del set di criteri.
Può essere un percorso di un nome file contenente la dichiarazione parameters o la dichiarazione Parameters come stringa JSON.
...
### -SubscriptionId
ID sottoscrizione della nuova definizione di set di criteri.
