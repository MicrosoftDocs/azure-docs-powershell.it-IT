...
## Descrizione
Crea una nuova applicazione di Azure Active Directory. Di seguito sono elencate le autorizzazioni necessarie per creare un'applicazione:

- Grafico di Azure Active Directory
...
### Esempio 2: creare una nuova applicazione AAD con la password.
