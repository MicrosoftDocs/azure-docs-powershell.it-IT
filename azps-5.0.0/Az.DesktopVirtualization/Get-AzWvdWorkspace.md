...
### Esempio 1: ottenere un desktop virtuale di Windows worksapce per nome
```powershell
...
Questo comando consente di ottenere un'area di lavoro desktop virtuale di Windows in un gruppo di risorse.

### Esempio 2: elencare le aree di lavoro desktop virtuali di Windows
```powershell
...
Questo comando elenca un'area di lavoro desktop virtuale di Windows in un gruppo di risorse.
