...
### Esempio 1: eliminare un desktop di Windows Virtual UserSession per nome
```powershell
...
Questo comando Elimina un UserSession desktop virtuale di Windows in un host di sessione.
...
### -Force
Imponi contrassegno per l'accesso disattivato userSession.
