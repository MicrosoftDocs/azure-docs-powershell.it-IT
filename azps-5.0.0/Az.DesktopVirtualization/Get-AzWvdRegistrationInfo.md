...
### Esempio 1: ottenere un token di registrazione desktop virtuale di Windows
```powershell
...
Questo comando consente di ottenere un token di registrazione desktop virtuale di Windows in un pool host.
