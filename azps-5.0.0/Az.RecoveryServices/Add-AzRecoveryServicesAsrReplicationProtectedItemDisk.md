...
## Descrizione
Il cmdlet **Add-AzRecoveryServicesAsrReplicationProtectedItemDisk** aggiunge il disco per la protezione per la macchina virtuale Azure già protetta.
...
Avviare l'operazione per aggiungere la configurazione del disco specificata per la protezione. Elemento protetto per la replica di input piping.

## PARAMETRI

### -AzureToAzureDiskReplicationConfiguration
Specifica la configurazione del disco usata per la protezione del disco per lo scenario di ripristino di emergenza di Azure in Azure.
...
### -InputObject
L'oggetto di input per il cmdlet: l'oggetto elemento protetto della replica ASR che corrisponde al nuovo disco che deve essere protetto.
