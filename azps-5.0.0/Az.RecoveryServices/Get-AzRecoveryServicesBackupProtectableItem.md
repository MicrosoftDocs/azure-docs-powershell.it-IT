...
## Descrizione
Il cmdlet **Get-AzRecoveryServicesBackupProtectableItem** Ottiene l'elenco degli elementi protettivi in un contenitore e lo stato di protezione degli elementi.
...
Il secondo comando consente di ottenere l'elemento protettivo di backup in $Container e quindi di archiviarlo nella variabile $Item.
