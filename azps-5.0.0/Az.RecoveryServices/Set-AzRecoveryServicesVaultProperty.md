...
Questo cmdlet restituisce le proprietà di Vault aggiornate dopo l'operazione di set corrente.
L'uso di queste proprietà cmdlet di Vault, ad esempio soft-delete, può essere abilitato in qualsiasi momento.
