...
Avvia l'operazione di creazione del piano di ripristino per Azure zone in elementi replicati zona e restituisce il processo ASR usato per tenere traccia dell'operazione.

## PARAMETRI

### -Azure
Parametro switch specifica lo scenario per il ripristino di emergenza di Azure in Azure, la creazione del piano di ripristino.
...
### -AzureZoneToZone
Parametro switch specifica la creazione dell'elemento replicato nello scenario di area di Azure.
...
### -PrimaryZone
Specifica l'area disponibilità primaria degli elementi protetti per la replica che faranno parte di questo piano di ripristino.
