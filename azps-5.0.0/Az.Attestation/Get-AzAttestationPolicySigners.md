...
## Sinossi
Ottiene i firmatari dei criteri attendibili da un tenant nell'attestazione di Azure.
...
## Descrizione
Il cmdlet Get-AzAttestationPolicySigners ottiene i firmatari dei criteri attendibili da un tenant nell'attestazione di Azure.
...
Ottiene i firmatari dei criteri attendibili per il provider di attestazioni *pshtest* nel gruppo di risorse *PSH-test-RG*.  Tieni presente che non ci sono firmatari attendibili per il provider di attestazioni.
...
Ottiene i firmatari dei criteri attendibili per il provider di attestazioni *pshtest2* nel gruppo di risorse *PSH-test-RG*.  Tieni presente che esiste un firmatario attendibile per il provider di attestazioni.
...
Ottiene i firmatari dei criteri attendibili per il provider predefinito per l'attestazione in location *Central US*.  Tieni presente che non ci sono firmatari attendibili per il provider predefinito per l'attestazione.
...
### -Nome
Specifica il nome di un provider di attestazione.
