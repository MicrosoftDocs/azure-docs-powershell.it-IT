...
### Esempio 1: elenca tutti i risultati dell'esecuzione in un modello
```powershell
...
Questo comando elenca tutti i risultati dell'esecuzione in un modello.

### Esempio 2: ottenere un risultato di esecuzione in un modello
```powershell
...
Questo comando ottiene un risultato di esecuzione in un modello.

### Esempio 3: ottenere un risultato di esecuzione in un modello
```powershell
...
### -RunOutputName
Nome dell'output di esecuzione
