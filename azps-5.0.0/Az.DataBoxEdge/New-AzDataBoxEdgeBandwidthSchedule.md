...
### BandwidthParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **New-AzDataBoxEdgeBandwidthSchedule** crea una nuova pianificazione della larghezza di banda per un dispositivo Edge della casella dati per facilitare la gestione dell'utilizzo della larghezza di banda.
...
### -UnlimitedBandwidth
Imposta la larghezza di banda illimitata, se impostato su false imposta il valore predefinito come 20 Mbps
