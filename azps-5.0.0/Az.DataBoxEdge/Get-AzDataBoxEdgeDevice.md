...
## Descrizione
Il cmdlet **Get-AzDataBoxEdgeDevice** ottiene le informazioni sui dispositivi Edge della casella dati disponibili. Puoi specificare il nome del dispositivo insieme al nome del gruppo di risorse per ottenere le informazioni su un dispositivo specifico. 
...
### -Avviso
Recuperare gli avvisi nel dispositivo Edge/Gateway della casella dati
...
### -ExtendedInfo
Ottiene informazioni aggiuntive per il dispositivo gateway della casella dati specificata Edge/Data Box
...
### -NetworkSetting
Ottiene le impostazioni di rete del dispositivo gateway della casella dati specificata Edge/Data Box
