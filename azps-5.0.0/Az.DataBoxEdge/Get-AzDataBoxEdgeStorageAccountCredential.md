...
## Descrizione
Il cmdlet **Get-AzDataBoxEdgeStorageAccountCredential** ottiene le credenziali dell'account di archiviazione per l'account di archiviazione corrispondente nel dispositivo Edge della casella dati. Puoi specificare i parametri nome, nome del gruppo di risorse e nome dispositivo per ottenere informazioni su una specifica credenziale dell'account di archiviazione.
