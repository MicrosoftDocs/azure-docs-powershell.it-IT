...
## Descrizione
Il cmdlet **Invoke-AzStackEdgeStorageContainer** richiama le azioni per aggiornare i dati in un contenitore di archiviazione in un dispositivo di bordo dello stack. 
