...
## Descrizione
Il cmdlet **set-AzStackEdgeRole** aggiorna un ruolo molto importante per un dispositivo Edge dello stack. Le vecchie condivisioni montate verranno sostituite con quelle appena fornite nel parametro ShareName.
