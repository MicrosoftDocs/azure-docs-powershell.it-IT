...
## Descrizione
Crea un nuovo processo per i dispositivi di esportazione per IotHub.
In questo modo verranno esportati tutti i dispositivi nel contenitore specificato. Vedere l'articolo seguente su come generare l'URI SAS.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## ESEMPI

### Esempio 1 emettere una richiesta di dispositivo di esportazione.
```
...
Crea una nuova richiesta di dispositivo di esportazione per il IotHub "myiothub" escluse le chiavi.
...
### -ExcludeKeys
Consente di esportare dispositivi senza tasti.
