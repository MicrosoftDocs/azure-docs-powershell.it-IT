...
## Descrizione
Valutare una metrica personalizzata o di sistema di destinazione definita in una configurazione di dispositivo molto.
Esistono metriche di sistema predefinite che vengono calcolate tramite hub molto e non possono essere personalizzate.
- "Mirato" specifica il numero di gemelli di dispositivo corrispondenti alla condizione di destinazione.
- "Applicato" specifica il numero di gemelli di dispositivo modificati dalla configurazione. 
...
Valutare la metrica del sistema "applicato".
