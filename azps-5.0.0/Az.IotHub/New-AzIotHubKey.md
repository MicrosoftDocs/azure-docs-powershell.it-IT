...
### Esempio 1 Rigenera chiave primaria
```
...
Chiave primaria rigenerata per i criteri di autorizzazione "testKey" di un hub di Azure.
...
Scambio di chiavi per i criteri di autorizzazione "testKey" di un hub di Azure molto.
