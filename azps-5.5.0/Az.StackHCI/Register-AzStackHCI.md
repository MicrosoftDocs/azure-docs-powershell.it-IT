...
## SYNOPSIS
Register-AzStackHCI crea una risorsa cloud Microsoft.AzureStackHCI che rappresenta il cluster locale e registra il cluster locale in Azure.
...
Specifica l'immagine thumbprint del certificato disponibile in tutti i nodi. L'utente è responsabile della gestione del certificato.
...
### -Area geografica
Specifica l'area geografica in cui creare la risorsa.
L'impostazione predefinita è EastUS.
...
### Risultato: Operazione riuscita o Non riuscita o PendingForAdminConsent o Annullato.
### ResourceId: ID risorsa della risorsa creata in Azure.
### PortalResourceURL: URL della risorsa del portale di Azure.
### PortalAADAppPermissionsURL: URL del portale di Azure per la pagina delle autorizzazioni per le app AAD.
## NOTE
