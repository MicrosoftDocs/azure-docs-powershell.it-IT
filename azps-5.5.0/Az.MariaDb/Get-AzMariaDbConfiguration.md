...
ms.locfileid: "100187423"
---
# <span data-ttu-id="ee463-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="ee463-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="ee463-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="ee463-102">SYNOPSIS</span></span>
<span data-ttu-id="ee463-103">Ottiene informazioni su una configurazione del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="ee463-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="ee463-104">SYNTAX</span></span>

### <span data-ttu-id="ee463-105">Elenco (impostazione predefinita)</span><span class="sxs-lookup"><span data-stu-id="ee463-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="ee463-106">Ottieni</span><span class="sxs-lookup"><span data-stu-id="ee463-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="ee463-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="ee463-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="ee463-108">DESCRIZIONE</span><span class="sxs-lookup"><span data-stu-id="ee463-108">DESCRIPTION</span></span>
<span data-ttu-id="ee463-109">Ottiene informazioni su una configurazione del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="ee463-110">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="ee463-110">EXAMPLES</span></span>

### <span data-ttu-id="ee463-111">Esempio 1: Elencare tutte le configurazioni in un database di MariaDB</span><span class="sxs-lookup"><span data-stu-id="ee463-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="ee463-112">Questo comando elenca tutte le configurazioni in un database di MariaDB.</span><span class="sxs-lookup"><span data-stu-id="ee463-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="ee463-113">Esempio 2: Ottenere una configurazione di MariaDB</span><span class="sxs-lookup"><span data-stu-id="ee463-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="ee463-114">Questo comando ottiene una configurazione di MariaDB.</span><span class="sxs-lookup"><span data-stu-id="ee463-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="ee463-115">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="ee463-115">PARAMETERS</span></span>

### <span data-ttu-id="ee463-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="ee463-116">-DefaultProfile</span></span>
<span data-ttu-id="ee463-117">Le credenziali, l'account, il tenant e la sottoscrizione usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="ee463-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="ee463-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="ee463-118">-InputObject</span></span>
<span data-ttu-id="ee463-119">Creazione di un parametro Identity To, vedere la sezione NOTES per le proprietà INPUTOBJECT e creare una tabella hash.</span><span class="sxs-lookup"><span data-stu-id="ee463-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="ee463-120">-Name</span><span class="sxs-lookup"><span data-stu-id="ee463-120">-Name</span></span>
<span data-ttu-id="ee463-121">Nome della configurazione del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="ee463-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="ee463-122">-ResourceGroupName</span></span>
<span data-ttu-id="ee463-123">Nome del gruppo di risorse che contiene la risorsa.</span><span class="sxs-lookup"><span data-stu-id="ee463-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="ee463-124">È possibile ottenere questo valore dall'API di Gestione risorse di Azure o dal portale.</span><span class="sxs-lookup"><span data-stu-id="ee463-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="ee463-125">-ServerName</span><span class="sxs-lookup"><span data-stu-id="ee463-125">-ServerName</span></span>
<span data-ttu-id="ee463-126">Nome del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-126">The name of the server.</span></span>
...
### <span data-ttu-id="ee463-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="ee463-127">-SubscriptionId</span></span>
<span data-ttu-id="ee463-128">ID sottoscrizione che identifica una sottoscrizione di Azure.</span><span class="sxs-lookup"><span data-stu-id="ee463-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="ee463-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="ee463-129">CommonParameters</span></span>
<span data-ttu-id="ee463-130">Questo cmdlet supporta i parametri comuni: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutAction, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="ee463-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="ee463-131">Per altre informazioni, [vedere](http://go.microsoft.com/fwlink/?LinkID=113216)about_CommonParameters.</span><span class="sxs-lookup"><span data-stu-id="ee463-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="ee463-132">INPUT</span><span class="sxs-lookup"><span data-stu-id="ee463-132">INPUTS</span></span>

### <span data-ttu-id="ee463-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="ee463-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="ee463-134">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="ee463-134">OUTPUTS</span></span>

### <span data-ttu-id="ee463-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span><span class="sxs-lookup"><span data-stu-id="ee463-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="ee463-136">NOTE</span><span class="sxs-lookup"><span data-stu-id="ee463-136">NOTES</span></span>

<span data-ttu-id="ee463-137">ALIAS</span><span class="sxs-lookup"><span data-stu-id="ee463-137">ALIASES</span></span>

<span data-ttu-id="ee463-138">PROPRIETÀ DEI PARAMETRI COMPLESSE</span><span class="sxs-lookup"><span data-stu-id="ee463-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="ee463-139">Per creare i parametri descritti di seguito, creare una tabella hash contenente le proprietà appropriate.</span><span class="sxs-lookup"><span data-stu-id="ee463-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="ee463-140">Per informazioni sulle tabelle hash, eseguire Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="ee463-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="ee463-141">INPUTOBJECT <IMariaDbIdentity> : parametro identity</span><span class="sxs-lookup"><span data-stu-id="ee463-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="ee463-142">`[ConfigurationName <String>]`: nome della configurazione del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="ee463-143">`[DatabaseName <String>]`: nome del database.</span><span class="sxs-lookup"><span data-stu-id="ee463-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="ee463-144">`[FirewallRuleName <String>]`: nome della regola del firewall del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="ee463-145">`[Id <String>]`: percorso di identità della risorsa</span><span class="sxs-lookup"><span data-stu-id="ee463-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="ee463-146">`[LocationName <String>]`: nome della posizione.</span><span class="sxs-lookup"><span data-stu-id="ee463-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="ee463-147">`[ResourceGroupName <String>]`: nome del gruppo di risorse che contiene la risorsa.</span><span class="sxs-lookup"><span data-stu-id="ee463-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="ee463-148">È possibile ottenere questo valore dall'API di Gestione risorse di Azure o dal portale.</span><span class="sxs-lookup"><span data-stu-id="ee463-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="ee463-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: nome del criterio di avviso di sicurezza.</span><span class="sxs-lookup"><span data-stu-id="ee463-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="ee463-150">`[ServerName <String>]`: nome del server.</span><span class="sxs-lookup"><span data-stu-id="ee463-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="ee463-151">`[SubscriptionId <String>]`: ID sottoscrizione che identifica una sottoscrizione di Azure.</span><span class="sxs-lookup"><span data-stu-id="ee463-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="ee463-152">`[VirtualNetworkRuleName <String>]`: nome della regola di rete virtuale.</span><span class="sxs-lookup"><span data-stu-id="ee463-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="ee463-153">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="ee463-153">RELATED LINKS</span></span>
