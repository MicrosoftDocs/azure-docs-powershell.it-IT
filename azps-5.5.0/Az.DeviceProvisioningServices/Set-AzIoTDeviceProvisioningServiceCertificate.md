...
## DESCRIZIONE
Verificare un certificato caricando un certificato di verifica contenente il codice di verifica ottenuto chiamando generate-verification-code. Questo è l'ultimo passaggio della prova del processo di approvazione.
Per una spiegazione dettagliata dei certificati CA nel servizio di provisioning dei dispositivi Hub IoT di Azure, vedi https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates
...
Verificare la proprietà della chiave privata "mycertificate".
...
Verificare la proprietà della chiave privata "mycertificate" usando la pipeline.
