...
Mostra i dettagli su "mycertificate" in un servizio di provisioning di dispositivi Hub IoT di Azure.
...
Elencare tutti i certificati in "myiotdps" usando la pipeline.
