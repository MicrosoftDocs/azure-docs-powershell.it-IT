...
## DESCRIZIONE
Carica un nuovo certificato o per sostituire quello esistente con lo stesso nome.
Per una spiegazione dettagliata dei certificati CA nel servizio di provisioning dei dispositivi hub IoT di Azure, vedere https://docs.microsoft.com/en-us/azure/iot-dps/how-to-verify-certificates .
...
Caricare un file CER del certificato CA in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Aggiorna un certificato CA in un servizio di provisioning dei dispositivi hub IoT caricando un nuovo file CER. 
