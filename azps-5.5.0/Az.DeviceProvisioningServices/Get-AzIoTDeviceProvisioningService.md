...
Elencare tutti i servizi di provisioning dei dispositivi Hub Azure IoT in una sottoscrizione.
...
Elencare tutti i servizi di provisioning dei dispositivi Hub Azure IoT nel gruppo di risorse 'myresourcegroup'.
...
Mostra i dettagli di un servizio di provisioning dei dispositivi Hub IoT di Azure 'myiotdps'.
