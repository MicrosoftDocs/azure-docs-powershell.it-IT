...
Hub IoT collegato a un servizio di provisioning dei dispositivi Hub IoT di Azure con AllocationWeight e ApplyAllocationPolicy.

## PARAMETERS

### -AllocationWeight
Peso dell'allocazione dell'Hub IoT
...
### -ApplyAllocationPolicy
Booleano che indica se applicare il criterio di assegnazione all'Hub IoT
...
Stringa di connessione della risorsa Hub Iot.
