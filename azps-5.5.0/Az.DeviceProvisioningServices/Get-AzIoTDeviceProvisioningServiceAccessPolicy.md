...
Elencare tutti i criteri di accesso condiviso in "myiotdps".
...
Mostra i dettagli del criterio di accesso condiviso "mypolicy" in un servizio di provisioning dei dispositivi Hub IoT di Azure.
