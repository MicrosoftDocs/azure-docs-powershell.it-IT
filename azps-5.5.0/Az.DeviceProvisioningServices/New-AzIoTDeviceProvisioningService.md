...
Creare un servizio di provisioning di dispositivi Hub Azure IoT con il livello di prezzi standard S1 e tag, nell'area del gruppo di risorse.
...
Crea un servizio di provisioning dei dispositivi Hub Azure IoT con il livello di prezzi standard S1, nell'area "estus".
...
### -Tag
Tag di istanza del servizio di provisioning dei dispositivi IoT. Il bag delle proprietà in coppie chiave-valore sotto forma di tabella hash.
