...
## DESCRIZIONE
Ottenere i dettagli di registrazione del dispositivo o elencare le registrazioni dei dispositivi in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Ottenere i dettagli di registrazione del dispositivo in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Elencare le registrazioni dei dispositivi in un servizio di provisioning dei dispositivi Hub IoT di Azure.
