...
Aggiungere un nuovo criterio di accesso condiviso in un servizio di provisioning del dispositivo Hub IoT di Azure con diritti EnrollmentWrite e ServiceConfig.
...
Aggiungere un nuovo criterio di accesso condiviso in un servizio di provisioning di dispositivi Hub IoT di Azure con il diritto EnrollmentRead.
...
### -Autorizzazioni
Autorizzazioni dei criteri di accesso al servizio di provisioning dei dispositivi IoT
