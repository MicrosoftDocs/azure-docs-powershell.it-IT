...
Eliminare un servizio di provisioning dei dispositivi Hub IoT di Azure 'myiotdps'.
...
Eliminare un servizio di provisioning dei dispositivi Hub IoT di Azure 'myiotdps' usando una pipeline.
