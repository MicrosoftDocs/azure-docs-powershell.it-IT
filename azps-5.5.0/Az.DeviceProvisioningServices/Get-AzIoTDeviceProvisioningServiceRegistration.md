...
## DESCRIZIONE
Ottenere lo stato di registrazione del dispositivo o lo stato di registrazione dei dispositivi nel gruppo di registrazione in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Ottenere i dettagli dello stato di registrazione del dispositivo in un servizio di provisioning dei dispositivi hub IoT di Azure.
...
Elencare tutti gli stati di registrazione dei dispositivi in questo gruppo di registrazione.
