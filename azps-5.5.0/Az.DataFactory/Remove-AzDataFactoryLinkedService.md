...
## DESCRIZIONE
Il cmdlet **Remove-AzDataFactoryLinkedService** rimuove un servizio collegato da Data factory di Azure.
...
Questo comando rimuove il servizio collegato denominato LinkedServiceTest dal data factory denominato WikiADF.
...
Questo cmdlet rimuove un servizio collegato dal data factory specificato da questo parametro.
...
### -Force
Indica che questo cmdlet rimuove un servizio collegato senza chiedere conferma.
...
Questo cmdlet rimuove un servizio collegato dal gruppo specificato da questo parametro.
