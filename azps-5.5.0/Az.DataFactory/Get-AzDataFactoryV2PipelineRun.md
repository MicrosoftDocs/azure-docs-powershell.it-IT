...
## DESCRIZIONE
Il **comando Get-AzDataFactoryV2PipelineRun** restituisce informazioni sulle esecuzioni per la pipeline specificata. Se si specifica PipelineRunId, vengono visualizzati i dettagli per l'esecuzione con tale ID. Se pipelineRunId non è specificato, visualizza informazioni su tutte le esecuzioni per le pipeline che si sono verificate tra i valori di LastUpdatedAfter e LastUpdatedBefore.

## ESEMPI

### Esempio 1: Ottenere informazioni per l'esecuzione di una pipeline
```
...
Questo comando recupera i dettagli sull'esecuzione della pipeline con ID "61eb095a-fe23-4591-8a97-fade6c65ca72".
...
### -LastUpdatedAfter
L'ora in cui o dopo l'esecuzione della pipeline è stata aggiornata nel formato ISO8601.
...
### -LastUpdatedBefore
L'ora in cui o prima dell'esecuzione della pipeline è stata aggiornata in formato ISO8601.
