...
L'elenco delle finestre delle attività è filtrato in base alla stringa di ricerca specificata da questo parametro.
...
### -OrderBy
Specifica di ordinare la risposta in base a uno dei parametri dell'elenco della finestra attività.
...
- Annullato
- timedOut
- La convalida di questo cmdlet recupera finestre di attività nella sottostate specificata da questo parametro.
