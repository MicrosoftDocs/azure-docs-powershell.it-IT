...
## DESCRIZIONE
Il cmdlet **Remove-AzDataFactory** rimuove un data factory.

## ESEMPI

### Esempio 1: Rimuovere un data factory
```
...
Questo comando rimuove il data factory denominato WikiADF dal gruppo di risorse denominato ADF.
Questo comando restituisce il valore $True.

## PARAMETERS

### -DataFactory
Specifica **l'oggetto PSDataFactory** da rimuovere.
...
### -Force
Indica che questo cmdlet rimuove un data factory senza richiedere conferma.
...
### -Name
Specifica il nome del data factory da rimuovere.
...
Questo cmdlet rimuove un data factory dal gruppo specificato da questo parametro.
