...
## DESCRIZIONE
Questo comando esegue l'anteprima dei dati, l'anteprima delle statistiche o l'anteprima dell'espressione per diversi flussi di dati nella sessione di debug.
La sequenza di comandi di PowerShell per il flusso di lavoro di debug del flusso di dati deve essere:
...
Questo esempio richiama il comando anteprima dati per la sessione di debug "fd76cd0d-8b37-4dc0-a370-3f9d43ac686d" nel data factory "WiKiADF" e quindi converte l'output JSON in una stringa leggibile.
...
### -Command
Comando di debug del flusso di dati. Gli elementi facoltativi sono executePreviewQuery, executeStatisticsQuery e executeExpressionQuery
...
### -StreamName
Il nome del flusso di dati per il debug.
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSDataFlowSessionCommandResult

## NOTE
Parole chiave: azure, azurerm, arm, resource, management, manager, data, factoriesKeywords: azure, azurerm, arm, resource, management, manager, data, factories
