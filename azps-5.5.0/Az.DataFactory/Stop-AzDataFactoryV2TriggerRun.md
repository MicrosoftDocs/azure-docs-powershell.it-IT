...
## SYNOPSIS
Interrompe l'esecuzione di un trigger in un data factory.
...
## DESCRIZIONE
Il cmdlet **Stop-AzDataFactoryV2TriggerRun** interrompe l'esecuzione di un trigger in un data factory specificato con il nome del trigger e l'ID di esecuzione del trigger.
Attualmente supportato solo per TumblingWindowTriggers in WaitingOnUsingy State.
...
Questo comando interrompe l'esecuzione del trigger con ID '0858600246800588497807248799CU16' nel produttore WikiADF.
...
### -InputObject
Informazioni sul trigger eseguito.
...
### -PassThru
Se è stato specificato il cmdlet write true nel caso l'operazione riesce.
