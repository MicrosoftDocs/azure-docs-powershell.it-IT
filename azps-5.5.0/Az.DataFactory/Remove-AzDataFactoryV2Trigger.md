...
## DESCRIZIONE
Il cmdlet **Remove-AzDataFactoryV2Trigger** rimuove un trigger da un data factory. Se si _specifica il_ parametro Force, il cmdlet non richiede conferma prima di rimuovere il trigger.
...
Rimuovere un trigger denominato "ScheduledTrigger" dal data factory "WikiADF".
