...
## DESCRIZIONE
Il cmdlet **New-AzDataFactoryGateway** crea un gateway nel Data factory di Azure.

## ESEMPI

### Esempio 1: Creare un gateway
```
...
Questo comando crea un gateway denominato ContosoGateway nel data factory denominato WikiADF nel gruppo di risorse denominato ADF.

## PARAMETERS

### -DataFactory
Specifica un **oggetto PSDataFactory.**
Questo cmdlet crea un gateway per il data factory specificato da questo parametro.
...
### -Name
Specifica il nome del gateway da creare.
...
Questo cmdlet crea un gateway che appartiene al gruppo specificato da questo parametro.
