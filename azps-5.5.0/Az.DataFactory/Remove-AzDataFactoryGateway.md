...
## DESCRIZIONE
Il cmdlet **Remove-AzDataFactoryGateway** rimuove il gateway specificato da Data factory di Azure.
...
Questo comando rimuove il gateway denominato ContosoGateway dal data factory denominato WikiADF.

## PARAMETERS

### -DataFactory
Specifica un **oggetto PSDataFactory.**
Questo cmdlet rimuove un gateway dal data factory specificato da questo parametro.
...
### -Force
Indica che questo cmdlet rimuove un gateway senza chiedere conferma.
...
Questo cmdlet rimuove un gateway che appartiene al gruppo specificato da questo parametro.
