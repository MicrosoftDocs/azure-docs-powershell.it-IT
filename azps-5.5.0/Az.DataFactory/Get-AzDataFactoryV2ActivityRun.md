...
## DESCRIZIONE
Il cmdlet **Get-AzDataActivityV2ActivityRun** ottiene informazioni sull'esecuzione in Data factory di Azure per l'esecuzione della pipeline specificata nell'intervallo di tempo specificato. Inoltre, è possibile specificare i filtri per il nome dell'attività, il nome del servizio collegato che ha eseguito l'esecuzione e lo stato dell'esecuzione.

## ESEMPI

### Esempio 1: Ottenere tutte le attività eseguite per un'esecuzione di una pipeline
```
...
Questo comando ottiene dettagli su tutte le attività eseguite nella pipeline con ID "f288712d-fb08-4cb8-96ef-82d3b9b30621" che si è verificato tra "2017-09-01" e "2017-09-30".
...
### -RunStartedAfter
Il tempo in corrispondenza o dopo il quale è iniziata l'esecuzione della pipeline.
...
### -RunStartedBefore
Il tempo in corrispondenza o prima del quale è iniziata l'esecuzione della pipeline.
