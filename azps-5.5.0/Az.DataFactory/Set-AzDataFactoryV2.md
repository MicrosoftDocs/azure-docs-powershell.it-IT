...
## DESCRIZIONE
Il cmdlet **Set-AzDataFactoryV2** crea un data factory con il nome e il percorso del gruppo di risorse specificati.
...
### Esempio 3: Creare una data factory con i dettagli di configurazione del repo in GitHub usando un nuovo oggetto factory.
```
...
### -AccountName
Nome account per la configurazione di repo.
...
### -RootFolder
La cartella radice per la configurazione dei repo.
