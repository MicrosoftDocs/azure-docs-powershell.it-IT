...
## DESCRIZIONE
Il cmdlet **Stop-AzDataFactoryV2IntegrationRuntime** interrompe un runtime di integrazione dedicato gestito nello stato "Avviato", che è stato avviato dal cmdlet Start-AzDataFactoryV2IntegrationRuntime> Le risorse vengono rilasciate e lo stato viene trasferimento a "Arrestato".

## ESEMPI

### Esempio 1: Arrestare un runtime di integrazione gestita che è in stato "Avviato".
```
