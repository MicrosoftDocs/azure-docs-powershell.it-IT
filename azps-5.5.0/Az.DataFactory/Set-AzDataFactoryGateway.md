...
## DESCRIZIONE
Il cmdlet **Set-AzDataFactoryGateway** imposta la descrizione per il gateway specificato in Data factory di Azure.
...
Questo comando imposta la descrizione del gateway denominato ContosoGateway nel data factory denominato WikiADF.
Il parametro Description consente di specificare la nuova descrizione.

## PARAMETERS

### -DataFactory
Specifica un **oggetto PSDataFactory.**
Questo cmdlet imposta la descrizione del gateway nel data factory specificato da questo parametro.
