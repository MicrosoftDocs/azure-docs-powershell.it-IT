...
## DESCRIZIONE
Il **comando Get-AzDataFactoryV2TriggerRun** restituisce informazioni dettagliate sull'esecuzione del trigger per il trigger specificato nell'intervallo di tempo specificato.
...
Questo comando mostra informazioni sulle esecuzioni di "WikiTrigger" nella fabbrica "WikiADF" iniziata tra "2017-09-01" e "2019-09-30".
...
Ora in cui o dopo l'esecuzione del trigger è iniziata l'esecuzione in formato ISO8601.
...
Ora in cui l'esecuzione del trigger è iniziata o è iniziata nel formato ISO8601.
