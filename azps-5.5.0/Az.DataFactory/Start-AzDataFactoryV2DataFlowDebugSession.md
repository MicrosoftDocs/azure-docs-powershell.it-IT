...
## DESCRIZIONE
Questo comando a esecuzione lunga avvia una sessione di debug del flusso di dati per i futuri comandi di debug. Questo comando può essere associato a una definizione di runtime di integrazione per configurare le dimensioni/tipo del cluster di sessione di debug.
...
### Microsoft.Azure.Commands.DataFactoryV2.Models.PSDataFlowSession
