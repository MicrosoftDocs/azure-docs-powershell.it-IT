...
## DESCRIZIONE
Il cmdlet **Remove-AzDataLakeStoreTrustedIdProvider** rimuove il provider di identità attendibile specificato nel Data Lake Store specificato.

## ESEMPI

### Esempio 1: Rimuovere un provider di identità attendibile.
```
PS C:\> Remove-AzDataLakeStoreTrustedIdProvider -AccountName "ContosoADL" -Name MyProvider
```

Rimuove il provider "MyProvider" dall'account "ContosoADL"

## PARAMETERS

### -Account
Account Data Lake Store da cui rimuovere il provider di identità attendibile
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene l'account da cui rimuovere il provider di identità attendibile.
