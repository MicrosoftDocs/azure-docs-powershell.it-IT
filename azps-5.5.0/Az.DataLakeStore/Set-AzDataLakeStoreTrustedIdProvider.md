...
## DESCRIZIONE
Il cmdlet **Set-AzDataLakeStoreTrustedIdProvider** modifica il provider di identità attendibile specificato nel data lake store specificato.
...
L'endpoint del provider per la regola del firewall "MyProvider" nell'account "ContosoADL" viene aggiornato a " https://sts.windows.net/6b04908c-b91f-40ce-8024-7ee8a4fd6150 "
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene l'account di cui aggiornare il provider di identità attendibile.
