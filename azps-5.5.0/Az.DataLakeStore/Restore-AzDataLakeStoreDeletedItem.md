...
## SYNOPSIS
Ripristinare una cartella o un file eliminato in Azure Data Lake.
...
## DESCRIZIONE
Il cmdlet **Restore-AzDataLakeStoreDeletedItem** ripristina un file o una cartella eliminata in Data Lake Store. Richiede il percorso dell'elemento eliminato nel Cestino restituito da Get-AzDataLakeStoreDeletedItem.
...
### Esempio 1: Ripristinare un file da Data Lake Store usando l'opzione -force
```
...
### -DeletedItem
Oggetto dell'elemento eliminato.
...
### -Destination
Il percorso di destinazione in cui deve essere ripristinata la cartella o il file eliminato. 
...
### -PassThru
Restituisce booleano true in caso di esito positivo.
...
### -Path
Il percorso del file o della cartella eliminata nel Cestino.
...
### -RestoreAction
Azione da eseguire sui conflitti di nomi di destinazione: "copia" o "sovrascrivere"
