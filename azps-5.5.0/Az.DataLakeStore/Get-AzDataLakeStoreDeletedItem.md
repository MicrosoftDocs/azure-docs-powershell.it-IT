...
## DESCRIZIONE
Il **cmdlet Get-AzDataLakeStoreDeletedItem** cerca nei file o nelle cartelle eliminate in Data Lake Store che corrispondono al filtro specificato.
...
### -Count
Specifica il numero di risultati che l'utente vuole trovare. La query viene eseguita finché non vengono trovati i risultati di Count o la ricerca viene eseguita nell'intero Cestino, a seconda dell'evento che si verifica per primo.
