...
Qui stiamo usando l'estensione passata tramite la pipeline per aiutare Microsoft a identificare l'estensione su cui si vuole operare e a specificare cosa si vuole modificare con i parametri normali (ad esempio `-Settings` )
