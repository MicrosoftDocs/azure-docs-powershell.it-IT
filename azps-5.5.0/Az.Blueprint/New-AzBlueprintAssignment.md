...
## DESCRIZIONE
Assegnare una definizione di progetto a una sottoscrizione.
...
Creare una nuova assegnazione della progetto della definizione del progetto all'interno della sottoscrizione specificata usando il parametro definito e `$blueprintObject` il dizionario del gruppo di risorse. Usa le identità assegnate dal sistema. La posizione definisce l'area geografica per la creazione dell'identità gestita.
...
Creare una nuova assegnazione della progetto della definizione del progetto all'interno della sottoscrizione specificata usando il dizionario del parametro definito e del gruppo di risorse e configurando il blocco delle risorse su `$blueprintObject` **AllResources.** Per impostazione predefinita, viene utilizzato l'uso delle identità assegnate dal sistema.  La posizione definisce l'area geografica per la creazione dell'identità gestita.
...
Creare una nuova assegnazione della progetto della definizione di progetto all'interno della sottoscrizione specificata usando il parametro definito e il dizionario del gruppo di risorse usando l'ID di identità `$blueprintObject` assegnato dall'utente specificato.
...
Creare una nuova assegnazione della progetto della definizione di progetto mirata alla sottoscrizione specificata all'interno del gruppo di `$blueprintObject` gestione specificato usando il parametro definito.
...
### -SubscriptionId
ID sottoscrizione per assegnare la definizione del progetto.
