...
## DESCRIZIONE
Pubblicare una nuova versione di una definizione di progetto.
...
### -ChangeNote
Note per descrivere il contenuto di questa versione del progetto.
...
### -Version
Versione per la definizione del progetto.
