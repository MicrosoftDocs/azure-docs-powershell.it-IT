...
## SYNOPSIS
Creare un oggetto in memoria per ReplicaSet
...
### Esempio 1: Creare ReplicaSet per AdDomain
```powershell
...
### -SubnetId
Nome della rete virtuale in cui verrà distribuito Servizi di dominio.
ID della subnet in cui verranno distribuiti i Servizi di dominio.
