...
### Esempio 2: Creare un'operazione di gestione delle API con i dettagli su richieste e risposte
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Questo esempio crea un'operazione di gestione DELLE API con i dettagli su richiesta e risposta.
...
### -ApiRevision
Identificatore della revisione API. Questo parametro è facoltativo. Se non viene specificato, l'operazione verrà collegata alla revisione dell'api attualmente attiva.
...
### -TemplateParameters
Specifica una matrice di parametri definiti nel parametro *UrlTemplate.*
Se non si specifica questo parametro, verrà generato un valore predefinito basato su *UrlTemplate.*
