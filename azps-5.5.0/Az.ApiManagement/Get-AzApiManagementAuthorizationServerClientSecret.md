...
### Esempio 1: Ottenere un segreto client del server di autorizzazione specificato in base all'ID
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementAuthorizationServerClientSecret -Context $ApiMgmtContext -ServerId "0123456789"
```

Questo comando recupera il server di autorizzazione specificato.
...
### -ResourceId
Arm Resource Identifier del server di autorizzazione.
Se specificato, tenterà di trovare il server di autorizzazione in base all'identificatore.
Questo parametro è obbligatorio.
...
Se specificato, troverà il server di autorizzazione in base all'identificatore.
