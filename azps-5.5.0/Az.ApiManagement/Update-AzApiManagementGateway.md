...
### -PassThru
Se si specifica l'istanza di Microsoft.Azure.Commands.ApiManagement.ServiceManagement.Models.PsApiManagementGateway che rappresenta il gateway modificato.
