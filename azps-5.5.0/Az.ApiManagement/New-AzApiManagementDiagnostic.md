...
## SYNOPSIS
Crea una nuova diagnostica nell'ambito globale o nell'ambito API.
...
## DESCRIZIONE
Il cmdlet **New-AzApiManagementDiagnostic** crea un'entità di diagnostica in ambito globale o in ambito API specifico.

## ESEMPI

### Esempio 1: Creare un nuovo ambito globale - Diagnostica
```powershell
...
### Esempio 2: Creare una diagnostica con ambito Api
```powershell
PS D:\github\azure-powershell> $context = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
L'esempio precedente crea una diagnostica per l'API per registrare l'intestazione e `httpbin` 100 byte del corpo `azuremonitor` in logger.
...
Se specificato, verrà impostato il criterio di ambito API.
