...
## SYNOPSIS
Rimuove il criterio di gestione delle API da un ambito specificato.
...
Se si specifica questo parametro con il *parametro ApiId,* questo cmdlet rimuove il criterio di ambito dell'operazione.
