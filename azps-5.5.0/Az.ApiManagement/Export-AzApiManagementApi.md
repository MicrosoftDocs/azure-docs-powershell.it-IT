...
## DESCRIZIONE
Il cmdlet **Export-AzApiManagementApi** esporta un'API di Gestione API Azure in un file in uno dei formati supportati.
...
Questo comando esporta un'API in formato Open Api come documento Json
