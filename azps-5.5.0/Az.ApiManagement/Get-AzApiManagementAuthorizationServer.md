...
## DESCRIZIONE
Il cmdlet **Get-AzApiManagementAuthorizationServer** ottiene tutti i server di autorizzazione gestione API di Azure o un server di autorizzazione specificato.
