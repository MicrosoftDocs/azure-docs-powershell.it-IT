...
### -Force
Specifica che questo cmdlet esegue il commit del database di configurazione corrente nel repository Git, anche se il repository Git contiene modifiche più recenti che vengono sovrascritte.
