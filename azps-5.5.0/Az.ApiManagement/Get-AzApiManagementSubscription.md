...
## DESCRIZIONE
Il cmdlet **Get-AzApiManagementSubscription** ottiene una sottoscrizione specificata o tutte le sottoscrizioni, se non è specificato alcun abbonamento.
Le chiavi non verranno incluse nei dettagli dei risultati. Per ottenere le chiavi, usare **Get-AzApiManagementSubscriptionKey.**

## ESEMPI

### Esempio 1: Ottenere tutti gli abbonamenti
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
PS C:\>Get-AzApiManagementSubscription -Context $apimContext
```

Questo comando recupera tutti gli abbonamenti.
...
Questo comando ottiene un abbonamento in base all'ID.

### Esempio 3: Ottenere tutte le sottoscrizioni per un utente
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
PS C:\>Get-AzApiManagementSubscription -Context $apimContext -UserId "777"
```

Questo comando recupera le sottoscrizioni di un utente.
...
Questo comando recupera tutte le sottoscrizioni per il prodotto.

### Esempio 5: Ottenere tutte le sottoscrizioni per un ambito
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
Questo comando recupera tutte le sottoscrizioni configurate per l'ambito api globale

### Esempio 6: Ottenere tutte le sottoscrizioni per un prodotto e un ambito utente
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
...
Se specificato, questo cmdlet trova tutte le sottoscrizioni in base all'identificatore prodotto.
...
### -Scope
Identificatore di ambito. Ambito della sottoscrizione, che si tratta di Ambito API /api/{apiId} o Ambito prodotto /products/{productId} o Ambito API globale /api o Ambito globale /.
...
Se specificato, questo cmdlet trova tutte le sottoscrizioni in base all'identificatore utente.
