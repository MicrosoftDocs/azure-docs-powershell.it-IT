...
### GetByGatewayId (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Get-AzApiManagementGatewayHostnameConfiguration** ottiene tutta la configurazione del nome host o specifica per il gateway esistente.

## ESEMPI

### Esempio 1: Ottenere tutte le configurazioni dei nomi host per il gateway
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGatewayHostnameConfiguration -Context $apimContext  -GatewayId "0123456789"
```

Questo comando recupera tutte le configurazioni dei nomi host per un gateway "0123456789".

### Esempio 2: Ottenere una configurazione del nome host per il gateway
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
Questo comando ottiene la configurazione del nome host "123" per un gateway "0123456789".
...
Identificatore di configurazione del nome host.
