...
Il cmdlet **Remove-AzAzureRmApiManagementApiRelease** rimuove una versione DI API esistente.
...
Questo comando rimuove la versione di API con i valori ApiId e ReleaseId specificati.
