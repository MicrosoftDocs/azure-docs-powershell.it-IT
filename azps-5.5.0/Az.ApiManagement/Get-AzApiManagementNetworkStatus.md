...
## SYNOPSIS
Ottiene lo stato di connettività alle risorse esterne da cui dipende il servizio di gestione delle API all'interno del servizio cloud. Restituisce anche i server DNS come visibili a CloudService.
