...
## DESCRIZIONE
Il cmdlet **New-AzApiManagementUser** registra un nuovo utente.
...
Questo parametro deve contenere da 1 a 100 caratteri.
...
### -Nota
Specifica una nota sull'utente.
...
Questo parametro è facoltativo.
Se questo parametro non è specificato, questo cmdlet genera un ID utente.
