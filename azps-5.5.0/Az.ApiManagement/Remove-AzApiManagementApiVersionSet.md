...
Questo comando rimuove il set di versioni dell'API con il valore ApiVersionSetId specificato.
...
### -ResourceId
Arm ResourceId di ApiVersionSet. Questo parametro è obbligatorio.
