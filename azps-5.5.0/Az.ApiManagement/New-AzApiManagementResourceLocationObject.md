...
## DESCRIZIONE
Il cmdlet **New-AzApiManagementResourceLocationObject** crea un nuovo contratto per la posizione delle risorse (usato nei gateway).

## ESEMPI

### Esempio 1: Creare un contratto per la posizione di una risorsa
```powershell
PS C:\>$location = New-AzApiManagementResourceLocationObject -Name "n1" -City "c1" -District "d1" -CountryOrRegion "r1"
```

Questo comando crea una posizione della risorsa.

## PARAMETERS

### -Città
Città della località.
...
### -CountryOrRegion
Paese o area geografica della posizione.
Questo parametro è facoltativo.
