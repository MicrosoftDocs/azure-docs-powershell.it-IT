...
Crea un servizio ApiManagement di External VpnType nell'area degli Stati Uniti occidentali, con un'area geografica aggiuntiva negli Stati Uniti centrali.

## PARAMETERS

### -Capacità
Capacità di SKU dell'area geografica aggiuntiva del servizio di gestione DELLE API di Azure.
...
### -VirtualNetwork
Configurazione di rete virtuale dell'area di distribuzione gestione API di Azure.
