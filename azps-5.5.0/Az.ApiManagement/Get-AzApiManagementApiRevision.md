...
Questo comando recupera tutta la revisione dell'API specificata per un particolare contesto ApiManagement.

## PARAMETERS

### -ApiId
Identificatore API di cui elencare le revisioni.
