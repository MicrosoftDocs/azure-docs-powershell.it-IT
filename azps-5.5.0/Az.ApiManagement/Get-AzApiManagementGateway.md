...
## DESCRIZIONE
Il **cmdlet Get-AzApiManagementGateway** ottiene un Gateway di gestione API specifico o uno specifico.
...
Questo comando recupera tutti i gateway.
...
Questo comando recupera il gateway 0123456789.
...
Se specificato, tenterà di trovare il gateway in base all'identificatore.
