...
## DESCRIZIONE
Il cmdlet **Set-AzApiManagementUser** imposta i dettagli dell'utente.

## ESEMPI

### Esempio 1: Cambiare la password, l'indirizzo di posta elettronica e lo stato di un utente
```powershell
...
Questo comando imposta una nuova password utente e un nuovo indirizzo di posta elettronica e blocca l'utente.
