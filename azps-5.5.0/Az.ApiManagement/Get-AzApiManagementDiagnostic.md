...
Questo comando recupera tutte le funzionalità di diagnostica configurate nel servizio di gestione api.
...
Questo comando recupera la `applicationinsights` diagnostica configurata nell'api. `echo-api`
