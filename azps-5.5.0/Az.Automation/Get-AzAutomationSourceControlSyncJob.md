...
### Esempio 1
Questo comando recupera tutti i processi di sincronizzazione del controllo origine di automazione per il controllo di origine VSTSNative.
...
### Esempio 2
Questo comando recupera il processo di sincronizzazione del controllo del codice sorgente con ID 08d6d266-27b6-463c-beea-bc48a67ace15 per il controllo di origine VSTSNative. 
...
Recupera i processi di sincronizzazione del controllo origine di Azure Automation. (autogenerated)
...
### -SourceControlName
Nome del controllo dell'origine del processo.
