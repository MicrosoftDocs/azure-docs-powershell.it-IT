...
## DESCRIZIONE
Il cmdlet **Export-AzAutomationDscConfiguration** esporta una configurazione DSC (Desired State Configuration) APS dall'automazione di Azure in un file locale.
Il file esportato ha estensione ps1.
...
Questo comando esporta la versione pubblicata di una configurazione DSC nell'automazione nella cartella specificata, ovvero il desktop.

## PARAMETERS

### -AutomationAccountName
Specifica il nome dell'account di automazione che contiene il DSC esportato dal cmdlet.
...
### -Name
Specifica il nome della configurazione DSC esportato dal cmdlet.
...
### -OutputFolder
Specifica la cartella di output in cui il cmdlet esporta la configurazione DSC.
...
### -Slot
Specifica la versione della configurazione DSC esportata dal cmdlet.
I valori validi sono: 
- Bozza
- Pubblicato Il valore predefinito è Pubblicato.
