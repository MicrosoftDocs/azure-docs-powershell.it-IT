...
## DESCRIZIONE
Il cmdlet **Get-AzAutomationDscNodeConfigurationDeployment** distribuisce una configurazione del nodo APS Desired State Configuration (DSC) nell'automazione di Azure.

## ESEMPI

### Esempio 1: Ottenere tutte le pianificazioni della distribuzione
```
...
### Esempio 2: Ottenere una pianificazione della distribuzione
```
...
### -JobScheduleId
Specifica l'ID pianificazione processo di un processo di distribuzione pianificato esistente.
