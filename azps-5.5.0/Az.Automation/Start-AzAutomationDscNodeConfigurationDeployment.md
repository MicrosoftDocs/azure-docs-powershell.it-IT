...
### Esempio 1: Distribuire una configurazione del nodo DSC di Azure in Automazione
```
...
### Esempio 2: Pianificare la distribuzione di una configurazione nodo DSC di Azure in Automazione
```
