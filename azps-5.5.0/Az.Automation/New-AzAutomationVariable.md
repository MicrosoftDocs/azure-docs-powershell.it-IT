...
## DESCRIZIONE
Il cmdlet **New-AzAutomationVariable** crea una variabile nell'automazione di Azure.
...
Il primo comando ottiene una macchina virtuale usando il cmdlet Get-AzVM.
Il comando lo archivia nella $VirtualMachine variabile.
