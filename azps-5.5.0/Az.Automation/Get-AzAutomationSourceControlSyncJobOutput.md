...
## DESCRIZIONE
Il cmdlet **Get-AzAutomationSourceControlSyncJobOutput** ottiene l'output per un processo di sincronizzazione del controllo origine di Automazione di Azure.

## ESEMPI

### Esempio 1
Questo comando ottiene l'output del processo di sincronizzazione del controllo del codice sorgente con ID 08d6d266-27b6-463c-beea-bc48a67ace15 per il controllo di origine VSTSNative. 
...
### -Stream
Tipo di flusso.
L'impostazione predefinita è Any.
