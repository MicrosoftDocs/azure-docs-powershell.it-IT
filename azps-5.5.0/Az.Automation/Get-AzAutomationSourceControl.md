...
## DESCRIZIONE
Il cmdlet Get-AzAutomationSourceControl ottiene i controlli origine di automazione.
Per ottenere un controllo del codice sorgente specifico, specificarne il nome.

## ESEMPI

### Esempio 1
Questo comando recupera un controllo origine di automazione denominato VSTSNative nell'account denominato devAccount.
