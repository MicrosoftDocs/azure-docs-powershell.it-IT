...
---
# Modulo di automazione di Az
## Descrizione
Questo argomento visualizza gli argomenti della Guida per i cmdlet di automazione di Azure.

## Cmdlet di Az.Automation
...
Esporta il contenuto non elaborati di un report DSC inviato da un nodo DSC all'automazione.

### [Export-AzAutomationRunbook](Export-AzAutomationRunbook.md)
Esporta un runbook di automazione.

### [Get-AzAutomationAccount](Get-AzAutomationAccount.md)
Recupera gli account di automazione in un gruppo di risorse.

### [Get-AzAutomationCertificate](Get-AzAutomationCertificate.md)
Ottiene certificati di automazione.
...
Recupera i processi di compilazione DSC nell'automazione.
...
Recupera le configurazioni DSC dall'automazione.
...
Recupera le distribuzioni di configurazione del nodo DSC nell'automazione.

### [Get-AzAutomationDscNodeConfigurationDeploymentSchedule](Get-AzAutomationDscNodeConfigurationDeploymentSchedule.md)
Recupera una pianificazione del processo di distribuzione della configurazione del nodo DSC nell'automazione.
...
Crea file mof di metaconfigurazione.
...
Recupera i processi di runbook di automazione.
...
Recupera i metadati per i moduli dall'automazione.

### [Get-AzAutomationRegistrationInfo](Get-AzAutomationRegistrationInfo.md)
Recupera le informazioni di registrazione per l'onboarding di un nodo DSC o di un utente ibrido all'automazione.
...
Recupera i runbook di automazione e le pianificazioni associate.
...
Ottiene un elenco di computer di configurazione dell'aggiornamento software di automazione di Azure eseguiti.
...
Ottiene un elenco di controlli origine di Automazione di Azure.

### [Get-AzAutomationSourceControlSyncJob](Get-AzAutomationSourceControlSyncJob.md)
Recupera i processi di sincronizzazione del controllo origine di Azure Automation.

### [Get-AzAutomationSourceControlSyncJobOutput](Get-AzAutomationSourceControlSyncJobOutput.md)
Ottiene l'output di un processo di sincronizzazione del controllo origine di Azure Automation.
...
Recupera gli webhook dall'automazione.
...
Rigenera i codici di registrazione per un account di automazione.
...
Crea una configurazione dell'aggiornamento software di automazione di Azure pianificata.
...
Rimuove le credenziali di automazione.
...
Rimuove i metadati dalle configurazioni nodo DSC nell'automazione.

### [Remove-AzAutomationHybridWorkerGroup](Remove-AzAutomationHybridWorkerGroup.md)
Rimuove il gruppo di utenti ibridi dall'automazione.
...
Rimuove una configurazione di aggiornamento software di automazione di Azure.

### [Remove-AzAutomationSourceControl](Remove-AzAutomationSourceControl.md)
Rimuove un controllo origine di Automazione di Azure.
...
Riprende un processo di automazione sospeso.
...
Modifica le credenziali di automazione.

### [Set-AzAutomationDscNode](Set-AzAutomationDscNode.md)
Modifica la configurazione del nodo a cui è mappato un nodo DSC.
...
Modifica una pianificazione di automazione.
...
Distribuisce la configurazione di un nodo DSC nell'automazione.
...
Avvia un processo di sincronizzazione del controllo origine di Azure Automation.

### [Stop-AzAutomationDscNodeConfigurationDeployment](Stop-AzAutomationDscNodeConfigurationDeployment.md)
Interrompe la distribuzione della configurazione del nodo DSC nell'automazione. Interrompe solo il processo di distribuzione corrente, ma non annulla l'assegnazione di configurazioni di nodo già assegnate.
...
Rimuove un nodo DSC dalla gestione tramite un account di automazione.

### [Unregister-AzAutomationScheduledRunbook](Unregister-AzAutomationScheduledRunbook.md)
Rimuove un'associazione tra un runbook e una pianificazione.
