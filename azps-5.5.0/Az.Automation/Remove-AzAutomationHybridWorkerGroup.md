...
## DESCRIZIONE
Il cmdlet Remove-AzAutomationHybridWorkerGroup rimuove un gruppo di utenti ibridi dall'automazione.

## ESEMPI

### Esempio 1
Questo comando rimuove un utente ibrido in base al nome.
...
### -Name
Nome del gruppo di utenti ibridi.
