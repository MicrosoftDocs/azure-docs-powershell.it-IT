...
## DESCRIZIONE
Il cmdlet Start-AzAutomationSourceControlSyncJob avvia un processo di sincronizzazione del controllo del codice sorgente di Azure Automation per il nome del controllo origine specificato.
