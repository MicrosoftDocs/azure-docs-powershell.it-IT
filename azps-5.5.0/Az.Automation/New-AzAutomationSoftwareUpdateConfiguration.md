...
## DESCRIZIONE
Crea una configurazione di aggiornamento software che viene eseguita in base a una pianificazione per aggiornare un elenco di computer. I computer includono sia macchine virtuali di Azure che computer non az.

## ESEMPI

### Esempio 1
Crea una configurazione di aggiornamento software per installare gli aggiornamenti critici in due macchine virtuali di Windows Azure una volta ogni sabato 21.00. In questo esempio la durata dell'aggiornamento è impostata su 2 ore.
...
### -AzureQuery
Query azure di gruppo dinamico.
...
### -Durata
Durata massima dell'aggiornamento.
...
### -ExcludedKbNumber
Numero di KB di aggiornamenti esclusi.
...
### -IncludedKbNumber
Numero di aggiornamenti inclusi nella Knowledge Base.
...
Classificazioni di pacchetti Linux incluse.
...
Maschere di pacchetto Linux incluse.
...
### -Linux
Indica che la configurazione dell'aggiornamento software è mirata ai computer del sistema operativo Linux.
...
### -NonAzureQuery
Query di gruppo dinamico non Azure.
...
### -Pianificazione
Oggetto Schedule usato per la configurazione degli aggiornamenti software.
...
### -Windows
Indica che la configurazione dell'aggiornamento software è mirata ai computer del sistema operativo Windows.
