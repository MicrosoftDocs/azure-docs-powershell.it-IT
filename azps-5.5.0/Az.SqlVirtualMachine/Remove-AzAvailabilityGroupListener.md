...
## DESCRIZIONE
Il Remove-AzAvailabilityGroupListener cmdlet elimina un listener del gruppo di disponibilità.
...
Elimina il listener del gruppo di disponibilità Ag Listener01 nel gruppo di disponibilità AvailabilityGroup01.
...
### -PassThru
Specifica se la risorsa eliminata deve essere restituita al termine dell'esecuzione del cmdlet.
