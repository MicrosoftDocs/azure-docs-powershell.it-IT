...
## DESCRIZIONE
**New-AzDataShareSynchronizationSetting** crea un'impostazione di sincronizzazione per la condivisione nell'account di condivisione per un intervallo di ricorrenza giornaliero o orario in un determinato momento.
...
Questo comando crea un'impostazione di sincronizzazione nell'intervallo di ricorrenza giornaliera alle 9:00 per condividere AdsShare nell'account di condivisione dati WikiAds.
...
### -Name
Nome dell'impostazione di sincronizzazione
...
### -RecurrenceInterval
Intervallo di ricorrenza per l'impostazione di sincronizzazione (giorno o ora)
...
### -ResourceGroupName
Nome del gruppo di risorse dell'account azure data share
...
### -SynchronizationTime
Ora di inizio dell'impostazione di sincronizzazione pianificata
