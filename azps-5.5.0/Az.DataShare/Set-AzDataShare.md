...
## DESCRIZIONE
Il cmdlet **Set-AzDataShare** aggiorna una condivisione dati esistente in un account di condivisione dati azure specificato.
...
### -InputObject
Oggetto di condivisione dati di Azure
...
### -TermsOfUse
Condizioni per l'utilizzo per la condivisione dei dati
