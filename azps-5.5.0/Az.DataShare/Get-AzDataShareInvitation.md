...
## DESCRIZIONE
Il **cmdlet Get-AzDataShareInvitation** ottiene informazioni sugli inviti aggiunti nella condivisione dati. Se si specifica il nome dell'invito, questo cmdlet riceve informazioni sull'invito. Se non si specifica un nome, questo cmdlet riceve informazioni su tutti gli inviti in una condivisione.
...
Questo comando fornisce informazioni sull'invito adsInvitation presente nella condivisione dati di AdsShare.
...
### -ResourceId
ID risorsa dell'invito alla condivisione dei dati di Azure
