...
## DESCRIZIONE
Il cmdlet **Remove-AzDataShareAccount** rimuove un account di condivisione dati.
...
Questo comando rimuove l'account di condivisione dati denominato WikiADS dal gruppo di risorse denominato ADS.
...
### -InputObject
Oggetto account per la condivisione dei dati di Azure.
