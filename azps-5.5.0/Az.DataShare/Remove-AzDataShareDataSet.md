...
## DESCRIZIONE
Il cmdlet **Remove-AzDataShareDataSet** rimuove un set di dati.
...
Questo comando rimuove il set di dati denominato DS dalla condivisione di WikiAds. 
