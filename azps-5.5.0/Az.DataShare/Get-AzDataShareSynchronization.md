...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareSynchronization** fornisce informazioni su tutte le impostazioni di sincronizzazione presenti in una condivisione con un account di condivisione dati.
...
Questo comando fornisce informazioni su tutte le impostazioni di sincronizzazione presenti in Share AdsShare nell'account di condivisione dati WikiAds.
