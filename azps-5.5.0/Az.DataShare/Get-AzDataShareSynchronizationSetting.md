...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareSynchronizationSetting** fornisce informazioni sulla sincronizzazione abilitata in una condivisione. 
...
Questo comando fornisce informazioni sulla sincronizzazione di ShareSynchronization abilitata in Share AdsShare nell'account di condivisione dati WikiAds.
...
### -Name
Nome per l'impostazione di sincronizzazione
