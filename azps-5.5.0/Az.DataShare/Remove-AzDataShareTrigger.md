...
## DESCRIZIONE
Il cmdlet **Remove-AzDataShareTrigger** rimuove un trigger di condivisione dati
...
Questo comando rimuove un trigger denominato AdsTrigger dalla sottoscrizione di condivisione AdsShareSubscription. 
...
### -InputObject
Oggetto trigger condivisione dati di Azure
...
### -ResourceId
Trigger per l'ID risorsa della condivisione dei dati di Azure
