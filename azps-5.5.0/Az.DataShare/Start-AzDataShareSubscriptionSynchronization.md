...
## DESCRIZIONE
Il cmdlet **Start-AzDataShareSubscriptionSynchronization** avvia la sincronizzazione per una sottoscrizione di condivisione
...
Questo comando avvia la sincronizzazione per una sottoscrizione di condivisione denominata AdsShareSubscription nell'account WikiAds. 
...
### -InputObject
Oggetto sottoscrizione della condivisione dati di Azure
...
### -ResourceId
ID risorsa della sottoscrizione di condivisione di Azure
...
### -SynchronizationMode
Modalità di sincronizzazione (FullSync o Incrementale)
