...
## DESCRIZIONE
Il cmdlet **Remove-AzDataShareDataSetMapping** rimuove i mapping di un set di dati.
...
Questo comando rimuove il set di dati denominato DSM da WikiAds sharesubscription. 
...
### -Name
Nome mapping set di dati di Azure
