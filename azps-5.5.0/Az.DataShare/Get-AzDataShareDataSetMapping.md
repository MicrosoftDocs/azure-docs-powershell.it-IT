...
## DESCRIZIONE
Se si specifica il nome, il cmdlet **Get-AzDataShareDataSetMapping ottiene** informazioni su uno specifico mapping del set di dati. In caso contrario, riceverà informazioni su tutti i mapping di set di dati in una sottoscrizione di condivisione. 
...
```
 ...
 Questo comando visualizza informazioni su tutti i mapping di set di dati nell'abbonamento alla condivisione.
