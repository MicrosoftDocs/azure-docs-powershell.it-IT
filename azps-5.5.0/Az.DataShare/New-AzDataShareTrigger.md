...
## DESCRIZIONE
Il cmdlet **New-AzDataShareTrigger** crea un trigger per la sottoscrizione di condivisione per l'intervallo di ricorrenza e l'ora di sincronizzazione specificati nell'account di condivisione dati di Azure.
...
Questo comando crea un nuovo trigger AdsTrigger per condividere l'abbonamento AdsShareSubscription con un intervallo di ricorrenza giornaliera di 9 am.
...
### -Name
Nome trigger condivisione dati di Azure
...
### -RecurrenceInterval
Intervallo di ricorrenza per il trigger (giorno o ora)
...
### -SynchronizationTime
Ora di inizio della sincronizzazione pianificata per il trigger
