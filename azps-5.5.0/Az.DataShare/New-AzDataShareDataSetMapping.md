...
## DESCRIZIONE
Il cmdlet **New-AzDataShareDataSetMapping** crea un mapping del set di dati tra i set di dati di origine e l'account di archiviazione dell'associazione nella sottoscrizione di condivisione.
...
Questo comando crea un mapping del set di dati AdsDataSetMapping all'account di archiviazione AdsStorage per la condivisione della sottoscrizione AdsShareSubscription nell'account di condivisione dati WikiAdsAccount.
