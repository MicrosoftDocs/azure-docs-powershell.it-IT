...
Elencare tutti i gruppi intelligenti formati nell'ultima ora. Usare Format-List per ottenere i dettagli completi di ogni gruppo intelligente nell'elenco.
...
Ottenere i dettagli di un gruppo intelligente in base all'ID (GUID) o all'ID risorsa (ID ARM risorsa)
