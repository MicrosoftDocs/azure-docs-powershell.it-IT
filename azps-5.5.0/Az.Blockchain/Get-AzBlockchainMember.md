...
### Esempio 1: Elencare membri di members
```powershell
...
Questo comando elenca i membri di un abbonamento.

### Esempio 2: Elencare membri di members
```powershell
...
Questo comando elenca i membri di un gruppo di risorse.

### Esempio 3: Ottenere un membro member
```powershell
...
Questo comando ottiene un membro di member member in un gruppo di risorse.

### Esempio 4: Ottenere un membro member
```powershell
