...
### Esempio 1: Elencare i nodi di transazione per un membro member
```powershell
...
Questo comando elenca i nodi della transazione per un membro member di questo tipo.

### Esempio 2: Ottenere un nodo di transazione
```powershell
...
Questo comando ottiene un nodo di transazione.

### Esempio 3: Ottenere un nodo di transazione
```powershell
...
### Microsoft.Azure.PowerShell.Cmdlets.Cmdlets.Gateway.Models.Api20180601Preview.INode
