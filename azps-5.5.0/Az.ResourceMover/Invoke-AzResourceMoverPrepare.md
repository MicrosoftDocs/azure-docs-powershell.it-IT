...
### Esempio 1: Convalidare le dipendenze prima di prepararsi per le risorse
```powershell
...
Verificare le dipendenze prima di prepararsi per le risorse.
...
Iniziare a preparare l'insieme di risorse nella raccolta di spostamento usando come input "MoveResource Name".
