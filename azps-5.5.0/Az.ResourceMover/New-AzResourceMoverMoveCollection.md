...
### Esempio 1: Creare una nuova raccolta Move.
```powershell
...
Creare una nuova raccolta di spostamento all'interno di una sottoscrizione.
...
### -IdentityType
Tipo di identità usato per il servizio di spostamento dell'area geografica.
