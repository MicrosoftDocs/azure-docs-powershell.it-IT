...
### Esempio 1: Calcola, risolve e convalida le dipendenze di moveresources nella raccolta Move.
```powershell
...
Calcola, risolve e convalida le dipendenze delle risorse di spostamento nella raccolta Move.
