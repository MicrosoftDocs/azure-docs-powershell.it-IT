...
### Esempio 1: Ottenere i dettagli di tutte le raccolte di spostamento dell'abbonamento
```powershell
...
Ottenere informazioni dettagliate su tutte le raccolte di spostamento dell'abbonamento.

### Esempio 2: Ottenere i dettagli della raccolta di spostamento con un nome di raccolta di spostamento specificato nell'abbonamento
```powershell
...
Ottenere informazioni dettagliate sulla raccolta di spostamento con il nome di una raccolta di spostamento specificata nella sottoscrizione.

### Esempio 3: Ottenere i dettagli della raccolta di spostamento con il nome di un gruppo di risorse specificato nella sottoscrizione
```powershell
...
Informazioni dettagliate sulla raccolta di spostamento con il nome di un gruppo di risorse specificato nella sottoscrizione.
