...
## SYNOPSIS
New-AzWebAppContainerPSSession crea una nuova sessione remota di PowerShell nel contenitore di windows specificato in un determinato sito o slot e gruppo di risorse specificato
...
Verrà creata una nuova sessione di PowerShell remota nell'app contenitore di Windows ContosoASP e verranno visualizzati i processi in esecuzione nel contenitore ContosoASP
