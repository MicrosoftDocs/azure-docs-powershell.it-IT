...
## DESCRIZIONE
**Switch-AzWebAppSlot** cambia due slot associati a un'app Web di Azure.
...
Questo comando cambia lo slot "sourceslot" con "destinationslot" nell'app Web ContosoWebApp associata al gruppo di risorse Default-Web-WestUS
