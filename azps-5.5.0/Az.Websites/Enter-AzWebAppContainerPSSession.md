...
## SYNOPSIS
Apre una sessione di PowerShell remota nel contenitore di windows specificato in un determinato sito o slot e gruppo di risorse
...
Questo comando apre una sessione di PowerShell remota nell'app contenitore di windows ContosoASP
...
### -Force
Creare la sessione di PowerShell senza chiedere conferma.
