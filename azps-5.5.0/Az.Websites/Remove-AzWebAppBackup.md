...
## DESCRIZIONE
Il cmdlet **Remove-AzWebAppBackup** rimuove il backup specificato di un'app Web di Azure.
...
Questo comando rimuove il backup con backup con ID "12345" dall'app Web denominata WebAppStandard che appartiene al gruppo di risorse Default-Web-WestUS.
