...
## DESCRIZIONE
Il cmdlet **Remove-AzWebAppTrafficRouting** rimuove una regola di routing da uno slot Azure Web App.

## ESEMPI

### Esempio 1: rimuove la regola di routing specifica dallo slot della webapp
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Questo comando rimuove una regola di routing per un determinato slot webapp.
