...
## SYNOPSIS
Ottenere l'output di esecuzione specificato per la risorsa modello di immagine specificata
...
### Esempio 1: Elencare tutti i risultati eseguiti in un modello
```powershell
...
Questo comando elenca tutti i risultati eseguiti in un modello.
...
### Microsoft.Azure.PowerShell.Cmdlets.ImageWl.Models.Api20200214.IRunOutput
