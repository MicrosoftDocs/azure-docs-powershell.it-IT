...
### Esempio 1: Ottenere tutti i piani dell'app per le funzioni.
```powershell
...
Questo comando recupera tutti i piani dell'app per le funzioni.

### Esempio 2: Ottenere i piani dell'app per le funzioni in base al nome del gruppo di risorse.
```powershell
...
Questo comando recupera i piani delle app per le funzioni in base al nome del gruppo di risorse.

### Esempio 3: Ottenere i piani dell'app per le funzioni per gli abbonamenti.
```powershell
...
Questo comando ottiene i piani dell'app per le funzioni per gli abbonamenti.

### Esempio 4: Ottenere i piani delle app per le funzioni in base alla posizione.
```powershell
...
Questo comando recupera i piani delle app per le funzioni in base alla posizione.
...
### -Location
Posizione del piano dell'app per le funzioni.
