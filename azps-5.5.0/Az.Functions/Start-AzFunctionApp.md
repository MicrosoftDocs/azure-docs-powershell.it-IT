...
### StartByName (impostazione predefinita)
```
...
### Esempio 1: Ottenere un'app per le funzioni in base al nome e avviarla.
```powershell
PS C:\> Get-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName | Start-AzFunctionApp
```

Questo comando ottiene un'app per funzioni in base al nome e la avvia.

### Esempio 2: Avviare un'app per funzioni in base al nome.
```powershell
PS C:\> Start-AzFunctionApp -Name MyAppName -ResourceGroupName MyResourceGroupName
```

Questo comando avvia un'app per funzioni in base al nome.
