...
Questo comando ottiene un'app per funzioni in base al nome e la interrompe.

### Esempio 2: Interrompere un'app per funzioni in base al nome.
```powershell
...
### -Force
Forza il cmdlet ad arrestare l'app funzione senza chiedere conferma.
