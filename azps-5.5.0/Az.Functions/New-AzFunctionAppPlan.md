...
### Esempio 1: Creare un piano di app Windows Premium nell'Europa occidentale con capacità a scatto esploso fino a 10 istanze.
```powershell
...
Questo comando crea un piano di app Premium di Windows nell'Europa occidentale con capacità a comparsa fino a 10 istanze.
