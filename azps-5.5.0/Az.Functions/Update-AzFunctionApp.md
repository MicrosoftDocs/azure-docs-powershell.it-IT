...
Questo comando aggiorna l'app Approfondimenti applicazioni per le funzioni.
...
Il tipo "Nessuna" rimuove le identità dall'app per le funzioni.
...
INPUTOBJECT <ISite> : 
  ...
  - `[CloningInfoCloneSourceControl <Boolean?>]`: <code>true</code> per clonare il controllo origine dall'app di origine; in caso contrario, <code>false</code> .
  ...
  - `[Config <ISiteConfig>]`: configurazione dell'app.
    ...
    - `[NetFrameworkVersion <String>]`: versione .NET Framework.
