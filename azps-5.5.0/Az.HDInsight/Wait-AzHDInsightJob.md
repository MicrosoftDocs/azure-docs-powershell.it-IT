...
### Esempio 1: Attendere il completamento o l'esito negativo di un processo
```
PS C:\># Cluster info
...
### -TimeoutInSeconds
Il tempo totale di attesa del completamento del processo, in secondi.
...
Il tempo di attesa tra i controlli dello stato del processo, in secondi.
