...
### Esempio 3: Impostare la configurazione della scala automatica del cluster HDInsight basata su un altro cluster che ha impostato la configurazione della gradazione automatica
```powershell
...
### -TimeZone
Ottiene o imposta il fuso orario della scala automatica basata su pianificazione.
