...
## DESCRIZIONE
Ruotare la chiave di crittografia del disco del cluster HDInsight specificato. Per questa operazione, il cluster deve avere accesso sia alla chiave corrente che alla nuova chiave prevista, altrimenti l'operazione di rotazione della chiave avrà esito negativo.
...
[Crittografia disco della chiave gestita dal cliente](https://docs.microsoft.com/en-us/azure/hdinsight/disk-encryption)
