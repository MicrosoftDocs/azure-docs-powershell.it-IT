...
## DESCRIZIONE
Il cmdlet **Add-AzHDInsightMetastore** aggiunge un metastore Hive o Oozie all'oggetto di configurazione HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.
Un metastore è un SQL dati dati che può essere usato per archiviare i metadati per Hive, Oozie o entrambi.

## ESEMPI

### Esempio 1: Aggiungere un metastore SQL di database all'oggetto di configurazione del cluster
```
...
Questo comando aggiunge un metastore SQL di database al cluster denominato your-hadoop-001.

### Esempio 2: Aggiungere un database Ambari personalizzato all'oggetto di configurazione del cluster
```
PS C:\># Primary storage account info
PS C:\> $storageAccountResourceGroupName = "Group"
PS C:\> $storageAccountResourceId = "yourstorageaccountresourceid"
...
Questo comando aggiunge un database Ambari personalizzato al cluster denominato your-hadoop-002.
...
### -DatabaseName
Specifica il database nell'istanza del server AzureSQL da usare per il metastore.
...
### -SqlAzureServerName
Specifica l'istanza del server AzureSQL da usare per il metastore.
