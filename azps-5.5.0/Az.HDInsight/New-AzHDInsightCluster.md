...
### Esempio 2: Creare un cluster con crittografia disco con chiave gestita dal cliente
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 6: Creare un cluster Azure HDInsight che abilita la scala automatica.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 8: Creare un cluster Azure HDInsight con lo spazio di archiviazione Azure Data Lake Gen2.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### -EnableComputeIsolation
Abilita la funzionalità di isolamento del calcolo HDInsight.
