...
## DESCRIZIONE
Il cmdlet Add-AzHDInsightComponentVersion aggiunge una versione per un servizio in esecuzione in un cluster all'oggetto di configurazione Azure HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.
