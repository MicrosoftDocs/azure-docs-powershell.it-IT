...
## DESCRIZIONE
Il cmdlet **New-AzHDInsightHiveJobDefinition** definisce un oggetto processo Hive da usare con un cluster Azure HDInsight.
...
Questo comando crea una definizione di processo di hive.
