...
## DESCRIZIONE
Il cmdlet **New-AzHDInsightMapReduceJobDefinition** definisce un nuovo processo MapReduce da usare con un cluster Azure HDInsight.
...
### -ClassName
Specifica la classe di processo nel file JAR.
...
### -LibJars
Specifica la lib JARS per il processo.
