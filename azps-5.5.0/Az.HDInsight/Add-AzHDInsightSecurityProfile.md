...
## DESCRIZIONE
Il profilo di sicurezza viene usato per creare un cluster sicuro con crenatura.
Il profilo di sicurezza contiene la configurazione correlata alla partecipazione del cluster al dominio Active Directory.

## ESEMPI

### Esempio 1: Aggiungere un profilo di sicurezza all'oggetto configurazione del cluster
```
...
Questo comando aggiunge al cluster un valore del profilo di sicurezza denominato your-hadoop-001.
...
### -DomainResourceId
ID risorsa dominio Active Directory per il cluster.
...
Il formato del nome utente dovrebbe user@domain essere
