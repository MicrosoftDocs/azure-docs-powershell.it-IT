...
## DESCRIZIONE
Il cmdlet **Add-AzDataLakeAnalyticsFirewallRule** aggiunge una regola del firewall a un account Azure Data Lake Analytics.
...
### -Account
Account di Data Lake Analytics a cui aggiungere la regola del firewall
