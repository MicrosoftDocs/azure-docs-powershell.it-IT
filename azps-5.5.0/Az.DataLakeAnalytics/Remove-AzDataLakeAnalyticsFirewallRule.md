...
## DESCRIZIONE
Il cmdlet **Remove-AzDataLakeAnalyticsFirewallRule** rimuove una regola del firewall da un account Azure Data Lake Analytics.
...
### -Account
Account di Data Lake Analytics da cui rimuovere la regola del firewall
