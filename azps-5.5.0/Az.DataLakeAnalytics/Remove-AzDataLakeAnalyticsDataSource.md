...
## DESCRIZIONE
Il cmdlet **Remove-AzDataLakeAnalyticsDataSource** rimuove un'origine dati da un account Azure Data Lake Analytics.

## ESEMPI

### Esempio 1: Rimuovere un'origine dati
```
PS C:\>Remove-AzDataLakeAnalyticsDataSource -Account "ContosoAdlAccount" -Blob "AzureStorage01"
```

Questo comando rimuove l'origine dati denominata AzureStorage01 dall'account denominato ContosoAdlAccount.
...
### -BLOB
Specifica il nome dell'account di archiviazione AzureBlob da rimuovere.
...
### -DataLakeStore
Specifica il nome dell'account AzureData Lake Store da rimuovere.
