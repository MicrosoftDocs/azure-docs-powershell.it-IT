...
Questo comando modifica la barra di accesso (ACE) del catalogo per concedere ad altri utenti le autorizzazioni di lettura.
...
### -Altro
Impostare la voce ACL del catalogo per altri elementi.
