...
## DESCRIZIONE
Il cmdlet **Remove-AzStreamAnalyticsJob** elimina in modo asincrono uno specifico processo di Analisi di flusso in Azure.
...
### -Name
Specifica il nome del processo di Analisi di flusso di Azure da rimuovere.
