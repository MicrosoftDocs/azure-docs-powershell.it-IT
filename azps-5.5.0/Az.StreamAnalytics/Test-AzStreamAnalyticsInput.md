...
## DESCRIZIONE
Il **cmdlet Test-AzStreamAnalyticsInput** verifica la capacità di Stream Analytics di connettersi a un input.

## ESEMPI

### Esempio 1: Verificare lo stato di connessione di uno stream di input
```powershell
PS C:\>Test-AzStreamAnalyticsInput -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamingJob" -Name "EntryStream"
```

Verifica lo stato della connessione dell'input EntryStream in StreamingJob.
...
### -Name
Specifica il nome dell'input di Analisi di flusso di Azure da testare.
