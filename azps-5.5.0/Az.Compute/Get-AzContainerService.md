...
È possibile visualizzare le proprietà di un servizio contenitore, che includono lo stato, il numero di master e agenti e il nome di dominio completo di master e agente.
...
Questo comando recupera tutti i servizi contenitore nella sottoscrizione.

### Esempio 3: Ottenere tutti i servizi contenitore nel gruppo di risorse
```
...
Questo comando recupera tutti i servizi contenitore in ResourceGroup17.

### Esempio 4: Ottenere tutti i servizi contenitore con il filtro
```
...
Questo comando recupera tutti i servizi contenitore a partire da "CSResourceGroup1".
...
### -Name
Specifica il nome del servizio contenitore che riceve questo cmdlet.
...
### -ResourceGroupName
Specifica il gruppo di risorse del servizio contenitore che riceve questo cmdlet.
