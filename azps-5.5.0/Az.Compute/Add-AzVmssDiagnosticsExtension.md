...
## DESCRIZIONE
Il cmdlet **Add-AzVmssDiagnosticsExtension** aggiunge un'estensione di diagnostica all'istanza VMSS (Virtual Machine Scale Set).
...
Questo comando aggiunge un'estensione di diagnostica al sistema VMSS.
...
Per ottenere la versione, eseguire il cmdlet [Get-AzVMExtensionImage](./Get-AzVMExtensionImage.md) con un valore Microsoft.Azure.Diagnostics per il parametro *PublisherName* e IaaSDiagnostics per il parametro *Type.*
