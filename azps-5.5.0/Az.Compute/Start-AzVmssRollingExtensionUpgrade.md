...
## SYNOPSIS
Questo cmdlet avvia un aggiornamento in sequenza per tutte le estensioni del set di scalabilità delle macchine virtuali specificato alla versione più recente disponibile. 
...
## DESCRIZIONE
Avvia un aggiornamento in sequenza per spostare tutte le estensioni di questo set di scalabilità delle macchine virtuali alla versione più recente disponibile.
Le estensioni che eseguono già l'ultima versione disponibile non sono interessate.
...
Questo esempio ottiene il set di scala della macchina virtuale esistente "MyVmssName" e aggiunge un'estensione. Il comando finale esegue il processo di aggiornamento dell'estensione in fase di distribuzione. 
...
### -ResourceId
ID risorsa dell'oggetto set di scalabilità della macchina virtuale. 
...
Oggetto set di scalabilità della macchina virtuale.
