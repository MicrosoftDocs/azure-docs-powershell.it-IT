...
Questo cmdlet elenca anche tutti i gruppi host in un gruppo di risorse, se non viene assegnato un nome a un gruppo host.
...
Questo comando restituisce tutti i gruppi host della sottoscrizione.
...
### -InstanceView
Espandere l'oggetto restituito per elencare anche le visualizzazioni dell'istanza dell'host. 
