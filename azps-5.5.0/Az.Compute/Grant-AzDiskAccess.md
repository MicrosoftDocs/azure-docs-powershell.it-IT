...
## DESCRIZIONE
Il cmdlet **Grant-AzDiskAccess** concede l'accesso a un disco.
...
Concedere l'accesso "Lettura" al disco denominato "Disco01" nel gruppo di risorse denominato "ResourceGroup01" per 60 secondi.
