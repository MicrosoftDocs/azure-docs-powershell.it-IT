...
## DESCRIZIONE
Il cmdlet **Grant-AzSnapshotAccess** concede l'accesso a uno snapshot.
...
Concedere l'accesso "Lettura" alla snapshot denominata "Snapshot01" nel gruppo di risorse denominato "ResourceGroup01" per 60 secondi.
...
### -DurationInSecond
Specifica la durata dell'accesso in secondi.
