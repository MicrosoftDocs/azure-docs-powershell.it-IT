...
Richiamare un comando Esegui di RunPowerShellScript con l'override dello script 'sample.ps1' e dei parametri per la macchina virtuale '0' nel set di scala della macchina virtuale 'vmssname' nel gruppo di risorse 'rgname'.
