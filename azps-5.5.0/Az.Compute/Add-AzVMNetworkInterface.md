...
È possibile aggiungere un'interfaccia quando si crea una macchina virtuale o la si aggiunge a una macchina virtuale esistente.
...
È possibile usare il cmdlet [Get-AzNetworkInterface](/powershell/module/az.network/get-aznetworkinterface) per ottenere un'interfaccia di rete.
