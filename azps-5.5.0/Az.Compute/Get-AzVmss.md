...
## DESCRIZIONE
Il cmdlet **Get-AzVmss ottiene** la visualizzazione modello e istanza di un set di scalabilità macchina virtuale (VMSS).
La visualizzazione modello rappresenta le proprietà specificate dall'utente del set di scalabilità della macchina virtuale.
La visualizzazione dell'istanza è lo stato del livello di istanza del set di scalabilità della macchina virtuale.
Specificare il *parametro InstanceView* per ottenere solo la visualizzazione dell'istanza di un set di scalabilità delle macchine virtuali.

## ESEMPI

### Esempio 1: Ottenere le proprietà di un sistema VMSS
```
...
Questo comando recupera le proprietà del sistema VMSS denominato VMSS001 che appartiene al gruppo di risorse denominato Group001.
Poiché il comando non specifica il parametro del parametro *InstanceView,* il cmdlet ottiene la visualizzazione del modello del set di scalabilità della macchina virtuale.

### Esempio 2: Ottenere tutte le vm in un gruppo di risorse
```
...
Ottenere tutte le vm nel gruppo di risorse "Group001"

### Esempio 3: Ottenere tutte le vm in un abbonamento
```
PS C:\> Get-AzVmss
...
Scarica tutte le Vms in abbonamento.

### Esempio 4: Usare i filtri per ottenere tutte le macchine virtuali
```
...
Ottieni tutte le vm in abbonamento che iniziano con "VMSS00".
...
### -InstanceView
Indica che questo cmdlet ottiene solo la visualizzazione dell'istanza del set di scalabilità della macchina virtuale.
...
### -OSUpgradeHistory
Indica che questo cmdlet elenca la cronologia di aggiornamento del sistema operativo del set di scalabilità delle macchine virtuali.
