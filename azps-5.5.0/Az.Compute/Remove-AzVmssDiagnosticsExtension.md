...
## DESCRIZIONE
Il cmdlet **Remove-AzVmssDiagnosticsExtension** rimuove un'estensione di diagnostica dal set di scala di macchine virtuali (VMSS).
...
Questo comando rimuove l'estensione di diagnostica da VMSS.
