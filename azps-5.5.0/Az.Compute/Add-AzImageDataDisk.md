...
I tre comandi seguenti assegnano i percorsi del disco del sistema operativo e due dischi dati alle variabili $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2.
Questo approccio è solo per la leggibilità dei comandi seguenti.
Ognuno dei tre comandi successivi aggiunge un disco del sistema operativo e due dischi di dati all'immagine archiviata in $imageConfig.
L'URI di ogni disco è archiviato in $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2.
Il comando finale crea un'immagine denominata Nome Image01 nel gruppo di risorse ResourceGroup01.
...
### -StorageAccountType
Tipo di account di archiviazione del disco immagine dati
