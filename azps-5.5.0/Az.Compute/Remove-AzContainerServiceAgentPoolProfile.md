...
Il primo comando ottiene un servizio contenitore denominato CSResourceGroup17 usando il cmdlet Get-AzContainerService.
Il comando archivia il servizio nella variabile $Container variabile.
...
### -Name
Specifica il nome del profilo del pool di agenti rimosso dal cmdlet.
