...
Crea un oggetto disco dati locale per una macchina virtuale o una VM Vmss. (autogenerated)
...
### -DiskEncryptionSetId
ID del set di crittografia del set di dischi della macchina virtuale.
