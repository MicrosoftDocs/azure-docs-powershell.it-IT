...
Se si ridistribuisce una macchina virtuale, questa viene riavviata, con la perdita dei dati effimeri delle unità.
...
### -SimulateEviction
Indica che questo cmdlet simula l'evizione della macchina virtuale spot.
