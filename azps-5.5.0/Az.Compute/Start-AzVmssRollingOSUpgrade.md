...
## DESCRIZIONE
Avvia un aggiornamento in sequenza per spostare tutte le istanze del set di scale delle macchine virtuali alla versione più recente del sistema operativo immagine della piattaforma disponibile.
Le istanze che eseguono già l'ultima versione del sistema operativo disponibile non sono interessate.
...
Questo comando avvia l'aggiornamento in sequenza di tutte le istanze della macchina virtuale del set di scala "VMSS001" nel gruppo di risorse "Group001".
