...
## DESCRIZIONE
Il cmdlet **Update-AzContainerService** aggiorna lo stato di un servizio contenitore in modo che corrisponda a un'istanza locale del servizio.
...
Questo comando recupera il servizio contenitore denominato CSResourceGroup17 usando il cmdlet Get-AzContainerService contenitore.
Il comando passa l'oggetto al cmdlet Remove-AzContainerServiceAgentPoolProfile tramite l'operatore pipeline.
**Remove-AzContainerServiceAgentPoolProfile** rimuove il profilo denominato AgentPool01.
Il comando passa il risultato al cmdlet Add-AzContainerServiceAgentPoolProfile cmdlet.
**Add-AzContainerServiceAgentPoolProfile** aggiunge un profilo con il nome AgentPool01 e con le proprietà specificate.
...
### -ContainerService
Specifica un oggetto **ContainerService locale** che contiene modifiche.
