...
## DESCRIZIONE
Il cmdlet **Remove-AzContainerService** rimuove un servizio contenitore dall'account di Azure.
...
### -Name
Specifica il nome del servizio contenitore rimosso dal cmdlet.
...
### -ResourceGroupName
Specifica il gruppo di risorse del servizio contenitore rimosso dal cmdlet.
