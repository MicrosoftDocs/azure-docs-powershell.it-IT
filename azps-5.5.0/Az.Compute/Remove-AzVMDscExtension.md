...
## DESCRIZIONE
Il cmdlet **Remove-AzVMDscExtension** rimuove un gestore delle estensioni DSC (Desired State Configuration) da una macchina virtuale in un gruppo di risorse.
...
Questo comando rimuove l'estensione DSC nella macchina virtuale denominata VM07.
...
### -Name
Specifica il nome dell'estensione DSC rimossa dal cmdlet.
Il cmdlet Set-AzVMDscExtension imposta questo nome su Microsoft.Powershell.DSC, ovvero il valore predefinito usato da **Remove-AzVMDscExtension.**
