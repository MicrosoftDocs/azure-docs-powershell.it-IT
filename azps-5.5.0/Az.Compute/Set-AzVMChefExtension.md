...
All'avvio della macchina virtuale, Bootstrap avvia la macchina virtuale per l'esecuzione di Apache.
Dopo il programma di avvio automatico, la macchina virtuale fa riferimento alle opzioni di avvio automatico specificate in formato JSON.
...
### -ValidationPem
Specifica il percorso del file Con estensione pem dell'altro file
