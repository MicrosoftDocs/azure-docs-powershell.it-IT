...
## DESCRIZIONE
Il **cmdlet Stop-AzVM** interrompe una macchina virtuale di Azure.
...
Questo comando interrompe la macchina virtuale denominata VirtualMachine07 in ResourceGroup11.
...
### -SkipShutdown
Per richiedere l'arresto non graceful della macchina virtuale durante il provisioning della macchina virtuale.
...
### -StayProvisioned
Il cmdlet interrompe tutte le macchine virtuali nel sistema VMS, ma non le deassegna. L'addebito per l'account viene addebitato per le macchine virtuali arrestate.
