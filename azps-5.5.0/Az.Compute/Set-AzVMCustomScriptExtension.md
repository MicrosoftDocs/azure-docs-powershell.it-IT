...
### -SecureExecution
Indica che questo cmdlet verifica che il valore del parametro *Run* non sia registrato sul server o non sia stato restituito all'utente usando l'API di estensione GET.
