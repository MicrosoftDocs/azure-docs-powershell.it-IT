...
## DESCRIZIONE
Il cmdlet **Set-AzVMBGInfoExtension aggiunge** l'estensione BGInfo a una macchina virtuale.
...
Questo comando aggiunge l'estensione BGInfo alla macchina virtuale contosoVM.
Il comando specifica il gruppo di risorse e il percorso della macchina virtuale.
...
Indica che questo cmdlet impedisce all'agente guest di Azure di aggiornare automaticamente l'estensione a una versione secondaria più recente.
...
### -Name
Specifica il nome dell'estensione BGInfo che il cmdlet aggiunge a una macchina virtuale.
