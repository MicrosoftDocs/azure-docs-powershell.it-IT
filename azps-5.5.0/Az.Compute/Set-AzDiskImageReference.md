...
## SYNOPSIS
Imposta le proprietà di riferimento dell'immagine su un oggetto disco.
...
## DESCRIZIONE
Il cmdlet **Set-AzDiskImageReference** imposta le proprietà di riferimento dell'immagine su un oggetto disco.
...
Il primo comando crea un oggetto disco locale con dimensioni di 10 GB Premium_LRS tipo di account di archiviazione.  Imposta anche il tipo di sistema operativo Windows.
Il secondo comando imposta l'ID immagine e il numero di unità 0 per l'oggetto disco.
