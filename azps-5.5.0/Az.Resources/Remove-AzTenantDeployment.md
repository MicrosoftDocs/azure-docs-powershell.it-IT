...
## DESCRIZIONE
Il cmdlet **Remove-AzTenantDeployment** rimuove una distribuzione di Azure nell'ambito tenant corrente ed eventuali operazioni associate.
...
Questo comando rimuove la distribuzione "RolesDeployment" nell'ambito tenant corrente.
...
Questo comando recupera la distribuzione "RolesDeployment" nell'ambito tenant corrente e la rimuove.
