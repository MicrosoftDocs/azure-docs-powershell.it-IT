...
L'ambito dell'assegnazione MAY può essere specificato e, se non specificato, viene utilizzato per impostazione predefinita l'ambito di sottoscrizione, ad esempio se si tenta di eliminare un'assegnazione all'entità e al ruolo specificati nell'ambito della sottoscrizione.
...
Rimuove un'assegnazione di ruolo john.doe@contoso.com per gli utenti assegnati al ruolo lettore nell'ambito del gruppo di risorse rg1.
...
Per impostazione predefinita, viene utilizzata la sottoscrizione corrente come ambito per trovare l'assegnazione da eliminare.
...
Deve essere usato insieme ai parametri ResourceGroupName, ResourceName e (facoltativamente) ParentResource per creare un ambito gerarchico sotto forma di URI relativo che identifichi la risorsa ed elimini un'assegnazione in tale ambito.
