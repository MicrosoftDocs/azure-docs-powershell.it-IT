...
## DESCRIZIONE
Il cmdlet **Update-AzManagementGroup** aggiorna **ParentId** o **DisplayName** per un gruppo di gestione.
...
### Esempio 2: Aggiornare il padre di un gruppo di gestione
```
...
### Esempio 3: Aggiornare un gruppo di gestione con l'oggetto PSManagementGroup
```
...
### Esempio 4: Aggiornare l'elemento padre di un gruppo di gestione usando ParentObject
```
