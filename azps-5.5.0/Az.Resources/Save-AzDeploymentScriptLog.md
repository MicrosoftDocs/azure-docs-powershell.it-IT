...
## DESCRIZIONE
**Save-AzDeploymentScriptLog** salva il log di esecuzione di uno script di distribuzione sul disco.
...
Salva il log di uno script di distribuzione con il nome e il gruppo di risorse specificato.
...
Salva le ultime 3 righe del log di uno script di distribuzione con il nome e il gruppo di risorse specificato.
...
### -Force
Forza la sovrascrittura del file esistente.
