...
## DESCRIZIONE
Il cmdlet **Invoke-AzResourceAction** richiama un'azione su una risorsa Azure specificata.
Per ottenere un elenco delle azioni supportate, usare lo strumento Esplora risorse di Azure.

## ESEMPI

### Esempio 1: Richiamare l'avvio di una macchina virtuale con ResourceId
...
Questo comando avvia la macchina virtuale con {ResourceId}.

### Esempio 2: Richiamare poweroffing di una macchina virtuale con ResourceName
...
Questo comando interrompe la macchina virtuale con {ResourceId}.
Il comando specifica il *parametro Force,* quindi non richiede conferma.

### Esempio 3: Richiamare la registrazione di un provider di risorse con ResourceId
...
Questo comando registra un provider di risorse "Microsoft.Network".
Il comando specifica il *parametro Force,* quindi non richiede conferma.

## PARAMETERS

### -Action
Specifica il nome dell'azione da richiamare.
...
Specifica il nome di una risorsa di estensione per la risorsa su cui questo cmdlet richiama un'azione.
...
Specifica il tipo di risorsa dell'estensione.
...
### -Parameters
Specifica i parametri, come tabella hash, per l'azione che il cmdlet richiama.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse in cui questo cmdlet richiama un'azione.
...
### -ResourceId
Specifica l'ID risorsa completo della risorsa su cui questo cmdlet richiama un'azione.
...
### -ResourceName
Specifica il nome della risorsa della risorsa su cui il cmdlet richiama un'azione.
