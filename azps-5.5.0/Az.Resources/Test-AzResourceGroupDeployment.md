...
Questo comando testa una distribuzione nel gruppo di risorse specificato usando una tabella hash in memoria creata dal file di modello specificato e un file di parametri.
