...
Questo comando ottiene un risultato What-If'ambito del gruppo di risorse specificato usando un file di modello personalizzato e un file di parametri sul disco.
...
### Esempio 2: Ottenere un risultato What-If'ambito del gruppo di risorse con ResourceIdOnly
```powershell
PS C:\> Get-AzResourceGroupDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -ResourceGroupName "myRG1" `
...
### -ExcludeChangeType
Tipi di modifica delle risorse con valori delimitati da virgole da escludere What-If risultati.
