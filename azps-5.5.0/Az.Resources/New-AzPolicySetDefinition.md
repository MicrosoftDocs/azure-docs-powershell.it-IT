...
## DESCRIZIONE
Il cmdlet **New-AzPolicySetDefinition** crea una definizione di set di criteri.

## ESEMPI

### Esempio 1: Creare una definizione del set di criteri con metadati usando un file del set di criteri
```
[
   {
...
Questo comando crea una definizione di set di criteri denominata VMPolicySetDefinition con metadati che indicano che la categoria è "Macchina virtuale" che contiene le definizioni dei criteri specificate in C:\VMPolicy.jsattivo. Il contenuto dell'VMPolicy.jsesempio è fornito sopra.

### Esempio 2: Creare una definizione di set di criteri con parametri
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Questo comando crea una definizione di set di criteri con parametri denominata VMPolicySetDefinition che contiene le definizioni dei criteri specificate in C:\VMPolicy.jsattivo. Il contenuto dell'VMPolicy.jsesempio è fornito sopra.

### Esempio 3: Creare una definizione del set di criteri con gruppi di definizioni dei criteri
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Questo comando crea una definizione di set di criteri denominata VMPolicySetDefinition con il raggruppamento delle definizioni dei criteri specificate C:\VMPolicy.jsattivo. Il contenuto dell'VMPolicy.jsesempio è fornito sopra.
...
### -GroupDefinition
Gruppi di definizione dei criteri per la definizione del nuovo set di criteri. Può trattarsi del percorso di un file contenente i gruppi o dei gruppi come stringa JSON.
...
### -ManagementGroupName
Nome del gruppo di gestione della definizione del nuovo set di criteri.
...
### -Metadata
Metadati per la definizione del set di criteri. Può trattarsi del percorso di un nome file contenente i metadati o dei metadati come stringa JSON.
...
### -Parameter
Dichiarazione dei parametri per la definizione del set di criteri.
Può trattarsi del percorso di un nome file contenente la dichiarazione dei parametri o della dichiarazione dei parametri come stringa JSON.
...
### -SubscriptionId
ID sottoscrizione della definizione del nuovo set di criteri.
