...
Senza parametri, questo comando restituisce tutte le assegnazioni di negazione effettuate sotto la sottoscrizione.
...
In questo modo verranno filtrate le assegnazioni di negazione che sono più efficaci in quello specifico ambito, ad esempio tutte le assegnazioni di negazione in tale ambito e nelle successive.
b.
ResourceGroupName: nome di qualsiasi gruppo di risorse nella sottoscrizione.
Verranno filtrate le assegnazioni effettive nel gruppo di risorse specificato, ad esempio tutte le assegnazioni di tipo Nega in tale ambito e nelle successive.
c.
...
Se specificato, restituisce le assegnazioni di negazione assegnate direttamente all'utente e ai gruppi di cui l'utente è membro (transitivamente).
...
Filtra tutte le assegnazioni di tipo Nega apportate all'entità specificata.
...
Il comando filtra tutte le assegnazioni di tipo Nega che sono efficaci in tale ambito.
