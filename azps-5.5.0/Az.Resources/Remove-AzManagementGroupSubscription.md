...
## DESCRIZIONE
Il cmdlet **Remove-AzManagementGroupSubscription** rimuove una sottoscrizione da un gruppo di gestione.

## ESEMPI

### Esempio 1: Rimuovere la sottoscrizione da un gruppo di gestione
```powershell
