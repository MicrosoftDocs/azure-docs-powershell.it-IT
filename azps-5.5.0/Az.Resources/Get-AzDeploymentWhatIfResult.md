...
### Esempio 1: Ottenere un risultato What-If'ambito della sottoscrizione
```powershell
...
Questo comando ottiene un risultato What-If'ambito di sottoscrizione corrente usando un file di modello personalizzato e un file di parametri sul disco.
...
### Esempio 2: Ottenere un risultato What-If'ambito della sottoscrizione con ResourceIdOnly
```powershell
PS C:\> Get-AzDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
