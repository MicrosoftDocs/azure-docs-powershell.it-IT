...
Questo esempio aggiunge un tag Status con il valore Approved e un tag FY2016 a un gruppo di risorse che contiene tag esistenti. Poiché i tag specificati sostituiscono quelli esistenti, è necessario includere i tag esistenti nella nuova raccolta di tag, in caso contrario andranno persi.
