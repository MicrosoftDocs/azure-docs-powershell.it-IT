...
## DESCRIZIONE
Il cmdlet **New-AzDeployment** aggiunge una distribuzione all'ambito di sottoscrizione corrente.
...
Oppure può essere una risorsa a livello di abbonamento, come la definizione del ruolo, la definizione dei criteri e così via.
...
Questo comando crea una nuova distribuzione nell'ambito di sottoscrizione corrente usando un modello personalizzato e un file di modello su disco, con un parametro di tag definito.
