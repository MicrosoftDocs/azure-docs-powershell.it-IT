...
Usare l'opzione IncludeClassicAdministrators per visualizzare anche gli amministratori dell'abbonamento e gli amministratori coamministratori.
...
Recupera tutte le assegnazioni di ruolo apportate all'utente e ai gruppi di cui è john.doe@contoso.com membro, nell'ambito testRG o superiore.
...
Filtra tutte le assegnazioni apportate all'entità specificata.
...
Se usato insieme ai parametri ResourceName, ResourceType e ParentResource, il comando elenca le assegnazioni effettive alle risorse all'interno del gruppo di risorse.
