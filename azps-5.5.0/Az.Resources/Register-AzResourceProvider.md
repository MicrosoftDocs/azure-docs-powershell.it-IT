...
## DESCRIZIONE
Il cmdlet **Register-AzResourceProvider** registra un provider di risorse di Azure.
...
In questo modo il provider di microsoft.network viene registrato per l'account.
