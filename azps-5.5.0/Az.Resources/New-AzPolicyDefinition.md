...
### Esempio 1: Creare una definizione di criterio usando un file di criteri
```
{
   "if": {
      "field": "location",
...
Questo comando crea una definizione di criterio denominata LocationDefinition che contiene la regola del criterio specificata in C:\LocationPolicy.jsattivo. Il contenuto di esempio per LocationPolicy.jsfile è fornito in precedenza.
...
Questo comando crea una definizione di criterio denominata LocationDefinition che contiene la regola del criterio specificata in C:\LocationPolicy.jsattivo. La definizione del parametro per la regola dei criteri è fornita in linea.
...
Questo comando crea una definizione di criterio denominata TagPolicyDefinition con modalità "Indicizzato" che indica che il criterio deve essere valutato solo per i tipi di risorsa che supportano tag e posizione.
