...
## DESCRIZIONE
Il cmdlet **New-AzResourceLock** crea un blocco delle risorse.

## ESEMPI

### Esempio 1: Creare un blocco di risorse in un sito Web
```
...
Questo comando crea un blocco di risorse su un sito Web.

### Esempio 2: Creare un blocco di risorse su un database
```
...
Questo comando crea un blocco delle risorse in un database di Azure.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse per cui viene applicato il blocco o che contiene il gruppo di risorse a cui si applica il blocco.
