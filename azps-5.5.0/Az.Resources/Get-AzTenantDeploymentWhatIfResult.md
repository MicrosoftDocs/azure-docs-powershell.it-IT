...
Questo comando ottiene un risultato What-If'ambito tenant usando un file di modello personalizzato e un file di parametri sul disco.
...
### Esempio 2: Ottenere un risultato What-If'ambito tenant con ResourceIdOnly
```powershell
PS C:\> Get-AzTenantDeploymentWhatIfResult `
    -DeploymentName "deploy-01" `
    -Location "West US" `
...
### -ExcludeChangeType
Elenco separato da virgola dei tipi di modifica delle risorse da escludere What-If risultati.
