...
## DESCRIZIONE
Il cmdlet **Unregister-AzProviderFeature** annulla la registrazione di una funzionalità del provider di Azure nel tuo account.

## ESEMPI

### Esempio 1: Annullare la registrazione di una funzionalità
```
PS C:\>Unregister-AzProviderFeature -FeatureName AllowApplicationSecurityGroups -ProviderNamespace Microsoft.Network
```

Questa operazione annulla la registrazione della funzionalità AllowApplicationSecurityGroups per Microsoft.Network dall'account.
