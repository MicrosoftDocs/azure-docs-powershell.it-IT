...
### Esempio 2: Elencare le voci del menu Start di Desktop virtuale di Windows
```powershell
...
Questo comando elenca le voci del menu Start del desktop virtuale di Windows in un gruppo applicato.
