...
### Esempio 1: Aggiornare un sessionHost di Desktop virtuale di Windows in base al nome
```powershell
...
Questo comando aggiorna un sessionhost di Desktop virtuale di Windows in un pool host.
