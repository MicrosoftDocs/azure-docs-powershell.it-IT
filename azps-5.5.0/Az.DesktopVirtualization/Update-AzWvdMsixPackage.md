...
### Esempio 1: Aggiornare un pacchetto MSIX 
```powershell
...
Questo comando aggiorna un pacchetto MSIX in un hostPool.
...
### -DisplayName
Nome visualizzato per il pacchetto MSIX.
...
### -IsActive
Impostare una versione del pacchetto in modo che sia attiva nell'altro pool host.
