...
### Esempio 1: Ottenere un token di registrazione di Desktop virtuale di Windows
```powershell
...
Questo comando ottiene un token di registrazione di Desktop virtuale di Windows in un pool host.
