...
Questo comando aggiorna un'applicazione Desktop virtuale di Windows in un gruppo applicato.
...
### -CommandLineSetting
Specifica se l'applicazione pubblicata può essere avviata con argomenti della riga di comando forniti dal client, argomenti della riga di comando specificati al momento della pubblicazione o nessun argomento della riga di comando.
