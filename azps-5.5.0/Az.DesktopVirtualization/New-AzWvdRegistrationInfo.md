...
### Esempio 1: Creare un token di registrazione di Desktop virtuale di Windows
```powershell
...
Questo comando crea un token di registrazione di Desktop virtuale di Windows in un pool host.
