...
### Esempio 1: Ottenere un gruppo applicazioni desktop virtuale di Windows in base al nome
```powershell
...
Questo comando ottiene un Gruppo Applicazioni Desktop virtuale Di Windows in un gruppo di risorse.

### Esempio 2: Elencare Desktop virtuale Windows ApplicationGroups
```powershell
...
Questo comando elenca un gruppo di risorse di Desktop virtuale Di Windows.
