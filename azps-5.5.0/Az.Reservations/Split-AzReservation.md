...
## DESCRIZIONE
Dividere una in `Reservation` due con la distribuzione di quantità `Reservation` specificata.
...
Dividere le specificate `Reservation` in due s con le quantità `Reservation` corrispondenti
...
### -Quantity
Numeri interi separati da virgola per il campo della quantità delle due `Reservation` unità
...
### -ReservationId
ID `Reservation` dell'elemento da dividere
...
### -ReservationOrderId
ID `ReservationOrder` dell'elemento che contiene `Reservation` l'utente da dividere
