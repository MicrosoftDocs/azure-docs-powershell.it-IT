...
## SYNOPSIS
Elimina un monitor SAP con la sottoscrizione, il gruppo di risorse e il nome del monitor specificati.
...
### Esempio 1: Rimuovere un monitor SAP in base al nome
```powershell
PS C:\> Remove-AzSapMonitor -ResourceGroupName nancyc-hn1 -Name ps-sapmonitor-t02

```

Questo comando rimuove un monitor SAP in base al nome.
