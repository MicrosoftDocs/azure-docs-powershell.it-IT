...
## SYNOPSIS
Crea un'istanza del provider per la sottoscrizione, il gruppo di risorse, il nome SapMonitor e il nome della risorsa specificati.

## SINTASSI

### ByString (impostazione predefinita)
```
...
### Esempio 1: Creare un'istanza di un monitor SAP per stringa per HANA
```powershell
...
Questo comando crea un'istanza del monitor SAP per stringa per HANA.

### Esempio 2: Creare un'istanza di monitoraggio SAP tramite il vault delle chiavi per HANA
```powershell
...
Questo comando crea un'istanza di monitoraggio SAP tramite il vault delle chiavi per HANA.

### Esempio 3: Creare un'istanza di un monitor SAP tramite dizionario per PrometheusHaCluster
```powershell
...
Questo comando crea un'istanza di sap monitor tramite dizionario per PrometheusHaCluster.

### Esempio 4: Creare un'istanza di sap monitor in base al dizionario per PrometheusOS
```powershell
...
Questo comando crea un'istanza di SAP Monitor tramite dizionario per PrometheusOS.

### Esempio 5: Creare un'istanza di sap monitor in base al dizionario per MsSqlServer
```powershell
...
Questo comando crea un'istanza di sap monitor tramite dizionario per MsSqlServer.

### Esempio 6: Creare un'istanza di un monitor SAP tramite dizionario per SapHana
```powershell
...
Questo comando crea un'istanza di sap monitor dal dizionario SapHana.
...
### -HanaDatabaseName
Nome del database dell'istanza di SAP HANA.
...
Password del database dell'istanza di SAP HANA.
...
ID risorsa del Vault delle chiavi che contiene le credenziali HANA.
...
Identificatore segreto per il segreto del Vault delle chiavi che contiene le credenziali HANA.
...
### -HanaDatabaseSqlPort
La SQL del database dell'istanza di SAP HANA.
...
Nome utente del database dell'istanza di SAP HANA.
...
### -HanaHostname
Il nome host dell'istanza di SAP HANA.
...
### -InstanceProperty
Proprietà dell'istanza di HANA.
...
### -Metadata
Stringa JSON contenente i metadati dell'istanza del provider.
...
### -ProviderType
Tipo di istanza del provider.
I valori supportati sono: "SapHana".
