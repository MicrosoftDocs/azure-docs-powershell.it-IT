...
## SYNOPSIS
Patch del campo Contrassegni di un monitor SAP per la sottoscrizione, il gruppo di risorse e il nome del monitor specificati.
...
### Esempio 1: Aggiornare un monitor SAP in base al nome
```powershell
...
Questo comando aggiorna un monitor SAP in base al nome.

### Esempio 2: Aggiornare un monitor SAP in base all'oggetto
```powershell
...
Questo comando aggiorna un monitor SAP in base all'oggetto.
...
### -Tag
Campo Contrassegni della risorsa.
