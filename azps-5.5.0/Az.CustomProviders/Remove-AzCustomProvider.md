...
## SYNOPSIS
Elimina il provider di risorse personalizzato.
...
### Esempio 1: Rimuovere un provider personalizzato.
```powershell
PS C:\> PS C:\> Remove-AzCustomProvider -ResourceGroupName myRg -Name Namespace.Type
```

Rimuovere un provider personalizzato

### Esempio 2: Rimuovere un provider personalizzato con PassThru
```powershell
...
Rimuovere un provider personalizzato usando la caratteristica PassThru per indicare un'operazione riuscita o non riuscita.
