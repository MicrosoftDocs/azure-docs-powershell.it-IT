...
## DESCRIZIONE
Il cmdlet **New-AzNetAppFilesActiveDirectory** crea un nuovo criterio snapshot per un account ANF.
...
Questo comando crea il nuovo criterio snapshot ANF per l'account ANF denominato account "MyAccount".
