...
## DESCRIZIONE
Il cmdlet **Remove-AzNetAppFilesBackup** elimina un account ANF.
...
Questo comando elimina il nuovo backup ANF con il nome "MyBackup" per il volume "MyVolume".
...
### -PassThru
Verificare se il backup specificato è stato rimosso correttamente
