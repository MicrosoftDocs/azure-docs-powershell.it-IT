...
## DESCRIZIONE
Il cmdlet **Get-AzNetAppFilesSnapshot** ottiene i dettagli di uno snapshot ANF.

## ESEMPI

### Esempio 1: Ottenere uno snapshot ANF
```
...
Questo comando recupera lo snapshot denominato MyAnfSnapshot dal volume "MyAnfVolume".
...
### -VolumeObject
Oggetto volume contenente lo snapshot da restituire
