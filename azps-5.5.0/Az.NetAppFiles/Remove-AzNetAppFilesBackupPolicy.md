...
## DESCRIZIONE
Il cmdlet **Remove-AzNetAppFilesBackupPolicy** elimina un criterio di backup ANF.
...
Questo comando elimina il nuovo criterio di backup ANF con il nome "MyBackupPolicy" per l'account "MyAccount".
...
### -AccountObject
Oggetto Account contenente il criterio di backup da rimuovere
...
### -PassThru
Verificare se il criterio di backup specificato è stato rimosso correttamente
