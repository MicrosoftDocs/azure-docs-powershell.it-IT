...
### -Backup
Matrice di tabella hash che rappresenta l'oggetto di backup
...
### -BackupId
ID backup. UUID v4 o identificatore di risorsa usato per identificare il backup
...
### -CreationToken
Un percorso file univoco per il volume
...
### -ExportPolicy
Matrice di tabella hash che rappresenta il criterio di esportazione
...
### -ReplicationObject
Matrice di tabella hash che rappresenta l'oggetto replica
...
### -Snapshot
Matrice di tabella hash che rappresenta l'oggetto snapshot
...
### -SnapshotId
Creare il volume da uno snapshot. UUID v4 o identificatore di risorsa usato per identificare lo snapshot
...
### -SubnetId
URI della risorsa Azure per una subnet delegata
...
### -ThroughputMibps
Velocità effettiva massima in Mibps che può essere raggiunta da questo volume
