...
## DESCRIZIONE
Il cmdlet **Update-AzNetAppFilesSnapshotPolicy** modifica un criterio snapshot ANF.
...
Questo comando modifica il criterio di backup ANF "MySnapshotPolicy" in modo da impostare il programma orario specificato.
...
### -DailySchedule
Matrice di tabella hash che rappresenta la pianificazione giornaliera
...
Matrice di tabella hash che rappresenta la pianificazione oraria
...
### -MonthlySchedule
Matrice di tabella hash che rappresenta la funzione Pianificazione montly
