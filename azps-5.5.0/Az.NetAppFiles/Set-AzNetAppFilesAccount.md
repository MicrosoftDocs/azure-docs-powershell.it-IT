...
## DESCRIZIONE
Il cmdlet **Set-AzNetAppFilesAccount** modifica un account ANF.

## ESEMPI

### Esempio 1: Modificare un account ANF
```
...
Questo comando esegue un aggiornamento per l'account specificato. L'assenza di Active Directory significa che verrà rimossa dall'account.

## PARAMETERS

### -ActiveDirectory
Matrice di tabella hash che rappresenta le directory attive
