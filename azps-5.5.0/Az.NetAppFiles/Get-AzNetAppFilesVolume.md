...
## DESCRIZIONE
Il cmdlet **Get-AzNetAppFilesVolume** ottiene i dettagli di un volume ANF.

## ESEMPI

### Esempio 1: Ottenere un volume ANF
```
...
Questo comando recupera il volume denominato MyAnfVolume dal pool "MyAnfPool". 
...
### -PoolObject
Oggetto pool contenente il volume da restituire
