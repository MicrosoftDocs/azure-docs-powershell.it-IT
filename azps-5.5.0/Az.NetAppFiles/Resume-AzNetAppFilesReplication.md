...
## DESCRIZIONE
Riprendere/risincronizzare la connessione nel volume di destinazione
...
Questo comando riprende la connessione a Replica ANF sul volume "MyDestinationAnfVolume".

## PARAMETERS

### -AccountName
Nome dell'account ANF del volume di replica
...
### -InputObject
Oggetto volume di destinazione della replica ANF da risincronizzare
...
### -Name
Nome del volume di destinazione della replica ANF
...
### -PassThru
Restituisce se è stata eseguita la sincronizzazione del volume di replica specificato
...
### -PoolName
Nome del pool ANF del volume di replica
...
### -ResourceGroupName
Gruppo di risorse del volume di destinazione della replica ANF
...
### -ResourceId
ID risorsa del volume di destinazione della replica ANF
