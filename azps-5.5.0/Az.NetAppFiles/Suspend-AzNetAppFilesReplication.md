...
Questo comando sospende la connessione a Replica ANF sul volume "MyDestinationAnfVolume".
...
### -ForceBreak
Se lo stato della replica è il trasferimento di stato e si vuole forzare l'interruzione della replica, impostato su true
...
### -InputObject
Oggetto volume di destinazione ANF con la replica da interrompere
...
### -PassThru
Restituisce se è stata eseguita l'interruzione della replica del volume specificata
