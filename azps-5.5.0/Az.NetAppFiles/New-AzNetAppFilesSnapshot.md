...
## DESCRIZIONE
Il cmdlet **New-AzNetAppFilesSnapshot** crea uno snapshot ANF.
...
Questo comando crea il nuovo snapshot ANF "MyAnfSnapshot" all'interno del volume "MyAnfVolume".
...
### -VolumeObject
Il volume del nuovo oggetto snapshot
