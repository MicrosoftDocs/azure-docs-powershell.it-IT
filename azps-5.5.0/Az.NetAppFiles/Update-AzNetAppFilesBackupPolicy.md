...
## DESCRIZIONE
Il cmdlet **Update-AzNetAppFilesBackupPolicy** modifica un criterio di backup ANF.
...
Questo comando modifica il criterio di backup ANF "MyBackupPolicy" in modo che abbia il dato DailyBackupsToKeep.
...
### -AccountObject
Oggetto Account contenente il criterio di backup da aggiornare
...
### -DailyBackupsToKeep
I backup giornalieri sono da conservare
...
Conteggio dei backup mensili da conservare
...
### -Name
Nome dei criteri di backup ANF
...
### -ResourceId
ID risorsa dei criteri di backup ANF
...
### -Tag
Matrice di tabella hash che rappresenta i tag di risorsa
...
### -WeeklyBackupsToKeep
Conteggio dei backup settimanali da conservare
...
### -YearlyBackupsToKeep
Numero di backup annuale da conservare
