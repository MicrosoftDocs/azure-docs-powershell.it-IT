...
## DESCRIZIONE
Approvare la connessione di replica nel volume di origine
...
Questo comando approva la replica in MyAnfVolume.

## PARAMETERS

### -AccountName
Nome dell'account ANF del volume di origine della replica
...
ID file system del volume di protezione dati di destinazione
...
### -InputObject
Oggetto volume di origine ANF per l'autorizzazione della destinazione della replica
...
### -Name
Nome del volume di origine della replica ANF
...
### -PassThru
Restituisce se è stata eseguita l'autorizzazione di replica del volume specificato
...
### -PoolName
Nome del pool ANF del volume di origine della replica
...
### -ResourceGroupName
Gruppo di risorse del volume di origine della replica ANF
...
### -ResourceId
ID risorsa del volume di origine della replica ANF
