...
## DESCRIZIONE
Si tratta di un cmdlet che consente di creare un oggetto profilo contatto di supporto durante la creazione o l'aggiornamento di un ticket di supporto. È necessario specificare i parametri seguenti obbligatori per la creazione di un ticket di supporto: 
