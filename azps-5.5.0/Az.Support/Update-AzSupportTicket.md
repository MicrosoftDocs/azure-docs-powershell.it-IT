...
## SYNOPSIS
Ticket di supporto per l'aggiornamento.
...
## DESCRIZIONE
Usare questo cmdlet per aggiornare il livello di gravità, lo stato o i dettagli di contatto del cliente di un ticket di supporto. L'aggiornamento del livello di gravità o dello stato di un ticket di supporto non è consentito quando il ticket viene assegnato a un tecnico del supporto. Se si vuole aggiornare il livello di gravità o lo stato dopo l'assegnazione del ticket, contattare il tecnico del supporto inviando una comunicazione sul ticket.
...
### Esempio 2: stato di aggiornamento del ticket di supporto.
```powershell
...
### Esempio 3: aggiornare i dettagli del contatto del ticket di supporto specificando l'oggetto contatto.
```powershell
...
### Esempio 4: Aggiornare la gravità del ticket di supporto usando l'oggetto ticket di supporto piping.
```powershell
...
### Esempio 5: aggiornare i dettagli di contatto del ticket di supporto specificando i singoli parametri di contatto.
```powershell
...
### Esempio 6: Aggiornare lo stato del ticket di supporto con l'oggetto ticket di supporto piping.
```powershell
...
Aggiorna i dettagli di contatto su SupportTicket.
...
### -InputObject
Oggetto risorsa SupportTicket aggiornato da questo cmdlet.
...
### -Name
Nome della risorsa SupportTicket aggiornata da questo cmdlet.
...
### -Gravità
Gravità dell'aggiornamento del supportTicket.
...
### -Stato
Stato di aggiornamento di SupportTicket.
