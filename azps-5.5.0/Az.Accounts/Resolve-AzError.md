...
## DESCRIZIONE
Risolve e visualizza informazioni dettagliate sugli errori nella sessione di PowerShell corrente, inclusa la posizione in cui si è verificato l'errore nello script, nella traccia dello stack e in tutte le eccezioni interne e aggregate. Per gli errori di Azure PowerShell fornisce altri dettagli sui problemi del servizio di debug, inclusi dettagli completi sulla richiesta e sulla risposta del server che ha causato l'errore.
...
Informazioni dettagliate sull'ultimo errore.

### Esempio 2: Risolvere tutti gli errori nella sessione
```
...
Visualizzare i dettagli di tutti gli errori che si sono verificati nella sessione corrente.
...
### -Error
Uno o più record di errore da risolvere.  Se non vengono specificati parametri, tutti gli errori nella sessione vengono risolti.
