...
### RemoveByInputObject (impostazione predefinita)
```
...
## DESCRIZIONE
Rimuovere un contesto azure dal set di contesti
...
Rimuovere il contesto denominato predefinito
...
### -Force
Rimuovere il contesto anche se è l'impostazione predefinita
...
### -PassThru
Restituire il contesto rimosso
