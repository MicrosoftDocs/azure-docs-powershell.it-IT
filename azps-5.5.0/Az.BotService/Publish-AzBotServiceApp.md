...
### Esempio 1: Pubblicare il servizio BotService in Azure
```powershell
PS C:\> Publish-AzBotServiceApp -ResourceGroupName youriBotTest -CodeDir D:\zips\MyEchoBot -Name youriechobottest

```

Pubblicare il servizio BotService in Azure tramite codice

## PARAMETERS

### -CodeDir
Questo parametro definisce il percorso del file ZIP
...
### -Name
Questo parametro definisce il nome del bot.
