...
### Esempio 1: Aggiornare il bot in base al nome e al nome del gruppo di risorse
```powershell
...
Aggiornare il bot in base al nome e al nome del gruppo di risorse

### Esempio 2: Aggiornare il bot in base a InputObject
```powershell
...
Aggiornare il bot in base a InputObject
...
Chiave API Application Insights
...
### -Kind
Obbligatorio.
Ottiene o imposta il tipo della risorsa.
...
### -Tag
Contiene tag di risorsa definiti come coppie chiave/valore.
...
INPUTOBJECT <IBotServiceIdentity> : parametro identity
  ...
  - `[ConnectionName <String>]`: nome della risorsa impostazione di connessione al servizio Bot
