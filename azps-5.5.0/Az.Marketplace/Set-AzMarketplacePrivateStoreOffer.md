...
## DESCRIZIONE
Aggiorna o crea un'offerta per l'archivio privato creato nell'ambito tenant.
...
Crea un'offerta con piani privati + pubblici per l'archivio privato creato nell'ambito tenant. 
...
Crea un'offerta con piani privati solo per l'archivio privato creato nell'ambito della sottoscrizione. 
...
Gli aggiornamenti offrono piani + pubblici privati per l'archivio privato creato nell'ambito tenant. È necessario un Etag.
...
Aggiornamenti dell'offerta per l'archivio privato con piani privati creati solo nell'ambito della sottoscrizione. È necessario un Etag.
...
### -ETag
ETag per l'aggiornamento dell'offerta di Azure Marketplace privato
...
Limitazione degli ID dei piani specifici dell'offerta di Azure Marketplace privata richiesta
