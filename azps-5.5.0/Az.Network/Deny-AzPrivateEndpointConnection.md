...
## DESCRIZIONE
Il cmdlet **Deny-AzPrivateEndpointConnection** impedisce una connessione all'endpoint privato.
...
Questo esempio impedisce una connessione all'endpoint privato.
