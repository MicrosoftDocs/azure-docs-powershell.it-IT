...
## DESCRIZIONE
Il cmdlet **Add-AzLoadBalancerInboundNatRuleConfig** aggiunge una configurazione della regola NAT (Network Address Translation) in ingresso in una bilanciamento del carico di Azure.

## ESEMPI

### Esempio 1: Aggiungere una configurazione di regola NAT in ingresso a una bilanciamento del carico
```
...
Il secondo comando usa l'operatore della pipeline per passare la bilanciamento del carico in $slb **ad Add-AzLoadBalancerInboundNatRuleConfig,** che aggiunge una configurazione della regola NAT in ingresso al bilanciamento del carico.

## PARAMETERS

### -BackendPort
Specifica la porta back-end per il traffico corrispondente a una configurazione di regola.
...
Specifica un ID per la configurazione di un indirizzo IP front-end.
...
### -FrontendPort
Specifica la porta front-end a cui corrisponde una configurazione di regola.
...
Questo cmdlet aggiunge una configurazione della regola NAT in ingresso alla bilanciamento del carico specificata da questo parametro.
...
### -Protocol
Specifica il protocollo a cui corrisponde una regola NAT in ingresso.
