...
## SYNOPSIS
Imposta la configurazione della rete di integrità in un Gateway applicazioni esistente.
...
Questo comando imposta la configurazione per un gruppo di integrità denominato "Pool05" per il gateway applicazione denominato Gateway.
Il comando imposta anche la soglia non integra su 8 tentativi e il timeout dopo 120 secondi.

### Esempio 2

Imposta la configurazione della rete di integrità in un Gateway applicazioni esistente. (autogenerated)
