...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayFirewallPolicy** crea un criterio firewall del gateway di applicazione.
...
Questo comando crea un nuovo criterio firewall del Gateway di applicazione Azure denominato "wafResource1" nel gruppo di risorse "rg1" nella posizione "westus" con regole personalizzate definite nella variabile $customRule>
...
### -PolicySetting
Impostazioni dei criteri per Firewall applicazione Web
