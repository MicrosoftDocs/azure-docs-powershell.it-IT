...
## DESCRIZIONE
**New-AzApplicationGatewayFirewallPolicyManagedRule** crea una regola gestita per un criterio firewall.
...
Il comando crea regole gestite un elenco di ManagedRuleSet con $managedRuleSet e un elenco di esclusioni con voci come $exclusion 1, $exclusion 2.
...
### -Exclusion
Elenco delle voci di esclusione.
...
### -ManagedRuleSet
Elenco dei set di regole gestiti.
