...
## DESCRIZIONE
Il cmdlet **Get-AzNetworkInterface** ottiene un'interfaccia di rete di Azure o un elenco di interfacce di rete di Azure in un gruppo di risorse.
...
Questo comando ottiene tutte le interfacce di rete per l'abbonamento corrente.
...
Questo comando recupera tutte le interfacce di rete del gruppo di risorse denominato ResourceGroup1 con lo stato di provisioning completato.

### Esempio 3: Ottenere le interfacce di rete con i filtri
```
...
Questo comando ottiene tutte le interfacce di rete per l'abbonamento corrente che iniziano con "test".
...
### -Name
Specifica il nome dell'interfaccia di rete che riceve questo cmdlet.
...
### -ResourceId
ID manager delle risorse di Azure dell'interfaccia di rete.
...
### -VirtualMachineIndex
Specifica l'indice della macchina virtuale del set di scalabilità della macchina virtuale da cui questo cmdlet ottiene le interfacce di rete.
...
Specifica il nome del set di scalabilità della macchina virtuale da cui questo cmdlet ottiene le interfacce di rete.
