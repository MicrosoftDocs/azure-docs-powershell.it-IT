...
Il secondo comando modifica la configurazione di reindirizzamento per il gateway applicazione in modo da reindirizzare il tipo Permanente e usa un URL di destinazione.

### Esempio 2

Imposta la configurazione di reindirizzamento in un Gateway applicazioni esistente. (autogenerated)
