...
## DESCRIZIONE
Il cmdlet **Set-AzApplicationGatewayAuthenticationCertificate** aggiorna un certificato di autenticazione per un gateway applicazione di Azure.

## ESEMPI

### Esempio 1: Aggiornare un certificato di autenticazione
```
...
Il secondo comando aggiorna il certificato di autenticazione denominato cert01 nel gateway applicazione.
Il terzo comando aggiorna il gateway applicazione.

## PARAMETERS

### -ApplicationGateway
Specifica il nome del gateway applicazione per il quale questo cmdlet aggiorna un certificato di autenticazione.
...
### -CertificateFile
Specifica il percorso del file del certificato di autenticazione con cui questo cmdlet aggiorna il certificato.
...
### -Name
Specifica il nome del certificato di autenticazione aggiornato da questo cmdlet.
