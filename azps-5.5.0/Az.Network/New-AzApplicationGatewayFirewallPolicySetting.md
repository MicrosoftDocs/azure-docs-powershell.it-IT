...
Il comando crea un'impostazione di criteri con stato $enabledState, modalità come $enabledMode, RequestCheck come false, FileUploadLimitInMb come $fileUploadLimitInMb e MaxRequest UnaridimensionaInKb come $$maxRequestBodySizeInKb.
Il nuovo policySettings viene archiviato in $condition.
...
### -DisableRequestCheck
Diables the requestCheck in policy settings of the firewall policy.
...
### -MaxFileUploadInMb
Dimensioni massime di caricamento file in MB.
...
MaxRequestRequestSizeInKb nelle impostazioni dei criteri del firewall.
