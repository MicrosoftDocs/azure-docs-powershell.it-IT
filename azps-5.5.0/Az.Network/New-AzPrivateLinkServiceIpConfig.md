...
Creare una configurazione IP del servizio di collegamento privato. (autogenerated)
...
### -PrivateIpAddress
Indirizzo IP privato della ipConfiguration se è specificata un'allocazione statica.
