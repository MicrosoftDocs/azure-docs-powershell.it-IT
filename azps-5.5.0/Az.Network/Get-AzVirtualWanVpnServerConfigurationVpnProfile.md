...
Il comando precedente genererà e restituirà l'URL della firma di accesso condiviso per il cliente per scaricare il profilo Vpn VirtualWan-VpnServerConfiguration livello per la configurazione del client Point to Site.
