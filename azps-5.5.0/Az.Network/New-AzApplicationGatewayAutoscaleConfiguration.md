...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayAutoscaleConfiguration crea** la configurazione di gradazione automatica per un gateway applicazione di Azure.
...
Il primo comando crea una configurazione di gradazioni automatica con capacità minima 3.
Il secondo comando crea un gateway applicazione con la configurazione della gradazione automatica.
