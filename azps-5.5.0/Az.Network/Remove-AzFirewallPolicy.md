...
## DESCRIZIONE
Il cmdlet **Remove-AzFirewallPolicy** rimuove un criterio del firewall di Azure.
...
Questo esempio rimuove il criterio del firewall denominato "firewallpolicy" nel gruppo di risorse "TestRg"
...
Questo esempio rimuove i criteri del firewall in base all'ID.
...
Questo esempio rimuove i criteri del firewall $fp
