...
## DESCRIZIONE
Il cmdlet **Get-AzDelegation** ottiene la delega denominata da una subnet. Se non viene specificata alcuna delega, restituisce tutte le delegazioni nella subnet specificata.
