...
## DESCRIZIONE
**Set-AzNetworkInterfaceTapConfig** aggiorna una configurazione di tocco per un'interfaccia di rete.

## ESEMPI

### Esempio 1: Impostare la configurazione TapConfiguration con il nome TapConfig aggiornato
```
...
Configurazione di Tocco Di NetworkInterface
