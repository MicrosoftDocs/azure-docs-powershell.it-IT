...
```
I comandi precedenti otterrà la RoutingConfiguration di un AzVHubRoute già esistente e aggiungeranno una route statica nella connessione. In alternativa, se si desidera creare una nuova connessione con la route statica al suo interno, vedere l'esempio 1 [qui.](New-AzRoutingConfiguration.md)
## PARAMETERS
