...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayTrustedRootCertificate aggiunge** un certificato radice attendibile a un gateway applicazione di Azure.
...
Il secondo comando aggiunge un nuovo certificato radice attendibile al Gateway applicazione, prendendo come input il percorso del certificato radice.
Il terzo comando crea una nuova impostazione HTTP back-end usando il certificato radice attendibile per convalidare il certificato del server back-end.
Il quarto comando aggiorna il Gateway applicazioni.
