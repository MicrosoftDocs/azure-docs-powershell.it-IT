...
## DESCRIZIONE
I cmdlet **Set-AzExpressRouteCircuit DigitaingConfig** salvano di nuovo una configurazione peering expressRoute modificata in Azure.
...
Salva una configurazione peering expressRoute modificata. (autogenerated)
