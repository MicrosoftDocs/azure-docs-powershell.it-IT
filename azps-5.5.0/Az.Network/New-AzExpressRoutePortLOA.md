...
## SYNOPSIS
Scarica la lettera di autorizzazione per una porta Express Route.
...
## DESCRIZIONE
New-AzExpressRoutePortLOA cmdlet scarica una lettera di autorizzazione in formato PDF per una porta Express Route.
...
Scaricare la lettera di autorizzazione per la porta Express Route "myPort" e archiviarla nel file "loa.pdf".
...
### -CustomerName
Nome del cliente a cui è assegnata la porta Express Route.
...
### -Destination
Percorso file di output in cui archiviare la lettera di autorizzazione.
...
### -ExpressRoutePort
Risorsa per la porta Express Route.
...
### -PortName
Nome della porta Express Route.
...
### -ResourceGroupName
Nome del gruppo di risorse della porta Express Route.
