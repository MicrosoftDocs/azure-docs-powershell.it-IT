...
## SYNOPSIS
Ottiene una configurazione di peering tra connessioni incrociate di ExpressRoute.
...
## DESCRIZIONE
Il cmdlet **Get-AzExpressRouteCrossConnectionEndoing** recupera la configurazione di una relazione di peering per una connessione incrociata ExpressRoute.

## ESEMPI

### Esempio 1: Visualizzare la configurazione del peering per una connessione incrociata ExpressRoute
```
...
Oggetto di connessione incrociata ExpressRoute contenente la configurazione di peering.
