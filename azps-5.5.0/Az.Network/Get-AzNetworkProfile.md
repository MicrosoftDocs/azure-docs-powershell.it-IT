...
In questo modo viene recuperato il profilo di rete np1 nel gruppo di risorse rg1
...
Vengono recuperati i profili di rete che iniziano con "np"
...
### -ResourceId
ID manager delle risorse di Azure del profilo di rete.
