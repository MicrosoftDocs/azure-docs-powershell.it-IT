...
## SYNOPSIS
Crea un elemento dell'ambito endpoint del monitor della connessione.
...
## DESCRIZIONE
Il cmdlet New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject crea l'elemento dell'ambito dell'endpoint.
...
### -Address
Indirizzo dell'elemento di ambito.
