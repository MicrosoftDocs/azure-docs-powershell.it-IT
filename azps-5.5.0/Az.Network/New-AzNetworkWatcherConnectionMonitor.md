...
## SYNOPSIS
Crea una risorsa di monitor della connessione.
...
## DESCRIZIONE
Il cmdlet New-AzNetworkWatcherConnectionMonitor crea una risorsa di monitor di connessione per il monitor di connessione di origine e destinazione specificato (monitor di connessione SingleSourcedestination) o per un set di gruppi di test (MultiEndpointConnectionMonitor).
...
### -ConfigureOnly
Configurare il monitor di connessione, ma non avviarlo
...
### -DestinationAddress
Indirizzo della destinazione del monitor di connessione (IP o nome di dominio).
...
### -DestinationPort
Porta di destinazione utilizzata dal monitor di connessione.
...
ID della risorsa usata come destinazione dal monitor di connessione.
...
Intervallo di monitoraggio in secondi. Il valore predefinito è 60 secondi.
...
### -Name
Nome del monitor di connessione.
...
### -Output
Descrive le destinazioni di output del monitor di connessione.
...
### -SourcePort
La porta di origine usata dal monitor di connessione.
...
### -SourceResourceId
ID della risorsa usata come origine dal monitor di connessione.
