...
## SYNOPSIS
Rimuove un'istanza di P2SVpnGateway esistente.
...
## DESCRIZIONE
Il cmdlet **Remove-AzP2sVpnGateway** consente di rimuovere un P2SVpnGateway esistente in VirtualHub. Dopo la rimozione di P2SVpnGateway, la connettività dei client del sito avrà esito negativo.
...
### -ResourceId
ID della risorsa Azure per p2sVpnGateway da eliminare.
