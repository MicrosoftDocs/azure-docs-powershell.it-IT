...
Questo esempio crea una rete virtuale in un gruppo di risorse e quindi la elimina immediatamente. Per eliminare la richiesta quando si elimina la rete virtuale, usare il contrassegno -Force.
...
### -Name
Specifica il nome della rete virtuale rimossa dal cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene la rete virtuale rimossa dal cmdlet.
