...
## DESCRIZIONE
Il cmdlet **Get-AzPrivateLinkResource** recupera tutte le risorse di collegamento che appartengono a PrivateLinkResource.
...
In questo esempio vengono elencate tutte le risorse di collegamento privato da sql server denominato mySql a sql server.
...
ID manager delle risorse di Azure della risorsa collegamento privato.
