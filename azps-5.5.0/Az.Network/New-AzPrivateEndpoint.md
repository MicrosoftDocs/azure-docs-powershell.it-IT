...
L'esempio seguente crea un endpoint privato con un ID del servizio di collegamento privato specifico nella subnet specificata in una rete virtuale.
...
Non chiedere conferma per sovrascrivere una risorsa.
...
Specifica una posizione per l'endpoint privato. Usare [Get-AzLocation per](/powershell/module/az.resources/get-azlocation) determinare i valori validi per questo parametro.
...
ID della risorsa per connettere l'endpoint privato.
