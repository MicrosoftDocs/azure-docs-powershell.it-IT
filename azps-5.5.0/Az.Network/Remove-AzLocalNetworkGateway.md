...
Il cmdlet **Remove-AzLocalNetworkGateway** elimina l'oggetto che rappresenta il gateway locale in base al nome e al nome del gruppo di risorse.

## ESEMPI

### Esempio 1: Eliminare un Gateway di rete locale
```powershell
Remove-AzLocalNetworkGateway -Name myLocalGW -ResourceGroupName myRG
```

Elimina l'oggetto del Gateway di rete locale con il nome "myLocalGW" all'interno del gruppo di risorse "myRG" Nota: è necessario eliminare prima tutte le connessioni al Gateway di rete locale usando il cmdlet **Remove-AzVirtualNetworkGatewayConnection.**
...
### -Name
Specifica il nome del gateway di rete locale rimosso dal cmdlet.
