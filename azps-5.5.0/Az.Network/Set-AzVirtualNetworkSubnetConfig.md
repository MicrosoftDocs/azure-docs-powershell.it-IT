...
Questo esempio crea una rete virtuale con una subnet. Viene quindi chiamato Set-AzVirtualNetworkSubnetConfig modificare il prefisso dell'indirizzo della subnet. Questo problema influisce solo sulla rappresentazione in memoria della rete virtuale. Set-AzVirtualNetwork viene quindi chiamata per modificare la rete virtuale in Azure.
