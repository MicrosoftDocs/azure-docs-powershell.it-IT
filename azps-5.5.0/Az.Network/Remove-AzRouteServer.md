...
## SYNOPSIS
Elimina un server di route di Azure.
...
## DESCRIZIONE
Il cmdlet **Remove-AzRouteServer** elimina un Azure RouteServer
...
### -InputObject
Oggetto di input del server di route.
...
### -ResourceId
ID di risorsa del server di route.
