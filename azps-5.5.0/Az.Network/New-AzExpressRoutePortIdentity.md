...
## DESCRIZIONE
Il cmdlet **New-AzExpressRoutePortIdentity** crea un oggetto Identità Azure ExpressRoutePort locale. Usare **New-AzExpressRoutePort** o **Set-AzExpressRoutePort** per assegnarlo ad Azure ExpressRoutePort.
