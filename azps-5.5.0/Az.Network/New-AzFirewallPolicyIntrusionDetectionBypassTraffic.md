...
## SYNOPSIS
Crea una nuova impostazione del traffico bypass per il rilevamento delle intrusioni dei criteri del firewall di Azure
...
## DESCRIZIONE
Il cmdlet **New-AzFirewallPolicyIntrusionDetectionBypassTraffic** crea un oggetto traffico di bypass per il rilevamento delle intrusioni dei criteri del firewall di Azure.

## ESEMPI

### Esempio 1: 1. Creare il traffico bypass con una porta e un indirizzo di origine specifici
```powershell
...
### -Descrizione
Ignora descrizione impostazione.
...
### -DestinationAddress
Elenco di indirizzi IP o intervalli IP di destinazione.
...
### -DestinationIpGroup
Elenco dei gruppi IpGroup di destinazione.
...
### -DestinationPort
Elenco di porte o intervalli di destinazione.
...
### -Protocol
Bypassare il protocollo di impostazione.
...
### -SourceAddress
Elenco di indirizzi IP o intervalli di origine.
...
### -SourceIpGroup
Elenco dei gruppi IpGroup di origine.
