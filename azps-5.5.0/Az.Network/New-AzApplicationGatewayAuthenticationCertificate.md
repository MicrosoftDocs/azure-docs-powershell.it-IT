...
## SYNOPSIS
Crea un certificato di autenticazione per un gateway applicazioni.
...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayAuthenticationCertificate crea** un certificato di autenticazione per un gateway applicazione di Azure.

## ESEMPI

### Esempio 1: Creare un certificato di autenticazione
```
PS C:\> $cert = New-AzApplicationGatewayAuthenticationCertificate -Name "cert01" -CertificateFile "C:\cert.cer"
```

Il primo comando crea il certificato di autenticazione denominato cert01.
