...
Se non è disponibile un certificato X.509, è possibile generarne uno tramite l'infrastruttura della chiave pubblica oppure usare un generatore di certificati, ad esempio makecert.exe.
