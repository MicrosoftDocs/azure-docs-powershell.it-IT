...
### Esempio 2: Eliminare un circuito ExpressRoute usando la pipeline
```
...
### -Name
Nome del circuito ExpressRoute da rimuovere.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse a cui appartiene questo circuito ExpressRoute.
