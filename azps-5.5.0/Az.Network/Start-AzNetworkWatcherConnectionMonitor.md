...
## DESCRIZIONE
Il Start-AzNetworkWatcherConnectionMonitor cmdlet avvia il monitor di connessione specificato.
...
In questo esempio viene avviato il monitor di connessione specificato per nome e network watcher
