...
## DESCRIZIONE
Il cmdlet **Update-AzCustomIpPrefix** consente all'utente di commissionare o rimuovere il formato CustomIpPrefix oppure di modificare i tag della risorsa.
...
### Esempio 2: Rimuovere il suffisso CustomIpPrefix
```powershell
