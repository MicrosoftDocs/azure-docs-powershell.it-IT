...
## SYNOPSIS
Aggiunge una catena di certificati CA client attendibili a un gateway applicazioni.
...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayTrustedClientCertificate aggiunge** una catena di certificati CA del client attendibile a un gateway applicazione di Azure.
...
Il primo comando recupera il gateway applicazione e lo archivia in $gw variabile. Il secondo comando crea una nuova catena di certificati CA del client attendibile che prende come input il percorso del certificato CA client. Il terzo comando crea un profilo SSL usando un certificato client attendibile. Il quarto comando aggiorna il Gateway applicazioni.
