...
## DESCRIZIONE
Il cmdlet New-AzIpsecPolicy crea una proposta per il criterio IPSec da usare in una connessione a un gateway di rete virtuale.
...
Creazione di un criterio IPSec da usare per una nuova connessione a un gateway di rete virtuale.
...
### -DhGroup
Gruppi DH usati nella fase 1 di IKE per l'accesso condiviso iniziale
...
### -IpsecEncryption
Algoritmo di crittografia IPSec (Fase IKE 2)
...
### -IpsecIntegrity
Algoritmo di integrità IPSec (Fase IKE 2)
...
### -PfsGroup
Gruppi DH usati nella fase 2 di IKE per la nuova SA figlio
...
### -SADataSizeKilobytes
Dimensione del payload dell'associazione di sicurezza IPSec (chiamata anche modalità rapida o sa di fase 2) in KB
...
### -SALifeTimeSeconds
Durata in secondi dell'associazione di sicurezza IPSec (chiamata anche modalità rapida o sa di fase 2)
