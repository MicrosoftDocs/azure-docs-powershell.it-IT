...
### -AuthorizationKey
Chiave di autorizzazione per il circuito Express Route peer in un altro abbonamento. L'autorizzazione sul circuito peer può essere creata usando comandi esistenti.
