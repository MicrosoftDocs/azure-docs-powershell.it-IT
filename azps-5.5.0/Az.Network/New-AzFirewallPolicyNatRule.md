...
## DESCRIZIONE
Il cmdlet **New-AzFirewallPolicyNatRule** crea una regola NAT per un criterio firewall di Azure.
...
Questo esempio crea una regola NAT con l'indirizzo di origine, il protocollo, l'indirizzo di destinazione, la porta di destinazione, l'FQDN tradotto e la porta tradotta.
...
### -DestinationAddress
Indirizzi di destinazione della regola. Questo deve essere l'indirizzo IP pubblico del firewall.
...
### -TranslatedFqdn
FQDN tradotti per questa regola NAT
...
### -TranslatedPort
La porta tradotta per questa regola NAT
