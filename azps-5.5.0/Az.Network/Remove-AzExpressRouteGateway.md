...
Questo esempio crea un gruppo di risorse, una WAN virtuale, un hub virtuale, un gateway ExpressRoute scalabile negli Stati Uniti centrali e quindi lo elimina immediatamente. Per eliminare la richiesta di conferma dell'eliminazione del Gateway virtuale, usare il contrassegno -Force.
In questo modo verranno eliminati expressRouteGateway e tutte le connessioni ExpressRoute Associate ad esso.
...
### -ResourceId
ID della risorsa Azure per ExpressRouteGateway da eliminare.
