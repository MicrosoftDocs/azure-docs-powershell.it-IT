...
## DESCRIZIONE
Il cmdlet **New-AzFirewallPolicyNatRuleCollection crea** una raccolta di regole Nat per un criterio firewall di Azure.
...
Questo esempio crea una raccolta di regole NAT con una regola di rete

## PARAMETERS

### -ActionType
Tipo di azione della regola
...
### -Name
Nome della raccolta di regole di rete
