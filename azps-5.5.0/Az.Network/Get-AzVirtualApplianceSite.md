...
## SYNOPSIS
Ottenere o elencare i siti connessi alle risorse di Network Virtual Appliance.
...
## DESCRIZIONE
LGet-AzVirtualApplianceSite ottiene o elenca i siti connessi a una o più risorse di Appliance virtuali di rete.
...
Ottenere una risorsa del sito Appliance virtuale.
...
Elencare le risorse del sito Appliance virtuale in un'appliance virtuale di rete.
...
Appliance virtuale di rete a cui è collegato il sito.
...
### -ResourceId
ID della risorsa del sito dell'appliance virtuale.
