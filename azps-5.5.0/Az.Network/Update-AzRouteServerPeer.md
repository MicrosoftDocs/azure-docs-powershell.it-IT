...
## SYNOPSIS
Aggiornare un peer in un RouteServer di Azure
...
### RouteServerNParamenameParameterSet
```
...
## DESCRIZIONE
Il cmdlet **Update-AzRouteServer Firmware** aggiorna un peer RouteServer a un Azure RouteServer
...
### -InputObject
Oggetto di input peer del server di route.
...
### -PeerAsn
ASN del peer del server route remoto.
...
### -PeerIp
Ip del peer del server route remoto.
...
### -PeerName
Nome del peer del server di route.
...
### -ResourceGroupName
Nome del gruppo di risorse del server/peer della route.
...
### -ResourceId
ID della risorsa peer del server di route.
...
### -RouteServerName
Server di route in cui è presente il peer.
...
### Microsoft.Azure.Commands.Network.Models.PSRouteServerDir
