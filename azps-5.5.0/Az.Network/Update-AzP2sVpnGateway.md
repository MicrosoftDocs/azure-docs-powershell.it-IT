...
## SYNOPSIS
Aggiornare unway P2SVpnGateway esistente in VirtualHub per la connettività del sito punto a punto.
...
Aggiornare unway P2SVpnGateway esistente in VirtualHub per la connettività del sito punto a punto. (autogenerated)
...
Disabilitare il contrassegno di sicurezza Internet per le connessioni P2SVpnGateway
