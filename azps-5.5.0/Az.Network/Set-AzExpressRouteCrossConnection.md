...
## DESCRIZIONE
Il cmdlet **Set-AzExpressRouteCrossConnection** salva la connessione incrociata ExpressRoute modificata ad Azure.

## ESEMPI

### Esempio 1: Modificare lo stato di provisioning del provider di servizi di una connessione incrociata ExpressRoute
```
...
Specifica **l'oggetto ExpressRouteCrossConnection** modificato da questo cmdlet.
...
### -Peering
Elenco di peering per la connessione incrociata
