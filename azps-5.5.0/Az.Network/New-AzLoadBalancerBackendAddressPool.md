...
## SYNOPSIS
Crea un pool di indirizzi back-end su un carico di carico. 
...
## DESCRIZIONE
Crea un pool di indirizzi back-end su un carico di carico. Consente di specificare una matrice di PSLoadBalancerBackendAddress. 
## ESEMPI
...
### -LoadBalancer
Risorsa di bilanciamento del carico.
...
### -ResourceGroupName
Nome del gruppo di risorse per il bilanciamento del carico.
