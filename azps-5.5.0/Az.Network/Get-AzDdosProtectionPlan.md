...
## DESCRIZIONE
Il Get-AzDdosProtectionPlan cmdlet ottiene un piano di protezione DDoS.
...
In questo caso, è necessario specificare gli attributi **ResourceGroupName** e **Name,** che corrispondono rispettivamente al gruppo di risorse e al nome del piano di protezione DDoS.
...
In questo scenario viene specificato solo il parametro **ResourceGroupName** per ottenere un elenco di piani di protezione DDoS.

### Esempio 3: Ottenere tutti i piani di protezione DDoS in un abbonamento
```
...
Qui non viene specificato alcun parametro per ottenere un elenco di tutti i piani di protezione DDoS in un abbonamento.

### Esempio 4: Ottenere tutti i piani di protezione DDoS in un abbonamento
```
...
Questo cmdlet restituisce tutti gli elementi DdosProtectionPlan che iniziano con "test".
