...
## DESCRIZIONE
Il cmdlet **Get-AzApplicationGatewayRequestRoutingRule** ottiene la regola di routing delle richieste di un gateway applicazione.

## ESEMPI

### Esempio 1: Ottenere una regola di routing delle richieste specifica
```
...
Il secondo comando recupera la regola di routing delle richieste denominata Rule01 dal Gateway applicazione archiviata nella variabile $AppGW.

### Esempio 2: Ottenere un elenco di regole di routing delle richieste
```
PS C:\>$AppGW = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
...
Il primo comando recupera il gateway applicazione denominato ApplicationGateway01 e archivia il risultato nella variabile $AppGW.
Il secondo comando ottiene un elenco di regole di routing delle richieste dal Gateway applicazione archiviato nella variabile $AppGW.

## PARAMETERS

### -ApplicationGateway
Specifica l'oggetto gateway applicazione che contiene la regola di routing delle richieste.
...
### -Name
Specifica il nome della regola di routing delle richieste recuperata da questo cmdlet.
