...
## SYNOPSIS
Rimuove una configurazione di tocco da un'interfaccia di rete specifica
...
Questo comando rimuove TapConfiguration da NetworkInterface1 in un gruppo di risorse ResourceGroup1.
...
### -Name
Nome del peering della rete virtuale.
