...
## DESCRIZIONE
Il cmdlet **Get-AzApplicationGatewaySslPolicy** ottiene il criterio SSL di un gateway applicazione.
...
Il secondo comando recupera i criteri SSL dal Gateway applicazione archiviati nella variabile $AppGW.

## PARAMETERS

### -ApplicationGateway
Specifica il gateway applicazione del criterio SSL che riceve questo cmdlet.
