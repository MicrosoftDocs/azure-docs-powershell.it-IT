...
## DESCRIZIONE
Il cmdlet **Get-AzServiceEndpointPolicyDefinition ottiene** la definizione di un criterio dell'endpoint del servizio.
...
Questo comando recupera la definizione del criterio dell'endpoint del servizio denominata ServiceEndpointPolicyDefinition1 in ServiceEndpointPolicy $Policy la archivia nella variabile $policydef servizio.
...
Criteri dell'endpoint del servizio
