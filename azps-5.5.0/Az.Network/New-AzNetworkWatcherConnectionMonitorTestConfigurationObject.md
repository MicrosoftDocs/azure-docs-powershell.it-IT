...
## SYNOPSIS
Creare una configurazione di test del monitor di connessione.
...
### -PreferredIPVersion
La versione IP preferita da usare nella valutazione di test. Il monitor di connessione può scegliere di usare una versione diversa a seconda di altri parametri.
