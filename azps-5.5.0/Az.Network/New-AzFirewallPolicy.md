...
### Esempio 2: 2. Creare criteri vuoti con la modalità ThreatIntel
```powershell
...
### Esempio 3: 3. Creare criteri vuoti con ThreatIntel Whitelist
```powershell
...
### Esempio 4: 4. Creare criteri con rilevamento delle intrusioni, sicurezza dell'identità e del trasporto
```powershell
...
### -Identity
Identità dei criteri del firewall da assegnare ai criteri del firewall.
...
### -IntrusionDetection
Impostazione rilevamento delle intrusioni
