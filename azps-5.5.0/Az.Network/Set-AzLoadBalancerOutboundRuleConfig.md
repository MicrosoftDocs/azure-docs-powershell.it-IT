...
## DESCRIZIONE
Il cmdlet **Set-AzLoadBalancerOutboundRuleConfig imposta** una configurazione della regola in uscita per una bilanciamento del carico di Azure.

## ESEMPI

### Esempio 1: Modificare la configurazione della regola in uscita in un servizio di bilanciamento del carico
```powershell
...
Il secondo comando usa l'operatore della pipeline per passare la bilanciamento del carico in $slb ad Add-AzLoadBalancerOutboundRuleConfig, che aggiunge una configurazione della regola in uscita.
Il terzo comando passa la bilanciamento del carico **a Set-AzLoadBalancerOutboundRuleConfig,** che salva e aggiorna la configurazione della regola in uscita.
