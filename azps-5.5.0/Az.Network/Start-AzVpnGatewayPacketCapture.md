...
## SYNOPSIS
Avvia l'operazione di acquisizione pacchetti in un Gateway Vpn.
...
### -FilterData
Opzioni di filtro per avviare l'acquisizione di pacchetti in Gateway Vpn.
...
### -Name
Nome del Gateway Vpn in cui deve essere avviata l'acquisizione di pacchetti.
