...
Il cmdlet New-AzVirtualHubVnetConnection crea una risorsa HubVirtualNetworkConnection che peera una rete virtuale all'hub virtuale di Azure. (autogenerated)
...
```
Quanto descritto sopra creerà una nuova configurazione di routing e creerà route statiche nella configurazione di routing con l'hop successivo come indirizzo IP specificato. Questa configurazione di routing può essere passata al comando New-AzVirtualHubVnetConnection come parametro -RoutingConfiguration.
...
La rete virtuale remota a cui è connessa questa connessione di rete virtuale dell'hub.
