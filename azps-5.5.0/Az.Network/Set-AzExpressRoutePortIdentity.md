...
## DESCRIZIONE
Il cmdlet **Set-AzExpressRoutePortIdentity** aggiorna un oggetto Azure ExpressRoutePort locale. Usare **Set-AzExpressRoutePort** per assegnarlo a ExpressRoutePort.
...
ResourceId dell'identità assegnata all'utente da assegnare a ExpressRoutePort.
