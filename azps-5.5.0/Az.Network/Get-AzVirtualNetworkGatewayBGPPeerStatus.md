...
## DESCRIZIONE
Questo comando enumera i peer BGP con cui è configurato un gateway di rete virtuale di Azure. Viene fornito anche lo stato di ogni peer.
...
Recupera i peer BGP per il gateway di rete virtuale di Azure denominato gatewayName nel gruppo di risorse ResourceGroup.
Questo output di esempio mostra un peer BGP connesso, con un indirizzo IP di 10.0.0.254.
...
### -Peer
IP del peer per cui recuperare lo stato
...
### Microsoft.Azure.Commands.Network.Models.PSBGPStatus
