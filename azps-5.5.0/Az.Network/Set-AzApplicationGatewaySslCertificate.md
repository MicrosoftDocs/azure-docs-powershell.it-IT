...
### Esempio 1: Aggiornare un certificato SSL esistente nel Gateway applicazione
```
...
### Esempio 2: Aggiornare un certificato SSL esistente usando KeyVault Secret (version-less secretId) in Gateway applicazione
```
...
### Esempio 3: Aggiornare un certificato SSL esistente usando il segreto KeyVault nel Gateway applicazione
```
PS C:\> $secret = Get-AzKeyVaultSecret -VaultName "keyvault01" -Name "sslCert01"
...
### -KeyVaultSecretId
SecretId (URI) del segreto KeyVault. Usare questa opzione quando è necessario usare una specifica versione di segreto.
