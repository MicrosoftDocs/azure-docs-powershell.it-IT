...
## DESCRIZIONE
Il cmdlet **Get-AzApplicationGatewayFirewallPolicy** ottiene un criterio firewall del gateway di applicazione.
...
Questo comando recupera il criterio firewall del gateway applicazione denominato FirewallPolicy1 che appartiene al gruppo di risorse denominato ResourceGroup01 e lo archivia nella $AppGwFirewallPolicy variabile.
