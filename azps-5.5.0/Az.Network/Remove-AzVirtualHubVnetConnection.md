...
Dopo la creazione della connessione alla rete virtuale dell'hub, la connessione alla rete virtuale dell'hub viene rimossa usando i piping di PowerShell sull'output di Get-AzHubVirtualNetworkConnection.
