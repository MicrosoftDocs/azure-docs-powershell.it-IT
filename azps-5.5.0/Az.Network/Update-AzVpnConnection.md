...
## DESCRIZIONE
Il cmdlet **Update-AzVpnConnection** aggiorna una connessione VPN.  
La connessione VPN crea una connessione IPsec che connette un gateway VPN a un ramo del cliente remoto rappresentato in Azure come sito VPN.
...
La connessione viene quindi aggiornata in modo da avere un nuovo IpSecPolicy usando il comando Set-AzVpnConnection.
...
La connessione viene quindi aggiornata in modo da avere una nuova chiave condivisa usando il costrutto di stringa di sicurezza.
...
### -InputObject
L'oggetto VpnConnection da aggiornare.
...
### -ResourceId
ID risorsa dell'oggetto VpnConnection da eliminare.
...
L'elenco di VpnSiteLinkConnections di cui ha bisogno vpnConnection.
