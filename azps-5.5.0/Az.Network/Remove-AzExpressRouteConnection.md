...
Una volta creato, il gateway viene connesso al sito ExpressRoute usando il comando New-AzExpressRouteConnection>
...
Come l'esempio 1, ma ora rimuove la connessione con l'oggetto pipe da Get-AzExpressRouteConnection.
