...
## SYNOPSIS
Elencare i percorsi annunciati da uno specifico peer di router virtuale
...
## DESCRIZIONE
Dato un peer di router virtuale per nome o per oggetto, enumerare le route annunciate al peer da uno specifico router virtuale.
...
### -ResourceGroupName
Nome del gruppo di risorse peer per router virtuale
