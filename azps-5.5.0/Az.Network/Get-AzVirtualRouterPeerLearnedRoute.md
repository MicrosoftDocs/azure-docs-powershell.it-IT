...
## SYNOPSIS
Elencare i percorsi appresi da uno specifico peer di router virtuale
...
## DESCRIZIONE
Consente di enumerare le route acquisite dal peer di un router virtuale da altre origini.
