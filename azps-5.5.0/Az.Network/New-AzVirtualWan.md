...
## DESCRIZIONE
Crea una nuova risorsa Azure VirtualWAN.
...
La procedura descritta in precedenza consente di creare un gruppo di risorse "testRG" nell'area "Stati Uniti occidentali" e una WAN virtuale di Azure con traffico di succursale consentito in quel gruppo di risorse in Azure.

## PARAMETERS

### -AllowBranchToBranchTraffic
Consentire il traffico di succursale per VirtualWan.
...
Consentire il traffico da vnet a vnet per VirtualWan.
...
### -Location
Posizione della risorsa VirtualWAN.
