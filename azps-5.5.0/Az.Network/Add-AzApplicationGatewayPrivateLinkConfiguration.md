...
## SYNOPSIS
Aggiunge una configurazione di collegamento privato a un gateway applicazioni.
...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayPrivateLinkConfiguration** aggiunge una configurazione di collegamento privato a un gateway di applicazione.
...
Il primo comando crea una configurazione privataLinkIpConfiguration e la archivia nella $PrivateLinkIpConfiguration variabile.
