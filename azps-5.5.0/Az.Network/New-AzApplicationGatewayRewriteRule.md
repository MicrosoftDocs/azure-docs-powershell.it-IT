...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayRewriteRule** crea una regola di riscrittura per un gateway applicazione di Azure.
...
Questo comando crea una regola di riscrittura denominata regola1 e archivia il risultato nella variabile $rule.

## PARAMETERS

### -ActionSet
ActionSet della regola di riscrittura
...
### -RuleSequence
L'ordinamento delle regole di questa regola di riscrittura nel set di regole di riscrittura
