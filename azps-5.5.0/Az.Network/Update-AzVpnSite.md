...
Una volta creato, il sito aggiorna IpAddress del sito usando il comando Set-AzVpnSite>
...
### -ResourceId
ID della risorsa Azure per il sito vpn.
...
### -VirtualWan
Il virtualwan a cui deve essere connesso questo sito Vpn.
...
### -VirtualWanId
Il valore ResourceId VirtualWan a cui deve essere connesso questo sito Vpn.
