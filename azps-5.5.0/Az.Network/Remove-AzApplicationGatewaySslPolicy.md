...
## DESCRIZIONE
Il cmdlet Remove-AzApplicationGatewaySslPolicy rimuove i criteri SSL da un gateway applicazione di Azure.

## ESEMPI

### Esempio 1: Rimuovere un criterio SSL da un gateway applicazioni
```
PS C:\>$AppGW = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> $AppGW = Remove-AzApplicationGatewaySslPolicy -ApplicationGateway $AppGW
```

Questo comando rimuove il criterio SSL dal gateway applicazione denominato ApplicationGateway01.

## PARAMETERS

### -ApplicationGateway
Specifica il gateway applicazione da cui questo cmdlet rimuove i criteri SSL.
