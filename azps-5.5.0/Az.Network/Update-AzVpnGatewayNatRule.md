...
## SYNOPSIS
Aggiorna una regola NAT associata a VpnGateway.
...
In questo modo verrà creato un gruppo di risorse, una WAN virtuale, una rete virtuale e un hub virtuale. Verrà quindi creata VpnGateway nell'hub virtuale. Creare quindi una nuova regola NAT associata a VpnGateway creata.
Usare questo comando: Update-AzVpnGatewayNatRule, aggiornare la regola NAT.
