...
## DESCRIZIONE
Il cmdlet **Remove-AzNetworkInterface rimuove** un'interfaccia di rete di Azure.
...
Poiché viene *usato* il parametro Force, all'utente non viene richiesta conferma.
...
### -Name
Specifica il nome dell'interfaccia di rete rimossa dal cmdlet.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse che contiene l'interfaccia di rete rimossa dal cmdlet.
