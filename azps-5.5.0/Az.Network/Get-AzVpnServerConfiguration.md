...
## DESCRIZIONE
Il cmdlet **Get-AzVpnServerConfiguration restituisce** l'istanza VpnServerConfiguration esistente per la connettività punto a sito.
...
Il comando precedente otterrà la VpnServerConfiguration esistente.
