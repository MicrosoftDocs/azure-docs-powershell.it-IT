...
### -Name
Nome dell'endpoint cloud. Una volta creato tramite il portale di Azure, il nome viene impostato sul nome della condivisione file di Azure a cui fa riferimento.
