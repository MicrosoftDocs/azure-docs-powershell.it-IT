...
## DESCRIZIONE
Questo comando elenca tutti gli endpoint del server all'interno di un determinato gruppo di sincronizzazione. Può essere usato per elencare anche gli attributi di ogni endpoint server.
...
Questo comando recupera tutti gli endpoint del server contenuti nel gruppo di sincronizzazione specificato. Specificare -ServerEndpointName per restituire un nome specifico.
