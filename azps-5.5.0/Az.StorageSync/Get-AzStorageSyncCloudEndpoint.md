...
## DESCRIZIONE
Questo comando elenca tutti gli endpoint cloud all'interno di un determinato gruppo di sincronizzazione. Può essere usato per elencare anche gli attributi di ogni endpoint cloud.
