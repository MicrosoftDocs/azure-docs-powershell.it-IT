...
## DESCRIZIONE
Questo comando consente di apportare modifiche ai parametri modificabili di un endpoint server. Ad esempio, i criteri di livelli del cloud e di livelli del cloud possono essere modificati in qualsiasi momento. Diversi aspetti di un endpoint server, ad esempio il percorso locale, non possono essere modificati dopo la creazione dell'endpoint del server.
