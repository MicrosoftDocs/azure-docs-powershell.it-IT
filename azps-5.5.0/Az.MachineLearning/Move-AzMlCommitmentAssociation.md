...
## DESCRIZIONE
Sposta una risorsa di associazione dell'impegno dal piano di impegno padre a un altro piano di impegno.

## ESEMPI

### Esempio 1: Spostare un'associazione di impegno
```
...
### -DestinationPlanId
ID della risorsa Azure del piano di impegno di Azure ML di destinazione.
