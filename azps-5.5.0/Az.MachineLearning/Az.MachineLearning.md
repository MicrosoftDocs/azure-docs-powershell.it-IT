...
## Descrizione
Cmdlet di Servizi Web di apprendimento automatico per Gestione risorse di Azure

## Cmdlet di Az.MachineLearning
### [Add-AzMlWebServiceRegionalProperty](Add-AzMlWebServiceRegionalProperty.md)
Crea proprietà del servizio Web locale.

### [Export-AzMlWebService](Export-AzMlWebService.md)
Esporta l'oggetto definizione del servizio Web come stringa in formato JSON.
...
Sposta un'associazione di impegno da un piano di impegno a un altro.

### [New-AzMlCommitmentPlan](New-AzMlCommitmentPlan.md)
Crea un nuovo piano di impegno.
