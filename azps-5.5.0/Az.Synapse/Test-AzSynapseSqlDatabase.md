...
## SYNOPSIS
Verifica la presenza di un database synapse Analytics SQL database.
...
## DESCRIZIONE
Il cmdlet **Test-AzSynapseSqlDatabase** verifica l'esistenza di un database di SQL Synapse Analytics.
...
Questo comando verifica l'esistenza della cartella di SQL database.
...
### -Name
Nome dell'account synapse SQL Database.
