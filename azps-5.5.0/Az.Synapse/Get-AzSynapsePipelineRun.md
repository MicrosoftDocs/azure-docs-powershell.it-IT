...
## DESCRIZIONE
Il **comando Get-AzSynapsePipelineRun** restituisce informazioni sulle esecuzioni per la pipeline specificata. Se si specifica PipelineRunId, vengono visualizzati i dettagli per l'esecuzione con tale ID. Se pipelineRunId non è specificato, visualizza informazioni su tutte le esecuzioni per le pipeline che si sono verificate tra i valori di RunStartedAfter e RunStartedBefore.
