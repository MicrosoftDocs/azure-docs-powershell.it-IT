...
## DESCRIZIONE
Il cmdlet **Remove-AzSynapseSparkSessionTimeout** reimposta il timeout di una sessione di Synapse Analytics Spark.
...
Questo comando reimposta il timeout della sessione di Synapse Analytics Spark con l'ID livy specificato.
...
Questo comando reimposta il timeout della sessione di Synapse Analytics Spark con l'ID flusso specificato tramite pipeline.
