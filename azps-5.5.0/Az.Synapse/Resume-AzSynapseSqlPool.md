...
## DESCRIZIONE
Il cmdlet **Resume-AzSynapseSqlPool** riprende un pool di SQL Azure Synapse Analytics.
...
Questo comando riprende un pool di SQL Azure Synapse Analytics sospeso.
