...
## DESCRIZIONE
Il cmdlet **Test-AzSynapseSparkPool** verifica l'esistenza di un pool Synapse Analytics Spark.
...
Questo comando verifica l'esistenza del pool spark specificato.
