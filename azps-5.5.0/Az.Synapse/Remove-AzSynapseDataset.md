...
## DESCRIZIONE
Il cmdlet **Remove-AzSynapseDataset** rimuove un set di dati dall'area di lavoro.
...
Questo comando rimuove il set di dati denominato ContosoDataset dall'area di lavoro contosoWorkspace.
