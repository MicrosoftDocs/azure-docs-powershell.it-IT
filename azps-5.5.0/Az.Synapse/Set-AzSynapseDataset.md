...
## DESCRIZIONE
Il cmdlet **Set-AzSynapseDataset** crea un set di dati o aggiorna un set di dati esistente nell'area di lavoro.
...
Questo comando crea un set di dati denominato ContosoDataset nell'area di lavoro ContosoWorkspace.
Il comando basa il set di dati sulle informazioni Dataset.jssu file.
