...
## DESCRIZIONE
Il cmdlet Enable-AzSynapseSqlPoolSensitivityRecommendation abilita i suggerimenti di riservatezza per le colonne nel pool SQL dati.

## ESEMPI

### Esempio 1: Abilitare i suggerimenti di riservatezza per una determinata colonna in un pool di SQL Azure Synapse.
```powershell
...
### Esempio 2: Abilitare i suggerimenti di riservatezza per una determinata colonna di Azure Synapse SQL pool tramite Piping.
```powershell
