...
## SYNOPSIS
Aggiorna un database SQL Synapse Analytics.
...
## DESCRIZIONE
Il cmdlet **Update-AzSynapseSqlDatabase** aggiorna un database di SQL Azure Synapse Analytics.
...
Questo comando aggiorna un database SQL Azure Synapse Analytics.
