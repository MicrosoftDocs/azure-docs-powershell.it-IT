...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSparkPool** ottiene informazioni su un pool Azure Synapse Analytics Spark.
...
Questo comando recupera tutti i pool di grafici Spark in un'area di lavoro.
...
Questo comando recupera il pool Spark nell'area di lavoro ContosoWorkspace con il nome ContosoSparkPool.
...
Questo comando recupera tutti i pool Spark in un'area di lavoro tramite una pipeline.
...
Questo comando recupera il pool Spark con l'ID risorsa specificato.
