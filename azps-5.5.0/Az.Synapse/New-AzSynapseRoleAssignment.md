...
Questo comando assegna ContosoRole all'utente il cui nome dell'entità è ContosoName.
...
Questo comando assegna ContosoRole all'utente il cui nome dell'entità è ContosoName tramite pipeline.
