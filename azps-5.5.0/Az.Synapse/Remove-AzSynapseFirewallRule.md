...
## DESCRIZIONE
Il cmdlet **Remove-AzSynapseFirewallRule** elimina definitivamente una regola del firewall di Azure Synapse Analytics.
...
Questo comando elimina la regola del firewall denominata ContosoFirewallRule nell'area di lavoro ContosoWorkspace con il nome ContosoFirewallRule.
...
Questo comando elimina la regola del firewall denominata ContosoFirewallRule in un'area di lavoro tramite pipeline.
