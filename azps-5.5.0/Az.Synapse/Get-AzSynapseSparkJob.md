...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSparkJob** ottiene un processo di Azure Synapse Analytics Spark.
...
Questo comando recupera tutti i processi in un pool Spark.
...
Questo comando recupera il processo con l'ID applicazione specificato.
...
Questo comando recupera tutti i processi in un pool Spark tramite pipeline.
