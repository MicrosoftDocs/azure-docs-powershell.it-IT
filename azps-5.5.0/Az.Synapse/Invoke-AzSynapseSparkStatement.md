...
## DESCRIZIONE
Il cmdlet **Invoke-AzSynapseSparkStatement** richiama un'istruzione Synapse Analytics Spark.
...
Questi comandi avviano una sessione spark, quindi richiamano un'istruzione Spark inline tramite pipeline.
...
Questi comandi avviano una sessione spark, quindi richiamano un'istruzione Grafico spark in linea.
...
Questi comandi avviano una sessione Spark e richiamano le istruzioni Spark in un file.
...
### -FilePath
Specifica un percorso di file locale contenente il codice di esecuzione.
...
### -Response
Indica che deve essere restituita una risposta completa.
