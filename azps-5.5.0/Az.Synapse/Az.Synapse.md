...
# Modulo Az.Synapse
## Descrizione
Gli argomenti di questa sezione descrivono i cmdlet di Azure PowerShell per Azure Synapse Analytics.
...
Disabilita Advanced Data Security in un'area di lavoro.

### [Disable-AzSynapseSqlPoolSensitivityRecommendation](Disable-AzSynapseSqlPoolSensitivityRecommendation.md)
Disabilita (ignora) i suggerimenti di riservatezza per le colonne nel SQL pool.
...
Abilita i suggerimenti di riservatezza per le colonne (i suggerimenti sono abilitati per impostazione predefinita in tutte le colonne) nel pool SQL colonna.

### [Export-AzSynapseNotebook](Export-AzSynapseNotebook.md)
Esporta notbook.

### [Get-AzSynapseActivityRun](Get-AzSynapseActivityRun.md)
Ottiene informazioni sulle attività eseguite per un'esecuzione di pipeline.
...
Recupera informazioni sui set di dati nell'area di lavoro.

### [Get-AzSynapseFirewallRule](Get-AzSynapseFirewallRule.md)
Ottiene una regola del firewall synapse Analytics.

### [Get-AzSynapseIntegrationRuntime](Get-AzSynapseIntegrationRuntime.md)
Ottiene informazioni sulle risorse di runtime di integrazione.
...
Recupera i dati della metrica per un runtime di integrazione. 
...
Recupera informazioni sui blocchi appunti in un'area di lavoro.
...
Recupera le impostazioni di controllo di un'area di lavoro di analisi di Azure Synapse.

### [Get-AzSynapseSqlDatabase](Get-AzSynapseSqlDatabase.md)
Questa funzionalità viene visualizzata in anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Ottiene un database SQL Synapse Analytics.

### [Get-AzSynapseSqlPool](Get-AzSynapseSqlPool.md)
Ottiene un pool di SQL Synapse Analytics.
...
Recupera i tipi di informazioni correnti e le etichette di riservatezza delle colonne nel pool SQL dati.

### [Get-AzSynapseSqlPoolSensitivityRecommendation](Get-AzSynapseSqlPoolSensitivityRecommendation.md)
Recupera i tipi di informazioni consigliati e le etichette di riservatezza delle colonne nel SQL pool.

### [Get-AzSynapseSqlPoolTransparentDataEncryption](Get-AzSynapseSqlPoolTransparentDataEncryption.md)
Ottiene lo stato TDE per un SQL pool.
...
Recupera le impostazioni di valutazione della vulnerabilità di un SQL pool.

### [Get-AzSynapseSqlVulnerabilityAssessmentSetting](Get-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Recupera le impostazioni di valutazione della vulnerabilità di un'area di lavoro.
...
Ottenere lo stato della sottoscrizione per il trigger di evento per gli eventi del servizio esterno specificati.
...
Aggiorna il runtime di integrazione self-hosted.
...
Richiama un'istruzione Synapse Analytics Spark.

### [New-AzSynapseFirewallRule](New-AzSynapseFirewallRule.md)
Crea una regola del firewall di Synapse Analytics.

### [New-AzSynapseIntegrationRuntimeKey](New-AzSynapseIntegrationRuntimeKey.md)
Rigenerare la chiave di runtime di integrazione self-hosted.
...
Crea un pool Synapse Analytics Spark.

### [New-AzSynapseSqlDatabase](New-AzSynapseSqlDatabase.md)
Questa funzionalità viene visualizzata in anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Crea un database SQL Synapse Analytics.

### [New-AzSynapseSqlPool](New-AzSynapseSqlPool.md)
Crea un pool di SQL Synapse Analytics.

### [New-AzSynapseSqlPoolRestorePoint](New-AzSynapseSqlPoolRestorePoint.md)
Crea un nuovo punto di ripristino in un pool di SQL Azure Synapse Analytics.

### [New-AzSynapseWorkspace](New-AzSynapseWorkspace.md)
Crea un'area di lavoro Synapse Analytics.

### [Remove-AzSynapseDataFlow](Remove-AzSynapseDataFlow.md)
Rimuove un flusso di dati dall'area di lavoro.

### [Remove-AzSynapseDataset](Remove-AzSynapseDataset.md)
Rimuove un set di dati dall'area di lavoro.

### [Remove-AzSynapseFirewallRule](Remove-AzSynapseFirewallRule.md)
Elimina una regola del firewall di Synapse Analytics.
...
Rimuove un servizio collegato dall'area di lavoro.
...
Rimuove una pipeline dall'area di lavoro.
...
Rimuove un amministratore di Azure AD per l'area di lavoro Synapse Analytics.

### [Remove-AzSynapseSqlDatabase](Remove-AzSynapseSqlDatabase.md)
Questa funzionalità viene visualizzata in anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Elimina un database SQL Synapse Analytics.

### [Remove-AzSynapseSqlPool](Remove-AzSynapseSqlPool.md)
Elimina un pool di SQL Synapse Analytics.

### [Remove-AzSynapseSqlPoolRestorePoint](Remove-AzSynapseSqlPoolRestorePoint.md)
Elimina un punto di ripristino del pool SQL Synapse Analytics.

### [Remove-AzSynapseSqlPoolSensitivityClassification](Remove-AzSynapseSqlPoolSensitivityClassification.md)
Rimuove i tipi di informazioni e le etichette di riservatezza delle colonne nel SQL pool.

### [Remove-AzSynapseTrigger](Remove-AzSynapseTrigger.md)
Rimuove un trigger da un'area di lavoro.

### [Remove-AzSynapseTriggerSubscription](Remove-AzSynapseTriggerSubscription.md)
Annullare la sottoscrizione del trigger di evento agli eventi del servizio esterno.
...
Collega un archivio dati o un servizio cloud all'area di lavoro.

### [Set-AzSynapseNotebook](Set-AzSynapseNotebook.md)
Crea o aggiorna un blocco appunti in un'area di lavoro.

### [Set-AzSynapsePipeline](Set-AzSynapsePipeline.md)
Crea una pipeline nell'area di lavoro.
...
Modifica le impostazioni di controllo di un'area di lavoro di analisi di Azure Synapse.

### [Set-AzSynapseSqlPoolAuditSetting](Set-AzSynapseSqlPoolAuditSetting.md)
Modifica le impostazioni di controllo per un pool di SQL Azure Synapse Analytics.

### [Set-AzSynapseSqlPoolSensitivityClassification](Set-AzSynapseSqlPoolSensitivityClassification.md)
Imposta i tipi di informazioni e le etichette di riservatezza delle colonne nel pool SQL informazioni.

### [Set-AzSynapseSqlPoolTransparentDataEncryption](Set-AzSynapseSqlPoolTransparentDataEncryption.md)
Modifica la proprietà TDE per un SQL pool.
...
Avvia una sessione di Synapse Analytics Spark.

### [Start-AzSynapseTrigger](Start-AzSynapseTrigger.md)
Avvia un trigger in un'area di lavoro.

### [Stop-AzSynapsePipelineRun](Stop-AzSynapsePipelineRun.md)
Interrompe l'esecuzione di una pipeline in un'area di lavoro.
...
Interrompe un trigger in un'area di lavoro.
...
Verifica la presenza di un pool Spark di Synapse Analytics.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Questa funzionalità viene visualizzata in anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Verifica la presenza di un database synapse Analytics SQL database.
...
Verifica la presenza di un'area di lavoro Synapse Analytics.

### [Update-AzSynapseFirewallRule](Update-AzSynapseFirewallRule.md)
Aggiorna una regola del firewall di Synapse Analytics.
...
Aggiorna il nodo di runtime di integrazione self-hosted.

### [Update-AzSynapseSparkPool](Update-AzSynapseSparkPool.md)
Aggiorna un pool Synapse Analytics Spark.

### [Update-AzSynapseSqlAdvancedThreatProtectionSetting](Update-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Aggiorna le impostazioni di Protezione avanzata dalle minacce in un'area di lavoro.

### [Update-AzSynapseSqlDatabase](Update-AzSynapseSqlDatabase.md)
Questa funzionalità viene visualizzata in anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Aggiorna un database SQL Synapse Analytics.

### [Update-AzSynapseSqlPool](Update-AzSynapseSqlPool.md)
Aggiorna un pool di SQL Synapse Analytics.

### [Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting](Update-AzSynapseSqlPoolAdvancedThreatProtectionSetting.md)
Configura le impostazioni di protezione dalle minacce avanzate in un pool SQL avanzata.

### [Update-AzSynapseSqlPoolVulnerabilityAssessmentSetting](Update-AzSynapseSqlPoolVulnerabilityAssessmentSetting.md)
Aggiorna le impostazioni di valutazione della vulnerabilità di un SQL pool.

### [Update-AzSynapseSqlVulnerabilityAssessmentSetting](Update-AzSynapseSqlVulnerabilityAssessmentSetting.md)
Aggiorna le impostazioni di valutazione della vulnerabilità di un'area di lavoro.
