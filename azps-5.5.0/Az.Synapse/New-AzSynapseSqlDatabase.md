...
## SYNOPSIS
Crea un database SQL Synapse Analytics.
...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSqlDatabase** ottiene informazioni su un database di Azure Synapse Analytics SQL database.
...
Questo comando crea un database di Azure Synapse Analytics SQL database.
...
### -Collation
La fascicolazione definisce le regole per ordinare e confrontare i dati e non può essere modificata dopo la SQL del pool.
