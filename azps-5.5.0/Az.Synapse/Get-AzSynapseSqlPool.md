...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSqlPool** ottiene informazioni su un pool di SQL Azure Synapse Analytics.
...
Questo comando recupera tutti i pool SQL in un'area di lavoro.
...
Questo comando recupera il pool SQL nell'area di lavoro ContosoWorkspace con il nome ContosoSqlPool.
...
Questo comando recupera tutti i pool di SQL in un'area di lavoro tramite pipeline.
...
Questo comando recupera il SQL di risorse con l'ID risorsa specificato.
...
### -Version
[Questa funzionalità viene visualizzata in anteprima limitata, inizialmente accessibile solo a determinati abbonamenti.] Versione di Synapse SQL pool. Ad esempio, 2 o 3.
