...
## DESCRIZIONE
Il cmdlet **Reset-AzSynapseSqlAuditSetting** rimuove le impostazioni di controllo di un'area di lavoro analisi di Azure Synapse.
...
Questo comando rimuove le impostazioni di controllo di un'area di lavoro di Azure Synapse Analytics denominata ContosoWorkspace.
...
Questo comando rimuove le impostazioni di controllo di un'area di lavoro di analisi di Azure Synapse denominata ContosoWorkspace tramite pipeline.
