...
## DESCRIZIONE
Il Get-AzSynapseSqlPoolSensitivityRecommendation cmdlet restituisce i tipi di informazioni consigliate e le etichette di riservatezza delle colonne nel pool SQL dati.

## ESEMPI

### Esempio 1: Ottenere i tipi di informazioni consigliati e le etichette di riservatezza di un pool di SQL Azure Synapse.
```powershell
...
### Esempio 2: ottenere i tipi di informazioni consigliati e le etichette di riservatezza di un pool di SQL Azure Synapse con Piping.
```powershell
