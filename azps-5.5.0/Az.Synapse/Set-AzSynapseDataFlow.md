...
Questo comando crea un flusso di dati denominato ContosoDataFlow nell'area di lavoro ContosoWorkspace.
Il comando basa il flusso di dati sulle informazioni DataFlow.jssu file.
