...
## DESCRIZIONE
Il cmdlet **Update-AzSynapseSqlPool** aggiorna un pool di SQL Azure Synapse Analytics.
...
Questo comando aggiorna un pool di SQL Azure Synapse Analytics.
...
Questo comando aggiorna un pool di SQL Azure Synapse Analytics tramite pipeline.
...
Questo comando aggiorna un pool di SQL Azure Synapse Analytics con ID risorsa.
