...
## DESCRIZIONE
Il cmdlet Disable-AzSynapseSqlPoolSensitivityRecommendation disabilita (elimina) i suggerimenti di riservatezza per le colonne nel pool SQL.

## ESEMPI

### Esempio 1: Disabilitare i suggerimenti di riservatezza per una determinata colonna in un pool di SQL Azure Synapse.
```powershell
...
### Esempio 2: Disabilitare i suggerimenti di riservatezza per le colonne che hanno suggerimenti di riservatezza in un pool di SQL Azure Synapse con Piping.
```powershell
...
### Esempio 3: Disabilitare i suggerimenti di riservatezza per una determinata colonna in un pool SQL Azure Synapse con Piping.
```powershell
