...
### DisableByNameParameterSet (Impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Disable-AzSynapseSqlAdvancedDataSecurity** disabilita Advanced Data Security in un'area di lavoro.
...
Questo comando disabilita Advanced Data Security nell'area di lavoro denominata ContosoWorkspace.
...
Questo comando disabilita Advanced Data Security nell'area di lavoro denominata ContosoWorkspace tramite pipeline.
