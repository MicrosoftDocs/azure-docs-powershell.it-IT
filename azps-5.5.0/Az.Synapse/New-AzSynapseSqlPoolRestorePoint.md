...
## DESCRIZIONE
Il cmdlet **New-AzSynapseSqlPoolRestorePoint** crea un nuovo punto di ripristino da cui è possibile ripristinare un pool di SQL Azure Synapse Analytics.
...
Questo comando crea un punto di ripristino per SQL pool denominato ContosoSqlPool nell'area di lavoro ContosoWorkspace.
...
### -RestorePointLabel
L'etichetta a cui associa un punto di ripristino potrebbe non essere univoca.
