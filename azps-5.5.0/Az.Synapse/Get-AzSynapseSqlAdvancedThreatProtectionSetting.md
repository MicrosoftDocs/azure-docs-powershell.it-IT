...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSqlAdvancedThreatProtectionSetting** ottiene le impostazioni di Protezione avanzata dalle minacce di un'area di lavoro analisi di Azure Synapse.
