...
## DESCRIZIONE
Il cmdlet **Set-AzSynapseSqlPoolTransparentDataEncryption** modifica la proprietà Transparent Data Encryption (TDE) di un pool di SQL Azure Synapse Analytics.
...
Questo comando abilita TDE per il pool SQL denominato ContosoSqlPool nell'area di lavoro ContosoWorkspace.
...
### -State
Stato crittografia dati trasparente del pool Sql di Azure Synapse Analytics.
