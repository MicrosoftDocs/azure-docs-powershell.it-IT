...
## DESCRIZIONE
Il cmdlet **Test-AzSynapseWorkspace** verifica l'esistenza di un'area di lavoro Synapse Analytics.
...
Questo comando verifica l'esistenza di un'area di lavoro Synapse Analytics.
