...
Questo comando elimina un'area di lavoro analisi di Azure Synapse tramite una pipeline.
...
Questo comando elimina un'area di lavoro Azure Synapse Analytics tramite pipeline con l'ID risorsa specificato.
