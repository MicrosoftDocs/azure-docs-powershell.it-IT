...
### StopByNameParameterSet (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Sync-AzSynapseIntegrationRuntimeCredential** sincronizza le credenziali locali tra i nodi di runtime di integrazione, che forzano le credenziali a essere identiche in tutti i nodi.
