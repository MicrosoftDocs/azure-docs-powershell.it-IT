...
## DESCRIZIONE
Il Remove-AzSynapseSqlPoolSensitivityClassification rimuovere i tipi di informazioni e le etichette di riservatezza delle colonne nel pool SQL informazioni.

## ESEMPI

### Esempio 1: Rimuovere il tipo di informazioni e l'etichetta di riservatezza di una colonna in un pool di SQL Azure Synapse.
```powershell
...
### Esempio 2: Rimuovere i tipi di informazioni correnti e le etichette di riservatezza delle colonne in un pool SQL Azure Synapse con Piping.
```powershell
...
### Esempio 3: Rimuovere il tipo di informazioni e l'etichetta di riservatezza di una colonna in un pool SQL Azure Synapse usando Piping.
```powershell
