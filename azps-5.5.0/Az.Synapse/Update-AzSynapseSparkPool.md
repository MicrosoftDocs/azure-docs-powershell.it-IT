...
## DESCRIZIONE
Il cmdlet **Update-AzSynapseSparkPool** aggiorna un pool Azure Synapse Analytics Spark.
...
Questo comando aggiorna un pool Spark di Azure Synapse Analytics.
...
Questo comando aggiorna un pool Spark spark di Azure Synapse tramite pipeline.
...
Questo comando aggiorna un pool Spark spark di Azure Synapse Analytics con ID risorsa.
...
Questo comando abilita il ridimensionamento automatico per un pool Azure Synapse Analytics Spark.
...
Questo comando disabilita il ridimensionamento automatico per un pool Spark di Azure Synapse Analytics.
...
Questo comando abilita la pausa automatica per un pool Azure Synapse Analytics Spark.
...
Questo comando disabilita la pausa automatica per un pool Spark di Azure Synapse Analytics.
...
Numero massimo di nodi da allocare nel pool spark specificato.
...
Numero minimo di nodi da allocare nel pool spark specificato.
Questo parametro deve essere specificato quando è abilitata la scala automatica.
...
### -EnableAutoPause
Indica se la pausa automatica deve essere abilitata.
...
File di configurazione dell'ambiente ("Output PIP freeze").
...
### -NodeCount
Numero di nodi da allocare nel pool Spark specificato.
...
### -NodeSize
Numero di core e memoria da usare per i nodi allocati nel pool Spark specificato.
