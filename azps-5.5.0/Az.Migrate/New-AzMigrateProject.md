...
Per creare, vedere la sezione NOTE per le proprietà PROPERTY e creare una tabella hash.
...
PROPRIETÀ: <IMigrateProjectProperties> specifica le proprietà del progetto.
  - `[ProvisioningState <ProvisioningState?>]`: stato di provisioning del progetto di migrazione.
  - `[RegisteredTool <String[]>]`: ottiene o imposta l'elenco di strumenti registrati con il progetto di migrazione.
