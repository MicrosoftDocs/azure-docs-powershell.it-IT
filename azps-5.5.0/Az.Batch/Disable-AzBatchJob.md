...
## DESCRIZIONE
Il cmdlet **Disable-AzBatchJob** disabilita un processo batch di Azure.
...
Questo comando disabilita il processo con ID Processo-000001.
...
### -DisableJobOption
Specifica cosa fare con le attività attive associate al processo che questo cmdlet disabilita.
...
### -Id
Specifica l'ID del processo disabilitato dal cmdlet.
