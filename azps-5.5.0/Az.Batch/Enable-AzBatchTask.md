...
Se un'attività ha esaurito il numero di tentativi, il cmdlet ne consente l'esecuzione.
...
Questo comando riattiva l'attività Attività2 nel processo Job7.
...
Questo comando recupera l'attività batch con ID Attività3 nel processo che contiene l'ID Job8 usando il cmdlet Get-AzBatchTask.
...
### -Attività
Specifica l'attività che viene riattivata dal cmdlet.
