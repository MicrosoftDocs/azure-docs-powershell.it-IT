...
### Esempio 2: Aggiungere un certificato dai dati non elaborati
```
PS C:\>$RawData = [System.IO.File]::ReadAllBytes("E:\Certificates\MyCert.pfx")
PS C:\> New-AzBatchCertificate -RawData $RawData -Password "Password1234" -BatchContext $Context
```

Il primo comando legge i dati dal file denominato MyCert.pfx nella $RawData variabile.
...
Il file del certificato deve essere in formato .cer o .pfx.
...
### -Kind
Tipo di certificato da creare. Se non viene specificato, si presuppone che tutti i certificati senza password siano cer e tutti i certificati con password siano PFX.
...
### -RawData
Specifica i dati del certificato non elaborati in formato .cer o .pfx.
