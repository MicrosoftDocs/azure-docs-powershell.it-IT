...
## DESCRIZIONE
Il cmdlet **Restart-AzBatchComputeNode** riavvia il nodo di calcolo specificato.

## ESEMPI

### Esempio 1: Riavviare un nodo di calcolo
```
PS C:\>Restart-AzBatchComputeNode -PoolId "MyPool" -Id "tvm-3257026573_2-20150813t200938z" -BatchContext $Context
```

Questo comando riavvia il nodo di calcolo con l'ID "tvm-3257026573_2-20150813t200938z" nel pool MyPool.
...
Questo comando riavvia ogni nodo di calcolo nel pool MyPool.
...
### -ComputeNode
Specifica **l'oggetto PSComputeNode** che rappresenta il nodo di calcolo da riavviare.
...
### -Id
Specifica l'ID del nodo di calcolo da riavviare.
...
### -RebootOption
Specifica quando riavviare il nodo e cosa fare con le attività in esecuzione.
