...
## DESCRIZIONE
Il cmdlet **Set-AzBatchPool** aggiorna le proprietà di un pool nel servizio batch di Azure.
Usare il cmdlet Get-AzBatchPool per ottenere un **oggetto PSCloudPool.**
Modificare le proprietà dell'oggetto e quindi usare il cmdlet corrente per eseguire il commit delle modifiche al servizio batch.
...
Il primo comando ottiene un pool con **Get-AzBatchPool** e quindi lo archivia nella variabile $Pool locale.
I tre comandi seguenti modificano la specifica dell'attività di inizio nell$Pool o object.
Il comando finale aggiorna il servizio batch in modo che corrisponda all'oggetto locale in $Pool.
...
### -Pool
Specifica **psCloudPool** a cui questo cmdlet aggiorna il servizio batch.
