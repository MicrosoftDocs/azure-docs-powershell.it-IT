...
### Esempio 2: Rimuovere un nodo di calcolo tramite la pipeline
```
...
Il cmdlet corrente rimuove il nodo di elaborazione.
...
### -PoolId
Specifica l'ID del pool che contiene i nodi di elaborazione rimossi dal cmdlet.
