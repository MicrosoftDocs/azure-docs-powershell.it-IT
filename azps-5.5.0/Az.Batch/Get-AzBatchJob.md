...
## SYNOPSIS
Recupera i processi batch per un account batch o una pianificazione di processo.
...
È possibile usare il *parametro ID* per ottenere un singolo processo.
È possibile usare il *parametro Filter* per ottenere i processi corrispondenti a un filtro OData (Open Data Protocol).
Se si specifica un ID pianificazione processo o **un'istanza PSCloudJobSchedule,** questo cmdlet restituisce solo i processi per tale pianificazione.

## ESEMPI

### Esempio 1: Ottenere un processo batch in base all'ID
```
...
Questo comando recupera il processo con ID Job01.
Usare il cmdlet Get-AzBatchAccountKey per assegnare un contesto alla $Context variabile.

### Esempio 2: Recuperare tutti i processi attivi per una pianificazione di un processo
```
...
Questo comando recupera i processi attivi per la pianificazione del processo con l'ID JobSchedule27.

### Esempio 3: Recupera tutti i processi sotto una pianificazione di processo tramite la pipeline
```
...
Questo comando recupera la pianificazione del processo con l'ID JobSchedule27 usando il cmdlet Get-AzBatchJobSchedule processo.
Il comando passa la pianificazione del processo al cmdlet corrente usando l'operatore della pipeline.
Il comando recupera tutti i processi per la pianificazione del processo.
...
### -Filter
Specifica una clausola del filtro OData per i processi.
Se non si specifica un filtro, questo cmdlet restituisce tutti i processi per l'account batch o la pianificazione del processo.
...
### -Id
Specifica l'ID del processo che riceve questo cmdlet.
