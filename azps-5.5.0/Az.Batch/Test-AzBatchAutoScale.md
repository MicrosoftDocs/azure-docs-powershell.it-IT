...
## DESCRIZIONE
Il **cmdlet Test-AzBatchAutoScale** ottiene il risultato di una formula di ridimensionamento automatico nel pool specificato.

## ESEMPI

### Esempio 1: Valutare una formula di scala automatica in un pool
```
...
Il primo comando archivia una formula nella $Formula variabile da usare nell'esempio.
Il secondo comando valuta la formula di scala automatica nel pool che contiene l'ID ContosoPool.
Il comando finale visualizza i **risultati usando la sintassi** standard del punto.
...
### -Id
Specifica l'ID oggetto del pool di cui verificare le proporzioni automatiche.
