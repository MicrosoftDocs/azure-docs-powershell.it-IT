...
## SYNOPSIS
Inizia a ridimensionare una pool.
...
Se al momento il pool non raggiunge le dimensioni di destinazione, l'operazione di ridimensionamento si interrompe.
...
Numero di nodi di calcolo di destinazione con priorità bassa.
