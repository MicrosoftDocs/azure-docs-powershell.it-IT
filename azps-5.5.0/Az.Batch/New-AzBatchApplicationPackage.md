...
## DESCRIZIONE
Il cmdlet **New-AzBatchApplicationPackage** crea un pacchetto dell'applicazione in un account batch di Azure.

## ESEMPI

### Esempio 1: Installare un pacchetto dell'applicazione in un account batch
```
