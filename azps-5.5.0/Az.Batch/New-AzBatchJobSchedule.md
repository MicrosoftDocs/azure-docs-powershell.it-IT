...
## DESCRIZIONE
Il cmdlet **New-AzBatchJobSchedule crea** una pianificazione di processo nel servizio batch di Azure.
Il *parametro BatchAccountContext* specifica l'account in cui questo cmdlet crea la pianificazione.

## ESEMPI

### Esempio 1: Creare una pianificazione di processo
```
...
Questo esempio crea una pianificazione di processo.
I primi cinque comandi creano e **modificano gli oggetti PSSchedule,** **PSJobSpecification** e **PSPoolInformation.**
I comandi usano il cmdlet New-Object e la sintassi standard di Azure PowerShell.
I comandi archiviano questi oggetti nelle $Schedule e $JobSpecification variabili.
Il comando finale crea una pianificazione di processo con l'ID JobSchedule17.
Questa pianificazione crea processi con un intervallo di ricorrenza di un giorno.
I processi vengono eseguiti nel pool con l'ID ContosoPool06, come specificato nel quinto comando.
...
### -JobSpecification
Specifica i dettagli dei processi inclusi in questo cmdlet nella pianificazione dei processi.
...
### -Pianificazione
Specifica la pianificazione che determina quando creare i processi.
