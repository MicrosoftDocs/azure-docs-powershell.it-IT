...
L'esempio mostra come ottenere i dettagli delle risorse del collegamento privato in formato JSON per praticità per il servizio Ricerca cognitiva di Azure.
