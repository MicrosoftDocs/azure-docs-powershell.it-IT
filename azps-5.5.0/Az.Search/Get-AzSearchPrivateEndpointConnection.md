...
## DESCRIZIONE
Il cmdlet **Get-AzSearchPrivateEndpointConnection** ottiene le connessioni degli endpoint privati al servizio Ricerca cognitiva di Azure.
...
L'esempio ottiene tutte le connessioni degli endpoint privati al servizio Ricerca cognitiva di Azure.
...
L'esempio ottiene una specifica connessione all'endpoint privato per nome (convertita in JSON per facilitare la lettura) nel servizio Ricerca cognitiva di Azure.
...
### -Name
Nome della connessione all'endpoint privato del servizio Cognitivo di Azure
