...
## DESCRIZIONE
Il cmdlet **New-AzSearchAdminKey** rigenera una chiave di amministratore del servizio Ricerca cognitiva di Azure.
...
L'esempio rigenera la chiave primaria del servizio Ricerca cognitiva di Azure.
...
### -Key Ritieni
Tipo di chiave di chiave del servizio ricerca cognitiva di Azure (primaria/secondaria).
