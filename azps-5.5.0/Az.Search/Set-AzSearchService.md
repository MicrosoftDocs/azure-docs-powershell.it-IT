...
## DESCRIZIONE
Il cmdlet **Set-AzSearchService** modifica un servizio di Ricerca cognitiva di Azure.
...
L'esempio modifica il numero di partizioni e il numero di replica del servizio Ricerca cognitiva di Azure in 2.
...
### -PartitionCount
Numero di partizioni del servizio di ricerca.
...
### -ReplicaCount
Numero di replica del servizio di ricerca.
...
### -ResourceId
ID risorsa servizio di ricerca.
