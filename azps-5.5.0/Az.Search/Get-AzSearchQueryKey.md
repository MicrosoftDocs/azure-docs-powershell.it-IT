...
## DESCRIZIONE
Il cmdlet **Get-AzSearchQueryKey** ottiene le chiavi di query del servizio Ricerca cognitiva di Azure.
...
L'esempio ottiene tutte le chiavi di query del servizio ricerca cognitiva di Azure.
