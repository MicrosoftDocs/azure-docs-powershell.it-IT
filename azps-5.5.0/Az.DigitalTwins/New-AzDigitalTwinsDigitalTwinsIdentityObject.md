...
### Esempio 1: Creare un oggetto DigitalTwinsIdentityObject
```powershell
...
Creare un oggetto DigitalTwinsIdentityObject in base a ID e percorso
...
### -Id
Percorso di identità della risorsa.
