...
### Esempio 1: Creare una AzDigitalTwinsInstance per impostazione predefinita.
```powershell
...
Creare una AzDigitalTwinsInstance per impostazione predefinita

### Esempio 2: Creare un oggetto AzDigitalTwinsInstance da AzDigitalTwins.
```powershell
...
Creare un oggetto AzDigitalTwinsInstance da AzDigitalTwins
...
Per creare, vedere la sezione NOTE per le proprietà DIGITALTWINSCREATE e creare una tabella hash.
...
DIGITALTWINSCREATE: <IDigitalTwinsDescription> descrizione del servizio DigitalTwins.
  - `Location <String>`: posizione della risorsa.
  - `[Tag <IDigitalTwinsResourceTags>]`: i tag di risorsa.
