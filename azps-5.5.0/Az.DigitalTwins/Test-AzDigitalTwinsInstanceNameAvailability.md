...
Verificare la disponibilità del nome per posizione e nome.
...
Ottenere A DigitalTwinsInstance e creare un oggetto Requset per testare la disponibilità del nome.
...
Risultato restituito dalla richiesta di disponibilità di un nome di controllo del database.
Per creare, vedere la sezione NOTE per le proprietà DIGITALTWINSINSTANCECHECKNAME e creare una tabella hash.
...
DIGITALTWINSINSTANCECHECKNAME: risultato restituito dalla richiesta di disponibilità del nome del controllo <ICheckNameRequest> del database.
