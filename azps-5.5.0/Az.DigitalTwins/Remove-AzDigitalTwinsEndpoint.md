...
### Esempio 1: Eliminare azDigitalTwinsEndPoint da EndPointName
```powershell
...
Eliminare azDigitalTwinsEndPoint da EndPointName ResourceGroupName e ResourceName

### Esempio 2: Eliminare il file azDigitalTwinsEndPoint in base all'oggetto
```powershell
...
Eliminare il valore azDigitalTwinsEndPoint in base all'oggetto
