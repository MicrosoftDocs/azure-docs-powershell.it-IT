...
## SYNOPSIS
Elimina un'applicazione ioT central.
...
## DESCRIZIONE
Elimina un'applicazione centrale IoT esistente.

## ESEMPI

### Esempio 1: Eliminazione e applicazione centrale IoT
```powershell
PS C:\> Remove-AzIotCentralApp -ResourceGroupName "MyResourceGroupName" -Name "MyAppResourceName"
```

Elimina l'applicazione centrale IoT fornita.
