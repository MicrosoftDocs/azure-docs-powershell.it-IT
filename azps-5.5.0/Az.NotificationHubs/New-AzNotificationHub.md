...
Non è necessario specificare un nome o altre informazioni di configurazione per l'hub; queste informazioni verranno prese dal file di input C:\Configurations\InternalHub.jsavanti.
