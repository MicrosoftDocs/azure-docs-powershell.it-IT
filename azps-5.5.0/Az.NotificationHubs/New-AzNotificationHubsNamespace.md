...
È possibile disporre di più spazi dei nomi per organizzare gli hub o per concedere a singoli utenti specifici l'autorizzazione per gestire un sottoinsieme selezionato di hub.
...
Anche se è possibile impostare questo parametro su qualsiasi posizione valida, per ottenere prestazioni ottimali è consigliabile usare un data center situato nella maggior parte degli utenti.
