...
### Esempio 1: Fornire i dettagli dell'Hub di notifica in modo interattivo
```powershell
...
Descrizione di un hub di notifica di Azure da collegare al servizio di comunicazione Da creare, vedere la sezione NOTE per le proprietà LINKNOTIFICATIONHUBPARAMETER e creare una tabella hash.
...
LINKNOTIFICATIONHUBPARAMETER: <ILinkNotificationHubParameters> Descrizione di un hub di notifica di Azure da collegare al servizio di comunicazione
