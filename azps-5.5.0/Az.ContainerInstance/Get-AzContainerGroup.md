...
## SYNOPSIS
Recupera i gruppi di contenitori.
...
## DESCRIZIONE
Il cmdlet **Get-AzContainerGroup** ottiene un gruppo di contenitori specificato o tutti i gruppi di contenitori in un gruppo di risorse o nella sottoscrizione.

## ESEMPI

### Esempio 1: ottiene un gruppo di contenitore specificato
```
...
### Esempio 2: Ottiene gruppi di contenitori in un gruppo di risorse
```
...
Il comando ottiene i gruppi di contenitori nel gruppo di `demo` risorse.

### Esempio 3: Ottiene i gruppi di contenitori nella sottoscrizione corrente
```
...
Il comando recupera i gruppi di contenitori nella sottoscrizione corrente.

### Esempio 4: ottiene i gruppi di contenitori usando l'ID risorsa.
```
...
Il comando ottiene il gruppo di contenitori con l'ID risorsa.
