...
### Esempio 1: Aggiornare la cache di Ridis Enterprise
```powershell
...
Questo comando aggiorna la versione minima di TLS e aggiunge un tag alla cache dell'organizzazione di Redis denominata MyCache.
...
I valori validi sono (2, 4, 6, ...) per SKU Enterprise e (3, 9, 15, ...) per gli SKU Flash.
