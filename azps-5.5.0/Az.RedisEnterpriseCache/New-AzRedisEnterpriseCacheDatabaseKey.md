...
### Esempio 1: Rigenerare la chiave di accesso primaria
```powershell
...
Questo comando rigenera la chiave di accesso segreta primaria usata per l'autenticazione delle connessioni al database della cache di Redis Enterprise denominata MyCache.

### Esempio 2: Rigenerare la chiave di accesso secondaria
```powershell
...
Questo comando rigenera la chiave di accesso segreta secondaria usata per l'autenticazione delle connessioni al database della cache aziendale di Redis denominata MyCache.
