...
Questo comando importa un file di database nel database della cache di Redis Enterprise denominata MyCache.

### Esempio 2: Importare il database (usando il nome file di esempio)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
...
### -SasUri
Uri di firma di accesso condiviso per il BLOB di destinazione da cui importare
