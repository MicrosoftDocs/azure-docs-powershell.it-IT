...
Questo comando esporta il database della cache dell'organizzazione di Redis denominata MyCache in un file di database.
...
### -SasUri
Uri della firma di accesso condiviso per la directory di destinazione in cui esportare
