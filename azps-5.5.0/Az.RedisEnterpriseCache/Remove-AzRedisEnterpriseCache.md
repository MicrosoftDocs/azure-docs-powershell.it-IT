...
### Esempio 1: Rimuovere una cache aziendale di Redis e restituire il risultato
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup" -PassThru
True
```

Questo comando rimuove una cache dell'organizzazione di Redis e indica se l'operazione riesce.

### Esempio 2: Rimuovere una cache aziendale di Redis e non visualizzare il risultato
```powershell
PS C:\> Remove-AzRedisEnterpriseCache -Name "MyCache" -ResourceGroupName "MyGroup"
```

Questo comando rimuove una cache aziendale di Redis.
