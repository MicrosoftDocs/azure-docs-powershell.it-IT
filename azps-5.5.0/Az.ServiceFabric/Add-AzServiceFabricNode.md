...
## DESCRIZIONE
Usare **Add-AzServiceFabricNode** per aggiungere nodi al tipo di nodo specifico. È sufficiente specificare il numero di nodi da aggiungere a un tipo di nodo.
...
Questo comando aggiunge 2 nodi al tipo di nodo 'n1'.
