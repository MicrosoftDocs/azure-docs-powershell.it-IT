...
## DESCRIZIONE
Usare **Remove-AzServiceFabricNode** per rimuovere i nodi da un tipo di nodo specifico da un cluster. La rimozione procede solo se soddisfa le metriche di integrità dei cluster.
...
Questo comando rimuove 2 nodi da NodeType 'nt1'.
...
Il numero di nodi da aggiungere
