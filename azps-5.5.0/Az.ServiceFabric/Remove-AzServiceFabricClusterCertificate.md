...
## DESCRIZIONE
Usare **Remove-AzServiceFabricClusterCertificate** per rimuovere un certificato del cluster dal cluster, purché nel cluster sia già in uso un altro certificato valido.
...
Questo comando rimuove il certificato con immagine thumbprint 5F3660C715EBBDA31DB1FFDCF508302348DE8E7A dall'uso per la sicurezza del cluster.
...
### -Thumbprint
Specificare l'impronta digitale del cluster da rimuovere.
