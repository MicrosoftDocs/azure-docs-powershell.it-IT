...
## SYNOPSIS
Ottenere i dettagli del servizio Service Fabric nell'applicazione e nel cluster specificati. Supporta solo i ARM distribuiti.
...
## DESCRIZIONE
Questo cmdlet otterrà i dettagli del servizio nell'applicazione e nel cluster specificati.
...
Questo esempio recupera i dettagli delle risorse del servizio per il servizio "testApp~testService".
...
Questo esempio ottiene un elenco dei servizi nell'applicazione "testApp".
