...
## SYNOPSIS
Rimuovere un tipo di applicazione da un tipo di applicazione del servizio dal cluster. In questo modo verranno rimuovono tutte le versioni del tipo in questa risorsa. Supporta solo i ARM di applicazioni distribuiti.
