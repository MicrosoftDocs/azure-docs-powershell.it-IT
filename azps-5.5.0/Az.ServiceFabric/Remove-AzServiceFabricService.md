...
## SYNOPSIS
Rimuovere un servizio dal cluster. Supporta solo i ARM distribuiti.
...
## DESCRIZIONE
Questo cmdlet rimuove un servizio dal cluster.
...
Questo esempio rimuove il servizio "testApp~testService1".
