...
Questo comando aggiunge un nuovo NodeType 'n2' con capacità di 5 e il nome amministratore della macchina virtuale è 'adminName'.
...
### -VmPassword
La password per l'accesso alla macchina virtuale
