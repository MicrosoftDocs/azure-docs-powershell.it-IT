...
## DESCRIZIONE
Il cmdlet **New-AzRedisCacheKey** rigenera la chiave di accesso di una cache di Azure Redis.
...
Questo comando rigenera la chiave primaria di una cache di Redis.
...
Questo comando rigenera la chiave secondaria di una cache di Ridis.
...
### -KeyType
Specifica se rigenerare la chiave di accesso primaria o secondaria.
...
### -Name
Specifica il nome della cache di Ridis.
