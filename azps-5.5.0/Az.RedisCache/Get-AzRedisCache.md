...
Questo comando recupera tutte le credenziali della cache di Ridis nell'abbonamento corrente.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene la cache di Redis da ottenere.
