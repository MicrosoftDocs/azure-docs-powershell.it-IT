...
## DESCRIZIONE
Il cmdlet **Enable-AzOperationalInsightsLinuxPerformanceCollection avvia** la raccolta di contatori delle prestazioni dai computer Linux connessi in un'area di lavoro.
