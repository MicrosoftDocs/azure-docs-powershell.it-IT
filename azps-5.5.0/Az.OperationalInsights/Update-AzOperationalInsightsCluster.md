...
Aggiornare il cluster con proprietà chiave del vault e SKU
...
### -KeyVaultUri
Uri vault chiave, "Protezione eliminazione" ed "Eliminazione reverscita" devono essere abilitati per questa chiave
...
### -SKUName
Nome SKU, ora può essere solo "CapacityReservation"
