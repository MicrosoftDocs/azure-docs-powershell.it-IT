...
Il comando finale crea un'unità di archiviazione denominata MyStorageInsight nell'area di lavoro denominata MyWorkspace.
...
Può essere recuperata eseguendo il cmdlet Get-AzStorageAccount e accedendo al *parametro Id* del risultato.
