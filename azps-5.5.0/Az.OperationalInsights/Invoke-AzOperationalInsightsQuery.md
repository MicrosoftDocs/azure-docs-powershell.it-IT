...
Vedere i dettagli dei limiti di query generali qui: https://docs.microsoft.com/en-us/azure/azure-monitor/service-limits#log-queries-and-language .
...
### Esempio 2: Convertire $results. Risultato I Possono essere restituito da una matrice
```
PS C:\> $queryResults = Invoke-AzOperationalInsightsQuery -WorkspaceId "63613592-b6f7-4c3d-a390-22ba13102111" -Query "union * | take 10"
