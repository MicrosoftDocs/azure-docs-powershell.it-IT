...
## SYNOPSIS
Ottiene la velocità effettiva di un database DiametiDB Gremlin.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBGremlinDatabaseThroughput** ottiene la velocità effettiva di un database Di maiodiDb Gremlin.
