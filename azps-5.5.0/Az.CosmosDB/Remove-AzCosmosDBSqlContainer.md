...
## DESCRIZIONE
Il cmdlet **Remove-AzCosmosDBSqlContainer** elimina il contenitore Sql DiBDb corrispondente al nome di gruppo di risorse, al nome dell'account, al nome database e al nome contenitore.
