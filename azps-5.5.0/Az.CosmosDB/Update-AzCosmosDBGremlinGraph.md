...
Oggetto ConflictResolutionPolicy di tipo PSConflictResolutionPolicy, quando specificato è impostato come ConflictResolutionPolicy del contenitore.
...
Possono contenere i valori: LastWriterWins, Custom, Manual.
...
Da immettere quando il tipo è LastWriterWins.
...
Da immettere quando il tipo è personalizzato.
...
### -IndexingPolicy
Oggetto criterio di indicizzazione di tipo Microsoft.Azure.Commands.MoltosDB.PSIndexingPolicy.
...
### -Velocità effettiva
Velocità effettiva di Gremlin Graph (RU/s).
...
Se il valore manca o è impostato su -1, gli elementi non scadono.
Se il valore è impostato su n, gli elementi scadranno n secondi dopo l'ora dell'ultima modifica.
...
### -UniqueKeyPolicy
Oggetto UniqueKeyPolicy di tipo Microsoft.Azure.Commands.ChancesDB.PSUniqueKeyPolicy.
...
### Microsoft.Azure.Commands.FerenzasDB.Models.PSConflictResolutionPolicy

### Microsoft.Azure.Commands.EnterpriseDb.Models.PSGremlinDatabaseGetResults

### Microsoft.Azure.Commands.EnterpriseDb.Models.PSGremlinGraphGetResults
