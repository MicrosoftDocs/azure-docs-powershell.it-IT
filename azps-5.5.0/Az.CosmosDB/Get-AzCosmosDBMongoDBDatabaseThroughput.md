...
## SYNOPSIS
Ottiene le proprietà di velocità effettivadb del database MongoDB.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBMongoDBDatabaseThroughput** ottiene le proprietà di velocità effettiva del database MongoDB.
