...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBSqlDatabase** ottiene l'elenco di tutti i database Sql esistenti diDbDb per un determinato NomeGruppoSocietà, NomeSocietà e ottiene un singolo database Sql DiRDB per un dato NomeGruppoSocietà, NomeSocietà, NomeDatabase e Nome Container.
