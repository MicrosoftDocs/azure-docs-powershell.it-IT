...
## SYNOPSIS
Creare un nuovo oggetto posizioneDbDb(PSLocation).
...
### -IsZoneRedundant
Booleano per indicare se l'area geografica è o meno un valore AvailabilityZone.
...
### -LocationName
Nome della posizione nella stringa.
...
### Microsoft.Azure.Commands.EnterpriseDb.Models.PSLocation
