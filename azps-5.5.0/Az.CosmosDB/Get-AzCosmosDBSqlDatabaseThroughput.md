...
## SYNOPSIS
Recupera le impostazioni di velocità effettiva corrispondenti a un database SQL di DatabaseDB.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBSqlDatabaseThroughput** ottiene le impostazioni di velocità effettiva corrispondenti a un database Sql Di DatabaseDb diDb.
