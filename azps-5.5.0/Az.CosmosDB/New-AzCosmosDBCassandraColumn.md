...
## SYNOPSIS
Crea una nuova colonna CassandraDB.
...
## DESCRIZIONE
La **nuova colonna New-AzCosmosDBCassandraColumn** crea una nuova colonnaDb Cassandra.
...
### Microsoft.Azure.Commands.EnterpriseDb.Models.PSColumn
