...
## SYNOPSIS
Ottiene le impostazioni di velocità effettiva corrispondenti a un contenitore SQL diDb.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBSqlContainerThroughput** ottiene le impostazioni di velocità effettiva corrispondenti a un contenitore Sql diSqlsDB. 
