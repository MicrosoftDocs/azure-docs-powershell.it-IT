...
## SYNOPSIS
Ottiene un elemento Db Cassandra Keyspace.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBCassandraKeyspace** crea un nuovo elemento o aggiorna un elemento Esistente CassasDB Cassandra Keyspace.
...
Get-AzCosmosDBCassandraKeyspace ottiene le proprietà di una cassandraKeyspace esistente. È possibile espandere la risorsa per ottenere le _etag proprietà _ts, _rid risorsa.
