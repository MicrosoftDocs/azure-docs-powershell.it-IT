...
Aggiorna il database SQL database DatabaseDb. Esegue un'operazione di patch sul lato client leggendo il database esistente.

### [Update-AzCosmosDBSqlDatabaseThroughput](Update-AzCosmosDBSqlDatabaseThroughput.md)
Aggiorna il valore di velocità effettiva di un database Sql database databasedb.

### [Update-AzCosmosDBSqlStoredProcedure](Update-AzCosmosDBSqlStoredProcedure.md)
Aggiorna la sintassi Sql StoredProcedure di Sql StoredProcedure del database database. Esegue un'operazione di patch sul lato client leggendo storedprocedure esistente.

### [Update-AzCosmosDBSqlTrigger](Update-AzCosmosDBSqlTrigger.md)
Aggiorna il trigger di sql database database. Esegue un'operazione di patch sul lato client leggendo il trigger esistente.
...
Aggiorna la tabella DatabaseDb. Esegue un'operazione di patch sul lato client leggendo la tabella esistente.

### [Update-AzCosmosDBTableThroughput](Update-AzCosmosDBTableThroughput.md)
Aggiorna il valore di velocità effettiva di una tabella AMMORT.