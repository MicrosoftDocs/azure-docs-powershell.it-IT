...
## SYNOPSIS
Ottenere keys{"ConnectionKeys", "PrimaryReadOnly" o "Keys"} per l'account DirDBA specificato. 
...
Elenca le chiavi dell'account di Ammort. Il tipo di chiave può essere un valore compreso tra: ConnectionStrings, Keys e ReadOnlyKeys. L'impostazione predefinita è Chiavi.
