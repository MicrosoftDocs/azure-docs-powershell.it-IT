...
## SYNOPSIS
Ottiene il valore di velocità effettiva della tabella Cassandra.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBCassandraTableThroughput** ottiene l'oggetto velocità effettiva corrispondente a un determinato keyspace.
