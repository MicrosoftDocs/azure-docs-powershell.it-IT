...
## SYNOPSIS
Creare un nuovo oggettoDb VirtualNetworkRule(PSVirtualNetworkRule).
...
Booleano per indicare se creare una regola del firewall prima che la rete virtuale abbia abilitato l'endpoint del servizio vnet.
...
### Microsoft.Azure.Commands.EnterpriseDb.Models.PSVirtualNetworkRule
