...
TTL di archiviazione analitica.
...
### -Schema
Oggetto PSCassandraSchema.
Usare New-AzCosmosDBCassandraSchema per creare l'oggetto.
...
### -Velocità effettiva
Velocità effettiva di Cassandra Keyspace (RU/s).
