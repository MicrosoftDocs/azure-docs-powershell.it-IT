...
## DESCRIZIONE
Registrare la configurazione di manutenzione per la risorsa.
...
Registrare la configurazione di manutenzione per un host dedicato.
...
MaintenanceConfiguration completa.
