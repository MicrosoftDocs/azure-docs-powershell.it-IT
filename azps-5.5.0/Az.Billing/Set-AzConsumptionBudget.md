...
### Esempio 2: Aggiornare un budget con una notifica quando il costo o l'utilizzo raggiunge una soglia del 90% a livello di abbonamento
```powershell
...
### Esempio 3: Aggiornare un preventivo in base a un nuovo importo con un nome di preventivo a livello di gruppo di risorse
```powershell
