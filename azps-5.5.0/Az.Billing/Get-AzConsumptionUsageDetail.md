...
## DESCRIZIONE
Il cmdlet **Get-AzConsumptionUsageDetail** ottiene i dettagli di utilizzo dell'abbonamento. 

## ESEMPI

### Esempio 1: Ottenere i dettagli di utilizzo con l'espansione di MeterDetails
```powershell
...
### Esempio 3: Ottenere i dettagli di utilizzo di BillingPeriodName con il filtro InstanceName
```powershell
...
### -BillingPeriodName
Nome di un periodo di fatturazione specifico a cui ottenere i dettagli di utilizzo associati.
...
### -EndDate
Data di fine (in UTC) degli utilizzi da filtrare.
...
### -Expand
Espandere gli utilizzi in base a MeterDetails o AdditionalInfo.
...
Includere proprietà aggiuntive nelle modalità di utilizzo.
...
### -IncludeMeterDetails
Includere i dettagli del contatore nelle modalità di utilizzo.
...
### -InstanceId
ID istanza degli utilizzi da filtrare.
...
### -InstanceName
Nome dell'istanza degli utilizzi da filtrare.
...
### -ResourceGroup
Gruppo di risorse degli utilizzi da filtrare.
...
### -StartDate
Data di inizio (in UTC) degli utilizzi da filtrare.
...
### -Tag
Tag degli utilizzi da filtrare.
