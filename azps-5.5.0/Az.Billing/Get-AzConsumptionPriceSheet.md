...
## DESCRIZIONE
Il **cmdlet Get-AzConsumptionPriceSheet** ottiene i listini prezzi dell'abbonamento.

## ESEMPI

### Esempio 1: Ottenere fogli prezzi
```powershell
...
### Esempio 2: Ottenere fogli prezzi con l'espansione di MeterDetails
```powershell
...
### Esempio 3: Ottenere fogli prezzi di BillingPeriodName
```powershell
...
### Esempio 4: Ottenere i primi 5 record di listini prezzi
```powershell
...
### -BillingPeriodName
Nome di un periodo di fatturazione specifico a cui ottenere gli fogli prezzi associati.
...
### -ExpandMeterDetail
Espandere i listini prezzi in base a MeterDetails.
