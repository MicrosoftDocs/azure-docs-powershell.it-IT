...
## DESCRIZIONE
Il cmdlet **Start-AzCdnEndpoint** avvia un endpoint della rete per la distribuzione di contenuti (CDN) di Azure.
...
### -CdnEndpoint
Specifica l'endpoint su cui viene avviato il cmdlet.
...
### -EndpointName
Specifica il nome dell'endpoint da cui viene avviato il cmdlet.
