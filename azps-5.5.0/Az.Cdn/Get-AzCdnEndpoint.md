...
## DESCRIZIONE
Il cmdlet **Get-AzCdnEndpoint** ottiene un endpoint della rete per la distribuzione di contenuti (CDN) di Azure e i dati di configurazione associati.
...
### -CdnProfile
Specifica l'oggetto profilo CDN a cui appartiene l'endpoint.
