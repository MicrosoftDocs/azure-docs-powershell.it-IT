...
## DESCRIZIONE
Il cmdlet **Get-AzCdnOrigin** ottiene un server di origine della rete per la distribuzione di contenuti (CDN) di Azure e i relativi dati di configurazione.
...
### -CdnEndpoint
Specifica l'oggetto endpoint della rete CDN a cui appartiene l'origine.
