...
## DESCRIZIONE
Remove-AzCdnOrigin eliminerà un'origine CDN dall'endpoint specificato. Se l'origine è l'unica origine all'interno dell'endpoint specificato, l'eliminazione non riuscirà perché è necessaria almeno un'origine. 
...
### -ResourceId
ID risorsa dell'origine CDN di Azure.
