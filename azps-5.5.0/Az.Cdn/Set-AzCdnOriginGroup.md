...
## DESCRIZIONE
Set-AzCdnOriginGroup aggiornerà il gruppo di origini specificato all'interno dell'endpoint specificato. 
...
### -OriginId
ID del gruppo di origine della rete CDN di Azure.
