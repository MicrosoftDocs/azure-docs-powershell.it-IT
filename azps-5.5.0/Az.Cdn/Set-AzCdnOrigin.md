...
## DESCRIZIONE
Il cmdlet **Set-AzCdnOrigin** aggiorna un server di origine della rete per la distribuzione di contenuti (CDN) di Azure.
...
### -CdnOrigin
Specifica il server di origine aggiornato da questo cmdlet.
...
### -HttpPort
Porta HTTP per l'origine HTTP della rete CDN di Azure.
...
### -PrivateLinkLocation
Percorso del collegamento privato di origine CDN di Azure.
