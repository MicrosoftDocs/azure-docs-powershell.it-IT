...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeUser** crea un nuovo utente per il dispositivo Data Box Edge. È supportata la creazione solo di `Share` utenti di tipo.
...
### -Password
Password, fornisci come stringa sicura
