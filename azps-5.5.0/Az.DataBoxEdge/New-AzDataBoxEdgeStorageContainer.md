...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeStorageContainer crea** un nuovo contenitore di archiviazione nell'account di Archiviazione Edge in un dispositivo Edge di Data Box.
