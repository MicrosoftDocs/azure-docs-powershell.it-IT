...
## DESCRIZIONE
Il **cmdlet Get-AzDataBoxEdgeUser** elenca gli utenti configurati per un dispositivo Data Box Edge. È possibile menzionare il nome nei parametri per ottenere informazioni dettagliate su un utente specifico.
