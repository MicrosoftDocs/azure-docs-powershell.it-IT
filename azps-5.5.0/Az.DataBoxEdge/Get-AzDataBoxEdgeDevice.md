...
## DESCRIZIONE
Il cmdlet **Get-AzDataBoxEdgeDevice** ottiene le informazioni sui dispositivi perimetrali della casella di dati disponibili. È possibile specificare il nome del dispositivo insieme al nome del gruppo di risorse per ottenere le informazioni in un dispositivo specifico. 
...
### -Avviso
Recuperare gli avvisi nel dispositivo gateway/edge della casella dei dati
...
### -ExtendedInfo
Recupera informazioni aggiuntive per il dispositivo gateway della casella di dati o del gateway della casella di dati specificato
...
### -NetworkSetting
Recupera le impostazioni di rete del dispositivo Gateway casella dati/Edge casella di dati specificato
...
### Microsoft.Azure.PowerShell.Cmdlets.DataBoxEdge.Models.PSDataBoxEdgeNetwork Collega
