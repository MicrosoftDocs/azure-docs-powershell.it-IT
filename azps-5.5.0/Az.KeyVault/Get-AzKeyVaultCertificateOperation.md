...
### Esempio 1: Ottenere lo stato di un'operazione sul certificato
```powershell
...
Questo comando ottiene lo stato dell'operazione sul certificato per TestCert01 nel vault delle chiavi ContosoKV01.
