...
### Esempio 1: Rimuovere un account di archiviazione di Azure gestito da Vault della chiave e tutte le definizioni di firma di accesso condiviso associate.
```powershell
...
### Esempio 2: rimuovere un account di archiviazione di Azure gestito dal Vault con una chiave e tutte le definizioni di firma di accesso condiviso associate senza conferma dell'utente.
```powershell
