...
## DESCRIZIONE
Ottiene un account di archiviazione di Azure gestito da Vault delle chiavi se il nome dell'account è specificato e le chiavi dell'account sono gestite dal vault specificato. Se il nome dell'account non è specificato, vengono elencati tutti gli account le cui chiavi sono gestite dal vault specificato.

## ESEMPI

### Esempio 1: Elencare tutti gli account di archiviazione gestiti da Vault chiave
```powershell
...
Elenca tutti gli account le cui chiavi sono gestite dal vault 'myvault'
...
Recupera i dettagli dell'account di archiviazione gestito da Vault delle chiavi di 'mystorageaccount' se le chiavi sono gestite dal vault 'myvault'

### Esempio 3: Elencare tutti gli account di archiviazione gestiti da Vault chiave usando il filtro
```powershell
...
Elenca tutti gli account le cui chiavi sono gestite dal vault 'myvault' che iniziano con "test"
