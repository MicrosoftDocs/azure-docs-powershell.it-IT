...
Questo comando crea una copia di backup della chiave denominata $key. Nome nel vault denominato $key. VaultName in un file denominato Backup.BLOB, sovrascrivendo automaticamente il file, se esistente.
...
### -InputObject
Bundle di chiavi di cui eseguire il backup, pipelined in seguito all'output di una chiamata di recupero.
...
### -VaultName
Specifica il nome del vault della chiave che contiene la chiave di cui eseguire il backup.
