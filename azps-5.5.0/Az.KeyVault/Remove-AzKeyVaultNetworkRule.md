...
Questo comando rimuove una regola di rete dal vault specificato, purché sia stata trovata una regola corrispondente all'indirizzo IP specificato e all'identificatore di risorsa di rete virtuale.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse associato al vault della chiave di cui viene modificata la regola di rete.
