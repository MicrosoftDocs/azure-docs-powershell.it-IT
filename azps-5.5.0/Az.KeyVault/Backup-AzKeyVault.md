...
Usare `Restore-AzKeyVault` per ripristinare il backup.
...
Il cmdlet crea una cartella (in genere denominata ) nel contenitore di archiviazione, archivia il backup in tale cartella e restituisce `mhsm-{name}-{timestamp}` l'URI della cartella.
