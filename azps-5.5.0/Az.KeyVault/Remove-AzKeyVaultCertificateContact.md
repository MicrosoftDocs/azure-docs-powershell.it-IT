...
## DESCRIZIONE
Il cmdlet **Remove-AzKeyVaultCertificateContact** elimina un contatto registrato per le notifiche di certificato da un vault chiave.

## ESEMPI

### Esempio 1: Rimuovere un contatto di certificato
```powershell
...
Questo comando rimuove Patti Fuller come contatto certificato per il vault della chiave Contoso01.  Se passThru è specificato, il cmdlet restituisce l'elenco dei contatti di certificati rimanenti.
