...
Se si impostano le autorizzazioni per un gruppo di sicurezza, questa operazione interessa solo gli utenti del gruppo di sicurezza.
...
Il secondo comando modifica le autorizzazioni concesse nel primo comando per consentire ora di ottenere informazioni segrete oltre a impostarle PattiFuller@contoso.com ed eliminarle. Le autorizzazioni per le operazioni con tasti rimangono invariate dopo questo comando.
...
Specifica le autorizzazioni per l'account di archiviazione gestito e le autorizzazioni per le operazioni di definizione della firma di accesso condiviso da concedere a un utente o a un'entità servizio.
Valori accettabili per questo parametro:
- tutti
- Ottieni
- elenco
