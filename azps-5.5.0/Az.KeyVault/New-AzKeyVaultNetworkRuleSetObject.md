...
## DESCRIZIONE
Creare un oggetto che rappresenti le impostazioni delle regole di rete che possono essere usate durante la creazione di un vault.
...
Creazione di un nuovo vault e specifica le regole di rete per consentire l'accesso all'indirizzo IP specificato dalla rete virtuale identificata $myNetworkResId.
