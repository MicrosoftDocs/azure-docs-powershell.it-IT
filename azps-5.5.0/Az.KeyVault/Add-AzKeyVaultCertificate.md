...
## DESCRIZIONE
Il cmdlet **Add-AzKeyVaultCertificate** avvia il processo di registrazione per un certificato in un vault delle chiavi nel Vault delle chiavi di Azure.

## ESEMPI

### Esempio 1: Aggiungere un certificato
```powershell
...
Il primo comando usa il cmdlet New-AzKeyVaultCertificatePolicy per creare un criterio di certificato e quindi lo archivia nella $Policy variabile.
Il secondo comando usa **Add-AzKeyVaultCertificate** per avviare il processo di creazione di un certificato.
Il terzo comando usa il cmdlet Get-AzKeyVaultCertificateOperation per eseguire il polling dell'operazione e verificare che sia stata completata.
Il comando finale usa il cmdlet Get-AzKeyVaultCertificate per ottenere il certificato.

## PARAMETERS

### -CertificatePolicy
Specifica un **oggetto KeyVaultCertificatePolicy.**
...
### -Name
Specifica il nome del certificato da aggiungere.
