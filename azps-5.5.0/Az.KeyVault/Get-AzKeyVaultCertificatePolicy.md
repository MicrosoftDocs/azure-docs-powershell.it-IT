...
## DESCRIZIONE
Il cmdlet **Get-AzKeyVaultCertificatePolicy** ottiene i criteri per un certificato in un vault delle chiavi nel Vault delle chiavi di Azure.
...
Questo comando recupera i criteri di certificato per il certificato TestCert01 nell'vault delle chiavi ContosoKV01.
