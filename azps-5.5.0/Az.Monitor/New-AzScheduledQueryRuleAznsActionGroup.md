...
## DESCRIZIONE
Crea un oggetto di tipo Gruppo di azioni azns.
Questo oggetto deve essere passato al comando che crea la regola di avviso.
...
### -ActionGroup
Elenco dei gruppi di azioni a cui inviare una notifica
...
### -EmailSubject
Oggetto del messaggio di posta elettronica della notifica di avviso
