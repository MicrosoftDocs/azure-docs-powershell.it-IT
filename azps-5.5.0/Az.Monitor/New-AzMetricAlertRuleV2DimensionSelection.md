...
### Esempio 1: Creare un oggetto di selezione della dimensione
...
Questo comando crea un oggetto di selezione della dimensione che specifica che è necessario selezionare {1,3,4} i valori per la dimensione "LUN"
