...
## DESCRIZIONE
Il cmdlet **Get-AzMetricAlertRuleV2** ottiene una regola di avviso metrica in base al nome o all'URI oppure a tutte le regole di avviso della metrica da un abbonamento o un gruppo di risorse specificato.
