...
## DESCRIZIONE
Il **cmdlet Get-AzAutoscaleHistory** recupera la cronologia degli eventi correlati a un'impostazione di scalabilità automatica.

## ESEMPI

### Esempio 1: Ottenere tutti gli eventi associati a una sottoscrizione
```
PS C:\>Get-AzAutoscaleHistory -StartTime 2015-02-09T18:35:00 -EndTime 2015-02-09T18:40:00 -DetailedOutput
```

Questo comando recupera tutti gli eventi correlati alla scala automatica associati alla sottoscrizione corrente.

### Esempio 2: GetAutoscaleHistory per una particolare risorsa
```
...
Questo comando recupera tutti gli eventi correlati alla scala automatica associati a una particolare risorsa identificata dall'ID della risorsa, essenzialmente ResourceUri.
...
### -ResourceId
Specifica l'ID della risorsa a cui è associata l'impostazione di scala automatica.
...
### -Stato
Specifica un filtro in base allo stato.
Questo parametro è facoltativo.
L'errore è una stringa vuota (ad esempio nessun filtro)
