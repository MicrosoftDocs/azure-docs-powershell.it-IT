...
## DESCRIZIONE
Il cmdlet **Add-AzAutoscaleSetting** crea un'impostazione di scala automatica.
...
### Esempio 1: Creare un'impostazione di gradazione automatica
```
...
I primi due comandi usano [Nuovo-AzAutoscaleRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscalerule) per creare due regole di scala $Rule 1 e $Rule 2.
Il terzo e il quarto comando usano [New-AzAutoscaleProfile](https://docs.microsoft.com/en-us/powershell/module/az.monitor/new-azautoscaleprofile) per creare profili di gradazione automatica, $Profile 1 e $Profile 2, usando $Rule 1 e $Rule 2.
Il comando finale crea un'impostazione di gradazione automatica usando i profili disponibili in $Profile 1 e $Profile 2.

## PARAMETERS

### -AutoscaleProfile
Specifica un elenco di profili da aggiungere all'impostazione di gradazione automatica oppure $Null non aggiungere alcun profilo.
...
### -DisableSetting
Disabilita un'impostazione di gradazione automatica esistente.
...
### -InputObject
Specifiche complete di una reimpostazione della scala automatica
...
### -Location
Specifica la posizione dell'impostazione di scala automatica.
...
### -Name
Specifica il nome dell'impostazione di scala automatica da creare.
...
### -Notifica
Specifica un elenco di notifiche separate da virgola.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse per la risorsa associata all'impostazione di scalabilità automatica.
...
### -TargetResourceId
Specifica l'ID della risorsa da scalare automaticamente.
