...
## DESCRIZIONE
Il cmdlet **Get-AzMetricDefinition** ottiene le definizioni della metrica.

## ESEMPI

### Esempio 1: Ottenere le definizioni metriche per una risorsa
```
...
Questo comando recupera le definizioni delle metriche per la risorsa specificata.

### Esempio 2: Ottenere le definizioni della metrica con output dettagliato
```
...
Questo comando ottiene le definizioni metriche per sito Web2.
L'output è dettagliato.

### Esempio 3: Ottenere le definizioni delle metriche in base al nome
```
...
Questo comando recupera le definizioni per le metriche ByteSent e CpuTime.
L'output è dettagliato.
...
### -DetailedOutput
Indica che questa operazione includeva un output dettagliato.
Se non si specifica questo parametro, l'output viene riepilogato.
...
### -MetricMetricMetric
Specifica lo spazio dei nomi metrico di cui eseguire query per le definizioni della metrica.
