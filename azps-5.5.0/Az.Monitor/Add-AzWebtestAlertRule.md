...
## DESCRIZIONE
Il cmdlet **Add-AzWebtestAlertRule** aggiunge o aggiorna una regola di avviso di tipo metrico, evento o test Web.
...
### Esempio 1: Aggiungere una regola di avviso test Web
```
...
Questo comando aggiunge o aggiorna una regola di avviso di test Web.
...
### -FailedLocationCount
Specifica il numero di posizione non riuscite per le regole di test Web.
Questa soglia è simile a quella degli altri tipi di regole.
...
### -MetricMetricMetric
Specifica lo spazio dei nomi metrico per la regola.
...
### -TargetResourceUri
Specifica l'ID risorsa del test Web.
