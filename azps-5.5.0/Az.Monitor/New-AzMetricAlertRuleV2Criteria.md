...
## DESCRIZIONE
Il cmdlet **New-AzMetricAlertRuleV2Criteria** crea un oggetto criteri metrico locale da usare come cmdlet [add-AzMetricAlertRuleV2](https://docs.microsoft.com/en-us/powershell/module/az.monitor/add-azmetricalertrulev2) di input, che crea una nuova regola di avviso per la metrica.
