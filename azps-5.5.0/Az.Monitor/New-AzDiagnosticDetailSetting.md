...
## DESCRIZIONE
Creare un oggetto PSMetricSettings o PSLogSettings. È possibile ottenere categorie tramite `Get-AzDiagnosticSettingCategory` .
...
Creare l'oggetto PSMetricSettings.
...
### -Log
Per creare un'impostazione del log
...
### -Metrica
Per creare un'impostazione metrica
...
### -TimeGrain
TimeGrain per l'impostazione della metrica
