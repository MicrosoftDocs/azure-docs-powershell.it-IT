...
Imposta le proprietà dell'argomento Griglia eventi Topic1 nel gruppo di risorse MyResourceGroupName per sostituire i tag con i tag \` \` specificati \` \` "Department" e "Environment".
