...
Rimuove la sottoscrizione evento \` EventSubscription1 in uno \` spazio dei nomi Hub eventi.
...
Rimuove la sottoscrizione \` dell'evento EventSubscription1 \` in un argomento della griglia eventi.
