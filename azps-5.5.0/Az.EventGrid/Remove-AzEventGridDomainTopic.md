...
Rimuove l'argomento Domain Topic1 della griglia eventi \` \` in Domain \` Domain1 nel gruppo di risorse \` \` MyResourceGroupName. \`
...
### -ResourceId
Identificatore di risorsa che rappresenta l'argomento Dominio griglia eventi.
