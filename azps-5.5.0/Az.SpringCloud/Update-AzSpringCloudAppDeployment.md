...
### Esempio 1: Aggiornare la distribuzione cloud Spring in base al nome.
```powershell
...
Aggiornare la distribuzione cloud spring in base al nome.

### Esempio 2: Aggiornare la distribuzione cloud spring dalla pipe.
```powershell
...
Aggiorna la distribuzione cloud spring dalla pipe.
...
### -MemoryInGb
Dimensioni della memoria richieste in GB
...
### -SourceArtifactSelector
Selettore per l'elemento da usare per la distribuzione per i progetti multi module.
Questo dovrebbe essere il percorso relativo del modulo o progetto di destinazione.
...
### -SourceRelativePath
Percorso relativo dello spazio di archiviazione in cui è archiviata l'origine
