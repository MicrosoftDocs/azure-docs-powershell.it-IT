...
### Esempio 1: Elencare tutte le chiavi dell'archivio di un archivio di configurazione delle app
```powershell
...
Questo comando elenca tutte le chiavi dell'archivio di un archivio di configurazione delle app.
