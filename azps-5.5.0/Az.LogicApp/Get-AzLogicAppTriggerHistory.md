...
Il cmdlet **Get-AzLogicAppTriggerHistory** ottiene la cronologia dei trigger in un'app per la logica nella caratteristica App logica.
...
### Esempio 1: Ottenere una cronologia trigger di un'app per la logica
...
Questo comando recupera l'intera cronologia dei trigger del flusso di lavoro per un trigger nell'app logica denominata LogicApp08 seguendo NextPageLink.
