...
### Esempio 1: Annullare un'esecuzione di un'app per la logica
```
...
### -Name
Specifica il nome di un'app per la logica per cui questo cmdlet annulla un'esecuzione.
...
### -RunName
Specifica il nome di un'app per la logica eseguita che questo cmdlet annulla.
