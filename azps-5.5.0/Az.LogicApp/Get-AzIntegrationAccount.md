...
## DESCRIZIONE
Il cmdlet **Get-AzIntegrationAccount** ottiene gli account di integrazione da un gruppo di risorse. Specificare il nome di un account di integrazione e di un gruppo di risorse.
