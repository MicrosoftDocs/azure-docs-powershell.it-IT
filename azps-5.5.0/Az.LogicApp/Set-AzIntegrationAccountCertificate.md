...
## DESCRIZIONE
Il **cmdlet Set-AzIntegrationAccountCertificate** modifica un certificato dell'account di integrazione.
...
### Esempio 1: Modificare un certificato di account di integrazione
```
...
Questo comando modifica il certificato dell'account di integrazione nel gruppo di risorse specificato.
...
### -KeyName
Specifica il nome di una chiave del certificato nel vault della chiave.
...
### -KeyVaultId
Specifica un ID vault della chiave.
...
### -KeyVersion
Specifica la versione della chiave del certificato nel vault della chiave.
