...
## DESCRIZIONE
Il cmdlet **Get-AzLogicAppTriggerUrl** ottiene un URL trigger trigger per l'app logica da un gruppo di risorse.
Questo cmdlet restituisce un oggetto **WorkflowTriggerUrlUrl** che rappresenta l'URL url.
Specificare il nome del gruppo di risorse, dell'app per la logica e il nome del trigger.
...
### Esempio 1: Ottenere un URL url url trigger per l'app per la logica
```
...
Questo comando recupera l'URL url url trigger dell'app logica.
...
### -TriggerName
Specifica il nome di un trigger.
...
### Microsoft.Azure.Management.Logic.Models.WorkflowTriggerUrl
