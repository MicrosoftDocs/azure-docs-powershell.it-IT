...
## DESCRIZIONE
Il cmdlet **Remove-AzIntegrationAccountBatchConfiguration** rimuove una configurazione batch da un account di integrazione.

## ESEMPI

### Esempio 1: Rimuovere una configurazione batch in base ai parametri
```powershell
...
Rimuove la configurazione batch denominata "sampleBatchConfig" che si trova nell'account di integrazione "sampleIntegrationAccount".
...
### -PassThru
Indica se il comando ha avuto esito positivo o meno.
