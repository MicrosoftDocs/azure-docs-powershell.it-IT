...
Il **cmdlet Get-AzLogicAppRunAction** ottiene un'azione da un'app logica eseguita.
Questo cmdlet restituisce un oggetto **WorkflowRunAction.**
Specificare l'app per la logica, il gruppo di risorse ed eseguire.
...
### Esempio 1: Ottenere un'azione da un'app logica eseguita
...
Questo comando ottiene una specifica azione dell'app logica denominata LogicApp05 per l'esecuzione con l'identificatore 08585925184423369718380498702CU26.
...
Questo comando recupera tutte le azioni dell'app logica da un'esecuzione con l'identificatore 08585925184423369718380498702CU26 di un'app logica denominata LogicApp05.

## PARAMETERS

### -ActionName

Specifica il nome di un'azione in esecuzione in un'app per la logica.
...
Specifica il nome di un'app per la logica per cui il cmdlet riceve un'azione.
...
Specifica il nome di un'esecuzione di un'app per la logica.
