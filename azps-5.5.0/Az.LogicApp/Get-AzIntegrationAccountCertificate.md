...
## DESCRIZIONE
Il cmdlet **Get-AzIntegrationAccountCertificate** ottiene certificati dell'account di integrazione da un gruppo di risorse.
...
Questo comando recupera il certificato dell'account di integrazione denominato IntegrationAccountCertificate01.

### Esempio 2: Ottenere certificati dell'account di integrazione in base al nome dell'account di integrazione
```
...
Questo comando recupera i certificati dell'account di integrazione per l'account di integrazione denominato IntegrationAccount31.
