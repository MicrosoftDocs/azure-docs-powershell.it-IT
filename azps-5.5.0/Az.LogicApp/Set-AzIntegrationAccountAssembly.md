...
### ByIntegrationAccountAndFilePath (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Set-AzIntegrationAccountAccountAccount Modifies** an integration account assembly.

## ESEMPI

### Esempio 1: Modificare un assembly usando un file locale
```powershell
...
Modifica l'assembly denominato "sampleSample" usando il file locale che si trova nel percorso del file contenuto in "$localAssemblyFilePath".

### Esempio 2: Modificare un assembly con dati di tipo byte
```powershell
...
Modifica l'assembly denominato "sampleSample" usando la matrice di byte contenuta in "$assemblyContent".

### Esempio 3: Modificare un assembly usando un collegamento di contenuto
```powershell
...
Modifica l'assembly denominato "sampleSample" usando i dati di tipo byte che si trovano nell'URL "$assemblyUrl". Questo è il metodo suggerito per la creazione di assembly di grandi dimensioni.

## PARAMETERS

### -AssemblyData
Dati di byte di assembly dell'account di integrazione.
...
### -AssemblyFilePath
Percorso file assembly dell'account di integrazione.
...
### -ContentLink
Collegamento pubblico ai dati di assembly dell'account di integrazione.
...
### -InputObject
Assembly di account di integrazione.
...
### -Metadata
Metadati dell'assembly dell'account di integrazione.
...
### -ResourceId
ID risorsa assembly dell'account di integrazione.
