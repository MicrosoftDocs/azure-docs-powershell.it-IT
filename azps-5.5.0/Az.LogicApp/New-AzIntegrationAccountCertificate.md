...
## DESCRIZIONE
Il cmdlet **New-AzIntegrationAccountCertificate** crea un certificato dell'account di integrazione.
Questo cmdlet restituisce un oggetto che rappresenta il certificato dell'account di integrazione.
Specificare il nome dell'account di integrazione, il nome del gruppo di risorse, il nome del certificato, il nome della chiave, la versione della chiave e l'ID vault della chiave.
...
### Esempio 1: Creare un certificato di account di integrazione
```
...
### -KeyName
Specifica il nome della chiave del certificato nel vault della chiave.
