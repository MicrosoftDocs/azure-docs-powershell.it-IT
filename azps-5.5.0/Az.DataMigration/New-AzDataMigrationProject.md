...
L'esempio precedente mostra come creare un nuovo progetto denominato MyDMSProject situato nell'area centrale degli Stati Uniti nell'istanza del servizio di migrazione di database di Azure denominata TestService.
...
### -SourceType
Tipo di piattaforma di origine per il progetto.
...
### -TargetType
Tipo di piattaforma di destinazione per il progetto.
