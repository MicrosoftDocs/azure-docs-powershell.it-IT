...
## DESCRIZIONE
Il cmdlet New-AzDataMigrationFileShare crea l'oggetto FileShare che specifica la condivisione di rete locale a cui il servizio di migrazione del database di Azure può eseguire il backup del database di origine. L'account del servizio che SQL Server'istanza di origine deve avere privilegi di scrittura su questa condivisione di rete.
