...
## DESCRIZIONE
Il Start-AzDataMigrationService cmdlet avvia un'istanza del servizio di migrazione del database di Azure in uno stato di interruzione. 
...
L'esempio precedente avvia un'istanza del servizio di migrazione del database di Azure denominata Servizio di test in stato di interruzione in base al nome del servizio passato come input
...
L'esempio precedente avvia un'istanza del servizio di migrazione del database di Azure basata su PSDataMigrationService passato come parametro di input
