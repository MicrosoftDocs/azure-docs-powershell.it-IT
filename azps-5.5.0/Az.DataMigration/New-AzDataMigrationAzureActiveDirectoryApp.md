...
## SYNOPSIS
Creare una nuova istanza dataMigration Azure ActiveDirectory Application details.
...
```
ApplicationId: "Id AppId/ID entità servizio qui" AppKey : System.Security.SecureString TenantId : "ID tenant"
...
### -ApplicationId
ID applicazione Azure Active Directory
