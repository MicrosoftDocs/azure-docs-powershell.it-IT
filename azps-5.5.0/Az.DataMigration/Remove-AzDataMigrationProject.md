...
## DESCRIZIONE
Il cmdlet Remove-AzDataMigrationProject rimuove un progetto del servizio di migrazione del database di Azure da Azure. Se si specifica il parametro DeleteRunningTask, vengono rimosse tutte le attività del servizio di migrazione del database di Azure associate al progetto da rimuovere. 
...
L'esempio precedente rimuove il progetto del servizio di migrazione dei database di Azure denominato myDMProject da Azure in base al nome come parametro di input
...
L'esempio precedente rimuove il progetto del servizio di migrazione del database di Azure basato sull'oggetto PSProject come parametro di input.
...
### -DeleteRunningTask
Eliminare qualsiasi attività in esecuzione
