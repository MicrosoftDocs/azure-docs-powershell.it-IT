...
<IServerAutoGenerated>INPUTOBJECT: server per la stringa di connessione
  ...
  - `[AdministratorLoginPassword <String>]`: password di accesso dell'amministratore (necessaria per la creazione del server).
  ...
  - `[SkuTier <SkuTier?>]`: il livello dello specifico SKU, ad esempio a scatto a scatto.
