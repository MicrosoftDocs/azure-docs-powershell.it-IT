...
### Esempio 1: Aggiornare la regola del firewall PostgreSql in base al nome
```powershell
...
Questo cmdlet aggiorna la regola del firewall PostgreSql in base al nome.

### Esempio 2: Aggiornare la regola del firewall PostgreSql in base all'identità.
```powershell
...
Questi cmdlet aggiornano la regola del firewall PostgreSql in base all'identità.

### Esempio 3: Aggiornare la regola del firewall PostgreSql per -ClientIPAddress.
```powershell
...
Questi cmdlet aggiornano la regola del firewall PostgreSql per -ClientIPAddress.
