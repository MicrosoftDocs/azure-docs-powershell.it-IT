...
### Esempio 1: Rimuovere la regola del firewall PostgreSql in base al nome
```powershell
PS C:\> Remove-AzPostgreSqlFirewallRule -Name rule -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Questo cmdlet rimuove la regola del firewall PostgreSql in base al nome.

### Esempio 2: Rimuovere la regola del firewall PostgreSql in base all'identità
```powershell
...
Questi cmdlet rimuovono la regola del firewall PostgreSql in base all'identità.
