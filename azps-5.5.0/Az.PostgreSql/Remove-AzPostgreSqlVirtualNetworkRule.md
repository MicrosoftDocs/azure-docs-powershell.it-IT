...
### Esempio 1: Rimuovere la regola di rete virtuale del server PostgreSql in base al nome
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Questo cmdlet rimuove la regola di rete virtuale del server PostgreSql in base al nome.

### Esempio 2: Rimuovere una regola di rete virtuale del server PostgreSql in base all'identità
```powershell
...
Questi cmdlet rimuovono la regola di rete virtuale del server PostgreSql in base all'identità.
