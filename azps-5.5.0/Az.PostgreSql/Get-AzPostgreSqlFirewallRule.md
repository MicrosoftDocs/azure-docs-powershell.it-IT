...
### Esempio 1: Elenca tutte le regole del firewall nel server PostgreSql specificato
```powershell
...
Questo cmdlet elenca tutte le regole del firewall nel server PostgreSql specificato.

### Esempio 2: Ottenere la regola del firewall in base al nome
```powershell
...
Questo cmdlet ottiene la regola del firewall in base al nome.

### Esempio 3: Ottenere la regola del firewall in base all'identità
```powershell
...
Questo cmdlet ottiene la regola del firewall in base all'identità.
