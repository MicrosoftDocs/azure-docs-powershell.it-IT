...
### Esempio 1: Updatae specificata configurazione PostgreSql in base al nome
```powershell
...
Questo cmdlet aggiorna la configurazione PostgreSql specificata in base al nome.

### Esempio 1: Updatae specificato configurazione PostgreSql in base all'identità
```powershell
...
Questo cmdlet aggiorna la configurazione PostgreSql specificata in base all'identità.
