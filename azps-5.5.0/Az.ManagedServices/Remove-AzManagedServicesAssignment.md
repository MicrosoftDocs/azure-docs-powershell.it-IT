...
## SYNOPSIS
Elimina un'attività di registrazione.
...
Elimina l'assegnazione di registrazione per nome nell'ambito predefinito.
...
Elimina l'assegnazione di registrazione per nome nell'ambito specificato.
...
### -InputObject
Oggetto assegnazione di registrazione.
...
### -Scope
Ambito dell'assegnazione di registrazione.
