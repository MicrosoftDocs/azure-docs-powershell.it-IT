...
Questo esempio crea **un'azione AlertRuleAction** per la regola di avviso specificata usando le proprietà dell'app logica e quindi la archivia nella $AlertRuleAction variabile.
