...
## DESCRIZIONE
Il cmdlet **Update-AzSentinelAlertRuleAction** aggiorna il segnalibro nell'area di lavoro specificata.
È possibile passare un **oggetto AlertRuleAction** come parametro o usando l'operatore della pipeline oppure in alternativa è possibile specificare i parametri *AlertRuleId* *e ActionId.*
...
Questo esempio aggiorna **un'azione AlertRuleAction** sostituendo un'azione *esistente* con nuove proprietà.
...
Questo esempio aggiorna **un oggetto AlertRuleAction usando** un oggetto InputObject sostituendo un'azione *esistente* con nuove proprietà.
...
### -TriggerUri
Uri del trigger dell'app per la logica di azione.
