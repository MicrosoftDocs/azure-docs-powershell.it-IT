...
## DESCRIZIONE
Il cmdlet **New-AzSentinelIncident** crea un evento imprevisto dall'area di lavoro specificata.
...
Questo esempio crea un evento **imprevisto** nell'area di lavoro specificata e quindi lo archivia nella $Incident variabile.
