...
## DESCRIZIONE
Il cmdlet **Remove-AzSentinelDataConnector** elimina definitivamente un connettore di dati da un'area di lavoro specificata.
È possibile passare un **oggetto DataConnector** usando l'operatore della pipeline oppure è possibile specificare i parametri obbligatori.
...
Questo comando rimuove DataConnector dall'area di lavoro.
