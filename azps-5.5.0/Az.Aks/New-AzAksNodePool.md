...
### -OsType
OsType da usare per specificare il tipo di carattere os.
Scegli tra Linux e Windows.
Per impostazione predefinita, Linux.
...
ScaleSetEvictionPolicy da usare per specificare i criteri di spostazione per il set di scalabilità delle macchine virtuali con priorità bassa.
L'impostazione predefinita è Elimina.
...
### -ScaleSetPriority
ScaleSetPriority da usare per specificare la priorità del set di scalabilità delle macchine virtuali.
