...
## SYNOPSIS
Importare e unire la configurazione Kubectl per un cluster Kubernetes gestito.
...
### Importare e unire la configurazione kubectl
```
...
### -Admin
Ottenere la configurazione kubectl di 'clusterAdmin' invece dell'impostazione predefinita 'clusterUser'.
...
### -ConfigPath
Un file di configurazione kubectl da creare o aggiornare.
Usare invece "-" per stampare YAML su stdout.
Impostazione predefinita: %Home%/.kube/config.
...
### -Force
Importa configurazione Kubernetes anche se è l'impostazione predefinita
...
### -PassThru
Restituisce true se l'importazione riesce
