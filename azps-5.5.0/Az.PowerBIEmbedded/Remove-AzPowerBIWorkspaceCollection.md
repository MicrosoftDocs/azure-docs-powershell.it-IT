...
## SYNOPSIS
Rimuove una raccolta di aree di lavoro di Power BI.
...
### Esempio 1: Rimuovere una raccolta di aree di lavoro
```
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse da cui questo cmdlet rimuove una raccolta di aree di lavoro.
...
Specifica il nome della raccolta dell'area di lavoro di Power BI rimossa dal cmdlet.
