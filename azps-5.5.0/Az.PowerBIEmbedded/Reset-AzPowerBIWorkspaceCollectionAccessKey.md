...
## DESCRIZIONE
Il cmdlet **Reset-AzPowerBIWorkspaceCollectionAccessKey** reimposta la chiave di accesso specificata nella raccolta dell'area di lavoro di Power BI.

## ESEMPI

### Esempio 1: Reimpostare la chiave di accesso primaria
```
PS C:\>Reset-AzPowerBIWorkspaceCollectionAccessKey -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11" -Key1
```

Questo comando reimposta la chiave di accesso primaria per la raccolta dell'area di lavoro denominata WCN11 nel gruppo di risorse specificato.
...
### -Key1
Indica che questo cmdlet reimposta la chiave di accesso primaria.
...
### -Key2
Indica che questo cmdlet reimposta la chiave di accesso secondaria.
...
Specifica il nome della raccolta dell'area di lavoro di Power BI su cui opera questo cmdlet.
...
### Microsoft.Azure.Commands.Management.PowerBIE systemdded.Models.PSWorkspaceCollectionAccessKey
