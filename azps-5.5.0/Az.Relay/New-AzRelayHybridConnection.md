...
## DESCRIZIONE
Il New-AzRelayHybridConnection cmdlet crea una connessione ibrida nello spazio dei nomi Relay specificato.
...
Crea una nuova hybirdConnection TestHybirdConnection2 nello spazio dei nomi \` \` Relay specificato \` TestNameSpace-HybirdConnection. \`
...
Crea una nuova connessione HybirdConnection TestHybirdConnection1 nello spazio dei nomi \` \` Relay specificato \` TestNameSpace-HybirdConnection. \`
...
true se è necessaria l'autorizzazione client per hybridConnections; in caso contrario false
