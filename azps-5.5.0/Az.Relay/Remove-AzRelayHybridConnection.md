...
## DESCRIZIONE
Il cmdlet **Remove-AzRelayHybridConnection** rimuove HybridConnection dallo spazio dei nomi Relay specificato.
...
Rimuove HybridConnection `TestHybridConnection` dallo spazio dei `TestNameSpace-Relay1` nomi.
