...
## DESCRIZIONE
Il cmdlet **Remove-AzWcfRelay** rimuove WcfRelay dallo spazio dei nomi Relay specificato.
...
Rimuove WcfRelay `TestWCFRelay1` dallo spazio dei `TestNameSpace-Relay1` nomi.
