...
ms.locfileid: "100206075"
---
# <span data-ttu-id="fe17c-101">Get-AzRelayOperation</span><span class="sxs-lookup"><span data-stu-id="fe17c-101">Get-AzRelayOperation</span></span>

## <span data-ttu-id="fe17c-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="fe17c-102">SYNOPSIS</span></span>
<span data-ttu-id="fe17c-103">Elencare le operazioni di inoltro supportate</span><span class="sxs-lookup"><span data-stu-id="fe17c-103">List supported Relay Operations</span></span>

## <span data-ttu-id="fe17c-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="fe17c-104">SYNTAX</span></span>

```
Get-AzRelayOperation [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="fe17c-105">DESCRIZIONE</span><span class="sxs-lookup"><span data-stu-id="fe17c-105">DESCRIPTION</span></span>
<span data-ttu-id="fe17c-106">Il **cmdlet Get-AzRelayOperation** elenca le operazioni supportate dall'inoltro.</span><span class="sxs-lookup"><span data-stu-id="fe17c-106">The **Get-AzRelayOperation** cmdlet Lists the Relay supported Operations.</span></span>

## <span data-ttu-id="fe17c-107">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="fe17c-107">EXAMPLES</span></span>

### <span data-ttu-id="fe17c-108">Esempio 1</span><span class="sxs-lookup"><span data-stu-id="fe17c-108">Example 1</span></span>
```
...
<span data-ttu-id="fe17c-109">Elenca le operazioni supportate dall'inoltro</span><span class="sxs-lookup"><span data-stu-id="fe17c-109">Lists Relay supported operations</span></span>

## <span data-ttu-id="fe17c-110">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="fe17c-110">PARAMETERS</span></span>

### <span data-ttu-id="fe17c-111">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="fe17c-111">-DefaultProfile</span></span>
<span data-ttu-id="fe17c-112">Le credenziali, l'account, il tenant e la sottoscrizione usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="fe17c-112">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="fe17c-113">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="fe17c-113">CommonParameters</span></span>
<span data-ttu-id="fe17c-114">Questo cmdlet supporta i parametri comuni: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutAction, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="fe17c-114">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="fe17c-115">Per altre informazioni, vedere about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="fe17c-115">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="fe17c-116">INPUT</span><span class="sxs-lookup"><span data-stu-id="fe17c-116">INPUTS</span></span>

### <span data-ttu-id="fe17c-117">Nessuno</span><span class="sxs-lookup"><span data-stu-id="fe17c-117">None</span></span>

## <span data-ttu-id="fe17c-118">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="fe17c-118">OUTPUTS</span></span>

### <span data-ttu-id="fe17c-119">Microsoft.Azure.Commands.Relay.Models.PSOperationAttributes</span><span class="sxs-lookup"><span data-stu-id="fe17c-119">Microsoft.Azure.Commands.Relay.Models.PSOperationAttributes</span></span>

## <span data-ttu-id="fe17c-120">NOTE</span><span class="sxs-lookup"><span data-stu-id="fe17c-120">NOTES</span></span>

## <span data-ttu-id="fe17c-121">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="fe17c-121">RELATED LINKS</span></span>
