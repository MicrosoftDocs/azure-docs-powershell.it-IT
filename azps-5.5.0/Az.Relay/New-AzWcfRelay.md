...
## DESCRIZIONE
Il cmdlet New-AzWcfRelay crea un elemento WcfRelay nello spazio dei nomi Relay specificato.
...
Crea un nuovo modello WcfRelay TestWCFRelay2 nello spazio dei nomi \` \` Relay specificato \` TestNameSpace-Relay. \`
...
Crea un nuovo oggetto WcfRelay \` TestWCFRelay nello spazio dei nomi \` Relay specificato \` TestNameSpace-Relay1. \`
...
true se è necessaria l'autorizzazione client per l'inoltro; in caso contrario false
...
true se è necessaria la sicurezza del trasporto per questo inoltro; in caso contrario false
