...
### Esempio 1: Aggiornare un kubernet connesso
```powershell
...
Questo comando aggiorna un kubernet connesso.

### Esempio 2: Aggiornare un kubernet connesso in base all'oggetto
```powershell
...
Questo comando aggiorna i kubernet connessi in base all'oggetto.
