...
## DESCRIZIONE
Per i token di firma di accesso condiviso del dispositivo, il parametro dei criteri viene usato solo per accedere al Registro di sistema del dispositivo. Di conseguenza, i criteri devono avere accesso in lettura al Registro di sistema.
Per i token dell'Hub IoT, il criterio fa parte della firma di accesso condiviso.
...
Generare un token di firma di accesso condiviso dell'Hub IoT usando il criterio iothubowner e la chiave primaria.
...
Generare un token di firma di accesso condiviso dell'Hub IoT usando il criterio RegistryRead e la chiave secondaria.
...
Genera un token di firma di accesso condiviso del dispositivo usando i criteri iothubowner per accedere al Registro di sistema del dispositivo {iothub_name}.
...
Generare un token di firma di accesso condiviso del modulo usando i criteri iothubowner per accedere al Registro di sistema del dispositivo {iothub_name}.
...
### -Durata
Scadenza futura (in secondi) del token da generare.
L'impostazione predefinita è 3600.
