...
## DESCRIZIONE
È possibile eseguire query in un Hub IoT usando un potente linguaggio simile SQL per recuperare informazioni su dispositivi e moduli, processi e routing dei messaggi.
Per https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-query-language altre informazioni, vedere.
...
Eseguire query su tutti i dati di dispositivo in un Hub IoT di Azure.
...
Eseguire query sui 2 principali dati del modulo in un dispositivo di destinazione.
...
Per impostazione predefinita, la query non ha alcun limite.
