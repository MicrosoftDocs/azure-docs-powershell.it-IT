...
Nota: Al momento dell'esecuzione del comando verrà generato l'output della raccolta dei moduli applicati al dispositivo.
...
Prova i moduli edge durante lo sviluppo impostando i moduli su un dispositivo di destinazione.
