...
## DESCRIZIONE
Aggiorna o sostituisce un dispositivo. Per https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twins altre informazioni, vedere.
...
Restituisce l'oggetto modulo dispositivo aggiornato.
...
Restituisce l'oggetto modulo dispositivo con le proprietà desiderate aggiornate.
...
Restituisce l'oggetto modulo dispositivo con la proprietà tag aggiornata.
...
Restituisce l'oggetto modulo dispositivo sostituito.
...
### -Desiderato
Aggiungere o aggiornare la proprietà desiderata in un modulo.
...
### -Parziale
Consente di aggiornare solo parzialmente i tag e le proprietà desiderate di un modulo.
...
### -Tag
Aggiungere o aggiornare la proprietà tag in un modulo.
