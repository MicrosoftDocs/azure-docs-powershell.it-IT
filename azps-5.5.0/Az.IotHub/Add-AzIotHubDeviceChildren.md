...
## DESCRIZIONE
Aggiungere l'elenco specificato con valori delimitati da virgole degli ID dispositivo non perimetrali come figli del dispositivo perimetrale specificato.
...
Aggiungi dispositivi non perimetrali come figli al dispositivo perimetrale indipendentemente dal fatto che il dispositivo non edge sia già un figlio di un altro dispositivo perimetrali.

## PARAMETERS

### -Bambini
L'elenco di dispositivi figlio (separati da virgola) include solo i dispositivi non perimetrali.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevice Avi
