...
## DESCRIZIONE
Valutare una metrica personalizzata o di sistema di destinazione definita in una configurazione di dispositivi IoT.
Esistono metriche di sistema predefinite che vengono calcolate dall'Hub Iot e non possono essere personalizzate.
- "Mirato" specifica il numero di unità di dispositivo che corrispondono alla condizione di destinazione.
- "Applied" ha specificato il numero di dispositivi che sono stati modificati dalla configurazione. 
