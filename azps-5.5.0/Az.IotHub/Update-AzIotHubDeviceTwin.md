...
## DESCRIZIONE
Aggiorna o sostituisce un dispositivo. Per https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twins altre informazioni, vedere.
...
Restituisce l'oggetto dispositivo aggiornato.
...
Restituisce l'oggetto dispositivo con le proprietà desiderate aggiornate.
...
Restituisce l'oggetto dispositivo con la proprietà tag aggiornata.
...
Restituisce l'oggetto dispositivo sostituito.
...
### -Desiderato
Aggiungere o aggiornare la proprietà desiderata in un dispositivo.
...
### -Parziale
Consente solo parzialmente di aggiornare i tag e le proprietà desiderate di un dispositivo.
...
### -Tag
Aggiungere o aggiornare la proprietà tag in un dispositivo.
