...
## DESCRIZIONE
Crea un nuovo processo di importazione dei dispositivi per IotHub.
Tutti i dispositivi verranno importati in IotHub dal contenitore specificato. Vedere l'articolo seguente che illustra come generare l'URI di firma di accesso condiviso.
...
Crea una nuova richiesta di dispositivo di importazione per il dispositivo IotHub "myiothub".
