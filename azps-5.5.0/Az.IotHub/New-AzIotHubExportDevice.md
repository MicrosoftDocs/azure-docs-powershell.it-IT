...
## DESCRIZIONE
Crea un nuovo processo di esportazione dei dispositivi per IotHub.
Tutti i dispositivi verranno esportati nel contenitore specificato. Vedere l'articolo seguente che illustra come generare l'URI di firma di accesso condiviso.
https://docs.microsoft.com/azure/iot-hub/iot-hub-bulk-identity-mgmt#get-the-container-sas-uri .

## ESEMPI

### Esempio 1: esportare una richiesta di dispositivo.
```
...
Crea una nuova richiesta di dispositivo di esportazione per il dispositivo IotHub "myiothub" escludendo le chiavi.
...
### -ExcludeKeys
Consente di esportare i dispositivi senza chiavi.
