...
## DESCRIZIONE
Per una spiegazione dettagliata dell'arricchimento dei messaggi nell'Hub IoT di Azure, vedere https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Elencare tutti gli arricchimenti dei messaggi in MyIotHub
...
Visualizzare i dettagli sull'arricchimento del messaggio "newKey".
