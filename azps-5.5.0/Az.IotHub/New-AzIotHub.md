...
## DESCRIZIONE
Crea un nuovo IotHub.
È possibile creare IotHub con le proprietà predefinite o specificare le proprietà di input.

## ESEMPI

### Esempio 1: Creare un nuovo IotHub con proprietà predefinite
```
PS C:\> $tags = @{}
...
Crea un nuovo IotHub denominato "myiothub" della sku "S1", della capacità 1 e della posizione "nordeuropea" inclusa in Tag.

### Esempio 2: Creare un nuovo iotHub con MaxDeliveryCount della coda CloudToDevice impostata su 20
```
PS C:\> New-AzIotHub -ResourceGroupName "myresourcegroup" -Name "myiothub" -SkuName "S1" -Units 1 -Location "northeurope" -Properties $properties
```

Crea un nuovo IotHub denominato "myiothub" della sku "S1", della capacità 1 e della posizione "nordeuropea" con proprietà di input avanzate rappresentate da $properties.
...
### -Location
Posizione in cui deve essere creato l'hub IoT. 
...
### -Tag
Tag di istanza dell'hub IoT. Il bag delle proprietà in coppie chiave-valore sotto forma di tabella hash.
