...
## DESCRIZIONE
Elenco della stringa di connessione di tutti i dispositivi o di un dispositivo IoT di destinazione contenuto in un hub IoT di Azure.
...
Mostra la stringa di connessione di tutti i dispositivi in un hub Iot.
...
Ottenere la stringa di connessione secondaria di un dispositivo IoT.
