...
## DESCRIZIONE
Verifica un certificato caricando un certificato di verifica contenente il codice di verifica ottenuto dal cmdlet Get-AzIotHubCertificateVerificationCode. Questo è l'ultimo passaggio della prova del processo di approvazione.
Per una spiegazione dettagliata dei certificati CA nell'Hub IoT di Azure, vedi https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-x509ca-overview
...
Verifica la proprietà della chiave privata MyCertificate. 
