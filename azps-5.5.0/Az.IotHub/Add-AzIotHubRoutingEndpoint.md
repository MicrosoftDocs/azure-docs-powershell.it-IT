...
## DESCRIZIONE
Aggiungere un nuovo endpoint nell'hub IoT. Per informazioni sugli endpoint supportati, vedi https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-endpoints
...
Aggiungere un nuovo endpoint "E2" di tipo EventHub a un hub IoT "myiothub".
...
Aggiungere un nuovo endpoint "S1" di tipo AzureStorageContainer a un hub IoT "myiothub".
...
### -Encoding
Selezionare il formato in cui instradare i dati. È possibile selezionare JSON o AVRO. L'impostazione predefinita è AVRO.
