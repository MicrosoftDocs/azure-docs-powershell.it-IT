...
### Esempio 1 Rigenerare la chiave primaria
```
...
Chiave primaria rigenerata per il criterio di autorizzazione "testKey" di un hub azure iot.

### Esempio 2 Scambio di tasti
```
...
Scambio di chiavi con il criterio di autorizzazione "testKey" di un hub azure iot.
