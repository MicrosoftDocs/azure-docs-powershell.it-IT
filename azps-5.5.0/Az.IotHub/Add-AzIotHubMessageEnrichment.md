...
## DESCRIZIONE
Aggiungere fino a 10 arricchimenti dei messaggi per l'Hub IoT. Vengono aggiunte come proprietà dell'applicazione ai messaggi inviati agli endpoint selezionati.
Per saperne di più, vedi https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-message-enrichments-overview
...
Aggiungere un nuovo arricchimento con la chiave "newKey" e il valore "newValue". Questo nuovo arricchimento viene applicato agli endpoint "endpoint1" e "endpoint2".
...
### -Endpoint
Endpoint a cui applicare l'arricchimento.
