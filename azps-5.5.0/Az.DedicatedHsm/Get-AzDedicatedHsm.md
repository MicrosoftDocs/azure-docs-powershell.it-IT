...
## SYNOPSIS
Ottiene l'HSM dedicato di Azure specificato.
...
### Esempio 1: Ottieni tutto il servizio HSM dedicato in un abbonamento
```powershell
...
Questo comando recupera tutti gli elementi Dedicated HSM in un abbonamento

### Esempio 2: Ottieni tutto il servizio HSM dedicato in un gruppo di risorse.
```powershell
...
Questo comando recupera tutte le risorse Dedicated HSM in un gruppo di risorse.

### Esempio 3: Ottenere un HSM dedicato in base al nome
```powershell
...
Questo comando ottiene un servizio HSM dedicato in base al nome.

### Esempio 4: Ottenere un HSM dedicato in base all'oggetto
```powershell
...
Questo comando ottiene un HSM dedicato in base all'oggetto.
...
### -Name
Il nome del servizio HSM dedicato.
...
### -ResourceGroupName
Nome del gruppo di risorse a cui appartiene l'hsm dedicato.
...
INPUTOBJECT <IDedicatedHsmIdentity> : parametro identity
  - `[Id <String>]`: percorso di identità della risorsa
  - `[Name <String>]`: nome dell'Hsm dedicato
  - `[ResourceGroupName <String>]`: nome del gruppo di risorse a cui appartiene la risorsa.
