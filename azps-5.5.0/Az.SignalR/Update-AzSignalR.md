...
### Aggiorna un servizio SignalR specifico.
```powershell
...
L'impostazione predefinita è "Standard_S1".
...
### -UnitCount
Il numero di unità di servizio SignalR, valore solo da {1, 2, 5, 10, 20, 50, 100}.
