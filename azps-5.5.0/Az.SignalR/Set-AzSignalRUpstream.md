...
## SYNOPSIS
Configura le impostazioni upstream di un servizio SignalR.
...
### Impostare due modelli upstream ordinati
```powershell
...
Il JSON seguente rappresenta il set di modelli effettivo. 
...
### Cancellare tutte le impostazioni di upstream
```powershell
...
Chiave obbligatoria: UrlTemplate.
Chiavi facoltative: HubOrdinamento, EventOrdinamento, CategoryOrdinamento.
Esempio di utilizzo della sintassi della splatting per passare il parametro templates: @{UrlTemplate=' http://host-connections1.com ', Hub Sistema= 'chat'; EventTemplate='broadcast' },@{UrlTemplate=' http://host-connections2.com '}
...
[Come usare la splatting per passare parametri ai comandi in PowerShell](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_splatting?view=powershell-7)
