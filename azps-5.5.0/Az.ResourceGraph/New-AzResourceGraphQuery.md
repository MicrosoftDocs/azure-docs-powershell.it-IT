...
## SYNOPSIS
Creare una nuova query grafico.
...
### Esempio 1: Creare una query del grafico delle risorse tramite il parametro di query
```powershell
...
Questo comando crea una query del diagramma risorse tramite il parametro di query.

### Esempio 2: Creare una query del grafico delle risorse tramite il parametro del file
```powershell
...
Questo comando crea una query del diagramma risorse tramite il parametro del file.
