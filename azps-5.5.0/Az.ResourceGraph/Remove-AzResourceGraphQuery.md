...
### Esempio 1: Rimuovere una query del grafico delle risorse in base al nome
```powershell
PS C:\> Remove-AzResourceGraphQuery -ResourceGroupName azure-rg-test -Name query-t03

```

Questo comando rimuove una query del grafico risorse in base al nome.

### Esempio 2: Rimuovere una query del grafico delle risorse per oggetto
```powershell
...
Questo comando rimuove una query del diagramma risorse per oggetto.
