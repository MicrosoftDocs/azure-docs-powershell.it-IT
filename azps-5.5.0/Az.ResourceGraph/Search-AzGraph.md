...
## SYNOPSIS
Esegue query sulle risorse gestite da Gestione risorse di Azure.
...
```
Query che mostra tutte le macchine virtuali che non usano dischi gestiti e che include i nomi visualizzati dell'abbonamento.
