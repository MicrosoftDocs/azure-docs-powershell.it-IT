...
Il primo comando usa il cmdlet Get-AzStorageAccount per ottenere l'account di archiviazione denominato Storage135 che appartiene a ResourceGroup001 e archivia il risultato nella variabile $StorageAccount.
Il secondo comando sincronizza le chiavi dell'account di archiviazione per il servizio multimediale denominato MediaService001 usando la **proprietà Id** contenuta nella $StorageAccount variabile.

## PARAMETERS

### -AccountName
Specifica il nome del servizio multimediale sincronizzato dal cmdlet.
