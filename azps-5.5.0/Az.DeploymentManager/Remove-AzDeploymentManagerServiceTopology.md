...
## DESCRIZIONE
Il cmdlet **Remove-AzDeploymentManagerServiceTopology** elimina una topologia di servizio.
...
Questo comando elimina una topologia di servizio denominata ContosoServiceTopology in ContosoResourceGroup.

### Esempio 2: Eliminare la topologia di un servizio usando l'identificatore di risorsa.
```powershell
...
### Esempio 3: Eliminare una topologia di servizio usando l'oggetto topologia di servizio.
```powershell
PS C:\> Remove-AzDeploymentManagerService -InputObject $serviceTopologyObject
```

Questo comando elimina una topologia di servizio il cui nome e GruppoSocietà Risorse corrispondono rispettivamente alle proprietà Name e ResourceGroupName del $serviceTopologyObject servizio.
