...
## DESCRIZIONE
Il cmdlet **Remove-AzDeploymentManagerService** elimina un servizio in una topologia del servizio.
...
Questo comando elimina un servizio denominato ContosoService1 in una topologia di servizio denominata ContosoServiceTopology in ContosoResourceGroup.

### Esempio 2: Eliminare un servizio usando l'identificatore di risorsa.
```powershell
...
Questo comando elimina un servizio il cui nome, il cui nome della topologia di servizio e ResourceGroup corrispondono rispettivamente alle proprietà Name, ServiceTopologyName e ResourceGroupName del $serviceObject.
