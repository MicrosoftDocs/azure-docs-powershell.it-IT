...
## DESCRIZIONE
Il cmdlet **Remove-AzDeploymentManagerArtifactSource** elimina un'origine dell'elemento Specifica l'origine dell'elemento in base al nome e al nome del gruppo di risorse. In alternativa, è possibile specificare l'oggetto ArtifactSource o ResourceId.
