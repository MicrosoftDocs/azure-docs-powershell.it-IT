...
### Esempio 1: Aggiornare il componente Application Insights
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

aggiornare il componente application insights "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery entrambi su "Disabled"
...
Tipo di accesso di rete per l'accesso all'inserimento di Application Insights.
Il valore deve essere "Abilitato" o "Disabilitato"
...
Tipo di accesso di rete per accedere alla query di Application Insights.
Il valore deve essere "Abilitato" o "Disabilitato"
