...
### Esempio 1: impostare il limite del volume dei dati giornalieri per una risorsa di Application Insights
```
...
Impostare il limite giornaliero del volume dei dati su 400 GB al giorno e interrompere l'invio della notifica quando viene raggiunto il limite per la risorsa "test" nel gruppo di risorse "gruppo di test"
