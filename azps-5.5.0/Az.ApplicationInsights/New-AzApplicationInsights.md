...
### Esempio 1: Creare una nuova risorsa application Insights
```
...
Aggiungere una nuova risorsa Application Insights denominata "test" nel gruppo di risorse "testgroup" con il tipo "java"
...
### -Location
Posizione delle risorse di Application Insights.
...
Tipo di accesso di rete per l'accesso all'inserimento di Application Insights. Il valore deve essere "Abilitato" o "Disabilitato"
...
Tipo di accesso di rete per accedere alla query di Application Insights. Il valore deve essere "Abilitato" o "Disabilitato"
...
### -RetentionInDays
Conservazione in giorni, 90 per impostazione predefinita.
