...
### Esempio 1: Rimuovere una risorsa di Application Insights
```
PS C:\> Remove-AzApplicationInsights -ResourceGroupName "testgroup" -Name "test" -PassThru
True
```

Rimuovere una risorsa Application Insights denominata "test" nel gruppo di risorse "gruppo di test"
...
### -PassThru
Se specificato, write true se l'operazione riesce. Questo parametro è facoltativo. Il valore predefinito è false.
