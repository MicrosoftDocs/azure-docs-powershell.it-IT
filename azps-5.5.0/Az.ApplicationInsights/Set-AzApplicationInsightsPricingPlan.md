...
## DESCRIZIONE
Impostare il piano tariffario e le informazioni sul volume giornaliero dei dati per una risorsa di Application Insights.
Il piano dei prezzi delle informazioni dettagliate sull'applicazione creato dopo aprile 2018 non può essere impostato da questo cmdlet: https://docs.microsoft.com/en-us/azure/azure-monitor/app/pricing#legacy-enterprise-per-node-pricing-tier
