...
### Esempio 1: Creare una nuova configurazione di esportazione continua per una risorsa di Application Insights
```
...
### -StorageSASUri
Uri della firma di accesso condiviso per l'archiviazione di destinazione.
