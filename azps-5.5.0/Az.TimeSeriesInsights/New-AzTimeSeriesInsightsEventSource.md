...
### Esempio 1: Creare un'origine evento eventhub nell'ambiente specificato
```powershell
...
Questo comando crea un'origine evento eventhub nell'ambiente specificato.

### Esempio 2: Creare un'origine evento iothub nell'ambiente specificato
```powershell
...
Questo comando crea un'origine evento iothub nell'ambiente specificato.

## PARAMETERS

### -ConsumerGroupName
Nome del gruppo consumer dell'hub evento/iot che contiene le partizioni da cui verranno letti gli eventi.
...
ID risorsa dell'origine evento in Gestione risorse di Azure.
...
### -KeyName
Nome della chiave di firma di accesso condiviso che concede al servizio Time Series Insights l'accesso all'hub evento/iot.
...
### -Kind
Il tipo di origine dell'evento.
...
### -SharedAccessKey
Valore della chiave di accesso condivisa che concede al servizio Time Series Insights l'accesso in lettura all'hub evento/iot.
...
Proprietà evento che verrà usata come timestamp dell'origine evento.
