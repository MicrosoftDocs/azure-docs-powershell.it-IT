...
### Esempio 1: Aggiornare un set di dati di riferimento specificato in base al nome
```powershell
...
### Esempio 2: Aggiornare un set di dati di riferimento specificato in base all'oggetto
```powershell
