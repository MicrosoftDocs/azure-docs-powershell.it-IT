...
### Esempio 1: Aggiornare un criterio di accesso specificato in base al nome
```powershell
...
Questo comando aggiorna i criteri di accesso specificati.

### Esempio 2: Aggiornare un criterio di accesso specificato in base all'oggetto
```powershell
...
### -Role
Elenco dei ruoli assegnati all'entità nell'ambiente.
