...
## SYNOPSIS
Creare l'oggetto PSHeaderAction.
...
## DESCRIZIONE
Crea l'oggetto PSHeaderAction per la creazione dell'oggetto PSRulesActionAction.
...
### -HeaderActionType
Tipo di modifica da applicare all'intestazione.
...
### -HeaderName
Nome dell'intestazione a cui verrà applicata questa azione.
...
### -Value
Valore con cui aggiornare il nome di intestazione specificato.
