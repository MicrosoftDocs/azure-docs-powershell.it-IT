...
## SYNOPSIS
Creare un oggetto PSRulesMatchMatchCondition per creare una regola del motore di regole.
...
Creare un nuovo oggetto PSRulesConditionMatchCondition.
...
### -MatchValue
Trovare corrispondenze per i valori in base a cui trovare una corrispondenza.
L'operatore verrà applicato a ogni valore in questa funzione con semantica OR.
Se uno o più operatori corrispondono alla variabile con l'operatore specificato, questa condizione di corrispondenza viene considerata una corrispondenza.
...
### -MatchVariable
Variabile Match.
I valori possibili sono IsMobile, RemoteAddr, RequestMethod, QueryString, PostArg, RequestUri, RequestPath, RequestFileName, RequestfilenameExtension, RequestHeader, RequestHeader, RequestScheme
...
I valori possibili sono Any, IPMatch, GeoMatch, Equal, Contains, LessWith, GreaterThan, LessThanOrEqual, GreaterThanOrEqual, BeginsWith, EndsWith.
...
### -Selettore
Nome del selettore in RequestHeader o RequestHeader per cui trovare una corrispondenza
...
### -Transform
Elenco delle trasformazioni applicate prima della corrispondenza. I singoli valori di trasformazione possibili sono Minuscole, Tutto Maiuscole, Trim, URLDecode, UrlEncode, RimuoviNull.
...
### Microsoft.Azure.Commands.FrontDoor.Models.PSRulesMatchMatchCondition
