...
## DESCRIZIONE
Il **cmdlet Get-AzFrontDoorGet** ottiene tutte le porte anteriore esistenti nell'abbonamento corrente che corrispondono alle informazioni fornite.

## ESEMPI

### Esempio 1: Ottenere tutti i FrontDoor nell'abbonamento corrente.
```powershell
...
Ottieni tutti gli elementi FrontDoors nell'abbonamento corrente.

### Esempio 2: Ottenere tutti i FrontDoor nel gruppo di risorse "rg1" nella sottoscrizione corrente.
```powershell
...
Ottenere tutti i FrontDoor nel gruppo di risorse "rg1" nella sottoscrizione corrente.

### Esempio 3: Ottenere i FrontDoors nel gruppo di risorse "rg1" con il nome "frontDoor1" nella sottoscrizione corrente.
```powershell
...
Ottenere i FrontDoor nel gruppo di risorse "rg1" con il nome "frontDoor1" nell'abbonamento corrente.
