...
## SYNOPSIS
Creare un oggetto PSLoadBalancingSetting per la creazione di Front Door
...
La latenza aggiuntiva in millisecondi per il ricadimento dei valori nel bucket di latenza più basso. Il valore predefinito è 0
...
### -SampleSize
Il numero di esempi da considerare per le decisioni di bilanciamento del carico.
...
Il numero di campioni che devono avere esito positivo nel periodo campione è 2
