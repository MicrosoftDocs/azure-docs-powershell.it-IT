...
## SYNOPSIS
Account per la creazione di ancoraggi nello spaziale
...
Creare un nuovo account di ancoraggi nello spaziale "example" nella sottoscrizione corrente, nel gruppo di risorse "rg1" e negli Stati Uniti centrali.
...
### -Location
Posizione account per ancoraggi nello spaziale.
