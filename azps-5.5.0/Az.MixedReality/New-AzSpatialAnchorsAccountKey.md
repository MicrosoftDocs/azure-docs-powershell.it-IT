...
## SYNOPSIS
Rigenerare la chiave dell'account degli ancoraggi nello stato spaziale
...
## DESCRIZIONE
Rigenerare la chiave primaria o la chiave secondaria dell'account degli ancoraggi nello stato spaziale.
...
Rigenerare la chiave secondaria dell'account degli ancoraggi nello stato "example" nel gruppo di risorse "rg1". 
...
Rigenerare la chiave secondaria dell'account degli ancoraggi nello spaziale "example" dalla sottoscrizione corrente e dal gruppo di risorse "rg1" con piping.
...
### -Principale
Rigenerare la chiave primaria dell'account degli ancoraggi nello stato spaziale.
