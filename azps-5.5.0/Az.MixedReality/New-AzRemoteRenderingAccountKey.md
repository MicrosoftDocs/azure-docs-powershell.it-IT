...
## SYNOPSIS
Rigenerare la chiave dell'account di rendering remoto
...
## DESCRIZIONE
Rigenerare la chiave primaria o la chiave secondaria dell'account di rendering remoto.
...
Rigenerare la chiave secondaria dell'account di rendering remoto "example" nel gruppo di risorse "rg1". 
...
Rigenerare la chiave secondaria dell'account di rendering remoto "example" dalla sottoscrizione corrente e dal gruppo di risorse "rg1" con piping.
...
### -Principale
Rigenerare la chiave primaria dell'account di rendering remoto.
