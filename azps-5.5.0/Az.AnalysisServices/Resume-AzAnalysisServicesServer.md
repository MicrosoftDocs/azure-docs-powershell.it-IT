...
## DESCRIZIONE
Il cmdlet Resume-AzAnalysisServicesServer riprendere un'istanza del server Analysis Services
...
Questo comando riprenderà un server denominato testserver in pausa nel gruppo di test del gruppo di risorse
