...
## DESCRIZIONE
Il cmdlet Remove-AzAnalysisServicesServer elimina un'istanza del server Analysis Services
...
Questo comando rimuove il server denominato server di test nel gruppo di test del gruppo di risorse
