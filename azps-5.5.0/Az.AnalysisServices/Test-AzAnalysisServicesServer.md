...
## DESCRIZIONE
Il cmdlet Test-AzAnalysisServicesServer verifica l'esistenza di un'istanza del server Analysis Services
...
Questo comando verifica se nel gruppo di test del gruppo di risorse è presente un server denominato testserver
