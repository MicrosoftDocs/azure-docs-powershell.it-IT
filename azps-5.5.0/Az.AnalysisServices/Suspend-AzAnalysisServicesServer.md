...
## DESCRIZIONE
Il cmdlet Suspend-AzAnalysisServicesServer sospende un'istanza del server Analysis Services
...
Questo comando sospende un server attivo denominato server di test nel gruppo di test del gruppo di risorse
