...
### Esempio 1: Elencare tutti i database seguiti
```powershell
...
Il comando precedente elenca tutti i database che appartengono a questo cluster e sono stati seguiti da un altro cluster.
