...
### Esempio 1: Elencare tutte le estensioni delle lingue impostate per un cluster
```powershell
...
Il comando precedente restituisce un elenco di estensioni delle lingue che possono essere eseguite all'interno di query KQL.
