...
### DetachExpanded (impostazione predefinita)
```
...
### Esempio 1: Scollegare un database di follower
```powershell
...
Il comando precedente scollega il database di follower definito in AttachedDatabaseConfiguration "myfollowerconfiguration" dal cluster "testnewkustoclusterf".
...
Nome della risorsa della configurazione di database collegata nel cluster follower.
...
### -ClusterResourceId
ID risorsa del cluster che segue un database di proprietà del cluster.
