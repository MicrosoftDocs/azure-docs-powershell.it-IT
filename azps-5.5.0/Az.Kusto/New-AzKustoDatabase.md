...
### Esempio 1: Creare un nuovo database Kusto in base al nome
```powershell
...
Il comando precedente crea un nuovo database Kusto denominato "mykustodatabase" nel cluster esistente "testnewkustocluster" trovato nel gruppo di risorse "testrg".
