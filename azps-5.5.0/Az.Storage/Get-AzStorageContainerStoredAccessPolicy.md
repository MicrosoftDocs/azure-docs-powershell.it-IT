...
### Esempio 1: Ottenere criteri di accesso archiviati in un contenitore di archiviazione
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07" -Policy "Policy22"
```

Questo comando recupera il criterio di accesso denominato Criterio22 nel contenitore di archiviazione denominato Container07.
