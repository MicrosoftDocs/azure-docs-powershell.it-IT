...
## DESCRIZIONE
Il cmdlet **New-AzStorageShareStoredAccessPolicy** crea un criterio di accesso archiviato in una condivisione di archiviazione di Azure.

## ESEMPI

### Esempio 1: Creare criteri di accesso archiviato in una condivisione
```
PS C:\>New-AzStorageShareStoredAccessPolicy -ShareName "ContosoShare" -Policy "GeneralPolicy" -Permission "rwdl"
```

Questo comando crea un criterio di accesso archiviato con autorizzazioni complete in una condivisione.
...
### -Permission
Specifica le autorizzazioni nei criteri di accesso archiviato per accedere alla condivisione di archiviazione o ai file al di sotto.
...
### -Policy
Specifica un nome per i criteri di accesso archiviato.
