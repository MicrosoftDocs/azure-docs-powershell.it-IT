...
Se il nome BLOB non è valido per il computer locale, questo cmdlet lo risolve automaticamente, se possibile.

## ESEMPI

### Esempio 1: Scaricare il contenuto BLOB in base al nome
```
PS C:\>Get-AzStorageBlobContent -Container "ContainerName" -Blob "Blob" -Destination "C:\test\"
```

Questo comando scarica un BLOB in base al nome.

### Esempio 2: Scaricare il contenuto BLOB con la pipeline
```
...
Questo esempio ottiene prima un oggetto BLOB e quindi lo salva in una variabile, quindi scarica il contenuto BLOB con l'oggetto BLOB. 
...
È possibile crearla o usare il cmdlet Get-AzStorageContainer cmdlet.
...
### -Container
Specifica il nome del contenitore che contiene il BLOB da scaricare.
...
### -Destination
Specifica la posizione in cui archiviare il file scaricato.
...
## NOTE
* Se il nome BLOB non è valido per il computer locale, questo cmdlet lo risolvere in modo automatico, se possibile.
