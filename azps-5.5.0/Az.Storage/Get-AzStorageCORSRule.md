...
## DESCRIZIONE
Il cmdlet **Get-AzStorageCORSRule** ottiene le regole di condivisione delle risorse tra origini (CORS) per un tipo di servizio di archiviazione di Azure.

## ESEMPI

### Esempio 1: Ottenere le regole CORS del servizio BLOB
```
...
### -ServiceType
Specifica il tipo di servizio di archiviazione di Azure per cui questo cmdlet ottiene le regole CORS.
