...
## DESCRIZIONE
Il **cmdlet Get-AzStorageFileHandle** elenca gli handle di file di una condivisione file, una directory file o un file.

## ESEMPI

### Esempio 1: Elencare tutti gli handle di file in una condivisione file in modo ricorsivo e ordinare per ClientIp e OpenTime
```
...
Questo comando elenca gli handle di file in una condivisione file e ordina l'output in base a ClientIp, quindi in base a OpenTime.

### Esempio 2: Elencare i primi 2 handle di file in modo ricorsivo in una directory di file
```
...
Questo comando elenca i primi 2 handle di file in modo ricorsivo in una directory di file.

### Esempio 3: Elencare i quadratini di ridimensionamento dal terzo al 6° file
```
...
Questo comando elenca i punti di controllo dal terzo al 6° file.
...
### -File
L'oggetto CloudFile ha indicato il file per elencare i punti di controllo file.
...
### -IncludeTotalCount
Segnala il numero di oggetti nel set di dati (un numero intero) seguito dagli oggetti. Se il cmdlet non riesce a determinare il conteggio totale, restituisce "Numero totale sconosciuto".
Attualmente, questo parametro non esegue alcuna operazione.
...
### -First
Ottiene solo i primi n oggetti.
