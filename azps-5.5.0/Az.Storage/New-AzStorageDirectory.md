...
Questo comando usa il cmdlet **Get-AzStorageShare** per ottenere la condivisione file denominata ContosoShare06 e quindi la passa al cmdlet corrente usando l'operatore della pipeline.
