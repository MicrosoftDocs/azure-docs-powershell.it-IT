...
Questo comando usa il cmdlet **Get-AzStorageShare** per ottenere la condivisione file denominata ContosoShare06, quindi passa l'oggetto al cmdlet corrente usando l'operatore della pipeline.
...
Questo cmdlet rimuove un file dalla cartella specificata da questo parametro.
...
Questo cmdlet rimuove il file specificato da questo parametro.
...
Questo cmdlet rimuove il file nella condivisione specificata da questo parametro.
