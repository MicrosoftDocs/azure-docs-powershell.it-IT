...
### Esempio 1: Modifica dei metadati e dell'accesso pubblico di un contenitore BLOB di archiviazione con il nome dell'account di archiviazione e il nome del contenitore
```
...
### Esempio 2: Disabilitare l'accesso pubblico in un contenitore BLOB archiviazione con l'oggetto account di archiviazione e il nome del contenitore
```
