...
### Esempio 1: Modifica dei metadati di una condivisione file di archiviazione e quota di condivisione con il nome dell'account di archiviazione e il nome della condivisione
```
...
Questo comando modifica i metadati di una condivisione file di archiviazione e la quota di condivisione con il nome dell'account di archiviazione e il nome della condivisione e mostra il risultato della modifica con l'oggetto di condivisione file restituito.
...
### Esempio 3: Modifica della quota di condivisione per tutte le condivisioni file di archiviazione in un account di archiviazione con pipeline
```
...
### Esempio 4: Modificare una condivisione file di archiviazione con un utente di accesso come Figo
```
...
Questo comando modifica una condivisione file di archiviazione con l'accesso come Cool.
...
### -ResourceId
Immettere un ID di risorsa condivisione file.
