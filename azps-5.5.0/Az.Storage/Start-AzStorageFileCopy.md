...
## DESCRIZIONE
Il cmdlet **Start-AzStorageFileCopy inizia** a copiare un file di origine in un file di destinazione.

## ESEMPI

### Esempio 1: Avviare l'operazione di copia da file a file usando il nome di condivisione e il nome file
```
...
Il comando specifica il nome della condivisione e il nome file

### Esempio 2: Avviare l'operazione di copia da BLOB a file usando il nome del contenitore e il nome del BLOB
```
...
Se il percorso di origine richiede credenziali, è necessario specificarne una.
...
### -DestContext
Specifica il contesto Archiviazione di Azure della destinazione.
Per ottenere un contesto, usare **New-AzStorageContext.**
...
È possibile creare un BLOB cloud o ottenerne uno usando il cmdlet Get-AzStorageBlob cloud.
...
È possibile creare un oggetto contenitore BLOB cloud o usare il cmdlet Get-AzStorageContainer cloud.
...
### -SrcFile
Specifica un **oggetto CloudFile.**
È possibile creare un file cloud o ottenerne uno usando **Get-AzStorageFile.**
...
### -SrcShare
Specifica un oggetto condivisione file nel cloud.
È possibile creare una condivisione file nel cloud o ottenerne una usando il cmdlet Get-AzStorageShare cloud.
