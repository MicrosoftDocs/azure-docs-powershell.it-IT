...
Questo comando imposta DefaultServiceVersion di Servizio BLOB su 2018-03-28.

### Esempio 2: Abilitare il changefeed nel servizio BLOB di un account di archiviazione
```
...
### -EnableChangeFeed
Abilitare la registrazione dei feed di modifica per l'account di archiviazione impostandola su $true, disabilitare la registrazione dei feed di modifica impostandola su $false.
...
### -IsVersioningEnabled
Ottiene o imposta il controllo delle versioni abilitato se impostato su true.
