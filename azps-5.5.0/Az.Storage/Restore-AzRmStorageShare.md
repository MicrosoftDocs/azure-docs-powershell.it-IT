...
## DESCRIZIONE
Il cmdlet **Restore-AzRmStorageShare** ripristina una condivisione file eliminata entro un giorno di conservazione valido se è abilitata l'eliminazione soft della condivisione.

## ESEMPI

### Esempio 1: Rimuovere e ripristinare una condivisione
```powershell
...
Questo comando elimina prima una condivisione file, quindi elenca le condivisioni e visualizza la versione di condivisione eliminata, infine ripristina una condivisione normale. È necessario abilitato l'eliminazione soft della condivisione con Update-AzStorageFileServiceProperty prima di eliminare la condivisione.
...
### -DeletedShareVersion
Versione di condivisione eliminata, da cui verrà ripristinata.
...
### -InputObject
Oggetto Condivisione eliminato
...
### -Name
Nome condivisione eliminato, che verrà ripristinato.
