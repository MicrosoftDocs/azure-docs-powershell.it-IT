...
## DESCRIZIONE
Il cmdlet **Remove-AzDataLakeGen2AclRecursive** rimuove L'ACL in modo ricorsivo nel percorso specificato. Le voci ACL nell'ACL originale, che ha lo stesso AccessControlType, DefaultScope ed EntityId con le voci ACL di input (anche con autorizzazioni diverse) verranno rimosse.
...
Questo comando crea prima di tutto un oggetto ACL con 2 voci di acl, quindi rimuove L'ACL in modo ricorsivo in una directory radice di un file system.
