...
## DESCRIZIONE
Il cmdlet **Set-AzStorageShareStoredAccessPolicy** aggiorna i criteri di accesso archiviato in una condivisione di archiviazione di Azure.
...
Questo comando aggiorna i criteri di accesso archiviati con autorizzazioni complete in una condivisione.
...
### -Permission
Specifica le autorizzazioni nei criteri di accesso archiviati per accedere alla condivisione o ai file al di sotto.
