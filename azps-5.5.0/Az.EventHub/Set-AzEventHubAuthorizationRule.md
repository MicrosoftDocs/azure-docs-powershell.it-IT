...
## DESCRIZIONE
Il Set-AzEventHubAuthorizationRule cmdlet aggiorna la regola di autorizzazione specificata nell'hub eventi specificato.
...
Aggiorna la regola di autorizzazione MyAuthRuleName per concedere i diritti di gestione per MyEventHubName dell'hub eventi, con ambito dallo spazio dei nomi \` \` \` \` \` MyAuthName. \`
