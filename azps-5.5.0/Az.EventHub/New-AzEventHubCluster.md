...
## SYNOPSIS
Crea un nuovo cluster eventhub dedicato
...
## DESCRIZIONE
Il cmdlet New-AzEventHubCluster crea il cluster eventhub dedicato nel gruppo di risorse specificato
...
Crea un cluster dedicato 'Eventhub-Cluster-5557' nel gruppo di risorse 'RSG-Cluster27651' con Location southcentralus e Capacity come 1

## PARAMETERS

### -Capacità
Capacità cluster (CU), curarntrly, valore consentito = 1
...
### -Tag
Hashtables che rappresenta i tag di risorsa per i cluster
