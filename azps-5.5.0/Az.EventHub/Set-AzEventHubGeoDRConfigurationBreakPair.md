...
## DESCRIZIONE
Il cmdlet **Set-AzEventHubGeoDRConfigurationBreakPair** disabilita il ripristino di emergenza e interrompe la replica delle modifiche dallo spazio dei nomi primario a quello secondario
...
### -InputObject
Oggetto di configurazione GeoDR di Eventhub
...
### -Spazio dei nomi
Nome spazio dei nomi - Spazio dei nomi principale
