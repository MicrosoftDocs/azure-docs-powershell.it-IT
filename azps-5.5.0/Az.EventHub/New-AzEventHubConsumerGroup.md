...
Crea il gruppo consumer \` MyConsumerGroupName nell'hub eventi MyEventHubName, con ambito allo spazio dei nomi MyResourceName, con gruppo di \` \` risorse \` \` \` \` MyResourceGroupName. \`
