...
## DESCRIZIONE
Il Get-AzEventHubKey cmdlet restituisce le stringhe di connessione principali e secondarie e i dettagli delle chiavi della regola di autorizzazione NameSpace/Hub eventi/Alias specificata.
...
### Esempio 3: Alias (Configurazione georicovery)
```powershell
