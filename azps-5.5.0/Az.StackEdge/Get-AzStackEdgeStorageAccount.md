...
## DESCRIZIONE
Il cmdlet **Get-AzStackEdgeStorageAccount** ottiene gli account di Archiviazione Edge disponibili in un dispositivo Stack Edge. È possibile specificare il nome come parametro nel cmdlet per ottenere le informazioni di uno specifico account di Archiviazione Edge.
