...
## DESCRIZIONE
Il cmdlet **Get-AzStackEdgeStorageContainer** ottiene il contenitore di archiviazione per un account di Archiviazione Edge in un dispositivo Stack Edge. È possibile specificare il nome come parametro nel cmdlet per recuperare i dettagli di uno specifico contenitore di archiviazione. 
...
Fornire un oggetto EdgeStorageAccount esistente
