...
## DESCRIZIONE
Il cmdlet **Get-AzStackEdgeTriger** ottiene i trigger per un dispositivo. È possibile specificare il nome come parametro nel cmdlet per recuperare i dettagli di uno specifico trigger
