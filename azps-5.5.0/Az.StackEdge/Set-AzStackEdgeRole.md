...
## DESCRIZIONE
Il cmdlet **Set-AzStackEdgeRole** aggiorna un ruolo IoT per un dispositivo Stack Edge. Le vecchie condivisioni montate verranno sostituite con quelle appena fornite nel parametro ShareName.
