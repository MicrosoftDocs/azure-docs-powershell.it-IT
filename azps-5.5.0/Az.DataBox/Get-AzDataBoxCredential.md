...
## SYNOPSIS
Ottiene le credenziali della casella dati di un processo specifico
...
## DESCRIZIONE
Il cmdlet **Get-AzDataBoxCredential** ottiene le credenziali della casella dei dati di un processo specifico. Le proprietà interne dell'oggetto credenziali restituito saranno diverse per tipi di SKU diversi.
...
In questo modo vengono riemersi i JobSecrets del processo specificato
...
### System.Collections.generic.INav'1[[Microsoft.Azure.Management.DataBox.Models.UnencryptedCredentials, Microsoft.Azure.Management.DataBox, Version=1.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35]]
