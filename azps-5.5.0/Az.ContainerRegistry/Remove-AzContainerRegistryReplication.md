...
## DESCRIZIONE
Il cmdlet Remove-AzContainerRegistryReplication rimuove una replica del Registro di sistema del contenitore.

## ESEMPI

### Esempio 1: rimuove una replica del Registro di sistema del contenitore.
```powershell
...
### -PassThru
Indica che questo cmdlet restituisce True se la rimozione è stata completata correttamente.
