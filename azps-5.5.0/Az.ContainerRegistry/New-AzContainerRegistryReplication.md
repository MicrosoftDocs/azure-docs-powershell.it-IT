...
## DESCRIZIONE
Il cmdlet New-AzContainerRegistryReplication crea una nuova replica del Registro di sistema del contenitore.

## ESEMPI

### Esempio 1: Creare una nuova replica del Registro di sistema del contenitore.
```powershell
...
Creare una nuova replica del Registro di sistema del contenitore.
...
### -Location
Posizione del Registro di sistema contenitore.
...
Impostazione predefinita per il nome della posizione.
...
### -Tag
Tag container del Registro di sistema.
