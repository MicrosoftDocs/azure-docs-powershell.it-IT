...
## DESCRIZIONE
Il Test-AzContainerRegistryNameAvailability cmdlet controlla se un nome del Registro di sistema del contenitore è valido e disponibile per l'uso.
...
Questo comando verifica la disponibilità del nome del Registro di sistema \` del contenitore SomeRegistryName. \`
