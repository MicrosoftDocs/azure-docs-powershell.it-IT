...
## DESCRIZIONE
Il cmdlet New-AzContainerRegistry crea un registro di contenitore.

## ESEMPI

### Esempio 1: Creare un Registro di sistema del contenitore con un nuovo account di archiviazione.
```powershell
...
Questo comando crea un registro di contenitore con un nuovo account di archiviazione nel gruppo di risorse \` \` MyResourceGroup.

### Esempio 2: Creare un registro di contenitore con un utente amministratore abilitato.
```powershell
...
Questo comando crea un registro di sistema del contenitore con l'ancoraggio degli utenti da parte dell'amministratore.
...
### -Tag
Container Registry Tags.Key-value pairs in form of a hash table.
