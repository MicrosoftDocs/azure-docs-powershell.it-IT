...
## DESCRIZIONE
Il Update-AzContainerRegistryWebhook cmdlet aggiorna un webhook del Registro di sistema contenitore.

## ESEMPI

### Esempio 1: Aggiornare un webhook del Registro di sistema contenitore esistente.
```powershell
...
Aggiornare un webhook del Registro di sistema contenitore esistente.

## PARAMETERS

### -Action
Elenco di azioni separate da spazi che attivano l'invio di notifiche al WebHook.
...
### -Header
Spaziare le intestazioni personalizzate nel formato 'chiave \[ \] =valore' che verrà aggiunto alle notifiche webhook.
...
### -Tag
Tag separati da spazi nel formato 'chiave \[ \] =valore'.
...
### -Uri
URI del servizio per il Webhook in cui pubblicare le notifiche.
