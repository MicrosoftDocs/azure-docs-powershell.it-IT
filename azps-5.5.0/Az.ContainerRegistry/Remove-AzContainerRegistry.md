...
## DESCRIZIONE
Il cmdlet Remove-AzContainerRegistry rimuove un contenitore del Registro di sistema.

## ESEMPI

### Esempio 1: Rimuovere un contenitore specificato nel Registro di sistema
```powershell
