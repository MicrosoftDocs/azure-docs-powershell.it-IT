...
## SYNOPSIS
Generare una nuova istanza dell'account di Servizi cognitivi ApiProperties
...
L'esempio precedente crea un account QnAMaker, con la proprietà API "QnaRuntimeEndpoint".
