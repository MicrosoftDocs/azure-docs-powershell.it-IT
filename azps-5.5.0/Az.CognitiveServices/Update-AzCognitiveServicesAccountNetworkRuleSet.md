...
## DESCRIZIONE
Il cmdlet **Update-AzCognitiveServicesAccountNetworkRuleSet** aggiorna la proprietà NetworkRule di un account di Servizi cognitivi
...
### Esempio 3: Pulire le regole di NetworkRule di un account di Servizi cognitivi
```
...
Questo comando pulisce le regole di NetworkRule di un account di Servizi cognitivi (altre proprietà non vengono modificate).

## PARAMETERS

### -DefaultAction
Account dei servizi cognitivi NetworkRule DefaultAction. Valore `Deny` predefinito.
