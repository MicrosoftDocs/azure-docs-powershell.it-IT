...
### SyncDatabaseDatabaseDatabase (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **New-AzSqlSyncAgent** crea un agente di sincronizzazione SQL Azure.

## ESEMPI

### Esempio 1: Creare un agente di sincronizzazione per un server SQL Azure.
```
...
Questo comando crea un agente di sincronizzazione per un server SQL Azure.
...
### -SyncDatabaseResourceID
ID risorsa del database dei metadati di sincronizzazione.
