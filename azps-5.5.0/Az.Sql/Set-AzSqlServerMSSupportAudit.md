...
### Esempio 4: Disabilitare i criteri di controllo delle operazioni di supporto per l'hub eventi Microsoft di un server SQL Azure
```powershell
...
### Esempio 6: Disabilitare i criteri di controllo delle operazioni di supporto Microsoft per i log di un server azure SQL
```powershell
