...
## DESCRIZIONE
Il cmdlet **Set-AzSqlServerFirewallRule** modifica una regola del firewall in un server di SQL azure.
...
Questo comando modifica una regola del firewall denominata Rule01 nel server denominato Server01.
Il comando modifica gli indirizzi IP di inizio e di fine.
...
### -FirewallRuleName
Specifica il nome della regola del firewall modificata dal cmdlet.
