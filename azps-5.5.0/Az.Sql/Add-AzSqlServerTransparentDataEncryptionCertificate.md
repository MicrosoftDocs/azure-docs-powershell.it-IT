...
## DESCRIZIONE
LAdd-AzSqlManagedInstanceTransparentDataEncryptionCertificate aggiunge un certificato di crittografia dei dati trasparente per l'istanza SQL Server specificata
...
Aggiungere il certificato TDE a un server SQL usando il nome del gruppo di risorse e il SQL Server risorse
...
Aggiungere il certificato TDE ai server usando resourceId del server
...
Aggiungere il certificato TDE a tutti i server SQL in un gruppo di risorse
...
### -PassThru
In caso di esecuzione corretta, restituisce l'oggetto certificato aggiunto.
...
### -PrivateBlob
BLOB privato per il certificato di crittografia dei dati trasparente
