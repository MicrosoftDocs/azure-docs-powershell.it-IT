...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlServerFirewallRule** elimina una regola del firewall dal server di database SQL Azure specificato.
...
### -FirewallRuleName
Specifica il nome della regola del firewall che il cmdlet elimina.
