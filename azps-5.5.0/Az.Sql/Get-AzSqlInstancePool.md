...
Questo comando recupera informazioni su tutti i pool di istanze all'interno della sottoscrizione del cliente.
...
Questo comando ottiene informazioni sull'istanza pool di istanze Pool0.
