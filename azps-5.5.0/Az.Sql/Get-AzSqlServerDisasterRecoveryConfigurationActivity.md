...
## DESCRIZIONE
Il cmdlet **Get-AzSqlServerDisasterRecoveryConfigurationActivity** ottiene l'attività per una configurazione di ripristino del sistema del server SQL database.
