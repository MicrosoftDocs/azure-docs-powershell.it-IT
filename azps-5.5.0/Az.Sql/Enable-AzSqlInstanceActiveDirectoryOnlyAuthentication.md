...
## DESCRIZIONE
Il cmdlet **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** abilita il requisito di autenticazione di Azure Active Directory (Azure AD) solo per un'istanza gestita di AzureSQL nella sottoscrizione corrente.
...
Questo comando abilita il requisito di autenticazione di Azure Active Directory (Azure AD) solo per un'istanza gestita di AzureSQL denominata ManagedInstance01 associata a un gruppo di risorse denominato ResourceGroup01.
...
### -InstanceName
Nome dell'istanza gestita di Azure SQL cui si trova solo l'autenticazione di Azure Active Directory.
...
### Microsoft.Azure.Commands.Sql.InstanceActiveDirectoryOnlyAuthentication.Model.AzureSqlActiveDirectoryOnlyAuthenticationModel
