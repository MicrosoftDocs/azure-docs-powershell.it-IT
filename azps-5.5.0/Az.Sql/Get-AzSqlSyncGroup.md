...
### Esempio 3: Ottenere tutte le istanze del gruppo di SQL azure assegnato a un database SQL Azure usando il filtro
```
...
Questo comando recupera informazioni su tutti i gruppi di SQL di database di Azure assegnati a un database SQL azure che iniziano con "SyncGroup".
