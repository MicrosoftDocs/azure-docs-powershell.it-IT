...
## SYNOPSIS
Rimuove uno o più database da un gruppo di failover del SQL database di Azure.
...
## DESCRIZIONE
Rimuove uno o più database dal gruppo di failover del database SQL Azure specificato. I database e le relazioni di replica non vengono modificati, ma non saranno più accessibili tramite gli endpoint del gruppo di failover.
...
Questo comando rimuove un database da un gruppo di failover tramite piping.
...
Questo comando rimuove tutti i database in un pool flessibile da un gruppo di failover.

## PARAMETERS

### -Database
Uno o più database SQL Azure nel server principale del gruppo di failover da rimuovere dal gruppo di failover.
