...
## DESCRIZIONE
Il cmdlet **New-AzSqlInstancePool** crea un pool di SQL Azure.
...
Questo comando crea un nuovo pool di SQL Azure.
...
### -ComputeGeneration
Generazione di elaborazione per il pool di istanze.
...
### -Edition
Edizione per il pool di istanze.
...
### -Location
Posizione in cui creare il pool di istanze.
...
### -SubnetId
ID subnet da usare per la creazione del pool di istanze.
