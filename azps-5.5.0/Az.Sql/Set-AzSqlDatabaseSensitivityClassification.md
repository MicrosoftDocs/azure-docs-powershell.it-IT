...
## DESCRIZIONE
Il Set-AzSqlDatabaseSensitivityClassification cmdlet imposta i tipi di informazioni e le etichette di riservatezza delle colonne nel database.

## ESEMPI

### Esempio 1: impostare il tipo di informazioni e l'etichetta di riservatezza di una colonna in un database SQL Azure.
```powershell
...
### Esempio 2: Impostare i tipi di informazioni consigliati e le etichette di riservatezza delle colonne in un database SQL Azure.
```powershell
...
### Esempio 3: Impostare il tipo di informazioni e l'etichetta di riservatezza di una colonna in un database di SQL Azure, usando le funzionalità di piping.
```powershell
...
Oggetto che rappresenta una classificazione di riservatezza SQL di riservatezza del database.
