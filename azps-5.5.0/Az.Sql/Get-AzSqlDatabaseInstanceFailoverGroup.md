...
## DESCRIZIONE
Recupera un gruppo di failover dell'istanza specifico o elenca i gruppi di failover delle istanze in un'area nella sottoscrizione dell'utente.

Per eseguire il comando, è possibile usare entrambe le aree del gruppo di failover delle istanze. I valori restituiti rifletteranno lo stato delle istanze gestite in tale area rispetto al gruppo di failover delle istanze.
...
Elenca tutti i gruppi di failover nell'area
...
Ottenere un gruppo di failover dell'istanza specifico.
