...
### Esempio 1: Ripristinare un database di istanze da un momento all'altro
```
...
### Esempio 2: Ripristinare un database di istanze da un momento a un'altra istanza in un gruppo di risorse diverso
```
...
### -GeoBackupObject
Oggetto di database di istanza ripristinabile da ripristinare
