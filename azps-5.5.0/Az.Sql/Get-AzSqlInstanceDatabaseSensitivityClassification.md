...
### DatabaseObjectParameterSet (impostazione predefinita)
```
...
## DESCRIZIONE
Il Get-AzSqlInstanceDatabaseSensitivityClassification cmdlet restituisce i tipi di informazioni correnti e le etichette di riservatezza delle colonne nel database SQL istanza gestita di Azure.

## ESEMPI

### Esempio 1: Ottenere i tipi di informazioni correnti e le etichette di riservatezza di un database di SQL gestito di Azure.
```powershell
...
### Esempio 2: Ottenere i tipi di informazioni correnti e le etichette di riservatezza di un database di SQL gestito di Azure con Piping.
```powershell
...
### Esempio 3: Ottenere il tipo di informazioni corrente e l'etichetta di riservatezza di una colonna specifica di un database SQL istanza gestita di Azure.
```powershell
...
### Esempio 4: Ottenere il tipo di informazioni corrente e l'etichetta di riservatezza di una colonna specifica di un database SQL istanza gestita di Azure con Piping.
```powershell
