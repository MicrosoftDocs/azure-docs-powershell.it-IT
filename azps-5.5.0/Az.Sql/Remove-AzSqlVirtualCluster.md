...
### RemoveVirtualClusterFromInputParameters (Impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlVirtualCluster** rimuove un cluster virtuale SQL Azure.
...
Questo comando rimuove il cluster virtuale denominato VirtualCluster1 assegnato al gruppo di risorse ResourceGroup01.
...
### -InputObject
L'oggetto istanza da rimuovere
...
### -ResourceId
ID risorsa dell'oggetto istanza da rimuovere
