...
## DESCRIZIONE
Questo comando elimina una regola di Rete SQL Server virtuale di Azure.
...
Elimina una regola di rete virtuale SQL Server azure esistente
...
Nome della regola per la rete virtuale di Sql Server di Azure
