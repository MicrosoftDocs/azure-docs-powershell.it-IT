...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlDatabase** rimuove un database SQL Azure.
Questo cmdlet è supportato anche dal servizio SQL Server di estensione del database in Azure.

## ESEMPI

### Esempio 1: Rimuovere un database da un server SQL Azure
```
PS C:\>Remove-AzSqlDatabase -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
```

Questo comando rimuove il database denominato Database01 dal server Server01.

## PARAMETERS

### -DatabaseName
Specifica il nome del database rimosso dal cmdlet.
