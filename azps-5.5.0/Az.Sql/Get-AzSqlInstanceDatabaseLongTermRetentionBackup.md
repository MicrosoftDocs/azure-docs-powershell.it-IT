...
Recupera tutti i backup di conservazione a lungo termine per un database specifico.  Il gruppo di risorse è facoltativo. 
...
### -DatabaseName
Il nome del database gestito in cui sono presenti i backup.
...
### -InstanceName
Il nome dell'istanza gestita in cui si stanno copiando i backup.
