...
## DESCRIZIONE
Il **cmdlet Get-AzSqlSyncGroupLog** restituisce i log di un gruppo di SQL database di Azure.

## ESEMPI

### Esempio 1: Ottenere i log di un gruppo di sincronizzazione SQL Azure
```
...
Questo comando recupera i log di un gruppo di sincronizzazione SQL Azure.
...
### -EndTime
Ora di fine dei log per la query.
...
### -LogLevel
Tipo di log in cui eseguire la query.
...
### -StartTime
Ora di inizio dei log per la query.
