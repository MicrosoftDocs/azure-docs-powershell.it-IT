...
## DESCRIZIONE
Il cmdlet **Enable-AzSqlServerActiveDirectoryOnlyAuthentication** abilita il requisito di autenticazione di Azure Active Directory (Azure AD) solo per un server AzureSQL nella sottoscrizione corrente.
...
Questo comando abilita il requisito di autenticazione di Azure Active Directory (Azure AD) solo per un server AzureSQL denominato Server01 associato a un gruppo di risorse denominato ResourceGroup01.
