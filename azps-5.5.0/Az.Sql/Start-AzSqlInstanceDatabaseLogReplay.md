...
Questo comando crea un nuovo database gestito e avvia il ripristino dei backup dal contenitore specificato finché last_backup il file bak non viene ripristinato.
...
Questo comando crea un nuovo database gestito e avvia il ripristino dei backup dal contenitore specificato finché Complete-AzSqlInstanceDatabaseLogReplay chiamata per l'ultimo backup.
...
### -AutoCompleteRestore
Indicatore che indica se eseguire o meno il ripristino automatico al completamento.
...
### -Collation
Fascicolazione del database delle istanze da usare.
...
### -InputObject
Oggetto di database dell'istanza.
