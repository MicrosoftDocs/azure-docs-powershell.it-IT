...
### Esempio 3: Abilitare i criteri di controllo dell'archiviazione BLOB di un database di SQL azure con i filtri usando un predicato di SQL BLOB
```powershell
...
### Esempio 4: Rimuovere il filtro dai criteri di controllo di un database di SQL Azure
```powershell
...
### Esempio 9: Disabilitare, tramite pipeline, i criteri di controllo di analisi del log di un database SQL Azure
```powershell
