...
## DESCRIZIONE
Questo comando rimuove il gruppo di failover dell'istanza con il nome specificato, lasciando inalterati tutti i database. L'endpoint del listener verrà ne verrà annullata la registrazione dal DNS.
...
### -PassThru
Specifica se passare l'output di esecuzione del cmdlet.
