...
## DESCRIZIONE
Il cmdlet **Get-AzSqlInstance** restituisce informazioni su una o più istanze gestite SQL Azure.
Specificare il nome di un'istanza per visualizzare le informazioni solo per tale istanza.
...
Questo comando recupera informazioni su tutte le istanze assegnate al gruppo di risorse ResourceGroup01.
...
Questo comando recupera informazioni sull'istanza denominata managedInstance1.

### Esempio 3: Ottenere tutte le istanze assegnate a un gruppo di risorse usando il filtro
```powershell
...
Questo comando recupera informazioni su tutte le istanze assegnate al gruppo di risorse ResourceGroup01 che iniziano con "managedInstance".

### Esempio 4: Ottenere tutte le istanze in un pool di istanze
```powershell
...
Questo comando ottiene informazioni su tutte le istanze all'interno del pool di istanze "instancePool0".

### Esempio 5: Ottenere tutte le istanze in un pool di istanze usando l'oggetto pool di istanze
```powershell
...
### Esempio 6: Ottenere tutte le istanze in un pool di istanze usando l'identificatore di risorsa del pool di istanze
```powershell
...
### Esempio 7: Ottenere un'istanza gestita usando l'identificatore di risorsa
```powershell
...
L'identificatore di risorsa del pool di istanze.
...
### -ResourceId
Identificatore di risorsa dell'istanza gestita.
