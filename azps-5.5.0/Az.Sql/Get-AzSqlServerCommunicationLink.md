...
## SYNOPSIS
Recupera i collegamenti di comunicazione per le transazioni di database di tipo elastico tra server di database.
...
Questo comando recupera il collegamento di comunicazione da server a server denominato Link01.
