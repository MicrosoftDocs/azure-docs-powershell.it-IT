...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlDatabaseDataMaskingRule** rimuove una specifica regola di maschera dati da un database SQL Azure.
È possibile rimuovere una regola di maschera dati usando i parametri *ResourceGroupName,* *ServerName,* *DatabaseName* e *RuleId* per identificare la regola rimossa dal cmdlet.
Questo cmdlet è supportato anche dal servizio SQL Server di estensione del database in Azure.

## ESEMPI

### Esempio 1: Rimuovere una regola di maschera dati di database
```
...
Questo comando rimuove il nome della regola Rule01 definita per il database Database01.
Il database si trova su Server01 e viene assegnato al gruppo di risorse ResourceGroup01.
