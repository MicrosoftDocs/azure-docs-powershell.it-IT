...
## DESCRIZIONE
Il Set-AzSqlServerTransparentDataEncryptionProtector cmdlet imposta la protezione TDE per un SQL server.
Se si modifica il tipo di protezione TDE, la protezione verrà ruotata.
...
Questo comando aggiorna il tipo di protezione TDE di un server a Service Managed.
...
Questo comando aggiorna un server in modo da usare la chiave del Vault della chiave del server con ID https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' ' come protettore TDE.
ResourceGroupName ServerName Type ServerKeyVaultKeyName
----------------- ----------                   ---- ---------------------
...
### -Type
Tipo di protezione TDE del database SQL di Azure.
