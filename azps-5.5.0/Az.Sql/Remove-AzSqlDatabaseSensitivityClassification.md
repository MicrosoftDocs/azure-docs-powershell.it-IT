...
## DESCRIZIONE
Il Remove-AzSqlDatabaseSensitivityClassification rimuovere i tipi di informazioni e le etichette di riservatezza delle colonne nel database.

## ESEMPI

### Esempio 1: Rimuovere il tipo di informazioni e l'etichetta di riservatezza di una colonna in un database SQL Azure.
```powershell
...
### Esempio 2: Rimuovere i tipi di informazioni correnti e le etichette di riservatezza delle colonne in un database SQL Azure tramite Piping.
```powershell
...
### Esempio 3: Rimuovere il tipo di informazioni e l'etichetta di riservatezza di una colonna in un database SQL Azure con Piping.
```powershell
