...
## DESCRIZIONE
Il cmdlet **Get-AzSqlServerActiveDirectoryAdministrator** ottiene informazioni su un amministratore di Azure Active Directory (Azure AD) per un server AzureSQL nella sottoscrizione corrente.
...
Questo comando ottiene informazioni su un amministratore di Azure AD per un server denominato Server01 associato a un gruppo di risorse denominato ResourceGroup01.
...
### -ServerName
Specifica il nome della SQL Server per cui il cmdlet riceve informazioni.
