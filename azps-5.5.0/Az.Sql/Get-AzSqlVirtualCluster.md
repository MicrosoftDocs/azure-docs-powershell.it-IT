...
## SYNOPSIS
Restituisce informazioni su Azure SQL virtual cluster.
...
## DESCRIZIONE
Il cmdlet **Get-AzSqlVirtualCluster** restituisce informazioni su uno o più cluster virtuali SQL Azure.
Specificare il nome di un cluster virtuale per visualizzare informazioni solo per tale cluster.

## ESEMPI

### Esempio 1: Assegnare tutti i cluster virtuali a un gruppo di risorse
```powershell
...
Questo comando recupera informazioni su tutti i cluster virtuali assegnati al gruppo di risorse ResourceGroup01.
...
Questo comando ottiene informazioni sul cluster virtuale VirtualCluster1 nel gruppo di risorse ResourceGroup01.
