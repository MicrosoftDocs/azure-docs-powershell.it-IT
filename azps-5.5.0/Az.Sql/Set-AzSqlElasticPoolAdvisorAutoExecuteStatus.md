...
## SYNOPSIS
Aggiorna lo stato di esecuzione automatica di un consulente SQL di Azure.
...
## NOTE
* Parole chiave: azure, azurerm, arm, risorsa, gestione, manager, sql, pool flessibile, mssql, advisor
