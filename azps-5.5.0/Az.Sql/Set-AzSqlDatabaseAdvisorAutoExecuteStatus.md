...
## DESCRIZIONE
Il cmdlet **Set-AzSqlDatabaseAdvisorAutoExecuteStatus** modifica la proprietà di esecuzione automatica per un componente aggiuntivo Azure SQL Database Advisor.
Attualmente, questo cmdlet supporta i valori Abilitata, Disabilitata e Predefinita.
...
Questo comando modifica lo stato di esecuzione automatica di un consulente denominato CreateIndex in Abilitato.

## PARAMETERS

### -AdvisorName
Specifica il nome dell'consulente per cui questo cmdlet modifica lo stato.
...
### -DatabaseName
Specifica il nome del database per cui il cmdlet modifica lo stato.
