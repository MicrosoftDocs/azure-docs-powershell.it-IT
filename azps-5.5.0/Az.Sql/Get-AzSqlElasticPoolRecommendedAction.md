...
## SYNOPSIS
Recupera una o più azioni consigliate per un consulente del SQL di Azure.
...
## DESCRIZIONE
Il cmdlet **Get-AzSqlElasticPoolRecommendedAction** ottiene una o più azioni consigliate per un consulente del pool SQL elastico di Azure.
...
Questo comando ottiene un elenco di tutte le azioni consigliate dell'consulente denominato CreateIndex disponibile per il pool elastico denominato WIRunnerPool.
...
Questo comando recupera l'azione consigliata IR_ \[ test_schema \] _ \[ test_table_0.036155 _6C7AE8CC9C87E7FD5893 1 dall'consulente denominato \] CreateIndex.

## PARAMETERS

### -AdvisorName
Specifica il nome dell'consulente per cui questo cmdlet richiede le azioni consigliate.
...
### -ElasticPoolName
Specifica il nome del pool flessibile per cui questo cmdlet richiede le azioni consigliate.
