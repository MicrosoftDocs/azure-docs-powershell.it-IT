...
## DESCRIZIONE
Il cmdlet **Start-AzSqlSyncGroupSync avvia** la sincronizzazione di un gruppo di sincronizzazione.
...
Questo comando avvia un round di sincronizzazione per il gruppo di sincronizzazione mysg.
