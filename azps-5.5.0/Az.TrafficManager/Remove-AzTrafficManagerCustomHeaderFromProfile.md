...
## DESCRIZIONE
Il cmdlet **Remove-AzTrafficManagerCustomHeaderFromProfile** rimuove le informazioni di intestazione personalizzate da un oggetto profilo di Gestione traffico Di Azure locale.
...
### Esempio 1: Rimuovere informazioni di intestazione personalizzate da un profilo
```
