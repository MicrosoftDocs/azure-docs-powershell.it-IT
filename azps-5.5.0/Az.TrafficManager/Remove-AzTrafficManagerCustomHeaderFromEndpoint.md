...
## DESCRIZIONE
Il cmdlet **Remove-AzTrafficManagerCustomHeaderFromEndpoint** rimuove le informazioni di intestazione personalizzate da un oggetto endpoint di Gestione traffico Di Azure locale.
...
### Esempio 1: Rimuovere le informazioni sulla subnet personalizzata da un endpoint
```
