...
L'endpoint di Azure punta all'app Web di Azure per cui l'ID di Gestione risorse di Azure viene fornito dal percorso URI in *TargetResourceId.*
...
### -Name
Specifica il nome dell'endpoint di Gestione traffico creato da questo cmdlet.
