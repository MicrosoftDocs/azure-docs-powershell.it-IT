...
## SYNOPSIS
Crea peering vNet per l'area di lavoro.
...
Questo comando crea un peering vnet per databrick.
...
### -AllowGatewayTransit
Se i collegamenti del gateway possono essere usati nella rete virtuale remota per collegarsi a questa rete virtuale.
...
### -UseRemoteGateway
Se è possibile usare gateway remoti in questa rete virtuale.
Se il flag è impostato su true e allowGatewayTransit anche nel peering remoto è true, la rete virtuale userà gateway di rete virtuale remota per il transito.
