...
## SYNOPSIS
Elimina l'area di lavoro vNetApplicationing.
...
### Esempio 1: Rimuovere un peering vnet dei databrick in base al nome
```powershell
PS C:\> Remove-AzDatabricksVNetPeering -WorkspaceName databricks-test01 -ResourceGroupName lucas-manual-test -Name vnetpeering-t01

```

Questo comando rimuove un peering vnet dei databrick in base al nome

### Esempio 2: Rimuovere un peering vnet dei dati in base all'oggetto
```powershell
PS C:\> Get-AzDatabricksVNetPeering -ResourceGroupName lucas-manual-test -WorkspaceName databricks-test01 -PeeringName MyPeering-test01 | Remove-AzDatabricksVNetPeering

```

Questo comando rimuove un peering vnet dei dati in base all'oggetto
