...
## SYNOPSIS
Recupera i firmatari dei criteri attendibili da un tenant in Azure Attestation.
...
## DESCRIZIONE
Il Get-AzAttestationPolicySigners cmdlet recupera i firmatari dei criteri attendibili da un tenant in Azure Attestation.
...
Ottiene i firmatari dei criteri attendibili per il *test pshtest* del provider di attestazione nel gruppo di risorse *psh-test-rg.*  Si noti che non sono presenti firmatari attendibili per questo provider di attestazione.
...
Ottiene i firmatari dei criteri attendibili per il provider di attestazione *pshtest2* nel gruppo di risorse *psh-test-rg.*  Si noti che esiste un unico firmatario attendibile per questo provider di attestazione.
...
Ottiene i firmatari dei criteri attendibili per il provider predefinito di attestazione nella posizione *Stati Uniti centrale.*  Si noti che non sono presenti firmatari attendibili per il provider predefinito di attestazione.
...
### -Name
Specifica il nome di un provider di attestazioni.
...
### -ResourceId
Specifica l'ID Risorsa di un provider di attestazioni.
