...
## DESCRIZIONE
Il Remove-AzAttestation cmdlet elimina la attestazione specificata.
...
Eliminare il provider di attestazione *denominato pshtest3* nel gruppo di risorse *denominato psh-test-rg* dalla sottoscrizione corrente.
...
### -InputObject
Oggetto attestazione da eliminare.
...
### -Name
Specifica il nome della attestazione da rimuovere.
