...
## DESCRIZIONE
Il cmdlet **Stop-AzServiceBusMigration** termina la migrazione tra lo spazio dei nomi Standard e Premium
...
Il cmdlet termina la migrazione tra lo spazio dei nomi Standard e lo spazio dei nomi Premium disponibile durante la creazione della configurazione di migrazione.
...
### -InputObject
Oggetto spazio dei nomi standard di configurazione del bus di servizio
...
### -ResourceId
ID risorsa spazio dei nomi standard di configurazione bus di servizio
