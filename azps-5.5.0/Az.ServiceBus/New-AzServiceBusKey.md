...
## DESCRIZIONE
Il cmdlet **New-AzServiceBusKey** genera nuove stringhe di connessione primaria o secondaria per lo spazio dei nomi o la coda o l'argomento specificato e la regola di autorizzazione.
...
Rigenera le stringhe di connessione primaria o secondaria con il valore chiave fornito per lo spazio dei nomi.
...
Rigenera le stringhe di connessione primaria o secondaria per la coda.
...
Rigenera le stringhe di connessione primaria o secondaria con il valore chiave fornito per la coda.
...
Rigenera le stringhe di connessione primaria o secondaria con il valore chiave fornito per l'argomento.
