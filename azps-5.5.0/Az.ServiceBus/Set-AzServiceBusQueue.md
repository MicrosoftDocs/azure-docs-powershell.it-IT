...
## DESCRIZIONE
Il cmdlet **Set-AzServiceBusQueue** aggiorna la descrizione della coda di bus di servizio nello spazio dei nomi del bus di servizio specificato.
