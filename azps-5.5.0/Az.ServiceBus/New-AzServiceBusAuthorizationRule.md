...
## DESCRIZIONE
Il cmdlet **New-AzServiceBusAuthorizationRule** crea una nuova regola di autorizzazione per lo spazio dei nomi o la coda o l'argomento del bus di servizio specificato.
...
Crea `AuthoRule1` con i **diritti** di ascolto **e invio** per lo spazio dei `SB-Example1` nomi.
...
Crea `AuthoRule1` con **diritti** di ascolto **e** invio per la `SBQueue` coda.
