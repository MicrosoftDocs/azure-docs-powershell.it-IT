...
## DESCRIZIONE
Il cmdlet **Get-AzServiceBusKey** restituisce le stringhe di connessione primaria e secondaria per lo spazio dei nomi o la coda o l'argomento o alias specificato (configurazioni geoDR).
...
Stringa di connessione principale e secondaria allo spazio dei nomi specificato.
...
Stringa di connessione principale e secondaria alla coda specificata.
...
Stringa di connessione principale e secondaria all'argomento specificato.
...
Stringa di connessione principale e secondaria allo spazio dei nomi e all'alias specificati.
