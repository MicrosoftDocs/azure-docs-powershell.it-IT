...
## DESCRIZIONE
Il cmdlet **Set-AzServiceBusSubscription** aggiorna la descrizione della sottoscrizione per l'argomento Bus di servizio nello spazio dei nomi del bus di servizio specificato.
...
Aggiorna la descrizione della sottoscrizione specificata all'argomento specificato. Questo esempio aggiorna **la proprietà DeadLetteringOnMessageExpiration** a **true** e **MaxDeliveryCount a** 9.
...
### -InputObject
Definizione di sottoscrizione ServiceBus.
