...
## DESCRIZIONE
Il **cmdlet Get-AzServiceBusRule** ottiene la descrizione della regola specificata nella sottoscrizione specificata dell'argomento.
...
Restituisce un elenco di descrizioni delle regole per una sottoscrizione specificata.  Per impostazione predefinita, viene restituita una regola 100, se si desidera restituire più di 100 regole, usare il parametro -MaxCount.
