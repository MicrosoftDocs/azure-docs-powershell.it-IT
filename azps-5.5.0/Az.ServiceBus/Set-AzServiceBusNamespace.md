...
## DESCRIZIONE
Il cmdlet **Set-AzServiceBus Firmware** aggiorna la descrizione dello spazio dei nomi del bus di servizio specificato all'interno del gruppo di risorse.
...
Aggiorna lo spazio dei nomi dei bus di servizio con una nuova descrizione.
...
### -Confirm
Aggiorna lo spazio dei nomi dei bus di servizio con le informazioni specificate.
