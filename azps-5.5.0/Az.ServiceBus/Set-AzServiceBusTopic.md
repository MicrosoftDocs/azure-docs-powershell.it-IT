...
## DESCRIZIONE
Il cmdlet **Set-AzServiceBusTopic** aggiorna un oggetto descrizione per un argomento Bus di servizio nello spazio dei nomi dei bus di servizio specificato.
...
Aggiorna l'argomento specificato con una nuova descrizione nello spazio dei nomi specificato. Questo esempio aggiorna la **proprietà EnableExpress** a **true.** 
...
### -InputObject
Definizione di argomento ServiceBus.
