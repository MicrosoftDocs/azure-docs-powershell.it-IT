...
## DESCRIZIONE
Il cmdlet **Remove-AzServiceBusQueue** rimuove la coda dallo spazio dei nomi del bus di servizio specificato.
...
Rimuove la coda del bus di `SB-Queue_exampl1` servizio dallo spazio dei `SB-Example1` nomi.

### Esempio 2: InputObject - Variabile Using:
```powershell
PS C:\> $inputobject = Get-AzServiceBusQueue <params>
PS C:\> Remove-AzServiceBusQueue -InputObject $inputobject
```

Rimuove la coda di bus di servizio specificata nel parametro $inputobject for -InputObject
...
### Esempio 4: ResourceId - Variabile Using:
```powershell
PS c:\> $resourceid = Get-AzServiceBusQueue <params>
PS C:\> Remove-AzServiceBusQueue -ResourceId $resourceid.Id
```

Rimuove la coda di bus di servizio specificata nell'ID ARM servizio in $resourceid/stringa per il parametro -ResourceId

### Esempio 5: ResourceId - passaggio come stringa:
```powershell
...
### -ResourceId
ID risorsa coda di bus di servizio
