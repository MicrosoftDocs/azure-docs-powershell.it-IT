...
## DESCRIZIONE
Il **cmdlet Test-AzServiceBusName controlla** la disponibilità del nome o alias NameSpace (nome configurazione DR)
...
Restituisce lo stato in base alla disponibilità del nome dello spazio dei nomi 'NomeSapceName' come True
