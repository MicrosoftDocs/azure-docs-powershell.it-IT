...
### Reimage (impostazione predefinita)
```
...
### Esempio 1: Istanza del ruolo Reimage di un servizio cloud
```powershell
...
Questo comando ricrea l'istanza del ruolo ContosoFrontEnd_IN_0 nome di un servizio cloud denominato ContosoCS che appartiene al gruppo di risorse denominato ContosOrg.
