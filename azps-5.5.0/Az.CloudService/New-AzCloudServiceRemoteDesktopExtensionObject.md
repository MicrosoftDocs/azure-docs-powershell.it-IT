...
### Esempio 1: Creare un oggetto estensione desktop remoto
```powershell
...
Questo comando crea un oggetto estensione desktop remoto usato per creare o aggiornare un servizio cloud.
...
### -Credential
Credenziali per l'estensione di Desktop remoto.
...
### -Expiration
Scadenza per l'estensione desktop remoto.
...
### -Name
Nome dell'estensione di Desktop remoto.
...
### -TypeHandlerVersion
Versione dell'estensione desktop remoto.
