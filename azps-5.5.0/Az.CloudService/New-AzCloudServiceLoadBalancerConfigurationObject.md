...
### Esempio 1: Creare un oggetto di configurazione di bilanciamento del carico
```powershell
...
Questo comando crea un oggetto di configurazione di bilanciamento del carico usato per creare o aggiornare un servizio cloud.
...
FrontendIPConfiguration.
Per creare, vedere la sezione NOTES per le proprietà FRONTENDIPCONFIGURATION e creare una tabella hash.
...
### -Name
Nome di LoadBalancerConfiguration.
