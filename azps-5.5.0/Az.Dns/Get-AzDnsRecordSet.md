...
Questo comando recupera una matrice di tutti i set di record nell'area denominata myzone.com nel gruppo di risorse denominato MyResourceGroup e quindi li archivia nella variabile $RecordSets locale.
