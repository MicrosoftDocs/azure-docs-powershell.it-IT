...
Questo fornisce protezione per le modifiche simultanee.
Per eliminare questo comportamento, è possibile usare il parametro *Overwrite,* che comporta l'aggiornamento del set di record indipendentemente dalle modifiche simultanee.
