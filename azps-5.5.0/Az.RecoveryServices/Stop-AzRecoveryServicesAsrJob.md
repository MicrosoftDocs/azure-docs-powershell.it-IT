...
## DESCRIZIONE
Il cmdlet **Stop-AzRecoveryServicesAsrJob** interrompe il processo di Ripristino siti di Azure specificato.
...
Prova ad arrestare il processo specificato e restituisce un oggetto processo ASR aggiornato.
...
### -InputObject
Oggetto di input: specificare l'oggetto processo ASR corrispondente al processo asr da arrestato
...
### -Name
Specificare il processo ASR che deve essere interrotto dal nome del processo ASR.
