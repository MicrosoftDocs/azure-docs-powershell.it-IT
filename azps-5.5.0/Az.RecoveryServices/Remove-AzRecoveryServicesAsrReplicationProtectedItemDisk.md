...
Avvia l'operazione per rimuovere il disco specificato e restituisce il processo asr usato per tenere traccia dell'operazione di rimozione del disco protetto.
...
### -DiskId
Specifica l'elenco degli ID disco gestiti.
