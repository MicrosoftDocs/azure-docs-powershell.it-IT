...
## DESCRIZIONE
Il cmdlet **New-AzRecoveryServicesAsrStorageClassificationMapping** crea una classificazione di archiviazione che mappa il vault dei servizi di recupero.
...
Avvia l'operazione di creazione del mapping della classificazione di archiviazione con i parametri specificati e restituisce il processo ASR usato per tenere traccia dell'operazione.
...
### -Name
Specifica un nome per il mapping della classificazione di archiviazione ASR.
...
Specifica l'oggetto principale della classificazione di archiviazione ASR per il mapping.
...
Specifica l'oggetto della classificazione di archiviazione ASR di ripristino per il mapping.
