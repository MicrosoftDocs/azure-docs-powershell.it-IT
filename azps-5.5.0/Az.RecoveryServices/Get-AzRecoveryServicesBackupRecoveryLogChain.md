...
L'ultimo comando ottiene una matrice di intervalli di tempo dei punti di ripristino per l'elemento in $BackupItem e quindi li archivia nella variabile $RP di recupero.

### Esempio 2

Questo comando elenca i punti di inizio e di fine della catena di log ininterrotta dell'elemento di backup specificato. (autogenerated)
