...
## DESCRIZIONE
Il cmdlet **Update-AzRecoveryServicesAsrvCenter** aggiorna i dettagli di individuazione per un vCenter registrato.
...
### -Account
account delle credenziali di accesso al vCenter.
...
### -InputObject
Oggetto server vCenter di cui aggiornare i dettagli di individuazione.
...
### -Porta
La porta TCP nel server vCenter da usare per l'individuazione.
