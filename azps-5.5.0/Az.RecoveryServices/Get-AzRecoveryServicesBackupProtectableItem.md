...
Il secondo comando recupera l'elemento protetto da backup in $Container, quindi lo archivia nella $Item variabile.
...
### -ParentID
È stato specificato ARM ID utente di un'istanza o di un gruppo di disponibilità.
