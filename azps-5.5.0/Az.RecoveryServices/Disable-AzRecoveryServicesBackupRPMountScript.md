...
## DESCRIZIONE
Il cmdlet Disable-AzRecoveryServicesBackupRPMountScript rimuove i file del punto di ripristino che sono stati montati in precedenza con il cmdlet Get-AzRecoveryServicesBackupRPMountScript.
...
Importo di tutti i file del punto di ripristino. (autogenerated)
