...
Crea una configurazione NIC ASR contenente i dettagli della configurazione correlata al failover e al failover del test. (autogenerated)
...
Specifica se la rete accelerata è abilitata al failover di test NIC.
...
Specifica l'ID del gruppo di rete NSG associato alla NIC di failover del test.
