...
## DESCRIZIONE
**Get-AzRecoveryServicesAsrEvent** ottiene l'elenco degli eventi nel Vault in base ai filtri di selezione specificati.
...
Ottenere l'evento in base al nome.
...
Elenco dell'evento per l'oggetto interessato.
...
Elenco dell'evento tra ora di inizio e ora di fine, gravità critica e tipo di integrità VmHealth.
...
### -EndTime
Specifica l'ora di fine della finestra di ricerca. Usare questo parametro per ottenere solo gli eventi che si sono verificati prima dell'ora specificata.
...
### -Tessuto
Filtra gli eventi in base al tessuto specificato.
...
### -FabricId
Specifica l'ID tessuto da filtrare.
...
### -Gravità
Gravità dell'evento da filtrare.
...
### -StartTime
Specifica l'ora di inizio della finestra di ricerca. Usare questo parametro per ottenere solo gli eventi che si sono verificati dopo l'ora specificata.
