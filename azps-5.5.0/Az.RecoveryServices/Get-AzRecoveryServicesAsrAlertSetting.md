...
## DESCRIZIONE
Il cmdlet **Get-AzRecoveryServicesAsrAlertSetting** ottiene le impostazioni di notifica di Azure Site Recovery configurate per il vault.
...
Impostazione di avviso/notifica per Azure Site Recovery.
