...
## DESCRIZIONE
Il cmdlet **Get-AzRecoveryServicesAsrStorageClassificationMapping** ottiene i dettagli di un mapping di classificazione di archiviazione ASR.
...
Elencare tutti i mapping della classificazione di archiviazione corrispondenti alla classificazione di archiviazione specificata.
...
### -Name
Specifica il nome del mapping della classificazione di archiviazione da ottenere.
...
Specifica un oggetto classificazione di archiviazione ASR. Il cmdlet ottiene i mapping della classificazione di archiviazione ASR corrispondenti alla classificazione di archiviazione specificata 
