...
## SYNOPSIS
Ottenere i metadati non correlati alla sicurezza di un servizio di dispositivi Windows IoT.
...
### Esempio 1: Ottenere tutti i servizi Windows IoT in un abbonamento
```powershell
...
Questo comando recupera tutti i servizi Windows IoT in un abbonamento.

### Esempio 2: Ottenere tutti i servizi IoT di Windows in un gruppo di risorse
```powershell
...
Questo comando recupera tutti i servizi Windows IoT in un gruppo di risorse.

### Esempio 3: Ottenere un servizio Windows IoT in base al nome
```powershell
...
Questo comando ottiene un servizio Windows IoT in base al nome.

### Esempio 4: Ottenere un servizio IoT di Windows in base all'oggetto
```powershell
...
Questo comando ottiene un servizio Windows IoT in base all'oggetto.

### Esempio 4: Ottenere un servizio IoT di Windows tramite pipeline
```powershell
...
Questo comando ottiene un servizio IoT di Windows tramite pipeline.
