...
Il suo lungo elenco di posizioni. Ottiene tutte le strutture di peering diretto.
...
Ottiene la posizione di peering di Exchange per l'ID della struttura di peering 71. 
...
### -PeeringDbFacilityId
ID PeeringDB.com della struttura
...
### Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PSLocationingLocation
