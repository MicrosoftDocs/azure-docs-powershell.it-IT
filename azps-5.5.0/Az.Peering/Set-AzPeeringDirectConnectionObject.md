...
### Larghezza di banda (impostazione predefinita)
```
...
### ParameterSetNameUseForUseingService
```
...
## DESCRIZIONE
Usata in combinazione con Update-Az Queste operazioni sono in memoria e vengono mantenute solo con `Update-AzPeering` . 

## ESEMPI

### Larghezza di banda per l'aggiornamento
```powershell
...
Aggiorna la larghezza di banda per la prima connessione nell'oggetto peering in memoria. 
...
### Aggiornamento dell'uso del servizio di peering
```powershell
...
Aggiorna la connessione per l'uso con il servizio di peering
