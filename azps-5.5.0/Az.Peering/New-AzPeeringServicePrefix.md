...
## DESCRIZIONE
Crea il prefisso del servizio di peering associato a un oggetto servizio di peering.
...
Crea un prefisso da un oggetto servizio di peering
...
Crea un prefisso da un ID di risorsa del servizio di peering.
...
Crea un prefisso dal nome e dal nome di un gruppo di risorse del servizio di peering
...
### -PeeringServiceName
Nome del servizio di peering.
Usare New-AzPeeringService cmdlet per un nuovo servizio di peering o un Get-AzPeeringService per un elenco.
...
### -ServiceKey
Si tratta di un GUID univoco fornito dal provider di servizi
...
### Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PSPreingServicePrefix
