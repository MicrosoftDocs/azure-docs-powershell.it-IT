...
## DESCRIZIONE
Creare asN registrati per gli oggetti di peering.

## ESEMPI

### Ottenere il peering e creare un ASN registrato
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredAsn -Name $asnName -Asn $asn
```

Ottenere il peering a cui si vuole aggiungere un asN registrato. Passare quindi questo al commandlet.

### Usare l'ID risorsa peering per creare una rete asn registrata
```powershell
