...
### Esempio 1: Rimuovere il database MySql in base al nome
```powershell
PS C:\> Remove-AzMySqlFlexibleServerDatabase -Name databasetest -ResourceGroupName PowershellMySqlTest -ServerName mysql-test
```

Questo cmdlet rimuove il database MySql in base al nome.

### Esempio 2: Rimuovere il database MySql in base all'identità
```powershell
...
Questi cmdlet rimuovono il database MySql in base all'identità.
