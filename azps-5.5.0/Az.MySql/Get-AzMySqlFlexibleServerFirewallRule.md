...
### Esempio 3: Elenca tutte le regole del firewall nel server MySql specificato
```powershell
...
Questo cmdlet elenca tutte le regole del firewall nel server MySql specificato.
