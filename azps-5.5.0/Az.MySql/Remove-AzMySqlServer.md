...
### Esempio 1: Rimuovere il server MySql in base a resourceGroup e al nome del server
```powershell
PS C:\> Remove-AzMySqlServer -ResourceGroupName PowershellMySqlTest -Name mysql-test

```

Questo cmdlet rimuove il server MySql in base a ResourceGroup e al nome del server.

### Esempio 2: Rimuovere il server MySql in base all'identità
```powershell
...
Questi cmdlet rimuovono il server MySql in base all'identità.
