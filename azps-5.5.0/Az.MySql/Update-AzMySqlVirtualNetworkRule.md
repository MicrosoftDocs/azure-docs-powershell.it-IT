...
### Esempio 1: Aggiornare la regola di rete virtuale MySql in base al nome
```powershell
...
Questo cmdlet aggiorna la regola della rete virtuale MySql in base al nome.

### Esempio 2: Aggiornare la regola della rete virtuale MySql in base all'identità.
```powershell
...
Questi cmdlet aggiornano la regola della rete virtuale MySql in base all'identità.
...
### -SubnetId
ID ARM della risorsa della rete virtuale.
