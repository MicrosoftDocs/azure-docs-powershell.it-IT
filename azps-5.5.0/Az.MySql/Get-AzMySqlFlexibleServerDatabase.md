...
### Esempio 1: Ottenere un database MySql in base al nome della risorsa
```powershell
...
Questo cmdlet ottiene il server MySql in base al nome della risorsa.

### Esempio 2: Ottenere database MySql in base all'identità
```powershell
...
Questo cmdlet ottiene un server MySql in base all'identità.
...
Questo cmdlet elenca tutti i server MySql nel server specificato.
