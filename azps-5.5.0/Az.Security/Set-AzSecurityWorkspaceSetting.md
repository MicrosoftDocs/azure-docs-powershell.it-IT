...
## DESCRIZIONE
Aggiorna le impostazioni dell'area di lavoro per l'abbonamento.
L'area di lavoro configurata contenerà i dati di sicurezza raccolti dall'agente di Analisi log di Azure installati nelle macchine virtuali all'interno della sottoscrizione.
...
Imposta l'area di lavoro "securityuserws" in modo da contenere tutti i dati di sicurezza raccolti dall'agente di Analisi log di Azure.
