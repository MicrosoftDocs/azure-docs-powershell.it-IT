...
## DESCRIZIONE
Il cmdlet New-AzDeviceSecurityGroupThresholdCustomAlertRuleObject crea un nuovo elenco di regole di avviso personalizzate per le soglie per il gruppo di sicurezza dei dispositivi nella soluzione di sicurezza IoT.
...
Creare una nuova regola di avviso personalizzata per la soglia dal tipo "SomeRuleType" con stato abilitato per la soglia minima e massima
