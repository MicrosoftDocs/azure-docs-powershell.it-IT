...
## DESCRIZIONE
Il cmdlet Set-AzDeviceSecurityGroup crea o aggiorna un gruppo di sicurezza dei dispositivi definito nella soluzione di sicurezza iot.
...
Aggiornare il gruppo di sicurezza del dispositivo esistente dall'hub IoT "/subscriptions/XXXXXXXX-XXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub" con il tipo di regola "ActiveConnectionsNotInAllowedRange"

## PARAMETERS

### -AllowlistRule
Regole degli elenchi di indirizzi consentiti.
...
### -DenylistRule
Regole per l'elenco di indirizzi non attendibili.
...
### -TimeWindowRule
Regole relative all'intervallo di tempo.
