...
## DESCRIZIONE
Il `Disable-AzSecurityAdvancedThreatProtection` cmdlet disabilita i criteri di protezione dalle minacce per un account di archiviazione/database.
...
Questo comando disabilita i criteri di Protezione avanzata dalle minacce per l'ID `"/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.Storage/storageAccounts/myStorageAccount/"` risorsa.

### Esempio 2 : Account Database Bancario
```powershell
...
Questo comando disabilita i criteri di Protezione avanzata dalle minacce per l'ID ` "/subscriptions/xxxxxxx-xxxx-xxxx-xxxxxxxxxxxxx/resourceGroups/myResourceGroup/providers/Microsoft.DocumentDb/databaseAccounts/myCosmosDBAccount/"` risorsa.
