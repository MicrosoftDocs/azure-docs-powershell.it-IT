...
### SQL di protezione delle informazioni personali (impostazione predefinita)
```
Set-AzSqlInformationProtectionPolicy -Policy <String> [-AsJob] [-DefaultProfile <IAzureContextContainer>]
 [-WhatIf] [-Confirm] [<CommonParameters>]
```

### SQL del file dei criteri di protezione delle informazioni
```
...
### -FilePath
Specifica il percorso di un file JSON contenente SQL definizione dei criteri di protezione delle informazioni.
...
### -Policy
Specifica una definizione SQL dei criteri di protezione delle informazioni personali. È possibile specificare il percorso di un file JSON o di una stringa in formato JSON che definisce il criterio.
