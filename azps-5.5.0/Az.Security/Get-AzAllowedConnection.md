...
## SYNOPSIS
Usato per visualizzare il traffico consentito tra le risorse per la sottoscrizione
...
## DESCRIZIONE
Ottiene l'elenco di tutto il traffico possibile tra le risorse per la sottoscrizione e la posizione, in base al tipo di connessione.
