...
ms.locfileid: "100197942"
---
# <span data-ttu-id="dc844-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="dc844-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="dc844-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="dc844-102">SYNOPSIS</span></span>
<span data-ttu-id="dc844-103">Recupera gli avvisi di sicurezza rilevati dal Centro sicurezza di Azure</span><span class="sxs-lookup"><span data-stu-id="dc844-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="dc844-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="dc844-104">SYNTAX</span></span>

### <span data-ttu-id="dc844-105">SubscriptionScope (impostazione predefinita)</span><span class="sxs-lookup"><span data-stu-id="dc844-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="dc844-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="dc844-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="dc844-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="dc844-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="dc844-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="dc844-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="dc844-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="dc844-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="dc844-110">DESCRIZIONE</span><span class="sxs-lookup"><span data-stu-id="dc844-110">DESCRIPTION</span></span>
<span data-ttu-id="dc844-111">Recupera gli avvisi di sicurezza rilevati dal Centro sicurezza di Azure</span><span class="sxs-lookup"><span data-stu-id="dc844-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="dc844-112">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="dc844-112">EXAMPLES</span></span>

### <span data-ttu-id="dc844-113">Esempio 1</span><span class="sxs-lookup"><span data-stu-id="dc844-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="dc844-114">Recupera tutti gli avvisi di sicurezza rilevati nelle risorse all'interno di una sottoscrizione</span><span class="sxs-lookup"><span data-stu-id="dc844-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="dc844-115">Esempio 2</span><span class="sxs-lookup"><span data-stu-id="dc844-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="dc844-116">Ottiene tutti gli avvisi di sicurezza rilevati nelle risorse all'interno del gruppo di risorse "myService1"</span><span class="sxs-lookup"><span data-stu-id="dc844-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="dc844-117">Esempio 3</span><span class="sxs-lookup"><span data-stu-id="dc844-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="dc844-118">Riceve uno specifico avviso di sicurezza rilevato nelle risorse all'interno del gruppo di risorse "myService1"</span><span class="sxs-lookup"><span data-stu-id="dc844-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="dc844-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="dc844-119">PARAMETERS</span></span>

### <span data-ttu-id="dc844-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="dc844-120">-DefaultProfile</span></span>
<span data-ttu-id="dc844-121">Le credenziali, l'account, il tenant e la sottoscrizione usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="dc844-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="dc844-122">-Location</span><span class="sxs-lookup"><span data-stu-id="dc844-122">-Location</span></span>
<span data-ttu-id="dc844-123">Posizione.</span><span class="sxs-lookup"><span data-stu-id="dc844-123">Location.</span></span>
...
### <span data-ttu-id="dc844-124">-Name</span><span class="sxs-lookup"><span data-stu-id="dc844-124">-Name</span></span>
<span data-ttu-id="dc844-125">Nome della risorsa.</span><span class="sxs-lookup"><span data-stu-id="dc844-125">Resource name.</span></span>
...
### <span data-ttu-id="dc844-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="dc844-126">-ResourceGroupName</span></span>
<span data-ttu-id="dc844-127">Nome del gruppo di risorse.</span><span class="sxs-lookup"><span data-stu-id="dc844-127">Resource group name.</span></span>
...
### <span data-ttu-id="dc844-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="dc844-128">-ResourceId</span></span>
<span data-ttu-id="dc844-129">ID risorsa.</span><span class="sxs-lookup"><span data-stu-id="dc844-129">Resource ID.</span></span>
...
### <span data-ttu-id="dc844-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="dc844-130">CommonParameters</span></span>
<span data-ttu-id="dc844-131">Questo cmdlet supporta i parametri comuni: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutAction, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="dc844-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="dc844-132">Per altre informazioni, [vedere](http://go.microsoft.com/fwlink/?LinkID=113216)about_CommonParameters.</span><span class="sxs-lookup"><span data-stu-id="dc844-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="dc844-133">INPUT</span><span class="sxs-lookup"><span data-stu-id="dc844-133">INPUTS</span></span>

### <span data-ttu-id="dc844-134">System.String</span><span class="sxs-lookup"><span data-stu-id="dc844-134">System.String</span></span>

## <span data-ttu-id="dc844-135">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="dc844-135">OUTPUTS</span></span>

### <span data-ttu-id="dc844-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="dc844-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="dc844-137">NOTE</span><span class="sxs-lookup"><span data-stu-id="dc844-137">NOTES</span></span>

## <span data-ttu-id="dc844-138">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="dc844-138">RELATED LINKS</span></span>
