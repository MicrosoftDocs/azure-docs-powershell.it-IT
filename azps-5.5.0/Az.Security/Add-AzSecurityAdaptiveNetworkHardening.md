...
## SYNOPSIS
Applica le regole fornite ai server dei criteri di rete elencati nella richiesta
...
## DESCRIZIONE
Le hardening adattive di rete vengono calcolate automaticamente da Centro sicurezza di Azure. Usare questo cmdlet per applicare le regole fornite nei gruppi NSG elencati nella richiesta.
...
Il nome della risorsa Protezione avanzata rete adattiva.
...
ID delle risorse di Azure dei gruppi di sicurezza di rete effettivi che verranno aggiornati con le regole di sicurezza create dalle regole di protezione avanzata di rete adattiva.
...
### -PassThru
Restituisce un valore che indica un'operazione riuscita o non riuscita
