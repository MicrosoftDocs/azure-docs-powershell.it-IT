...
## SYNOPSIS
Ottiene un gruppo di server/vm di controllo dell'applicazione.
...
## DESCRIZIONE
I controlli adattivi delle applicazioni vengono calcolati automaticamente dal Centro sicurezza e usano questo cmdlet per ottenere un gruppo di server/vm di controllo dell'applicazione.
...
### -AscLocation
Posizione in cui asc archivia i dati della sottoscrizione. possono essere recuperate da Ottieni posizioni.
...
### -GroupName
Nome di un gruppo di server/vm di controllo dell'applicazione.
