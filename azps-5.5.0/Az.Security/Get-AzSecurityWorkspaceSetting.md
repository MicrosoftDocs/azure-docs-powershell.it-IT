...
## DESCRIZIONE
Questo cmdlet consente di individuare l'area di lavoro configurata che contenerà i dati di sicurezza raccolti dall'agente di sicurezza installato nelle macchine virtuali all'interno dell'abbonamento.
