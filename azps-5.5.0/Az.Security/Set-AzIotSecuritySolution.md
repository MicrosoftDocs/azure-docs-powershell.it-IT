...
## DESCRIZIONE
Il cmdlet Set-AzIotSecuritySolution crea o aggiorna una specifica soluzione di sicurezza iot. La soluzione di sicurezza IoT raccoglie dati di sicurezza ed eventi dai dispositivi iot e dall'hub iot per prevenire e rilevare le minacce.
Il nome della soluzione di sicurezza iot deve essere identico al nome dell'hub iot.
...
Creare una nuova soluzione di sicurezza iot "MySample" per l'hub IoT con ID risorsa "/subscriptions/XXXXXXXX-XXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MichalResourceGroup/providers/Microsoft.Devices/IotHubs/MySample" (il nome della soluzione deve essere identico al nome dell'hub IoT)
...
Stato registrazione IP non mascherata.
