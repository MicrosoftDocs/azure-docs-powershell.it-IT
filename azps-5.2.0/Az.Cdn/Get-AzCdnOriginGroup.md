...
## Descrizione
Il cmdlet Get-AzCdnOriginGroup recupera un gruppo di origini CDN.
...
Questo comando otterrà il gruppo di origine nell'endpoint specificato.
...
### -ResourceId
ID risorsa per il gruppo origine
