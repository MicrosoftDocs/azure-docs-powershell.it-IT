...
## Sinossi
API per registrare un nuovo cluster di K8s e quindi creare una risorsa rilevata in ARM
...
### Esempio 1: creare un kubernetes connesso
```powershell
...
Questo comando crea un kubernetes connesso.

### Esempio 1: creare un kubernetes connesso con i parametri kubeConfig e kubeContext
```powershell
...
Questo comando crea un kubernetes connesso con i parametri kubeConfig e kubeContext.
...
### -ResourceGroupName
Nome del gruppo di risorse a cui è registrato il cluster kubernetes.
...
### -SubscriptionId
ID dell'abbonamento a cui è registrato il cluster kubernetes.
