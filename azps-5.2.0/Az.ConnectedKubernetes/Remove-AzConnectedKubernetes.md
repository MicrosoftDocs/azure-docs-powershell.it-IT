...
### Esempio 1: rimuovere un kubernetes connesso
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Questo comando rimuove un kubernetes connesso

### Esempio 2: rimuovere un kubernetes connesso per oggetto
```powershell
...
Questo comando rimuove un oggetto kubernetes connesso
