...
## Descrizione
Il comando **Get-AzDataFactoryV2TriggerRun** restituisce informazioni dettagliate sulle esecuzioni dei trigger per il trigger specificato nell'intervallo di tempo specificato.

## ESEMPI

### Esempio 1: ottenere informazioni sull'esecuzione del trigger
```
...
Questo comando Mostra le informazioni sulle esecuzioni per "WikiTrigger" nella Factory "WikiADF" iniziata tra "2017-09-01" e "2019-09-30".
...
Il tempo trascorso o dopo il quale l'esecuzione del trigger viene avviata in formato ISO8601.
...
L'ora in cui viene eseguito il trigger o prima del quale viene avviata l'esecuzione in formato ISO8601.
