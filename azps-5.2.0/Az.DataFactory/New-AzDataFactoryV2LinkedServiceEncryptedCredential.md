...
* L'opzione di **accesso remoto** è abilitata nel runtime di integrazione ospitata autonomamente.
* PowerShell 7,0 o versioni successive viene usato per eseguire il cmdlet.
