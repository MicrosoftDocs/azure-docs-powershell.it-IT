...
### Esempio 1: aggiornare il servizio cloud primaverile in base al nome.
```powershell
...
Aggiornare il servizio cloud primaverile in base al nome.

### Esempio 2: aggiornare il servizio cloud primaverile da pipe.
```powershell
...
Aggiornare il servizio cloud primaverile da pipe.
