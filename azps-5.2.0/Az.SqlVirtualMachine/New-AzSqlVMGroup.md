...
## Descrizione
Il cmdlet New-AzSqlVMGroup crea un gruppo di macchine virtuali di Azure SQL.
...
Crea un nuovo gruppo di macchine virtuali di Azure SQL con il gruppo di test VM nel gruppo di risorse ResourceGroup01.
...
Nome usato per la creazione di un cluster
...
Percorso facoltativo per il witness di condivisione file
...
### -Posizione
Posizione del gruppo della macchina virtuale SQL.
...
### -Offerta
Offerta di un gruppo di macchine virtuali SQL.
...
### -OuPath
Percorso unità organizzativa in cui saranno presenti i nodi e il cluster
...
### -SKU
Tipo di gruppo SQL Virtual Machine Edition.
...
### -SqlServiceAccount
Nome in cui verrà eseguito il servizio SQL in tutte le macchine virtuali SQL partecipanti nel cluster
...
Chiave primaria dell'account di archiviazione dei testimoni
...
### -Tag
Tag da associare al gruppo SQL Virtual Machine.
