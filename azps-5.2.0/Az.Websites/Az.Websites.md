...
### [Modifica-AzWebAppBackupConfiguration](Edit-AzWebAppBackupConfiguration.md)


### [Invio-AzWebAppContainerPSSession](Enter-AzWebAppContainerPSSession.md)
...
Ottiene la configurazione di restiction di Access per una Azure Web App.
...
Ottenere una regola di routing per il nome di slot assegnato.
...
New-AzWebAppContainerPSSession creerà una nuova sessione remota di PowerShell nel contenitore di Windows specificato in un determinato sito o uno slot e un determinato gruppo di risorse
...
### [Riavviare-AzWebAppSlot](Restart-AzWebAppSlot.md)


### [Ripristinare-AzDeletedWebApp](Restore-AzDeletedWebApp.md)
Ripristina un'app Web eliminata in un'app Web nuova o esistente.

### [Ripristinare-AzWebAppBackup](Restore-AzWebAppBackup.md)


### [Ripristinare-AzWebAppSnapshot](Restore-AzWebAppSnapshot.md)
...
Aggiorna l'ereditarietà della configurazione di Access restiction del sito principale in un sito SCM per una Web App Azure.
