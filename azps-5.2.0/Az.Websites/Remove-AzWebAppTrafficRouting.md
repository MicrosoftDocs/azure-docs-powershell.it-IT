...
## Descrizione
Il cmdlet **Remove-AzWebAppTrafficRouting** rimuove una regola di routing da uno slot di Azure Web App.

## ESEMPI

### L'esempio 1 rimuove la regola di routing specifica dallo slot Web App
```powershell
PS C:\> Remove-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite"  -RuleName 'Stg'
```

Questo comando rimuove una regola di routing per un certo slot Web App.
