...
Nel caso in cui ci siano 2 App eliminate con lo stesso nome (ContosoApp), allora otteniamo i dettagli di entrambi i siti e ripristiniamo l'app denominata ContosoRestore con l'app di nostra scelta chiamando Restore con ID.
...
Nel caso in cui ci siano 2 App eliminate con lo stesso nome (ContosoApp), allora otteniamo i dettagli di entrambi i siti e ripristiniamo l'app denominata ContosoRestore con l'app di nostra scelta chiamando il ripristino con i dettagli di InputObject (Deletedsite) 
...
### -DeletedId
ID dell'app Web Azure eliminata.
