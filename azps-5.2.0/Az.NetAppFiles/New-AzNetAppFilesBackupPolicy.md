...
## Descrizione
Il cmdlet **New-AzNetAppFilesActiveDirectory** crea un nuovo criterio di backup per un account di ANF.
...
Questo comando crea il nuovo criterio di backup di ANF per l'account ANF denominato account "account".
...
### -AccountObject
Oggetto account per i nuovi criteri di backup
