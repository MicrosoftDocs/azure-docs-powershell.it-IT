...
## Descrizione
Il cmdlet **Remove-AzNetAppFilesBackupPolicy** Elimina i criteri di backup di ANF.
...
### -AccountObject
Oggetto account che contiene i criteri di backup da rimuovere
...
### -PassThru
Restituire se il criterio di backup specificato è stato rimosso correttamente
