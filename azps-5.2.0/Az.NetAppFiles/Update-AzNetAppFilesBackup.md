...
## Descrizione
Il cmdlet **Update-AzNetAppFilesBackup** modifica un backup di ANF.
...
Questo comando esegue un aggiornamento sul backup specificato modificando il nome utente in quello fornito.
