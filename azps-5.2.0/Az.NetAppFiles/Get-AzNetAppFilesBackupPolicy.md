...
## Descrizione
Il cmdlet **Get-AzNetAppFilesBackupPolicy** ottiene i dettagli di un criterio di backup di ANF.
...
### -AccountObject
Oggetto account che contiene i criteri di backup da restituire
