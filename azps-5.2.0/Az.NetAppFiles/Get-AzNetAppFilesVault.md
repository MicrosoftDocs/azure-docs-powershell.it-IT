...
## Descrizione
Il cmdlet **Get-AzNetAppFilesVault** Ottiene l'elenco degli archivi di backup degli account di ANF.
...
Questo comando ottiene un elenco dei Vault di backup per Azure NetappFiles (ANF) account "MyAnfAccount".
