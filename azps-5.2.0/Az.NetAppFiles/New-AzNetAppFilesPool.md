...
## Descrizione
Il cmdlet **New-AzNetAppFilesPool** crea un pool di ANF.

## ESEMPI

### Esempio 1: creare un pool di ANF
```
...
Questo comando crea il nuovo pool di ANF "MyAnfPool" nell'account "MyAnfAccount".
