...
## Sinossi
Ottiene l'HSM dedicato di Azure specifico.
...
### Esempio 1: ottenere tutti i HSM dedicati in un abbonamento
```powershell
...
Questo comando ottiene tutti i HSM dedicati in un abbonamento

### Esempio 2: ottenere tutti i HSM dedicati in un gruppo di risorse.
```powershell
...
Questo comando ottiene tutti i HSM dedicati in un gruppo di risorse.

### Esempio 3: ottenere un HSM dedicato per nome
```powershell
...
Questo comando ottiene un HSM dedicato per nome.

### Esempio 4: ottenere un HSM dedicato per oggetto
```powershell
...
Questo comando ottiene un HSM dedicato per oggetto.
...
### -ResourceGroupName
Il nome del gruppo di risorse a cui appartiene l'HSM dedicato.
