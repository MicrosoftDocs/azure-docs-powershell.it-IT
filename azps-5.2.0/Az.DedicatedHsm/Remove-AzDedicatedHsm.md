...
## Sinossi
Elimina l'HSM dedicato di Azure specifico.
...
### Esempio 1: rimuovere un HSM dedicato per nome
```powershell
PS C:\> Remove-AzDedicatedHsm -Name hsm-7t2xaf -ResourceGroupName lucas-manual-test

```

Questo commnad rimuove un modulo HSM (hardware Security Module) per nome.

### Esempio 2: rimuovere un HSM dedicato per oggetto
```powershell
...
Questo commnad rimuove un HSM dedicato per oggetto.
...
### -Nome
Nome dell'HSM dedicato da eliminare
