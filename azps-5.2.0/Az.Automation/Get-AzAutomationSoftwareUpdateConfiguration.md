...
## Descrizione
La Get-AzAutomationSoftwareUpdateConfiguration restituisce un elenco di configurazioni di aggiornamento software. Per ottenere una configurazione di aggiornamento software specifica, specificare il parametro Name. È anche possibile elencare le configurazioni di aggiornamento software destinate a specifiche macchine virtuali di Azure specificando l'ID delle risorse di Azure per questa macchina virtuale.

## ESEMPI

### Esempio 1
Ottenere una configurazione di aggiornamento software di automazione Azure per nome.
