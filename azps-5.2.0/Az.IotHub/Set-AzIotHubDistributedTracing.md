...
### -SamplingMode
Attiva il campionamento per abilitare e disabilitare la traccia distribuita.
...
### -SamplingRate
Controlla la quantità di messaggi campionati per l'aggiunta di un contesto di traccia.
Questo valore è una percentuale.
Sono consentiti solo i valori compresi tra 0 e 100 (inclusi).
