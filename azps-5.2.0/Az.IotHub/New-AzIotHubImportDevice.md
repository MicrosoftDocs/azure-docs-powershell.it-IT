...
## Descrizione
Crea un nuovo processo di importazione di dispositivi per IotHub.
In questo modo verranno importati tutti i dispositivi in IotHub dal contenitore specificato. Vedere l'articolo seguente su come generare l'URI SAS.
...
Crea una nuova richiesta di importazione di dispositivi per il IotHub "myiothub".
...
URI contenitore BLOB di input per FileUpload
