...
## Descrizione
Aggiorna o sostituisce un dispositivo Twin. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-device-twinsPer altre informazioni, vedere.
...
Restituisce l'oggetto Twin del dispositivo aggiornato.
...
Restituisce l'oggetto Twin del dispositivo con le proprietà desiderate aggiornate.
...
Restituisce il dispositivo Twin Object con la proprietà Tags aggiornata.
...
Restituisce l'oggetto Twin del dispositivo sostituito.
...
### -Desiderato
Aggiungere o aggiornare la proprietà desiderata in un dispositivo Twin.
...
### -Parziale
Consente di aggiornare solo parzialmente i tag e le proprietà desiderate di un dispositivo Twin.
...
### -Tag
Aggiungere o aggiornare la proprietà Tags in un dispositivo Twin.
