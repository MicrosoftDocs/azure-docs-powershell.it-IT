...
### Esempio 1: UpdateExpanded (impostazione predefinita)
```powershell
...
Aggiornare l'oggetto DigitalTwinsInstance specificato da ResourceGroupName

### Esempio 2: aggiornare la AzDigitalTwinsInstance da un altro AzDigitalTwinsInstance
```powershell
...
Aggiornare il AzDigitalTwinsInstance da un altro AzDigitalTwinsInstance
...
Per costruire, vedere la sezione Note per le proprietà di DIGITALTWINSPATCHDESCRIPTION e creare una tabella hash.
...
DIGITALTWINSPATCHDESCRIPTION <IDigitalTwinsPatchDescription> : la descrizione del servizio DigitalTwins.
  - `[Tag <IDigitalTwinsPatchDescriptionTags>]`: Tag di istanza
