...
### Esempio 1: eliminare il azDigitalTwinsEndPoint per EndPointname
```powershell
...
Eliminare il azDigitalTwinsEndPoint per EndPointname ResourceGroupName e resourceName

### Esempio 2: eliminare il azDigitalTwinsEndPoint per oggetto
```powershell
...
Eliminare il azDigitalTwinsEndPoint per oggetto
