...
### Esempio 1: rimuovere un AzDigitalTwinsInstance per nome
```powershell
...
Questo comando rimuove un AzDigitalTwinsInstance per nome

### Esempio 2: rimuovere un AzDigitalTwinsInstance da InputObject
```powershell
