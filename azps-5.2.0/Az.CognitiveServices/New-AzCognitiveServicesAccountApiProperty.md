...
## Sinossi
Generare una nuova istanza di account dei servizi cognitivi ApiProperties
...
## Descrizione
Genera una nuova istanza di ApiProperties account dei servizi cognitivi.
ApiProperties può essere usato quando si crea un nuovo account o si aggiorna un account esistente.
ApiProperties è richiesto da determinati tipi di account.
...
Sopra l'esempio verrà creato un account QnAMaker con la proprietà API "QnaRuntimeEndpoint".
