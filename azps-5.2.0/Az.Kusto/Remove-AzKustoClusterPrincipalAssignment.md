...
### Esempio 1: eliminare un cluster di Kusto esistente PrincipalAssignment per nome
```powershell
...
Il comando precedente elimina il PrincipalAssignment denominato "kustoprincipal1" nel cluster kusto "testnewkustocluster".
