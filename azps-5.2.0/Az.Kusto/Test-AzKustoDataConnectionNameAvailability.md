...
### Esempio 1: verificare la disponibilità di un nome di connessione dati in uso
```powershell
...
Il comando sopra riportato restituisce se esiste o meno una connessione dati denominata "mykustodataconnection" nel database "mykustodatabase".

### Esempio 2: verificare la disponibilità di un nome di connessione dati non in uso
```powershell
...
Il comando sopra riportato restituisce se esiste o meno una connessione dati denominata "mydataconnection" nel database "mykustodatabase".
...
### -Digitare
Il tipo di risorsa, Microsoft. kusto/Clusters/database/dataconnectings.
