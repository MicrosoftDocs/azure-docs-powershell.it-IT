...
### Esempio 1: eliminare un AttachedDatabaseConfiguration esistente per nome
```powershell
...
Il comando precedente elimina il database di follower definito nel AttachedDatabaseConfiguration "myfollowerconfiguration" dal cluster "testnewkustoclusterf".
