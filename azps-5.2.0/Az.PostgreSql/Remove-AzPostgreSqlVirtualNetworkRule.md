...
### Esempio 1: rimuovere la regola di rete virtuale del server PostgreSql per nome
```powershell
PS C:\> Remove-AzPostgreSqlVirtualNetworkRule -Name vnet -ResourceGroupName PostgreSqlTestRG -ServerName PostgreSqlTestServer

```

Questo cmdlet rimuove la regola di rete virtuale del server PostgreSql per nome.

### Esempio 2: rimuovere la regola di rete virtuale del server PostgreSql per identità
```powershell
...
Questi cmdlet rimuovono la regola della rete virtuale del server PostgreSql per identità.
