...
### Esempio 1: ripristinare il server PostgreSql tramite il ripristino di georeplica
```powershell
...
Questo cmdlet ripristina il server PostgreSql usando il ripristino di georeplica.

### Esempio 2: ripristinare il server PostgreSql tramite il ripristino di PointInTime
```powershell
...
Questi cmdlet ripristinano il server PostgreSql usando il ripristino di PointInTime.
