...
## Sinossi
Rimuovere un servizio dal cluster. Supporta solo i servizi distribuiti con ARM.
...
## Descrizione
Questo cmdlet consente di rimuovere un modulo del servizio nel cluster.
...
In questo esempio viene rimosso il servizio "testApp ~ testService1".
