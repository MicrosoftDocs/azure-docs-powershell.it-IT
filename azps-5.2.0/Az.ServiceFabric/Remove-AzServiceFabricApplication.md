...
## Sinossi
Rimuovere un'applicazione dal cluster. Verranno rimossi tutti i servizi sotto l'applicazione. Supporta solo le applicazioni distribuite ARM.
...
## Descrizione
Questo cmdlet consente di rimuovere un modulo di applicazione il cluster. In questo modo verranno rimossi tutti i servizi, se presenti, nella risorsa applicazione.
...
In questo esempio viene rimossa l'applicazione "testApp" nel gruppo di risorse "testRG" e il cluster "testCluster".
