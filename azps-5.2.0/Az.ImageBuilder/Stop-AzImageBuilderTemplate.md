...
### Esempio 1: interrompere la creazione di modelli di immagine
```powershell
...
Questo comando interrompe la creazione di modelli di immagine.

### Esempio 2: interrompere la creazione di modelli di immagine
```powershell
PS C:\> Start-AzImageBuilderTemplate -ImageTemplateName template-name-sn78hg -ResourceGroupName wyunchi-imagebuilder -AsJob 
