...
## Sinossi
Creare o aggiornare i metadati di un servizio per dispositivi Windows.
...
### Esempio 1: creare nuovi servizi Windows
```powershell
...
Questo comando crea un nuovo servizio Windows.
...
Non specificare per la creazione di un nuovo servizio Windows sacco di dispositivi.
