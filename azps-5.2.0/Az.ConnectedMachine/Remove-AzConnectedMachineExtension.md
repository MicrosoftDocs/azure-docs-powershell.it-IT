...
### Esempio 1: rimuovere un'estensione del computer.
```powershell
PS C:\> Remove-AzConnectedMachineExtension -MachineName myMachine -ResourceGroupName myRG -Name custom

```

Elimina l'estensione nel computer.

### Esempio 2: rimuovere l'estensione tramite la pipeline
```powershell
PS C:\> Get-AzConnectedMachineExtension -ResourceGroupName contoso-connected-machines -MachineName myMachine | Remove-AzConnectedMachineExtension

```

Rimuove tutte le estensioni nel computer specificato.
...
### -MachineName
Il nome del computer in cui deve essere eliminata l'estensione.
