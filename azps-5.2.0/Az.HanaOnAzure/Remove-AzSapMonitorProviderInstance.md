...
### Esempio 1: rimuovere l'istanza di SAP monitor per nome
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Questo comando rimuove l'istanza di SAP monitor per nome.

### Esempio 2: rimuovere l'istanza di SAP monitor by Object
```powershell
...
Questo comando rimuove l'istanza di SAP monitor by Object.
