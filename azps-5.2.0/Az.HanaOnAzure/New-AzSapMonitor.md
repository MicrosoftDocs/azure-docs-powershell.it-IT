...
## Sinossi
Crea un monitor SAP per l'abbonamento, il gruppo di risorse e il nome della risorsa specificati.
...
Questo comando crea un monitor SAP.
...
Valore che indica se inviare analisi a Microsoft
...
ID area di lavoro dell'area di lavoro analisi log da usare per il monitoraggio
...
ID ARM dell'area di lavoro analisi log usata per il monitoraggio
...
Chiave condivisa dell'area di lavoro analisi log usata per il monitoraggio
...
Subnet in cui verrà distribuito il monitor SAP.
Dovrebbe essere la stessa subnet del database HANA.
