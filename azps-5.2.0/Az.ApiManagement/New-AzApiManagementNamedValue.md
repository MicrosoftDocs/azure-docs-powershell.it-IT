...
## Descrizione
Il cmdlet **New-AzApiManagementNamedValue** crea una gestione API di Azure **denominata value**.
...
Il secondo comando crea un valore denominato e assegna le stringhe in $Tags come tag nella proprietà.
...
Questo comando crea un **valore denominato** che contiene un valore crittografato.
