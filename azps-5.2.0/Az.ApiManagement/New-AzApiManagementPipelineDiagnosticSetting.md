...
## Descrizione
Il cmdlet **New-AzApiManagementPipelineDiagnosticSetting** crea le impostazioni di diagnostica per i messaggi HTTP in arrivo/in uscita nel gateway.
...
Creare un sistema di diagnostica della pipeline da usare in FrontEnd o backend nell'entità di diagnostica.
...
### -Request
Impostazione di diagnostica per Request.
...
### -Risposta
Impostazione di diagnostica per la risposta.
Questo parametro è facoltativo.
