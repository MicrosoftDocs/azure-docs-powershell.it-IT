...
## Descrizione
Il cmdlet **Get-AzApiManagementOpenIdConnectProvider** ottiene i provider di connessione OpenID in gestione API di Azure.
ClientSecret non verrà incluso nei dettagli dei risultati. Per ottenere il segreto del client, USA **Get-AzApiManagementOpenIdConnectProviderClientSecret**.
