...
## Descrizione
Il cmdlet **Get-AzApiManagementAuthorizationServer** ottiene tutti i server di autorizzazione di gestione delle API Azure o il server di autorizzazione specificato.
ClientSecret non verrà incluso nei dettagli dei risultati. Per ottenere il segreto del client, USA **Get-AzApiManagementAuthorizationServerClientSecret**.
