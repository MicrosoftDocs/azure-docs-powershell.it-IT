...
Questo comando ottiene i criteri per l'ambito del tenant in formato di escape non XML.
...
### -ApiRevision
Identificatore della revisione API. Questo parametro è facoltativo. Se non specificato, il criterio verrà recuperato dalla revisione API attualmente attiva.
