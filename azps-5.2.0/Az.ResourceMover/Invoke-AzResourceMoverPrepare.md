...
### Esempio 1: convalidare la dependecies prima di preparare le risorse
```powershell
...
Convalidare dependecies prima di preparare le risorse.

### Esempio 2: avviare la preparazione per il set di risorse nella raccolta di mosse usando "MoveResource Name" come input
```powershell
...
Avviare prepararsi per il set di risorse nella raccolta di mosse usando "MoveResource Name" come input.

### Esempio 3: avviare la preparazione per il set di risorse nella raccolta di mosse usando "SourceARMID"
```powershell
...
Avviare prepararsi per il set di risorse nella raccolta di mosse usando "SourceARMID".
