...
### Esempio 1: ottenere informazioni dettagliate su tutte le risorse della raccolta Move.
```powershell
...
Ottenere informazioni dettagliate su tutte le risorse della raccolta Move.

### Esempio 2: ottenere i dettagli di una specifica risorsa in una raccolta di mosse usando il nome della risorsa di trasferimento.
```powershell
...
Ottenere i dettagli di una specifica risorsa in una raccolta di mosse usando il nome della risorsa di trasferimento.

### Esempio 3: ottenere i dettagli di una specifica risorsa in una raccolta di mosse usando filtri come: SourceResourceName, SourceId, MoveState, IsResolveRequired, ProvisioningState
```powershell
...
Ottenere i dettagli di una specifica risorsa in una raccolta di mosse tramite filtro, ad esempio Armid, moveStatusMoveState (verifica) e così via.
...
Ad esempio, puoi usare $filter = Properties/ProvisioningState EQ ' succeeded '.
...
### -Nome
Il nome della risorsa di trasferimento.
