...
### Esempio 1: creare una nuova raccolta di mosse.
```powershell
...
Creare una nuova raccolta di mosse all'interno di un abbonamento.
...
### -IdentityType
Il tipo di identità utilizzata per il servizio di trasferimento dell'area geografica.
