...
### Esempio 1: convalidare la dependecies prima dello scarto delle risorse.
```powershell
...
Convalidare la dependecies prima dello scarto delle risorse.

### Esempio 2: Elimina il passaggio delle risorse usando "nome MoveResource" come input
```powershell
...
Elimina il passaggio delle risorse usando "MoveResource Name" come input.

### Esempio 3: Elimina il passaggio delle risorse con "SourceARMID" come input
```powershell
...
Elimina il passaggio delle risorse usando "SourceARMID" come input.
