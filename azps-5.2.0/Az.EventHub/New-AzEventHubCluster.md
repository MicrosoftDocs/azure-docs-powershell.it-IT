...
## Sinossi
Crea un nuovo cluster di eventhub dedicato

## SINTASSI

### ClusterPropertiesSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet New-AzEventHubCluster crea il cluster eventhub dedicato nel gruppo di risorse specifico
...
Crea il cluster dedicato "Eventhub-cluster-5557" in ResourceGroup "RSG-Cluster27651" con posizione southcentralus e capacità come 1

## PARAMETRI

### -Capacità
Capacità cluster (CU), curerntrly, valore consentito = 1
...
### -Tag
Hashtable che rappresenta i tag delle risorse per i cluster
