...
## Descrizione
Esporta i dati del dominio di sicurezza di un HSM gestito per l'importazione in un altro HSM.
...
Questo comando Recupera l'HSM gestito denominato testmhsm e salva una copia di backup del dominio di sicurezza di HSM gestito nel file di output specificato.

## PARAMETRI

### -Certificati
Percorsi per i certificati usati per crittografare i dati del dominio di sicurezza.
