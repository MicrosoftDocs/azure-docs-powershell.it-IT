...
## Descrizione
Il cmdlet **Stop-AzKeyVaultCertificateOperation** Annulla un'operazione di certificato nel servizio di archiviazione delle chiavi di Azure.

## ESEMPI

### Esempio 1: annullamento di un'operazione su un certificato
```powershell
...
Questo comando Annulla l'operazione del certificato TestCert02.
