...
## Descrizione
Il cmdlet **Get-AzKeyVaultManagedHsm** ottiene informazioni sulle HSM gestite in un abbonamento. È possibile visualizzare tutte le istanze di HSM gestite in un abbonamento o filtrare i risultati in base a un gruppo di risorse o a un determinato HSM gestito.
