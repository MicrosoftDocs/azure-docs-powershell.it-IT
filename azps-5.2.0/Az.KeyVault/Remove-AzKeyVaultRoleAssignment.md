...
Questo esempio revoca il ruolo "amministratore dei criteri di HSM gestito" di " user1@microsoft.com " all'ambito "/Keys".
...
### -PassThru
Restituisce vero quando l'HSM viene ripristinato.
