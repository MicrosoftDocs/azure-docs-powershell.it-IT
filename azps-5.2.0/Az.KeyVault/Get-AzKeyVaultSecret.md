...
Questo comando consente di ottenere tutte le versioni del segreto denominato secret1 nel caveau della chiave denominato contoso.
...
Questo comando consente di ottenere la versione corrente del segreto denominato secret1 nel caveau della chiave denominato contoso.
...
Questo comando consente di ottenere una versione specifica del segreto denominata secret1 nel caveau della chiave denominato contoso.
...
(Nota: usare il metodo 3 Se si usa la [modalità ConstrainedLanguage](https://docs.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_language_modes?view=powershell-7.1#constrained-language-constrained-language)di PowerShell, ad esempio, per le workstation di accesso sicuro/privilegiato).
...
Questo comando ottiene il segreto "secret1" che è stato eliminato in precedenza, ma non è stato eliminato, nel caveau della chiave denominato contoso.
...
### Esempio 8: ottenere tutte le versioni correnti di tutti i segreti in un Vault chiave usando il filtro
```powershell
...
Questo comando consente di ottenere le versioni correnti di tutti i segreti nel Vault chiave denominato Contoso che iniziano con "segreto".
