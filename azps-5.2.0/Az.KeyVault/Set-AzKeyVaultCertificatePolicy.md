...
## Descrizione
Il cmdlet **set-AzKeyVaultCertificatePolicy** crea o aggiorna i criteri per un certificato in un Vault chiave.
...
Questo comando imposta i criteri per il certificato TestCert01 nel Vault della chiave ContosoKV01.
...
`-IssuerName` deve essere specificato durante l'impostazione di questa proprietà.
...
### -EmailAtNumberOfDaysBeforeExpiry
Specifica il numero di giorni prima della scadenza quando deve iniziare il rinnovo automatico.
...
### -InputObject
Specifica i criteri di certificato.
