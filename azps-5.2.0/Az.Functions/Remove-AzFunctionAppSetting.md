...
### Esempio 1: rimuovere le impostazioni dell'app in un'app di funzione.
```powershell
...
Questo comando rimuove le impostazioni dell'app in un'app di funzione.

## PARAMETRI

### -AppSettingName
Elenco delle impostazioni dell'app funzione da rimuovere dall'App funzione.
...
### -Force
Impone al cmdlet di rimuovere l'impostazione dell'app funzione senza richiedere conferma.
