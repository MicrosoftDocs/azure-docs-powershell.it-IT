...
Questo comando consente di ottenere tutte le configurazioni del cluster kubernetes.

### Esempio 2: ottenere una configurazione del cluster kubernetes per nome
```powershell
...
Questo comando ottiene una configurazione del cluster kubernetes per nome.

### Esempio 3: ottenere una configurazione di kubernetes cluster by Object
```powershell
...
Questo comando ottiene una configurazione di kubernetes cluster by Object.

### Esempio 4: ottenere una configurazione del cluster kubernetes per pipeline
```powershell
...
Questo comando ottiene una configurazione del cluster kubernetes per pipeline.
...
### -ClusterRp
Il cluster Kubernetes RP-Microsoft. ContainerService (per i cluster AKS) o Microsoft. Kubernetes (per i cluster OnPrem K8S).
