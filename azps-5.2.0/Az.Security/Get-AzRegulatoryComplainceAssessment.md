...
## Descrizione
Ottenere un dettaglio di valutazione di spcific o elencare tutte le valutazioni in base a specifici controlli e conformità normative.
...
Ottenere tutte le valutazioni in specifici controlli e standard.
...
Ottenere una valutazione specifica in un controllo specifico e standard in base all'ID valutazione.
...
Ottenere una valutazione specifica in un controllo specifico e standard in base all'ID risorsa.
