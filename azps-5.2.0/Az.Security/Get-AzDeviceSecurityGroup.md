...
### ResourceIdScope (impostazione predefinita)
```
...
## Descrizione
Il cmdlet Get-AzDeviceSecurityGroup restituisce un gruppo di sicurezza dei dispositivi definito nella soluzione di sicurezza degli Stati
...
Ottenere il gruppo di sicurezza dei dispositivi "MySecurityGroup" nell'hub degli molto con l'ID risorse "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
...
Ottenere un elenco di gruppi di sicurezza dei dispositivi nell'hub degli molto con l'ID risorse "/subscriptions/XXXXXXXX-XXXX-XXXXX-XXXX-XXXXXXXXXXXX/resourceGroups/MyResourceGroup/providers/Microsoft.Devices/IotHubs/MyHub"
