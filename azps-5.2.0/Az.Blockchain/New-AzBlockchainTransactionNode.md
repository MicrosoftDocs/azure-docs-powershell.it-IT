...
### Esempio 1: creare un nodo delle transazioni blockchain
```powershell
...
Questo comando crea un nodo transazione blockchain.
...
Per costruire, vedere la sezione Note per le proprietà di FIREWALLRULE e creare una tabella hash.
...
### -Posizione
Ottiene o imposta la posizione del nodo della transazione.
...
### -Password
Imposta la password di autenticazione di base dell'endpoint DNS di Transaction node.
