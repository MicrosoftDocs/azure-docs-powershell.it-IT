...
### Esempio 1: aggiornare un desktop di Windows Virtual HostPool per nome
```powershell
...
Questo comando aggiorna un HostPool desktop virtuale di Windows in un gruppo di risorse.
