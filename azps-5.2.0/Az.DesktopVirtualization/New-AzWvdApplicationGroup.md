...
### Esempio 1: creare un desktop virtuale di Windows ApplicationGroup per nome
```powershell
...
Questo comando crea un ApplicationGroup desktop virtuale di Windows in un gruppo di risorse.

### Esempio 2: creare un desktop virtuale di Windows ApplicationGroup per nome
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Tipo di risorsa di ApplicationGroup.
...
### -HostPoolArmPath
Percorso del braccio HostPool di ApplicationGroup.
