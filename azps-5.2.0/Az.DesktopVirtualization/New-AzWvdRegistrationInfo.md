...
### Esempio 1: creare un token di registrazione desktop virtuale di Windows
```powershell
...
Questo comando crea un token di registrazione desktop virtuale di Windows in un pool host.
