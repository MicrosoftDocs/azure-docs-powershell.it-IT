...
### Esempio 1: registrare un gruppo di applicazioni desktop virtuale di Windows
```powershell
...
Questo comando registra un gruppo di applicazioni desktop virtuale di Windows in un'area di lavoro.

## PARAMETRI

### -ApplicationGroupPath
Percorso ApplicationGroupPath
