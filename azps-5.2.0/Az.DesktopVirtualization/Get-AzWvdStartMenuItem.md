...
### Esempio 2: elenco delle voci di menu Start di Windows Virtual Desktop
```powershell
...
Questo comando elenca le voci di menu Start di Windows Virtual Desktop in un gruppo di Applicaton.
