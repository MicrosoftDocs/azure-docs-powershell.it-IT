...
## Descrizione
Il cmdlet **Get-AzDataLakeGen2Item** ottiene i dettagli di un file o di una directory in un filesystem in un account di archiviazione di Azure.
...
### Esempio 1: ottenere una directory da un filesystem e visualizzare i dettagli
```
...
Questo comando consente di ottenere una directory da un filesystem e visualizzare i dettagli.

### Esempio 2: ottenere un file da un filesystem
```
...
Questo comando consente di ottenere i dettagli di un file da un filesystem. 
...
Non specificare questo parametro per ottenere la directory radice del filesystem.
