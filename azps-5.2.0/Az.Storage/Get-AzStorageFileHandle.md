...
## Descrizione
Il cmdlet **Get-AzStorageFileHandle** elenca gli handle di file di una condivisione file o di un file o di una directory.

## ESEMPI

### Esempio 1: elenca tutti gli handle di file in una condivisione file ricorsivamente e ordina in base a ClientIp e OpenTime
```
...
Questo comando elenca gli handle di file in una condivisione file e ordina l'output per ClientIp, quindi per OpenTime.

### Esempio 2: elencare i primi 2 handle di file in una directory di file ricorsivamente
```
...
Questo comando elenca i primi 2 handle di file in una directory di file in modo ricorsivo.

### Esempio 3: elencare i quadratini di file da 3 a 6 in un file
```
...
Questo comando elenca il 3 ° al 6 ° handle di file in un file.
...
### -File
L'oggetto CloudFile ha indicato il file per elencare gli handle di file.
...
### -IncludeTotalCount
Indica il numero di oggetti nel set di dati (un numero intero) seguito dagli oggetti. Se il cmdlet non riesce a determinare il conteggio totale, restituisce "numero totale sconosciuto".
