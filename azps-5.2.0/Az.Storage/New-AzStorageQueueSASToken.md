...
## Descrizione
Il cmdlet **New-AzStorageQueueSASToken** genera il token della firma di accesso condiviso per una coda di archiviazione di Azure.
...
Puoi crearla tramite il cmdlet New-AzStorageContext.
