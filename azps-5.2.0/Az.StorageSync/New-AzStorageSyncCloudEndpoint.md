...
## Descrizione
Questo comando crea un endpoint cloud di sincronizzazione di Azure file. Un endpoint cloud è un riferimento a una condivisione di file Azure esistente. Rappresenta la condivisione di file e la definisce partecipazione alla sincronizzazione di tutti i file parte del gruppo di sincronizzazione in cui è stato creato l'endpoint cloud.
...
Un endpoint cloud è un membro integrale di un gruppo di sincronizzazione, questo è un esempio di creazione di uno all'interno di un gruppo di sincronizzazione esistente denominato "mySyncGroupName".
...
### -AzureFileShareName
Nome condivisione account di archiviazione (nome condivisione file Azure)
...
### -Nome
Nome dell'endpoint cloud. Quando viene creato tramite il portale di Azure, il nome viene impostato sul nome della condivisione di file di Azure a cui fa riferimento.
...
ID tenant dell'account di archiviazione (ID directory aziendale)
