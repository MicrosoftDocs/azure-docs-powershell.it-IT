...
## Descrizione
Il cmdlet **Get-AzRecoveryServicesAsrProtectionContainer** ottiene i contenitori di protezione dal ripristino dei siti di Azure nell'archivio di servizi di ripristino.
...
Elenco dei contenitori di protezione in tessuto $fabric.
...
Contenitore di protezione in tessuto $fabric con nome.
...
Contenitore di protezione in tessuto $fabric con nome descrittivo.
