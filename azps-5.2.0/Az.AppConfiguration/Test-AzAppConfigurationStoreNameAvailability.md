...
### Esempio 1: verificare la disponibilità del nome dell'archivio di configurazione dell'app
...
Questo comando verifica la disponibilità del nome dell'archivio di configurazione dell'app.
...
### -Nome
Il nome per verificare la disponibilità.
