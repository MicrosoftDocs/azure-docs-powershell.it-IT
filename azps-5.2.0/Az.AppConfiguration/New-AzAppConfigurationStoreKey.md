...
## Sinossi
Rigenera un tasto di scelta per l'archivio di configurazione specificato.
...
### Esempio 1: chiave di rigenerazione di un archivio di configurazione dell'app
```powershell
...
Questo comando rigenera la chiave di un archivio di configurazione dell'app.

### Esempio 2: rigenerare la chiave di un archivio di configurazione dell'app per oggetto
```powershell
...
Questo comando rigenera la chiave di un archivio di configurazione dell'app per oggetto.
