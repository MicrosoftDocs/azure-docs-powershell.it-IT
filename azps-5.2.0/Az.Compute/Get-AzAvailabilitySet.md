...
### Esempio 3: ottenere tutti i set di disponibilità con filtri
```
...
Questo comando ottiene tutti i set di disponibilità nel gruppo di risorse denominato ResourceGroup11 che iniziano con "AvailabilitySet0".

### Esempio 4: ottenere tutti i set di disponibilità con il nome che inizia con AvailabilitySet0
```
