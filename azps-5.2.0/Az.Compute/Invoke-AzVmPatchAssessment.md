...
## Descrizione
Valuta lo stato della patch di una VM e riporta tutte le patch rilevate disponibili per l'installazione.
...
### -ResourceId
ID risorsa per la tua macchina virtuale.
...
### -VM
Oggetto macchina virtuale di PowerShell
