...
## Descrizione
Questo cmdlet otterrà o elenca le risorse del gruppo di posizionamento di prossimità.
...
Questo comando ottiene il gruppo posizionamento di prossimità
...
Questo comando elenca tutti i gruppi di posizionamento di prossimità in un gruppo di risorse specifico.
...
Questo comando elenca tutti i gruppi di posizionamento di prossimità sotto l'abbonamento.

## PARAMETRI

### -ColocationStatus
Mostra lo stato di Colocation di una risorsa nel gruppo posizionamento di prossimità.
