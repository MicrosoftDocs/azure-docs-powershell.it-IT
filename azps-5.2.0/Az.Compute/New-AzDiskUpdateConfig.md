...
### -DiskMBpsReadOnly
Il throughput totale (MBps) che sarà consentito in tutte le VM che montano il disco condiviso come ReadOnly. MBps significa milioni di byte al secondo MB Usa la notazione ISO, di poteri di 10.
...
### -MaxSharesCount
Numero massimo di VM che possono essere allegate al disco contemporaneamente. Il valore maggiore di uno indica un disco che può essere montato su più VM contemporaneamente.
