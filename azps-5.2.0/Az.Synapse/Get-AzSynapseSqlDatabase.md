...
## Sinossi
Ottiene un database SQL di analisi sinapsi.
...
## Descrizione
[Questa caratteristica è in un'anteprima limitata, inizialmente accessibile solo a determinati abbonamenti.] Il cmdlet **Get-AzSynapseSqlDatabase** ottiene le informazioni su un database SQL di analisi delle sinapsi di Azure.
...
Questo comando consente di ottenere tutti i database SQL in un'area di lavoro.
...
Questo comando ottiene il database SQL in area di lavoro ContosoWorkspace con nome ContosoSqlDatabase.
...
Questo comando consente di ottenere tutti i database SQL in un'area di lavoro tramite pipeline.
...
Questo comando ottiene il database SQL con l'ID risorsa specificato.
...
### -ResourceId
Identificatore delle risorse del database SQL di sinapsi.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSSynapseSqlDatabase
