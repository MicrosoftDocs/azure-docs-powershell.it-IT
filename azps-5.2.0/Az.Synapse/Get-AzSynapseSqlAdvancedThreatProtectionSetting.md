...
## Descrizione
Il cmdlet **Get-AzSynapseSqlAdvancedThreatProtectionSetting** ottiene le impostazioni avanzate per la protezione delle minacce di un'area di lavoro di analisi di Azure sinapsi.
...
Questo comando consente di ottenere le impostazioni avanzate di protezione dalle minacce per un'area di lavoro denominata ContosoWorkspace.
