...
## Descrizione
Il cmdlet **Suspend-AzSynapseSqlPool** sospende un pool SQL di analisi delle sinapsi di Azure.
...
Questo comando sospende un pool SQL di analisi delle sinapsi di Azure attivo.
