...
## Descrizione
Il cmdlet **Get-AzSynapseIntegrationRuntimeKey** ottiene le chiavi per un runtime di integrazione. I tasti vengono usati per registrare un nodo runtime di Integration.
