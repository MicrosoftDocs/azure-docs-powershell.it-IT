...
## Descrizione
Il cmdlet **Reset-AzSynapseSqlAuditSetting** rimuove le impostazioni di controllo di un'area di lavoro di analisi di Azure sinapsi.
...
Questo comando rimuove le impostazioni di controllo di un'area di lavoro di analisi di Azure sinapsi denominata ContosoWorkspace.
...
Questo comando rimuove le impostazioni di controllo di un'area di lavoro di analisi di Azure sinapsi denominata ContosoWorkspace tramite pipeline.
