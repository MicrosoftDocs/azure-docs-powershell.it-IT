...
## Descrizione
Il cmdlet **test-AzSynapseSqlPool** controlla l'esistenza di un pool di analisi delle sinapsi SQL.
...
Questo comando controlla l'esistenza del pool SQL specificato.
