...
---
# Modulo di AZ. sinapsi
## Descrizione
Gli argomenti di questa sezione documentano i cmdlet di PowerShell di Azure per l'analisi di Azure sinapsi.

## Cmdlet AZ. sinapsi
### [Add-AzSynapseTriggerSubscription](Add-AzSynapseTriggerSubscription.md)
Sottoscrivere il trigger dell'evento per gli eventi del servizio esterno.
...
Ottiene informazioni sui flussi di dati nell'area di lavoro.
...
Ottiene una regola del firewall di analisi sinapsi.
...
Ottiene informazioni sui servizi collegati nell'area di lavoro.
...
Ottiene un'assegnazione di ruolo di analisi sinapsi.

### [Get-AzSynapseRoleDefinition](Get-AzSynapseRoleDefinition.md)
Ottiene una definizione del ruolo di analisi sinapsi.

### [Get-AzSynapseSparkJob](Get-AzSynapseSparkJob.md)
Ottiene un processo Spark analisi sinapsi.

### [Get-AzSynapseSparkPool](Get-AzSynapseSparkPool.md)
Ottiene un pool di scintille di analisi sinapsi.
...
Ottiene un'istruzione Spark di analisi sinapsi.

### [Get-AzSynapseSqlActiveDirectoryAdministrator](Get-AzSynapseSqlActiveDirectoryAdministrator.md)
Ottiene informazioni su un amministratore di Azure AD per l'area di lavoro di analisi sinapsi.

### [Get-AzSynapseSqlAdvancedThreatProtectionSetting](Get-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Ottiene le impostazioni avanzate per la protezione delle minacce per un'area di lavoro.

### [Get-AzSynapseSqlAuditSetting](Get-AzSynapseSqlAuditSetting.md)
Ottiene le impostazioni di controllo di un'area di lavoro di analisi di Azure sinapsi.

### [Get-AzSynapseSqlDatabase](Get-AzSynapseSqlDatabase.md)
Questa funzionalità è in un'anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Ottiene un database SQL di analisi sinapsi.
...
Ottiene le impostazioni di controllo di un pool SQL di analisi delle sinapsi di Azure.

### [Get-AzSynapseSqlPoolRestorePoint](Get-AzSynapseSqlPoolRestorePoint.md)
Recupera i punti di ripristino distinti da cui può essere ripristinato un pool SQL di analisi delle sinapsi.
...
Ottiene le impostazioni di valutazione della vulnerabilità di un'area di lavoro.
...
Ottenere lo stato della sottoscrizione per il trigger dell'evento per gli eventi del servizio esterno specificati.
...
Crea un'assegnazione di ruolo di analisi sinapsi.

### [New-AzSynapseSparkPool](New-AzSynapseSparkPool.md)
Crea un pool di scintille di analisi sinapsi.

### [New-AzSynapseSqlDatabase](New-AzSynapseSqlDatabase.md)
Questa funzionalità è in un'anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Crea un database SQL di analisi sinapsi.

### [New-AzSynapseSqlPool](New-AzSynapseSqlPool.md)
Crea un pool di analisi delle sinapsi SQL.

### [New-AzSynapseSqlPoolRestorePoint](New-AzSynapseSqlPoolRestorePoint.md)
Crea un nuovo punto di ripristino in un pool di analisi SQL sinapsi di Azure.

### [New-AzSynapseWorkspace](New-AzSynapseWorkspace.md)
Crea un'area di lavoro di analisi sinapsi.
...
Rimuove un DataSet dall'area di lavoro.

### [Remove-AzSynapseFirewallRule](Remove-AzSynapseFirewallRule.md)
Elimina una regola del firewall di analisi sinapsi.
...
Rimuove un amministratore di Azure AD per l'area di lavoro di analisi sinapsi.

### [Remove-AzSynapseSqlDatabase](Remove-AzSynapseSqlDatabase.md)
Questa funzionalità è in un'anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Elimina un database SQL di analisi sinapsi.
...
Annullare la sottoscrizione del trigger dell'evento agli eventi del servizio esterno.

### [Remove-AzSynapseWorkspace](Remove-AzSynapseWorkspace.md)
Elimina un'area di lavoro di analisi sinapsi.

### [Reset-AzSynapseSparkSessionTimeout](Reset-AzSynapseSparkSessionTimeout.md)
Reimposta il timeout di una sessione di scintilla di analisi sinapsi.

### [Reset-AzSynapseSqlAdvancedThreatProtectionSetting](Reset-AzSynapseSqlAdvancedThreatProtectionSetting.md)
Rimuove le impostazioni avanzate di protezione dalle minacce da un'area di lavoro.

### [Reset-AzSynapseSqlAuditSetting](Reset-AzSynapseSqlAuditSetting.md)
Rimuove le impostazioni di controllo di un'area di lavoro di analisi di Azure sinapsi.

### [Reset-AzSynapseSqlPoolAuditSetting](Reset-AzSynapseSqlPoolAuditSetting.md)
Rimuove le impostazioni di controllo di un pool SQL di analisi di una sinapsi di Azure.
...
### [Ripristinare-AzSynapseSqlPool](Restore-AzSynapseSqlPool.md)
Ripristina un pool SQL di analisi sinapsi.

### [Curriculum vitae-AzSynapseSqlPool](Resume-AzSynapseSqlPool.md)
Riprende un pool SQL di analisi sinapsi.
...
Modifica le impostazioni di controllo per un pool di analisi SQL di Azure sinapsi.

### [Set-AzSynapseSqlTransparentDataEncryptionProtector](Set-AzSynapseSqlTransparentDataEncryptionProtector.md)
Imposta la protezione di crittografia dati trasparente (Transparent Data Encryption) per un'area di lavoro di analisi sinapsi.
...
Annulla un processo Spark analisi sinapsi.

### [Stop-AzSynapseSparkSession](Stop-AzSynapseSparkSession.md)
Interrompe una sessione di Spark analisi sinapsi.

### [Stop-AzSynapseSparkStatement](Stop-AzSynapseSparkStatement.md)
Annulla un'istruzione Spark di analisi sinapsi.

### [Stop-AzSynapseTrigger](Stop-AzSynapseTrigger.md)
Arresta un trigger in un'area di lavoro.

### [Invia-AzSynapseSparkJob](Submit-AzSynapseSparkJob.md)
Invia un processo Spark analisi sinapsi.

### [Suspend-AzSynapseSqlPool](Suspend-AzSynapseSqlPool.md)
Sospende un pool SQL di analisi sinapsi.

### [Sincronizzazione-AzSynapseIntegrationRuntimeCredential](Sync-AzSynapseIntegrationRuntimeCredential.md)
Sincronizza le credenziali tra i nodi di Integration Runtime.

### [Test-AzSynapseSparkPool](Test-AzSynapseSparkPool.md)
Verifica l'esistenza di un pool di scintille di analisi sinapsi.

### [Test-AzSynapseSqlDatabase](Test-AzSynapseSqlDatabase.md)
Questa funzionalità è in un'anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Verifica l'esistenza di un database SQL di analisi sinapsi.

### [Test-AzSynapseSqlPool](Test-AzSynapseSqlPool.md)
Verifica l'esistenza di un pool SQL di analisi sinapsi.
...
Aggiorna una regola del firewall per l'analisi sinapsi.
...
Aggiorna un pool di analisi sinapsi.
...
Questa funzionalità è in un'anteprima limitata, inizialmente accessibile solo a determinati abbonamenti. Aggiorna un database SQL di analisi sinapsi.
