...
## Descrizione
Il cmdlet **Reset-AzSynapseSqlAdvancedThreatProtectionSetting** rimuove le impostazioni avanzate di protezione dalle minacce da un'area di lavoro di analisi di Azure sinapsi.
...
Questo comando rimuove le impostazioni avanzate di protezione dalle minacce da un'area di lavoro denominata ContosoWorkspace.
