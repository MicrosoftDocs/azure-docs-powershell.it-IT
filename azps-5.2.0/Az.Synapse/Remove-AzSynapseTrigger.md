...
## Descrizione
Il cmdlet **Remove-AzSynapseTrigger** rimuove un trigger da un'area di lavoro.
...
Rimuovere un trigger denominato ContosoTrigger dall'area di lavoro ContosoWorkspace.
...
Rimuovere un trigger denominato ContosoTrigger dall'area di lavoro ContosoWorkspace tramite pipeline.
