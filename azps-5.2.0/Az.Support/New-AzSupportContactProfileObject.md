...
## Sinossi
Crea un oggetto del profilo del contatto di supporto.
...
## Descrizione
Questo è un cmdlet helper che puoi usare per creare un oggetto profilo di contatto di supporto durante la creazione o l'aggiornamento di un ticket di supporto. È necessario specificare i parametri seguenti obbligatori per la creazione di un ticket di supporto: 
