...
## Descrizione
Il cmdlet Remove-AzContainerRegistryReplication rimuove una replica del registro di sistema contenitore.

## ESEMPI

### Esempio 1: rimuove una replica del registro di sistema contenitore.
```powershell
...
### -PassThru
Indica che questo cmdlet restituisce true se la rimozione è stata eseguita correttamente.
