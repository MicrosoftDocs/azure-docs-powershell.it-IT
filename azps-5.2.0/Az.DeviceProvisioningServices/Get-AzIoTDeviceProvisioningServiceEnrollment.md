...
## Descrizione
Ottenere i dettagli di registrazione del dispositivo o le iscrizioni del dispositivo di elenco in un servizio di provisioning del dispositivo hub Azure molto.
...
Ottenere i dettagli di registrazione del dispositivo in un servizio di provisioning del dispositivo hub Azure molto.
...
Elencare le iscrizioni del dispositivo in un servizio di provisioning del dispositivo hub Azure molto.
