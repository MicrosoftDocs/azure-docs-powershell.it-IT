...
Creare un servizio di provisioning del dispositivo hub di Azure molto con il livello di prezzo standard S1 e i tag, nell'area del gruppo risorse.
...
Creare un servizio di provisioning del dispositivo hub di Azure molto con il livello di prezzo standard S1 nella regione "eastus".
...
### -Tag
Tag di istanza del servizio di provisioning del dispositivo. Elenco delle proprietà in coppie chiave-valore in forma di tabella hash.
