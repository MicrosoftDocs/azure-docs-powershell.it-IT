...
Eliminare i criteri di accesso condiviso "criteri" in un servizio di provisioning del dispositivo hub Azure molto.
...
Eliminare i criteri di accesso condiviso "criteri" in un servizio di provisioning del dispositivo hub di Azure molto tramite pipeline.
