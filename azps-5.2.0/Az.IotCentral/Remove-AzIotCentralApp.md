...
## Sinossi
Elimina un'applicazione centrale di un sacco.
...
## Descrizione
Elimina un'applicazione centrale di un sacco esistente.

## ESEMPI

### Esempio 1 applicazione centrale Elimina e un sacco
```powershell
PS C:\> Remove-AzIotCentralApp -ResourceGroupName "MyResourceGroupName" -Name "MyAppResourceName"
```

Elimina l'applicazione centrale disponibile.
