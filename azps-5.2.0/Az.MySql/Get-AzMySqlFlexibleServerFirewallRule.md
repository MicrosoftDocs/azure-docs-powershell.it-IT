...
### Esempio 1: ottenere le regole del firewall per nome
```powershell
...
Questo cmdlet ottiene le regole del firewall per nome.

### Esempio 2: ottenere regole firewall per identità
```powershell
...
Questo cmdlet ottiene le regole del firewall per identità.
