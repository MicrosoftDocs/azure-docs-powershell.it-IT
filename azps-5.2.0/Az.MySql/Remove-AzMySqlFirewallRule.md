...
### Esempio 1: rimuovere la regola del firewall MySql per nome
```powershell
PS C:\> Remove-AzMySqlFirewallRule -Name rule -ResourceGroupName PowershellMySqlTest -ServerName mysql-test

```

Questo cmdlet rimuove la regola del firewall MySql per nome.

### Esempio 2: rimuovere la regola del firewall MySql per identità
```powershell
...
Questi cmdlet eliminano la regola del firewall MySql in base all'identità.
