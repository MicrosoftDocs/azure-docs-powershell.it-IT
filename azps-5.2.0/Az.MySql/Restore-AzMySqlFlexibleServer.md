...
### Esempio 1: ripristinare il server MySql tramite il ripristino di PointInTime
```powershell
...
### -SKU
Nome dell'USK, ad esempio Standard_D2ds_v4, Standard_B1ms
...
INPUTOBJECT <IServerAutoGenerated> : l'oggetto server di origine da cui ripristinare il ripristino.
