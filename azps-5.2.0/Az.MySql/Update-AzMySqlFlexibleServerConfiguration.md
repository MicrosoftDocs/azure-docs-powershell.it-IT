...
### Esempio 1: aggiornare la configurazione di MySql per nome
```powershell
...
Questo cmdlet aggiorna la configurazione di MySql per nome.

### Esempio 2: aggiornare la configurazione di MySql per identità.
```powershell
...
### -Origine
L'origine del valore di aggiornamento.
