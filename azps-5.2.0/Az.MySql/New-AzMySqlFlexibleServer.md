...
### Esempio 1: creare un nuovo server flessibile MySql
```powershell
...
### Esempio 2: creare un nuovo server flessibile MySql con l'impostazione predefinita
```powershell
PS C:\> New-AzMySqlFlexibleServer -Name mysql-test -ResourceGroupName PowershellMySqlTest \
...
Creare un server MySql con valori predefiniti.
I valori predefiniti di location sono West US 2, SKU is Standard_B1ms, il livello SKU è Burstable e la dimensione dello spazio di archiviazione è 10GiB.
...
### -SKU
Nome dell'USK, in genere, livello + famiglia + Core, ad esempio Standard_B1ms, Standard_D2ds_v4.
...
Impostazione predefinita: Burstable.
