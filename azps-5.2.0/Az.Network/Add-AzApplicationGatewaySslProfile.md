...
## Sinossi
Aggiunge il profilo SSL a un gateway dell'applicazione.
...
## Descrizione
Il cmdlet **Add-AzApplicationGatewaySslProfile** aggiunge un profilo SSL a un gateway dell'applicazione. Il profilo SSL viene applicato ai listener HTTPS.
...
Il secondo comando crea un nuovo criterio SSL e lo archivia nella variabile $sslPolicy.
Il terzo e il quarto comando crea due nuove catene di certificati CA client attendibili e le archivia nelle variabili $ClientCert 01 e $ClientCert 02.
Il quinto comando aggiunge il profilo SSL con il criterio SSL e le catene di certificati CA del client trusted per il gateway dell'applicazione $AppGw.
