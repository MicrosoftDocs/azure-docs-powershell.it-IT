...
## Descrizione
Il cmdlet New-AzNetworkWatcherConnectionMonitor crea una risorsa Monitor di connessione per l'origine e la destinazione specificati (SingleSourcedestination Connection Monitor) o set di gruppi di test (MultiEndpointConnectionMonitor).
...
### -ConfigureOnly
Configurare monitor di connessione, ma non avviarlo
...
### -DestinationPort
Porta di destinazione utilizzata da monitor di connessione.
...
ID della risorsa usata come destinazione tramite monitor di connessione.
...
### -SourcePort
Porta di origine usata da monitor di connessione.
...
### -SourceResourceId
ID della risorsa usata come origine tramite monitor di connessione.
