...
Il cmdlet **set-AzExpressRouteGateway** consente di aggiornare le unità di scala per un ExpressRouteGateway esistente o di aggiornare i tag delle risorse.
...
Quanto sopra creerà un gruppo di risorse, una WAN virtuale, una rete virtuale, un hub virtuale in West US nel gruppo di risorse "testRG" in Azure. Un gateway ExpressRoute verrà creato in seguito nell'hub virtuale con due unità di scala che verranno quindi modificate in 3 unità di misura
...
### -InputObject
ExpressRouteGateway che deve essere aggiornato.
...
### -ResourceGroupName
Il nome del gruppo di risorse di ExpressRouteGateway da aggiornare.
...
### -ResourceId
ID dell'ExpressRouteGateway che deve essere aggiornato.
