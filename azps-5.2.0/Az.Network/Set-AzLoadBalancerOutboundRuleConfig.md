...
## Descrizione
Il cmdlet **set-AzLoadBalancerOutboundRuleConfig** imposta una configurazione della regola in uscita per un bilanciamento del carico di Azure.
...
Il secondo comando usa l'operatore pipeline per passare il bilanciamento del carico in $slb a Add-AzLoadBalancerOutboundRuleConfig, che aggiunge una configurazione di regola in uscita.
Il terzo comando passa il bilanciamento del carico a **set-AzLoadBalancerOutboundRuleConfig**, che salva e aggiorna la configurazione della regola in uscita.
