...
## Sinossi
Crea un elemento dell'ambito endpoint di monitoraggio connessione.
...
## Descrizione
Il cmdlet New-AzNetworkWatcherConnectionMonitorEndpointScopeItemObject crea l'elemento dell'ambito endpoint.
...
### -Address
Indirizzo dell'elemento dell'ambito.
