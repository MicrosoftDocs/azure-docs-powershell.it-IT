...
## Descrizione
Il cmdlet New-AzRouteFilterRuleConfig crea una regola di filtro route per un filtro di route di Azure.
...
Il comando crea una nuova regola di filtro della route e la archivia in una variabile $rule 1.

## PARAMETRI

### -Access
Accesso per la regola di filtro route.
I valori validi sono allow o Deny.
...
### -Nome
Specifica un nome per la regola di filtro della route.
