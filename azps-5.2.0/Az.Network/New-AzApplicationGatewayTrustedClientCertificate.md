...
## Sinossi
Crea una catena di certificati CA client attendibile per un gateway dell'applicazione.
...
## Descrizione
Il cmdlet New-AzApplicationGatewayTrustedClientCertificate crea una catena di certificati CA client attendibile per un gateway dell'applicazione.
...
```
Il comando crea un nuovo oggetto della catena di certificati CA del client attendibile che sta prendendo il percorso del certificato della CA client come input.
