...
## Sinossi
Modificare o modificare un sito Virtual Appliance connesso a una risorsa di Virtual Appliance di rete.
...
## Descrizione
Il comando Update-AzVirtualApplianceSite modifica una risorsa sito Virtual Appliance.
...
Modificare il prefisso dell'indirizzo per una risorsa sito Virtual Appliance.

## PARAMETRI

### -AddresssPrefix
Prefisso dell'indirizzo per il sito.
...
Appliance virtuale di rete a cui è associato il sito.
...
### -O365Policy
Criteri di breakout di Office 365.
