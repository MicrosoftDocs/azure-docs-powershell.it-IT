...
## Descrizione
Il cmdlet **set-AzNetworkSecurityGroup** aggiorna un gruppo di sicurezza della rete.
...
Specifica un oggetto gruppo di sicurezza di rete che rappresenta lo stato in cui deve essere impostato il gruppo di sicurezza della rete.
