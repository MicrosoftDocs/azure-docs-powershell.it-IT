...
```
Il precedente creerà una nuova configurazione di routing e creerà route statiche nella configurazione di routing con l'hop successivo come indirizzo IP specificato. Questa configurazione di routing può quindi essere passata al comando New-AzVirtualHubVnetConnection come parametro-RoutingConfiguration.
