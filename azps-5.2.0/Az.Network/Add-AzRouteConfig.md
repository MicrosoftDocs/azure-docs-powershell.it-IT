...
Il primo comando consente di ottenere una tabella di route denominata RouteTable01 usando il cmdlet Get-AzRouteTable.
...
Questo comando ottiene la tabella route denominata RouteTable01 utilizzando **Get-AzRouteTable**.
