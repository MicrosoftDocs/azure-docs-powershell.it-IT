...
## Descrizione
Il cmdlet **New-AzContainerNicConfigIpConfig** crea una nuova configurazione IP di configurazione dell'interfaccia di rete container. 
...
### -Nome
Nome del profilo di configurazione IP della configurazione dell'interfaccia di rete contenitore.
