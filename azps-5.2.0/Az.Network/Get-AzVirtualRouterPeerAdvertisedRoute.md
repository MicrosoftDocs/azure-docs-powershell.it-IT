...
## Sinossi
Route di elenco annunciate tramite peer di router virtuale specifico
...
## Descrizione
Dato un peer di router virtuale per nome o per oggetto, enumerare le route annunciate a tale peer da un router virtuale specifico.
