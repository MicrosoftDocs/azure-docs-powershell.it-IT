...
## Descrizione
Il cmdlet **Remove-AzPrivateDnsZoneGroup** rimuove un gruppo di aree DNS. 
...
Sopra l'esempio viene rimossa una zona DNS Grup denominata dnsgroup1 da endpoint test-PR-endpoint.
