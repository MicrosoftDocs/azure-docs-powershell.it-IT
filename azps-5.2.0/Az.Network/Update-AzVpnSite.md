...
### ByVpnSiteNameNoVirtualWanUpdate (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Update-AzVpnSite** aggiorna un sito VPN.
...
Quanto sopra creerà un gruppo di risorse, Virtual WAN in West US nel gruppo di risorse "testRG" in Azure. 

Crea quindi un VpnSite per rappresentare un ramo Customer e lo collega alla rete WAN virtuale.

Dopo aver creato il sito, viene aggiornato l'indirizzo IpAddress del sito tramite il comando Set-AzVpnSite.

## PARAMETRI

### -AddressSpace
I prefissi degli indirizzi della rete virtuale.
Usare questo o AddressSpaceObject ma non entrambi.
...
### -InputObject
Oggetto sito VPN da modificare
...
### -ResourceId
ID risorsa Azure per il sito VPN.
