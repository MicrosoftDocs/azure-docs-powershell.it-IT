...
Questo comando consente di ottenere la WAN virtuale denominata myVirtualWAN nel gruppo di risorse testRG.
...
Questo comando consente di ottenere tutte le WAN virtuali che iniziano con "test".
