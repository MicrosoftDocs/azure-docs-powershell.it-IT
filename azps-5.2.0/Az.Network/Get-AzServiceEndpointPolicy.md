...
## Descrizione
Il cmdlet **Get-AzServiceEndpointPolicy** ottiene un criterio endpoint del servizio.
...
Questo comando consente di ottenere un elenco di tutti i criteri dell'endpoint del servizio che iniziano con "ServiceEndpointPolicy".
...
### -ResourceId
ID del criterio endpoint del servizio.
