...
## Descrizione
Il cmdlet **set-AzExpressRouteCrossConnection** salva la connessione trasversale ExpressRoute modificata in Azure.

## ESEMPI

### Esempio 1: cambiare lo stato di provisioning del provider di servizi di una connessione incrociata ExpressRoute
```
...
Specifica l'oggetto **ExpressRouteCrossConnection** che questo cmdlet modifica.
...
### -Peerings
Elenco dei peer per la connessione trasversale
...
Stato di provisioning del provider di servizi da impostare
