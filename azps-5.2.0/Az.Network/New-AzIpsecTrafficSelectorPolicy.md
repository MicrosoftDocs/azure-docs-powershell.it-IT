...
## Descrizione
Il cmdlet New-AzTrafficSelectorPolicy crea una proposta di criteri di selezione del traffico da usare in una connessione di gateway di rete virtuale.
...
Crea un'istanza di un criterio del selettore del traffico e lo aggiunge come parametro quando si crea una connessione virtuale del gateway di rete con un protocollo IKEv2.
...
### -LocalAddressRange
Una raccolta di intervalli di indirizzi CIDR
