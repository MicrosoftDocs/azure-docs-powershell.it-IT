...
## Descrizione
La risorsa tabella route hub virtuale contiene l'elenco di route e un elenco di connessioni a cui può essere associato e viene usato per instradare il traffico in un hub virtuale.
...
Il comando precedente creerà una risorsa della tabella route hub virtuale dalle route passate e questo oggetto può essere usato per il routing del traffico in un hub virtuale.  

## PARAMETRI

### -Connessione
Elenco delle connessioni a cui è associata la tabella route.
