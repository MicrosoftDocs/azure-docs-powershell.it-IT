...
## Sinossi
Modifica la catena di certificati CA del client attendibile di un gateway dell'applicazione.
...
## Descrizione
Il cmdlet **set-AzApplicationGatewayTrustedClientCertificate** modifica la catena di certificati CA client attendibili di un gateway dell'applicazione.
...
In scenari precedenti viene illustrato come aggiornare un oggetto della catena di certificati CA del client attendibile esistente. Il primo comando ottiene un gateway dell'applicazione e lo archivia nella variabile $gw. Il secondo comando consente di modificare l'oggetto esistente della catena di certificati CA del client attendibile con un nuovo file della catena di certificati CA. Il terzo comando Aggiorna il gateway dell'applicazione in Azure.
