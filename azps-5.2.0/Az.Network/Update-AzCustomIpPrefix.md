...
## Descrizione
Il cmdlet **Update-AzCustomIpPrefix** consente all'utente di commissionare o rimuovere il proprio CustomIpPrefix o modificare i tag della risorsa.

## ESEMPI

### Esempio 1: commissiona il CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

Il comando precedente avvierà il processo di messa in servizio della CustomIpPrefix.

### Esempio 2: rimuovere la CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Decommission
```

Il comando precedente avvierà il processo di disattivazione della CustomIpPrefix.

### Esempio 3: aggiornare i tag per CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Tag $tags
```

Il comando sopra aggiornerà i tag per CustomIpPrefix.
