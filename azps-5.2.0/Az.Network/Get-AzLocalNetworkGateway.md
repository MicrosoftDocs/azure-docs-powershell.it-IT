...
Il cmdlet **Get-AzLocalNetworkGateway** restituisce l'oggetto che rappresenta il Gateway on-Prem in base al nome e al nome del gruppo di risorse.

## ESEMPI

### Esempio 1: ottenere un gateway di rete locale
```powershell
...
Restituisce l'oggetto del gateway di rete locale con il nome "myLocalGW1" nel gruppo di risorse "myRG"

### Esempio 2: ottenere gateway di rete locali tramite filtro
```powershell
...
Restituisce l'oggetto del gateway di rete locale con il nome che inizia con "myLocalGW" nel gruppo di risorse "myRG"
