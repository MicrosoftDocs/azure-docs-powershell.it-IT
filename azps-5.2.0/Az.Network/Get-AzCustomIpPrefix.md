...
## Sinossi
Ottiene una risorsa CustomIpPrefix
...
## Descrizione
Il cmdlet **Get-AzCustomIpPrefix** ottiene uno o più CustomIpPrefixes in base al set di parametri di input
...
Questo comando ottiene una risorsa CustomIpPrefix denominata myCustomIpPrefix nel gruppo di risorse myRg
