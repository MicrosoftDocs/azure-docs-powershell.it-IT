...
## Descrizione
Il cmdlet **Add-AzApplicationGatewayRewriteRuleSet** aggiunge un set di regole di riscrittura a un gateway dell'applicazione.
...
Il secondo comando aggiunge il set di regole di riscrittura al gateway dell'applicazione.
