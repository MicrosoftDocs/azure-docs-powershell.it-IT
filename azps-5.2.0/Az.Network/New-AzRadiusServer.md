...
## Descrizione
Il cmdlet New-AzRadiusServer crea una configurazione del server RADIUS esterna da usare nella configurazione del gateway di rete virtuale e del server VPN.
...
Creazione di più configurazioni di server RADIUS esterni da usare per la configurazione di P2S in un nuovo gateway di rete virtuale.
...
### -RadiusServerAddress
Indirizzo del server RADIUS esterno
...
### -RadiusServerScore
Punteggio del server RADIUS esterno
...
### -RadiusServerSecret
Segreto del server RADIUS esterno
