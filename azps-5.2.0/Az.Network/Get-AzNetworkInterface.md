...
## Descrizione
Il cmdlet **Get-AzNetworkInterface** ottiene un'interfaccia di rete Azure o un elenco di interfacce di rete Azure in un gruppo di risorse.
...
### Esempio 3: ottenere interfacce di rete tramite filtri
```
...
Questo comando consente di ottenere tutte le interfacce di rete per l'abbonamento corrente che iniziano con "test".
...
### -ResourceId
ID di gestione risorse di Azure dell'interfaccia di rete.
