...
## Descrizione
Il cmdlet Get-AzApplicationGatewayBackendHealth Ottiene l'integrità del backend di Application Gateway.
...
### Esempio 2: Ottiene l'integrità del backend con risorse espanse.
```
