...
## Descrizione
Il cmdlet **Get-AzPrivateDnsZoneGroup** ottiene uno o più gruppi di aree DNS privati.

## ESEMPI

### Esempio 1: recuperare il gruppo di aree DNS private
```powershell
...
Sopra l'esempio ottiene un gruppo di aree DNS privato denominato dnsgroup1 nel gruppo di risorse RG.
