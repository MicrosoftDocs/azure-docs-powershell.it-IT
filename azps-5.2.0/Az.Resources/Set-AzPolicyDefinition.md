...
### Esempio 3: aggiornare i metadati di una definizione di criterio
```
...
### -InputObject
Oggetto di definizione dei criteri da aggiornare che è stato restituito da un altro cmdlet.
