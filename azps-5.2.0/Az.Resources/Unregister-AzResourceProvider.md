...
## Descrizione
Il cmdlet **Unregister-AzResourceProvider** Annulla la registrazione di un provider di risorse Azure.

## ESEMPI

### Esempio 1: annullamento della registrazione del provider di risorse con ProviderNamespace
