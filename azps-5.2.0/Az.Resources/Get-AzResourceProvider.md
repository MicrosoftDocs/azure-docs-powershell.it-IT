...
## Descrizione
Il cmdlet **Get-AzResourceProvider** ottiene un provider di risorse Azure.

## ESEMPI

### Esempio 1: ottenere tutti i provider di risorse registrati con l'abbonamento corrente
...
Questo comando consente di ottenere tutti i provider di risorse dall'abbonamento.

### Esempio 2: ottenere tutti i dettagli del provider di risorse dal ProviderNamespace indicato
...
Questo comando consente di ottenere tutti i provider di risorse in "Microsoft. Compute".

### Esempio 3: ottenere tutti i dettagli del provider di risorse dalla matrice ProviderNamespace specificata
...
Questo comando consente di ottenere tutti i provider di risorse in "Microsoft. Compute" e "Microsoft. Network".
