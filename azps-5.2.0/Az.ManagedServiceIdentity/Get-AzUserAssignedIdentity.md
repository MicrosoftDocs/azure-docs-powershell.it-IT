...
## Sinossi
Ottiene l'identità/identità assegnate dall'utente.

## SINTASSI

### SuscriptionParameterSet (impostazione predefinita)
```
...
## Descrizione
**Get-AzUserAssignedIdentity** ottiene le identità assegnate agli utenti esistenti.

## ESEMPI

### Esempio 1
Questo cmdlet di esempio ottiene l'identità assegnata dall'utente con il nome **ID1** nel gruppo di risorse **PSRG**
...
### Esempio 2
Questo cmdlet di esempio ottiene tutte le identità assegnate dall'utente nel gruppo di risorse **PSRG**
...
### Esempio 3
Questo cmdlet di esempio ottiene tutte le identità assegnate dall'utente sotto l'abbonamento.
