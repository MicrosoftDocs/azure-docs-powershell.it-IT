...
## Descrizione
Il cmdlet **Get-AzInvoiceSection** ottiene le sezioni fattura sotto il profilo di fatturazione specificato. 
...
Ottenere tutte le sezioni della fattura sotto il profilo di fatturazione specificato.
...
Ottenere la sezione fattura con il nome specificato.
...
### -BillingProfileName
Nome del profilo di fatturazione specifico.
...
### -Nome
Nome di una specifica sezione fattura.
