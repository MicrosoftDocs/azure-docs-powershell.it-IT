...
Ottenere una configurazione del motore di regole esistente e aggiungere un'altra regola del motore regole.
...
### -InputObject
Oggetto Engine Rules da aggiornare.
...
### -ResourceId
ID risorsa di RulesEngine da aggiornare
