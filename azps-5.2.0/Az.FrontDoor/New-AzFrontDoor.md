...
### ByFieldsWithBackendPoolsSettingParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **New-AzFrontDoor** crea un nuovo bilanciamento del carico di Azure porta anteriore nel gruppo di risorse specificato in abbonamento corrente

## ESEMPI

### Esempio 1: creare uno sportello anteriore in base a determinati parametri.
```powershell
