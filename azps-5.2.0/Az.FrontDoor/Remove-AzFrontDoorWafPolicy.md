...
## Descrizione
Il cmdlet **Remove-AzFrontDoorWafPolicy** rimuove un criterio WAF sotto la sottoscrizione corrente
...
Rimuovere i criteri di WAF denominati $policyName in $resourceGroupName.
...
Rimuovere tutti i criteri di WAF in $resourceGroupName.
...
### -InputObject
Oggetto Criteri WAF da eliminare.
...
### -Nome
Il nome del criterio WAF da eliminare.
...
### -ResourceGroupName
Il gruppo di risorse a cui appartiene il criterio WAF.
...
### -ResourceId
ID risorsa dei criteri di WAF da eliminare
