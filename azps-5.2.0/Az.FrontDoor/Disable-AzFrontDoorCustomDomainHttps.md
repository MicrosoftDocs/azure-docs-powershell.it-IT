...
## Descrizione
Il **Disable-AzFrontDoorCustomDomainHttps Disabilita** HTTPS per un dominio personalizzato.

## ESEMPI

### Esempio 1: disabilitare HTTPS per un dominio personalizzato con FrontDoorName e ResourceGroupName.
```powershell
...
Disabilitare HTTPS per un dominio personalizzato "frontendpointname1-Custom-XYZ" con FrontDoorName come "frontdoor1" e ResourceGroupName come "resourcegroup1".

### Esempio 2: disabilitare HTTPS per un dominio personalizzato con l'oggetto PSFrontendEndpoint.
```powershell
...
Disabilitare HTTPS per un dominio personalizzato con l'oggetto PSFrontendEndpoint.

### Esempio 3: disabilitare HTTPS per un dominio personalizzato con ResourceId.
```powershell
...
Disabilitare HTTPS per un dominio personalizzato "frontendpointname1-Custom-XYZ" con ResourceId come $resourceId.
...
### -ResourceId
ID risorsa dell'endpoint della porta principale per disabilitare https
