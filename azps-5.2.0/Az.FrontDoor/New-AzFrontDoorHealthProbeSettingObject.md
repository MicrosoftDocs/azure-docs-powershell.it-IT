...
Nota: l'impostazione di HealthProbeMethod non è distinzione tra maiuscole e minuscole.
...
### -EnabledState
Se abilitare le sonde di integrità da eseguire con i backend definiti in backendPools. Le sonde di integrità possono essere disabilitate solo se è disponibile un singolo backend abilitato in un unico pool di backend abilitato.
...
### -HealthProbeMethod
Configura il metodo HTTP da usare per sondare i backend definiti in backendPools.
