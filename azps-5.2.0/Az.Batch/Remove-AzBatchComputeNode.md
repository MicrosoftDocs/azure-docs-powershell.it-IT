...
## Descrizione
Il cmdlet **Remove-AzBatchComputeNode** rimuove i nodi compute batch di Azure da un pool.
...
Questo comando ottiene il nodo COMPUTE con l'ID specificato da pool che contiene l'ID Pool07 usando il cmdlet Get-AzBatchComputeNode.
