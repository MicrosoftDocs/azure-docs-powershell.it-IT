...
## Sinossi
Aggiunge un firmatario dei criteri attendibile per un tenant nell'attestazione di Azure.
...
## Descrizione
Il cmdlet Add-AzAttestationPolicySigner aggiunge un firmatario dei criteri attendibile per un tenant nell'attestazione di Azure.
...
### -Firmatario
Specifica il token Web JSON RFC7519 che contiene un'attestazione denominata "Maa-policyCertificate" il cui valore è una chiave Web JSON di RFC7517 che contiene una nuova chiave di firma attendibile da aggiungere.
La JWT RFC7519 deve essere firmata con una delle chiavi di firma attendibili esistenti.
