...
## Sinossi
Ottiene la velocità effettiva di un database di CosmosDB Gremlin.
...
## Descrizione
Il cmdlet **Get-AzCosmosDBGremlinDatabaseThroughput** ottiene la velocità effettiva di un database di CosmosDB Gremlin.
