...
## Descrizione
Rimuovere un account di CosmosDB con un nome specifico nella ResourceGroup specificata.
...
L'account con nome account dbname in ResourceGroup RG viene eliminato. 
