...
Aggiorna il database di CosmosDB Gremlin. Esegue un'operazione di patch lato client leggendo il database esistente.

### [Update-AzCosmosDBGremlinDatabaseThroughput](Update-AzCosmosDBGremlinDatabaseThroughput.md)
Aggiorna il valore di throughput di un database di CosmosDB Gremlin.

### [Update-AzCosmosDBGremlinGraph](Update-AzCosmosDBGremlinGraph.md)
Aggiorna il grafico Gremlin di CosmosDB. Esegue un'operazione di patch lato client leggendo il grafico esistente.

### [Update-AzCosmosDBGremlinGraphThroughput](Update-AzCosmosDBGremlinGraphThroughput.md)
Aggiorna il valore di throughput di un grafico di CosmosDB Gremlin.
...
Aggiorna il valore di velocità effettiva di una raccolta di CosmosDB MongoDB.

### [Update-AzCosmosDBMongoDBDatabase](Update-AzCosmosDBMongoDBDatabase.md)
Aggiorna il database MongoDB di CosmosDB. Esegue un'operazione di patch lato client leggendo il database esistente.

### [Update-AzCosmosDBMongoDBDatabaseThroughput](Update-AzCosmosDBMongoDBDatabaseThroughput.md)
Aggiorna il valore della velocità effettiva di un database MongoDB CosmosDB.

### [Update-AzCosmosDBSqlContainer](Update-AzCosmosDBSqlContainer.md)
Aggiorna il contenitore SQL CosmosDB. Esegue un'operazione di patch lato client leggendo il contenitore esistente.
...
Aggiorna il database SQL di CosmosDB. Esegue un'operazione di patch lato client leggendo il database esistente.

### [Update-AzCosmosDBSqlDatabaseThroughput](Update-AzCosmosDBSqlDatabaseThroughput.md)
Aggiorna il valore della velocità effettiva di un database SQL di CosmosDB.

### [Update-AzCosmosDBSqlStoredProcedure](Update-AzCosmosDBSqlStoredProcedure.md)
Aggiorna il CosmosDB SQL StoredProcedure. Esegue un'operazione di patch lato client leggendo l'esistente StoredProcedure.

### [Update-AzCosmosDBSqlTrigger](Update-AzCosmosDBSqlTrigger.md)
Aggiorna il trigger SQL CosmosDB. Esegue un'operazione di patch lato client leggendo il trigger esistente.

### [Update-AzCosmosDBSqlUserDefinedFunction](Update-AzCosmosDBSqlUserDefinedFunction.md)
Aggiorna il CosmosDB SQL. Consente di eseguire un'operazione di patch lato client leggendo il valore esistente.

### [Update-AzCosmosDBTable](Update-AzCosmosDBTable.md)
Aggiorna la tabella CosmosDB. Esegue un'operazione di patch lato client leggendo la tabella esistente.

### [Update-AzCosmosDBTableThroughput](Update-AzCosmosDBTableThroughput.md)
Aggiorna il valore di velocità effettiva di una tabella CosmosDB.