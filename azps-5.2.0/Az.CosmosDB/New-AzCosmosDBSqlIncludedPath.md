...
## Sinossi
Crea un nuovo oggetto di tipo PSIncludedPath. Può essere passato come valore di parametro per set-AzCosmosDBSqlContainer.
...
## Descrizione
Oggetto che corrisponde al IncludedPath dell'API SQL.
