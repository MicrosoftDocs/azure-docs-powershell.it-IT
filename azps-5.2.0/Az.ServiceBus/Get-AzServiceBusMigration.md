...
## Descrizione
**Get-AzServiceBusMigration** recupera la configurazione di migrazione per lo spazio dei nomi
...
Ottiene le proprietà di configurazione della migrazione di "TestingNamespaceStandardMigration"
