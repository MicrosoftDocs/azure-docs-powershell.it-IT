...
## Descrizione
Il cmdlet **New-AzServiceBusGeoDRConfiguration** crea un nuovo alias (configurazione del ripristino di emergenza)
...
### -PartnerNamespace
DR Configuration PartnerNamespace (ARM ID di PartnerNamespace [namespace secondario])
