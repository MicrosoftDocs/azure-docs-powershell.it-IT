...
Restituisce l'elenco delle code per lo spazio dei nomi specificato, per impostazione predefinita verranno restituite le code di 100, se vengono restituite più di 100 code, usare il parametro-MaxCount.
