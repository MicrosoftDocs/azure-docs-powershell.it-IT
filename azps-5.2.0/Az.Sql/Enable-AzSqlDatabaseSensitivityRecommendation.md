...
## Descrizione
Il cmdlet Enable-AzSqlDatabaseSensitivityRecommendation consente di abilitare i consigli di sensitività sulle colonne del database.

## ESEMPI

### Esempio 1: abilitare i consigli di sensitività per una determinata colonna in un database SQL di Azure.
```powershell
...
### Esempio 2: abilitare i suggerimenti per la sensitività in un database SQL di Column Azure specifico tramite piping.
```powershell
