...
## Descrizione
Il cmdlet **Get-AzSqlDatabase** ottiene uno o più database SQL di Azure da un server di database SQL di Azure.
...
Questo comando consente di ottenere tutti i database nel server denominato Server01.

### Esempio 2: ottenere un database per nome in un server
```
...
Questo comando consente di ottenere un database denominato Database02 da un server denominato Server01.

### Esempio 3: ottenere tutti i database in un server tramite filtro
```
...
Questo comando consente di ottenere tutti i database nel server di nome Server01 che iniziano con "database".
