...
Ottiene tutti i backup di conservazione a lungo termine per un determinato database.  Il gruppo di risorse è facoltativo. 
...
### -DatabaseName
Nome del database gestito in cui si trovano i backup.
...
### -InstanceName
Nome dell'istanza gestita in cui si trovano i backup.
