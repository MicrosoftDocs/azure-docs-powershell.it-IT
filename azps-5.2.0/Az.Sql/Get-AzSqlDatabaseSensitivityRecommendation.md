...
## Descrizione
Il cmdlet Get-AzSqlDatabaseSensitivityRecommendation restituisce i tipi di informazioni e le etichette di sensitività consigliati delle colonne nel database.

## ESEMPI

### Esempio 1: ottenere i tipi di informazioni e le etichette di sensitività consigliati di un database SQL di Azure.
```powershell
...
### Esempio 2: ottenere i tipi di informazioni e le etichette di sensitività consigliati di un database SQL di Azure tramite piping.
```powershell
