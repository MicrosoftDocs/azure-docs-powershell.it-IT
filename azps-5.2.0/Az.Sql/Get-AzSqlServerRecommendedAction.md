...
## Descrizione
Il cmdlet **Get-AzSqlServerRecommendedAction** consente di ottenere una o più azioni consigliate per un programma di gestione di SQL Server di Azure.

## ESEMPI

### Esempio 1: ottenere un elenco di tutte le azioni consigliate per un consulente specifico
```
...
Questo comando consente di ottenere un elenco di tutte le azioni consigliate per SQL Server Advisor denominato CreateIndex disponibile per il server denominato Wi-Runner-Australia-Est.
...
### -Advisorname
Specifica il nome del consulente per il quale questo cmdlet richiede le azioni.
...
### -Nomeserver
Specifica il nome del server a cui appartiene Advisor.
...
## Note
* Parole chiave: Azure, azurerm, ARM, Resource, Management, Manager, SQL, server, MSSQL, Advisor, RecommendedAction
