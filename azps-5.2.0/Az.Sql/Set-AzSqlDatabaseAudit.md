...
### Esempio 3: abilitare i criteri di controllo dello spazio di archiviazione BLOB di un database SQL di Azure con filtro avanzato usando un predicato T-SQL
```powershell
...
### Esempio 4: rimuovere l'impostazione di filtro avanzato dai criteri di controllo di un database SQL di Azure
```powershell
...
### Esempio 5: abilitare i criteri di controllo Hub eventi di un database SQL di Azure
```powershell
...
### Esempio 6: disabilitare i criteri di controllo Hub eventi di un database SQL di Azure
```powershell
...
### Esempio 7: abilitare i criteri di controllo del log Analytics di un database SQL di Azure
```powershell
...
### Esempio 8: disabilitare i criteri di controllo del log Analytics di un database SQL di Azure
```powershell
...
### Esempio 9: disabilitare, tramite pipeline, i criteri di controllo di analisi del log di un database SQL di Azure
```powershell
...
### Esempio 10: disabilitare l'invio dei record di controllo di un database SQL di Azure allo spazio di archiviazione BLOB e consentire l'invio di un log di analisi.
```powershell
...
### Esempio 11: consentire l'invio di record di controllo di un database SQL di Azure a archiviazione BLOB, Hub eventi e analisi log.
```powershell
