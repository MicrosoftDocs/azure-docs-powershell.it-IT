...
## Descrizione
Il cmdlet **New-AzSqlInstancePool** crea un pool di istanze SQL di Azure.
...
Questo comando crea un nuovo pool di istanze di Azure SQL.
...
### -ComputeGeneration
Generazione di COMPUTE per il pool di istanze.
...
### -Edition
L'edizione per il pool di istanze.
...
### -Posizione
La posizione per creare il pool di istanze.
...
### -SubnetId
ID subnet da usare per la creazione di pool di istanze.
