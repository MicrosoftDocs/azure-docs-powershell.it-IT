...
## Descrizione
Il cmdlet Remove-AzSqlElasticJobTarget consente di rimuovere una risorsa di destinazione in un gruppo di destinazione
...
### Esempio 2: rimuovere una destinazione del database
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Esempio 3: rimuovere una destinazione del pool elastico
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Esempio 4: rimuovere una destinazione della mappa Shard
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Rimuove una destinazione (server, pool elastico, database e mappa di coccio) da un gruppo di destinazione

## PARAMETRI

### -AgentName
Nome agente database SQL.
...
### -AgentServerName
Nome del server agente database SQL.
