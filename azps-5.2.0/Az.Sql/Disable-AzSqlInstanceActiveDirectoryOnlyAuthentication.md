...
## Descrizione
Il cmdlet **Disable-AzSqlInstanceActiveDirectoryOnlyAuthentication Disabilita** il requisito di autenticazione di Azure Active Directory (Azure ad) solo per un'istanza gestita di AzureSQL nell'abbonamento corrente.
...
Questo comando Disabilita Azure Active Directory (Azure AD) solo il requisito di autenticazione per un'istanza gestita AzureSQL denominata ManagedInstance01 associata a un gruppo di risorse denominato ResourceGroup01.
...
### -InstanceName
Nome dell'istanza gestita di Azure SQL in cui è attiva solo l'autenticazione di Azure Active Directory.
