...
## Descrizione
Il cmdlet **Get-AzSqlSyncMember** restituisce informazioni su uno o più membri della sincronizzazione di database SQL di Azure.
Specificare il nome di un membro di sincronizzazione per visualizzare le informazioni solo per il membro di sincronizzazione.

## ESEMPI

### Esempio 1: ottenere tutte le istanze del membro di sincronizzazione di Azure SQL assegnato a un gruppo di sincronizzazione
```
...
Questo comando consente di ottenere informazioni su tutto il membro di sincronizzazione del database SQL di Azure assegnato al gruppo di sincronizzazione SyncGroup01.

### Esempio 2: ottenere informazioni su un membro di sincronizzazione di database SQL di Azure
```
...
Questo comando ottiene le informazioni sul membro di sincronizzazione di database SQL di Azure con il nome "SyncMember01"

### Esempio 3: ottenere tutte le istanze del membro di sincronizzazione di Azure SQL assegnate a un gruppo di sincronizzazione tramite filtro
```
...
Questo comando consente di ottenere informazioni su tutto il membro di sincronizzazione di database SQL di Azure assegnato al gruppo di sincronizzazione SyncGroup01 che inizia con "SyncMember".
