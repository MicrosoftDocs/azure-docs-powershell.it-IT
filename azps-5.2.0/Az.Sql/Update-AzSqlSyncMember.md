...
## Descrizione
Il cmdlet **Update-AzSqlSyncGroup** modifica le proprietà di un membro di sincronizzazione di database SQL di Azure.
...
Questo comando Reimposta la password di amministratore per il database dei membri.
...
ID risorsa per il database del membro di sincronizzazione, usato se UsePrivateLinkConnection è impostato su true.
...
Se usare il collegamento privato quando si esegue la connessione a questo membro di sincronizzazione.
