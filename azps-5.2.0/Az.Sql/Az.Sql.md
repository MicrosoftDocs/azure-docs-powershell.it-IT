...
### [<span data-ttu-id="61d64-111">Add-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="61d64-111">Add-AzSqlInstanceKeyVaultKey</span></span>](Add-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="61d64-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-123">Clear-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Clear-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="61d64-135">Completamento-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="61d64-135">Complete-AzSqlInstanceDatabaseLogReplay</span></span>](Complete-AzSqlInstanceDatabaseLogReplay.md)
...
### [<span data-ttu-id="61d64-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="61d64-147">Disable-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Disable-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="61d64-159">Enable-AzSqlInstanceAdvancedDataSecurity</span><span class="sxs-lookup"><span data-stu-id="61d64-159">Enable-AzSqlInstanceAdvancedDataSecurity</span></span>](Enable-AzSqlInstanceAdvancedDataSecurity.md)
...
### [<span data-ttu-id="61d64-171">Get-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="61d64-171">Get-AzSqlDatabase</span></span>](Get-AzSqlDatabase.md)
...
### [<span data-ttu-id="61d64-185">Get-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-185">Get-AzSqlDatabaseDataMaskingPolicy</span></span>](Get-AzSqlDatabaseDataMaskingPolicy.md)
...
### [<span data-ttu-id="61d64-199">Get-AzSqlDatabaseIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="61d64-199">Get-AzSqlDatabaseIndexRecommendation</span></span>](Get-AzSqlDatabaseIndexRecommendation.md)
...
### [<span data-ttu-id="61d64-213">Get-AzSqlDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="61d64-213">Get-AzSqlDatabaseSensitivityRecommendation</span></span>](Get-AzSqlDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="61d64-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-225">Get-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
...
### [<span data-ttu-id="61d64-239">Get-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="61d64-239">Get-AzSqlElasticJobStep</span></span>](Get-AzSqlElasticJobStep.md)
...
### [<span data-ttu-id="61d64-253">Get-AzSqlElasticPoolDatabase</span><span class="sxs-lookup"><span data-stu-id="61d64-253">Get-AzSqlElasticPoolDatabase</span></span>](Get-AzSqlElasticPoolDatabase.md)
...
### [<span data-ttu-id="61d64-267">Get-AzSqlInstanceDatabase</span><span class="sxs-lookup"><span data-stu-id="61d64-267">Get-AzSqlInstanceDatabase</span></span>](Get-AzSqlInstanceDatabase.md)
...
### [<span data-ttu-id="61d64-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span><span class="sxs-lookup"><span data-stu-id="61d64-281">Get-AzSqlInstanceDatabaseSensitivityRecommendation</span></span>](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
...
### [<span data-ttu-id="61d64-293">Get-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="61d64-293">Get-AzSqlInstancePool</span></span>](Get-AzSqlInstancePool.md)
...
### [<span data-ttu-id="61d64-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span><span class="sxs-lookup"><span data-stu-id="61d64-305">Get-AzSqlServerActiveDirectoryOnlyAuthentication</span></span>](Get-AzSqlServerActiveDirectoryOnlyAuthentication.md)
...
### [<span data-ttu-id="61d64-317">Get-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="61d64-317">Get-AzSqlServerDisasterRecoveryConfiguration</span></span>](Get-AzSqlServerDisasterRecoveryConfiguration.md)
...
### [<span data-ttu-id="61d64-331">Get-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="61d64-331">Get-AzSqlServerTransparentDataEncryptionProtector</span></span>](Get-AzSqlServerTransparentDataEncryptionProtector.md)
...
### [<span data-ttu-id="61d64-345">Get-AzSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="61d64-345">Get-AzSqlSyncGroupLog</span></span>](Get-AzSqlSyncGroupLog.md)
...
### [<span data-ttu-id="61d64-359">New-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="61d64-359">New-AzSqlDatabase</span></span>](New-AzSqlDatabase.md)
...
### [<span data-ttu-id="61d64-373">New-AzSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="61d64-373">New-AzSqlDatabaseRestorePoint</span></span>](New-AzSqlDatabaseRestorePoint.md)
...
### [<span data-ttu-id="61d64-387">New-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="61d64-387">New-AzSqlInstance</span></span>](New-AzSqlInstance.md)
...
### [<span data-ttu-id="61d64-401">New-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="61d64-401">New-AzSqlServerFirewallRule</span></span>](New-AzSqlServerFirewallRule.md)
...
### [<span data-ttu-id="61d64-415">Remove-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="61d64-415">Remove-AzSqlDatabaseAudit</span></span>](Remove-AzSqlDatabaseAudit.md)
...
### [<span data-ttu-id="61d64-429">Remove-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="61d64-429">Remove-AzSqlDatabaseSecondary</span></span>](Remove-AzSqlDatabaseSecondary.md)
...
### [<span data-ttu-id="61d64-443">Remove-AzSqlElasticJobTargetGroup</span><span class="sxs-lookup"><span data-stu-id="61d64-443">Remove-AzSqlElasticJobTargetGroup</span></span>](Remove-AzSqlElasticJobTargetGroup.md)
...
### [<span data-ttu-id="61d64-457">Remove-AzSqlInstanceKeyVaultKey</span><span class="sxs-lookup"><span data-stu-id="61d64-457">Remove-AzSqlInstanceKeyVaultKey</span></span>](Remove-AzSqlInstanceKeyVaultKey.md)
...
### [<span data-ttu-id="61d64-471">Remove-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="61d64-471">Remove-AzSqlServerDnsAlias</span></span>](Remove-AzSqlServerDnsAlias.md)
...
### [<span data-ttu-id="61d64-485">Remove-AzSqlVirtualCluster</span><span class="sxs-lookup"><span data-stu-id="61d64-485">Remove-AzSqlVirtualCluster</span></span>](Remove-AzSqlVirtualCluster.md)
...
<span data-ttu-id="61d64-496">Modifica lo stato di esecuzione automatica di un consulente di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-496">Modifies auto execute status of an Azure SQL Database Advisor.</span></span>

### [<span data-ttu-id="61d64-497">Set-AzSqlDatabaseAudit</span><span class="sxs-lookup"><span data-stu-id="61d64-497">Set-AzSqlDatabaseAudit</span></span>](Set-AzSqlDatabaseAudit.md)
<span data-ttu-id="61d64-498">Modifica le impostazioni di controllo per un database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-498">Changes the auditing settings for an Azure SQL database.</span></span>

### [<span data-ttu-id="61d64-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-499">Set-AzSqlDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="61d64-500">Imposta i criteri di conservazione a lungo termine del server.</span><span class="sxs-lookup"><span data-stu-id="61d64-500">Sets a server long term retention policy.</span></span>

### [<span data-ttu-id="61d64-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-501">Set-AzSqlDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="61d64-502">Imposta un criterio di conservazione a breve termine per il backup.</span><span class="sxs-lookup"><span data-stu-id="61d64-502">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="61d64-503">Set-AzSqlDatabaseDataMaskingPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-503">Set-AzSqlDatabaseDataMaskingPolicy</span></span>](Set-AzSqlDatabaseDataMaskingPolicy.md)
<span data-ttu-id="61d64-504">Imposta la mascheratura dei dati per un database.</span><span class="sxs-lookup"><span data-stu-id="61d64-504">Sets data masking for a database.</span></span>

### [<span data-ttu-id="61d64-505">Set-AzSqlDatabaseDataMaskingRule</span><span class="sxs-lookup"><span data-stu-id="61d64-505">Set-AzSqlDatabaseDataMaskingRule</span></span>](Set-AzSqlDatabaseDataMaskingRule.md)
<span data-ttu-id="61d64-506">Imposta le proprietà di una regola di mascheramento dei dati per un database.</span><span class="sxs-lookup"><span data-stu-id="61d64-506">Sets the properties of a data masking rule for a database.</span></span>

### [<span data-ttu-id="61d64-507">Set-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="61d64-507">Set-AzSqlDatabaseFailoverGroup</span></span>](Set-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="61d64-508">Modifica la configurazione di un gruppo di failover di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-508">Modifies the configuration of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="61d64-509">Set-AzSqlDatabaseGeoBackupPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-509">Set-AzSqlDatabaseGeoBackupPolicy</span></span>](Set-AzSqlDatabaseGeoBackupPolicy.md)
<span data-ttu-id="61d64-510">Imposta un criterio di Geo backup del database.</span><span class="sxs-lookup"><span data-stu-id="61d64-510">Sets a database geo backup policy.</span></span>

### [<span data-ttu-id="61d64-511">Set-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="61d64-511">Set-AzSqlDatabaseInstanceFailoverGroup</span></span>](Set-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="61d64-512">Modifica la configurazione di un gruppo di failover delle istanze.</span><span class="sxs-lookup"><span data-stu-id="61d64-512">Modifies the configuration of an Instance Failover Group.</span></span>

### [<span data-ttu-id="61d64-513">Set-AzSqlDatabaseRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="61d64-513">Set-AzSqlDatabaseRecommendedActionState</span></span>](Set-AzSqlDatabaseRecommendedActionState.md)
<span data-ttu-id="61d64-514">Aggiorna lo stato di un'azione consigliata per il database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-514">Updates the state of an Azure SQL Database recommended action.</span></span>

### [<span data-ttu-id="61d64-515">Set-AzSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="61d64-515">Set-AzSqlDatabaseSecondary</span></span>](Set-AzSqlDatabaseSecondary.md)
<span data-ttu-id="61d64-516">Commuta un database secondario come primario per avviare il failover.</span><span class="sxs-lookup"><span data-stu-id="61d64-516">Switches a secondary database to be primary in order to initiate failover.</span></span>

### [<span data-ttu-id="61d64-517">Set-AzSqlDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="61d64-517">Set-AzSqlDatabaseSensitivityClassification</span></span>](Set-AzSqlDatabaseSensitivityClassification.md)
<span data-ttu-id="61d64-518">Imposta i tipi di informazioni e le etichette di sensitività delle colonne nel database.</span><span class="sxs-lookup"><span data-stu-id="61d64-518">Sets the information types and sensitivity labels of columns in the database.</span></span>

### [<span data-ttu-id="61d64-519">Set-AzSqlDatabaseTransparentDataEncryption</span><span class="sxs-lookup"><span data-stu-id="61d64-519">Set-AzSqlDatabaseTransparentDataEncryption</span></span>](Set-AzSqlDatabaseTransparentDataEncryption.md)
<span data-ttu-id="61d64-520">Modifica la proprietà transparent per un database.</span><span class="sxs-lookup"><span data-stu-id="61d64-520">Modifies TDE property for a database.</span></span>

### [<span data-ttu-id="61d64-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="61d64-521">Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="61d64-522">Imposta la previsione della regola di valutazione della vulnerabilità.</span><span class="sxs-lookup"><span data-stu-id="61d64-522">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="61d64-523">Set-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="61d64-523">Set-AzSqlElasticJob</span></span>](Set-AzSqlElasticJob.md)
<span data-ttu-id="61d64-524">Aggiorna un processo</span><span class="sxs-lookup"><span data-stu-id="61d64-524">Updates a job</span></span>

### [<span data-ttu-id="61d64-525">Set-AzSqlElasticJobAgent</span><span class="sxs-lookup"><span data-stu-id="61d64-525">Set-AzSqlElasticJobAgent</span></span>](Set-AzSqlElasticJobAgent.md)
<span data-ttu-id="61d64-526">Aggiorna un agente del processo elastico</span><span class="sxs-lookup"><span data-stu-id="61d64-526">Updates an elastic job agent</span></span>

### [<span data-ttu-id="61d64-527">Set-AzSqlElasticJobCredential</span><span class="sxs-lookup"><span data-stu-id="61d64-527">Set-AzSqlElasticJobCredential</span></span>](Set-AzSqlElasticJobCredential.md)
<span data-ttu-id="61d64-528">Aggiorna le credenziali di un processo</span><span class="sxs-lookup"><span data-stu-id="61d64-528">Updates a job credential</span></span>

### [<span data-ttu-id="61d64-529">Set-AzSqlElasticJobStep</span><span class="sxs-lookup"><span data-stu-id="61d64-529">Set-AzSqlElasticJobStep</span></span>](Set-AzSqlElasticJobStep.md)
<span data-ttu-id="61d64-530">Aggiorna un passaggio di processo</span><span class="sxs-lookup"><span data-stu-id="61d64-530">Updates a job step</span></span>

### [<span data-ttu-id="61d64-531">Set-AzSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="61d64-531">Set-AzSqlElasticPool</span></span>](Set-AzSqlElasticPool.md)
<span data-ttu-id="61d64-532">Modifica le proprietà di un pool di database elastici in Azure SQL database.</span><span class="sxs-lookup"><span data-stu-id="61d64-532">Modifies properties of an elastic database pool in Azure SQL Database.</span></span>

### [<span data-ttu-id="61d64-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="61d64-533">Set-AzSqlElasticPoolAdvisorAutoExecuteStatus</span></span>](Set-AzSqlElasticPoolAdvisorAutoExecuteStatus.md)
<span data-ttu-id="61d64-534">Aggiorna lo stato di esecuzione automatica di un Advisor di Azure SQL Elastic pool.</span><span class="sxs-lookup"><span data-stu-id="61d64-534">Updates auto execute status of an Azure SQL Elastic Pool Advisor.</span></span>

### [<span data-ttu-id="61d64-535">Set-AzSqlElasticPoolRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="61d64-535">Set-AzSqlElasticPoolRecommendedActionState</span></span>](Set-AzSqlElasticPoolRecommendedActionState.md)
<span data-ttu-id="61d64-536">Aggiorna lo stato di un'azione consigliata di Azure SQL Elastic pool.</span><span class="sxs-lookup"><span data-stu-id="61d64-536">Updates the state of an Azure SQL Elastic Pool recommended action.</span></span>

### [<span data-ttu-id="61d64-537">Set-AzSqlInstance</span><span class="sxs-lookup"><span data-stu-id="61d64-537">Set-AzSqlInstance</span></span>](Set-AzSqlInstance.md)
<span data-ttu-id="61d64-538">Imposta le proprietà per un'istanza gestita di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-538">Sets properties for an Azure SQL Database Managed Instance.</span></span>

### [<span data-ttu-id="61d64-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="61d64-539">Set-AzSqlInstanceActiveDirectoryAdministrator</span></span>](Set-AzSqlInstanceActiveDirectoryAdministrator.md)
<span data-ttu-id="61d64-540">Viene previsto un amministratore di Azure AD per l'istanza gestita da SQL.</span><span class="sxs-lookup"><span data-stu-id="61d64-540">Provisions an Azure AD administrator for SQL Managed Instance.</span></span>

### [<span data-ttu-id="61d64-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-541">Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupLongTermRetentionPolicy.md)
<span data-ttu-id="61d64-542">Il cmdlet **set-AzSqlInstanceDatabaseLongTermRetentionBackup** imposta i criteri di conservazione a lungo termine di un database gestito.</span><span class="sxs-lookup"><span data-stu-id="61d64-542">The **Set-AzSqlInstanceDatabaseLongTermRetentionBackup** cmdlet sets a managed database's long term retention policy.</span></span>

### [<span data-ttu-id="61d64-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span><span class="sxs-lookup"><span data-stu-id="61d64-543">Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy</span></span>](Set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy.md)
<span data-ttu-id="61d64-544">Imposta un criterio di conservazione a breve termine per il backup.</span><span class="sxs-lookup"><span data-stu-id="61d64-544">Sets a backup short term retention policy.</span></span>

### [<span data-ttu-id="61d64-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span><span class="sxs-lookup"><span data-stu-id="61d64-545">Set-AzSqlInstanceDatabaseSensitivityClassification</span></span>](Set-AzSqlInstanceDatabaseSensitivityClassification.md)
<span data-ttu-id="61d64-546">Imposta i tipi di informazioni e le etichette di sensitività delle colonne nel database di istanze gestite di Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="61d64-546">Sets the information types and sensitivity labels of columns in the Azure SQL managed instance database.</span></span>

### [<span data-ttu-id="61d64-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="61d64-547">Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline</span></span>](Set-AzSqlInstanceDatabaseVulnerabilityAssessmentRuleBaseline.md)
<span data-ttu-id="61d64-548">Imposta la previsione della regola di valutazione della vulnerabilità.</span><span class="sxs-lookup"><span data-stu-id="61d64-548">Sets the vulnerability assessment rule baseline.</span></span>

### [<span data-ttu-id="61d64-549">Set-AzSqlInstancePool</span><span class="sxs-lookup"><span data-stu-id="61d64-549">Set-AzSqlInstancePool</span></span>](Set-AzSqlInstancePool.md)
<span data-ttu-id="61d64-550">Imposta le proprietà per un pool di istanze di Azure SQL.</span><span class="sxs-lookup"><span data-stu-id="61d64-550">Sets properties for an Azure SQL Instance pool.</span></span>

### [<span data-ttu-id="61d64-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="61d64-551">Set-AzSqlInstanceTransparentDataEncryptionProtector</span></span>](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
<span data-ttu-id="61d64-552">Imposta la protezione di crittografia dati trasparente (Transparent Data Encryption) per un'istanza gestita da SQL.</span><span class="sxs-lookup"><span data-stu-id="61d64-552">Sets the Transparent Data Encryption (TDE) protector for a SQL managed instance.</span></span>

### [<span data-ttu-id="61d64-553">Set-AzSqlServer</span><span class="sxs-lookup"><span data-stu-id="61d64-553">Set-AzSqlServer</span></span>](Set-AzSqlServer.md)
<span data-ttu-id="61d64-554">Modifica le proprietà di un server di database SQL.</span><span class="sxs-lookup"><span data-stu-id="61d64-554">Modifies properties of a SQL Database server.</span></span>

### [<span data-ttu-id="61d64-555">Set-AzSqlServerActiveDirectoryAdministrator</span><span class="sxs-lookup"><span data-stu-id="61d64-555">Set-AzSqlServerActiveDirectoryAdministrator</span></span>](Set-AzSqlServerActiveDirectoryAdministrator.md)
<span data-ttu-id="61d64-556">Viene previsto un amministratore di Azure AD per SQL Server.</span><span class="sxs-lookup"><span data-stu-id="61d64-556">Provisions an Azure AD administrator for SQL Server.</span></span>

### [<span data-ttu-id="61d64-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span><span class="sxs-lookup"><span data-stu-id="61d64-557">Set-AzSqlServerAdvisorAutoExecuteStatus</span></span>](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
<span data-ttu-id="61d64-558">Aggiorna lo stato di esecuzione automatica di un consulente di Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="61d64-558">Updates the auto execute status of an Azure SQL Server Advisor.</span></span>

### [<span data-ttu-id="61d64-559">Set-AzSqlServerAudit</span><span class="sxs-lookup"><span data-stu-id="61d64-559">Set-AzSqlServerAudit</span></span>](Set-AzSqlServerAudit.md)
<span data-ttu-id="61d64-560">Modifica le impostazioni di controllo di un server SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-560">Changes the auditing settings of an Azure SQL server.</span></span>

### [<span data-ttu-id="61d64-561">Set-AzSqlServerDisasterRecoveryConfiguration</span><span class="sxs-lookup"><span data-stu-id="61d64-561">Set-AzSqlServerDisasterRecoveryConfiguration</span></span>](Set-AzSqlServerDisasterRecoveryConfiguration.md)
<span data-ttu-id="61d64-562">Modifica una configurazione di ripristino del server di database.</span><span class="sxs-lookup"><span data-stu-id="61d64-562">Modifies a database server recovery configuration.</span></span>

### [<span data-ttu-id="61d64-563">Set-AzSqlServerDnsAlias</span><span class="sxs-lookup"><span data-stu-id="61d64-563">Set-AzSqlServerDnsAlias</span></span>](Set-AzSqlServerDnsAlias.md)
<span data-ttu-id="61d64-564">Modifica il server in cui punta l'alias di Azure SQL Server DNS</span><span class="sxs-lookup"><span data-stu-id="61d64-564">Modifies the server to which Azure SQL Server DNS Alias is pointing</span></span>

### [<span data-ttu-id="61d64-565">Set-AzSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="61d64-565">Set-AzSqlServerFirewallRule</span></span>](Set-AzSqlServerFirewallRule.md)
<span data-ttu-id="61d64-566">Modifica una regola del firewall nel server di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-566">Modifies a firewall rule in Azure SQL Database server.</span></span>

### [<span data-ttu-id="61d64-567">Set-AzSqlServerRecommendedActionState</span><span class="sxs-lookup"><span data-stu-id="61d64-567">Set-AzSqlServerRecommendedActionState</span></span>](Set-AzSqlServerRecommendedActionState.md)
<span data-ttu-id="61d64-568">Aggiorna lo stato di un'azione consigliata di Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="61d64-568">Updates the state of an Azure SQL Server recommended action.</span></span>

### [<span data-ttu-id="61d64-569">Set-AzSqlServerTransparentDataEncryptionProtector</span><span class="sxs-lookup"><span data-stu-id="61d64-569">Set-AzSqlServerTransparentDataEncryptionProtector</span></span>](Set-AzSqlServerTransparentDataEncryptionProtector.md)
<span data-ttu-id="61d64-570">Imposta la protezione per la crittografia dei dati trasparente (Transparent Data Encryption) per un server SQL.</span><span class="sxs-lookup"><span data-stu-id="61d64-570">Sets the Transparent Data Encryption (TDE) protector for a SQL server.</span></span>

### [<span data-ttu-id="61d64-571">Set-AzSqlServerVirtualNetworkRule</span><span class="sxs-lookup"><span data-stu-id="61d64-571">Set-AzSqlServerVirtualNetworkRule</span></span>](Set-AzSqlServerVirtualNetworkRule.md)
<span data-ttu-id="61d64-572">Modifica la configurazione di una regola di rete virtuale di Azure SQL Server.</span><span class="sxs-lookup"><span data-stu-id="61d64-572">Modifies the configuration of an Azure SQL Server Virtual Network Rule.</span></span>

### [<span data-ttu-id="61d64-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="61d64-573">Start-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="61d64-574">Avvia il flusso di lavoro che esegue un'operazione di indice consigliata.</span><span class="sxs-lookup"><span data-stu-id="61d64-574">Starts the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="61d64-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="61d64-575">Start-AzSqlDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="61d64-576">Avvia un'analisi di valutazione della vulnerabilità.</span><span class="sxs-lookup"><span data-stu-id="61d64-576">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="61d64-577">Start-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="61d64-577">Start-AzSqlElasticJob</span></span>](Start-AzSqlElasticJob.md)
<span data-ttu-id="61d64-578">Avvia un processo, restituendo un ID di esecuzione del processo di cui è possibile eseguire il polling per visualizzarne lo stato</span><span class="sxs-lookup"><span data-stu-id="61d64-578">Starts a job, returning a job execution id that can be polled to view it's status</span></span>

### [<span data-ttu-id="61d64-579">Start-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="61d64-579">Start-AzSqlInstanceDatabaseLogReplay</span></span>](Start-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="61d64-580">Avvia un servizio di riproduzione del log con i parametri specificati.</span><span class="sxs-lookup"><span data-stu-id="61d64-580">Starts a Log Replay service with the given parameters.</span></span>

### [<span data-ttu-id="61d64-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="61d64-581">Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan</span></span>](Start-AzSqlInstanceDatabaseVulnerabilityAssessmentScan.md)
<span data-ttu-id="61d64-582">Avvia un'analisi di valutazione della vulnerabilità.</span><span class="sxs-lookup"><span data-stu-id="61d64-582">Starts a vulnerability assessment scan.</span></span>

### [<span data-ttu-id="61d64-583">Start-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="61d64-583">Start-AzSqlSyncGroupSync</span></span>](Start-AzSqlSyncGroupSync.md)
<span data-ttu-id="61d64-584">Avvia la sincronizzazione di un gruppo di sincronizzazione.</span><span class="sxs-lookup"><span data-stu-id="61d64-584">Starts a sync group synchronization.</span></span>

### [<span data-ttu-id="61d64-585">Stop-AzSqlDatabaseActivity</span><span class="sxs-lookup"><span data-stu-id="61d64-585">Stop-AzSqlDatabaseActivity</span></span>](Stop-AzSqlDatabaseActivity.md)
<span data-ttu-id="61d64-586">Annulla l'operazione di aggiornamento asincrono nel database.</span><span class="sxs-lookup"><span data-stu-id="61d64-586">Cancels the asynchronous updates operation on the database.</span></span>

### [<span data-ttu-id="61d64-587">Stop-AzSqlDatabaseExecuteIndexRecommendation</span><span class="sxs-lookup"><span data-stu-id="61d64-587">Stop-AzSqlDatabaseExecuteIndexRecommendation</span></span>](Stop-AzSqlDatabaseExecuteIndexRecommendation.md)
<span data-ttu-id="61d64-588">Interrompe il flusso di lavoro che esegue un'operazione di indice consigliata.</span><span class="sxs-lookup"><span data-stu-id="61d64-588">Stops the workflow that runs a recommended index operation.</span></span>

### [<span data-ttu-id="61d64-589">Stop-AzSqlElasticJob</span><span class="sxs-lookup"><span data-stu-id="61d64-589">Stop-AzSqlElasticJob</span></span>](Stop-AzSqlElasticJob.md)
<span data-ttu-id="61d64-590">Arresta un processo in base all'ID esecuzione del processo</span><span class="sxs-lookup"><span data-stu-id="61d64-590">Stops a job given it's job execution id</span></span>

### [<span data-ttu-id="61d64-591">Stop-AzSqlElasticPoolActivity</span><span class="sxs-lookup"><span data-stu-id="61d64-591">Stop-AzSqlElasticPoolActivity</span></span>](Stop-AzSqlElasticPoolActivity.md)
<span data-ttu-id="61d64-592">Annulla l'operazione di aggiornamento asincrono in un pool elastico.</span><span class="sxs-lookup"><span data-stu-id="61d64-592">Cancels the asynchronous update operation on an elastic pool.</span></span>

### [<span data-ttu-id="61d64-593">Stop-AzSqlInstanceDatabaseLogReplay</span><span class="sxs-lookup"><span data-stu-id="61d64-593">Stop-AzSqlInstanceDatabaseLogReplay</span></span>](Stop-AzSqlInstanceDatabaseLogReplay.md)
<span data-ttu-id="61d64-594">Annulla il servizio di riproduzione del log eliminando il database.</span><span class="sxs-lookup"><span data-stu-id="61d64-594">Cancels the Log Replay service by dropping the database.</span></span>

### [<span data-ttu-id="61d64-595">Stop-AzSqlInstanceOperation</span><span class="sxs-lookup"><span data-stu-id="61d64-595">Stop-AzSqlInstanceOperation</span></span>](Stop-AzSqlInstanceOperation.md)
<span data-ttu-id="61d64-596">Interrompe le operazioni di un'istanza di SQL Managed.</span><span class="sxs-lookup"><span data-stu-id="61d64-596">Stops a SQL managed instance's operations.</span></span>

### [<span data-ttu-id="61d64-597">Stop-AzSqlSyncGroupSync</span><span class="sxs-lookup"><span data-stu-id="61d64-597">Stop-AzSqlSyncGroupSync</span></span>](Stop-AzSqlSyncGroupSync.md)
<span data-ttu-id="61d64-598">Interrompe la sincronizzazione di un gruppo di sincronizzazione.</span><span class="sxs-lookup"><span data-stu-id="61d64-598">Stops a sync group synchronization.</span></span>

### [<span data-ttu-id="61d64-599">Suspend-AzSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="61d64-599">Suspend-AzSqlDatabase</span></span>](Suspend-AzSqlDatabase.md)
<span data-ttu-id="61d64-600">Sospende un database di SQL data warehouse.</span><span class="sxs-lookup"><span data-stu-id="61d64-600">Suspends a SQL Data Warehouse database.</span></span>

### [<span data-ttu-id="61d64-601">Switch-AzSqlDatabaseFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="61d64-601">Switch-AzSqlDatabaseFailoverGroup</span></span>](Switch-AzSqlDatabaseFailoverGroup.md)
<span data-ttu-id="61d64-602">Esegue un failover di un gruppo di failover di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-602">Executes a failover of an Azure SQL Database Failover Group.</span></span>

### [<span data-ttu-id="61d64-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span><span class="sxs-lookup"><span data-stu-id="61d64-603">Switch-AzSqlDatabaseInstanceFailoverGroup</span></span>](Switch-AzSqlDatabaseInstanceFailoverGroup.md)
<span data-ttu-id="61d64-604">Esegue un failover di un gruppo di failover di istanze.</span><span class="sxs-lookup"><span data-stu-id="61d64-604">Executes a failover of an Instance Failover Group.</span></span>

### [<span data-ttu-id="61d64-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-605">Update-AzSqlDatabaseAdvancedThreatProtectionSetting</span></span>](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
<span data-ttu-id="61d64-606">Imposta le impostazioni avanzate di protezione dalle minacce in un database.</span><span class="sxs-lookup"><span data-stu-id="61d64-606">Sets a advanced threat protection settings on a database.</span></span>

### [<span data-ttu-id="61d64-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-607">Update-AzSqlDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="61d64-608">Aggiorna le impostazioni di valutazione della vulnerabilità di un database.</span><span class="sxs-lookup"><span data-stu-id="61d64-608">Updates the vulnerability assessment settings of a database.</span></span>

### [<span data-ttu-id="61d64-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-609">Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
<span data-ttu-id="61d64-610">Aggiorna le impostazioni di valutazione della vulnerabilità di un database gestito.</span><span class="sxs-lookup"><span data-stu-id="61d64-610">Updates the vulnerability assessment settings of a managed database.</span></span>

### [<span data-ttu-id="61d64-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-611">Update-AzSqlInstanceVulnerabilityAssessmentSetting</span></span>](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
<span data-ttu-id="61d64-612">Aggiorna le impostazioni di valutazione della vulnerabilità di un'istanza gestita.</span><span class="sxs-lookup"><span data-stu-id="61d64-612">Updates the vulnerability assessment settings of a managed instance.</span></span>

### [<span data-ttu-id="61d64-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-613">Update-AzSqlServerAdvancedThreatProtectionSetting</span></span>](Update-AzSqlServerAdvancedThreatProtectionSetting.md)
<span data-ttu-id="61d64-614">Imposta le impostazioni avanzate di protezione dalle minacce in un server.</span><span class="sxs-lookup"><span data-stu-id="61d64-614">Sets a advanced threat protection settings on a server.</span></span>

### [<span data-ttu-id="61d64-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span><span class="sxs-lookup"><span data-stu-id="61d64-615">Update-AzSqlServerVulnerabilityAssessmentSetting</span></span>](Update-AzSqlServerVulnerabilityAssessmentSetting.md)
<span data-ttu-id="61d64-616">Aggiorna le impostazioni di valutazione della vulnerabilità di un server.</span><span class="sxs-lookup"><span data-stu-id="61d64-616">Updates the vulnerability assessment settings of a server.</span></span>

### [<span data-ttu-id="61d64-617">Update-AzSqlSyncGroup</span><span class="sxs-lookup"><span data-stu-id="61d64-617">Update-AzSqlSyncGroup</span></span>](Update-AzSqlSyncGroup.md)
<span data-ttu-id="61d64-618">Aggiorna un gruppo di sincronizzazione di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-618">Updates an Azure SQL Database Sync Group.</span></span>

### [<span data-ttu-id="61d64-619">Update-AzSqlSyncMember</span><span class="sxs-lookup"><span data-stu-id="61d64-619">Update-AzSqlSyncMember</span></span>](Update-AzSqlSyncMember.md)
<span data-ttu-id="61d64-620">Aggiorna un membro di sincronizzazione di database SQL di Azure.</span><span class="sxs-lookup"><span data-stu-id="61d64-620">Updates an Azure SQL Database Sync Member.</span></span>

### [<span data-ttu-id="61d64-621">Update-AzSqlSyncSchema</span><span class="sxs-lookup"><span data-stu-id="61d64-621">Update-AzSqlSyncSchema</span></span>](Update-AzSqlSyncSchema.md)
<span data-ttu-id="61d64-622">Aggiornare lo schema di sincronizzazione per un database membro di sincronizzazione o un database dell'hub di sincronizzazione.</span><span class="sxs-lookup"><span data-stu-id="61d64-622">Update the sync schema for a sync member database or a sync hub database.</span></span>
<span data-ttu-id="61d64-623">Otterrà lo schema di database più recente dal database reale e lo userà per aggiornare lo schema memorizzato nella cache dal database dei metadati di sincronizzazione.</span><span class="sxs-lookup"><span data-stu-id="61d64-623">It will get the latest database schema from the real database and then use it refresh the schema cached by Sync metadata database.</span></span>
<span data-ttu-id="61d64-624">Se viene specificato "SyncMemberName", lo schema del database membro verrà aggiornato; in caso contrario, aggiornerà lo schema del database hub.</span><span class="sxs-lookup"><span data-stu-id="61d64-624">If "SyncMemberName" is specified, it will refresh the member database schema; if not, it will refresh the hub database schema.</span></span>
