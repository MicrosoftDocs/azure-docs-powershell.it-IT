...
## Descrizione
Il cmdlet **Get-AzSqlSyncSchema** restituisce informazioni sullo schema di sincronizzazione di un database di membri o di un database hub.
...
Questo comando consente di ottenere lo schema di sincronizzazione per il database hub nella proprietà gruppo di sincronizzazione syncGroup01 ed Espandi tabelle.

### Esempio 3: ottenere lo schema di sincronizzazione per un database di membri
```powershell
