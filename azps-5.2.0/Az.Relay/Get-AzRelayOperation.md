...
ms.locfileid: "98335863"
---
# <span data-ttu-id="27196-101">Get-AzRelayOperation</span><span class="sxs-lookup"><span data-stu-id="27196-101">Get-AzRelayOperation</span></span>

## <span data-ttu-id="27196-102">Sinossi</span><span class="sxs-lookup"><span data-stu-id="27196-102">SYNOPSIS</span></span>
<span data-ttu-id="27196-103">Elenco delle operazioni di inoltro supportate</span><span class="sxs-lookup"><span data-stu-id="27196-103">List supported Relay Operations</span></span>

## <span data-ttu-id="27196-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="27196-104">SYNTAX</span></span>

```
Get-AzRelayOperation [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="27196-105">Descrizione</span><span class="sxs-lookup"><span data-stu-id="27196-105">DESCRIPTION</span></span>
<span data-ttu-id="27196-106">Il cmdlet **Get-AzRelayOperation** elenca le operazioni supportate da relay.</span><span class="sxs-lookup"><span data-stu-id="27196-106">The **Get-AzRelayOperation** cmdlet Lists the Relay supported Operations.</span></span>

## <span data-ttu-id="27196-107">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="27196-107">EXAMPLES</span></span>

### <span data-ttu-id="27196-108">Esempio 1</span><span class="sxs-lookup"><span data-stu-id="27196-108">Example 1</span></span>
```
...
<span data-ttu-id="27196-109">Elenca le operazioni supportate tramite inoltro</span><span class="sxs-lookup"><span data-stu-id="27196-109">Lists Relay supported operations</span></span>

## <span data-ttu-id="27196-110">PARAMETRI</span><span class="sxs-lookup"><span data-stu-id="27196-110">PARAMETERS</span></span>

### <span data-ttu-id="27196-111">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="27196-111">-DefaultProfile</span></span>
<span data-ttu-id="27196-112">Le credenziali, l'account, il tenant e l'abbonamento usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="27196-112">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="27196-113">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="27196-113">CommonParameters</span></span>
<span data-ttu-id="27196-114">Questo cmdlet supporta i parametri comuni:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose,-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="27196-114">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="27196-115">Per altre informazioni, Vedi about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="27196-115">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="27196-116">INGRESSI</span><span class="sxs-lookup"><span data-stu-id="27196-116">INPUTS</span></span>

### <span data-ttu-id="27196-117">Nessuno</span><span class="sxs-lookup"><span data-stu-id="27196-117">None</span></span>

## <span data-ttu-id="27196-118">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="27196-118">OUTPUTS</span></span>

### <span data-ttu-id="27196-119">Microsoft. Azure. Commands. Relay. Models. PSOperationAttributes</span><span class="sxs-lookup"><span data-stu-id="27196-119">Microsoft.Azure.Commands.Relay.Models.PSOperationAttributes</span></span>

## <span data-ttu-id="27196-120">Note</span><span class="sxs-lookup"><span data-stu-id="27196-120">NOTES</span></span>

## <span data-ttu-id="27196-121">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="27196-121">RELATED LINKS</span></span>
