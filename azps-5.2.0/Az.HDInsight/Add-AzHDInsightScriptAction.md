...
## Descrizione
Il cmdlet **Add-AzHDInsightScriptAction** aggiunge le azioni di script all'oggetto di configurazione HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.
