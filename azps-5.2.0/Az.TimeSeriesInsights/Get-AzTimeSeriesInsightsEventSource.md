...
### Esempio 1: elencare tutte le origini eventi nell'ambiente specificato
```powershell
...
Questo comando elenca tutte le origini eventi in ambienti specificati.

### Esempio 2: ottenere un'origine eventi specificata per nome
```powershell
...
Questo comando ottiene una specifica origine eventi.

### Esempio 3: ottenere un'origine eventi specificata per oggetto
```powershell
...
### -Nome
Nome dell'origine dell'evento Insights Series associato all'ambiente specificato.
