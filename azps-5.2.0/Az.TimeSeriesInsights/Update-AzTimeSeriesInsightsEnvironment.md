...
### Esempio 1: aggiornare un ambiente per gli approfondimenti delle serie temporali di Gen1
```powershell
...
Questo comando aggiorna un ambiente per gli approfondimenti delle serie temporali di Gen1.

### Esempio 2: aggiornare un ambiente per gli approfondimenti delle serie temporali di Gen1
```powershell
...
### -Tag
Coppie chiave-valore di proprietà aggiuntive per l'ambiente.
