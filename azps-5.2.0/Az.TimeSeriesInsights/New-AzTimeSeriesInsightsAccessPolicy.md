...
### Esempio 1: creare un criterio di accesso per un ambiente specificato
```powershell
...
Questo comando crea un criterio di accesso per un ambiente specificato.
