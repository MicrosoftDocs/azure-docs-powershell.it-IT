...
Creare un oggetto PSServiceDiagnosticSettings. E crea l'impostazione di diagnostica per la risorsa di destinazione.

## PARAMETRI

### -DedicatedLogAnalyticsDestinationType
Valore che indica se esportare (in ODS) in specifiche delle risorse (se presenti) o in AzureDiagnostics (impostazione predefinita, non presente)
...
### -Impostazione
Impostazioni metriche o Impostazioni log
...
### -WorkspaceId
ID risorsa dell'area di lavoro analisi log per l'invio di registri/metriche a
