...
## Descrizione
Crea un oggetto di tipo Condition trigger.
Questo oggetto deve essere passato al comando che crea l'oggetto azione di avviso
...
### -MetricTrigger
Condizione trigger per la regola di query metrica
...
### -Soglia
Soglia sopra la quale viene generato l'avviso
...
### -ThresholdOperator
Operatore soglia: GreaterThan, LessThan o uguale
