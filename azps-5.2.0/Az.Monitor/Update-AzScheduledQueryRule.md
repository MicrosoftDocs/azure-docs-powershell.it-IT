...
## Descrizione
Aggiorna una regola di avviso del log, l'aggiornamento solo della proprietà "Enabled" è supportato da questo comando.
Per aggiornare altre proprietà, vedi comando [set-AzScheduledQueryRule](https://docs.microsoft.com/en-us/powershell/module/az.monitor/set-azscheduledqueryrule) .

## ESEMPI

### Esempio 1: aggiornamento per nome regola
```powershell
...
### Esempio 2: aggiornamento per oggetto di input
```powershell
...
### Esempio 3: aggiornamento per ID risorsa
```powershell
...
### -Enabled
Stato di avviso di Azure-valori validi-$true $false
