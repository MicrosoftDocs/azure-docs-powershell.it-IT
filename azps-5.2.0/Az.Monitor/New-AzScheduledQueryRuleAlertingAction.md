...
## Descrizione
Crea un oggetto di tipo Action Alerting questo oggetto deve essere passato al comando che crea la regola di avviso del log
...
### -ThrottlingInMinutes
Durata in minuti per cui deve essere strozzata l'allerta
...
### -Trigger
Condizione del trigger di avviso
