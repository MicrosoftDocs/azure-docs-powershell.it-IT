...
### Esempio 1 impostare il CAP del volume dei dati giornalieri per una risorsa Insights applicazione
```
...
Impostare il CAP del volume di dati giornalieri su 400GB per giorno e interrompere l'invio della notifica quando si preme il pulsante per la risorsa "test" nel gruppo di risorse "testgroup"
