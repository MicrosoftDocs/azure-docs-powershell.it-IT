...
### Esempio 1 creare una nuova risorsa approfondimenti applicazione
```
...
Aggiungere una nuova risorsa approfondimenti applicazione denominata "test" nel gruppo risorse "testgroup" con il tipo "Java"
...
### -Posizione
Percorso delle risorse dell'applicazione Insights.
...
Tipo di accesso alla rete per l'accesso all'ingestione di Insight per l'applicazione. Il valore deve essere "Enabled" o "disabled"
...
Tipo di accesso alla rete per l'accesso alla query Insights dell'applicazione. Il valore deve essere "Enabled" o "disabled"
