...
## Descrizione
Il cmdlet **Remove-AzHpcCacheStorageTarget** rimuove una destinazione di archiviazione dalla cache di Azure HPC.
...
### -Force
Indica che il cmdlet non chiede conferma. Per impostazione predefinita, questo cmdlet richiede di confermare che si vuole rimuovere la destinazione di archiviazione.
...
### -ResourceGroupName
Nome del gruppo di risorse in cui si vuole rimuovere la destinazione di archiviazione dalla cache.
