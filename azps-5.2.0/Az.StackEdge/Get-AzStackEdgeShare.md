...
## Descrizione
Il cmdlet **Get-AzStackEdgeShare** ottiene le condivisioni disponibili per un dispositivo Edge dello stack. Se viene fornito il nome, otterrà il nome della condivisione.
