...
## Descrizione
Il cmdlet **Get-AzStackEdgeUser** elenca gli utenti configurati per un dispositivo Edge in pila. Puoi menzionare il nome in parametri per ottenere informazioni dettagliate su un utente specifico.
