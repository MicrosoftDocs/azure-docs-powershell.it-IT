...
## Descrizione
Il cmdlet **Invoke-AzDataBoxEdgeDevice** richiama le azioni per analizzare, scaricare e installare gli aggiornamenti nel dispositivo Edge della casella dati. Un'analisi automatica viene eseguita giornalmente sul dispositivo, è possibile attivare l'analisi in modo esplicito eseguendo questo cmdlet.
...
### -FetchUpdate
Scarica gli aggiornamenti in una casella dati Edge/Device gateway
...
### -InstallUpdate
Installa gli aggiornamenti nel dispositivo Edge/Gateway della casella dati
...
### -ScanForUpdate
Analizza gli aggiornamenti in un dispositivo Edge/Gateway della casella dati.
