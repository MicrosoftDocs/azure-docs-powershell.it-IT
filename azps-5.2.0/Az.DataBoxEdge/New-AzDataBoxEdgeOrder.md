...
## Descrizione
Il cmdlet **New-AzDataBoxEdgeOrder** crea un nuovo ordine per un dispositivo Edge della casella dati. Prima di creare un ordine, è necessario creare una risorsa per il dispositivo Edge della casella dati. Puoi specificare i dettagli come i parametri di contatto, nome società, posta elettronica, indirizzo e così via come per la creazione dell'ordine.
...
### -Posta elettronica
Elenco dei messaggi di posta elettronica per ricevere gli aggiornamenti, accetta massimo di 10 messaggi di posta elettronica
