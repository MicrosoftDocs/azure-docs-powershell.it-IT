...
## Descrizione
Il cmdlet **New-AzDataBoxEdgeShare** crea una nuova condivisione nel dispositivo Edge della casella dati.
...
### -ClientAccessRight
Accesso in lettura/scrittura per ClientID, ad esempio: @ (@ {"ClientID" = "192.168.10.10"; " AccessRight "=" NoAccess "}, @ {" ClientID "=" 192.168.10.11 ";" AccessRight "=" ReadOnly "})
...
### -CloudShare
Specificare il nome della risorsa di StorageAccountCredential esistente
...
### -ContainerName
Nome contenitore (in base al formato dati specificato, rappresenta il nome di file Azure/Pageblob/BLOB blocco)
...
### -NFS
AccessProtocol in caso di creazione di una condivisione
...
### -UserAccessRight
consente di accedere a destra insieme ai nomi utente esistenti per accedere ai tipi di condivisione SMB, ad esempio: @ (@ {"username" = "nome utente-1"; " AccessRight "=" Read "}, @ {" username "=" User-Name-2 ";" AccessRight "=" Read "}, @ {" username "=" User-Name-3 ";" AccessRight "=" personalizzato "})
