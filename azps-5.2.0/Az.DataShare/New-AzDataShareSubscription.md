...
## Descrizione
Il cmdlet **New-AzDataShareSubscription** crea un abbonamento a una condivisione nell'account di condivisione dati e nell'ID invito specificati.
...
Questo comando crea una nuova AdsShareSubscription di sottoscrizione di condivisione per invitaionId in WikiAds account di condivisione dati.
...
### -InvitationId
Condivisione dati di Azure invitationId
...
### -SourceShareLocation
Posizione della condivisione dati in Azure
