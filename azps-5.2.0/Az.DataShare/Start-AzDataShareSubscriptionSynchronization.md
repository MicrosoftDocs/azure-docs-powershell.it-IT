...
## Descrizione
Il cmdlet **Start-AzDataShareSubscriptionSynchronization** avvia la sincronizzazione per un abbonamento a una condivisione
...
Questo comando avvia la sincronizzazione per un sharesubscription denominato AdsShareSubscription nell'account WikiAds. 
