...
Account di archiviazione collegato Get o List
...
Scollegare il servizio per l'area di lavoro

### [Remove-AzOperationalInsightsLinkedStorageAccount](Remove-AzOperationalInsightsLinkedStorageAccount.md)
Eliminare l'account di archiviazione collegata per l'area di lavoro
...
### [Ripristinare-AzOperationalInsightsWorkspace](Restore-AzOperationalInsightsWorkspace.md)
...
collegamento al servizio per l'area di lavoro

### [Set-AzOperationalInsightsLinkedStorageAccount](Set-AzOperationalInsightsLinkedStorageAccount.md)
Impostare un account di archiviazione collegato per l'area di lavoro
