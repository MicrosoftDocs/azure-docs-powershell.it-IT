...
## Descrizione
Il cmdlet **set-AzOperationalInsightsIntelligencePack** Abilita l'intelligence Pack specificata se *Enabled* è impostato su $true e lo Disabilita se *Enabled* è impostato su $false.

## ESEMPI

### Esempio 1: impostare i pacchetti di intelligence
```
PS C:\>Set-AzOperationalInsightsIntelligencePack -ResourceGroupName "ContosoResourceGroup" -WorkspaceName "ContosoWorkspace" -IntelligencePackName "ContosoWorkspace" -Enabled $True
```

Questo comando Abilita il pacchetto di informazioni specificato.
...
Specifica il nome del pacchetto di intelligence.
