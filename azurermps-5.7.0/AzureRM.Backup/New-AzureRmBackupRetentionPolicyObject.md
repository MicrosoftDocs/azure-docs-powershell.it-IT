...
Creare un criterio di conservazione per ogni tipo di conservazione che si prevede di usare.
...
Specificare questo parametro se si specificano i parametri *WeeklyRetention* , *MonthlyRetentionInWeeklyFormat* e *YearlyRetentionInWeeklyFormat* .
