...
## Descrizione
Il cmdlet **Get-AzureKeyVaultCertificateOperation** ottiene lo stato di un'operazione di certificato.

## ESEMPI

### Esempio 1: ottenere lo stato di un'operazione di certificato
```
...
Questo comando consente di ottenere lo stato dell'operazione certificate per TestCert01 nel caveau della chiave ContosoKV01.
