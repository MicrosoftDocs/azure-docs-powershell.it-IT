...
## Descrizione
Il cmdlet **Get-AzureRmRecoveryServicesBackupRecoveryPoint** ottiene i punti di ripristino per un elemento di backup di Azure supportato.
...
Il terzo comando ottiene i contenitori di backup di AzureVM e li archivia nella variabile $Containers.

Il quarto comando ottiene l'elemento di backup denominato V2VM e lo archivia nella variabile $BackupItem.
...
Per ottenere un oggetto **AzureRmRecoveryServicesBackupItem** , usa il cmdlet Get-AzureRmRecoveryServicesBackupItem.
