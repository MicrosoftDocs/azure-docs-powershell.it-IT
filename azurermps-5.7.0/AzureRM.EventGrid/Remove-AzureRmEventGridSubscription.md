...
## Descrizione
Rimuove un abbonamento a un evento della griglia di eventi di Azure per un argomento della griglia di eventi di Azure, una risorsa, un abbonamento a Azure o un gruppo di risorse.
...
Rimuove la sottoscrizione dell'evento \` EventSubscription1 in \` un argomento della griglia di eventi di Azure \` Topic1 \` nel gruppo di risorse \` MyResourceGroupName \` .
...
Rimuove la sottoscrizione dell'evento \` EventSubscription1 \` a un gruppo di risorse \` MyResourceGroupName \` .
...
Rimuove la sottoscrizione dell'evento \` EventSubscription1 \` all'abbonamento Azure predefinito.
...
Rimuove la sottoscrizione dell'evento \` EventSubscription1 \` in uno spazio dei nomi Hub eventi.
...
Rimuove l'argomento della sottoscrizione dell'evento \` EventSubscription1 \` in una griglia eventi.
...
Nome dell'abbonamento a un evento che deve essere rimosso.
...
### -InputObject
Oggetto EventSubscription EventGrid.
...
### -ResourceId
Identificatore della risorsa la cui sottoscrizione di eventi deve essere rimossa.
