...
## Descrizione
Il cmdlet **Grant-AzureRmHDInsightRdpServicesAccess** consente il protocollo RDP (Remote Desktop Protocol) per accedere a un cluster di HDInsight Azure basato su Windows.
