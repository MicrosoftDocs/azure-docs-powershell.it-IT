...
## Descrizione
La New-AzureHDInsightCluster crea un cluster di Azure HDInsight usando i parametri specificati o usando un oggetto Configuration creato usando il cmdlet New-AzureRmHDInsightClusterConfig.
...
In alternativa, puoi usare il cmdlet Add-AzureRmHDInsightStorage.
...
Le opzioni disponibili sono: Hadoop, HBase, Storm, Spark
...
Questo oggetto può essere creato usando il cmdlet New-AzureRmHDInsightClusterConfig.
...
In alternativa, puoi usare il cmdlet Add-AzureRmHDInsightConfigValues.
...
In alternativa, puoi usare il cmdlet Set-AzureRmHDInsightDefaultStorage.
...
In alternativa, è possibile usare Add-AzureRmHDInsightScriptAction.
...
In alternativa, puoi usare il cmdlet Add-AzureRmHDInsightSecurityProfile.
