...
## Descrizione
Il cmdlet **Start-AzureRmSiteRecoveryPolicyAssociationJob** avvia un processo di associazione per associare un criterio di replica con un contenitore di protezione per il ripristino di un sito Azure.
