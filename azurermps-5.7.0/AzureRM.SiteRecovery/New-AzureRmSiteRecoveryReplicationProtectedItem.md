...
## Descrizione
Il cmdlet **New-AzureRmSiteRecoveryReplicationProtectedItem** crea un nuovo elemento protetto da replica.
Usa questo cmdlet per abilitare la replica per un elemento protetto.
...
### -Nome
Specifica il nome dell'elemento protetto della replica di ripristino di Azure sito.
...
### -ProtectableItem
Specifica l'elemento protetto per il ripristino di Azure site.
...
Specifica l'oggetto di mapping del contenitore di protezione del sito di Azure da usare per la replica.
...
Specifica l'ID dell'account di archiviazione di Azure a cui viene replicato il cmdlet.
...
### -WaitForCompletion
Indica che il cmdlet attende il completamento.
