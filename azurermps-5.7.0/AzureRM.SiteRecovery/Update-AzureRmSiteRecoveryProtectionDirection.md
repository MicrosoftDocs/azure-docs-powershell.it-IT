...
## Descrizione
Il cmdlet **Update-AzureRmSiteRecoveryProtectionDirection** aggiorna il server di origine e di destinazione per la protezione di un oggetto di ripristino di un sito di Azure dopo il completamento di un'operazione di failover di commit.
...
### -Direzione
Specifica la direzione del commit.
