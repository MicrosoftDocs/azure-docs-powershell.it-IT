...
## Descrizione
Il cmdlet **New-AzureRmSiteRecoveryFabric** crea un tessuto di recupero del sito di Azure del tipo specificato.
...
### -Nome
Specifica il nome del tessuto di ripristino del sito di Azure
