...
## Descrizione
Il cmdlet Add-AzureRmEnvironment aggiunge endpoint e metadati per consentire ai cmdlet di Azure Resource Manager di connettersi con una nuova istanza di Azure Resource Manager.
...
### PSAzureEnvironment
Questo cmdlet restituisce il set di endpoint e metadati necessari per comunicare con un'istanza di Azure.
