...
Si connette a Azure con un account autenticato da usare con le richieste di cmdlet di Azure Resource Manager.
...
Disconnette da un account di Azure connesso e rimuove tutte le credenziali e i contesti associati a tale account.
