...
## Descrizione
Il cmdlet **Remove-AzureRmNotificationHubsNamespaceAuthorizationRules** rimuove una regola di autorizzazione della firma di accesso condiviso (SAS) da uno spazio dei nomi dell'hub di notifica.
