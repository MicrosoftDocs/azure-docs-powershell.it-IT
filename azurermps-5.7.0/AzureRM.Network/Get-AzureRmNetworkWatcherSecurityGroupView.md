...
## Descrizione
Il Get-AzureRmNetworkWatcherSecurityGroupView consente di visualizzare le regole di gruppo di sicurezza di rete configurate ed effettive applicate in una VM.

## ESEMPI

### ---Esempio 1: effettuare una chiamata di visualizzazione per un gruppo di sicurezza in una---VM
```
