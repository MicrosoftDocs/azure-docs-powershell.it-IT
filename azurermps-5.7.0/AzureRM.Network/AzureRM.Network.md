...
{{Immettere manualmente Add-AzureRmLoadBalancerInboundNatPoolConfig descrizione qui}}
...
{{Immettere manualmente Get-AzureRmBgpServiceCommunity descrizione qui}}
...
{{Immettere manualmente Get-AzureRmLoadBalancerInboundNatPoolConfig descrizione qui}}
...
Ottiene un monitor di connessione

### [Get-AzureRmNetworkWatcherConnectionMonitorReport](Get-AzureRmNetworkWatcherConnectionMonitorReport.md)
Ottiene uno snapshot degli Stati di connessione più recenti
...
{{Immettere manualmente Get-AzureRmVirtualNetworkGatewayConnectionSharedKey descrizione qui}}
...
{{Immettere manualmente New-AzureRmLoadBalancerInboundNatPoolConfig descrizione qui}}
...
Crea una nuova risorsa monitoraggio connessione.
...
{{Immettere manualmente New-AzureRmVirtualNetworkGatewayConnection descrizione qui}}
...
{{Immettere manualmente Remove-AzureRmLoadBalancerInboundNatPoolConfig descrizione qui}}
...
{{Immettere manualmente Remove-AzureRmVirtualNetworkGatewayIpConfig descrizione qui}}

### [Remove-AzureRmVirtualNetworkPeering](Remove-AzureRmVirtualNetworkPeering.md)
{{Immettere manualmente Remove-AzureRmVirtualNetworkPeering descrizione qui}}
...
{{Immettere manualmente Reset-AzureRmVirtualNetworkGateway descrizione qui}}

### [Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey](Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey.md)
{{Immettere manualmente Reset-AzureRmVirtualNetworkGatewayConnectionSharedKey descrizione qui}}
...
{{Immettere manualmente Set-AzureRmLoadBalancerInboundNatPoolConfig descrizione qui}}
...
Modifica di un monitor di connessione.
...
Avvia un monitor di connessione.
...
Interrompe un monitor di connessione in corso
...
{{Immettere manualmente Test-AzureRmDnsAvailability descrizione qui}}
