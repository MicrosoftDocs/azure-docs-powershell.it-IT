...
## Descrizione
Il cmdlet **Remove-AzureRmVirtualNetwork** rimuove una rete virtuale di Azure.

## ESEMPI

### 1: creare ed eliminare una rete virtuale
```
...
Questo esempio crea una rete virtuale in un gruppo di risorse e quindi la Elimina immediatamente. Per eliminare la richiesta quando si elimina la rete virtuale, usare il contrassegno-forza.
...
### -Nome
Specifica il nome della rete virtuale rimossa da questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene la rete virtuale rimossa da questo cmdlet.
