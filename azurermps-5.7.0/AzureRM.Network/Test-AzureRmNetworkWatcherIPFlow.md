...
## Descrizione
Il cmdlet Test-AzureRmNetworkWatcherIPFlow, per una risorsa VM specificata e un pacchetto con una direzione specificata con gli indirizzi IP locali e remoti e le porte, restituisce se il pacchetto è consentito o negato.

## ESEMPI

### ---Esempio 1: eseguire Test-AzureRmNetworkWatcherIPFlow---
```
...
Ottieni l'osservatore di rete in West Central US per questo abbonamento, quindi ottiene la VM ed è associata alle interfacce di rete. Quindi, per la prima interfaccia di rete, viene eseguito Test-AzureRmNetworkWatcherIPFlow usando il primo IP della prima interfaccia di rete per una connessione in uscita a un IP su Internet.
