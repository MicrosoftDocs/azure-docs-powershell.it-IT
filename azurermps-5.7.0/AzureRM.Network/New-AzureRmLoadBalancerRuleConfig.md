...
## Descrizione
Il cmdlet **New-AzureRmLoadBalancerRuleConfig** crea una configurazione di regola per un bilanciamento del carico di Azure.

## ESEMPI

### 1: creazione di una configurazione di regola per un bilanciamento del carico di Azure
```
