...
## Descrizione
Il cmdlet New-AzureRmNetworkWatcherConnectionMonitor rcreates un monitor di connessione per un'origine e una destinazione specificate.

## ESEMPI

### Esempio 1: creare un monitor di connessione per una VM e una destinazione Internet
```
...
Il cmdlet New-AzureRmNetworkWatcherConnectionMonitor crea un monitor di connessione per un'origine e una destinazione specificate.
