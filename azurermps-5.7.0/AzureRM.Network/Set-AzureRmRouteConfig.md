...
## Descrizione
Il cmdlet **set-AzureRmRouteConfig** imposta lo stato dell'obiettivo per una route di Azure.
...
Il cmdlet Current modifica la route denominata Route02 e quindi passa il risultato al cmdlet **set-AzureRmRouteTable** , che aggiorna la tabella in base alle modifiche apportate.
