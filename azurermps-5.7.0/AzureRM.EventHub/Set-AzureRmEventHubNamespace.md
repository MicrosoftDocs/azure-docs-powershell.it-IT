...
## Descrizione
Il cmdlet Set-AzureRmEventHubNamespace aggiorna le proprietà dello spazio dei nomi degli hub eventi specificati.
...
Aggiorna lo stato dello spazio dei nomi NamespaceName \` \` in created.
