...
## Sinossi
Crea un contratto per l'account di integrazione.
...
## Descrizione
Il cmdlet **New-AzureRmIntegrationAccountAgreement** crea un contratto per l'account di integrazione.
Questo cmdlet restituisce un oggetto che rappresenta il contratto di integrazione dell'account.
Specificare il nome dell'account di integrazione, il nome del gruppo di risorse, il nome dell'accordo, il tipo, il nome del partner, i qualificatori partner e il contenuto del contratto
...
### Esempio 1: creare un contratto per l'account di integrazione
```
...
Questo comando crea un contratto per l'account di integrazione nel gruppo di risorse Azure specificato.

## PARAMETRI

### -AgreementContent
Specifica il contenuto del contratto, in formato JSON (JavaScript Object Notation) per il contratto.
Specificare questo parametro o il parametro *AgreementContentFilePath* .
...
### -Contratto
Specifica un nome per il contratto di integrazione dell'account.
...
### -AgreementType
Specifica il tipo di contratto per l'account di integrazione. I valori accettabili per questo parametro sono i seguenti:
