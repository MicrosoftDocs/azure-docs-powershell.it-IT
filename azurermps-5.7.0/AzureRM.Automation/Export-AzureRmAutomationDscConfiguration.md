...
## Descrizione
Il cmdlet **Export-AzureRmAutomationDscConfiguration** esporta una configurazione DSC (APS desired state Configuration) da Azure Automation in un file locale.
...
Il valore predefinito viene pubblicato.
