...
## Descrizione
Il cmdlet **Import-AzureRmAutomationDscConfiguration** importa una configurazione DSC (APS desired state Configuration) in Azure Automation.
Specifica il percorso di uno script APS che contiene una singola configurazione DSC.

## ESEMPI

### Esempio 1: importare una configurazione DSC in automazione
```
PS C:\>Import-AzureRmAutomationDscConfiguration -AutomationAccountName "Contoso17"-ResourceGroupName "ResourceGroup01" -SourcePath "C:\DSC\client.ps1" -Force
```

Questo comando importa la configurazione DSC nel file denominato client.ps1 nell'account di automazione denominato Contoso17. Il comando specifica il parametro *Force* . Se esiste una configurazione DSC esistente, questo comando lo sostituisce.
...
### -Descrizione
Specifica una descrizione della configurazione importata da questo cmdlet.
...
### -LogVerbose
Specifica se questo cmdlet attiva o disattiva la registrazione dettagliata per i processi di compilazione della configurazione DSC. Specificare un valore di $True per attivare la registrazione dettagliata o $False per disattivarla.
...
### -Pubblicato
Indica che questo cmdlet importa la configurazione DSC nello stato Published.
...
### -SourcePath
Specifica il percorso dello script wps_2 che contiene la configurazione DSC importata da questo cmdlet.
