...
## Descrizione
Il cmdlet **Get-AzureRmAutomationCertificate** ottiene uno o più certificati di automazione Azure.
Per impostazione predefinita, questo cmdlet ottiene tutti i certificati.
Specificare il nome di un certificato per ottenere un certificato specifico.
...
Questo comando consente di ottenere metadati per tutti i certificati nell'account di automazione denominato Contoso17.
...
Questo comando consente di ottenere metadati per il certificato denominato ContosoCertificate.

## PARAMETRI

### -AutomationAccountName
Specifica il nome dell'account di automazione per cui questo cmdlet recupera un certificato.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse per cui questo cmdlet ottiene un certificato di automazione.
