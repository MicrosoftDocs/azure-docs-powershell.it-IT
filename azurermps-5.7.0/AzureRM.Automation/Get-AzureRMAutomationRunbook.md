...
## Descrizione
Il cmdlet **Get-AzureRmAutomationRunbook** ottiene manuali operativi di automazione di Azure.
Per ottenere uno specifico Runbook, specificarne il nome.
...
Specifica il nome di un account di automazione in cui questo cmdlet ottiene manuali operativi.
...
### -Nome
Specifica il nome di un Runbook ottenuto da questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse per cui questo cmdlet ottiene manuali operativi.
