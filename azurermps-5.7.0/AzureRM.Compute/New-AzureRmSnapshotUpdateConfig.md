...
### -CreateOption
Specifica se questo cmdlet crea uno snapshot nella macchina virtuale da una piattaforma o da un'immagine utente, crea un disco vuoto o allega un disco esistente.
...
### -ImageReference
Specifica il riferimento alle immagini in uno snapshot.
...
Sistema. Nullable `1[[Microsoft.Azure.Management.Compute.Models.OperatingSystemTypes, Microsoft.Azure.Management.Compute, Version=14.0.0.0, Culture=neutral, PublicKeyToken=31bf3856ad364e35]]
