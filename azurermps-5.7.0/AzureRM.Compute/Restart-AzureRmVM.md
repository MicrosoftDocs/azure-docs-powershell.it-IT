...
### RestartResourceGroupNameParameterSetName (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Restart-AzureRmVM riavvia** una macchina virtuale di Azure.
...
Questo comando Riavvia la macchina virtuale denominata VirtualMachine07 in ResourceGroup11.
...
### -PerformMaintenance
Per eseguire la manutenzione della macchina virtuale.
