...
Il comando specifica le varie impostazioni per la configurazione del servizio contenitore.
Il comando passa l'oggetto Configuration al cmdlet Add-AzureRmContainerServiceAgentPoolProfile usando l'operatore pipeline.
Questo cmdlet aggiunge un profilo del pool di agenti.
...
### -Tag
Specifica i tag per il servizio contenitore.
