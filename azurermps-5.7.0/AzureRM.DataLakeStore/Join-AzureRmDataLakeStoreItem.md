...
## Descrizione
Il cmdlet **join-AzureRmDataLakeStoreItem** unisce uno o più file per creare un file in data Lake Store.

## ESEMPI

### Esempio 1: unire due elementi
```
...
Questo comando unisce File01.txt e File02.txt per creare il file CombinedFile.txt.
...
### -Destinazione
Specifica il percorso dello Store Data Lake per l'elemento Unito, a partire dalla directory radice (/).
...
### -Percorsi
Specifica una matrice di percorsi per l'archiviazione dei dati di un lago nei file da combinare, a partire dalla directory radice (/).
...
### stringa
Il percorso completo del file risultante dai file Uniti.
