...
### NoDiagnosticLogging (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Export-AzureRmDataLakeStoreItem** Scarica un file da data Lake Store.
...
Questo comando Scarica il file TestSource.csv da data Lake Store per C:\Test.csv con una concorrenza di 4.
...
### -Concorrenza
Indica il numero di file o blocchi da scaricare in parallelo. L'impostazione predefinita verrà calcolata come uno sforzo ottimale in base alle specifiche di sistema.
...
### -ConcurrentFileCount
Indica il numero massimo di file da scaricare in parallelo per il download di una cartella.  Il calcolo predefinito verrà calcolato come uno sforzo ottimale in base alle dimensioni della cartella e del file
...
### -Destinazione
Specifica il percorso del file locale a cui scaricare il file.
...
### -PerFileThreadCount
Indica il numero massimo di thread da usare per ogni file.  Il calcolo predefinito verrà calcolato come uno sforzo ottimale in base alle dimensioni della cartella e del file
...
### -Curriculum vitae
Indica che i file da copiare sono la continuazione di un download precedente.
In questo modo il sistema cercherà di riprendere dall'ultimo file che non è stato completamente scaricato.
...
### stringa
Percorso in cui è stato scaricato il file o la cartella.
