...
## Descrizione
Il cmdlet **test-AzureRmDataLakeStoreAccount** verifica l'esistenza di un account di data Lake Store.

## ESEMPI

### Esempio 1: testare un account
```
PS C:\>Test-AzureRmDataLakeStoreAccount -Name "ContosoADL"
```

Questo comando verifica se l'account denominato ContosoADL esiste.
...
### -Nome
Specifica il nome dell'account di data Lake Store da testare.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene l'account da testare.
...
### bool
Vero o falso che indica l'esistenza dell'account specificato.
