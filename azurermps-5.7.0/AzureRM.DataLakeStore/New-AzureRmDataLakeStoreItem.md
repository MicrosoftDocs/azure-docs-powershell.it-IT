...
## Descrizione
Il cmdlet **New-AzureRmDataLakeStoreItem** crea un nuovo file o una nuova cartella in data Lake Store.
...
Il primo comando crea il file NewFile.txt per l'account specificato.

Il secondo comando crea la cartella NewFolder nella cartella radice.
...
### -Path
Specifica il percorso dello Store Data Lake dell'elemento da creare, a partire dalla directory radice (/).
...
### Oggetto
Il parametro "value" accetta il valore di tipo "Object" dalla pipeline

## OUTPUT

### stringa
Percorso completo per il file o la cartella creata.
