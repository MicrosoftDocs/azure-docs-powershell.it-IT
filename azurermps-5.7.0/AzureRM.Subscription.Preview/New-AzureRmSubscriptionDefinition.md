...
## Sinossi
Crea una definizione di abbonamento.

[!INCLUDE [migrate-to-az-banner](../../includes/migrate-to-az-banner.md)]

## SINTASSI

### Creare una definizione di abbonamento
```
New-AzureRmSubscriptionDefinition -Name <String> -OfferType <String> [-SubscriptionDisplayName <String>]
```

## Descrizione
Il cmdlet **New-AzureRmSubscriptionDefinition** crea una definizione di abbonamento.
...
Crea una definizione di abbonamento con un nome visualizzato dell'abbonamento predefinito.
...
Crea una definizione di abbonamento con un nome visualizzato dell'abbonamento personalizzato.

## PARAMETRI

### -Nome
Nome della definizione della sottoscrizione da creare.
...
### -OfferType
Tipo di offerta da usare per la creazione dell'abbonamento sottostante.
...
Nome visualizzato da usare quando si crea l'abbonamento sottostante alla definizione della sottoscrizione.
