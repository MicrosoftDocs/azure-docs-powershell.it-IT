...
## Descrizione
Il cmdlet **Reset-AzureRmRedisCache** riavvia i nodi di un'istanza della cache di Azure Redis.
...
### -ShardId
Specifica l'ID del frammento che questo cmdlet riavvia per una cache Premium con il clustering abilitato.
