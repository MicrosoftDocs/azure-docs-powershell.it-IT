...
## Descrizione
Il cmdlet **Get-AzureRmRedisCacheKey** ottiene i tasti di scelta per una cache di Azure Redis.

## ESEMPI

### Esempio 1: ottenere i tasti di scelta per una cache di redis
```
...
Questo comando consente di ottenere i tasti di scelta denominati MyCacheKey.
...
### -Nome
Specifica il nome di una cache Redis.
...
Questo cmdlet restituisce i tasti di scelta primari e secondari per una cache di Redis.
