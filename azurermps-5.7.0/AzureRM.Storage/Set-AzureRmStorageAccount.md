...
### -KeyvaultEncryption
Se impostare la fonte di crittografia dell'account di archiviazione su Microsoft. Vault o meno.
Se specifichi il nome di codice, la versione di base e KeyvaultUri, la sorgente di crittografia dell'account di archiviazione sarà impostata anche su Microsoft. temporizzatore Meteo questo parametro è impostato o meno.
```yaml
Type: SwitchParameter
Parameter Sets: KeyvaultEncryption
Aliases:
