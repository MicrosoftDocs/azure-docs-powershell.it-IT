...
## Descrizione
Il cmdlet Remove-AzureRmDataLakeAnalyticsCatalogCredential Elimina le credenziali di un catalogo di analisi del Lago di dati di Azure.

## ESEMPI

### Esempio 1: rimuovere una credenziale
```
...
Questo comando consente di rimuovere le credenziali del catalogo dei dati del lago analitico specificato.
...
### -DatabaseName
Specifica il nome del database che contiene le credenziali.
...
### -PassThru
Indica che il cmdlet non attende il completamento dell'operazione.
...
### -Password
La password per la credenziale.
Questa operazione è obbligatoria se il chiamante non è il proprietario dell'account.
...
### -Recurse
Indica che questa operazione di eliminazione deve passare e anche eliminare e rilasciare tutte le risorse dipendenti da questa credenziale.
...
### bool
Se PassThru è specificato, restituisce vero al completamento dell'operazione.
