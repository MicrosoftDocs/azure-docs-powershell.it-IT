...
## Descrizione
Verifica un certificato caricando un certificato di verifica contenente il codice di verifica ottenuto dal cmdlet Get-AzureRmIotHubCertificateVerificationCode. Questo è l'ultimo passaggio del processo di prova del possesso.
