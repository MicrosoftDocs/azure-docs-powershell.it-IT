...
## Descrizione
Il cmdlet **Remove-AzureBatchCertificate** rimuove un certificato dall'account batch di Azure specificato.
...
Questo comando ottiene tutti i certificati attivi tramite il cmdlet Get-AzureBatchCertificate.
