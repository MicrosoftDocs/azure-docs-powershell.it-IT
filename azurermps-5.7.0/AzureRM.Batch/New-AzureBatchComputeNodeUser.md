...
## Descrizione
Il cmdlet **New-AzureBatchComputeNodeUser** crea un account utente in un nodo di calcolo batch di Azure.
...
Questo comando ottiene il nodo Compute denominato ComputeNode01 usando il cmdlet **Get-AzureBatchComputeNode** .
Il nodo è nel pool che contiene l'ID MyPool01.
Il comando passa il nodo Compute al cmdlet Current usando l'operatore pipeline.
Il comando crea un account utente con il nome utente TestUserand password.
