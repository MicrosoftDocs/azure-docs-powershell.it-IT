...
## Descrizione
Il cmdlet **Remove-AzureRmBatchApplication** Elimina un'applicazione da un account batch di Azure.
...
### -AccountName
Specifica il nome dell'account batch da cui questo cmdlet rimuove un'applicazione.
