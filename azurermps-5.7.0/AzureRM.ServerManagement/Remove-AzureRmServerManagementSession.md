...
## Descrizione
Il cmdlet **Remove-AzureRmServerManagementSession** rimuove una sessione di gestione di Azure server.
...
### -NodeName
Specifica il nome del nodo in cui questo cmdlet rimuove la sessione.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse a cui appartiene la sessione.
...
### -Sessione
Specifica la sessione rimossa da questo cmdlet.

Questo parametro può essere usato al posto dei parametri *ResourceGroupName* , *NodeName* e *sessionname* .
...
### -Sessionname
Specifica il nome della sessione rimossa da questo cmdlet.
