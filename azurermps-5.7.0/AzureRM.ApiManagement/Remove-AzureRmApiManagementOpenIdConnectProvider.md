...
## Descrizione
Il cmdlet **Remove-AzureRmApiManagementOpenIdConnectProvider** rimuove un provider OpenID Connect per la gestione delle API di Azure.
...
Questo comando rimuove un provider con ID OICProvicer01.
