...
Il dettaglio del provider OpenId Connect configurato nel servizio di gestione API.

### IList<Microsoft. Azure. Commands. ApiManagement. ServiceManagement. Models. PsApiManagementOpenIdConnectProvider>
Elenco dei provider di connessione OpenId configurati nel servizio di gestione API.
