...
## Descrizione
Il cmdlet **Remove-AzureRmApiManagementProperty** rimuove una **Proprietà** di gestione delle API di Azure.

## ESEMPI

### Esempio 1: rimuovere una proprietà
```
PS C:\>$apimContext = New-AzureRmApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzureRmApiManagementProperty -Context $apimContext -PropertyId "Property11" -PassThru
```

Questo comando rimuove la proprietà con ID Property11.
...
### -PropertyId
Specifica un ID della proprietà rimossa da questo cmdlet.
