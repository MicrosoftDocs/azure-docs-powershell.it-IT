...
### GetAllCertificates (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzureRmApiManagementCertificate** ottiene tutti i certificati o i certificati di gestione delle API di Azure specificati.
