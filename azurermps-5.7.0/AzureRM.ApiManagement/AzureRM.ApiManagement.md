...
Ottiene i certificati di gestione delle API.
...
{{Immettere manualmente Get-AzureRmApiManagementProperty descrizione qui}}
...
Modifica un certificato di gestione delle API.
