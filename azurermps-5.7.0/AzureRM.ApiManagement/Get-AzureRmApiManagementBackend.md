...
### GetAllBackends (impostazione predefinita)
```
...
Dettagli del backend configurato nel servizio di gestione API.

### IList<Microsoft. Azure. Commands. ApiManagement. ServiceManagement. Models. PsApiManagementBackend>
Elenco di backend configurato nel servizio di gestione API.
