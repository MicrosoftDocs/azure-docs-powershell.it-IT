...
Per eseguire il comando, è possibile che venga usato un server nel gruppo di failover. I valori restituiti riflettono lo stato del server specificato rispetto al gruppo di failover.
