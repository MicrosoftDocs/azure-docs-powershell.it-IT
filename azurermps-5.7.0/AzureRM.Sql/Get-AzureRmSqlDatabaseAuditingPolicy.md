...
## Descrizione
Il cmdlet **Get-AzureRmSqlDatabaseAuditingPolicy** ottiene i criteri di controllo di un database SQL di Azure.
Per usare il cmdlet, usare i parametri *ResourceGroupName* , *ServerName* e *DatabaseName* per identificare il database.

## ESEMPI

### Esempio 1: ottenere i criteri di controllo di un database SQL di Azure con il controllo della tabella definito
```
...
### Esempio 2: ottenere i criteri di controllo di un database SQL di Azure con il controllo BLOB definito
```
PS C:\>Get-AzureRmSqlDatabaseAuditingPolicy -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
DatabaseName           : database01
AuditAction            : {}
