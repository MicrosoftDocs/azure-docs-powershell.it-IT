...
## Descrizione
Questo comando Aggiorna il server in cui punta l'alias. 

Questo comando deve essere emesso durante l'accesso all'abbonamento in cui si trova il nuovo server a cui punta l'alias.
