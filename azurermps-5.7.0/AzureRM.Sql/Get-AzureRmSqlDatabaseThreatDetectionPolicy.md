...
## Descrizione
Il cmdlet **Get-AzureRmSqlDatabaseThreatDetectionPolicy** ottiene i criteri di rilevamento delle minacce di un database SQL di Azure.
Per usare questo cmdlet, specificare i parametri *ResourceGroupName* , *ServerName* e *DatabaseName* per identificare il database per cui questo cmdlet ottiene i criteri.

## ESEMPI

### Esempio 1: ottenere i criteri di rilevamento delle minacce per un database
```
...
Questo comando consente di ottenere i criteri di rilevamento delle minacce per un database denominato Database01.
