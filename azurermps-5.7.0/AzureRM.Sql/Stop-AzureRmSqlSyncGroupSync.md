...
## Descrizione
Il cmdlet **Stop-AzureRmSqlSyncGroupSync** interrompe la sincronizzazione di un gruppo di sincronizzazione.
...
Questo comando interrompe la sincronizzazione in corso per il gruppo di sincronizzazione mysg.
