...
## Descrizione
Il cmdlet **Suspend-AzureRmSqlDatabase** sospende un database di Azure SQL data warehouse.
...
## Note
* Il cmdlet **Suspend-AzureRmSqlDatabase** funziona solo nei database di Azure SQL data warehouse. Questa operazione non è supportata nelle edizioni Basic, standard e Premium di Azure SQL.
