...
## Descrizione
Il cmdlet **set-AzureRmSchedulerJobCollection** modifica una raccolta processi in Azure Scheduler.
...
### -Posizione
Specifica l'area di Azure in cui è presente la raccolta processi.
...
### -MaxJobCount
Specifica il numero massimo di processi che è possibile creare nella raccolta processi.
...
### -ResourceGroupName
Specifica il gruppo di risorse della raccolta processi.
