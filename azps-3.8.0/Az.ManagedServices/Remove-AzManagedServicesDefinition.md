...
Rimuove la definizione di registrazione assegnata all'identificatore.
...
Rimuove la definizione di registrazione in base all'ID risorsa completo. 
...
Elimina la definizione di registrazione in base all'oggetto.
...
### -ID
Identificatore della definizione di registrazione.
...
### -ResourceId
ResourceId della definizione di registrazione
