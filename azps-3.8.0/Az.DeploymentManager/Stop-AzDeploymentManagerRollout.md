...
## Descrizione
Il cmdlet **Stop-AzDeploymentManagerRollout** interrompe l'implementazione in corso e restituisce un oggetto che rappresenta lo stato corrente dell'implementazione.
...
Tieni presente che una volta arrestata l'implementazione, non può essere ripresa o riavviata. È possibile creare una nuova implementazione solo.
...
Questo comando interrompe un'implementazione denominata ContosoRollout in ContosoResourceGroup. 

### Esempio 2: interrompere l'implementazione usando l'identificatore delle risorse
```powershell
...
### Esempio 3: interrompere l'implementazione usando l'oggetto di implementazione.
```powershell
PS C:\> Get-AzDeploymentManagerRollout -InputObject $rolloutObject
```

Questo comando interrompe un implementazione il cui nome e ResourceGroup corrispondono rispettivamente alle proprietà Name e ResourceGroupName della $rolloutObject.
...
### -InputObject
L'implementazione da rimuovere.
