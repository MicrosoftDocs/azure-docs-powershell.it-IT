...
## Descrizione
Il cmdlet **New-AzDeploymentManagerService** crea un servizio in una topologia di servizio e restituisce un oggetto che rappresenta tale servizio.
Specificare il servizio in base al nome, alla topologia del servizio e al nome del gruppo di risorse. 

Il cmdlet restituisce un oggetto servizio. Puoi modificare l'oggetto localmente e quindi applicare le modifiche al servizio usando il cmdlet Set-AzDeploymentManagerService.
...
Crea un nuovo servizio con nome ContosoService1 in topologia di servizio ContosoServiceTopology nel gruppo risorse ContosoResourceGroup, nella posizione centrale degli Stati Uniti. La proprietà TargetLocation indica che il servizio ContosoService1 deve essere distribuito nell'area est degli Stati Uniti nella sottoscrizione specificata.
...
### -Posizione
Posizione della risorsa del servizio.
...
### -ServiceTopologyName
Nome della topologia del servizio a cui appartiene il servizio.
...
### -TargetLocation
Determina la posizione in cui verranno distribuite le risorse del servizio.
...
Determina la sottoscrizione a cui verranno distribuite le risorse del servizio.
