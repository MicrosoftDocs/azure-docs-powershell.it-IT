...
## Descrizione
Il cmdlet **Get-AzBatchAccount** ottiene un account batch di Azure nell'abbonamento corrente. Puoi usare il parametro *AccountName* per ottenere un singolo account oppure puoi usare il parametro *ResourceGroupName* per ottenere gli account in tale gruppo di risorse.

## ESEMPI

### Esempio 1: ottenere un account batch per nome
```
...
Questo comando consente di ottenere gli account batch associati al gruppo di risorse CmdletExampleRG.

## PARAMETRI

### -AccountName
Specifica il nome di un account.
Se specifichi un nome account, questo cmdlet restituisce solo l'account.
...
Se si specifica un gruppo di risorse, questo cmdlet ottiene gli account nel gruppo di risorse specificato.
...
### -Tag
Coppie chiave-valore in forma di tabella hash. Ad esempio: @ {Key0 = "value0"; Key1 = $null; key2 = "value2"} questo cmdlet ottiene gli account che contengono i tag specificati da questo parametro.
