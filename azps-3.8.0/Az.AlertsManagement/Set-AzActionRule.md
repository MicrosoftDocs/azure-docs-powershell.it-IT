...
Questo cmdlet crea una regola di azione per Supression.
...
Questo cmdlet crea una regola di azione per il gruppo di azioni.
...
Questo cmdlet crea una regola di azione per le impostazioni di diagnostica.
...
Formato previsto-{ \< Operation \> : \< elenco di valori separati da virgole \> } per EG.
