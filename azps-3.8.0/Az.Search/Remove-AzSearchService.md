...
## Descrizione
Il cmdlet **Remove-AzSearchService** rimuove un servizio di ricerca di Azure con parametri specificati.
...
Nell'esempio viene rimosso un servizio di ricerca di Azure.
