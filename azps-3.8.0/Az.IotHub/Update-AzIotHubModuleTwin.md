...
## Descrizione
Aggiorna o sostituisce un dispositivo Twin. https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-devguide-module-twinsPer altre informazioni, vedere.
...
Restituisce l'oggetto Twin del modulo di dispositivo aggiornato.
...
Restituisce l'oggetto Twin del modulo di dispositivo con le proprietà desiderate aggiornate.
...
Restituisce l'oggetto Twin Device module con la proprietà Tags aggiornata.
...
Restituisce l'oggetto Twin Device module sostituito.
...
### -Desiderato
Aggiungere o aggiornare la proprietà desiderata in un modulo Twin.
...
### -Parziale
Consente di aggiornare solo parzialmente i tag e le proprietà desiderate di un modulo Twin.
...
### -Tag
Aggiungere o aggiornare la proprietà Tags in un modulo Twin.
