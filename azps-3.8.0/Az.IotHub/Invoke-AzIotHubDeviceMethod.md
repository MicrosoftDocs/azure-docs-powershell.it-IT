...
## Descrizione
Richiamare un metodo diretto in un dispositivo. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsPer altre informazioni, vedere.
...
Richiama un metodo di dispositivo.

## PARAMETRI

### -ConnectionTimeOut
Numero di secondi di attesa finché non viene eseguita correttamente una connessione.
...
### -Nome
Nome del metodo da richiamare su questo dispositivo.
...
### -Payload
Payload per il metodo da richiamare su questo dispositivo.
...
### -ResponseTimeOut
Numero di secondi di attesa finché non viene ricevuto un risultato dal metodo Direct.
Il valore predefinito è 10.
