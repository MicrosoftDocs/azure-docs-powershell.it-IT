...
## Descrizione
Verificare un certificato caricando un certificato di verifica contenente il codice di verifica ottenuto chiamando genera-verifica-codice. Questo è l'ultimo passaggio del processo di prova del possesso.
...
Verificare la proprietà della chiave privata "certificato".
...
Verificare la proprietà della chiave privata "certificato" usando pipeline.

## PARAMETRI

### -Certificate
Nome del certificato del servizio di provisioning dei dispositivi molto
