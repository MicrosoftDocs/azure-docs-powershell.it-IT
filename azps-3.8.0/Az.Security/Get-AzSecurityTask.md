...
## Descrizione
Azure Security Center analizza le risorse per individuare potenziali problemi di sicurezza.
Questo cmdlet consente di individuare le attività di sicurezza consigliate da Azure Security Center.
...
Ottiene tutte le attività di sicurezza individuate nelle risorse all'interno di un abbonamento.
...
Ottiene una specifica attività di sicurezza.
