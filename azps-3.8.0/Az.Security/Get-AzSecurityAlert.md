...
ms.locfileid: "94022643"
---
# <span data-ttu-id="1ad8a-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="1ad8a-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="1ad8a-102">Sinossi</span><span class="sxs-lookup"><span data-stu-id="1ad8a-102">SYNOPSIS</span></span>
<span data-ttu-id="1ad8a-103">Ottiene gli avvisi di sicurezza rilevati da Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="1ad8a-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="1ad8a-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="1ad8a-104">SYNTAX</span></span>

### <span data-ttu-id="1ad8a-105">SubscriptionScope (impostazione predefinita)</span><span class="sxs-lookup"><span data-stu-id="1ad8a-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="1ad8a-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="1ad8a-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="1ad8a-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="1ad8a-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="1ad8a-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="1ad8a-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="1ad8a-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="1ad8a-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="1ad8a-110">Descrizione</span><span class="sxs-lookup"><span data-stu-id="1ad8a-110">DESCRIPTION</span></span>
<span data-ttu-id="1ad8a-111">Ottiene gli avvisi di sicurezza rilevati da Azure Security Center</span><span class="sxs-lookup"><span data-stu-id="1ad8a-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="1ad8a-112">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="1ad8a-112">EXAMPLES</span></span>

### <span data-ttu-id="1ad8a-113">Esempio 1</span><span class="sxs-lookup"><span data-stu-id="1ad8a-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="1ad8a-114">Ottiene tutti gli avvisi di sicurezza rilevati sulle risorse all'interno di un abbonamento</span><span class="sxs-lookup"><span data-stu-id="1ad8a-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="1ad8a-115">Esempio 2</span><span class="sxs-lookup"><span data-stu-id="1ad8a-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="1ad8a-116">Ottiene tutti gli avvisi di sicurezza rilevati sulle risorse all'interno del gruppo di risorse "myService1"</span><span class="sxs-lookup"><span data-stu-id="1ad8a-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="1ad8a-117">Esempio 3</span><span class="sxs-lookup"><span data-stu-id="1ad8a-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="1ad8a-118">Ottiene un avviso di sicurezza specifico rilevato sulle risorse all'interno del gruppo di risorse "myService1"</span><span class="sxs-lookup"><span data-stu-id="1ad8a-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="1ad8a-119">PARAMETRI</span><span class="sxs-lookup"><span data-stu-id="1ad8a-119">PARAMETERS</span></span>

### <span data-ttu-id="1ad8a-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="1ad8a-120">-DefaultProfile</span></span>
<span data-ttu-id="1ad8a-121">Le credenziali, l'account, il tenant e l'abbonamento usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="1ad8a-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="1ad8a-122">-Posizione</span><span class="sxs-lookup"><span data-stu-id="1ad8a-122">-Location</span></span>
<span data-ttu-id="1ad8a-123">Posizione.</span><span class="sxs-lookup"><span data-stu-id="1ad8a-123">Location.</span></span>
...
### <span data-ttu-id="1ad8a-124">-Nome</span><span class="sxs-lookup"><span data-stu-id="1ad8a-124">-Name</span></span>
<span data-ttu-id="1ad8a-125">Nome risorsa.</span><span class="sxs-lookup"><span data-stu-id="1ad8a-125">Resource name.</span></span>
...
### <span data-ttu-id="1ad8a-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="1ad8a-126">-ResourceGroupName</span></span>
<span data-ttu-id="1ad8a-127">Nome del gruppo di risorse.</span><span class="sxs-lookup"><span data-stu-id="1ad8a-127">Resource group name.</span></span>
...
### <span data-ttu-id="1ad8a-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="1ad8a-128">-ResourceId</span></span>
<span data-ttu-id="1ad8a-129">ID risorsa.</span><span class="sxs-lookup"><span data-stu-id="1ad8a-129">Resource ID.</span></span>
...
### <span data-ttu-id="1ad8a-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="1ad8a-130">CommonParameters</span></span>
<span data-ttu-id="1ad8a-131">Questo cmdlet supporta i parametri comuni:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose,-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="1ad8a-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="1ad8a-132">Per altre informazioni, Vedi about_CommonParameters ( http://go.microsoft.com/fwlink/?LinkID=113216) .</span><span class="sxs-lookup"><span data-stu-id="1ad8a-132">For more information, see about_CommonParameters (http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="1ad8a-133">INGRESSI</span><span class="sxs-lookup"><span data-stu-id="1ad8a-133">INPUTS</span></span>

### <span data-ttu-id="1ad8a-134">System. String</span><span class="sxs-lookup"><span data-stu-id="1ad8a-134">System.String</span></span>

## <span data-ttu-id="1ad8a-135">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="1ad8a-135">OUTPUTS</span></span>

### <span data-ttu-id="1ad8a-136">Microsoft. Azure. Commands. Security. Models. alerts. PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="1ad8a-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="1ad8a-137">Note</span><span class="sxs-lookup"><span data-stu-id="1ad8a-137">NOTES</span></span>

## <span data-ttu-id="1ad8a-138">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="1ad8a-138">RELATED LINKS</span></span>
