...
## Descrizione
Il cmdlet **New-AzDataBoxEdgeRole** crea un nuovo ruolo per un dispositivo Edge della casella dati.
...
### -ConnectionString
Per specificare stringhe di connessione
...
### -DeviceProperty
Per specificare le proprietà del dispositivo
...
### -IotDeviceAccessKey
Tasto di accesso del dispositivo
...
Fornisci la stringa di connessione del dispositivo per gli altri
...
### -IotDeviceId
ID dispositivo del dispositivo per gli altri dispositivi
...
Chiave di accesso del dispositivo Edge
...
Fornisci la stringa di connessione del dispositivo Edge
...
### -RoleStatus
Specificare lo stato di attivazione/disattivazione
