...
## Descrizione
Il cmdlet **New-AzDataBoxEdgeUser** crea un nuovo utente per il dispositivo Edge della casella dati. È supportata la creazione di solo utenti di tipo `Share` .
...
### -Password
Password, specificare una stringa sicura
