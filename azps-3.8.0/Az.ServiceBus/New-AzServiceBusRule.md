...
## Descrizione
Il cmdlet **New-AzServiceBusRule** crea una nuova regola per la sottoscrizione specificata.
...
Il cmdlet New-AzServiceBusRule crea una nuova regola per l'abbonamento specificato.
...
Il cmdlet New-AzServiceBusRule crea una nuova regola per l'abbonamento specificato con ActionFilter.

## PARAMETRI

### -ActionSqlExpression
Espressione SqlFilter azione
...
Azione richiede la pre-elaborazione
