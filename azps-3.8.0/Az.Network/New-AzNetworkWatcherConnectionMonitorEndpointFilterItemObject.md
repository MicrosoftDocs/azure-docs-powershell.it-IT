...
## Descrizione
Il cmdlet New-AzNetworkWatcherConnectionMonitorEndpointFilterItemObject crea l'elemento filtro endpoint.
...
Digitare: AgentAddress Indirizzo: 10.0.0.1

## PARAMETRI

### -Address
Indirizzo dell'elemento filter.
...
### -Digitare
Tipo di elemento incluso nel filtro. Attualmente è supportato solo "AgentAddress".
