...
## Descrizione
Il cmdlet New-AzNetworkWatcherConnectionMonitorTestGroupObject crea un gruppo di test per il monitoraggio della connessione.

## ESEMPI

### Esempio 1: creare un gruppo di test con 2 testConfigurations, w source e 2 endpoint di destinazione
...
### -Destinazione
Elenco di endpoint di destinazione.
