...
### HostedGatewayParameterSet (impostazione predefinita)
```
...
### -HostedGateway
Il gateway in cui è necessario ospitare il router virtuale.
...
### -HostedGatewayId
ID del gateway in cui è necessario ospitare il router virtuale.
