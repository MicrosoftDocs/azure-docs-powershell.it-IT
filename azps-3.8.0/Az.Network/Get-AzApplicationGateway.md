...
### Esempio 4: ottenere un elenco dei gateway delle applicazioni in una sottoscrizione tramite filtro
```
...
Questo comando consente di ottenere un elenco di tutti i gateway dell'applicazione nell'abbonamento che iniziano con "ApplicationGateway01" e lo archivia nella variabile $AppGwList.
