...
Questo esempio crea un endpoint privato con ID del servizio di collegamento privato specifico in una subnet specifica in una rete virtuale.
...
Connessione del servizio di collegamento privato.
