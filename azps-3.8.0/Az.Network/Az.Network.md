...
Restituire tipi di endpoint privati disponibili nella posizione
...
Crea una configurazione di URL di regole di riscrittura per un gateway applicazione
...
Crea un endpoint di monitoraggio della connessione.
...
Rimuove un monitor di connessione.

### [Remove-AzNetworkWatcherFlowLog](Remove-AzNetworkWatcherFlowLog.md)
Rimuove una risorsa del log di flusso.
...
Aggiornare una risorsa del log di flusso.
...
Disconnettere la connessione VPN del gateway di rete virtuale.

### [Disconnetti-AzP2sVpnGatewayVpnConnection](Disconnect-AzP2sVpnGatewayVpnConnection.md)
Scollegare la connessione VPN del gateway VPN di P2S.
