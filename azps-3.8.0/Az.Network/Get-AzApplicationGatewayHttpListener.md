...
## Descrizione
Il cmdlet **Get-AzApplicationGatewayHttpListener** ottiene il listener HTTP di un gateway dell'applicazione.
...
### -ApplicationGateway
Specifica l'oggetto gateway dell'applicazione che contiene il listener HTTP.
...
### -Nome
Specifica il nome del listener HTTP ottenuto da questo cmdlet.
