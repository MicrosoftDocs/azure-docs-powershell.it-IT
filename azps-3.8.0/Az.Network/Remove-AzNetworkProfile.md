...
## Descrizione
Il cmdlet **Remove-AzNetworkProfile** rimuove un profilo di rete se non sono state create interfacce di rete di contenitori (in contrapposizione a una **configurazione** di interfaccia di rete contenitore).
...
In questo articolo viene rimosso il profilo di rete con il nome NP1 dal gruppo di risorse RG1.
...
### -ResourceId
ID risorsa di Azure Resource Manager del profilo di rete.
