...
## Descrizione
Il cmdlet **Remove-AzPublicIpPrefix** rimuove un prefisso IP pubblico di Azure purché non siano stati assegnati indirizzi IP pubblici.
...
Rimuove il prefisso IP pubblico con il nome $prefixName dal gruppo di risorse $rgName
...
### -ResourceId
ResourceId per la risorsa da rimuovere
