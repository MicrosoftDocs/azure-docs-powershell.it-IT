...
### 1: eliminare un gateway di rete virtuale
```
Remove-AzVirtualNetworkGateway -Name myGateway -ResourceGroupName myRG
```

Elimina l'oggetto del gateway di rete virtuale con il nome "gateway" nel gruppo di risorse "myRG" Nota: per prima cosa è necessario eliminare tutte le connessioni al gateway di rete virtuale usando il cmdlet **Remove-AzVirtualNetworkGatewayConnection** .
...
### -Nome
Specifica il nome del gateway di rete virtuale rimosso da questo cmdlet.
