...
## Descrizione
Il **nuovo AzApplicationGatewayFirewallPolicySetting** crea una delle impostazioni dei criteri per un criterio firewall.
...
Il comando crea un'impostazione di criteri con lo stato come $enabledState, modalità come $enabledMode, RequestBodyCheck come false, FileUploadLimitInMb come $fileUploadLimitInMb e MaxRequestBodySizeInKb come $ $maxRequestBodySizeInKb.
La nuova policySettings è archiviata in $condition.
...
Disabilita il requestBodyCheck nelle impostazioni dei criteri del criterio firewall.
...
MaxRequestBodySizeInKb in impostazioni dei criteri del criterio firewall.
...
### -Modalità
Modalità firewall in impostazioni dei criteri del criterio firewall.
...
### -Stato
Variabile di stato nelle impostazioni dei criteri del criterio firewall.
