...
New-AzExpressRouteGateway crea un gateway ExpressRoute scalabile. Questa è la connettività definita dal software per la premessa ad Azure all'interno del VirtualHub. 

Questo gateway può essere ridimensionato in base all'unità di scala specificata in questo o nel cmdlet Set-AzExpressRouteGateway. 

Una connessione viene configurata da un circuito di ExpressRoute locale al gateway scalabile.

Il ExpressRouteGateway sarà nella stessa posizione della VirtualHub a cui si fa riferimento.
