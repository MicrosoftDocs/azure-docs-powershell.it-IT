...
## Descrizione
Il cmdlet **Get-AzP2sVpnGatewayDetailedConnectionHealth** consente di ottenere informazioni dettagliate sulle connessioni del punto corrente a quelle del sito da P2SVpnGateway. Il cliente deve passare l'URL SAS in cui è possibile inserire queste informazioni dettagliate sull'integrità.
...
Il cmdlet **Get-AzP2sVpnGatewayDetailedConnectionHealth** consente di ottenere informazioni dettagliate sulle connessioni del punto corrente a quelle del sito da P2SVpnGateway. Il cliente può scaricare i dettagli sull'integrità da download di URL SAS passati. In questo modo verranno visualizzate le informazioni di ogni collegamento al sito con nomi utente, byte in, byte fuori, indirizzo IP allocato e così via.
...
### -OutputBlobSasUrl
URL di OutputBlob SAS a cui verrà scritta l'integrità della connessione VPN di P2S.
...
### -VpnUserNamesFilter
L'elenco dei nomi utente di P2S VPN da filtrare.
