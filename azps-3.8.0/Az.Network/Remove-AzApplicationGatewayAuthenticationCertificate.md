...
## Descrizione
Il cmdlet **Remove-AzApplicationGatewayAuthenticationCertificate** rimuove un certificato di autenticazione da un gateway dell'applicazione Azure.

## ESEMPI

### Esempio 1: rimuovere un certificato di autenticazione da un gateway applicazione
```
...
Il secondo comando rimuove il certificato di autenticazione denominato cert01 dal gateway dell'applicazione.
