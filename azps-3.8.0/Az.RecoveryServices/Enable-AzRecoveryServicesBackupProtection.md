...
## Descrizione
Il cmdlet **Enable-AzRecoveryServicesBackupProtection** imposta i criteri di protezione di Azure Backup su un elemento.
...
### -ExclusionDisksList
Elenco dei LUN del disco da escludere nel backup
...
### -InclusionDisksList
Elenco dei LUN del disco da includere nel backup
...
### -ProtectableItem
Valore di filtro per lo stato di job.
