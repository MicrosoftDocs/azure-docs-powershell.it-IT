...
## Descrizione
Il cmdlet **set-AzRecoveryServicesVaultProperty** aggiorna le proprietà di un Vault di servizi di ripristino.
Puoi usare il cmdlet **set-AzRecoveryServicesVaultProperty** per ottenere le proprietà correnti di un Vault.
L'uso di questo cmdlet **SoftDeleteFeatureState** proprietà di un Vault può essere abilitato in qualsiasi momento.
La proprietà **SoftDeleteFeatureState** di un Vault può essere disabilitata solo se non sono presenti contenitori registrati nel Vault.
