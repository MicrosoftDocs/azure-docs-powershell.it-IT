...
## Descrizione
Il cmdlet **Update-AzRecoveryServicesAsrMobilityService** cerca di spingere gli aggiornamenti degli agenti del servizio di mobilità in computer protetti (se è disponibile un aggiornamento).
...
Processo per tenere traccia dell'agente del servizio di mobilità dell'elemento protetto della replica di aggiornamento.

## PARAMETRI

### -Account
ID account RunAs da usare per spingere l'aggiornamento. Deve essere uno dall'elenco di account RunAs nel tessuto ASR corrispondente al computer da aggiornare.
...
Elemento protetto della replica del ripristino del sito di Azure da aggiornare.
