...
L'uso del parametro FriendlyName può determinare la restituzione di più di una condivisione di file Azure. In questi casi, usare il parametro Name con il valore parameter come proprietà Name restituita nella variabile $BackupItem.
