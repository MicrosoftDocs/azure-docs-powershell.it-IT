...
## Descrizione
Il cmdlet **New-AzRecoveryServicesAsrFabric** crea un tessuto di recupero del sito di Azure del tipo specificato.
...
### -Azure
Parametro switch specifica la creazione di un tessuto Azure.
