...
## Descrizione
Esporta i dati statistici sulle chiamate dell'abbonamento all'API Microsoft. COMPUTE per successo, errore o stato strozzato, in intervalli di tempo predefiniti. I registri possono essere ulteriormente raggruppati per tre parametri: GroupByOperationName, GroupByThrottlePolicy o GroupByResourceName.
Tieni presente che questo cmdlet raccoglie solo i registri del provider di risorse COMPUTE; Inoltre, i dati relativi ai tipi di risorsa disco e snapshot non sono ancora disponibili.
