...
Fornisci questo oggetto al cmdlet New-AzContainerService per creare un servizio contenitore.
...
Il comando specifica le varie impostazioni per la configurazione del servizio contenitore. Il comando passa l'oggetto Configuration al cmdlet Add-AzContainerServiceAgentPoolProfile usando l'operatore pipeline. Questo cmdlet aggiunge un profilo del pool di agenti.
Specifica l'oggetto in $Container per il parametro *ContainerService* di **New-AzContainerService**.
