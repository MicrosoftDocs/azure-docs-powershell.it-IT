...
### Esempio 2: ottenere le versioni di un'immagine di estensione con il filtro sulla versione
```
...
Questo comando consente di ottenere tutte le versioni dell'immagine dell'estensione per la posizione, l'editore, il tipo e la versione specificati a partire da 12.

### Esempio 3: ottenere le versioni di un'immagine di estensione con il filtro sulla versione
```
...
Questo comando consente di ottenere tutte le versioni dell'immagine dell'estensione per la posizione, l'editore, il tipo e la versione specificati.
