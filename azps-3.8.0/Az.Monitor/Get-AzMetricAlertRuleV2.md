...
## Descrizione
Il cmdlet **Get-AzMetricAlertRuleV2** ottiene una regola di avviso metrica in base al nome o all'URI o a tutte le regole di avviso metriche da un gruppo di risorse o da un abbonamento specificato.

## ESEMPI

### Esempio 1: ottenere tutte le regole di avviso metriche nell'abbonamento corrente
```powershell
...
Questo comando consente di ottenere tutte le regole di avviso metriche nell'abbonamento corrente.

### Esempio 2: ottenere tutte le regole di avviso metriche in un gruppo di risorse
...
Questo comando consente di ottenere tutte le regole di avviso metriche nel gruppo di risorse denominato metricAlertsRG.

### Esempio 3: ottenere una regola di avviso metrica per nome
...
Questo comando consente di ottenere la regola di avviso metrica denominata PS3182019 nel gruppo di risorse denominato metricAlertsRG.

### Esempio 4: ottenere una regola di avviso metrica da ruleID
...
Questo comando consente di ottenere la regola di avviso metrica con l'ID risorsa specificata.
...
### -ResourceId
ID regola della regola di avviso metrica
