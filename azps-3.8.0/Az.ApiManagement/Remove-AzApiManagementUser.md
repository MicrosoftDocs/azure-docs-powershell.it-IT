...
## Descrizione
Il cmdlet **Remove-AzApiManagementUser** Elimina un utente esistente.
...
Questo comando Elimina un utente esistente.
...
Se questo parametro non viene specificato e esiste un abbonamento, questo cmdlet genera un'eccezione.
...
### -PassThru
Indica che questo cmdlet restituisce un valore di $Ture, se ha esito positivo o un valore di $False, in caso contrario.
...
### -UserId
Specifica l'ID dell'utente da rimuovere.
