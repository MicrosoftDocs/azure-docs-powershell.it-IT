...
## Descrizione
Il cmdlet **Get-AzLogicAppTriggerCallbackUrl** ottiene un URL di callback del trigger dell'app logica da un gruppo di risorse.
Questo cmdlet restituisce un oggetto **WorkflowTriggerCallbackUrl** che rappresenta l'URL di callback.
Specificare il nome del gruppo di risorse, il nome dell'app logica e il nome del trigger.
...
### Esempio 1: ottenere un URL di callback del trigger dell'app logica
```
...
Questo comando consente di ottenere un URL di callback dell'app logica.
