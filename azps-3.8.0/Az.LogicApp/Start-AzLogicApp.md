...
## Descrizione
Il cmdlet **Start-AzLogicApp** esegue un'app logica usando la funzionalità delle app logiche.
Specificare un nome, un gruppo di risorse e un trigger.
...
### Esempio 1: eseguire un'app logica
```
PS C:\>Start-AzLogicApp -ResourceGroupName "ResourceGroup11" -Name "LogicApp03" -TriggerName "Trigger22"
```

Questo comando esegue l'app logica nel gruppo risorse denominato ResourceGroup11.
...
### -Nome
Specifica il nome dell'app logica avviata da questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene l'app logica avviata da questo cmdlet.
...
### -Triggername
Specifica il nome del trigger dell'app logica avviata da questo cmdlet.
