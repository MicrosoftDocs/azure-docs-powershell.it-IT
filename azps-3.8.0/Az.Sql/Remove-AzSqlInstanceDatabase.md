...
### RemoveInstanceDatabaseFromInputParameters (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Remove-AzSqlInstanceDatabase** rimuove un database di istanze gestite di Azure SQL.

## ESEMPI

### Esempio 1: rimuovere un database da un'istanza
```
PS C:\>Remove-AzSqlInstanceDatabase -Name "Database01" -InstanceName "managedInstance1" -ResourceGroupName "ResourceGroup01"
```

Questo comando rimuove il database denominato Database01 dall'istanza managedInstance1.
...
### -InputObject
Oggetto database dell'istanza da rimuovere
...
### -Nome
Nome del database dell'istanza SQL di Azure da rimuovere.
...
### -ResourceId
ID risorsa dell'oggetto di database di istanza da rimuovere
