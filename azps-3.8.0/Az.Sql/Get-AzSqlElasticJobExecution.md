...
## Descrizione
Il cmdlet Get-AzSqlElasticJobExecution ottiene una o più esecuzioni dei processi

## ESEMPI

### Esempio 1: ottiene una o più esecuzioni di processo in tutti i processi
```
...
### Esempio 2: ottiene una o più esecuzioni di processi per un processo
```
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
