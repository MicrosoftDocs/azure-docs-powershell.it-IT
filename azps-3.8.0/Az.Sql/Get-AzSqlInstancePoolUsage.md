...
### InstancePoolUsageDefaultParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzSqlInstancePoolUsage** restituisce informazioni sull'utilizzo di un pool di istanze di Azure SQL.

## ESEMPI

### Esempio 1: Ottiene l'utilizzo di un pool di istanze SQL di Azure
```powershell
...
Ottiene l'utilizzo per il pool di istanze SQL di Azure instancepool0.

### Esempio 2: Ottiene l'utilizzo di un pool di istanze SQL di Azure usando un oggetto pool di istanze
```powershell
...
Ottiene l'utilizzo per il pool di istanze SQL di Azure instancepool0 usando un oggetto pool di istanze.

### Esempio 3: Ottiene l'utilizzo di un pool di istanze SQL di Azure usando un ID risorsa di pool di istanze
```powershell
...
Ottiene l'utilizzo per il pool di istanze SQL di Azure instancepool0 usando un identificatore di risorsa del pool di istanze.

### Esempio 3: Ottiene l'utilizzo di un pool di istanze SQL di Azure con una ripartizione degli usi delle istanze gestite all'interno del pool.
```powershell
...
Ottiene l'utilizzo per il pool di istanze SQL di Azure instancepool0 insieme agli usi delle istanze gestite in instancepool0.
...
### -ExpandChildren
Flag che indica se espandere l'utilizzo di questo pool di istanze con l'utilizzo dei relativi elementi figlio.
...
### -Nome
Nome del pool di istanze gestito.
