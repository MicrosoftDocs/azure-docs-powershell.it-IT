...
## Descrizione
Il cmdlet **Get-AzSqlServerServiceObjective** ottiene gli obiettivi di servizio disponibili per un server di database SQL di Azure.
...
Questo comando consente di ottenere gli obiettivi di servizio per il server denominato Server01.

### Esempio 2: ottenere gli obiettivi di servizio tramite filtro
```
...
Questo comando consente di ottenere gli obiettivi di servizio per il server denominato Server01 che iniziano con "System".

### Esempio 3: ottenere gli obiettivi di servizio per una posizione
```
...
Questo comando ottiene gli obiettivi di servizio per un'area di Azure specificata.
...
### -Posizione
Nome della posizione per cui ottenere gli obiettivi di servizio.
