...
## Descrizione
Il cmdlet **Disable-AzSqlServerAdvancedDataSecurity Disabilita** la sicurezza dei dati avanzata in un server.

## ESEMPI

### Esempio 1
### Esempio 1-disabilitare la sicurezza dei dati avanzata del server
```powershell
...
### Esempio 2-disabilitare la sicurezza dei dati avanzata del server dalla risorsa server
```powershell
