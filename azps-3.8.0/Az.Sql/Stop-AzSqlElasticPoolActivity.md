...
## Descrizione
Il cmdlet **Stop-AzSqlElasticPoolActivity** Annulla l'operazione di aggiornamento asincrono in un pool elastico.
...
Questo comando Annulla l'operazione di aggiornamento asincrono sul pool elastico.
...
### -ElasticPoolName
Il nome del pool di Azure SQL elastico.
