...
## Descrizione
Il cmdlet **Get-AzSqlServer** restituisce informazioni su uno o più server di database SQL di Azure.
...
### Esempio 4: ottenere tutte le istanze di SQL Server assegnate a un gruppo di risorse tramite filtro
```
...
Questo comando consente di ottenere informazioni su tutti i server di database SQL di Azure assegnati al gruppo di risorse ResourceGroup01 che iniziano con "Server".
