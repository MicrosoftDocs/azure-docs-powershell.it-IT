...
## Descrizione
Il cmdlet **New-AzSqlDatabaseCopy** crea una copia di un database SQL di Azure che usa lo snapshot dei dati in corrispondenza dell'ora corrente. Usa questo cmdlet invece del cmdlet Start-AzSqlDatabaseCopy per creare una copia di un database unica. Questo cmdlet restituisce l'oggetto di **database** della copia.
Nota: usare il cmdlet New-AzSqlDatabaseSecondary per configurare la replica geografica per un database.
...
### -ComputeGeneration
Generazione di Compute da assegnare alla nuova copia.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene il database da copiare.
...
### -Tag
Specifica le coppie chiave-valore nella forma di una tabella hash da associare alla copia del database SQL di Azure. Ad esempio: @ {Key0 = "value0"; Key1 = $null; key2 = "value2"}
...
### -VCore
I numeri Vcore della copia del database SQL di Azure.
