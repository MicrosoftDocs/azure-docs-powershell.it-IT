...
## Descrizione
Il cmdlet **Get-AzSqlDatabaseAudit** ottiene le impostazioni di controllo di un database SQL di Azure.
Per usare il cmdlet, usare i parametri *ResourceGroupName* , *ServerName* e *DatabaseName* per identificare il database.

## ESEMPI

### Esempio 1: recuperare le impostazioni di controllo di un database SQL di Azure
```
...
### Esempio 2: ottenere, tramite pipeline, le impostazioni di controllo di un database SQL di Azure
```
...
### Esempio 3: ottenere le impostazioni di controllo di un database SQL di Azure
```
PS C:\>Get-AzSqlDatabaseAudit -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -DatabaseName "Database01"
ServerName                          : server01
DatabaseName                        : database01
