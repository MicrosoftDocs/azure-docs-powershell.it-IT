...
## Descrizione
Il cmdlet **Get-AzSqlServerAudit** ottiene le impostazioni di controllo di un server SQL di Azure.
...
### Esempio 2: ottenere, tramite pipeline, le impostazioni di controllo di un server SQL di Azure
```
...
### Esempio 3: ottenere le impostazioni di controllo di un server SQL di Azure
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
