...
### Esempio 3: ottenere i primi 2 ticket di supporto filtrati in base allo stato
```powershell
...
### Esempio 3: ottenere tutti i ticket di supporto in stato aperto e creati dopo il 20 dicembre 2019
```powershell
