...
### Esempio 1: ottenere tutti i problemi di classificaitons per un servizio tramite il parametro ID servizio.
```powershell
...
### Esempio 2: ottenere tutti i problemi di classificaitons per un servizio tramite l'oggetto servizio padre
```powershell
...
### Esempio 3: ottenere i dettagli di un singolo problema classificaiton dall'oggetto servizio di ID tramite piping
```powershell
...
### -ServiceId
ID servizio per cui vengono recuperate tutte le classificazioni dei problemi.
...
### -ServiceObject
Oggetto servizio per cui vengono recuperate le classificazioni dei problemi.
