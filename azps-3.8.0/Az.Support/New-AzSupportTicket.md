...
### Esempio 15: creare un ticket di supporto specificando i singoli parametri di contatto del cliente anziché l'oggetto CustomerContactDetail. 
```powershell
...
### Esempio 16: creare un ticket di supporto con la richiesta di risposta 24 x 7 da Azure. 
```powershell
