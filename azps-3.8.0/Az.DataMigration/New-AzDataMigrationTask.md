...
## Descrizione
Il cmdlet New-AzDataMigrationTask crea l'attività di migrazione dei dati. Questo cmdlet accetta i parametri per l'enumeratore dei tipi di attività, il gruppo di risorse Azure, il nome del servizio di migrazione del database Azure associato e il progetto come input. 
...
### -MigrationValidation 
Oggetto risposta attività tramite chiamata di convalida, facoltativo ma consigliato.
...
### -Wait
Se aspettare che l'attività finisca. Se il contrassegno è impostato, controlla ogni 1 secondo finché l'attività non termina e restituisce all'utente le proprietà dell'attività in cui è possibile controllare l'output o l'errore. 
```yaml
