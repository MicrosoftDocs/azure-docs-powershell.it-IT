...
## Descrizione
Il cmdlet **New-AzOperationalInsightsLinuxSyslogDataSource** aggiunge un'origine dati syslog ai computer Linux collegati in un'area di lavoro.
Le informazioni operative di Azure possono raccogliere dati syslog.

## ESEMPI

### Esempio 1: creare origini dati syslog
```
$FacilityNames       = @()
$FacilityNames      += 'auth'
...
### -CollectAlert
Indica che gli approfondimenti operativi raccolgono i messaggi di avviso.
...
### -CollectCritical
Indica che gli approfondimenti operativi raccolgono messaggi critici.
...
### -CollectDebug
Indica che gli approfondimenti operativi raccolgono i messaggi di debug.
...
### -CollectEmergency
Indica che gli approfondimenti operativi raccolgono messaggi di emergenza.
...
### -CollectError
Indica che gli approfondimenti operativi raccolgono i messaggi di errore.
...
### -CollectInformational
Indica che gli approfondimenti operativi raccolgono i messaggi informativi.
...
### -CollectWarning
Indica che il syslog include messaggi di avviso.
...
### -Struttura
Specifica un codice di struttura.
...
### -Nome
Specifica un nome per l'origine dati. Il nome non viene esposto nel portale di Azure e qualsiasi stringa può essere usata purché sia univoca.
