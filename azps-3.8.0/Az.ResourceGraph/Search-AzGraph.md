...
```
Query contenente tutte le macchine virtuali che non usano dischi gestiti e include nomi visualizzati in abbonamento.
...
```
Query che Visualizza il numero di risorse per i nomi visualizzati tenant e Subscription.
