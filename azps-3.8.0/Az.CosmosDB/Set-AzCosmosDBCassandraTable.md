...
## Sinossi
Imposta la tabella CosmosDB Cassandra.
...
## Descrizione
Il cmdlet **set-AzCosmosDBCassandraTable** imposta lo spazio per la CosmosDB Cassandra.
...
Oggetto Resource contiene i valori delle proprietà _rid, _ts, _etag, DefaultTtl e schema.
...
USA New-AzCosmosDBCassandraSchema per creare questo oggetto.
