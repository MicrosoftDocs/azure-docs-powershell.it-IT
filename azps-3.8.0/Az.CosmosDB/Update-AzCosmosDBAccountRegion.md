...
## Descrizione
Aggiornare le aree geografiche di un account di CosmosDB. La posizione può essere fornita come oggetto di tipo PSLocation o come stringhe di nome di posizione ordinate per priorità di failover.
Il parametro LocationObject prevede l'elenco delle posizioni correnti (il failover prioritiies incluso) accodato dal nuovo LocationObjects che corrisponde a nuove posizioni da aggiungere.
Il parametro location prevede l'elenco della posizione corrente (ordinata per priorità di failover) e delle nuove posizioni. Tieni presente che supportiamo solo l'aggiunta di aree geografiche. Fornisci una posizione o LocationObject.
