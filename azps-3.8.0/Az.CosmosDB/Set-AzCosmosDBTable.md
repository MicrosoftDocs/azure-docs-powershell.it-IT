...
## Descrizione
Il cmdlet **set-AzCosmosDBTable** crea una nuova tabella o aggiorna una tabella esistente, sostituendo completamente la tabella esistente.
...
### -Throughput
La velocità effettiva della tabella (RU/s).
