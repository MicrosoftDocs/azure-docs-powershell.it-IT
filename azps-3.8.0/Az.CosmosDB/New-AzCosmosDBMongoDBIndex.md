...
## Sinossi
Crea un nuovo indice MongoDB di CosmosDB.
...
## Descrizione
Il **nuovo AzCosmosDBMongoDBIndex** crea un nuovo indice MongoDB di CosmosDB.
...
### -Key
Matrice di valori chiave come stringhe.
...
### -TtlInSeconds
Numero di secondi dopo il quale l'indice scade.
