...
## Sinossi
Imposta lo spazio di CosmosDB Cassandra.
...
## Descrizione
Il cmdlet **set-AzCosmosDBCassandraKeyspace** imposta lo spazio per la CosmosDB Cassandra.
...
Oggetto Resource contiene i valori delle proprietà _rid, _ts, _etag.
