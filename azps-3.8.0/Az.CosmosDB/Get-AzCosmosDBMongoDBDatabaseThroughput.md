...
## Sinossi
Ottiene le proprietà della velocità effettiva CosmosDB del database MongoDB.
...
## Descrizione
Il cmdlet **Get-AzCosmosDBMongoDBDatabaseThroughput** ottiene le proprietà throughput del database MongoDB.
