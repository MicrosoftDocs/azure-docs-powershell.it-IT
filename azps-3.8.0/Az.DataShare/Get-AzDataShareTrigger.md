...
## Descrizione
Il cmdlet **Get-AzDataShareTrigger** ottiene le informazioni sul trigger per l'abbonamento alla condivisione in account di condivisione dati.
...
Questo comando consente di ottenere informazioni su trigger AdsTrigger per l'abbonamento alla condivisione AdsShareSubscription in WikiAds account di condivisione dati.
