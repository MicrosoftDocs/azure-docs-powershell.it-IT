...
## Descrizione
Questo comando Annulla la sottoscrizione del trigger di evento agli eventi del servizio esterno specificati dal trigger definizione.
...
Questo comando consente di annullare l'abbonamento a BlobEnetTrigger1 trigger agli eventi specificati dal trigger definizione.
...
### -PassThru
Se specificato, cmdlet restituirà return true per l'eliminazione corretta.
