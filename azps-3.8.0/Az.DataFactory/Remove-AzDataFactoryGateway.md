...
## Descrizione
Il cmdlet **Remove-AzDataFactoryGateway** rimuove il gateway specificato da Azure Data Factory.

## ESEMPI

### Esempio 1: rimuovere un gateway
```
...
Questo comando rimuove il gateway denominato ContosoGateway dalla data factory denominata WikiADF.

## PARAMETRI

### -DataFactory
Specifica un oggetto **PSDataFactory** .
Questo cmdlet consente di rimuovere un gateway dalla data factory specificata da questo parametro.
...
### -Force
Indica che questo cmdlet rimuove un gateway senza richiedere conferma.
...
### -Nome
Specifica il nome del gateway da rimuovere.
...
Questo cmdlet consente di rimuovere un gateway che appartiene al gruppo specificato da questo parametro.
