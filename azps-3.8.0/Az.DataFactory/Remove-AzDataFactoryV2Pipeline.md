...
## Descrizione
Il cmdlet Remove-AzDataFactoryV2Pipeline consente di rimuovere una pipeline da Azure Data Factory.
...
Questo cmdlet consente di rimuovere la pipeline specificata da questo parametro.
...
### -ResourceId
ID risorsa Azure della pipeline da rimuovere.
