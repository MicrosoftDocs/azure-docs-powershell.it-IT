...
## Descrizione
Il cmdlet **Get-AzNetAppFilesVolume** ottiene i dettagli di un volume di ANF.
...
Questo comando ottiene il volume denominato MyAnfVolume dal pool "MyAnfPool". 
...
### -PoolObject
Oggetto pool che contiene il volume da restituire
