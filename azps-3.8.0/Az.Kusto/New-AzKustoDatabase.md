...
### Esempio 1-creare un nuovo database di Kusto in base al nome
...
Il comando precedente crea un nuovo database di Kusto denominato "mykustodatabase" nel cluster esistente "mykustocluster" disponibile nel gruppo di risorse "testrg".

## PARAMETRI

### -Clustername
Nome del cluster in cui si vuole creare il database.
...
Numero di giorni di dati che devono essere conservati nella cache per le query veloci.
...
Il numero di giorni di dati deve essere mantenuto prima che smetta di essere accessibile alle query.
