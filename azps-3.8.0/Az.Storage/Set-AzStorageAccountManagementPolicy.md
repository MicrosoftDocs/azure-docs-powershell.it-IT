...
### Esempio 1: creare o aggiornare i criteri di gestione di un account di archiviazione con gli oggetti della regola ManagementPolicy.
```
...
Questo comando crea prima di tutto 2 oggetti della regola ManagementPolicy, quindi crea o aggiorna i criteri di gestione di un account di archiviazione con i 2 oggetti della regola ManagementPolicy.
...
Questo comando crea o aggiorna i criteri di gestione di un account di archiviazione con un criterio in formato JSON.

### Esempio 3: ottenere i criteri di gestione da un account di archiviazione e impostarlo su un altro account di archiviazione.
```
...
Questo comando ottiene prima i criteri di gestione da un account di archiviazione, quindi lo imposta su un altro account di archiviazione.
...
### -Regola
Regole dei criteri di gestione. Ottenere l'oggetto con il cmdlet New-AzStorageAccountManagementPolicyRule.
