...
### -Firmatario
Specifica il token Web JSON RFC7519 che contiene un'attestazione denominata "AAS-policyCertificate" il cui valore è una chiave Web JSON di RFC7517 che contiene una nuova chiave di firma attendibile da aggiungere.
