...
## Descrizione
Il cmdlet **Get-AzAutomationDscNodeConfigurationDeployment** distribuisce una configurazione di nodi DSC (APS desired state Configuration) in Azure Automation.

## ESEMPI

### Esempio 1: ottenere tutte le pianificazioni di distribuzione
```
...
### -JobScheduleId
Specifica l'ID pianificazione processo di un processo di distribuzione pianificata esistente.
