...
## Descrizione
Il cmdlet **Get-AzAutomationSchedule** ottiene una pianificazione di Azure Automation.
...
Specifica il nome di un account di automazione per cui questo cmdlet ottiene una programmazione.
...
### -Nome
Specifica il nome di una pianificazione ottenuta da questo cmdlet.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse per cui questo cmdlet ottiene una programmazione.
