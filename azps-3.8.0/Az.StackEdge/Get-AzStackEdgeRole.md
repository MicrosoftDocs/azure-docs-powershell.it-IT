...
## Descrizione
Il cmdlet **Get-AzStackEdgeRole** recupera i ruoli disponibili per un dispositivo Edge dello stack. Puoi menzionare il parametro Name per ottenere i dettagli di un ruolo specifico.
