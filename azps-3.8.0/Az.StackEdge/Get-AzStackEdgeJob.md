...
## Descrizione
Il cmdlet **Get-AzStackEdgeJob** ottiene i processi attivi in un dispositivo Edge dello stack. Puoi menzionare il parametro Name per ottenere i dettagli di un processo specifico.
