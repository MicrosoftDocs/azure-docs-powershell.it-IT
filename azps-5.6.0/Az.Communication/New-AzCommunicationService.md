...
### Esempio 1: Creare una risorsa ACS
```powershell
...
Crea una risorsa ACS usando i parametri specificati.
...
### -DataLocation
Posizione in cui il servizio di comunicazione archivia i dati archiviati.
...
### -Location
Posizione di Azure in cui è in esecuzione CommunicationService.
