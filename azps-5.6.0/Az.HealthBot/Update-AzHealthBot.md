...
### Esempio 1: aggiornare HealthBot in base al nome e al nome del gruppo di risorse
```powershell
...
Aggiornare HealthBot in base al nome del gruppo di risorse e al nome

### Esempio 2: aggiornare HealthBot per InputObject
```powershell
...
Aggiornare HealthBot per InputObject
