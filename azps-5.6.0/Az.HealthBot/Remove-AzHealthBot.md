...
### Esempio 1: Eliminare HealthBot in base al nome e al nome ResourceGroupName
```powershell
PS C:\> Remove-AzHealthBot -Name yourihealthbot -ResourceGroupName youriTest

```

Eliminare HealthBot per NomeGruppo ResourceGroup e Nome

### Esempio 2: Eliminare HealthBot per InputObject
```powershell
...
Eliminare HealthBot per InputObject
