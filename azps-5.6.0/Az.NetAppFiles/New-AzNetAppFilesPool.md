...
## DESCRIZIONE
Il cmdlet **New-AzNetAppFilesPool** crea un pool ANF.

## ESEMPI

### Esempio 1: Creare un pool ANF
```
...
Questo comando crea il nuovo pool ANF "MyAnfPool" all'interno dell'account "MyAnfAccount".
...
### -AccountObject
Account per il nuovo oggetto pool
...
### -ServiceLevel
Livello di servizio del pool ANF
