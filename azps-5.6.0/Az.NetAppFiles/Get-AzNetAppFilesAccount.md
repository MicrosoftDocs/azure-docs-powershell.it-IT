...
## DESCRIZIONE
Il cmdlet **Get-AzNetAppFilesAccount** ottiene i dettagli di un account ANF.

## ESEMPI

### Esempio 1: Ottenere un account ANF
```
...
Questo comando recupera l'account denominato AccountAnf.
