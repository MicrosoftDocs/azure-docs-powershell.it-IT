...
## DESCRIZIONE
Il cmdlet **New-AzNetAppFilesActiveDirectory** crea un nuovo criterio di backup per un account ANF.
...
Questo comando crea il nuovo criterio di backup ANF per l'account ANF denominato account "MyAccount".
...
### -AccountObject
Oggetto Account per il nuovo criterio di backup
...
### -DailyBackupsToKeep
Conteggio dei backup giornalieri da mantenere
