...
Questo comando ottiene lo stato di replica su MyVol

## PARAMETERS

### -AccountName
Nome dell'account ANF del volume di destinazione della replica
...
### -PoolName
Nome del pool ANF del volume di destinazione della replica
