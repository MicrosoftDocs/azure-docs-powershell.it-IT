...
## DESCRIZIONE
Il cmdlet **Get-AzNetAppFilesBackup** ottiene i dettagli di un backup ANF.
...
Questo comando recupera il backcup denominato "MyAnfAccount" dal volume denominato "MyVolume".
