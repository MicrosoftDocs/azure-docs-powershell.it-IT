...
## DESCRIZIONE
Il cmdlet **Get-AzNetAppFilesPool** ottiene i dettagli di un pool ANF.

## ESEMPI

### Esempio 1: Ottenere un pool ANF
```
...
Questo comando recupera l'account denominato MyAnfPool dall'account "MyAnfAccount".
...
### -AccountObject
Oggetto account contenente il pool da restituire
...
### -ResourceGroupName
Gruppo di risorse del pool ANF
