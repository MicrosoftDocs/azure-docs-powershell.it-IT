...
## DESCRIZIONE
Il cmdlet **Remove-AzNetAppFilesPool** elimina un pool ANF.
...
Questo comando elimina il pool ANF "MyAnfPool".
...
### -AccountObject
Oggetto account contenente il pool da rimuovere
...
### -PassThru
Restituire se il pool specificato è stato rimosso correttamente
