...
## DESCRIZIONE
Il cmdlet **New-AzNetAppFilesBackup** crea un backup per un volume ANF.
...
Questo comando crea il nuovo backup ANF per il volume denominato account "MyVolume".
...
### -VolumeObject
Volume del nuovo oggetto di backup
