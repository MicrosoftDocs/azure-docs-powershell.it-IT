...
## DESCRIZIONE
Il cmdlet **Update-AzNetAppFilesPool** modifica un pool ANF.

## ESEMPI

### Esempio 1: Modificare un pool ANF
```
...
Questo comando modifica le dimensioni e QosType del pool ANF "MyAnfPool".
...
### -AccountObject
Oggetto account contenente il pool da aggiornare
...
### -QosType
Il tipo di qos della pool. I valori possibili includono" "Auto", "Manuale"
