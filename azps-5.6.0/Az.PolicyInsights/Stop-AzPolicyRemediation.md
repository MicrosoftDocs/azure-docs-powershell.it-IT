...
## DESCRIZIONE
Il cmdlet **Stop-AzPolicyRemediation** annulla una correzione dei criteri in corso. Le distribuzioni attive verranno annullate e non verranno create nuove distribuzioni.

## ESEMPI

### Esempio 1: Annullare la correzione di un criterio nell'ambito del gruppo di risorse
```
...
### Esempio 2: Annullare la correzione di un gruppo di gestione tramite piping
```
