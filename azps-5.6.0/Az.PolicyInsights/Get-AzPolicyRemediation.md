...
## SYNOPSIS
Recupera le correzioni dei criteri.
...
## DESCRIZIONE
Il cmdlet **Get-AzPolicyRemediation** ottiene tutte le correzioni dei criteri in un ambito o in una particolare correzione.
...
Questo comando recupera tutte le correzioni create in corrispondenza o sotto un abbonamento denominato "Abbonamento".

### Esempio 2: Ottenere una correzione dei criteri specifica e i dettagli della distribuzione
```
PS C:\> Get-AzPolicyRemediation -ResourceGroupName "myResourceGroup" -Name "remediation1" -IncludeDetail
```

Questo comando recupera la correzione denominata 'remediation1' dal gruppo di risorse 'myResourceGroup'. Verranno inclusi i dettagli delle risorse da correggere.
...
Questo comando ottiene al massimo 10 correzioni dei criteri da un gruppo di gestione denominato "mg1". Verranno recuperate solo le correzioni dei criteri per l'assegnazione di criteri specificata.
...
### -IncludeDetail
Includere i dettagli delle distribuzioni create dalla correzione.
