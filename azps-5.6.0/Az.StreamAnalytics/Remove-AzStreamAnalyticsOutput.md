...
## DESCRIZIONE
Il cmdlet **Remove-AzStreamAnalyticsOutput** elimina in modo asincrono un output da un processo di Analisi di flusso in Azure.

## ESEMPI

### ESEMPIO 1: Rimuovere un output da un processo
```
PS C:\>Remove-AzStreamAnalyticsOutput -ResourceGroupName "StreamAnalytics-Default-West-US" -JobName "StreamingJob" -Name "Output"
```

Questo comando rimuove l'output di output nel processo StreamingJob.
...
### -Name
Specifica il nome dell'output di Analisi di flusso di Azure da rimuovere.
