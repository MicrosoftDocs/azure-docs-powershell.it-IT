...
## DESCRIZIONE
Il cmdlet **Get-AzStreamAnalyticsInput** elenca tutti gli input definiti in un processo di Analisi di flusso o ottiene informazioni su un input specifico.
...
### -Name
Specifica il nome dell'input di Analisi di flusso di Azure da recuperare.
