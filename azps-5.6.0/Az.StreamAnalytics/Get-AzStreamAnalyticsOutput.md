...
## SYNOPSIS
Ottiene gli output definiti in un output o in un processo di Analisi di flusso specificato.
...
## DESCRIZIONE
Il cmdlet **Get-AzStreamAnalyticsOutput** elenca tutti gli output definiti in un processo specifico di Analisi di flusso o riceve informazioni su un output specifico.

## ESEMPI

### Esempio 1: Ottenere informazioni sugli output di processo
```powershell
...
### -JobName
Specifica il nome del processo di Analisi di flusso di Azure a cui appartiene l'output di Analisi di flusso di Azure.
...
### -Name
Specifica il nome dell'output di Analisi di flusso di Azure da recuperare.
