...
## SYNOPSIS
Abilita i suggerimenti di Azure Advisor.
...
## DESCRIZIONE
Questo cmdlet abilita un suggerimento non eliminato in precedenza. È possibile rimuovere anche tutte le eliminazioni associate a un consiglio.
...
Rimuove tutte le eliminazioni per il consiglio specificato con il nome "recommendation_id".
...
Rimuove tutte le eliminazioni per i suggerimenti dati passati dalla pipeline.
