...
## DESCRIZIONE
Il cmdlet **Remove-AzCognitiveServicesAccountNetworkRule** rimuove IpRules o VirtualNetworkRules dalla proprietà NetWorkRule di un account di Servizi cognitivi
...
Questo comando rimuove diverse IpRules con IPAddressOrRange.

### Esempio 2: Rimuovere un valore VirtualNetworkRule con l'input dell'oggetto VirtualNetworkRule con JSON
```
...
Questo comando rimuove un valore VirtualNetworkRule con l'input dell'oggetto VirtualNetworkRule con JSON.

### Esempio 3: Rimuovere la prima regola IpRule con pipeline
```
...
Questo comando rimuove la prima regola IpRule con pipeline.

### Esempio 4: Rimuovere più RegoleRelavoro VirtualNet con VirtualNetworkResourceID
```
...
### -IpAddressOrRange
Account dei servizi cognitivi NetworkRule IpRules IpAddressOrRange nella stringa.
...
### -IpRule
Account dei servizi cognitivi NetworkRule IpRules.
...
### -Name
Nome account di Servizi cognitivi.
...
Account dei servizi cognitivi NetworkRule VirtualNetworkRules VirtualNetworkResourceId nella stringa.
...
### -VirtualNetworkRule
Account di Servizi cognitivi NetworkRule VirtualNetworkRules.
