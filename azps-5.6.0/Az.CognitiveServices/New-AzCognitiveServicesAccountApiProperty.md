...
## SYNOPSIS
Generare una nuova istanza di Account ApiProperties di Servizi cognitivi
...
## DESCRIZIONE
Generare una nuova istanza di Account ApiProperties di Servizi cognitivi.
ApiProperties può essere usata quando si crea un nuovo account o si aggiorna un account esistente.
ApiProperties è necessaria per alcuni tipi di account.
...
In questo esempio verrà creato un account QnAMaker con la proprietà API "QnaRuntimeEndpoint".
