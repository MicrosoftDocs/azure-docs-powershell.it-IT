...
Il set di comandi precedente crea un servizio cloud con un unico ruolo e l'estensione RDP
...
L'URL del pacchetto del servizio può essere URI della firma di accesso condiviso da qualsiasi account di archiviazione. Si tratta di una proprietà di sola scrittura e non viene restituita nelle chiamate GET.
...
### -ExtensionProfile
Descrive un profilo dell'estensione del servizio cloud.
