...
## DESCRIZIONE
Il cmdlet **Stop-AzKeyVaultCertificateOperation** annulla un'operazione di certificato nel servizio Azure Key Vault.

## ESEMPI

### Esempio 1: Annullare un'operazione con un certificato
```powershell
...
Questo comando annulla l'operazione sul certificato TestCert02.
