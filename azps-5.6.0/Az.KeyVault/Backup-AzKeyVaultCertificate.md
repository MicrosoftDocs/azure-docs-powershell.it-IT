...
Questo comando recupera il certificato denominato MyCert dal vault delle chiavi denominato MyKeyVault e salva una copia di backup del certificato in un file denominato automaticamente e visualizza il nome file.
