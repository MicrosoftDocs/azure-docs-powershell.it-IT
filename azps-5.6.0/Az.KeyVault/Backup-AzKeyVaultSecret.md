...
Questo comando recupera il segreto denominato MySecret dalla chiave vault denominata MyKeyVault e salva una copia di backup del segreto in un file denominato Backup.BLOB.
...
### -VaultName
Specifica il nome del vault delle chiavi che contiene il segreto di cui eseguire il backup.
