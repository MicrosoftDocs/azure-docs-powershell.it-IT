...
## DESCRIZIONE
Il cmdlet **Set-AzKeyVaultCertificatePolicy** crea o aggiorna il criterio per un certificato in un vault delle chiavi.
...
### -RenewAtPercentageLifetime
Specifica la percentuale di durata al termine del quale ha inizio il processo automatico per il rinnovo del certificato.
