...
## DESCRIZIONE
Il cmdlet **Update-AzKeyVaultCertificate** modifica gli attributi modificabili di un certificato.
...
Il primo comando assegna una matrice di coppie chiave/valore alla $Tags variabile.
Il secondo comando imposta il valore tag del certificato denominato TestCert01 $Tags.

### Esempio 2

Modifica gli attributi modificabili di un certificato. (autogenerati)
...
### -Enable
Se presente, abilitare un certificato se il valore è vero.
Disabilitare un certificato se il valore è falso.
Se non viene specificato, il valore esistente dello stato abilitato/disabilitato del certificato rimane invariato.
...
Se questa opzione è specificata, restituire l'oggetto certificato.
...
### -Tag
Tabella hash che rappresenta i tag di certificato.
Se non viene specificato, i tag esistenti della notifica restano invariati.
...
Il cmdlet crea l'FQDN di un certificato dal nome dell'insieme di credenziali, l'ambiente attualmente selezionato, il nome del certificato e la versione del certificato.
