...
- Importare una chiave dal proprio modulo di sicurezza hardware (HSM) al sistema HMS nel servizio Vault delle chiavi.
...
Per maggiori dettagli, consulta https://docs.microsoft.com/azure/key-vault/keys/hsm-protected-keys
