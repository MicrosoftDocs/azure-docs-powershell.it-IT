...
## DESCRIZIONE
Il cmdlet **Remove-AzKeyVaultCertificateIss cmdlet** elimina un'autorità di certificazione da un vault delle chiavi.

## ESEMPI

### Esempio 1: Rimuovere un'autorità di certificazione
```powershell
...
Questo comando rimuove l'autorità di certificazione denominata TestIssuer01 dal vault della chiave ContosoKV01.
...
### -Name
Specifica il nome dell'autorità emittente da rimuovere.
