...
## DESCRIZIONE
Il cmdlet **Get-AzKeyVaultCertificateContact** ottiene i contatti registrati per le notifiche sui certificati per un vault delle chiavi nel Vault delle chiavi di Azure.
...
Questo comando recupera tutti i contatti per gli oggetti certificato nel vault della chiave Contoso e li archivia nella variabile $Contacts certificato.
