...
## DESCRIZIONE
Il cmdlet **Undo-AzKeyVaultCertificateRemoval** recupera un certificato eliminato in precedenza.
Il certificato recuperato sarà attivo e può essere usato per tutte le operazioni.
...
Questo comando recupererà il certificato 'MyCertificate' eliminato in precedenza, in uno stato attivo e utilizzabile.
...
### -Name
Nome certificato.
Il cmdlet crea l'FQDN di un certificato dal nome del vault, l'ambiente attualmente selezionato e il nome del certificato.
