...
## DESCRIZIONE
Il Set-AzKeyVaultCertificateIssuer cmdlet imposta un'autorità di certificazione in un vault delle chiavi.

## ESEMPI

### Esempio 1: Impostare un'autorità di certificazione
```powershell
...
Questo comando imposta le proprietà per un'autorità di certificazione.

## PARAMETERS

### -AccountId
Specifica l'ID account per l'autorità di certificazione.
...
### -ApiKey
Specifica la chiave API per l'autorità di certificazione.
...
### -InputObject
Specifica l'autorità di certificazione da impostare.
