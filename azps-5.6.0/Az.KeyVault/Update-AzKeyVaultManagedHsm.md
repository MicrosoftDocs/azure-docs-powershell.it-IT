...
## DESCRIZIONE
Questo cmdlet aggiorna lo stato di un servizio HSM gestito da Azure.

## ESEMPI

### Esempio 1: Aggiornare direttamente un file Hsm gestito
```powershell
...
Aggiorna i tag per l'Hsm gestito `$hsmName` denominato nel gruppo di `$resourceGroupName` risorse.

### Esempio 2: Aggiornare un'Hsm gestita tramite piping
```powershell
...
Aggiorna i tag per l'Hsm gestito usando la sintassi di piping.
