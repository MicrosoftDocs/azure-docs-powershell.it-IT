...
## SYNOPSIS
Elencare le definizioni di un determinato HSM gestito in un ambito specifico.
...
L'esempio elenca tutti i ruoli nell'ambito "/keys".
...
L'esempio ottiene il ruolo "Managed HSM Backup" e ne esamina le autorizzazioni.
...
### -RoleDefinitionName
Nome della definizione di ruolo da ottenere.
...
### -Scope
Ambito in cui si applica l'assegnazione o la definizione di ruolo, ad esempio '/' o '/keys' o '/keys/{keyName}'.
