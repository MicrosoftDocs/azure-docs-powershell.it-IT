...
## DESCRIZIONE
Il cmdlet **Remove-AzKeyVaultCertificateOperation** elimina un'operazione di certificato da un vault delle chiavi.
...
Questo comando rimuove l'operazione del certificato denominata TestCert01 dal vault della chiave ContosoKV01 senza chiedere conferma.
