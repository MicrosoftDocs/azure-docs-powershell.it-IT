...
## DESCRIZIONE
Il cmdlet **Get-AzKeyVaultCertificateIss cmdlet** ottiene un'autorità di certificazione specificata o tutte le autorità di certificazione per un vault delle chiavi nel Vault delle chiavi di Azure.

## ESEMPI

### Esempio 1: Ottenere un'autorità di certificazione
```powershell
...
Questo comando recupera l'autorità di certificazione denominata TestIssuer01.

### Esempio 2: Elencare le autorità di certificazione mediante il filtro
```powershell
...
Questo comando recupera le autorità di certificazione che iniziano con "test".
...
### -Name
Specifica il nome dell'autorità di certificazione da ottenere.
