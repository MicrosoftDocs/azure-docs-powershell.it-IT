...
## DESCRIZIONE
Il cmdlet **Set-AzApiManagementManagementManagementmanagement** modifica le impostazioni di un servizio di gestione delle API **di** Azure.
...
Modifica un registro GESTIONE API. (autogenerati)
...
### -ConnectionString
Specifica una stringa di connessione hub eventi di Azure che include i diritti dei criteri di invio.
