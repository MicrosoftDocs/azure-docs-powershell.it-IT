...
## DESCRIZIONE
Il **cmdlet Get-AzApiManagementGateway** ottiene un Gateway di gestione DELLE API o uno specifico.
...
Se specificato, cercherà di trovare il gateway in base all'identificatore.
