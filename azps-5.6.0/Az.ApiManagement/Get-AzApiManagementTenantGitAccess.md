...
## DESCRIZIONE
Il cmdlet **Get-AzApiManagementTenantGitAccess** ottiene la configurazione di accesso Git per un tenant.
Le chiavi non verranno incluse nei dettagli dei risultati. Per ottenere il segreto client, usare **Get-AzApiManagementTenantGitAccessSecret.**
