...
## DESCRIZIONE
Il cmdlet **New-AzApiManagementDiagnostic** crea un'entità di diagnostica nell'ambito globale o in un ambito API specifico.
...
Nell'esempio precedente viene creata una diagnostica per l'API per registrare l'intestazione e `httpbin` 100 byte del corpo `azuremonitor` da sempre.
