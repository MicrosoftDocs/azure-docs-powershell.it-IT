...
Questo comando carica un certificato in Gestione API. Questo certificato può essere usato per l'autenticazione a comune con il back-end mediante criteri.

### Esempio 2

Crea un certificato di gestione API da usare durante l'autenticazione con back-end. (autogenerati)
