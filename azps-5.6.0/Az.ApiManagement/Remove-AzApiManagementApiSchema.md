...
Lo script rimuove lo schema `2` dall'API `echo-api` se non vi si fa riferimento.

### Esempio 2

Lo script rimuove lo schema 2 dall'Api echo-api se non vi si fa riferimento. (autogenerated)
...
### -ResourceId
Arm ResourceId di ApiSchema. Questo parametro è obbligatorio.
