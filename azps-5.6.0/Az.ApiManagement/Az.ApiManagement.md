...
---
# Modulo Az.ApiManagement
## Descrizione
Questo argomento visualizza gli argomenti della Guida per i cmdlet di gestione delle API di Azure.
...
Recupera un segreto client per il server di autorizzazione gestione API.

### [Get-AzApiManagementBackend](Get-AzApiManagementBackend.md)
Ottenere i dettagli del back-end.
...
Recupera i certificati di gestione DELLE API configurati per l'autenticazione reciproca con Back-end nel servizio.
...
Recupera un Gateway di gestione API o uno specifico.

### [Get-AzApiManagementGatewayHostnameConfiguration](Get-AzApiManagementGatewayHostnameConfiguration.md)
Recupera tutta la configurazione del nome host o una specifica per il Gateway esistente.

### [Get-AzApiManagementGatewayKey](Get-AzApiManagementGatewayKey.md)
Recupera le chiavi del gateway esistente
...
Ottenere i dettagli di configurazione del provider di identità.

### [Get-AzApiManagementIdentityProviderClientSecret](Get-AzApiManagementIdentityProviderClientSecret.md)
Ottenere il segreto client del provider di identità.
...
Ottiene un elenco o un determinato valore denominato.

### [Get-AzApiManagementNamedValueSecretValue](Get-AzApiManagementNamedValueSecretValue.md)
Ottiene un valore segreto del valore denominato specifico.
...
Recupera il segreto client del provider OpenID Connect.
...
Ottiene la configurazione di accesso per un tenant.
...
Ottiene le chiavi di configurazione di accesso Git per un tenant.

### [Get-AzApiManagementTenantSyncState](Get-AzApiManagementTenantSyncState.md)
Ottiene lo stato della sincronizzazione più recente tra il database di configurazione e il repository Git.
...
Crea il nuovo schema API nel servizio ApiManagement
...
Crea un nuovo contratto per le credenziali back-end.
...
Crea una nuova diagnostica con ambito globale o ambito API.

### [New-AzApiManagementGateway](New-AzApiManagementGateway.md)
Crea una nuova entità Gateway.
...
Crea un'istanza di **PsApiManagementHttpMessageDiagnostic,** che è un'impostazione diagnostica del messaggio HTTP della diagnostica
...
Creare impostazioni di diagnostica per i messaggi HTTP in arrivo/in uscita al gateway.
...
Creare un nuovo contratto per la posizione delle risorse (usato in Gateway).
...
Pubblica le modifiche da un branch Git nel database di configurazione.

### [Remove-AzApiManagement](Remove-AzApiManagement.md)
Rimuove un servizio di gestione DELLE API.
...
Rimuove una particolare versione di API
...
Rimuove un prodotto di gestione delle API esistente.
...
Ripristina un servizio di gestione API dal BLOB di archiviazione di Azure specificato.
...
Aggiorna un servizio di gestione delle api di Azure

### [Set-AzApiManagementApi](Set-AzApiManagementApi.md)
Modifica un'API.

### [Set-AzApiManagementApiRevision](Set-AzApiManagementApiRevision.md)
Modifica la revisione di un'API
...
Aggiorna un set di versioni dell'API nel contesto di gestione delle API.
...
Modifica un registro API management.
...
Imposta i dettagli del prodotto per la gestione delle API.

### [Set-AzApiManagementSubscription](Set-AzApiManagementSubscription.md)
Imposta i dettagli dell'abbonamento esistente.
...
Aggiorna una specifica versione di Api.

### [Update-AzApiManagementCache](Update-AzApiManagementCache.md)
aggiorna una cache nel servizio di gestione api.
