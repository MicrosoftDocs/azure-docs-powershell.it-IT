...
## DESCRIZIONE
Il **cmdlet Get-AzApiManagementApi** ottiene una o più API Di gestione API Di Azure.
...
Questo comando recupera tutte le API per il contesto specificato.

### Esempio 2: Ottenere un'API di gestione in base all'ID
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementApi -Context $ApiMgmtContext -ApiId $ApiId
```

Questo comando ottiene l'API con l'ID specificato.

### Esempio 3: Ottenere un'API di gestione in base al nome
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementApi -Context $ApiMgmtContext -Name "EchoApi"
```

Questo comando ottiene l'API con il nome specificato.

### Esempio 4: Ottenere un'API di gestione per GatewayId
```
PS C:\>$ApiMgmtContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementApi -Context $ApiMgmtContext -GatewayId "g01"
```

Questo comando ottiene l'API per il valore GatewayId specificato.
...
### -ApiRevision
Identificatore di revisione della specifica revisione api. Questo parametro è facoltativo.
...
### -GatewayId
Se specificato, tenterà di ottenere tutte le API gateway.
