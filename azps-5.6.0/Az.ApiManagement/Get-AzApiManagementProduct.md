...
## DESCRIZIONE
Il cmdlet **Get-AzApiManagementProduct** ottiene un elenco o un prodotto specifico.
...
Questo comando consente di ottenere tutti i prodotti per la gestione delle API.
...
Questo comando consente di ottenere un prodotto di gestione DELLE API in base all'ID.
...
Se specificato, il cmdlet prova a ottenere il prodotto in base al titolo.
