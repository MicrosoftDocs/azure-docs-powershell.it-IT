...
## DESCRIZIONE
Il cmdlet **Remove-AzApiManagementNamedValue** rimuove un valore denominato Gestione API **di** Azure.
...
Questo comando rimuove il valore denominato con ID Property11.
