...
## DESCRIZIONE
Il cmdlet **Set-AzApiManagementApiSchema** modifica uno schema dell'API di gestione delle API di Azure.

## ESEMPI

### Esempio 1: Modifica di uno schema API
```powershell
...
Modifica uno schema API. (autogenerati)
...
### -ResourceId
Arm ResourceId di diagnostica o schema api. Questo parametro è obbligatorio.
...
### -SchemaDocument
Api schema document as a string. Questo parametro è obbligatorio: SchemaDocumentFile non è specificato.
...
ContentType dello schema api. Questo parametro è facoltativo.
...
Percorso del file del documento dello schema API. Questo parametro è obbligatorio. SchemaDocument non è specificato.
...
### -SchemaId
Identificatore dello schema esistente.
Questo parametro è obbligatorio.
