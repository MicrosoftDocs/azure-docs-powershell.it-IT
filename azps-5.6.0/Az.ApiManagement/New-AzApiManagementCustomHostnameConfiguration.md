...
## DESCRIZIONE
Il cmdlet **New-AzApiManagementCustomHostnameConfiguration** è un comando helper che crea un'istanza di **PsApiManagementCustomHostNameConfiguration.**
...
Questo comando crea e inizializza un'istanza **di PsApiManagementCustomHostNameConfiguration** per il portale. Viene quindi creato un nuovo servizio ApiManagement con configurazione di nomi host personalizzati.
...
Configurazione certificato esistente.
...
### -KeyVaultId
KeyVaultId per il segreto in cui è archiviato il certificato SSL personalizzato.
