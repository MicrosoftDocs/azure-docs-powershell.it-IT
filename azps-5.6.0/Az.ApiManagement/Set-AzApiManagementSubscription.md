...
## DESCRIZIONE
Il cmdlet **Set-AzApiManagementSubscription** imposta i dettagli della sottoscrizione esistente.

## ESEMPI

### Esempio 1: Impostare lo stato e le chiavi primaria e secondaria per un abbonamento
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementSubscription -Context $apimContext -SubscriptionId -0123456789 -PrimaryKey "80450f7d0b6d481382113073f67822c1" -SecondaryKey "97d6112c3a8f48d5bf0266b7a09a761c" -State "Active"
```

Questo comando imposta i tasti primario e secondario per un abbonamento e lo attiva.
...
### -ExpiresOn
Specifica la data di scadenza di un abbonamento.
...
### -Name
Specifica il nome di un abbonamento.
...
### -StateComment
Specifica il commento sullo stato della sottoscrizione.
Il valore predefinito di questo parametro è $Null.
...
### -UserId
Proprietario della sottoscrizione. Questo parametro è facoltativo.
