...
Questo comando ottiene lo schema dell'API `5cc9cf67e6ed3b1154e638bd` associato a un'Api `swagger-petstore-extensive` per un determinato contesto ApiManagement.
