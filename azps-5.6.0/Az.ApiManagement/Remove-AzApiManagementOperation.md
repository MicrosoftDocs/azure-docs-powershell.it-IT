...
## DESCRIZIONE
Il cmdlet **Remove-AzApiManagementOperation** rimuove un'operazione esistente.

## ESEMPI

### Esempio 1: Rimuovere un'operazione API esistente
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Remove-AzApiManagementOperation -Context $apimContext -ApiId "0123456789" -OperationId "9876543210" -Force
```

Questo comando rimuove un'operazione API esistente.
...
### -ApiRevision
Identificatore della revisione API. Questo parametro è facoltativo. Se non è specificato, l'operazione verrà rimossa dalla revisione dell'API attualmente attiva.
...
### -PassThru
Indica che questo cmdlet restituisce il valore $True se ha esito positivo oppure un valore $False, in caso contrario.
