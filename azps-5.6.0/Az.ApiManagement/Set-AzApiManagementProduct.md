...
## DESCRIZIONE
Il cmdlet **Set-AzApiManagementProduct** imposta i dettagli del prodotto gestione API.
...
Questo comando aggiorna i dettagli del prodotto per la gestione delle API, richiede una sottoscrizione e quindi annulla la pubblicazione.
...
Il valore predefinito per questo parametro è Nessuno.
