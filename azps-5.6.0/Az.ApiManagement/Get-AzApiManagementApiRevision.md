...
### Esempio 1: Ottenere tutte le revisioni delle API di un'API
```powershell
...
Questo comando recupera tutta la revisione dell'API specificata per uno specifico contesto ApiManagement.
