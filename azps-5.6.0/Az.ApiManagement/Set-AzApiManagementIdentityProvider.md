...
Aggiorna la configurazione di un provider di identità esistente. (autogenerati)
...
### -PassThru
Indica che questo cmdlet restituisce  **PsApiManagementIdentityProvider** che questo cmdlet modifica.
...
### -SigninTenant
Accedi al tenant per eseguire l'override in AAD B2C invece che nel `common` tenant
...
### -SignupPolicyName
Nome del criterio di iscrizione. Si applica solo al provider di identità B2C di AAD. Questo parametro è facoltativo.
