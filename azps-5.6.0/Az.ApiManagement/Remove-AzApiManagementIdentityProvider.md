...
Elimina la configurazione correlata alla configurazione del provider di identità di Facebook.
...
### -PassThru
Indica che questo cmdlet restituisce un valore di $True se l'operazione riesce o se $False in caso contrario.
