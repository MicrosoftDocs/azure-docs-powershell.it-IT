...
Se non viene fornito il nome dell'argomento relativo al dominio, viene restituito un elenco di argomenti di dominio sotto il nome di dominio specificato. Il numero di elementi restituiti in questo elenco è controllato dal parametro Top. Se non si specificato il valore Massimo o $null, l'elenco conterrà tutti gli elementi degli argomenti di dominio. In caso contrario, Top indicherà il numero massimo di elementi da restituire nell'elenco.
