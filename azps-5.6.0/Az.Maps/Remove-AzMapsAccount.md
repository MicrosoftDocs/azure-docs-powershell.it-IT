...
## DESCRIZIONE
Il Remove-AzMapsAccount cmdlet elimina l'account di Azure Maps specificato.
...
Elimina l'account MyAccount dal gruppo di risorse MyResourceGroup.
...
Elimina l'account di Azure Maps specificato.
...
### -PassThru
Indica se l'account specificato è stato eliminato o meno.
