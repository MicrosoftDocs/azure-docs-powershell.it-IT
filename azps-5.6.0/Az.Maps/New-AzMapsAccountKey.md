...
## DESCRIZIONE
Il cmdlet New-AzMapsAccountKey rigenera una chiave API per un account di Azure Maps.
...
Rigenera la chiave API primaria per l'account MyAccount nel gruppo di risorse MyResourceGroup.
