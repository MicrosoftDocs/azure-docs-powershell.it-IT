...
## DESCRIZIONE
Il Get-AzDataFactoryV2Dataset cmdlet recupera informazioni sui set di dati in Data factory di Azure.
...
### -Name
Specifica il nome del set di dati su cui ottenere informazioni.
