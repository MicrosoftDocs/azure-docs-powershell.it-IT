...
## DESCRIZIONE
Il cmdlet **Stop-AzDataFactoryV2IntegrationRuntime** interrompe un runtime di integrazione dedicato gestito in stato "Avviato", che è stato avviato dal cmdlet Start-AzDataFactoryV2IntegrationRuntime. Le risorse vengono rilasciate e lo stato viene trasferire in "Arrestato".

## ESEMPI

### Esempio 1: Arrestare un runtime di integrazione gestita in stato "Avviato".
```
...
Il runtime di integrazione gestita 'test-reserlved-ir' è in stato "Avviato". Dopo aver Stop-AzDataFactoryV2IntegrationRuntime cmdlet, le risorse vengono rilasciate e lo stato viene trasferimento a "Arrestato".
