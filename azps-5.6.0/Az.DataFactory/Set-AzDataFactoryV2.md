...
## DESCRIZIONE
Il cmdlet **Set-AzDataFactoryV2** crea un data factory con il nome e la posizione del gruppo di risorse specificati.
Eseguire queste operazioni nell'ordine seguente: -- Creare un data factory.
...
### Esempio 2: Creare una data factory con i dettagli di configurazione del repo usando un oggetto factory esistente.
```
...
Questo comando crea un data factory denominato WikiADF nel gruppo di risorse denominato ADF nella posizione EastUS con la configurazione del controllo del codice sorgente di Azure DevOps.

### Esempio 3: Creare un data factory con i dettagli di configurazione del repo in GitHub usando un nuovo oggetto factory.
```
...
Questo comando crea un data factory denominato WikiADF nel gruppo di risorse denominato ADF nella posizione EastUS con la configurazione del controllo del codice sorgente di GitHub.

## PARAMETERS

### -AccountName
Nome dell'account per la configurazione del repo.
...
### -CollaborationBranch
Ramo di collaborazione per la configurazione del repo.
...
Dizionario contenente i parametri globali del data factory.
...
### -HostName
Nome host per la configurazione del repo di GitHub.
...
### -LastCommitId
L'ultimo ID commit per la configurazione di ripetizione.
...
### -Location
Il data factory viene creato in questa area geografica.
...
### -ProjectName
Nome del progetto Azure DevOps per la configurazione di repo.
...
### -RepositoryName
Nome dell'archivio per la configurazione del repository.
...
### -ResourceId
ID risorsa Azure del data factory V2.
...
### -RootFolder
La cartella radice per la configurazione del repo.
...
### -TenantId
ID tenant per la configurazione del repo di Azure DevOps.
