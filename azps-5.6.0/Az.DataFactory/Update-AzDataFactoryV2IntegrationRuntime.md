...
## DESCRIZIONE
Il cmdlet **Update-AzDataFactoryV2IntegrationRuntime aggiorna** le proprietà di runtime dell'integrazione. Attualmente il cmdlet supporta solo l'aggiornamento di "AutoUpdate" e "AutoUpdateDelayGraf" per il runtime di integrazione self-hosted.
