...
## DESCRIZIONE
Il cmdlet **Invoke-AzDataFactoryV2IntegrationRuntimeUpgrade** aggiorna il runtime di integrazione self-hosted, se la nuova versione è disponibile.

## ESEMPI

### Esempio 1: Aggiorna un runtime di integrazione self-hosted
```
...
Il cmdlet aggiorna il runtime di integrazione self-hosted denominato "test-selfhost-ir" nel data factory 'test-df-eu2'.
