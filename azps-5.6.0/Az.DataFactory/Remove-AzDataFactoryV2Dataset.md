...
## DESCRIZIONE
Il cmdlet Remove-AzDataFactoryV2Dataset rimuove un set di dati da Data factory di Azure.

## ESEMPI

### Esempio 1: Rimuovere un set di dati
```
...
Questo comando rimuove il set di dati denominato DAWikiAggregatedData dal data factory denominato WikiADF.
...
Questo cmdlet rimuove un set di dati dal data factory specificato da questo parametro.
...
### -InputObject
Specifica un oggetto Dataset da rimuovere.
...
### -Name
Specifica il nome del set di dati da rimuovere.
...
Questo cmdlet rimuove un set di dati dal gruppo specificato da questo parametro.
