...
## DESCRIZIONE
Il cmdlet **New-AzDataFactoryV2IntegrationRuntimeKey** rigenera la chiave di runtime di integrazione con il nome di chiave specificato dal parametro 'KeyName'. La chiave precedente non è valida.
