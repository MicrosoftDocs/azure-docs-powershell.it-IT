...
## DESCRIZIONE
Il cmdlet **Get-AzDataFactoryV2IntegrationRuntimeNode** ottiene le informazioni dettagliate di un nodo di runtime di integrazione.

## ESEMPI

### Esempio 1: recupera le informazioni dettagliate di un nodo di runtime di integrazione.
```
...
Il cmdlet ottiene le informazioni sul nodo denominato "Node_1" nel runtime di integrazione self-hosted 'test-selfhost-ir' nel data factory 'test-df-eu2'.

### Esempio 2: recupera le informazioni dettagliate di un nodo di runtime di integrazione con l'indirizzo IP.
```
...
Il cmdlet ottiene le informazioni sul nodo denominato "Node_1" nel runtime di integrazione self-hosted 'test-selfhost-ir' nel data factory 'test-df-eu2', incluso l'indirizzo IP.
