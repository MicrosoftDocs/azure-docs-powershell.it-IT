...
## DESCRIZIONE
Questo comando recupera lo stato della sottoscrizione per il trigger di evento per gli eventi del servizio esterno specificati. Il trigger non può essere avviato finché lo stato restituito non è "Abilitato".
...
Questo comando ottiene lo stato del trigger BlobEnetTrigger1 per la sottoscrizione per gli eventi del servizio esterno.
