...
## DESCRIZIONE
Il cmdlet Remove-AzDataFactoryV2IntegrationRuntime rimuove un runtime di integrazione.

## ESEMPI

### Esempio 1: Rimuovere un runtime di integrazione
```
...
Questo comando rimuove il runtime di integrazione denominato "test-reserved-ir" dal data factory denominato "test-df".
...
Nome del data factory collegato.
