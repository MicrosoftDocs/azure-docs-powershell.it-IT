...
## DESCRIZIONE
Il cmdlet **Start-AzDataFactoryV2IntegrationRuntime avvia** un runtime di integrazione dedicato gestito. Viene effettuato il provisioning della risorsa e, dopo l'operazione, lo stato è "Avviato".
