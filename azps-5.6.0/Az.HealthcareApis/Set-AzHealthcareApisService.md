...
## SYNOPSIS
Aggiorna un servizio healthcareApis fhir esistente.
...
### Esempio 1: aggiorna il servizio healthcareapis esistente denominato MyService nel gruppo di risorse MyResourceGroup con il database database OfferThroughput = 500.
...
### Esempio 2: Aggiorna il servizio healthcareapis esistente denominato MyService nel gruppo di risorse MyResourceGroup con il database database OfferThroughput = 500 e l'URI chiave vault chiave "https:// \<my-keyvault> .vault.azure.net/keys/ \<my-key> "
...
Audience HealthcareApis FhirService.
...
### -CorsMethod
Elenco dei metodi Cors di HealthcareApis FhirService.
...
### -HosOfferThroughput
HealthcareApis FhirServiceFerenzasOfferThroughput.
...
### -InputObject
Il servizio HealthcareApis fhir è stato reindirizzato da Get-AzHealthcareApisFhirService.
