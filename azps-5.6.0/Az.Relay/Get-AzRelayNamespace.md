...
## DESCRIZIONE
Il cmdlet **Get-AzRelayLé ottiene** una descrizione per lo spazio dei nomi Relay specificato all'interno del gruppo di risorse.
...
Restituisce una descrizione dello spazio dei nomi Relay specificato.
...
### Microsoft.Azure.Commands.Relay.Models.PSRelayAttributes
