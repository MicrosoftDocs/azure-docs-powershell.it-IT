...
Crea un nuovo modello WcfRelay \` TestWCFRelay nello \` spazio dei nomi Relay specificato \` TestNameSpace-Relay1. \`
...
true se è necessaria l'autorizzazione client per questo inoltro; in caso contrario false
