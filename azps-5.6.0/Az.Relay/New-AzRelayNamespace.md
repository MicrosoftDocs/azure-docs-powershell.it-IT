...
## DESCRIZIONE
Il cmdlet **New-AzRelayLé crea** un nuovo spazio dei nomi Relay. Una volta creato, il manifesto della risorsa dello spazio dei nomi non è modificabile.
...
Crea un nuovo spazio dei nomi Inoltro all'interno del gruppo di risorse specificato.
...
### -Location
Posizione dello spazio dei nomi di inoltro.
