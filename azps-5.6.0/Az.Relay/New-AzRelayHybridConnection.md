...
## DESCRIZIONE
Il cmdlet New-AzRelayHybridConnection crea una connessione HybridConnection nello spazio dei nomi Relay specificato.
...
Crea una nuova connessione HybirdConnection TestHybirdConnection2 nello spazio dei nomi \` \` Relay specificato \` TestNameSpace-HybirdConnection. \`
