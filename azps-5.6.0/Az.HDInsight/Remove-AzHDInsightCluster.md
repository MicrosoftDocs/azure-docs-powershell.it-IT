...
## DESCRIZIONE
Il cmdlet **Remove-AzHDInsightCluster** rimuove il cluster di servizi HDInsight specificato da una sottoscrizione.
...
### Esempio 1: Eliminare un cluster Azure HDInsight
```
...
### -PassThru
Se PassThru è presente, genera l'output del risultato
