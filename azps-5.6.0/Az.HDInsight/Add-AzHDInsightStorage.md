...
## DESCRIZIONE
Il cmdlet **Add-AzHDInsightStorage** aggiunge una voce dell'account di archiviazione di Azure all'oggetto configurazione di Azure HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.
...
Questo comando aggiunge una voce dell'account di archiviazione BLOB alla configurazione HDInsight denominata your-hadoop-001.
...
### -StorageAccountKey
Specifica la chiave dell'account di archiviazione da aggiungere al nuovo cluster.
...
### -StorageAccountName
Specifica il nome dell'account di archiviazione da aggiungere al cluster.
