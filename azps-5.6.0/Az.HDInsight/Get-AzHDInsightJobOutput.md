...
## DESCRIZIONE
Il cmdlet **Get-AzHDInsightJobOutput** ottiene l'output del log per un processo dall'account di archiviazione associato a un cluster Azure HDInsight.
...
Questo comando recupera l'output del log dal cluster denominato your-hadoop-001.
...
Specifica la chiave predefinita dell'account di archiviazione.
...
Specifica il nome predefinito dell'account di archiviazione.
...
### -JobId
Specifica l'ID processo del processo di cui verrà recuperato l'output.
