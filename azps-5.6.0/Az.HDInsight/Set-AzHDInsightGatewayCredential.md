...
## DESCRIZIONE
Il cmdlet **Set-AzHDInsightGatewayCredential** imposta le credenziali del gateway di un cluster Azure HDInsight.
...
Questo comando imposta le credenziali del gateway del cluster denominato your-hadoop-001 in base al set di parametri del nome.
...
Questo comando imposta le credenziali del gateway del cluster denominato your-hadoop-001 in base al set di parametri ResourceId.
...
Questo comando imposta le credenziali del gateway del cluster denominato your-hadoop-001 in base al set di parametri InputObject.
...
### -HttpCredential
Ottiene o imposta l'accesso per l'utente del cluster.
