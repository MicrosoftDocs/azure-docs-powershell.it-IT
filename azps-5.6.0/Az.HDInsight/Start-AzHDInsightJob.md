...
## DESCRIZIONE
Il cmdlet **Start-AzHDInsightJob** avvia un processo definito di Azure HDInsight in un cluster specificato.
Può trattarsi di un processo di MapReduce, di un processo di Streaming MapReduce, di un processo di hive o di maiali.
...
### -JobDefinition
Specifica il processo da avviare nel cluster Azure HDInsight.
