...
## DESCRIZIONE
Il cmdlet **Set-AzHDInsightDefaultStorage** imposta l'impostazione predefinita dell'account di archiviazione nell'oggetto di configurazione del cluster Azure HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.

## ESEMPI

### Esempio 1: Impostare l'account di archiviazione predefinito per l'oggetto di configurazione del cluster
```
...
Questo comando imposta l'account di archiviazione predefinito per un oggetto di configurazione del cluster.
...
### -StorageAccountKey
Specifica la chiave dell'account di archiviazione di Azure predefinito che verrà utilizzato dal cluster HDInsight.
...
Nome dell'account di archiviazione da aggiungere al nuovo cluster.
...
### -StorageAccountType
Ottiene o imposta il tipo di account di archiviazione predefinito. Impostazioni predefinite di AzureStorage
