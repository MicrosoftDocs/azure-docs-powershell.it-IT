...
## SYNOPSIS
Imposta la configurazione della scala automatica di un cluster Azure HDInsight.

## SINTASSI

### LoadAutoscaleByNameParameterSet (impostazione predefinita)
```
...
## DESCRIZIONE
Questo cmdlet **Set-AzHDInsightClusterAutoscaleConfiguration** imposta la configurazione della scala automatica di un cluster Azure HDInsight.

## ESEMPI

### Esempio 1: Impostare la configurazione della gradazione automatica basata sul carico del cluster HDInsight
```powershell
...
Questo comando imposta la configurazione della scala automatica basata sul carico di un cluster Azure HDInsight.

### Esempio 2: Impostare la scala automatica basata su pianificazione del cluster HDInsight
```powershell
...
Questo comando imposta la configurazione della scala automatica basata su pianificazione del cluster HDInsight.

### Esempio 3: Impostare la configurazione della scala automatica del cluster HDInsight basata su un altro cluster che ha impostato la configurazione di gradazione automatica
```powershell
...
Questo comando imposta la configurazione della scala automatica del cluster HDInsight basata su un altro cluster.
...
### -Condizione
Ottiene o imposta la condizione della gradazione automatica basata sulla pianificazione.
...
### -MaxWorkerNodeCount
Ottiene o imposta il numero massimo di workernode della scala automatica basata sul carico.
...
### -MinWorkerNodeCount
Ottiene o imposta il numero minimo di workernode della scala automatica basata sul carico.
...
### -TimeZone
Ottiene o imposta il fuso orario della scala automatica basata sulla pianificazione.
