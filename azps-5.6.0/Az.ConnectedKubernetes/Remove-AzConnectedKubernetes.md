...
## SYNOPSIS
Eliminare un cluster connesso, rimuovendo la risorsa monitorata in Gestione risorse di Azure (ARM).
...
### Esempio 1: Rimuovere un kubernet connesso
```powershell
PS C:\> Remove-AzConnectedKubernetes -ResourceGroupName azureps-manual-test -ClusterName ps-connaks-t01

```

Questo comando rimuove un kubernet connesso

### Esempio 2: Rimuovere un kubernet connesso dall'oggetto
```powershell
...
Questo comando rimuove un kubernet connesso dall'oggetto
...
### -KubeConfig
Percorso del file di configurazione del kube
