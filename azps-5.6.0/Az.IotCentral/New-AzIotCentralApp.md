...
## DESCRIZIONE
Crea una nuova applicazione IoT Central con le proprietà e i metadati forniti. Per un'introduzione a IoT Central, vedere https://docs.microsoft.com/azure/iot-central/ .

## ESEMPI

### Esempio 1: Creare una semplice applicazione ioT central.
```powershell
...
Creare un'applicazione IoT Central nel piano prezzi standard ST2, nell'area del gruppo di risorse.

### Esempio 2: Creare una semplice applicazione ioT central.
```powershell
...
Creare un'applicazione IoT Central con lo standard pricing tier ST2 nell'area "westus", con un nome visualizzato personalizzato basato sul modello iotc-default.
