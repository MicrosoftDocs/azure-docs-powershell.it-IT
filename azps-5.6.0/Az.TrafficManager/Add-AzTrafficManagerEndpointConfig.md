...
## DESCRIZIONE
Il cmdlet **Add-AzTrafficManagerEndpointConfig aggiunge** un endpoint a un oggetto profilo locale di Gestione traffico di Azure.
...
### -CustomHeader
Elenco di coppie di nomi di intestazione e valori personalizzati per le richieste di acquisto.
...
### -GeoMapping
Elenco di aree geografiche mappato a questo endpoint quando si usa il metodo di routing del traffico "Geografico". Per un elenco completo dei valori accettati, consultare la documentazione di Gestione [traffico.](https://docs.microsoft.com/azure/traffic-manager/traffic-manager-geographic-regions)
