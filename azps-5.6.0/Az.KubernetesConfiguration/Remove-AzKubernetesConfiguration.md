...
## SYNOPSIS
In questo modo verrà eliminato il file YAML usato per configurare la configurazione del controllo del codice sorgente, interrompendo così la futura sincronizzazione dal repo di origine.
...
### Esempio 1: Rimuovere la configurazione di un cluster kubernetes in base al nome
```powershell
...
Questo comando rimuove una configurazione del cluster kubernetes in base al nome.

### Esempio 2: Rimuovere una configurazione di kubernetes raggruppate per oggetto
```powershell
...
Questo comando rimuove una configurazione di kubernetes raggruppati per oggetto.
