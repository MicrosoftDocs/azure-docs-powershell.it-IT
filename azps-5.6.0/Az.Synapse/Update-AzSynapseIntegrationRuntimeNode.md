...
## DESCRIZIONE
Il cmdlet **Update-AzSynapseIntegrationRuntimeNode** aggiorna le proprietà del nodo di runtime di integrazione self-hosted in un'area di lavoro. Attualmente supporta solo l'aggiornamento di 'ConcurrentJobsLimit'.
