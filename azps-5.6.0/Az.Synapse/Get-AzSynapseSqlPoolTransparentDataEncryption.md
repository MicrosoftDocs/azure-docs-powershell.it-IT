...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSqlPoolTransparentDataEncryption** ottiene lo stato di Transparent Data Encryption (TDE) per un pool di SQL Azure Synapse Analytics.
...
Questo comando recupera lo stato di TDE per il pool SQL denominato ContosoSqlPool nell'area di lavoro ContosoWorkspace.
