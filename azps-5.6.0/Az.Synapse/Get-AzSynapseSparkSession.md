...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseSparkSession** ottiene informazioni su una sessione di Azure Synapse Analytics Spark.
...
Questo comando recupera tutte le sessioni Spark nel pool di grafici spark specificato.
...
Questo comando recupera la sessione di Spark con l'ID del livy specificato.
...
Questo comando recupera tutte le sessioni spark nel pool spark specificato tramite pipeline.
