...
## DESCRIZIONE
Il cmdlet **Reset-AzSynapseSqlPoolAdvancedThreatProtectionSetting** rimuove le impostazioni di Protezione avanzata dalle minacce da un pool di SQL Azure Synapse Analytics.
...
Questo comando rimuove le impostazioni di protezione avanzata dalle minacce da un pool SQL denominato ContosoSqlPool nell'area di lavoro ContosoWorkspace.
