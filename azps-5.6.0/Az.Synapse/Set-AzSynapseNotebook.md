...
## DESCRIZIONE
Il cmdlet **Set-AzSynapseNotebook** crea o aggiorna un blocco appunti in un'area di lavoro.
...
Questo comando crea o aggiorna un blocco appunti dal file del blocco appunti notebook.ipynb nell'area di lavoro ContosoWorkspace.
...
Questo comando crea o aggiorna un blocco appunti dal file del blocco appunti notebook notebook.ipynb nell'area di lavoro denominata ContosoWorkspace tramite pipeline.
...
Questo comando crea o aggiorna un blocco appunti dal file del blocco appunti notebook notebook.ipynb, che si collega a ContosoSparkPool e usa 2 esecutori nell'area di lavoro denominata ContosoWorkspace.
