...
## SYNOPSIS
Modifica le impostazioni di controllo di un'area di lavoro di Analisi Sinapse di Azure.
...
## DESCRIZIONE
Il cmdlet **Set-AzSynapseSqlAuditSetting** cambia le impostazioni di controllo di un'area di lavoro analisi di Azure Synapse.
...
Abilitare i criteri di controllo dell'archiviazione BLOB di un'area di lavoro di analisi di Azure Synapse denominata ContosoWorkspace.
...
Disabilitare i criteri di controllo dell'archiviazione BLOB di un'area di lavoro di analisi di Azure Synapse denominata ContosoWorkspace.
...
Abilitare i criteri di controllo dell'archiviazione BLOB di un'area di lavoro di analisi Di azure Synapse denominata ContosoWorkspace con filtri avanzati usando un predicato T-SQL.
...
Rimuovere l'impostazione di filtro avanzato dai criteri di controllo di un'area di lavoro di Azure Synapse Analytics denominata ContosoWorkspace.
...
Disabilitare i criteri di controllo dell'archiviazione BLOB di un'area di lavoro di analisi di Azure Synapse denominata ContosoWorkspace tramite pipeline.
