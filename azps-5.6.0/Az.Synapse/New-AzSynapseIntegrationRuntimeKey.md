...
### NewByNameParameterSet (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **New-AzSynapseIntegrationRuntimeKey** rigenera la chiave di runtime di integrazione con il nome di chiave specificato dal parametro 'KeyName'. La chiave precedente non è valida.
...
Il cmdlet rigenera la chiave "authKey2" per il runtime di integrazione denominato "test-selfhost-ir".
...
### -KeyName
Nome della chiave di autenticazione del runtime di integrazione self-hosted.
