...
## DESCRIZIONE
Il cmdlet **Set-AzSynapseSqlPoolAuditSetting** modifica le impostazioni di controllo di un SQL Azure Synapse Analytics.
...
Abilitare i criteri di controllo dell'archiviazione BLOB di un pool di SQL Azure Synapse Analytics denominato ContosoSqlPool.
...
Disabilitare i criteri di controllo dell'archiviazione BLOB di un pool di SQL Azure Synapse Analytics denominato ContosoSqlPool.
...
Abilitare i criteri di controllo dell'archiviazione BLOB di un pool di SQL Azure Synapse Analytics denominato ContosoSqlPool con filtri avanzati usando un predicato di SQL T.
...
Rimuovere l'impostazione di filtro avanzato dai criteri di controllo di un SQL Azure Synapse Analytics denominato ContosoSqlPool.
...
Disabilitare i criteri di controllo dell'archiviazione BLOB di un pool SQL Azure Synapse Analytics denominato ContosoSqlPool tramite pipeline.
...
Si noti che un oggetto nel formato precedente può fare riferimento a un oggetto come una tabella, una visualizzazione o una stored procedure oppure a \[ un intero database o \] schema.
Per gli ultimi casi, vengono usate, rispettivamente, le maschere DATABASE:: \[ nome db e \] SCHEMA:: \[ nome \] schema.
...
Anche questa combinazione è configurata per impostazione predefinita.
Questi gruppi coprono tutte SQL istruzione e le stored procedure eseguite sul database e non devono essere usati insieme ad altri gruppi perché ciò genererà log di controllo duplicati.
