...
## DESCRIZIONE
Il cmdlet **New-AzSynapseFirewallRule** crea una regola firewall di Azure Synapse Analytics.
...
Questo comando crea una regola del firewall denominata ContosoFirewallRule nell'area di lavoro ContosoWorkspace con il nome ContosoFirewallRule.
...
Questo comando crea una regola del firewall denominata ContosoFirewallRule in un'area di lavoro tramite pipeline.
...
Questo comando crea una regola del firewall che consente tutti gli ip azure in un'area di lavoro.

## PARAMETERS

### -AllowAllAzureIP
Crea una regola del firewall speciale che consente l'accesso a tutti gli IP di Azure.
...
### -Name
Nome della regola firerwall per l'area di lavoro.
