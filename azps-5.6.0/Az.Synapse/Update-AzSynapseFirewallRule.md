...
## DESCRIZIONE
Il cmdlet **Update-AzSynapseFirewallRule** modifica una regola del firewall di Azure Synapse Analytics.
...
Questo comando aggiorna la regola del firewall denominata ContosoFirewallRule nell'area di lavoro ContosoWorkspace con il nome ContosoFirewallRule.
...
Questo comando aggiorna la regola del firewall denominata ContosoFirewallRule in un'area di lavoro tramite pipeline.
