...
## DESCRIZIONE
Il cmdlet **Remove-AzSynapseSqlPool** elimina definitivamente un SQL Azure Synapse Analytics.
...
Questo comando elimina un pool di SQL Azure Synapse Analytics.
...
Questo comando elimina un pool di SQL Azure Synapse Analytics tramite pipeline.
...
Questo comando elimina un pool di SQL Azure Synapse Analytics con l'ID risorsa specificato.
