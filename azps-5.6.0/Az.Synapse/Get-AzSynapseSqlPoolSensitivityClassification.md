...
## SYNOPSIS
Recupera i tipi di informazioni correnti e le etichette di riservatezza delle colonne nel SQL pool.
...
## DESCRIZIONE
Il Get-AzSynapseSqlPoolSensitivityClassification cmdlet restituisce i tipi di informazioni correnti e le etichette di riservatezza delle colonne nel pool di SQL Azure Synapse.

## ESEMPI

### Esempio 1: Ottenere i tipi di informazioni correnti e le etichette di riservatezza di un pool di SQL Azure Synapse.
```powershell
...
### Esempio 2: Ottenere i tipi di informazioni correnti e le etichette di riservatezza di un pool SQL Azure Synapse con Piping.
```powershell
...
### Esempio 3: Ottenere il tipo di informazioni corrente e l'etichetta di riservatezza di una colonna specifica di un pool di SQL Azure Synapse.
```powershell
...
### Esempio 4: Ottenere il tipo di informazioni corrente e l'etichetta di riservatezza di una colonna specifica di un pool di SQL Azure Synapse usando Piping.
```powershell
