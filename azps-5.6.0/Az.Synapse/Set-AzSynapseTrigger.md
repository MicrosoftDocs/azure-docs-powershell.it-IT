...
Creare un nuovo trigger denominato ContosoTrigger nell'area di lavoro ContosoWorkspace. Il trigger viene creato nello stato "Arrestato", ovvero non viene avviato immediatamente. È possibile avviare un trigger usando il `Start-AzDataFactoryV2Trigger` cmdlet.
...
Creare un nuovo trigger denominato ContosoTrigger nell'area di lavoro ContosoWorkspace tramite pipeline. Il trigger viene creato nello stato "Arrestato", ovvero non viene avviato immediatamente. È possibile avviare un trigger usando il `Start-AzDataFactoryV2Trigger` cmdlet.
