...
## DESCRIZIONE
Il cmdlet **Get-AzSynapseNotebook** ottiene informazioni sui blocchi appunti in un'area di lavoro. Se si specifica il nome di un blocco appunti, il cmdlet riceverà informazioni sul blocco appunti. Se non si specifica un nome, il cmdlet riceve informazioni su tutti i blocchi appunti nell'area di lavoro.
