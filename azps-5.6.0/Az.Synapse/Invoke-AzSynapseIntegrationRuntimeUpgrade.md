...
### InvokeByNameParameterSet (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Invoke-AzSynapseIntegrationRuntimeUpgrade** aggiorna il runtime di integrazione self-hosted, se la nuova versione è disponibile.
...
Il cmdlet aggiorna il runtime di integrazione self-hosted denominato "test-selfhost-ir" nell'area di lavoro ContosoWorkspace.
