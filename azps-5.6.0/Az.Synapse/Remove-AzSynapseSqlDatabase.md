...
## SYNOPSIS
Elimina un database SQL Synapse Analytics.
...
## DESCRIZIONE
Il cmdlet **Remove-AzSynapseSqlPool** elimina definitivamente un database di Azure Synapse Analytics SQL database.
...
Questo comando elimina un database di Azure Synapse Analytics SQL database.
...
Questo comando elimina un database azure synapse Analytics SQL tramite pipeline.
...
Questo comando elimina un database SQL Azure Synapse Analytics con l'ID risorsa specificato.
...
### -InputObject
SQL di input di database, in genere passato attraverso la pipeline.
