...
## DESCRIZIONE
Il cmdlet **Update-AzSynapseSqlAdvancedThreatProtectionSetting** aggiorna le impostazioni di Protezione avanzata dalle minacce in un'area di lavoro analisi di Azure Synapse. Per abilitare la protezione avanzata dalle minacce in un'area di lavoro, è necessario che in tale area di lavoro siano abilitate le impostazioni di controllo.
...
Questo comando aggiorna le impostazioni di Protezione avanzata dalle minacce per un'area di lavoro denominata ContosoWorkspace.
