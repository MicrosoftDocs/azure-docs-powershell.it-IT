...
## DESCRIZIONE
Il cmdlet **Start-AzSynapseTrigger** avvia un trigger in un'area di lavoro. Se il trigger è in stato "Arrestato", il cmdlet avvia il trigger e alla fine richiama pipeline in base alla relativa definizione. Se il trigger è già in stato "Avviato", questo cmdlet non ha alcun effetto.
