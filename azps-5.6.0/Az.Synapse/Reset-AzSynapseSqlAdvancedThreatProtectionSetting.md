...
## DESCRIZIONE
Il cmdlet **Reset-AzSynapseSqlAdvancedThreatProtectionSetting** rimuove le impostazioni di Protezione avanzata dalle minacce da un'area di lavoro analisi di Azure Synapse.
...
Questo comando rimuove le impostazioni di protezione avanzata dalle minacce da un'area di lavoro denominata ContosoWorkspace.
