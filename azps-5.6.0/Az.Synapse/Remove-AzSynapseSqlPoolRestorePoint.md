...
## DESCRIZIONE
Il cmdlet **Remove-AzSynapseSqlPoolRestorePoint** elimina definitivamente un SQL di ripristino del pool azure Synapse Analytics.
...
Questo comando elimina un punto di ripristino del pool SQL Azure Synapse Analytics.
...
Questo comando elimina un punto di ripristino del pool SQL Azure Synapse Analytics tramite pipeline.
...
Questo comando elimina un punto di ripristino del SQL azure Synapse Analytics con l'ID risorsa specificato.
...
### -InputObject
SQL di input dell'ora di creazione del punto di ripristino del pool, in genere passato attraverso la pipeline.
...
Nome della sinapse SQL data di creazione del punto di ripristino.
...
### -SqlPoolObject
Oggetto di input Pool Sql, in genere passato attraverso la pipeline.
