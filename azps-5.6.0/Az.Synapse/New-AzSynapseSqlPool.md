...
## DESCRIZIONE
Il cmdlet **New-AzSynapseSqlPool** crea un pool di SQL Azure Synapse Analytics.
...
Questo comando crea un pool di SQL Azure Synapse Analytics.
...
### -Collation
Le regole di confronto definiscono le regole per ordinare e confrontare i dati e non possono essere modificate dopo la SQL del pool.
La fascicolazione predefinita SQL_Latin1_General_CP1_CI_AS.
