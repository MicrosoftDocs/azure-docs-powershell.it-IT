...
## SYNOPSIS
Esegue una query sulle risorse gestite da Gestione risorse di Azure.
...
## DESCRIZIONE
Per altre informazioni sulla sintassi della query, vedere: https://aka.ms/resource-graph/learntoquery
...
Query di risorse semplice che richiede un sottoinsieme di campi delle risorse.
...
Query complessa sulle risorse con selezione dei campi, filtro e riepilogo.
...
```
Query con tutte le macchine virtuali che non usano dischi gestiti e che include i nomi visualizzati dell'abbonamento.
...
```
Query che visualizza il conteggio delle risorse per nome visualizzato del tenant e della sottoscrizione.
...
### -Abbonamento
Sottoscrizioni su cui eseguire la query.
