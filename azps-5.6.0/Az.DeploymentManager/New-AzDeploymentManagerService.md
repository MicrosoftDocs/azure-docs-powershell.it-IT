...
Specificare il servizio in base al nome, alla topologia di servizio in cui si trova e al nome del gruppo di risorse. 

Il cmdlet restituisce un oggetto Service. È possibile modificare l'oggetto in locale e quindi applicarvi le modifiche usando il cmdlet Set-AzDeploymentManagerService servizio.
...
Crea un nuovo servizio con il nome ContosoService1 nella topologia di servizio ContosoServiceTopology nel gruppo di risorse ContosoResourceGroup, nella posizione Stati Uniti centrale. La proprietà TargetLocation indica che il servizio ContosoService1 deve essere distribuito nell'area degli Stati Uniti orientali nella sottoscrizione specificata.
...
### -Location
Posizione della risorsa servizio.
...
### -ServiceTopologyName
Nome della topologia del servizio a cui appartiene questo servizio.
...
Determina la sottoscrizione a cui distribuire le risorse del servizio.
