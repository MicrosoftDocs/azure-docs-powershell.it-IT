...
Questo cmdlet crea una nuova topologia di servizio nel gruppo di risorse ContosoResourceGroup con il nome ContosoServiceTopology e nella posizione Stati Uniti centrale. L'id Risorsa origine elemento indica che gli elementi necessari per le definizioni di unità di servizio in questa topologia devono essere letti dall'origine dell'elemento specificato.
