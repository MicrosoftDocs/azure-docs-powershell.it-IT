...
### Esempio 1: Rimuovere una AzDigitalTwinsInstance in base al nome
```powershell
...
Questo comando rimuove una AzDigitalTwinsInstance in base al nome

### Esempio 2: Rimuovere una AzDigitalTwinsInstance per InputObject
```powershell
