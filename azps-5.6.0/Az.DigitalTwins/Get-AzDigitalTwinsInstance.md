...
### Esempio 1: Elenco (impostazione predefinita)
```powershell
...
Ottenere tutti i digitalTwinsInstance per impostazione predefinita
...
Ottenere l'istanza specificata di AzDigitalTwinsInstance da ResourceName

### Esempio 3: GetViaIdentity
```powershell
...
Ottenere l'istanza specificata di AzDigitalTwinsInstance per Object
...
Ottenere tutta DigitalTwinsInstance da ResourceGroupName
