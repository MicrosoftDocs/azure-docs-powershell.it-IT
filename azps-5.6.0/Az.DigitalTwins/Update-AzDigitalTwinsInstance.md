...
Aggiornare l'istanza di DigitalTwinsInstance specificata in base a ResourceGroupName

### Esempio 2: Aggiornare AzDigitalTwinsInstance da un altro AzDigitalTwinsInstance
```powershell
...
Aggiornare AzDigitalTwinsInstance da un altro AzDigitalTwinsInstance
...
Per creare, vedere la sezione NOTE per le proprietà DIGITALTWINSPATCHDESCRIPTION e creare una tabella hash.
...
DIGITALTWINSPATCHDESCRIPTION: <IDigitalTwinsPatchDescription> descrizione del servizio DigitalTwins.
