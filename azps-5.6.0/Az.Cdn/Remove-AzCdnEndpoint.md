...
## DESCRIZIONE
Il cmdlet **Remove-AzCdnEndpoint** rimuove un endpoint della rete per la distribuzione di contenuti (CDN) di Azure.
...
### -CdnEndpoint
Specifica l'endpoint rimosso dal cmdlet.
...
### -EndpointName
Specifica il nome dell'endpoint rimosso dal cmdlet.
