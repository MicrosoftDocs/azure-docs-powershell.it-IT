...
## DESCRIZIONE
Il cmdlet Get-AzCdnOriginGroup recupera un gruppo di origine CDN.
...
Questo comando otterrà il gruppo di origini all'interno dell'endpoint specificato.
...
### -ResourceId
ID risorsa per il gruppo di origine
