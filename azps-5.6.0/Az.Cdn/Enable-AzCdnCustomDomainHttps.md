...
## DESCRIZIONE
Il cmdlet **Enable-AzCdnCustomDomainHttps consente** la distribuzione protetta di HTTPS di un dominio personalizzato della rete CDN.
...
Abilitare la distribuzione sicura del dominio personalizzato.

## PARAMETERS

### -CustomDomainName
Nome visualizzato del dominio personalizzato della rete CDN di Azure.
...
### -InputObject
Oggetto dominio personalizzato.
...
### -ResourceGroupName
Gruppo di risorse del profilo CDN di Azure
...
### -ResourceId
ResourceId del dominio personalizzato
