...
## DESCRIZIONE
Il cmdlet **Publish-AzCdnEndpointContent** carica il contenuto da un server di origine per l'endpoint rete per la distribuzione di contenuti (CDN) di Azure.
...
### -CdnEndpoint
Specifica l'endpoint della rete CDN.
...
### -LoadContent
Specifica una matrice di percorsi relativi per il contenuto nel server di origine pubblicato dal cmdlet.
