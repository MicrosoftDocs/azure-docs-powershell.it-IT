...
## DESCRIZIONE
La New-AzCdnOrigin creerà una nuova origine CDN all'interno dell'endpoint specificato.
...
Questo cmdlet creerà una nuova origine CDN per l'endpoint specificato. Userà il nome host fornito come origine. 
...
### -HostName
Nome host origine CDN di Azure.
...
### -HttpPort
Porta HTTP di origine della rete CDN di Azure.
...
### -HttpsPort
Porta https di origine della rete CDN di Azure.
...
### -OriginHostHeader
Intestazione host origine CDN di Azure.
...
### -OriginName
Nome di origine della rete CDN di Azure.
