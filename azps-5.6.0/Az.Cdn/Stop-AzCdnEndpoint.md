...
## DESCRIZIONE
Il cmdlet **Stop-AzCdnEndpoint** interrompe l'endpoint della rete per la distribuzione di contenuti (CDN) di Azure.
...
### -CdnEndpoint
Specifica l'oggetto endpoint interrotto da questo cmdlet.
...
### -EndpointName
Specifica il nome dell'endpoint a cui il cmdlet si arresta.
