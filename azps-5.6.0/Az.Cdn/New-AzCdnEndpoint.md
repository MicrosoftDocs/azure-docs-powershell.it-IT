...
## DESCRIZIONE
Il cmdlet **New-AzCdnEndpoint** crea un endpoint della rete per la distribuzione di contenuti (CDN) di Azure.
...
### -CdnProfile
Specifica l'oggetto profilo CDN a cui viene aggiunto l'endpoint.
...
Specifica una matrice di tipi di contenuto da comprimere dal nodo perimetrale al client.
...
### -DefaultOriginGroup
Il gruppo di origini predefinito.
...
### -DeliveryPolicy
Criteri di recapito per questo endpoint.
...
### -GeoFilters
Elenco di filtri geografici applicabili a questo endpoint.
...
### -OriginHostHeader
Specifica l'intestazione dell'host di origine dell'endpoint.
...
### -Priority
Priorità di origine della rete CDN di Azure.
...
### -PrivateLinkLocation
Posizione del collegamento privato dell'origine CDN di Azure.
...
ID risorsa collegamento privato origine CDN di Azure.
...
### -Path
Specifica il percorso di accelerazione dinamica del sito
...
Specifica il comportamento dell'endpoint CDN quando una stringa di query è nell'URL della richiesta.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse a cui appartiene questo endpoint.
...
### -Tag
I tag da associare all'endpoint della rete CDN di Azure.
...
### -Spessore
Peso origine rete CDN di Azure.
