...
Crea un oggetto servizio di peering con provider e posizione di peering. Uso in coniugato con `Get-AzPeeringServiceProvider` e `Get-AzPeeringServiceLocation`
...
### -PeeringLocation
Posizione fisica diversa dall'area geografica di Azure. Usare Get-AzPeeringServiceLocation [-Country <country> ]
...
Nome del provider del servizio di peering.
Usare Get-AzPeeringServiceProvider cmdlet per un elenco
...
### -Tag
I tag da associare al servizio Microsoft InputObject.
