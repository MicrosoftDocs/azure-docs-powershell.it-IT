...
## DESCRIZIONE
Ottiene i peering da una sottoscrizione, un gruppo di risorse o in base al nome.
...
Recupera tutte le risorse per la sottoscrizione.
...
Ottiene il nome del peering di Exchange `myExchangePeering1`
