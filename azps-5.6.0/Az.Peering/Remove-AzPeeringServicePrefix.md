...
## DESCRIZIONE
Rimuove un prefisso del servizio di peering da un servizio di peering.
...
Rimuovere un prefisso da un oggetto servizio di peering
...
Rimuovere un prefisso da un ID di risorsa del servizio di peering.
...
Rimuovere un prefisso dal nome e dal nome di un gruppo di risorse del servizio di peering
...
### -PassThru
Restituisce true per success o false per failed.
