...
### Ottenere il peering e creare un prefisso registrato
```powershell
PS C:\>$peering = Get-AzPeering -ResourceGroupName $resourceGroupName -Name $name
PS C:\>$peering | New-AzPeeringRegisteredPrefix -Name $asnName -Asn $asn
```

Ottenere il peering a cui si vuole aggiungere un prefisso registrato. Passare quindi questo al commandlet.

### Usare resourceId di peering per creare una rete asn registrata
```powershell
...
### Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PSRegisteredPrefix
