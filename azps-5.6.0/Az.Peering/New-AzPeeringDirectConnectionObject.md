...
## DESCRIZIONE
Crea un oggetto PSObject in memoria 
...
Creare una connessione peering diretta con l'uso per il servizio di peering abilitato e indirizzi IP forniti da Microsoft
...
Creare una connessione peering diretta con l'uso per il servizio di peering abilitato e gli indirizzi IP forniti dal peering
...
Creare una connessione peering diretta senza indirizzi IP della sessione bgp. Il peer dovrà impostare gli indirizzi IP prima di configurare la sessione bgp.

## PARAMETERS

### -BandwidthInMbps
La larghezza di banda disponibile in questa posizione in Mbps.
...
Il numero massimo di IPv4 annunciati
...
Il numero massimo di IPv6 annunciati
...
Chiave di autenticazione MD5 per la sessione.
...
Abilitare il contrassegno che indica a Microsoft di fornire gli indirizzi di sessione BGP.
...
### -PeeringDBFacilityId
ID della struttura di peering trovato in https://peeringdb.com
...
### -UseForServingService
Abilita per l'uso con il servizio di peering Microsoft (MPS).
