...
## DESCRIZIONE
Crea un nuovo oggetto PeerAsn per la sottoscrizione.
...
### -Dettagli contatto
Indirizzi di posta elettronica usati per contattare in caso di problemi in genere un Network Operations Center
...
### Microsoft.Azure.PowerShell.Cmdlets.Peering.Models.PSZionaAsn
