...
### -ParentResource
La risorsa padre nella gerarchia(della risorsa specificata con il parametro ResourceName).
Deve essere usato solo in combinazione con i parametri ResourceGroupName, ResourceType e ResourceName per creare un ambito gerarchico in forma di URI relativo che identifichi una risorsa.
