...
## DESCRIZIONE
Il cmdlet **Stop-AzTenantDeployment** annulla una distribuzione avviata ma non completata in base all'ambito tenant corrente.
...
Per creare una distribuzione nell'ambito tenant, usare il cmdlet New-AzTenantDeployment tenant.
...
Questo comando annulla una distribuzione in esecuzione "deployment01" nell'ambito tenant corrente.
...
Questo comando recupera la distribuzione "deployment01" nell'ambito tenant corrente e la annulla. 
