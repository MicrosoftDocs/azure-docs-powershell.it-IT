...
Nell'esempio viene utilizzato un valore segnaposto per l'ID sottoscrizione.
...
Specifica il nome di una risorsa di estensione della risorsa che il cmdlet rimuove.
