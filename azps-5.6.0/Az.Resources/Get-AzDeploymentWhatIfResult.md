...
## SYNOPSIS
Ottiene un modello che What-If risultato per una distribuzione nell'ambito della sottoscrizione. 
...
Questo comando ottiene un risultato What-If'ambito della sottoscrizione corrente usando un file di modello personalizzato e un file di parametri sul disco.
