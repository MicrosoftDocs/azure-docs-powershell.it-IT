...
## DESCRIZIONE
Crea una nuova applicazione azure Active Directory. Di seguito sono elencate le autorizzazioni necessarie per creare un'applicazione:
...
### Esempio 1: Creare una nuova applicazione AAD.

```powershell
PS C:\> New-AzADApplication -DisplayName "NewApplication" -HomePage "http://www.microsoft.com" -IdentifierUris "http://NewApplication"
```

Crea una nuova applicazione azure Active Directory senza credenziali.

### Esempio 2: Creare una nuova applicazione AAD con una password.
...
Crea una nuova applicazione azure Active Directory e le associa le credenziali della password.
...
### -PasswordCredentials
Elenco delle credenziali password associate all'applicazione.
