...
## DESCRIZIONE
Il cmdlet **Get-AzResourceProvider** ottiene un provider di risorse di Azure.
...
Questo comando recupera tutti i provider di risorse dalla sottoscrizione.

### Esempio 2: Ottenere tutti i dettagli del provider di risorse dal provider Di provider specificato
...
Questo comando recupera tutti i provider di risorse in "Microsoft.Compute".

### Esempio 3: Ottenere tutti i dettagli del provider di risorse dalla matrice ProviderNtassi specificata
...
Questo comando recupera tutti i provider di risorse in "Microsoft.Compute" e "Microsoft.Network".
