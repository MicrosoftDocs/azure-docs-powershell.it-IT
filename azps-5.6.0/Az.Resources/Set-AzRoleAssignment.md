...
## DESCRIZIONE
Usare il New-AzRoleAssignment per modificare un'assegnazione esistente.  
Le descrizioni possono essere qualsiasi stringa valida, usarla per eseguire la deferenziazione l'una dall'altra.  
Se la condizione è impostata, è necessario impostare anche la versione della condizione, ma se si sta aggiornando una condizione non necessaria.
La versione della condizione può essere aggiornata da 1.0 a 2.0, ma non può essere aggiornata di nuovo. Attenzione: 2.0 non è retrocompatibile con 1.0.
