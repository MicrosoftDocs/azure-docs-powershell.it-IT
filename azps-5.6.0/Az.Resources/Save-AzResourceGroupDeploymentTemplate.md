...
## DESCRIZIONE
Il cmdlet **Save-AzResourceGroupDeploymentTemplate**  salva un modello di distribuzione del gruppo di risorse in un file JSON.
...
Salva un modello di distribuzione del gruppo di risorse in un file. (autogenerati)
