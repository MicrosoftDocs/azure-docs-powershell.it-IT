...
## DESCRIZIONE
Il cmdlet **New-AzPolicySetDefinition** crea una definizione del set di criteri.
...
Questo comando crea una definizione di set di criteri denominata VMPolicySetDefinition con metadati che indicano che la categoria è "Macchina virtuale" che contiene le definizioni dei criteri C:\VMPolicy.jsattivo. Il contenuto dell'VMPolicy.jsesempio è fornito in precedenza.
...
Questo comando crea una definizione di set di criteri con parametri denominata VMPolicySetDefinition che contiene le definizioni dei criteri specificate in C:\VMPolicy.jsattivo. Il contenuto dell'VMPolicy.jsesempio è fornito in precedenza.

### Esempio 3: Creare una definizione del set di criteri con gruppi di definizione dei criteri
```
[
   {
      "policyDefinitionId": "/providers/Microsoft.Authorization/policyDefinitions/2a0e14a6-b0a6-4fab-991a-187a4f81c498",
...
Questo comando crea una definizione di set di criteri denominata VMPolicySetDefinition con il raggruppamento delle definizioni dei criteri specificate C:\VMPolicy.jsattivo. Il contenuto dell'VMPolicy.jsesempio è fornito in precedenza.
