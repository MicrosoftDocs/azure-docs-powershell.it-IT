...
## DESCRIZIONE
Esporta una specifica versione Delle specifiche del modello nel file system locale.

## ESEMPI

### Esempio 1: Esportare in base al nome
```powershell
PS C:\> Export-AzTemplateSpec -ResourceGroupName 'myRG' -Name 'MyTemplateSpec' -Version 'v1.0' -OutputFolder 'v1'
```

Esporta la versione 'v1.0' della specifica del modello denominata "MyTemplateSpec" all'interno del gruppo di risorse 'myRG' nella cartella di output locale "v1".
...
Esporta la versione 'v1.0' della specifica di modello denominata "MyTemplateSpec" all'interno del gruppo di risorse 'myRG' dell'id secondario della sottoscrizione nella cartella di output locale \{ \} "v1".
...
### -OutputFolder
Percorso della cartella in cui verrà restituita la versione specifica del modello.
...
### -Version
Versione delle specifiche del modello da esportare.
