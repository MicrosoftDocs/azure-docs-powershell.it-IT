...
Se esiste un'operazione specifica a cui non si vuole concedere l'accesso in un ruolo personalizzato, è utile usare NotActions per escluderla, invece di specificare tutte le operazioni diverse da quella specifica in Azioni.
