...
Questo comando testa una distribuzione nel gruppo di gestione "myMG" usando una tabella hash in memoria creata dal file modello specificato e un file di parametri.
