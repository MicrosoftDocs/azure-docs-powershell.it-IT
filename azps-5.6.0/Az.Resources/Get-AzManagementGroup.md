...
## DESCRIZIONE
Il Get-AzManagementGroup cmdlet recupera tutto o un gruppo di gestione specifico.
...
Con il `Expand` contrassegno, è possibile spostarsi nella `Children` matrice e ottenere i dettagli per ogni elemento figlio. Ad esempio, `Children[0]` verranno fornite informazioni dettagliate per il gruppo con il nome `TestGroup1DisplayName` visualizzato.
