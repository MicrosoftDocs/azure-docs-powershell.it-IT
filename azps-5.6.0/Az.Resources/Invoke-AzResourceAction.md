...
Specifica il nome di una risorsa dell'estensione per la risorsa in cui questo cmdlet richiama un'azione.
...
### -ResourceId
Specifica l'ID risorsa completo della risorsa su cui il cmdlet richiama un'azione.
