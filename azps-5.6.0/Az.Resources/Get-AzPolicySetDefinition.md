...
## DESCRIZIONE
Il cmdlet **Get-AzPolicySetDefinition** ottiene una raccolta di definizioni del set di criteri o una definizione del set di criteri specifica identificata da nome o ID.
