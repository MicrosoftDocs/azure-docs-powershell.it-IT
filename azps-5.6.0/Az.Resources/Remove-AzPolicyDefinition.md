...
Il secondo comando rimuove la definizione del criterio identificata dalla **proprietà ResourceId** dell'$PolicyDefinition.
...
### -Id
Specifica l'ID risorsa completo per la definizione del criterio che questo cmdlet rimuove.
