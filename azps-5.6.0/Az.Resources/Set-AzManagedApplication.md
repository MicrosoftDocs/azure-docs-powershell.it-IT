...
## DESCRIZIONE
Il cmdlet **Set-AzManagedApplication** aggiorna le applicazioni gestite
...
Questo comando aggiorna la descrizione dell'applicazione gestita
...
### -Id
ID applicazione gestita completo, inclusa la sottoscrizione. ad esempio /subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName
...
### -Kind
Il tipo di applicazione gestita.
Uno dei marketplace o servicecatalog
...
### -Parameter
Stringa di parametri in formato JSON per l'applicazione gestita.
Può trattarsi del percorso di un nome file o di un URI contenente i parametri oppure dei parametri come stringa.
...
### -Plan
Tabella hash che rappresenta le proprietà del piano di applicazioni gestite.
