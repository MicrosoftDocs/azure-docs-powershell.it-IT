...
## DESCRIZIONE
Aggiorna un'applicazione Azure Active Directory esistente.
Per aggiornare le credenziali associate all'applicazione, usare il cmdlet New-AzADAppCredential.
...
Aggiorna il nome visualizzato dell'applicazione il cui ID oggetto 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' sarà "NomeVisualizzazioneNew".
...
Aggiorna le proprietà di un'applicazione con ID oggetto 'fb7b3405-ca44-4b5b-8584-12392f5d96d7'.
...
Ottiene l'applicazione con ID oggetto 'fb7b3405-ca44-4b5b-8584-12392f5d96d7' e pipe che al cmdlet Update-AzADApplication per aggiornare il nome visualizzato dell'applicazione in "NomeVisualizzazioneNew".
...
### -ReplyUrl
Specifica gli URL a cui vengono inviati i token utente per l'accesso o gli URL di reindirizzamento a cui vengono inviati i codici di autorizzazione e i token di accesso di OAuth 2.0.
