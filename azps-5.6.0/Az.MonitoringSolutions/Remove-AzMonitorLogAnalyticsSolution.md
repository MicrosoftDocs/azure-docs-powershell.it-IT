...
### Esempio 1: Rimuovere una soluzione di analisi del log di monitoraggio in base al nome
```powershell
PS C:\> Remove-AzMonitorLogAnalyticsSolution  -ResourceGroupName azureps-manual-test -Name 'Containers(monitoringworkspace-2vob7n)'

```

Questo comando rimuove una soluzione di analisi del log di monitoraggio in base al nome.
