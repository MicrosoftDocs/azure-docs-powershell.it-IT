...
### Esempio 1: Aggiornare una soluzione di analisi del log di monitoraggio in base al nome
```powershell
...
Questo comando aggiorna una soluzione di analisi del log di monitoraggio in base al nome.

### Esempio 2: Aggiornare una soluzione di analisi del log di monitoraggio per oggetto
```powershell
...
Questo comando aggiorna una soluzione di analisi del log di monitoraggio per oggetto.
