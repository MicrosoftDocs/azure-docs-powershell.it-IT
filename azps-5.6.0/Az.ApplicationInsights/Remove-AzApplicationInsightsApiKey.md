...
### Esempio 1: rimuovere una chiave API di Application Insights per una risorsa di Application Insights
```
...
Rimuovere la specifica chiave api di Application Insights che id è "dd173f38-4fd1-4c75-8af5-9 9c29aa0f867" per la risorsa "test" nel gruppo di risorse "testGroup".
