...
### Esempio 1 Ottenere l'esportazione continua per una risorsa application Insights
```
...
Ottenere informazioni dettagliate sull'applicazione per le configurazioni di esportazione continue per la risorsa denominata "test" nel gruppo di risorse "gruppo di test"

### Esempio 2: Ottenere l'esportazione continua per una risorsa application Insights
```
...
Ottenere informazioni dettagliate sull'applicazione per la configurazione continua dell'esportazione con ID esportazione "ZJrfffySPdtG3ESn3iRxVIEFuNY=" per la risorsa denominata "test" nel gruppo di risorse "gruppo di test"
