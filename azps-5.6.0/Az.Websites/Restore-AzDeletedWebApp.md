...
Se vengono eliminate 2 app con lo stesso nome (ContosoApp), si ottengono i dettagli di entrambi i siti e si ripristina l'app denominata ContosoRestore con l'app desiderata chiamando Ripristina con l'ID.
...
Se sono presenti 2 app eliminate con lo stesso nome (ContosoApp), si ottengono i dettagli dei siti e si ripristina l'app denominata ContosoRestore con l'app desiderata chiamando ripristina con i dettagli di InputObject(Deletedsite) 
...
Il piano di servizio app per la nuova app Web di Azure.
