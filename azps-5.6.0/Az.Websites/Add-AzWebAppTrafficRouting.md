...
### Esempio 1 Aggiungere una regola di routing per trasferire il 15% del traffico di produzione nello slot Stg
```powershell
PS C:\>Add-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
-RoutingRule @{ActionHostName='XXXX.azurewebsites.net';ReroutePercentage=15;Name='Stg'}
```

Questo comando aggiunge una regola di routing per trasferire il 15% del traffico di produzione nello slot Stg

### Esempio 2 Aggiungere una regola di routing per trasferire il traffico di produzione agli intervalli di slot Stg dal 50% al 90% in modo incrementale.
```powershell
PS C:\>Add-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
...
Questo comando aggiunge una regola di routing per trasferire il traffico di produzione agli intervalli di slot Stg dal 50% al 90% in modo incrementale.
