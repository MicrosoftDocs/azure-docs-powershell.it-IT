...
## DESCRIZIONE
Il cmdlet **Get-AzWebApp** ottiene informazioni su un'app Web di Azure.
...
Questo comando recupera l'app Web denominata ContosoSite che appartiene al gruppo di risorse Default-Web-WestUS.
