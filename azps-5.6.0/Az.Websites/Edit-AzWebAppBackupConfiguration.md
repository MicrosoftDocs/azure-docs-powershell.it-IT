...
## DESCRIZIONE
Il cmdlet **Edit-AzWebAppBackupConfiguration** modifica il backup di configurazione corrente per un'app Web di Azure.

## ESEMPI

### Esempio 1

Il Edit-AzWebAppBackupConfiguration cmdlet modifica il backup di configurazione corrente per un'app Web di Azure. (autogenerati)
