...
### Esempio 1: aggiornare una regola di routing per trasferire il 15% del traffico di produzione nello slot Stg
```powershell
PS C:\>Update-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
- RoutingRule @{AtionHostName='XXXX.azurewebsites.net';ReroutePercentage=15;Name='Stg'}
```

Questo comando aggiorna una regola di routing per trasferire il 15% del traffico di produzione nello slot Stg.

### Esempio 2 Aggiornare una regola di routing per trasferire il traffico di produzione agli intervalli di slot Stg dal 50% al 90% in modo incrementale.
```powershell
PS C:\>Update-AzWebAppTrafficRouting -ResourceGroupName "Default-Web-WestUS" -WebAppName "ContosoSite" 
...
Questo comando aggiorna una regola di routing per trasferire il traffico di produzione agli intervalli di slot Stg dal 50% al 90% in modo incrementale.
