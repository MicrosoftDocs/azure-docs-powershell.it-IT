...
## DESCRIZIONE
Crea un oggetto che rappresenta un percorso di Archiviazione di Azure da montato all'interno di un'app Web.
...
### -Name
Identificatore della proprietà Archiviazione di Azure.
...
Windows Containers supporta solo file di Azure
