...
Crea un'impostazione di backup del database (stringa di connessione) di tipo SqlAzure per l'app specificata ContosoWebApp all'interno del gruppo di risorse Default-Web-WestUS.

### Esempio 2

Il cmdlet New-AzWebAppDatabaseBackupSetting crea una nuova impostazione di Backup di Azure Web App. (autogenerati)
