...
## DESCRIZIONE
Il cmdlet Update-AzContainerRegistry aggiorna il Registro di sistema di un contenitore.

## ESEMPI

### Esempio 1: Abilitare un utente amministratore per un contenitore specificato nel Registro di sistema
```powershell
...
Questo comando abilita l'utente amministratore per il Registro di sistema del contenitore specificato.

### Esempio 2: Impostare l'account di archiviazione usato da un contenitore specificato nel Registro di sistema
```powershell
...
Questo comando imposta il Registro di sistema del contenitore specificato in modo da usare un account di archiviazione \` esistente nella \` stessa sottoscrizione.
...
### -DisableAdminUser
Abilitare l'utente amministratore per il Registro di sistema del contenitore.
...
### -NetworkRuleSet
Set di regole di rete per un registro dei contenitori.
...
Ad esempio: @{key0="value0";key1=$null;key2="value2"}
