...
### Esempio 1: Creare un registro contenitore con un nuovo account di archiviazione.
```powershell
...
### Esempio 2: Creare un Registro di sistema del contenitore con un utente amministratore abilitato.
```powershell
...
Questo comando crea un registro di contenitore con l'utente amministratore abilitato.
