...
## DESCRIZIONE
Il cmdlet New-AzContainerRegistryWebhook crea un webhook del Registro di sistema contenitore.

## ESEMPI

### Esempio 1: Creare un webhook contenitore del Registro di sistema.
```
...
### -Location
Posizione Webhook.
Per impostazione predefinita, viene selezionata la posizione del Registro di sistema.
...
### -Stato
Stato Webhook, il valore predefinito è abilitato
