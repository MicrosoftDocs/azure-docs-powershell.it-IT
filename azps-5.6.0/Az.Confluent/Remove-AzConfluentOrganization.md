...
### Esempio 1: Rimuovere un'organizzazione confluente in base al nome
```powershell
PS C:\> Remove-AzConfluentOrganization -ResourceGroupName azure-rg-test -Name confluentorg-01-portal

```

Questo comando rimuove un'organizzazione confluente in base al nome

### Esempio 2: Rimuovere un'organizzazione confluente tramite pipeline
```powershell
...
Questo comando rimuove un'organizzazione confluente tramite pipeline.
...
INPUTOBJECT <IConfluentIdentity> : parametro Identity
  - `[Id <String>]`: percorso di identità della risorsa
  - `[OrganizationName <String>]`: nome della risorsa dell'organizzazione
  - `[ResourceGroupName <String>]`: nome gruppo di risorse
  - `[SubscriptionId <String>]`: ID sottoscrizione Microsoft Azure
