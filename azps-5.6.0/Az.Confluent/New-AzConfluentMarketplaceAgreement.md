...
## SYNOPSIS
Accetta le condizioni del marketplace.
...
### Esempio 1: Creare un contratto di Marketplace confluente in un abbonamento
```powershell
...
Questo comando crea un contratto di Marketplace confluente in una sottoscrizione.

## PARAMETERS

### -Accettato
Se sono state accettate versioni delle condizioni, altrimenti false.
...
### -LicenseTextLink
Creare un collegamento a html con i termini di Microsoft e Publisher.
...
### -Plan
Stringa identificatore del piano.
...
### -PrivacyPolicyLink
Collegamento all'informativa sulla privacy dell'autore.
...
### -Prodotto
Stringa dell'identificatore prodotto.
...
### -Publisher
Stringa dell'identificatore dell'autore.
...
### -RetrieveDatetime
Data e ora in FORMATO UTC in cui i termini sono stati accettati.
È vuoto se Accettato è falso.
