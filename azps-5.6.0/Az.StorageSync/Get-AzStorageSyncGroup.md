...
## DESCRIZIONE
Questo comando elenca tutti i gruppi di sincronizzazione all'interno di un determinato servizio di sincronizzazione di archiviazione. Può essere usato per elencare anche gli attributi di ogni gruppo di sincronizzazione.
