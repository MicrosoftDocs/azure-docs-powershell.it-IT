...
## DESCRIZIONE
Questo comando elenca tutti i server registrati con un determinato servizio di sincronizzazione di archiviazione. Può essere usato per elencare anche gli attributi di ogni server registrato.
...
Questo comando recupera tutti i server registrati in uno specifico servizio di sincronizzazione di archiviazione.
