...
Questo comando esegue il roll-to-roll del certificato del server locale e informa in modo sicuro il servizio di sincronizzazione di archiviazione corrispondente della nuova identità del server.
