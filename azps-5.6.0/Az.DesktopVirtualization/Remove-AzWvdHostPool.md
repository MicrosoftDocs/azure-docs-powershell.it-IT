...
### Esempio 1: Eliminare un pool di desktop virtuali Windows in base al nome
```powershell
PS C:\> Remove-AzWvdHostPool -ResourceGroupName ResourceGroupName -Name HostPoolName
```

Questo comando elimina un pool di desktop virtuali Windows in un gruppo di risorse.
...
### -Force
Forzare il contrassegno a eliminare sessionHost.
