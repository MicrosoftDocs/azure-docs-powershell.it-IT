...
### Esempio 1: Ottenere un pacchetto MSIX in base al nome
```powershell
...
Questo comando ottiene un pacchetto MSIX in un hostPool.

### Esempio 2: Elencare i pacchetti MSIX 
```powershell
...
Questo comando elenca i pacchetti MSIX in un hostPool.
