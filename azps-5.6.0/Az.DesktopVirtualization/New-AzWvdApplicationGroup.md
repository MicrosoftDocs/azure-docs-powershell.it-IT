...
### Esempio 1: Creare un gruppo applicazioni desktop virtuale di Windows in base al nome
```powershell
...
Questo comando crea un Gruppo Applicazioni Desktop virtuale Windows in un gruppo di risorse.

### Esempio 2: Creare un gruppo applicazioni desktop virtuale di Windows in base al nome
```powershell
PS C:\> New-AzWvdApplicationGroup -ResourceGroupName ResourceGroupName `
                            -Name ApplicationGroupName `
                            -Location 'eastus' `
...
Tipo di risorsa ApplicationGroup.
...
### -Descrizione
Descrizione di ApplicationGroup.
...
### -FriendlyName
Nome descrittivo di ApplicationGroup.
...
### -HostPoolArmPath
Percorso arm HostPool di ApplicationGroup.
