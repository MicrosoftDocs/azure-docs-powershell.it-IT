...
### Esempio 1: Eliminare un sessionHost di Desktop virtuale di Windows in base al nome
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Questo comando elimina un sessionhost di Desktop virtuale di Windows in un pool host.
...
### -Force
Forzare il flag a forzare l'eliminazione di sessionHost anche quando è presente userSession.
