...
### Esempio 1: Aggiornare un pool di desktop virtuali Windows in base al nome
```powershell
...
Questo comando aggiorna un Windows Virtual Desktop HostPool in un gruppo di risorse.
