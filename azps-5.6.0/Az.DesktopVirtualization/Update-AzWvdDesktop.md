...
### Esempio 1: Aggiornare un desktop virtuale di Windows
```powershell
...
Questo comando aggiorna un Desktop virtuale di Windows in un gruppo applicato.
