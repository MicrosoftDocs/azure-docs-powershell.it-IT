...
### Esempio 1: Ottenere un desktop virtuale di Windows in base al nome
```powershell
...
Questo comando recupera un desktop virtuale di Windows in un gruppo applicato.

### Esempio 2: Elencare desktop virtuali Di Windows
```powershell
...
Questo comando elenca i desktop virtuali di Windows in un gruppo applicato.
...
### -Name
Nome del desktop all'interno del gruppo di desktop specificato
