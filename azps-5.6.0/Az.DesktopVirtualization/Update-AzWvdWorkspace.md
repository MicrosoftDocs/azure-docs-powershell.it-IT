...
### Esempio 1: Aggiornare un'area di lavoro desktop virtuale di Windows in base al nome
```powershell
...
Questo comando aggiorna un'area di lavoro desktop virtuale di Windows in un gruppo di risorse.

## PARAMETERS

### -ApplicationGroupReference
Elenco di collegamenti applicationGroup.
