...
### Esempio 1: Ottenere un userSession di Desktop virtuale di Windows in base al nome
```powershell
...
Questo comando ottiene una UserSession di Desktop virtuale di Windows in un host di sessione.

### Esempio 2: Elencare le UserSessions di Desktop virtuale di Windows
```powershell
...
Questo comando elenca le UserSessions di Desktop virtuale di Windows in un host di sessione.

### Esempio 3: Elencare le UserSessions di Desktop virtuale di Windows nel pool host
```powershell
...
Questo comando elenca le UserSessions di Desktop virtuale di Windows in un host di sessione in un pool host.
