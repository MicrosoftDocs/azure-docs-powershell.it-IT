...
### Esempio 1: Eliminare un'applicazione Desktop virtuale di Windows in base al nome
```powershell
PS C:\> Remove-AzWvdApplication -ResourceGroupName ResourceGroupName -ApplicationGroupName ApplicationGroupName -Name ApplicationName
```

Questo comando elimina un'applicazione Desktop virtuale di Windows in un gruppo applicato.
