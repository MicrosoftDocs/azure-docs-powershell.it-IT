...
## DESCRIZIONE
Il cmdlet **Remove-AzDataBoxEdgeStorageAccount** rimuove un account di archiviazione Edge associato per un dispositivo Edge di Data Box. È possibile specificare il nome dell'account di archiviazione di Microsoft Edge da rimuovere come parametro nel cmdlet.
