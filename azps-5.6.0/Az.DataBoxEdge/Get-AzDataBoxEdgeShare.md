...
## DESCRIZIONE
Il **cmdlet Get-AzDataBoxEdgeShare** ottiene le condivisioni disponibili per un dispositivo Data Box Edge. Se si fa clic su Nome, la condivisione viene scaricata in base al nome.
