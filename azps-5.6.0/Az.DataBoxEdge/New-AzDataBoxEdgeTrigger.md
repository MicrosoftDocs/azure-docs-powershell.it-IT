...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeTrigger** configura un trigger nel dispositivo Data Box Edge. 
...
### -ShareId
ID condivisione file da passare in Trigger Evento File
...
### -Topic
Argomento in cui gli eventi periodici vengono pubblicati in un dispositivo IoT.
