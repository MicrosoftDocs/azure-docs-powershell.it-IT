...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeStorageAccount** crea un nuovo account di Archiviazione Edge in un dispositivo Edge di Data Box. Per un dispositivo, è possibile eseguire il mapping di un account di Archiviazione Edge al massimo a un solo account di Archiviazione cloud.
...
2 EdgeStorageAccounts nel dispositivo non possono condividere più di 1 account di archiviazione cloud
