...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeBandwidthSchedule** crea una nuova pianificazione della larghezza di banda per un dispositivo Data Box Edge per gestire l'utilizzo della larghezza di banda.
...
### -UnlimitedBandwidth
Imposta larghezza di banda illimitata, se è impostata su false, imposta il valore predefinito su 20 Mbps
