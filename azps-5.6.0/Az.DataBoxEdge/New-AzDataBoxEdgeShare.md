...
### SmbParameterSet (Impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeShare** crea una nuova condivisione nel dispositivo Data Box Edge.
...
### -ClientAccessRight
Accesso di lettura/scrittura per id client, ad esempio:@(@{"Id Client"="192.168.10.10";" AccessRight"="NoAccess"}, @{"ClientId"="192.168.10.11";" AccessRight"="ReadOnly"})
...
### -CloudShare
Fornire il nome della risorsa StorageAccountCredential esistente
...
### -ContainerName
Nome del contenitore (in base al formato dati specificato, rappresenta il nome di File di Azure/Paginablob/BLOB blocco)
...
### -DataFormat
Impostare il formato dati ad esempio PageBlob, BLOBBlob
...
### -NFS
AccessProtocol nel caso di creazione di Condividi
...
### -UserAccessRight
fornire l'accesso direttamente insieme ai nomi utente esistenti per accedere ai tipi di condivisione SMB, Ad esempio: @(@{"Username"="nome-utente-1";" AccessRight"="Read"}, @{"Username"="user-name-2";" AccessRight"="Read"}, @{"Username"="user-name-3";" AccessRight"="Custom"})
