...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeStorageAccountCredential** crea una nuova credenziali dell'account di archiviazione Edge per un dispositivo Data Box Edge.
...
### -StorageAccountType
Tipo di accesso di archiviazione possibile GeneralPurposeStorage, BlockStorage
