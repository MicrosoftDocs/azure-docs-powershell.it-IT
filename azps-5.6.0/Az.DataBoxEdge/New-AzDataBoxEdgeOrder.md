...
## DESCRIZIONE
Il cmdlet **New-AzDataBoxEdgeOrder** crea un nuovo ordine per un dispositivo Data Box Edge. Prima di creare un ordine, è necessario creare una risorsa dispositivo Data Box Edge. È possibile specificare dettagli come la persona di contatto, il nome della società, l'indirizzo di posta elettronica, l'indirizzo e così via come parametri per la creazione dell'ordine.
...
### -E-mail
Elenco dei messaggi di posta elettronica da ricevere gli aggiornamenti, accetta al massimo 10 messaggi
