...
## DESCRIZIONE
Il cmdlet **Invoke-AzDataBoxEdgeShare** richiama l'azione per aggiornare i dati in una condivisione in un dispositivo Microsoft Data Box Edge.
...
### -RefreshData
Aggiornare i metadati di condivisione con i dati dal cloud
