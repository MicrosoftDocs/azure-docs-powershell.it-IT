...
## DESCRIZIONE
Il **cmdlet Get-AzDataBoxEdgeRole** recupera i ruoli IoT disponibili per un dispositivo Data Box Edge. È possibile menzionare il parametro Name per ottenere i dettagli di un ruolo IoT specifico.
