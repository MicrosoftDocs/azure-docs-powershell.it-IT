...
Creare un nuovo bot in base a ResourceGroupName e ApplicationId

### Esempio 2: Creare una nuova app Web
```powershell
...
Creare una nuova app Web in base a ResourceGroupName e ApplicationId
