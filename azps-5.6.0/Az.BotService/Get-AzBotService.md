...
### Esempio 1: Ottenere tutti i BotServices
```powershell
...
Ottieni tutti i BotServices

### Esempio 2: Ottenere BotService dal nome e dal nome ResourceGroupName
```powershell
...
Ottenere BotService per ResourceGroupName e Name

### Esempio 3: Ottenere tutti i BotServices per ResourceGroupName
```powershell
...
Ottenere tutti i BotServices per ResourceGroupName

### Esempio 4: Ottenere BotService da inputObject
```powershell
...
Ottenere BotService da inputObject
...
INPUTOBJECT <IBotServiceIdentity> : parametro Identity
  ...
  - `[ConnectionName <String>]`: nome della risorsa delle impostazioni di connessione al servizio Bot
