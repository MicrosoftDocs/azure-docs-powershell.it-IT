...
### Esempio 1: Ottenere una cache aziendale di Redis in base al nome
```powershell
...
Questo comando recupera la cache dell'organizzazione di Redis denominata MyCache.

### Esempio 2: Ottenere ogni cache di Ridis Enterprise in un gruppo di risorse
```powershell
...
Questo comando recupera ogni cache di Ridis Enterprise nel gruppo di risorse specificato.
