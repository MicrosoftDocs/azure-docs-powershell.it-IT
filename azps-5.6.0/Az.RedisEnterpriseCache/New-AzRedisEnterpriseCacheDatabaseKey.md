...
Questo comando rigenera la chiave di accesso segreto primario usata per l'autenticazione delle connessioni al database della cache di Redis Enterprise denominata MyCache.
