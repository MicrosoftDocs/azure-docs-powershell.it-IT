...
### ParamaterList (impostazione predefinita)
```
...
## DESCRIZIONE
Il Remove-AzSqlVMGroup cmdlet elimina un gruppo di macchine virtuali SQL.
...
Elimina il gruppo SQL di macchine virtuali Azure "test-group" nel gruppo di risorse ResourceGroup01.
...
### -PassThru
Specifica se l'output della risorsa eliminata deve essere restituito al termine dell'esecuzione del cmdlet.
