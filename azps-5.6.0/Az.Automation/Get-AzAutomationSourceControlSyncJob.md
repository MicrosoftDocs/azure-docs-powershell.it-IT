...
## DESCRIZIONE
Il cmdlet Get-AzAutomationSourceControlSyncJob cmdlet recupera i processi di sincronizzazione del controllo del codice sorgente di Azure Automation. Per ottenere un processo di sincronizzazione del controllo del codice sorgente specifico, specificarne l'ID.

## ESEMPI

### Esempio 1
Questo comando recupera tutti i processi di sincronizzazione del controllo origine automazione per il controllo di origine VSTSNative.
...
### Esempio 2
Questo comando recupera il processo di sincronizzazione del controllo del codice sorgente con ID 08d6d266-27b6-463c-beea-bc48a67ace15 per il controllo del codice sorgente VSTSNative. 
...
Recupera i processi di sincronizzazione del controllo origine di Azure Automation. (autogenerati)
...
### -JobId
ID del processo di sincronizzazione del controllo del codice sorgente.
