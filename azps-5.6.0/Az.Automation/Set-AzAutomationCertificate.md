...
## DESCRIZIONE
Il cmdlet **Set-AzAutomationCertificate** modifica la configurazione di un certificato nell'automazione di Azure.
...
Il primo comando converte una password di testo normale in stringa sicura usando il cmdlet ConvertTo-SecureString testo.
...
Il comando specifica il nome dell'account e il percorso del file da caricare.
...
### -Name
Specifica il nome del certificato modificato dal cmdlet.
...
### -Path
Specifica il percorso di un file script da caricare.
