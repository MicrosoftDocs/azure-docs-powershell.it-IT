...
## SYNOPSIS
Ottiene un elenco di computer di configurazione dell'aggiornamento software per l'automazione di Azure.
...
## DESCRIZIONE
Questo cmdlet restituisce un elenco di esecuzioni del computer. Ogni aggiornamento software eseguito attiverà l'esecuzione di un computer per ogni computer di destinazione della configurazione dell'aggiornamento software. Per ottenere l'esecuzione di un computer specifico, passare il parametro ID. È possibile elencare tutte le esecuzioni del computer, tutte le esecuzioni per un computer specifico, tutte con uno stato specifico passando i parametri corrispondenti.

## ESEMPI

### Esempio 1
Questo esempio restituisce tutte le esecuzioni non riuscite del computer per la macchina virtuale di Azure specificata.
...
### -Id
ID del computer di aggiornamento software eseguito.
...
### -SoftwareUpdateRun
Viene eseguito l'aggiornamento software.
...
### -SoftwareUpdateRunId
ID dell'esecuzione dell'aggiornamento software.
...
### -Stato
Stato del computer in esecuzione.
...
### -TargetComputer
computer di destinazione per l'esecuzione del computer.
Può essere un nome di computer diverso dall'az o un ID risorsa azure VM.
