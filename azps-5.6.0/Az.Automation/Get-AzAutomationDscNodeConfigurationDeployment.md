...
## SYNOPSIS
Recupera le distribuzioni della configurazione del nodo DSC nell'automazione.
...
### Esempio 1: Ottenere una distribuzione di configurazione nodo
```
