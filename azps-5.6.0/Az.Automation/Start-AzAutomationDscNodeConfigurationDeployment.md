...
## DESCRIZIONE
Il cmdlet **Start-AzAutomationDscNodeConfigurationDeployment** distribuisce una configurazione del nodo Desired State Configuration (DSC) in Automazione di Azure.

## ESEMPI

### Esempio 1: Distribuire una configurazione del nodo DSC di Azure nell'automazione
```
...
Il comando precedente distribuisce la configurazione del nodo DSC denominata "Config01.Node1" nella matrice bidimensionale specificata di Nomi nodo. La distribuzione avviene a fasi.

### Esempio 2: Pianificare la distribuzione di una configurazione del nodo DSC di Azure nell'automazione
```
...
Il comando precedente pianifica una distribuzione di una configurazione del nodo DSC denominata "Config01.Node1" nella matrice bidimensionale specificata di nomi di nodo. La distribuzione avviene in fasi e verrà eseguita in base alla pianificazione.
...
Specifica il nome della configurazione del nodo DSC distribuito dal cmdlet.
...
### -NodeName
Specifica i nomi dei nodi in cui verrà distribuita la configurazione nodo.
...
### -Pianificazione
Oggetto Automation Schedule per pianificare il processo di distribuzione.
