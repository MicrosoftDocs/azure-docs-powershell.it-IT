...
## SYNOPSIS
Crea un oggetto query di azure per la configurazione dell'aggiornamento software di azure.
...
## DESCRIZIONE
Crea un oggetto query di azure per la configurazione degli aggiornamenti software che verrà usato per creare una configurazione di aggiornamento software che verrà eseguita in base a una pianificazione per aggiornare un elenco di macchine virtuali di Azure risolte dinamicamente.
