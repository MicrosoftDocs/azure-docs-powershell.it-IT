...
Specificare il nome di una credenziali per ottenere una specifica credenziali.
Ai fini della sicurezza, questo cmdlet non restituisce password per le credenziali.
