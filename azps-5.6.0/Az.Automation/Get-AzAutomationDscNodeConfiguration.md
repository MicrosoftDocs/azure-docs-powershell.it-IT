...
## DESCRIZIONE
Il cmdlet **Get-AzAutomationDscNodeConfiguration** ottiene i metadati per le configurazioni del nodo APS Desired State Configuration (DSC) nell'automazione di Azure.
...
Questo cmdlet recupera i metadati per le configurazioni del nodo DSC nel gruppo di risorse specificato da questo parametro.
...
### -RollupStatus
Specifica lo stato di rollup delle configurazioni dei nodi DSC che riceve questo cmdlet.
