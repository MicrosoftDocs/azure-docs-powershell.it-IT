...
## DESCRIZIONE
Il cmdlet **Remove-AzAutomationDscNodeConfiguration** rimuove i metadati dalle configurazioni del nodo APS Desired State Configuration (DSC) nell'automazione di Azure.
...
Rimuove i metadati dalle configurazioni nodo DSC nell'automazione. (autogenerati)
...
Specifica il nome di un account di automazione che contiene le configurazioni del nodo DSC per cui questo cmdlet rimuove i metadati.
...
### -IgnoreNodeMappings
Indica che questo cmdlet ignora i mapping del nodo.
...
Questo cmdlet rimuove i metadati per le configurazioni nodo DSC nel gruppo di risorse specificato da questo parametro.
...
[Cmdlet di automazione di Azure](/powershell/module/Az.Automation/)
