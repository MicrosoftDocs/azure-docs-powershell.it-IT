...
## DESCRIZIONE
Il cmdlet **New-AzAutomationCertificate** crea un certificato nell'automazione di Azure.
...
Il primo comando converte una password di testo normale in una stringa sicura usando il cmdlet ConvertTo-SecureString testo.
...
Specifica il nome dell'account di automazione per cui questo cmdlet archivia il certificato.
...
### -Name
Specifica il nome per il certificato.
...
### -Path
Specifica il percorso di un file script caricato dal cmdlet.
