...
## DESCRIZIONE
Il cmdlet **Export-AzAutomationDscNodeReportContent** esporta il contenuto non elaborato di un report APS Desired State Configuration (DSC).
Un nodo DSC invia un report DSC all'automazione di Azure.
...
### -NodeId
Specifica l'ID univoco del nodo DSC per cui il cmdlet esporta il contenuto del report.
...
### -OutputFolder
Specifica la cartella di output in cui il cmdlet esporta il contenuto del report.
...
### -ReportId
Specifica l'ID univoco del report del nodo DSC esportato dal cmdlet.
