...
## DESCRIZIONE
Il cmdlet **New-AzAutomationConnection** crea una connessione nell'automazione di Azure.
...
Il primo comando assegna una tabella hash dei valori dei campi alla $FieldValue variabile.
...
Il comando usa i valori del campo di connessione in $FieldValues.
...
Il comando crea una connessione Azure denominata Connection13 nell'account di automazione denominato AutomationAccount01 usando $RunAsAccountConnectionFieldValues e ConnectionTypeName=AzureServicePrincipal.
Questo ConnectionTypeName=AzureServicePrincipal viene usato principalmente per l'account Run As di Azure.
...
Il comando crea una connessione Azure denominata Connection14 nell'account di automazione denominato AutomationAccount01 usando $ClassicRunAsAccountConnectionFieldValues e ConnectionTypeName=AzureClassicCertificate.
Questo ConnectionTypeName=AzureClassicCertificate viene usato principalmente per l'account Azure Classic Run As.
...
Specifica una tabella hash contenente coppie chiave/valore.
...
### -Descrizione
Specifica una descrizione della connessione.
