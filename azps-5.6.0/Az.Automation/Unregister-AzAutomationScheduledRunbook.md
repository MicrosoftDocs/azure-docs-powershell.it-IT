...
### ByJobScheduleId (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Unregister-AzAutomationScheduledRunbook** rimuove l'associazione tra un runbook di automazione di Azure e una pianificazione.
La pianificazione non avvia più il runbook.

## ESEMPI

### Esempio 1: Rimuovere l'associazione tra un runbook e una pianificazione
```
...
Questo comando rimuove l'associazione tra il runbook denominato Runbk01 e la pianificazione denominata Runbk01Sched.
...
### -JobScheduleId
Specifica l'ID di un runbook pianificato.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse per il runbook pianificato.
...
### -RunbookName
Specifica il nome del runbook che questo cmdlet dissocia da una pianificazione.
...
### -ScheduleName
Specifica il nome della pianificazione da cui questo cmdlet dissocia un runbook.
