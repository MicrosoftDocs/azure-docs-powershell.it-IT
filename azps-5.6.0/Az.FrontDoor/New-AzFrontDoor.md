...
## DESCRIZIONE
Il cmdlet **New-AzFrontDoor** crea una nuova bilanciamento del carico azure front-door nel gruppo di risorse specificato nell'abbonamento corrente

## ESEMPI

### Esempio 1: Creare una porta anteriore in base a specifici parametri.
```powershell
...
Creare una porta anteriore in base a specifici parametri.
...
### -EnabledState
EnabledState della bilanciamento del carico anteriore.
