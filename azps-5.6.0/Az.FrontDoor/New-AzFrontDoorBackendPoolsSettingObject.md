...
## DESCRIZIONE
Il cmdlet **New-AzFrontDoorBackendpoolsSettingObject** crea un nuovo oggetto PSBackendPoolsSettings per la creazione della porta anteriore.

## ESEMPI

### Esempio 1: Creare l'oggetto BackendPoolsSettings usando i valori predefiniti
```powershell
...
### Esempio 2: Creare l'oggetto BackendPoolsSettings con i valori specificati dall'utente
```powershell
...
Se applicare o meno la verifica del nome del certificato nelle richieste HTTPS a tutti i pool back-end.
...
Timeout di invio e ricezione durante la richiesta di inoltro al back-end. Quando viene raggiunto il timeout, la richiesta non riesce e restituisce.
