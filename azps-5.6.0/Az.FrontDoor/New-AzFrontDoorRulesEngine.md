...
Usare il cmdlet "New-AzFrontDoorRulesRulesRule" per creare regole del motore di regole da passare al parametro "-Rules" di questo cmdlet.
...
Crea una nuova configurazione del motore di regole per il porta anteriore specificata.
...
### -Rule
Elenco di regole che definiscono una particolare configurazione del motore di regole.
