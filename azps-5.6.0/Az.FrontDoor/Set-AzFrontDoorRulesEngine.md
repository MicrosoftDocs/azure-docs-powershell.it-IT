...
Ottenere una configurazione del motore di regole esistente e aggiungerne un'altra.
...
### -InputObject
Oggetto Motore di regole da aggiornare.
...
### -ResourceId
ID risorsa di RulesStudio da aggiornare
