...
## DESCRIZIONE
**Disable-AzFrontDoorCustomDomainHttps** disabilita HTTPS per un dominio personalizzato.
...
### Esempio 2: Disabilitare HTTPS per un dominio personalizzato con oggetto PSFrontendEndpoint.
```powershell
...
Disabilitare HTTPS per un dominio personalizzato con oggetto PSFrontendEndpoint.
...
### -ResourceId
ID risorsa dell'endpoint Front Door per disabilitare https
