...
## DESCRIZIONE
Creare un oggetto PSBackend per la creazione della porta anteriore
...
### -BackendHostHeader
Valore da usare come intestazione host inviata al back-end. Il valore predefinito è l'indirizzo back-end.
...
### -EnabledState
Se abilitare o meno l'uso di questo back-end. Il valore predefinito è Abilitato
...
### -PrivateLinkAlias
Alias della risorsa Collegamento privato. La compilazione di questo campo facoltativo indica che il back-end è 'Privato'
...
### -PrivateLinkLocation
Posizione della risorsa Collegamento privato. Location è obbligatorio quando PrivateLinkResourceId è impostato
...
ID risorsa del collegamento privato. La compilazione di questo campo facoltativo indica che il back-end è 'Privato'
...
### -Spessore
Peso di questo endpoint a scopo di bilanciamento del carico.
