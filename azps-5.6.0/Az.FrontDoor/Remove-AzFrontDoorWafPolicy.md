...
## DESCRIZIONE
Il cmdlet **Remove-AzFrontDoorWafPolicy** rimuove un criterio WAF nell'abbonamento corrente
...
Rimuovere i criteri WAF denominati $policyName in $resourceGroupName.
...
Rimuovere tutti i criteri WAF in $resourceGroupName.
...
### -InputObject
Oggetto criterio WAF da eliminare.
...
### -Name
Nome dei criteri WAF da eliminare.
...
### -ResourceGroupName
Gruppo di risorse a cui appartengono i criteri WAF.
...
### -ResourceId
ID risorsa dei criteri WAF da eliminare
