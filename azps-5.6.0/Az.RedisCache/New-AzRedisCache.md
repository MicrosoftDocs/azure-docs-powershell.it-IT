...
### Esempio 1: Creare una cache di Ridis
```
...
Questo comando crea una cache di Ridis.

### Esempio 2: Creare una cache di ridisposizione SKU standard
```
...
### -Location
Specifica la posizione in cui creare una cache di Ridisposizione.
I valori validi sono: 
- Stati Uniti centro settersi
...
### -Name
Specifica il nome della cache di Ridis da creare.
...
- rdb-backup-enabled.
Specifica che la persistenza dei dati di Ridisposizione è abilitata.
...
Specifica la frequenza di backup per la persistenza dei dati ridisposizione.
Solo livello Premium. 
- maxmemory-reserved.
Configura la memoria riservata ai processi non nella cache.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse in cui creare la cache di ridisposizione.
...
- 13 GB
- 26 GB
- 53 GB Il valore predefinito è 1 GB o C1.
...
### -StaticIP
Specifica un indirizzo IP univoco nella subnet per la cache di Redis.
Se non si specifica alcun valore per questo parametro, questo cmdlet sceglie un indirizzo IP dalla subnet.
