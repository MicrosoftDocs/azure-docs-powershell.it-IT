...
## DESCRIZIONE
Se viene specificato il parametro **RuleName,** il cmdlet **Get-AzRedisCacheFirewallRule** ottiene informazioni dettagliate sulla regola del firewall specificata nella cache di Azure Redis. Se si **specifica solo il** nome, questa operazione consente di ottenere tutte le regole del firewall disponibili nella cache di Ridis.
