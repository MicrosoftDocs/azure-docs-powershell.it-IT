...
## SYNOPSIS
Recupera informazioni sulla visualizzazione modello o sulla visualizzazione delle istanze di un computer ibrido.
...
### Esempio 1: Elencare tutti i computer connessi in un abbonamento
```powershell
...
Elenca tutti i computer connessi in un abbonamento.
Se non viene specificato l'abbonamento, userà quello del contesto corrente di Azure PowerShell.
...
### Esempio 3: Ottenere un computer connesso in un gruppo di risorse in base al nome
```powershell
...
Ottenere un computer connesso in un gruppo di risorse in base al nome.
