...
Consente di eseguire l'onboardmento di un computer remoto come dispositivo connesso tramite PowerShell.
...
### -PSSession
Se specificato, il comando che esegue l'onboarder di computer in Azure viene eseguito in ogni PSSession.
