...
### Esempio 1: Rimuovere un archivio di configurazione delle app
```powershell
PS C:\> Remove-AzAppConfigurationStore -Name appconfig-test03 -ResourceGroupName lucas-manual-test

```

Questo comando rimuove un archivio di configurazione delle app.

### Esempio 2: Rimuovere un archivio di configurazione delle app
```powershell
