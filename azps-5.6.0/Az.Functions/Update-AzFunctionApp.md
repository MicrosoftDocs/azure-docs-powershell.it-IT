...
## SYNOPSIS
Aggiorna un'app per le funzioni.
...
### Esempio 1: Aggiornare il piano di hosting dell'app con funzioni.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -PlanName NewPlanName 
```

Questo comando aggiorna il piano di hosting delle app con funzioni.

### Esempio 2: Impostare un'identità gestita SystemAssigned per un'app function.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -IdentityType SystemAssigned 
```

Questo comando imposta un'identità gestita SystemAssigned per un'app function.

### Esempio 3: Aggiornare application insights dell'app con funzioni.
```powershell
...
Questo comando aggiorna la funzionalità Application Insights dell'app.

### Esempio 3: Rimuovere l'identità gestita da un'app per le funzioni.
```powershell
PS C:\> Update-AzFunctionApp -Name MyUniqueFunctionAppName -ResourceGroupName MyResourceGroupName -IdentityType None 
```

Questo comando rimuove un'identità gestita da un'app per le funzioni.
...
Il tipo "Nessuno" rimuove le identità dall'app per le funzioni.
