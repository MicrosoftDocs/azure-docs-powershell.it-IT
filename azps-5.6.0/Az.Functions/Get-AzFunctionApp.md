...
### Esempio 1: Ottenere tutte le app con funzioni.
```powershell
...
### Esempio 2: Ottenere le app con funzioni in base al nome.
```powershell
...
### Esempio 3: Ottenere app con funzioni in base al nome del gruppo di risorse.
```powershell
...
### Esempio 4: Ottenere app con funzioni per gli abbonamenti.
```powershell
...
### Esempio 5: Ottenere le app con funzioni in base alla posizione.
```powershell
...
### -IncludeSlot
Da usare per specificare se includere gli slot di distribuzione nei risultati.
...
### -Location
Posizione dell'app per le funzioni.
