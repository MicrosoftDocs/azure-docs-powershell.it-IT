...
# Modulo Az.Functions
## Descrizione
Microsoft Azure PowerShell - Cmdlet del servizio Funzioni di Azure per Gestione risorse di Azure in Windows PowerShell e PowerShell Core.\n\n Per informazioni sulle funzioni di Azure, visita: https://docs.microsoft.com/azure/azure-functions/

## Cmdlet di Az.Functions
...
Recupera le app con funzioni in un abbonamento.

### [Get-AzFunctionAppAvailableLocation](Get-AzFunctionAppAvailableLocation.md)
Ottiene la posizione in cui è disponibile un'app per le funzioni per il tipo di piano e di sistema specificato.

### [Get-AzFunctionAppPlan](Get-AzFunctionAppPlan.md)
Ottenere i piani delle app per le funzioni in un abbonamento.

### [Get-AzFunctionAppSetting](Get-AzFunctionAppSetting.md)
Recupera le impostazioni dell'app per un'app per le funzioni.

### [Get-AzSystemAssignedIdentity](Get-AzSystemAssignedIdentity.md)
Ottiene systemAssignedIdentity disponibile nell'ambito RP specificato.

### [GetAzWebAppConfig](GetAzWebAppConfig.md)


### [Get-AzWebAppFunctionKey](Get-AzWebAppFunctionKey.md)
Descrizione di Ottenere i tasti funzione per una funzione in un sito Web o uno slot di distribuzione.
...
Descrizione per ottenere le impostazioni e lo stato dell'app di riferimento alla configurazione di un'app

### [Get-AzWebAppSyncStatus](Get-AzWebAppSyncStatus.md)
Descrizione per consentire le chiamate tramite PowerShell e ARM modello.
...
### [Move-Az](Move-Az.md)
Descrizione dello spostamento di risorse tra gruppi di risorse.
...
La descrizione della funzione sincronizza attiva i metadati nel database di gestione

### [Test-Az](Test-Az.md)
Descrizione per Verificare se è possibile creare una risorsa.
...
Aggiunge o aggiorna le impostazioni dell'app in un'app per le funzioni.
...
### [ValidatePlanValidValidCompatibility](ValidatePlanSwitchCompatibility.md)
