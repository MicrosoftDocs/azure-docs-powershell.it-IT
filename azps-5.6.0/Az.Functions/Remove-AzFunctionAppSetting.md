...
## SYNOPSIS
Rimuove le impostazioni dell'app da un'app per le funzioni.
...
### Esempio 1: Rimuovere le impostazioni dell'app in un'app per le funzioni.
```powershell
...
Questo comando rimuove le impostazioni dell'app in un'app per le funzioni.

## PARAMETERS

### -AppSettingName
Elenco delle impostazioni dell'app per le funzioni da rimuovere dall'app per le funzioni.
...
### -Force
Forza il cmdlet a rimuovere l'impostazione dell'app funzione senza richiedere conferma.
...
INPUTOBJECT <ISite> : 
  ...
  - `[Config <ISiteConfig>]`: configurazione dell'app.
    ...
    - `[AppCommandLine <String>]`: riga di comando dell'app per l'avvio.
