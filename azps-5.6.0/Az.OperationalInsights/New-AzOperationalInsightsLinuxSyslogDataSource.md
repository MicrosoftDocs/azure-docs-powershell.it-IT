...
## DESCRIZIONE
Il cmdlet **New-AzOperationalInsightsLinuxSyslogDataSource** aggiunge un'origine dati SysLog ai computer Linux connessi in un'area di lavoro.
Azure Operational Insights può raccogliere dati syslog.
...
### -CollectCritical
Indica che Dati operativi raccoglie messaggi critici.
...
### -CollectSetting
Indica che Dati operativi raccoglie messaggi di debug.
...
### -CollectEmergency
Indica che Dati operativi raccoglie messaggi di emergenza.
...
### -CollectWarning
Indica che il log di sistema include messaggi di avviso.
