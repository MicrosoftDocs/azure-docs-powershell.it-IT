...
## DESCRIZIONE
Il cmdlet **New-AzOperationalInsightsLinuxPerformanceObjectDataSource** aggiunge i contatori delle prestazioni da cui Azure Operational Insights raccoglie dati in tutti i computer Linux in un'area di lavoro.
