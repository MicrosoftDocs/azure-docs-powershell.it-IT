...
## SYNOPSIS
Crea un'area di lavoro o ripristina un'area di lavoro eliminata in modo ].
...
### -SKU
Specifica il livello di servizio dell'area di lavoro. Per altre informazioni sul valore da usare, https://docs.microsoft.com/azure/azure-monitor/platform/manage-cost-storage#legacy-pricing-tiers controlla.
