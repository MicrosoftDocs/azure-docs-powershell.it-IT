...
## DESCRIZIONE
Il cmdlet **Disable-AzOperationalInsightsLinuxPerformanceCollection** interrompe la raccolta di contatori delle prestazioni dai computer Linux connessi in un'area di lavoro.
