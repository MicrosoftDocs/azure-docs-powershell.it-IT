...
## DESCRIZIONE
Il cmdlet **Enable-AzOperationalInsightsLinuxCustomLogCollection avvia** la raccolta di log personalizzati dai computer Linux connessi in un'area di lavoro.
