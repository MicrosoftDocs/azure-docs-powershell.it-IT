...
## Descrizione
Questo argomento visualizza gli argomenti della Guida per i cmdlet di Azure Operational Insights.
...
Interrompe la raccolta di log personalizzati da computer Linux.

### [Disable-AzOperationalInsightsLinuxPerformanceCollection](Disable-AzOperationalInsightsLinuxPerformanceCollection.md)
Interrompe la raccolta di contatori delle prestazioni dai computer Linux.
...
Avvia la raccolta di log IIS dai computer di un'area di lavoro.

### [Enable-AzOperationalInsightsLinuxCustomLogCollection](Enable-AzOperationalInsightsLinuxCustomLogCollection.md)
Avvia la raccolta di log personalizzati da computer Linux.
...
Ottiene informazioni su informazioni sull'archiviazione.
...
Recupera i dettagli dei gruppi di gestione connessi a un'area di lavoro.
...
Recupera i dati di utilizzo per un'area di lavoro.
...
Raccogliere log da una determinata Application-Insights applicazione.

### [New-AzOperationalInsightsAzureActivityLogDataSource](New-AzOperationalInsightsAzureActivityLogDataSource.md)
Raccogliere il log attività di Azure dalla sottoscrizione specificata.
...
Creare un account di archiviazione collegato per l'area di lavoro

### [New-AzOperationalInsightsLinuxPerformanceObjectDataSource](New-AzOperationalInsightsLinuxPerformanceObjectDataSource.md)
Aggiunge i contatori delle prestazioni a tutti i computer Linux in un'area di lavoro.
...
Scollega servizio per l'area di lavoro
...
Abilita o disabilita il Pacchetto di intelligence specificato.
...
Impostare l'account di archiviazione collegato per l'area di lavoro
