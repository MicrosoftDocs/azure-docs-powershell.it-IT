...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareTrigger** ottiene informazioni sul trigger per la sottoscrizione della condivisione nell'account di condivisione dati.
...
Questo comando recupera informazioni sull'attivazione di AdsTrigger per la condivisione della sottoscrizione AdsShareSubscription in WikiAds dell'account per la condivisione di dati.
