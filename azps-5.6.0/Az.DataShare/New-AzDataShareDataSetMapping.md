...
Questo comando crea un set di dati che mappa AdsDataSetMapping all'account di archiviazione AdsStorage per la sottoscrizione di condivisione AdsShareSubscription nell'account di condivisione dati WikiAdsAccount.
