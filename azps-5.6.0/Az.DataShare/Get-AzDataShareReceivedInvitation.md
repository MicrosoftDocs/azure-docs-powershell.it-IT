...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareReceivedInvitation** fornisce informazioni su tutti gli inviti che il consumer ha ricevuto. Se si fornisce l'ID della posizione o dell'invito, questo cmdlet fornisce informazioni sull'invito in una località specifica o sull'ID invito. In caso contrario, fornisce un elenco di inviti inviati al consumatore.
...
Questo punto e virgola fornisce informazioni sugli inviti dei consumatori.
...
### -Location
Percorso di invito per la condivisione di dati di Azure.
