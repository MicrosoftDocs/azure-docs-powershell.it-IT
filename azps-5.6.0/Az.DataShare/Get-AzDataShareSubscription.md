...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareSubscription** fornisce informazioni sulla sottoscrizione della condivisione in un account di condivisione dati. Se si specifica il nome della sottoscrizione di condivisione, il cmdlet fornisce informazioni sulla sottoscrizione di condivisione specifica. In caso contrario, il cmdlet fornisce un elenco delle sottoscrizioni di condivisione nell'account di condivisione dati.
...
Questo comando fornisce informazioni sulla condivisione della sottoscrizione AdsShareSubscription nell'account di condivisione dati WikiAds.
...
### -Name
Nome della sottoscrizione della condivisione dati di Azure
...
### -ResourceId
ID risorsa della sottoscrizione della condivisione dei dati di Azure
