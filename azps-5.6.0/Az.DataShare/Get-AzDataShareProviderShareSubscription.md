...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareProviderSubscription** ottiene informazioni sulle sottoscrizioni per le condivisioni consumer sul lato provider. Se si specifica l'ID sottoscrizione della condivisione, questo cmdlet ottiene informazioni sulla sottoscrizione della condivisione. Se non si specifica l'ID della sottoscrizione di condivisione, questo cmdlet riceve informazioni su tutte le sottoscrizioni di condivisione consumer associate alla condivisione.
