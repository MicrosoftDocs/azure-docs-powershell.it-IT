...
## SYNOPSIS
Crea un trigger per la condivisione della sottoscrizione.
...
Questo comando crea un nuovo trigger AdsTrigger per condividere l'abbonamento AdsShareSubscription con un intervallo di ricorrenza giornaliero di 9 am.
