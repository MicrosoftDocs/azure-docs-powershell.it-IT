...
### -InputObject
Oggetto di condivisione dati di Azure ' ''yaml Type: PSDataShare Parameter Sets: ByObjectParameterSet Aliases: 
...
Obbligatorio: Posizione Falso: Valore predefinito denominato: Input pipeline None Accept: False Accept wildcard characters: False
