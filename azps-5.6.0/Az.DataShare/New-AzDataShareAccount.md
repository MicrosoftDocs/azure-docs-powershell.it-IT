...
## DESCRIZIONE
Il cmdlet **New-AzDataShareAccount** crea un account di condivisione dati nel gruppo di risorse Azure specificato.
...
Crea un account denominato "WikiADS" nel gruppo di risorse "ADS"
...
### -ResourceGroupName
Verrà creato il nome del gruppo di risorse dell'account di condivisione dei dati di Azure.
...
### -Tag
I tag da associare all'account di condivisione dati di Azure.
