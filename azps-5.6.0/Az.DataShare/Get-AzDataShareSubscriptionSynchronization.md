...
## DESCRIZIONE
Il cmdlet **Get-AzDataShareSubscriptionSynchronization** fornisce informazioni su tutta la sincronizzazione eseguita in una sottoscrizione di condivisione in un account di condivisione dati nel consumer.
...
Questo comando fornisce informazioni su tutta la sincronizzazione eseguita per una sottoscrizione di condivisione AdsShareSubscription nell'account di condivisione dati WikiAds.
...
### -ResourceId
ID risorsa sottoscrizione condivisione dati di Azure
