...
## DESCRIZIONE
Il cmdlet **Remove-AzDataShareInvitation** rimuove un invito alla condivisione dati.
...
Questo comando rimuove un invito denominato ADSInvite da condividere AdsShare. 
...
### -InputObject
Oggetto invito per la condivisione di dati di Azure
