...
Il New-AzServiceBusRule cmdlet crea una nuova regola per la sottoscrizione specificata con ActionFilter.

## PARAMETERS

### -ActionSqlExpression
Espressione SqlFilter per azioni
...
L'azione richiede la pre-elaborazione
