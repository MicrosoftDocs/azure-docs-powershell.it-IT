...
## DESCRIZIONE
Il cmdlet **Start-AzServiceBusMigration** crea una nuova configurazione di migrazione e inizia la migrazione delle entità dagli spazi dei nomi Standard a Premium
...
Crea una nuova configurazione di migrazione per 'TestingStandardMigration' per gli spazi dei nomi 'TestingStandardPremiumMigration'
...
### -PostMigrationName
Nome post-migrazione per lo spazio dei nomi standard nella migrazione
