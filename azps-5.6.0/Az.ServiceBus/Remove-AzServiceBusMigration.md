...
## DESCRIZIONE
Il cmdlet **Remove-AzServiceBusMigration** elimina la configurazione della migrazione per gli spazi dei nomi Da Standard a Premium
...
Elimina la configurazione di migrazione 'TestingStandardMigration'
...
### -InputObject
Oggetto Spazio dei nomi standard di migrazione del bus di servizio
...
### -ResourceId
ID risorsa spazio dei nomi standard di migrazione bus di servizio
