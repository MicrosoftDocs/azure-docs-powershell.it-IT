...
## DESCRIZIONE
Il cmdlet **New-AzServiceBus Pull crea** un nuovo spazio dei nomi del bus di servizio. Una volta creato, il manifesto della risorsa dello spazio dei nomi non è modificabile. Questa operazione è stata identificata come idempotente.
