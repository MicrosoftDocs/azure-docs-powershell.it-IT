...
### Esempio 1: Creare una nuova raccolta di spostamento.
```powershell
...
Creare una nuova raccolta di spostamento.
...
### -IdentityType
Tipo di identità usato per il servizio di spostamento delle risorse.
