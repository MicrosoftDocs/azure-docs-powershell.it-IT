...
### Esempio 1: Convalidare le dipendenze prima di eliminare le risorse.
```powershell
...
Verificare le dipendenze prima dell'eliminazione delle risorse.

### Esempio 2: Elimina lo spostamento delle risorse usando "MoveResource Name" come input.
```powershell
...
Elimina lo spostamento delle risorse usando "MoveResource Name" come input.

### Esempio 3: Elimina lo spostamento delle risorse usando "SourceARMID" come input.
```powershell
...
Elimina lo spostamento delle risorse con "SourceARMID" come input.
