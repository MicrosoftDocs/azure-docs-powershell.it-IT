...
### Esempio 1: Ottenere i dettagli di tutte le raccolte di spostamento nell'abbonamento
```powershell
...
Ottenere informazioni dettagliate sulla raccolta di spostamento con un nome di raccolta di spostamento specificato nella sottoscrizione.
