...
### Esempio 1: Convalidare le dipendenze prima di iniziare lo spostamento per le risorse.
```powershell
...
Verificare le dipendenze prima di iniziare lo spostamento per le risorse.

### Esempio 2: Iniziare lo spostamento per il set di risorse nella raccolta Move usando "MoveResource Name" come input.
```powershell
...
Iniziare lo spostamento per il set di risorse nella raccolta Move usando "MoveResource Name" come input.

### Esempio 3: Iniziare lo spostamento per il set di risorse nella raccolta di spostamento usando "SourceARMID" come input.
```powershell
...
Iniziare lo spostamento per il set di risorse nella raccolta Move usando "SourceARMID" come input.
