...
## DESCRIZIONE
Il cmdlet **Get-AzSearchAdminKeyPair** ottiene la coppia di chiavi di amministrazione del servizio Azure Cognitive Search.
...
L'esempio ottiene la coppia di chiavi di amministratore del servizio Ricerca cognitiva di Azure.
