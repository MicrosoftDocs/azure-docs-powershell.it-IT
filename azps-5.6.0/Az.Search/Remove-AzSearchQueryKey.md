...
## DESCRIZIONE
Il cmdlet **Remove-AzSearchQueryKey** rimuove la chiave di query dal servizio Azure Cognitive Search.
...
L'esempio rimuove la chiave di query dal servizio Ricerca cognitiva di Azure.
...
### -KeyValue
Valore di chiave della chiave della query del servizio cognitivo di Azure.
