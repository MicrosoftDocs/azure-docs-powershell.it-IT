...
## DESCRIZIONE
**Set-AzSearchPrivateEndpointConnection** aggiorna la connessione dell'endpoint privato al servizio Ricerca cognitiva di Azure.
...
Questo esempio aggiorna lo stato del servizio Ricerca cognitiva cognitiva di Azure per una connessione all'endpoint privato in modo che sia "Rifiutato".
...
### -Descrizione
Descrizione della connessione all'endpoint privato
...
### -InputObject
Oggetto di input della connessione all'endpoint privato
