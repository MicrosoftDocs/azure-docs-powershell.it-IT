...
## DESCRIZIONE
Il cmdlet **New-AzSearchQueryKey** crea una nuova chiave di query per il servizio Azure Cognitive Search.
...
L'esempio crea una nuova chiave di query per il servizio Ricerca cognitiva di Azure.
...
### -Name
Nome della chiave della chiave della query del servizio di ricerca cognitiva di Azure.
