...
## DESCRIZIONE
Questo **set-AzSearchSharedPrivateLinkResource** aggiorna la risorsa collegamento privato condiviso per il servizio Ricerca cognitiva di Azure.
...
Questo esempio aggiorna il messaggio di richiesta per la risorsa collegamento privato condiviso in sospeso per il servizio Azure Cognitive Search.
