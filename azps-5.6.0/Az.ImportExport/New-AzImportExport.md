...
URI relativo al BLOB di blocco che contiene l'elenco di percorsi BLOB o prefissi del percorso BLOB definiti in precedenza, a partire dal nome del contenitore.
...
Percorso BLOB che punta a un BLOB di blocco contenente un elenco di nomi BLOB non esportati a causa di spazio insufficiente sull'unità.
