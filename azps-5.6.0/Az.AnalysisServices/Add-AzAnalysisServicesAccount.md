...
Questo esempio aggiungerà l'account dell'entità servizio applicazione specificato da ApplicationId, TenantId e CertificateThumbprint all'ambiente westcentralus.asazure.windows.net Analysis Services.
