...
## DESCRIZIONE
LNew-AzAnalysisServicesFirewallRule crea un nuovo oggetto regola del firewall.
...
Crea una regola del firewall denominata regola1 con intervallo di inizio 0.0.0.0 e intervallo finale 255.255.255.255.
...
### -RangeStart
L'inizio dell'intervallo di una regola del firewall
