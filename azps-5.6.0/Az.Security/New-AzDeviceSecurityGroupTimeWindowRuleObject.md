...
## DESCRIZIONE
Il New-AzDeviceSecurityGroupTimeWindowRuleObject cmdlet crea un nuovo elenco di regole di avviso per il periodo di tempo per il gruppo di sicurezza dei dispositivi nella soluzione di sicurezza IoT.
...
Creare una nuova regola per l'intervallo di tempo dal tipo "ActiveConnectionsNotInAllowedRange"
...
### -TimeWindowSize
Dimensioni dell'intervallo di tempo.
