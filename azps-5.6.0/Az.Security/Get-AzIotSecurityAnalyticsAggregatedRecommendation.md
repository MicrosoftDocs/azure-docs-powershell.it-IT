...
## DESCRIZIONE
Il Get-AzIotSecurityAnalyticsAggregatedAlert cmdlet restituisce uno o più consigli aggregati nei dispositivi dell'hub iot. Il nome di un suggerimento aggregato è il relativo tipo
...
Ottenere il suggerimento aggregato "IoT_OpenPorts" nella soluzione di sicurezza "MySolution" e nel gruppo di risorse "MyResourceGroup"
...
Ottenere un elenco di suggerimenti aggregati nella soluzione di sicurezza "MySolution" e nel gruppo di risorse "MyResourceGroup"
