...
## SYNOPSIS
Recupera i criteri di accesso alla rete JIT
...
## DESCRIZIONE
I criteri di accesso di rete Just In Time (JIT) consentono di definire un criterio per consentire agli utenti semplici di creare una connessione di rete temporanea a una macchina virtuale.
Il criterio definisce quali porte, protocollo e indirizzi IP di origine possono richiedere una connessione a una macchina virtuale e la durata massima prima che la connessione venga chiusa automaticamente.
Nei criteri è anche possibile visualizzare la richiesta di connessione effettuata con questo criterio. 
...
Ottenere tutti i criteri di accesso alla rete JIT in un abbonamento
...
Ottenere tutti i criteri di accesso alla rete JIT nel gruppo di risorse "myService1"
...
Ottiene uno specifico criterio di accesso alla rete JIT
