...
## DESCRIZIONE
Il cmdlet New-AzDeviceSecurityGroupDenylistCustomAlertRuleObject crea un nuovo elenco di regole di avviso personalizzate non negate per il gruppo di sicurezza dei dispositivi nella soluzione di sicurezza IoT.
...
Creare una nuova regola di avviso personalizzata con il tipo di avviso personalizzato "SomeRuleType" e lo stato impostato su desable
...
### -DenylistValue
Valori dell'elenco non consentiti.
