...
## DESCRIZIONE
Richiama una richiesta di accesso temporaneo alla rete.
La richiesta viene convalidata in base al criterio di accesso di rete JIT configurato e, se consentito, apre una connessione di rete in base alla richiesta dell'utente.
La richiesta verrà registrata nei criteri per un'analisi successiva e verrà terminata quando verrà superata la durata specificata.
...
Apre una connessione di rete per 1 ora sulla porta 22 dall'IP pubblico (non visualizzata).
