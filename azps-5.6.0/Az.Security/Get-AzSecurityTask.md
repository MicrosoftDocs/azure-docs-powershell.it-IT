...
## DESCRIZIONE
Il Centro sicurezza di Azure analizza le risorse per rilevare potenziali problemi di sicurezza.
Questo cmdlet consente di individuare le attività di sicurezza consigliate dal Centro sicurezza di Azure.
...
Recupera tutte le attività di sicurezza individuate nelle risorse all'interno di una sottoscrizione.
...
Ottiene tutte le attività di sicurezza individuate nelle risorse all'interno di un gruppo di risorse.
...
Ottiene un'attività di sicurezza specifica.
