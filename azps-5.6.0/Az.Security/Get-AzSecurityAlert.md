...
ms.locfileid: "101979342"
---
# <span data-ttu-id="df327-101">Get-AzSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="df327-101">Get-AzSecurityAlert</span></span>

## <span data-ttu-id="df327-102">SYNOPSIS</span><span class="sxs-lookup"><span data-stu-id="df327-102">SYNOPSIS</span></span>
<span data-ttu-id="df327-103">Recupera gli avvisi di sicurezza rilevati dal Centro sicurezza di Azure</span><span class="sxs-lookup"><span data-stu-id="df327-103">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="df327-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="df327-104">SYNTAX</span></span>

### <span data-ttu-id="df327-105">SubscriptionScope (impostazione predefinita)</span><span class="sxs-lookup"><span data-stu-id="df327-105">SubscriptionScope (Default)</span></span>
```
Get-AzSecurityAlert [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="df327-106">ResourceGroupScope</span><span class="sxs-lookup"><span data-stu-id="df327-106">ResourceGroupScope</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="df327-107">ResourceGroupLevelResource</span><span class="sxs-lookup"><span data-stu-id="df327-107">ResourceGroupLevelResource</span></span>
```
Get-AzSecurityAlert -ResourceGroupName <String> -Name <String> -Location <String>
 [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

### <span data-ttu-id="df327-108">SubscriptionLevelResource</span><span class="sxs-lookup"><span data-stu-id="df327-108">SubscriptionLevelResource</span></span>
```
Get-AzSecurityAlert -Name <String> -Location <String> [-DefaultProfile <IAzureContextContainer>]
 [<CommonParameters>]
```

### <span data-ttu-id="df327-109">ResourceId</span><span class="sxs-lookup"><span data-stu-id="df327-109">ResourceId</span></span>
```
Get-AzSecurityAlert -ResourceId <String> [-DefaultProfile <IAzureContextContainer>] [<CommonParameters>]
```

## <span data-ttu-id="df327-110">DESCRIZIONE</span><span class="sxs-lookup"><span data-stu-id="df327-110">DESCRIPTION</span></span>
<span data-ttu-id="df327-111">Recupera gli avvisi di sicurezza rilevati dal Centro sicurezza di Azure</span><span class="sxs-lookup"><span data-stu-id="df327-111">Gets security alerts that were detected by Azure Security Center</span></span>

## <span data-ttu-id="df327-112">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="df327-112">EXAMPLES</span></span>

### <span data-ttu-id="df327-113">Esempio 1</span><span class="sxs-lookup"><span data-stu-id="df327-113">Example 1</span></span>
```powershell
...
<span data-ttu-id="df327-114">Recupera tutti gli avvisi di sicurezza rilevati nelle risorse all'interno di una sottoscrizione</span><span class="sxs-lookup"><span data-stu-id="df327-114">Gets all the security alerts that were detected on resources inside a subscription</span></span>

### <span data-ttu-id="df327-115">Esempio 2</span><span class="sxs-lookup"><span data-stu-id="df327-115">Example 2</span></span>
```powershell
...
<span data-ttu-id="df327-116">Recupera tutti gli avvisi di sicurezza rilevati nelle risorse all'interno del gruppo di risorse "myService1"</span><span class="sxs-lookup"><span data-stu-id="df327-116">Gets all the security alerts that were detected on resources inside the "myService1" resource group</span></span>

### <span data-ttu-id="df327-117">Esempio 3</span><span class="sxs-lookup"><span data-stu-id="df327-117">Example 3</span></span>
```powershell
...
<span data-ttu-id="df327-118">Ottiene uno specifico avviso di sicurezza rilevato nelle risorse all'interno del gruppo di risorse "myService1"</span><span class="sxs-lookup"><span data-stu-id="df327-118">Gets a specific security alert that were detected on resources inside the "myService1" resource group</span></span>

## <span data-ttu-id="df327-119">PARAMETERS</span><span class="sxs-lookup"><span data-stu-id="df327-119">PARAMETERS</span></span>

### <span data-ttu-id="df327-120">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="df327-120">-DefaultProfile</span></span>
<span data-ttu-id="df327-121">Le credenziali, l'account, il tenant e la sottoscrizione usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="df327-121">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="df327-122">-Location</span><span class="sxs-lookup"><span data-stu-id="df327-122">-Location</span></span>
<span data-ttu-id="df327-123">Posizione.</span><span class="sxs-lookup"><span data-stu-id="df327-123">Location.</span></span>
...
### <span data-ttu-id="df327-124">-Name</span><span class="sxs-lookup"><span data-stu-id="df327-124">-Name</span></span>
<span data-ttu-id="df327-125">Nome della risorsa.</span><span class="sxs-lookup"><span data-stu-id="df327-125">Resource name.</span></span>
...
### <span data-ttu-id="df327-126">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="df327-126">-ResourceGroupName</span></span>
<span data-ttu-id="df327-127">Nome del gruppo di risorse.</span><span class="sxs-lookup"><span data-stu-id="df327-127">Resource group name.</span></span>
...
### <span data-ttu-id="df327-128">-ResourceId</span><span class="sxs-lookup"><span data-stu-id="df327-128">-ResourceId</span></span>
<span data-ttu-id="df327-129">ID risorsa.</span><span class="sxs-lookup"><span data-stu-id="df327-129">Resource ID.</span></span>
...
### <span data-ttu-id="df327-130">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="df327-130">CommonParameters</span></span>
<span data-ttu-id="df327-131">Questo cmdlet supporta i parametri comuni: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutAction, -PipelineVariable, -Verbose, -WarningAction e -WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="df327-131">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="df327-132">Per altre informazioni, [vedere](http://go.microsoft.com/fwlink/?LinkID=113216)about_CommonParameters.</span><span class="sxs-lookup"><span data-stu-id="df327-132">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="df327-133">INPUT</span><span class="sxs-lookup"><span data-stu-id="df327-133">INPUTS</span></span>

### <span data-ttu-id="df327-134">System.String</span><span class="sxs-lookup"><span data-stu-id="df327-134">System.String</span></span>

## <span data-ttu-id="df327-135">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="df327-135">OUTPUTS</span></span>

### <span data-ttu-id="df327-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span><span class="sxs-lookup"><span data-stu-id="df327-136">Microsoft.Azure.Commands.Security.Models.Alerts.PSSecurityAlert</span></span>

## <span data-ttu-id="df327-137">NOTE</span><span class="sxs-lookup"><span data-stu-id="df327-137">NOTES</span></span>

## <span data-ttu-id="df327-138">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="df327-138">RELATED LINKS</span></span>
