...
## SYNOPSIS
Verifica che il nome dell'assegnazione dell'entità sia valido e che non sia già in uso.
...
### Esempio 1: Controllare la disponibilità di un nome di entità principale di un cluster che è in uso
```powershell
...
Il comando precedente restituisce se un principalAssignment denominato "myprincipal" esiste nel cluster "testnewkustocluster".

### Esempio 2: Controllare la disponibilità di un nome di entità principale di un cluster che non è in uso
```powershell
...
Il comando precedente restituisce se un principalAssignment denominato "newprincipal" esiste nel cluster "testnewkustocluster".
...
### -Type
Tipo di risorsa, Microsoft.Kusto/Clusters/principalAssignments.
