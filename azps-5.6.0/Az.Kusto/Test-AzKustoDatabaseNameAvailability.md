...
### Esempio 1: Verificare la disponibilità di un nome di database Kusto in uso
```powershell
...
Il comando precedente restituisce se un database Kusto denominato "mykustodatabase" esiste nel cluster "testnewkustocluster".

### Esempio 2: Verificare la disponibilità di un nome di database Kusto che non è in uso
```powershell
...
Il comando precedente restituisce se un database Kusto denominato "mykustodatabase2" esiste nel cluster "testnewkustocluster".
