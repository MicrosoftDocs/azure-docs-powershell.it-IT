...
### Esempio 1: Creare un'entità database cluster Kusto principalAssignment
```powershell
...
Il comando precedente crea un'entità database cluster Kusto principalAssignment
...
### -PrincipalId
ID entità assegnato all'entità database.
Può trattarsi di un messaggio di posta elettronica dell'utente, un ID applicazione o il nome di un gruppo di sicurezza.
