...
### Esempio 1: Aggiungere un elenco di estensioni delle lingue
```powershell
PS C:\> Add-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"}, @{Name="PYTHON"})
```

Il comando precedente aggiunge un elenco di estensioni delle lingue che possono essere eseguite all'interno di query KQL
