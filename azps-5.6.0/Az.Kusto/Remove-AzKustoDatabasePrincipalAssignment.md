...
### Esempio 1: Eliminare un database PrincipalAssignment esistente di Kusto in base al nome
```powershell
...
Il comando precedente elimina l'assegnazione principalAssignment denominata "kustoprincipal1" nel database Kusto "mykustodatabase".
