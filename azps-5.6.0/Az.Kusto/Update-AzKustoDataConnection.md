...
### Esempio 1: Aggiornare una connessione dati di EventHub esistente
```powershell
...
Il comando precedente aggiorna la connessione dati Esistente di EventHub denominata "myeventhubdc" per il database "mykustodatabase" nel cluster "testnewkustocluster".
...
### Esempio 4: Aggiornare una connessione dati di EventHub esistente tramite identità
```powershell
...
### Esempio 5: Aggiornare una connessione dati EventGrid esistente tramite l'identità
```powershell
...
### Esempio 6: Aggiornare una connessione dati IotHub esistente tramite un'identità
```powershell
...
Facoltativamente, le informazioni della tabella possono essere aggiunte a ogni messaggio.
