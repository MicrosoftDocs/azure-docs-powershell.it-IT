...
### Esempio 1: Elencare tutte le principalAssignment in un database in base al nome
```powershell
...
Il comando precedente restituisce tutti gli elementi PrincipalAssignment del database "mykustodatabase" trovati nel cluster "testnewkustocluster".

### Esempio 2: Ottenere un'assegnazione principale specifica in un database in base al nome
```powershell
...
Il comando precedente restituisce tutto il principalAssignment denominato "kustoprincipal1" nel database "mykustodatabase" trovato nel cluster "testnewkustocluster".
