...
### Esempio 1: Verificare la disponibilità di un nome di entità principale di database in uso
```powershell
...
Il comando precedente restituisce se un principalAssignment denominato "myprincipal" esiste nel database "mykustodatabase" del cluster "testnewkustocluster".

### Esempio 2: Verificare la disponibilità di un nome di entità principale di database che non è in uso
```powershell
...
### -Type
Tipo di risorsa, Microsoft.Kusto/Clusters/Databases/principalAssignments.
