...
### Esempio 1: Rimuovere un elenco di estensioni delle lingue dal cluster
```powershell
PS C:\> Remove-AzKustoClusterLanguageExtension -ResourceGroupName testrg -ClusterName testnewkustocluster -Value (@{Name="R"})
```

Il comando precedente rimuove un elenco di estensioni di lingua che possono essere eseguite all'interno di query KQL.
...
VALUE <ILanguageExtension[]>: elenco delle estensioni delle lingue.
