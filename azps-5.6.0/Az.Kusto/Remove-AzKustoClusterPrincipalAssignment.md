...
### Esempio 1: Eliminare un cluster PrincipalAssignment esistente di Kusto in base al nome
```powershell
...
Il comando precedente elimina l'app PrincipalAssignment denominata "kustoprincipal1" nel cluster Kusto "testnewkustocluster".
