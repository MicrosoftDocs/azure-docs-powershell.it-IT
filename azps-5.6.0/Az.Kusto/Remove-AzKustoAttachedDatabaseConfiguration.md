...
### Esempio 1: Eliminare un'istanza di AttachedDatabaseConfiguration esistente in base al nome
```powershell
...
Il comando precedente elimina il database di follower definito in AttachedDatabaseConfiguration "myfollowerconfiguration" dal cluster "testnewkustoclusterf".
...
### -Name
Nome della configurazione di database allegata.
