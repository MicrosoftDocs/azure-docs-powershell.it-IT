...
### Esempio 1: Elenco delle entità database del cluster e del database Kusto specificato
```powershell
...
Il comando precedente restituisce un elenco delle entità database del cluster e del database Kusto specificato
