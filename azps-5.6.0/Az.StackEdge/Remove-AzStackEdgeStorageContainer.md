...
## DESCRIZIONE
Il cmdlet **Remove-AzStackEdgeStorageContainer rimuove** un contenitore di archiviazione associato per l'account Di archiviazione Edge in un dispositivo Stack Edge. È possibile specificare il nome del contenitore di archiviazione da rimuovere come parametro.
