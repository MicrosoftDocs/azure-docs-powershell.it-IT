...
## DESCRIZIONE
Il cmdlet **Get-AzStackEdgeJob** ottiene i processi attivi in un dispositivo Stack Edge. È possibile menzionare il parametro Name per ottenere i dettagli di un processo specifico.
