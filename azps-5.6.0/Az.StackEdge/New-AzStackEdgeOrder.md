...
## DESCRIZIONE
Il cmdlet **New-AzStackEdgeOrder** crea un nuovo ordine per un dispositivo Stack Edge. Prima di creare un ordine, è necessario creare una risorsa dispositivo Stack Edge. È possibile specificare dettagli come la persona di contatto, il nome della società, l'indirizzo di posta elettronica, l'indirizzo e così via come parametri per la creazione dell'ordine.
