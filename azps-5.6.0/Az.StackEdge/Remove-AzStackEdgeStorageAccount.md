...
## DESCRIZIONE
Il cmdlet **Remove-AzStackEdgeStorageAccount** rimuove un account di archiviazione Edge associato per un dispositivo Stack Edge. È possibile specificare il nome dell'account di archiviazione di Microsoft Edge da rimuovere come parametro nel cmdlet.
