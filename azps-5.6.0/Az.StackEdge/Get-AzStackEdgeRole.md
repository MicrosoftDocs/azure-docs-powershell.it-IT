...
## DESCRIZIONE
Il **cmdlet Get-AzStackEdgeRole** recupera i ruoli IoT disponibili per un dispositivo Stack Edge. È possibile menzionare il parametro Name per ottenere i dettagli di un ruolo IoT specifico.
