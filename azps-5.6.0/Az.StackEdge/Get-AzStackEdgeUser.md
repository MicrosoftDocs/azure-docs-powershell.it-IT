...
## DESCRIZIONE
Il **cmdlet Get-AzStackEdgeUser** elenca gli utenti configurati per un dispositivo Stack Edge. È possibile menzionare il nome nei parametri per ottenere informazioni dettagliate su un utente specifico.
