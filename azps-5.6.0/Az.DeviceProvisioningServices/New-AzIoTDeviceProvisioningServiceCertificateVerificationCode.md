...
## SYNOPSIS
Generare un codice di verifica per un certificato del servizio di provisioning dei dispositivi Hub IoT di Azure.
...
## DESCRIZIONE
Questo codice di verifica viene usato per completare il passaggio di prova di convalida per un certificato. Usare questo codice di verifica come CN di un nuovo certificato firmato con la chiave privata dei certificati radice.
Per una spiegazione dettagliata dei certificati CA nel servizio di provisioning dei dispositivi hub IoT di Azure, vedere https://docs.microsoft.com/azure/iot-dps/how-to-verify-certificates .
...
Genera un codice di verifica per "mycertificate" usando la pipeline.

## PARAMETERS

### -CertificateName
Nome del certificato del servizio di provisioning del dispositivo Iot
...
### -InputObject
Oggetto certificato del servizio di provisioning dispositivi IoT
...
### -ResourceId
ID risorsa certificato del servizio di provisioning dispositivi IoT
