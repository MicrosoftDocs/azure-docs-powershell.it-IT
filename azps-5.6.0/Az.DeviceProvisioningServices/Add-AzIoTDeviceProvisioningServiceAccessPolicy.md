...
Aggiungere un nuovo criterio di accesso condiviso in un servizio di provisioning del dispositivo Hub IoT di Azure con i diritti EnrollmentWrite e ServiceConfig.
...
Aggiungere un nuovo criterio di accesso condiviso in un servizio di provisioning del dispositivo Hub IoT di Azure con il diritto EnrollmentRead.
