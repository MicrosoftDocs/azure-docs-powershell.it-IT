...
## DESCRIZIONE
Ottenere i dettagli di un gruppo di registrazione o elencare tutti i gruppi di registrazione in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Ottenere un gruppo di registrazione del dispositivo in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Elencare tutti i gruppi di registrazione dei dispositivi in un servizio di provisioning dei dispositivi Hub IoT di Azure.
