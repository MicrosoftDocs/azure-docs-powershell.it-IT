...
Aggiornare "myiothub.azure-devices.net" dell'hub IoT collegato in un servizio di provisioning dei dispositivi Hub IoT di Azure.
...
Applicare criteri di assegnazione all'hub IoT
