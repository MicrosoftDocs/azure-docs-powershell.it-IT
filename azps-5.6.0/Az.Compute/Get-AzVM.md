...
## DESCRIZIONE
Il **cmdlet Get-AzVM** ottiene la visualizzazione del modello o la visualizzazione dell'istanza di una macchina virtuale di Azure.
...
Specificare il *parametro Status* per ottenere la visualizzazione dell'istanza di una macchina virtuale invece della visualizzazione modello, che è l'impostazione predefinita.

## ESEMPI

### Esempio 1: Ottenere le proprietà della visualizzazione modello e istanza
```
...
Questo comando ottiene le proprietà della visualizzazione modello e della visualizzazione istanza della macchina virtuale denominata VirtualMachine07.
...
Questo comando recupera le proprietà della macchina virtuale denominata VirtualMachine07.
Questo comando specifica il *parametro Status.*
Di conseguenza, il comando ottiene solo le proprietà della visualizzazione istanza.
...
Questo comando recupera le proprietà per tutte le macchine virtuali nel gruppo di risorse denominato ResourceGroup11.
...
Questo comando recupera tutte le macchine virtuali nell'abbonamento.
...
Questo comando recupera tutte le macchine virtuali nell'area Degli Stati Uniti occidentali.

### Esempio 6: Usare i filtri per tutte le macchine virtuali
```
...
Questo comando recupera tutte le macchine virtuali dell'abbonamento che iniziano con "test".
...
### -DisplayHint
Determina la modalità di visualizzazione dell'oggetto della macchina virtuale.
I valori validi sono: -- Compatta: visualizza solo le proprietà di primo livello -- Espandi: visualizza tutte le proprietà in tutti i livelli
...
### -Location
Specifica una posizione in cui elencare le macchine virtuali.
