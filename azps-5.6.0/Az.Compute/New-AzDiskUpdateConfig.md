...
### -DiskIOPSReadWrite
Numero di operazioni di I/O al secondo consentite per il disco. impostabile solo per dischi UltraSSD. È possibile trasferire un'operazione tra 4.000 e 256.000 byte.
...
### -DiskMBpsReadOnly
Velocità effettiva totale (MBps) consentita in tutte le macchine virtuali che montaggio del disco condiviso come ReadOnly. MBps significa milioni di byte al secondo - MB usa la notazione ISO, ovvero potenze di 10.
