...
## DESCRIZIONE
Il cmdlet **Set-AzVmssStorageProfile** imposta le proprietà del profilo di archiviazione per il set di scalabilità delle macchine virtuali (VMSS).
...
Questo comando imposta le proprietà del profilo di archiviazione per i sistemi VMS denominati ContosoVMSS.
...
### -OsDiskCreateOption
Specifica in che modo questo cmdlet crea le macchine virtuali VMSS.
...
Questa operazione è necessaria solo per scenari con immagini utente e non per un'immagine della piattaforma.
...
Per ottenere l'oggetto, usare l'New-AzVmssConfig o object.
