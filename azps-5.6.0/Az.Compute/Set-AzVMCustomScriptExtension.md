...
## DESCRIZIONE
Il cmdlet **Set-AzVMCustomScriptExtension aggiunge** uno script personalizzato virtual machine extension a una macchina virtuale.
...
Il file script viene contososcript.exe.

### Esempio 2

Aggiunge un'estensione di script personalizzata a una macchina virtuale. (autogenerati)
...
### -FileName
Specifica il nome del file script. Se il file è archiviato in Archiviazione BLOB di Azure, per il valore del nome file viene fatto distinzione tra maiuscole e minuscole. I nomi file dei file archiviati in Archiviazione file di Azure non fa distinzione tra maiuscole e minuscole.
...
### -FileUri
Specifica l'URI del file script.
...
### -InputObject
Oggetto di estensione della macchina virtuale.
...
### -ResourceId
RESOURCEID dell'estensione della macchina virtuale.
...
### -SecureExecution
Indica che questo cmdlet verifica che il valore del parametro *Run* non sia registrato sul server o non sia restituito all'utente usando l'API di estensione GET.
Il valore di *Run* potrebbe contenere segreti o password da passare al file script in modo sicuro.
