...
Prima di creare un'immagine della macchina virtuale, preparare la macchina virtuale e quindi contrassegnarla come generalizzata con il cmdlet Set-AzVM.
...
L'URL dell'immagine salvata è simile al seguente: https:// \<storageAccountName\> .blob.core.windows.net/system/Microsoft.Compute/Images/ \<imagesContainer\> / \<vhdPrefix-osDisk\> .xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx.vhd.
