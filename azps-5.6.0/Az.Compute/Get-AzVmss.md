...
La visualizzazione modello è le proprietà specificate dall'utente del set di scalabilità della macchina virtuale.
...
Questo comando ottiene le proprietà del sistema VMSS denominato VMSS001 che appartiene al gruppo di risorse denominato Group001.
...
### Esempio 4: Ottenere tutte le vms con i filtri
```
