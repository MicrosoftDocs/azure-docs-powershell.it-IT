...
## DESCRIZIONE
Il cmdlet **New-AzImageConfig** crea un oggetto immagine configurabile.
...
I tre comandi seguenti assegnano i percorsi del disco os e due dischi dati alle variabili $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2. Questo approccio è solo per la leggibilità dei comandi seguenti.
I successivi tre comandi aggiungono ciascuno un disco os e due dischi dati all'immagine archiviata in $imageConfig.
...
### -ZoneResilient
Abilitare la resilienza dell'area
