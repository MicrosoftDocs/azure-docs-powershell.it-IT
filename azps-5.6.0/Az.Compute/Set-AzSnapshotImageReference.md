...
## DESCRIZIONE
Il cmdlet **Set-AzSnapshotImageReference** imposta le proprietà di riferimento per l'immagine su un oggetto snapshot.
...
Il primo comando crea un oggetto snapshot locale con dimensioni di 10 GB Premium_LRS tipo di account di archiviazione.  Imposta anche il tipo di sistema operativo Windows.
Il secondo comando imposta l'ID immagine e il numero di unità 0 per l'oggetto snapshot.
