...
Questo comando crea un pacchetto ZIP per lo script specificato e gli eventuali moduli di risorse dipendenti e lo archivia nel file locale denominato .\MyConfiguration.ps1.zip.
...
Questo comando aggiunge la configurazione denominata Sample.ps1, i dati di configurazione SampleData.psd1 e altro contenuto all'archivio di configurazione per il caricamento in Archiviazione di Azure.
