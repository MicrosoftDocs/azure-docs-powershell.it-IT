...
### -MaxPrice
Il prezzo massimo della fatturazione di una macchina virtuale con priorità bassa.
...
### -OpenPorts
Elenco di porte da aprire nel gruppo di sicurezza di rete (NSG) per la macchina virtuale creata.  Il valore predefinito dipende dal tipo di immagine scelto (ad esempio, Windows: 3389, 5985 e Linux: 22).
