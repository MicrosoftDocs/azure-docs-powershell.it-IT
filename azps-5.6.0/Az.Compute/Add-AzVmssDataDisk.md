...
## DESCRIZIONE
Il cmdlet **Add-AzVmssDataDisk** aggiunge un disco dati all'istanza VMSS (Virtual Machine Scale Set).
...
Questo comando aggiunge un disco dati vuoto all'oggetto VMSS.
...
### -CreateOption
Specifica l'opzione di creazione del disco.
...
### -DiskIOPSReadWrite
Specifica l'Read-Write operazioni di I/O al secondo per il disco gestito. Deve essere usato solo quando StorageAccountType è UltraSSD_LRS. Se non viene specificato, verrà assegnato un valore predefinito in base a diskSizeGB.
...
### -DiskMBpsReadWrite
Specifica la larghezza di banda in MB al secondo per il disco gestito. Deve essere usato solo quando StorageAccountType è UltraSSD_LRS. Se non viene specificato, verrà assegnato un valore predefinito in base a diskSizeGB.
