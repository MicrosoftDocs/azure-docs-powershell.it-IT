...
## DESCRIZIONE
Il cmdlet **Set-AzImageOsDisk** imposta le proprietà del disco del sistema operativo su un oggetto immagine.
...
Il primo comando crea un oggetto immagine e quindi lo archivia nella $imageConfig variabile.
I tre comandi seguenti assegnano i percorsi del disco os e due dischi dati alle variabili $osDiskVhdUri, $dataDiskVhdUri 1 e $dataDiskVhdUri 2.
Questo approccio è solo per la leggibilità dei comandi seguenti.
I successivi tre comandi aggiungono ciascuno un disco del sistema operativo e due dischi dati all'immagine archiviata in $imageConfig.
...
### -StorageAccountType
Tipo di account di archiviazione del disco dell'immagine del sistema operativo
