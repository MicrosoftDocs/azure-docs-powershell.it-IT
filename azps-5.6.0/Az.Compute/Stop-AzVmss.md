...
### -StayProvisioned
Se specificato, la macchina virtuale entra nello stato di interruzione. Se non viene specificato, la macchina virtuale entra nello stato arrestato deassegnato. L'addebito per le macchine virtuali è ancora in stato di interruzione, ma non per le macchine virtuali con stato di interruzione deassegnata.
