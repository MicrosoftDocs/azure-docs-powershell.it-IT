...
Il comando disabilita SQL Server'estensione della macchina virtuale nella macchina virtuale.
...
Per creare un **oggetto AutoBackupSettings,** usare il cmdlet New-AzVMSqlServerAutoBackupConfig.
