...
## DESCRIZIONE
Il cmdlet **Add-AzVmssNetworkInterfaceConfiguration** aggiunge una configurazione dell'interfaccia di rete al set di scalabilità delle macchine virtuali (VMSS).

## ESEMPI

### Esempio 1: Aggiungere una configurazione dell'interfaccia di rete al sistema VMSS
```
PS C:\> Add-AzVmssNetworkInterfaceConfiguration -VirtualMachineScaleSet $VMSS -Name "Test" -Primary $True -IPConfiguration $IPCfg
```

Questo comando aggiunge una configurazione dell'interfaccia di rete al sistema VMSS.
...
Specifica se l'interfaccia di rete è accelerata e abilitata per la rete.
...
### -EnableIPForwarding
Specifica se l'inoltro IP è abilitato su questa scheda NIC.
...
ID del gruppo di sicurezza di rete.
...
### -Principale
Indica se le interfacce di rete create dalla configurazione dell'interfaccia di rete saranno il network information center (NIC) principale della macchina virtuale.
