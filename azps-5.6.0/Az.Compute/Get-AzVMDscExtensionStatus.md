...
## DESCRIZIONE
Il cmdlet **Get-AzVMDscExtensionStatus** ottiene lo stato del gestore dell'estensione DSC (Desired State Configuration) per una macchina virtuale in un gruppo di risorse.
Quando viene applicata una configurazione, questo cmdlet genera un output coerente con quello Start-DscConfiguration cmdlet.

## ESEMPI

### Esempio 1

Ottiene lo stato del gestore delle estensioni DSC per una macchina virtuale. (autogenerati)
