...
Questo comando ottiene il gruppo di posizionamento per prossimità
...
Questo comando elenca tutti i gruppi di posizionamento di prossimità nel gruppo di risorse specificato.
...
Questo comando elenca tutti i gruppi di posizionamento per prossimità nella sottoscrizione.

## PARAMETERS

### -ColocationStatus
Mostra lo stato di colocation di una risorsa nel gruppo di posizionamento di prossimità.
