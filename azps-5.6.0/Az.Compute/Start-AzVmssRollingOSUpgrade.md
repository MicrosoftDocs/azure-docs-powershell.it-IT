...
## SYNOPSIS
Avvia un aggiornamento in sequenza per spostare tutte le istanze del set di scale di macchine virtuali alla versione più recente del sistema operativo immagine della piattaforma disponibile.
