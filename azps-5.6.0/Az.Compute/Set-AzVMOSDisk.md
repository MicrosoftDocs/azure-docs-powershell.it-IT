...
La modifica del valore di memorizzazione nella cache causa il riavvio della macchina virtuale.
...
Specifica l'ID della risorsa del Vault delle chiavi che contiene la chiave di crittografia della chiave.
...
Specificare questo parametro per la distribuzione di macchine virtuali basate sull'immagine utente.
...
Per uno scenario di avvio con macchina virtuale basata su disco, questo parametro specifica il file VHD che la macchina virtuale usa direttamente per l'avvio.
