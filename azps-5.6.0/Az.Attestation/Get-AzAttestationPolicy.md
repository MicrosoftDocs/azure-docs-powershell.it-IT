...
## DESCRIZIONE
Il cmdlet Get-AzAttestationPolicy cmdlet recupera il criterio da un tenant in Azure Attestation.
...
Recupera il criterio per il provider predefinito di attestazione da Location *UK South* per Tee type *SgxEnclave.*
