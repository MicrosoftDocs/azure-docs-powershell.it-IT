...
## DESCRIZIONE
Il cmdlet Remove-AzAttestationPolicySigner rimuove un firmatario di criteri attendibili per un tenant in Azure Attestation.
...
Rimuovere un firmatario attendibile per il provider di attestazione *denominato pshtest.*
...
### -Firmatario
Specifica il token Web JSON RFC7519 contenente un'attestazione denominata "maa-policyCertificate" il cui valore è una chiave Web JSON RFC7517 che contiene una chiave di firma attendibile da rimuovere.
