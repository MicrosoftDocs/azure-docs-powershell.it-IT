...
Ottiene i firmatari dei criteri attendibili per il provider predefinito di attestazione nella posizione *Usa centrale.*  Si noti che non sono presenti firmatari attendibili per il provider predefinito di attestazione.
