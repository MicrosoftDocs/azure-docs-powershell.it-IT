...
### Esempio 1: Rimuovere un'origine evento specificata in base al nome
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEventSource -EnvironmentName tsitest001 -Name iots001 -ResourceGroupName testgroup

```

In questo modo viene rimossa un'origine evento specifica.

### Esempio 2: Rimuovere un'origine evento specificata in base all'oggetto
```powershell
