...
### Esempio 1: Rimuovere un ambiente approfondimenti della serie temporale in base al nome
```powershell
PS C:\> Remove-AzTimeSeriesInsightsEnvironment -ResourceGroupName testgroup -Name tsill

```

Questo comando rimuove un ambiente approfondimenti della serie temporale.

### Esempio 2: Rimuovere un ambiente approfondimenti della serie temporale in base all'oggetto
```powershell
