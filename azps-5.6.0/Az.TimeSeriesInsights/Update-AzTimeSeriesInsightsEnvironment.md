...
### Esempio 1: Aggiornare un ambiente approfondimenti serie temporale Gen1
```powershell
...
Questo comando aggiorna un ambiente approfondimenti serie temporale gen1.

### Esempio 2: Aggiornare un ambiente approfondimenti serie temporale Gen1
```powershell
