...
Per creare, vedere la sezione NOTE per le proprietà PARTITIONKEYPROPERTY e creare una tabella hash.
...
Il comportamento che il servizio Time Series Insights dovrebbe adottare quando la capacità dell'ambiente è stata superata
