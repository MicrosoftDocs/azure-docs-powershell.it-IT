...
### Esempio 1: Elencare tutte le origini evento nell'ambiente specificato
```powershell
...
Questo comando elenca tutte le origini evento negli ambienti specificati.

### Esempio 2: Ottenere un'origine evento specificata in base al nome
```powershell
...
Questo comando ottiene un'origine evento specifica.

### Esempio 3: Ottenere un'origine evento specificata in base all'oggetto
```powershell
