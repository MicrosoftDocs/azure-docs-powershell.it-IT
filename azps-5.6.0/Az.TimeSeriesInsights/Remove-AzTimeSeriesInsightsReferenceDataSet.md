...
### Esempio 1: Rimuovere un set di dati di riferimento specificato in base al nome
```powershell
...
### Esempio 2: Rimuovere un set di dati di riferimento specificato in base all'oggetto
```powershell
