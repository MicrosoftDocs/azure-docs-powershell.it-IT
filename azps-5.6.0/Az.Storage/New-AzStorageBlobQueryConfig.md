...
### Esempio 1: Creare query BLOB configura ed esegue una query su un BLOB
```powershell
...
Questo comando crea prima l'oggetto configurazione di input come CSV e l'oggetto configurazione di output come json, quindi usa le due configurazioni per eseguire query BLOB.
...
### -EscapeCharacter
Facoltativo.
Valore char usato come carattere di escape.
...
### -HasHeader
Facoltativo.
Indicare che i dati hanno intestazioni.
...
### -QuotationCharacter
Facoltativo.
Valore char usato per citare un campo specifico.
