...
## DESCRIZIONE
Il cmdlet **Set-AzStorageShareQuota** imposta la capacità di archiviazione per una condivisione specificata.
...
Questo comando imposta la capacità di archiviazione per una condivisione denominata ContosoShare01 su 1024 GB.
...
### -Quota
Specifica il valore della quota in gigabyte (GB).
Vedere la limitazione delle quote in https://docs.microsoft.com/azure/azure-subscription-service-limits#azure-files-limits . 
...
### -Condividi
Specifica un **oggetto CloudFileShare** che rappresenta la condivisione per cui questo cmdlet imposta una quota.
