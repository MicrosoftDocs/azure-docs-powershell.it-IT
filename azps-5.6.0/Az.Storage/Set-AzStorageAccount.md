...
Il comando imposta il valore di Access Tier su cool.
...
Il comando aggiorna un account di archiviazione abilitando l'autenticazione DS di Azure Files AAD.
...
### Esempio 12: Set MinimumTlsVersion, AllowBlobPublicAccess e AllowSharedKeyAccess
```
...
Il comando imposta MinimumTlsVersion, AllowBlobPublicAccess e AllowSharedKeyAccess, quindi mostra le 3 proprietà dell'account 
...
Non è possibile modificare Standard_ZRS e Premium_LRS ad altri tipi di account.
