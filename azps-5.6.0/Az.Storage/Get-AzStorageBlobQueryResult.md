...
Questo comando esegue una query blob inccssamente con configurazione di input come CSV e configurazione di output come json e salva l'output nel file locale "c:\resultfile.js".
...
Questo comando ottiene prima un oggetto BLOB per lo snapshot BLOB, quindi esegue una query per lo snapshot BLOB e mostra il risultato include l'errore della query.
...
### -QueryString
Stringa di query, vedere altri dettagli in: https://docs.microsoft.com/azure/storage/blobs/query-acceleration-sql-reference
