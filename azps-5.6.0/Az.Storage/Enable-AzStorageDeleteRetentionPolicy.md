...
## DESCRIZIONE
Il cmdlet **Enable-AzStorageDeleteRetentionPolicy** abilita l'eliminazione dei criteri di conservazione per il servizio BLOB di archiviazione di Azure.
...
Questo comando abilita i criteri di conservazione per il servizio BLOB e imposta i giorni di conservazione BLOB eliminati su 3.
