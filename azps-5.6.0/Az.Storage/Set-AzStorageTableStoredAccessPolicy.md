...
## DESCRIZIONE
Il cmdlet **Set-AzStorageTableStoredAccessPolicy** imposta i criteri di accesso archiviato per una tabella di archiviazione di Azure.

## ESEMPI

### Esempio 1: Impostare un criterio di accesso archiviato in una tabella con autorizzazioni complete
```
PS C:\>Set-AzStorageTableStoredAccessPolicy -Table "MyTable" -Policy "Policy08" -Permission raud
```

Questo comando imposta un criterio di accesso denominato Policy08 per la tabella di archiviazione denominata Tabella_
...
### -ExpiryTime
Specifica l'ora di scadenza dei criteri di accesso archiviato.
...
### -NoStartTime
Indica che l'ora di inizio è impostata su $Null.
...
### -Permission
Specifica le autorizzazioni nei criteri di accesso archiviato per accedere alla tabella di archiviazione.
