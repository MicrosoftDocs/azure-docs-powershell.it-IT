...
Questo script aggiornerà gli ACL in modo ricorsivo in blocchi di directory, con dimensioni dei blocchi come BatchSize * MaxBatchCount. La dimensione dei blocchi è 5000 in questo script.
...
### -ContinueOnFailure
Impostare questo parametro in modo da ignorare gli errori e continuare la procezione con l'operazione in altre entità secondarie della directory. Per impostazione predefinita, l'operazione si interromperà rapidamente in caso di errori.
