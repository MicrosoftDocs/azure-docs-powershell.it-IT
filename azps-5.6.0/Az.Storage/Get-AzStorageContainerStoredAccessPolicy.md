...
## DESCRIZIONE
Il cmdlet **Get-AzStorageContainerStoredAccessPolicy** elenca i criteri di accesso archiviato per un contenitore di archiviazione di Azure.
...
Questo comando recupera i criteri di accesso denominati Criterio22 nel contenitore di archiviazione denominato Container07.

### Esempio 2: Ottenere tutti i criteri di accesso archiviato in un contenitore di archiviazione
```
PS C:\>Get-AzStorageContainerStoredAccessPolicy -Container "Container07"
```

Questo comando recupera tutti i criteri di accesso nel contenitore di archiviazione denominato Container07.
