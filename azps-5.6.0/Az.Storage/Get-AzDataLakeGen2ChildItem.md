...
## DESCRIZIONE
Il cmdlet **Get-AzDataLakeGen2Item Elenca** le sotto directory e i file in una directory o filesystem in un account di archiviazione di Azure.
...
### Esempio 2: Elencare in modo ricorsivo da una directory e recuperare le proprietà/ACL
```
...
### Esempio 3: Elencare gli elementi in modo ricorsivo da un filesystem in più batch
```
...
Il quinto comando specifica **un'istruzione Do-While** che usa il cmdlet **Get-AzDataLakeGen2Item** per elencare gli elementi.
...
### -FetchProperty
Recuperare le proprietà dell'elemento della connessione dati e l'ACL.
...
### -MaxCount
Numero massimo di BLOB che possono essere restituiti.
...
### -Path
Percorso nel file system specificato che deve essere recuperato.
...
### -Ricorrenza
Indica se l'elemento figlio viene visualizzato in modo ricorsivo.
