...
## DESCRIZIONE
Il cmdlet **Close-AzStorageFileHandle** chiude gli handle di file di una condivisione file, di una directory file o di un file.
...
### Esempio 2: Chiudere tutti gli handle di file in modo ricorsivo in una directory di file e visualizzare il numero di handle di file chiusi
```
...
### -ShareName
Nome della condivisione file in cui verranno elencati i file o le directory.
