...
### Esempio 1: Impostare i criteri di replica degli oggetti sia sull'account di destinazione che su quello di origine.
```
...
Questo comando imposta i criteri di replica degli oggetti sia sull'account di destinazione che su quello di origine.
Creare prima di tutto 2 regole dei criteri di replica degli oggetti e impostare il criterio con 2 regole per l'account di destinazione. Impostare quindi i criteri di replica degli oggetti dall'account di destinazione all'account di origine.
...
### -DestinationAccount
DestinationAccount dei criteri di replica degli oggetti.
...
### -PolicyId
ID dei criteri di replica degli oggetti. Deve essere un GUID o un valore "predefinito".
Se non input policyId, userà "predefinito", il che significa che per creare un nuovo criterio e l'ID del nuovo criterio verrà restituito nei criteri creati.
...
### -SourceAccount
SourceAccount dei criteri di replica degli oggetti.
