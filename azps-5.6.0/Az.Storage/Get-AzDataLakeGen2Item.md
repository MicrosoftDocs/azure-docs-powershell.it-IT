...
Questo comando recupera una directory da un file system e visualizza i dettagli.

### Esempio 2: Ottenere un file da un file system
```
...
Questo comando recupera i dettagli di un file da un file system. 
