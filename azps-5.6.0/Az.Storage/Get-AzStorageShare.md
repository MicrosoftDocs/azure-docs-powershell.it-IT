...
## DESCRIZIONE
Il cmdlet **Get-AzStorageShare** ottiene un elenco di condivisioni file per un account di archiviazione.
...
Questo comando recupera la condivisione file denominata ContosoShare06.

### Esempio 2: Ottenere tutte le condivisioni file che iniziano con una stringa
```
PS C:\>Get-AzStorageShare -Prefix "Contoso"
```

Questo comando recupera tutte le condivisioni file con nomi che iniziano con Contoso.

### Esempio 3: Ottenere tutte le condivisioni file in un contesto specificato
```
PS C:\>$Context = New-AzStorageContext -Local
PS C:\> Get-AzStorageShare -Context $Context
```

Il primo comando usa il cmdlet **New-AzStorageContext** per creare un contesto usando il parametro *Local* e quindi archivia l'oggetto di contesto nella $Context variabile.
Il secondo comando ottiene le condivisioni file per l'oggetto di contesto archiviato nel $Context.
...
Questo cmdlet ottiene la condivisione file specificata da questo parametro oppure nessuna opzione se si specifica il nome di una condivisione file inesistente.
...
Questo cmdlet ottiene condivisioni file che corrispondono al prefisso specificato da questo parametro oppure nessuna condivisione file se nessuna condivisione file corrisponde al prefisso specificato.
