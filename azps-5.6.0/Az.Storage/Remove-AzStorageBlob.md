...
## DESCRIZIONE
Il cmdlet **Remove-AzStorageBlob** rimuove il BLOB specificato da un account di archiviazione in Azure.

## ESEMPI

### Esempio 1: Rimuovere un BLOB di archiviazione in base al nome
```
...
### Esempio 2: Rimuovere un BLOB di archiviazione usando la pipeline
```
...
### Esempio 3: Rimuovere BLOB di archiviazione usando la pipeline
```
PS C:\>Get-AzStorageContainer -Container container* | Remove-AzStorageBlob -Blob "BlobName"
```

Questo comando usa il carattere jolly asterisco (*) e la pipeline per recuperare i BLOB e quindi li rimuove.

### Esempio 4: Rimuovere una singola versione BLOB
```
PS C:\> Remove-AzStorageBlob -Container "containername" -Blob blob2 -VersionId "2020-07-03T16:19:16.2883167Z"
```

Questo comando rimuove un singolo BLOB con VersionId.

### Esempio 5: Rimuovere un singolo snapshot BLOB
```
PS C:\> Remove-AzStorageBlob -Container "containername" -Blob blob1 -SnapshotTime "2020-07-06T06:56:06.8588431Z"
```

Questo comando rimuove un singolo snapshot BLOB con SnapshotTime.

## PARAMETERS

### -BLOB
Specifica il nome del BLOB da rimuovere.
...
È possibile usare il cmdlet Get-AzStorageContainer per ottenerlo.
...
### -DeleteSnapshot
Specifica che devono essere eliminati tutti gli snapshot, ma non il BLOB di base.
Se non si specifica questo parametro, il BLOB di base e i relativi snapshot vengono eliminati insieme.
All'utente viene chiesto di confermare l'operazione di eliminazione.
...
### -Force
Indica che questo cmdlet rimuove il BLOB e il relativo snapshot senza conferma.
...
Specifica il profilo di Azure che il cmdlet deve leggere.
Se non viene specificato, il cmdlet legge dal profilo predefinito.
