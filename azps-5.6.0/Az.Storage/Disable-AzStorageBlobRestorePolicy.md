...
### Esempio 1: Disabilita i criteri di Ripristino BLOB per il servizio BLOB archiviazione di Azure in un account di archiviazione
```powershell
PS C:\> Disable-AzStorageBlobRestorePolicy -ResourceGroupName "myresourcegoup" -StorageAccountName "mystorageaccount"
```

Questo comando disabilita i criteri di ripristino BLOB per il servizio BLOB archiviazione di Azure in un account di archiviazione.
