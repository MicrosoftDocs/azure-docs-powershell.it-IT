...
### Esempio 1: Ottenere la proprietà dei servizi BLOB di archiviazione di Azure per un account di archiviazione specificato
```powershell
...
### -ResourceId
ID risorsa proprietà servizio BLOB.
