...
Il *parametro Overwrite* assicura che questo set di record sovrascriva qualsiasi set di record pre-esistente con lo stesso nome e tipo. I record esistenti in tale set di record andranno persi.
...
- PTR
- SRV
- I record TXT SOA vengono creati automaticamente quando viene creata l'area e non possono essere creati manualmente.
...
### -Zone
Specifica dnsZone in cui creare il **recordSet.**
