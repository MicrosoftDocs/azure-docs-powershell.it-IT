...
Non è possibile eliminare record SOA o server dei nomi (NS) creati automaticamente nell'apice di zona.
È possibile passare un **oggetto RecordSet** a questo cmdlet usando l'operatore della pipeline o come parametro.
...
Ciò fornisce protezione per le modifiche simultanee.
