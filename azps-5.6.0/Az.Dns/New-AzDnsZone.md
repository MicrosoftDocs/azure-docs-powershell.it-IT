...
### -ZoneType
Tipo di area, Pubblica o Privata. Le aree senza un tipo o con un tipo di pubblico vengono rese disponibili nel DNS pubblico da usare nella gerarchia DNS. Le aree con un tipo di private sono visibili solo con il set di reti virtuali associate (questa caratteristica è in anteprima). Questa proprietà non può essere modificata per un'area.
