...
## DESCRIZIONE
Modificare un percorso. È possibile aggiornare tutti i campi di un percorso, inclusi l'origine dati, l'endpoint, la query di routing e anche abilitare o disabilitare il percorso.
...
Aggiornamento delle informazioni sulla route.
...
Aggiornamento delle informazioni del percorso.
...
### -Condizione
Condizione valutata per l'applicazione della regola di routing
