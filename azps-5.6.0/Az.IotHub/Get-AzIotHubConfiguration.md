...
## DESCRIZIONE
Ottenere i dettagli di una configurazione automatica di gestione dei dispositivi IoT o elencare le configurazioni di gestione automatica dei dispositivi IoT in un Hub IoT.
...
Ottenere i dettagli di una configurazione automatica di gestione dei dispositivi IoT.
...
Elencare le configurazioni automatiche di gestione dei dispositivi IoT in un Hub IoT.
