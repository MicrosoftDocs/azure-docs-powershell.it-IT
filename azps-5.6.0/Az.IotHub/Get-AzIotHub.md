...
## DESCRIZIONE
Ottiene informazioni sugli IotHub in un abbonamento.
È possibile visualizzare tutte le istanze di IotHub in una sottoscrizione oppure filtrare i risultati in base a un gruppo di risorse o a un nome specifico di IotHub.
