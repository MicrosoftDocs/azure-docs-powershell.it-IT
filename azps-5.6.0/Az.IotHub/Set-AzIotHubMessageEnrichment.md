...
## DESCRIZIONE
Per una spiegazione dettagliata dell'arricchimento dei messaggi nell'Hub IoT di Azure, vedi https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
Aggiorna il valore di arricchimento in "updatedValue" per la chiave "newKey".
Per una spiegazione dettagliata dell'arricchimento dei messaggi nell'Hub IoT di Azure, vedi https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
...
Aggiorna l'endpoint di arricchimento a "endpoint1, endpoint2, endpoint3" per la chiave "newKey".
Per una spiegazione dettagliata dell'arricchimento dei messaggi nell'Hub IoT di Azure, vedi https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
