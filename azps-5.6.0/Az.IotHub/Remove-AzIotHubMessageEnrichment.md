...
## DESCRIZIONE
Per una spiegazione dettagliata dell'arricchimento dei messaggi nell'Hub IoT di Azure, vedere https://docs.microsoft.com/azure/iot-hub/iot-hub-message-enrichments-overview
