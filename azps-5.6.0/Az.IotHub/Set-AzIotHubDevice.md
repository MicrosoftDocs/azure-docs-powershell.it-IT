...
### ResourceSetForStatus (impostazione predefinita)
```
...
Attivare le funzionalità Edge per il dispositivo.
...
Disabilitare lo stato del dispositivo.
...
Aggiornare il tipo di autorizzazione di un dispositivo hub Iot.

## PARAMETERS

### -AuthMethod
Tipo di autorizzazione con cui deve essere creata un'entità.
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDevaso
