...
## DESCRIZIONE
Elencare la stringa di connessione di tutti i moduli o di un modulo specificato di un dispositivo IoT di destinazione contenuto in un hub IoT di Azure.
