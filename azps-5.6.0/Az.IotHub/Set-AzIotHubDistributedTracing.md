...
### -SamplingMode
Attiva e disattiva il campionamento per le traccia distribuite.
...
### -SamplingRate
Controlla la quantità di messaggi di esempio per l'aggiunta di contesto di traccia.
Questo valore è una percentuale.
Sono consentiti solo valori compresi tra 0 e 100 (inclusi).
...
### Microsoft.Azure.Commands.Management.IotHub.Models.PSDeviceT più elettronica
