...
## DESCRIZIONE
Richiamare un metodo del modulo di Microsoft Edge. Per https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methods altre informazioni, vedere.
...
### -Name
Nome del metodo da richiamare in questo modulo del dispositivo.
...
### -Payload
Payload per il metodo da richiamare in questo modulo del dispositivo.
