...
## DESCRIZIONE
Aggiornare le proprietà specificate di una distribuzione Edge IoT.
...
Modificare la priorità della distribuzione edge di IoT e aggiornare le condizioni di destinazione.
...
Aggiornare le metriche e le etichette della distribuzione Edge di IoT.
...
### -Force
Consente di sostituire l'oggetto di distribuzione anche se è stato aggiornato dopo il recupero dell'ultima volta.
