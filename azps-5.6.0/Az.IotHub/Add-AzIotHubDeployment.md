...
## DESCRIZIONE
Le distribuzioni Edge possono essere create con metriche definite dall'utente per la valutazione su richiesta.
Per https://docs.microsoft.com/azure/iot-edge/module-deployment-monitoring altre informazioni, vedere.
...
Creare una distribuzione Edge con metadati predefiniti.
...
Creare una distribuzione Edge con priorità 3 che si applica a una condizione quando un dispositivo è contrassegnato nell'edificio 9 e l'ambiente è "test".
...
Crea una distribuzione Edge con metriche utente.
...
Creare una distribuzione Edge con etichette.
...
Creare una distribuzione Edge con contenuto.
...
### -Label
Mappa di etichette da applicare alla distribuzione di destinazione.
...
### -Metrico
Raccolta di query per la definizione delle metriche di distribuzione di IoT Edge.
...
### -ModulesContent
Contenuto della distribuzione dei moduli per dispositivi Edge IoT.
...
### -Priority
Peso della distribuzione in caso di regole concorrenti (il punteggio più alto).
...
### -TargetCondition
Condizione di destinazione in cui si applica una distribuzione Edge.
