...
Ottenere tutti gli endpoint dall'Hub IoT di "myiothub".
...
Ottenere tutti gli endpoint di tipo EventHub dall'Hub IoT di "myiothub". 
...
Ottenere informazioni sull'endpoint dall'Hub IoT di "myiothub".
