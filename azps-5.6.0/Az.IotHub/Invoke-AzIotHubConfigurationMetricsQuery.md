...
## SYNOPSIS
Richiamare una query metrica di configurazione dei dispositivi IoT.
...
- "Mirato" specifica il numero di utenti del dispositivo che soddisfano la condizione di destinazione.
