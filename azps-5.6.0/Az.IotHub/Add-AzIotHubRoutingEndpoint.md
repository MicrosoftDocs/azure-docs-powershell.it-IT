...
## DESCRIZIONE
Aggiungere un nuovo endpoint nell'hub IoT. Per informazioni sugli endpoint supportati, vedi https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-endpoints
...
Aggiungere un nuovo endpoint "E2" di tipo EventHub a un hub IoT di "myiothub".
