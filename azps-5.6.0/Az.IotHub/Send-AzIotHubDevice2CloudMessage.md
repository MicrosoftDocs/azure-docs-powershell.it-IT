...
## DESCRIZIONE
Il comando supporta l'invio di messaggi con le proprietà di applicazioni e di sistema.
...
Invio di un dispositivo a un messaggio nel cloud con il tipo di trasporto predefinito.
...
Invio di un dispositivo mqtt a un messaggio nel cloud.
...
### -Messaggio
Corpo del messaggio da inviare all'Hub IoT.
...
### -TransportType
Tipo di trasporto da usare.
L'impostazione predefinita è Amqp.
