...
## DESCRIZIONE
Creare un modulo in un dispositivo IoT di destinazione con un tipo di autorizzazione diverso in un Hub IoT.
...
Creare un modulo in un dispositivo IoT di destinazione con l'autorizzazione predefinita (chiave privata condivisa).
