...
Questo comando recupera un'area di lavoro Databricks in un gruppo di risorse.

### Esempio 2: Elencare tutte le aree di lavoro Databricks in una sottoscrizione
```powershell
...
Questo comando elenca tutte le aree di lavoro Databricks in una sottoscrizione.
