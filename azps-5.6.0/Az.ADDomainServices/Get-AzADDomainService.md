...
## DESCRIZIONE
L'operazione Get Domain Service recupera una rappresentazione json del servizio di dominio.
...
### Esempio 2: Ottenere ADDomainService By ResourceGroup e il nome
```powershell
