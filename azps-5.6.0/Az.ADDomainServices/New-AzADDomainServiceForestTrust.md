...
## SYNOPSIS
Creare un oggetto in memoria per ForestTrust
...
### Esempio 1: Creare ServiceForestTrust per ADDomain
```powershell
...
Creare ServiceForestTrust per ADDomain
