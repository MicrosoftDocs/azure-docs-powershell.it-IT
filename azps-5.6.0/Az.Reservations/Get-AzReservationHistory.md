...
### -Prenotazione
Parametro per l'oggetto pipe `Reservation` per s
...
### -ReservationId
ReservationId della `Reservation` cronologia di cui deve essere visualizzata la cronologia
...
### -ReservationOrderId
ReservationOrderId per `ReservationOrder` l'elemento che contiene l'elemento `Reservation`
