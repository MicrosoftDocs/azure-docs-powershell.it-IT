...
## DESCRIZIONE
Calcolare il prezzo per l'esecuzione di un ordine di prenotazione.
...
Dopo aver ottenere il catalogo, il cliente può ottenere il prodotto diverso in base alla posizione. Usando queste informazioni, controlla il prezzo correttamente

## PARAMETERS

### -AppliedScope
Abbonamento in cui verrà applicato il vantaggio. Obbligatorio se --applied-scope-type è Single. Non specificare se --applied-scope-type è Shared.
...
### -AppliedScopeType
Tipo di ambito applicato per aggiornare la prenotazione con "Singola" o "Condivisa"
...
### -BillingScopeId
Abbonamento che verrà addebitato per la prenotazione degli acquisti.
...
### -InstanceFlexibility
Tipo di flessibilità delle istanze con cui aggiornare la prenotazione.
...
### -SKU
Nome SKU, ottenere l'elenco di SKU usando il comando az reservations catalog show
