...
### Esempio 1: Riavviare il server PostgreSql in base al gruppo di risorse e al nome del server
```powershell
PS C:\> Restart-AzPostgreSqlServer -ResourceGroupName PostgreSqlTestRG -Name PostgreSqlTestServer

```

Questo cmdlet riavvia il server PostgreSql in base al gruppo di risorse e al nome del server.

### Esempio 2: Riavviare il server PostgreSql in base all'identità
```powershell
...
Questi cmdlet riavviano il server PostgreSql in base all'identità.
