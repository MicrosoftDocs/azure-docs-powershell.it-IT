...
### Esempio 1: Aggiornare la configurazione PostgreSql in base al nome
```powershell
...
Questo cmdlet aggiorna la configurazione PostgreSql in base al nome.

### Esempio 2: Aggiornare la configurazione PostgreSql in base all'identità.
```powershell
...
Questi cmdlet aggiornano la configurazione PostgreSql in base all'identità.
