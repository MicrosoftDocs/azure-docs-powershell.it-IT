...
Il valore predefinito per la posizione è Stati Uniti occidentali 2, SKU è Standard_D2s_v3, il livello SKU è GeneralPurpose e le dimensioni di archiviazione sono 128GiB.
...
Dopo la delega, la subnet non può essere usata per altri tipi di risorse di Azure.
