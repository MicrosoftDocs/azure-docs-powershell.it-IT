...
### Esempio 1: Aggiornare la regola di rete virtuale PostgreSql in base al nome
```powershell
...
Questo cmdlet aggiorna la regola della rete virtuale PostgreSql in base al nome.

### Esempio 2: Aggiornare la regola di rete virtuale PostgreSql in base all'identità.
```powershell
...
Questi cmdlet aggiornano la regola della rete virtuale PostgreSql in base all'identità.
...
Creare una regola del firewall prima che per la rete virtuale sia abilitato l'endpoint del servizio vnet.
