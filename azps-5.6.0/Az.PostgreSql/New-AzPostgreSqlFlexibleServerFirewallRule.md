...
### Esempio 1: Creare una nuova regola firewall del server PostgreSql
```powershell
...
Questi cmdlet creano una regola firewall del server PostgreSql.
...
### Esempio 3: Creare una nuova regola del firewall PostgreSql per consentire tutti gli IP
```powershell
...
Questo cmdlet crea una nuova regola del firewall PostgreSql per consentire tutti gli IP.
