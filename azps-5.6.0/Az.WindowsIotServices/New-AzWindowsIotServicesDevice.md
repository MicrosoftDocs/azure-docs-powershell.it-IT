...
## SYNOPSIS
Creare o aggiornare i metadati di un servizio dispositivi IoT di Windows.
...
### Esempio 1: Creare nuovi servizi IoT di Windows
```powershell
...
Questo comando crea nuovi servizi Windows IoT.
...
Se viene fornito nel corpo della risposta, deve essere fornito anche come intestazione in base alla normale convenzione ETag.
