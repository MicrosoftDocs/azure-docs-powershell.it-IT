...
## SYNOPSIS
Recupera lo stato di un processo di azure migrate.
...
In questo modo si recupera un processo in base all'ID.
...
### Esempio 3: Ottenere per gruppo di risorse, progetto e nome di processo
```powershell
