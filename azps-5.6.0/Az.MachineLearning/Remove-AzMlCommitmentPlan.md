...
## DESCRIZIONE
Elimina un piano di impegno di Azure Machine Learning. Si noti che i piani di impegno con associazioni di impegno non possono essere eliminati. Le associazioni di impegno possono essere eliminate solo dalla risorsa di destinazione. Ad esempio, se si elimina un servizio Web di Apprendimento automatico di Azure, verrà eliminata anche l'associazione di impegno che associa il servizio Web a un piano di impegno.
...
### -MlCommitmentPlan
Oggetto del servizio Web di apprendimento automatico.
