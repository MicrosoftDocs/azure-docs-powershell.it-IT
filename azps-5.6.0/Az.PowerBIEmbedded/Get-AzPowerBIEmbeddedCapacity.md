...
## SYNOPSIS
Recupera i dettagli di una capacità incorporata di PowerBI.
...
## DESCRIZIONE
Il Get-AzPowerBIEmbeddedCapacity cmdlet di powerbi ottiene i dettagli di una capacità incorporata di PowerBI.

## ESEMPI

### Esempio 1: Ottenere i capacità del gruppo di risorse
```
...
Questo comando recupera tutta la capacità incorporata di Azure PowerBI nel gruppo di risorse denominato testRG
...
Questo comando recupera la capacità incorporata di Azure PowerBI denominata testcapacity nel gruppo di risorse denominato testRG.
