...
## DESCRIZIONE
Il cmdlet New-AzPowerBIEmbeddedCapacity crea una nuova capacità incorporata di PowerBI
...
Crea una capacità denominata testcapacity nell'area azure centrale di Azure e nel testRG del gruppo di risorse. Il livello di SKU per la capacità sarà A1.

## PARAMETERS

### -Administrator
Nomi separati da virgola da impostare come amministratori della capacità
...
### -Location
Area geografica di Azure in cui è ospitata la capacità incorporata di PowerBI
