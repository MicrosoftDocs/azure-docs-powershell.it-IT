...
## SYNOPSIS
Crea una raccolta di aree di lavoro di Power BI.
...
## DESCRIZIONE
Il cmdlet **New-AzPowerBIWorkspaceCollection** crea una raccolta di aree di lavoro di Power BI per la sottoscrizione di Azure nel gruppo di risorse e nella posizione specificati.

## ESEMPI

### Esempio 1: Creare una raccolta dell'area di lavoro
```
...
Questo comando crea una raccolta di aree di lavoro denominata WCN11 nel gruppo di risorse specificato nella posizione specificata.
...
### -Location
Specifica la posizione di Azure in cui questo cmdlet crea una raccolta dell'area di lavoro.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse in cui questo cmdlet crea una raccolta dell'area di lavoro.
...
Specifica un nome per la raccolta dell'area di lavoro di Power BI.
