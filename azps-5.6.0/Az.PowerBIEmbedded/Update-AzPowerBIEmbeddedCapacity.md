...
## DESCRIZIONE
Il Update-AzPowerBIEmbeddedCapacity cmdlet modifica un'istanza della capacità incorporata di PowerBI
...
Modifica la capacità denominata testcapacity nel gruppo di test del gruppo di risorse in modo da impostare i tag key1:value1 e key2:value2 e administrator su e l'entità testuser1@contoso.com testuser2@contoso.com servizio: 9035a021-a96f-43ea-acbf-864227c2abbb@45119f4f-c71b-4420-b6ec-60e503450098

## PARAMETERS

### -Administrator
Nomi separati da virgola da impostare come amministratori della capacità. Per entità servizio: <service principal object id>@<tenant id>
...
### -ResourceId
RESOURCEID capacità incorporata di PowerBI.
...
### -SKU
Nome della SKU per la capacità.
...
### -Tag
Coppie chiave-valore sotto forma di tabella hash impostata come tag sulla capacità.
