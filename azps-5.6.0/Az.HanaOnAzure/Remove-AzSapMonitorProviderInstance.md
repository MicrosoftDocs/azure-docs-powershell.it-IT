...
## SYNOPSIS
Elimina un'istanza del provider per la sottoscrizione, il gruppo di risorse, il nome SapMonitor e il nome della risorsa specificati.
...
### Esempio 1: Rimuovere un'istanza di un monitor SAP in base al nome
```powershell
PS C:\> Remove-AzSapMonitorProviderInstance -ResourceGroupName nancyc-hn1 -SapMonitorName ps-spamonitor-t01 -Name ps-sapmonitorins-t02

```

Questo comando rimuove un'istanza di monitoraggio SAP in base al nome.

### Esempio 2: Rimuovere un'istanza di un monitor SAP in base all'oggetto
```powershell
...
Questo comando rimuove un'istanza di SAP Monitor per oggetto.
