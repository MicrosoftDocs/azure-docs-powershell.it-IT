...
### Esempio 3: Creare un'istanza di sap monitor tramite dizionario per PrometheusHaCluster
```powershell
...
### Esempio 5: Creare un'istanza di sap monitor tramite dizionario per MsSqlServer
```powershell
