...
## SYNOPSIS
Crea un monitor SAP per la sottoscrizione, il gruppo di risorse e il nome della risorsa specificati.
...
ID ARM'area di lavoro Analisi log usata per il monitoraggio
