...
Crea uno spazio dei nomi Hub eventi MyWithName nella posizione \` \` geografica specificata MyLocation, nel gruppo di risorse \` \` \` MyResourceGroupName. \`
...
### Esempio 5: Creazione di spazio dei nomi con Gestisci identità in un cluster 
```powershell
...
Limite superiore delle unità di velocità effettiva quando l'opzione AutoInflate è abilitata, il valore deve essere compreso tra 0 e 20 unità di velocità effettiva.
