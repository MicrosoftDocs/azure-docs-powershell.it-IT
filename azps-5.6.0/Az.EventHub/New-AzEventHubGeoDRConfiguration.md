...
## DESCRIZIONE
Il cmdlet **New-AzEventHubGeoDRConfiguration** crea un nuovo alias (configurazione di ripristino di emergenza)
...
### -AlternateName
AlternateName obbligatorio quando il nome della configurazione DR corrisponde allo spazio dei nomi principale
...
### -PartnerEnne
ID ARM DR Configuration Partner</b0>
