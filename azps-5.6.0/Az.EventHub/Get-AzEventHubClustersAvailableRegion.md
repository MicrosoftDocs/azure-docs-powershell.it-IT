...
## SYNOPSIS
Recupera i dettagli di un singolo cluster Eventhub o dell'elenco di cluster nel gruppo di risorse specificato
...
## DESCRIZIONE
Elenco Get-AzEventHubClustersAvailableRegion cmdlet di aree geografiche in cui sono disponibili elementi dedicati per la creazione.
...
Viene restituito un elenco di aree geografiche dove
...
### System.Collections.generic.I Paese'1[[Microsoft.Azure.Commands.EventHub.Models.PSEventHubsAvailableCluster, Microsoft.Azure.PowerShell.Cmdlets.EventHub, Version=1.5.0.0, Culture=neutral, PublicKeyToken=null]]
