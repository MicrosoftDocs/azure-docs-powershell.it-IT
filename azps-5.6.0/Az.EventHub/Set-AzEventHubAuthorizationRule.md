...
Aggiorna la regola di autorizzazione MyAuthRuleName per concedere i diritti di gestione per \` l'hub eventi MyEventHubName, con ambito dallo spazio dei nomi \` \` \` \` MyAuthName. \`
