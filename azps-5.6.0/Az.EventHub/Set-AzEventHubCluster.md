...
## SYNOPSIS
Aggiorna il tag per il cluster specificato
...
## DESCRIZIONE
Il cmdlet Set-AzEventHubCluster aggiorna i tag del cluster specificato
...
Aggiorna i tag del cluster specificato. 
...
### -Tag
Hashtables che rappresenta il tag di risorsa per i cluster
