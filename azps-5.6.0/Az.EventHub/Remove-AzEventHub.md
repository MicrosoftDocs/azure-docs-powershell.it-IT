...
## DESCRIZIONE
Il cmdlet Remove-AzEventHub rimuove ed elimina l'hub eventi specificato dallo spazio dei nomi specificato.
...
Rimuove l'hub eventi \` MyEventHubName. \`
...
### Esempio 3: InputObject tramite Piping:
```powershell
...
### Esempio 5: ResourceId - Uso della stringa:
```powershell
