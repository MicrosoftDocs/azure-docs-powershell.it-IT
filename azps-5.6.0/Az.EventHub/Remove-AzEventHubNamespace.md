...
## DESCRIZIONE
Il cmdlet Remove-AzEventHubNamespace rimuove ed elimina lo spazio dei nomi Hub eventi specificato.
...
Rimuove lo spazio dei nomi Hub eventi \` MyWithName \` nel gruppo di risorse \` MyResourceGroupName. \`
...
### Esempio 5: ResourceId - Uso di Piping:
```powershell
PS C:\> Get-AzResource -ResourceType Microsoft.EventHub/Namespaces | Remove-AzEventHubNamespace
```

### Esempio 6: ResourceId - Uso della stringa:
```powershell
...
### -InputObject
Oggetto Spazio dei nomi di EventHubs
...
### -ResourceId
ID risorsa spazio dei nomi di EventHubs
