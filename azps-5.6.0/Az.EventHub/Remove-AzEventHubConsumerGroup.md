...
## DESCRIZIONE
Il cmdlet Remove-AzEventHubConsumerGroup rimuove ed elimina il gruppo consumer specificato dall'hub eventi specificato.
...
Elimina il gruppo consumer \` MyConsumerGroupName dall'hub eventi MyEventHubName, con ambito allo spazio \` \` dei nomi \` \` \` MyHubName.
