...
## DESCRIZIONE
Il Set-AzEventHubConsumerGroup cmdlet aggiorna il gruppo consumer Hub eventi specificato.
...
Imposta i metadati utente del gruppo consumer \` MyConsumerGroupName \` su "Test".
