...
## SYNOPSIS
Genera un token di firma di accesso condiviso per la regola di autorizzazione di Azure eventhub dello spazio dei nomi/eventhub. 
...
## DESCRIZIONE
Il cmdlet New-AzEventHubAuthorizationRuleSASToken genera un token di firma di accesso condiviso per un nome Azure Eventhub Namesapce o Azure Eventhub
...
Generare il token di firma di accesso condiviso per la regola di autorizzazione specificata per Spazio dei nomi con data di inizio e scadenza.
