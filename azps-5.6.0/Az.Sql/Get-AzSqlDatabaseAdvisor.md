...
## DESCRIZIONE
Il cmdlet **Get-AzSqlDatabaseAdvisor** ottiene uno o più consulenti database di Azure SQL per un database SQL Azure.

## ESEMPI

### Esempio 1: Elencare tutti gli consulenti per il database specificato
```
...
Questo comando ottiene l'elenco di tutti gli consulenti per il database denominato WIRunner che appartiene al server denominato wi-run-australia-east.

### Esempio 2: Ottenere un unico consulente per il database specificato
```
...
Questo comando recupera l'advisor denominato CreateIndex per il database denominato WIRunner.
...
Questo comando recupera tutti gli consulenti per il database denominati "WIRunner" con le azioni consigliate incluse nella risposta.
...
Questo comando recupera l'consulente denominato CreateIndex dal database denominato WIRunner con le azioni consigliate incluse nella risposta.
Poiché il comando usa *il parametro ExpandRecommendedActions,* il cmdlet ottiene le azioni consigliate con la risposta.

### Esempio 5: Elencare tutti gli consulenti per il database specificato usando i filtri
```
...
Questo comando ottiene l'elenco di tutti gli consulenti per il database denominato WIRunner che appartiene al server denominato wi-run-australia-east e inizia con la lettera "d".
...
### -DatabaseName
Specifica il nome del database per cui questo cmdlet richiede l'advisor.
...
## NOTE
* Parole chiave: azure, azurerm, arm, risorsa, gestione, manager, sql, database, mssql, advisor
