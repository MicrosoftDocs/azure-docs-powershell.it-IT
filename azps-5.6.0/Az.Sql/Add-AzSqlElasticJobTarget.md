...
### Esempio 3: Aggiungere una destinazione del pool flessibile
```powershell
...
### Esempio 4: Aggiungere una destinazione di una mappa partizionata
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Aggiunge una destinazione (server, pool flessibile, database e mappa partizionata) a un gruppo di destinazione
...
### -ElasticPoolName
Nome destinazione pool elastico
