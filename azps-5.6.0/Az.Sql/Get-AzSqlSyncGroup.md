...
## DESCRIZIONE
Il **cmdlet Get-AzSqlSyncGroup** restituisce informazioni su uno o più gruppi di SQL database di Azure.
Specificare il nome di un gruppo di sincronizzazione per visualizzare informazioni solo per quel gruppo di sincronizzazione.

## ESEMPI

### Esempio 1: Ottenere tutte le istanze del gruppo di SQL azure assegnato a un database SQL Azure
```
...
Questo comando ottiene informazioni su tutti i gruppi di SQL database di Azure assegnati a un database SQL Azure.

### Esempio 2: Ottenere informazioni su un gruppo di sincronizzazione SQL database di Azure
```
...
Questo comando ottiene informazioni sul gruppo di sincronizzazione SQL database di Azure con nome "SyncGroup01"

### Esempio 3: Assegnare tutte le istanze del gruppo di sincronizzazione SQL Azure a un database SQL Azure usando il filtro
```
...
Questo comando ottiene informazioni su tutti i gruppi di SQL di database di Azure assegnati a un database SQL azure che iniziano con "SyncGroup".
