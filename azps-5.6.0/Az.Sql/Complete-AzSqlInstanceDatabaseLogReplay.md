...
## DESCRIZIONE
Il cmdlet **Complete-AzSqlInstanceDatabaseLogReplay** completa il servizio di riproduzione del log nel database specificato.
...
Questo comando completa il servizio di riproduzione del log per il database specificato dopo il ripristino dell'ultimo backup.
