...
Questo comando ottiene un elenco di tutti gli consulenti per il server denominato wi-run-australia-east che appartengono al gruppo di risorse denominato WIRunnersProd.
