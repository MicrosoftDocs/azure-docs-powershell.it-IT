...
## DESCRIZIONE
Il cmdlet **Get-AzSqlInstancePool** restituisce informazioni su uno o più pool di istanze SQL Azure.
Specificare il nome di un pool di istanze per visualizzare informazioni solo per tale pool di istanze.

## ESEMPI

### Esempio 1: Ottenere tutti i pool di istanze nell'abbonamento di un cliente
```powershell
...
Questo comando ottiene informazioni su tutti i pool di istanze all'interno della sottoscrizione del cliente.
...
Questo comando ottiene informazioni su tutti i pool di istanze all'interno del gruppo di risorse resourcegroup01.
...
Questo comando recupera informazioni sull'istanza pool di istanze Pool0.

### Esempio 4: Ottenere informazioni su un pool di istanze usando l'ID risorsa pool di istanze
```powershell
...
Questo comando ottiene informazioni sul pool di istanze con il relativo identificatore di risorsa.
