...
## DESCRIZIONE
Il cmdlet **New-AzSqlDatabaseRestorePoint** crea un nuovo punto di ripristino da cui è possibile ripristinare un data warehouse di SQL Azure.
...
### -RestorePointLabel
Specifica l'etichetta del punto di ripristino per facilitane l'identificazione.
