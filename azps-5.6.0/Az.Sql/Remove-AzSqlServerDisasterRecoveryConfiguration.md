...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlServerDisasterRecoveryConfiguration** rimuove una SQL di ripristino del sistema del server di database.
...
### -ServerName
Specifica il nome di un server di SQL database.
