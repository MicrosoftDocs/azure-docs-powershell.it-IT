...
## DESCRIZIONE
Il cmdlet **Update-AzSqlSyncGroup** modifica le proprietà di un gruppo di SQL database di Azure.

## ESEMPI

### Esempio 1: Aggiornare un gruppo di sincronizzazione per un database SQL Azure.
```
...
Se usare una connessione di collegamento privato durante la connessione all'hub del gruppo di sincronizzazione.
