...
## DESCRIZIONE
Questo comando rimuove il gruppo di failover delle istanze con il nome specificato, lasciando inalterati tutti i database. L'endpoint del listener verrà ne verrà annullata la registrazione dal DNS.
...
### -Name
Nome del gruppo di failover delle istanze da rimuovere.
...
### -PassThru
Specifica se passare attraverso l'output di esecuzione del cmdlet.
...
### -ResourceId
ID risorsa del gruppo di failover dell'istanza da rimuovere.
