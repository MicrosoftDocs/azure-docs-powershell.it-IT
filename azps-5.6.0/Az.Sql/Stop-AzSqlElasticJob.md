...
## DESCRIZIONE
Il Stop-AzSqlElasticJob cmdlet interrompe un processo con un'esecuzione in esecuzione.
Restituisce lo stato corrente dell'esecuzione del processo

## ESEMPI

### Esempio 1: Interrompe un processo con l'esecuzione di un processo in esecuzione
```powershell
...
Interrompe l'esecuzione di un processo in esecuzione e lo restituisce allo stato corrente
...
### -ParentObject
Oggetto di database controllo agente
...
### -ParentResourceId
ID risorsa di esecuzione del processo
