...
## DESCRIZIONE
Il Get-AzSqlInstanceTransparentDataEncryptionProtector cmdlet ottiene la protezione TDE per l'istanza SQL gestita specificata.
...
Questo comando recupera la protezione TDE per l'istanza gestita denominata ContosoManagedInstanceName nel gruppo di risorse denominato ContosoResourceGroup.
