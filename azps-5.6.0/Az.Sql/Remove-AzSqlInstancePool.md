...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlInstancePool** rimuove un pool di SQL azure.
...
### Esempio 2: Rimuovere un pool di istanze in base al relativo identificatore di risorsa
```powershell
...
Questo comando rimuove un pool di istanze denominato istanzaPool0.
...
### -ResourceId
ID della risorsa del pool di istanze da rimuovere.
