...
Il Set-AzSqlInstanceDatabaseLongTermRetentionBackup cmdlet imposta i criteri di conservazione a lungo termine di un database gestito. (autogenerati)
...
### -InstanceName
Nome dell'istanza gestita di Azure a cui appartiene il database.
...
Ci sono un minimo di 7 giorni e un massimo di 10 anni.
