...
## DESCRIZIONE
Il **cmdlet Stop-AzSqlDatabaseActivity** annulla l'operazione di aggiornamento asincrono sul database.

## ESEMPI

### Esempio 1: Annullare l'operazione di aggiornamento asincrono sul database
```
...
Questo comando annulla l'operazione di aggiornamento asincrono sul database.
