...
## DESCRIZIONE
Il cmdlet **New-AzSqlInstanceDatabase** crea un database SQL istanza gestita di Azure.
...
### -Collation
Fascicolazione delle regole di confronto del SQL istanza di Azure da usare.
...
### -Name
Nome del database delle istanze SQL Azure da creare.
...
### -Tag
I tag da associare al database dell'istanza SQL di Azure
