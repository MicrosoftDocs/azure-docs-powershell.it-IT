...
## DESCRIZIONE
Il cmdlet Set-AzSqlInstanceTransparentDataEncryptionProtector imposta la protezione TDE per un'SQL gestita. Modificando il tipo di protezione TDE, la protezione verrà ruotata.
