...
## DESCRIZIONE
Il cmdlet **Get-AzSqlSyncAgentLinkedDatabase** restituisce informazioni sui database SQL Server collegati da un agente di sincronizzazione.

## ESEMPI

### Esempio 1: Ottenere i database di SQL Server collegati per un agente di sincronizzazione SQL Azure.

L'esempio seguente restituisce i database SQL Server collegati da un agente di sincronizzazione SQL Azure.
