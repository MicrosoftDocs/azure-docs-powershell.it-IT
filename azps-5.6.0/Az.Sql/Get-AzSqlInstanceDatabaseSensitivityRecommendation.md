...
## DESCRIZIONE
Il cmdlet Get-AzSqlInstanceDatabaseSensitivityRecommendation cmdlet restituisce i tipi di informazioni consigliati e le etichette di riservatezza delle colonne nel database SQL istanza gestita di Azure.

## ESEMPI

### Esempio 1: Ottenere i tipi di informazioni consigliati e le etichette di riservatezza di un database SQL istanza gestita di Azure.
```powershell
...
### Esempio 2: Ottenere i tipi di informazioni consigliati e le etichette di riservatezza di un database SQL gestito di Azure con Piping.
```powershell
