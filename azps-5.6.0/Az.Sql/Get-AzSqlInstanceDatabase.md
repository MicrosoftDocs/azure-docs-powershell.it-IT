...
## DESCRIZIONE
Il cmdlet **Get-AzSqlInstanceDatabase** ottiene uno o più database SQL Azure da un'istanza gestita SQL database di Azure.

## ESEMPI

### Esempio 1: Recuperare tutti i database in un'istanza
```
...
### Esempio 3: Recuperare tutti i database di un'istanza usando i filtri
```
