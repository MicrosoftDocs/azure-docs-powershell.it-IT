...
## DESCRIZIONE
Il cmdlet Enable-AzSqlDatabaseSensitivityRecommendation abilita i suggerimenti di riservatezza per le colonne del database.

## ESEMPI

### Esempio 1: Abilitare i suggerimenti di riservatezza per una determinata colonna in un database SQL Azure.
```powershell
...
### Esempio 2: Abilitare i suggerimenti di riservatezza per una determinata colonna di Azure SQL database usando Piping.
```powershell
