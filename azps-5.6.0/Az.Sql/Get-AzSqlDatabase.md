...
## DESCRIZIONE
Il cmdlet **Get-AzSqlDatabase** ottiene uno o più database SQL Azure da un server di database SQL Azure.
...
Questo comando recupera tutti i database nel server denominato server01.
...
Questo comando recupera un database denominato Database02 da un server denominato Server01.

### Esempio 3: Recuperare tutti i database in un server usando i filtri
```
...
Questo comando recupera tutti i database nel server denominato server01 che iniziano con "database".
