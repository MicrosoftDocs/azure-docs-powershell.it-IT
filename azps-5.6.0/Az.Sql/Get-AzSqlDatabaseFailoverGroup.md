...
Per eseguire il comando, è possibile usare uno dei server del gruppo di failover. I valori restituiti rifletteranno lo stato del server specificato rispetto al gruppo di failover.
