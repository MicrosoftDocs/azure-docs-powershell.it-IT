...
Imposta i criteri di conservazione a lungo termine di database01 in modo da salvare ogni backup completo per 14 giorni, il primo backup completo di ogni mese per 24 settimane e il backup completo eseguito nella 26a settimana dell'anno per 10 anni
