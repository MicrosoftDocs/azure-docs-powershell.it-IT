...
## DESCRIZIONE
Questo comando modifica la configurazione di una regola di azure SQL Server rete virtuale.
Per controllare il set di regole di rete virtuale nel server, usare invece "Add-AzSqlServerVirtualNetworkRule" e "Remove-AzSqlServerVirtualNetworkRule".
...
Modifica una regola di rete virtuale esistente con il nuovo ID subnet della rete virtuale che contiene informazioni sulla nuova rete virtuale
...
Nome della regola di rete virtuale del server sql di Azure.
...
ID subnet della rete virtuale per la regola.
