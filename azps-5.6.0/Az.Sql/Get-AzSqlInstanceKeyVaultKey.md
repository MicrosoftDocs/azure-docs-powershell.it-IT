...
## DESCRIZIONE
Il cmdlet Get-AzSqlInstanceKeyVaultKey cmdlet ottiene informazioni sulle chiavi del Vault delle chiavi in un'SQL gestita. È possibile visualizzare tutte le chiavi in un'istanza gestita o una chiave specifica fornendo keyId.
...
Questo comando recupera tutte le chiavi del Vault delle chiavi in un'SQL gestita.
