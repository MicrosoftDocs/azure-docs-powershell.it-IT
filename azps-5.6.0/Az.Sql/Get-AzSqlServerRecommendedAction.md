...
## DESCRIZIONE
Il **cmdlet Get-AzSqlServerRecommendedAction** ottiene una o più azioni consigliate per un consulente SQL Server Azure.

## ESEMPI

### Esempio 1: Ottenere un elenco di tutte le azioni consigliate per uno specifico consulente
```
...
Questo comando ottiene un elenco di tutte le azioni consigliate di SQL Server Advisor denominato CreateIndex disponibile per il server denominato wi-runner-australia-east.

### Esempio 2: Ottenere una sola azione consigliata per un consulente
```
...
Questo comando recupera un'azione consigliata IR_ \[ test_schema \] _ \[ test_table_0.036155 _6C7AE8CC9C87E7FD5893 1 dall'consulente denominato \] CreateIndex.

## PARAMETERS

### -AdvisorName
Specifica il nome dell'consulente per cui il cmdlet richiede azioni.
...
Specifica il nome dell'azione consigliata che riceve questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse del server che contiene il server.
...
### -ServerName
Specifica il nome del server a cui appartiene l'consulente.
...
## NOTE
* Parole chiave: azure, azurerm, arm, risorsa, gestione, manager, sql, server, mssql, advisor, recommendedaction
