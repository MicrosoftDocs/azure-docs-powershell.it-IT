...
### Esempio 1: sospende un database SQL Data Warehouse di Azure
```
...
## NOTE
* Il cmdlet **Suspend-AzSqlDatabase** funziona solo sui database azure SQL Data Warehouse. Questa operazione non è supportata nelle edizioni Azure SQL Database Basic, Standard e Premium.
