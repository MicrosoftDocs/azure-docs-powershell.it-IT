...
Criterio per la risoluzione dei conflitti tra il database hub e quello membro nel gruppo di sincronizzazione.
...
Usare una connessione di collegamento privato quando ci si connette all'hub di questo gruppo di sincronizzazione.
