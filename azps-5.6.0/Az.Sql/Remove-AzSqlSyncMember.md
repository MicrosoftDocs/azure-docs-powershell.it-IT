...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlSyncMember** rimuove un membro di sincronizzazione SQL database di Azure.
...
Questo comando rimuove il membro di SQL database azure denominato syncMember01.
...
### -PassThru
Definisce se restituire o meno il membro di sincronizzazione rimosso
