...
# Modulo Az.Sql
## Descrizione
Questo argomento visualizza gli argomenti della Guida per i cmdlet SQL database di Azure.
...
Aggiunge un passaggio di processo a un processo
...
Aggiunge una chiave vault della chiave all'istanza gestita fornita. 
...
Aggiunge un certificato di crittografia dei dati trasparente per l'istanza gestita specificata

### [Add-AzSqlServerKeyVaultKey](Add-AzSqlServerKeyVaultKey.md)
Aggiunge una chiave del Vault chiave a un SQL server.

### [Add-AzSqlServerTransparentDataEncryptionCertificate](Add-AzSqlServerTransparentDataEncryptionCertificate.md)
Aggiunge un certificato di crittografia dei dati trasparente per l'istanza SQL Server dati specificata

### [Clear-AzSqlDatabaseAdvancedThreatProtectionSetting](Clear-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
Rimuove le impostazioni di Protezione avanzata dalle minacce da un database.

### [Clear-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline](Clear-AzSqlDatabaseVulnerabilityAssessmentRuleBaseline.md)
Cancella la linea di base della regola di valutazione della vulnerabilità.
...
Cancella le impostazioni di valutazione della vulnerabilità di un database gestito.

### [Clear-AzSqlInstanceVulnerabilityAssessmentSetting](Clear-AzSqlInstanceVulnerabilityAssessmentSetting.md)
Cancella le impostazioni di valutazione della vulnerabilità di un'istanza gestita.
...
Cancella le impostazioni di valutazione della vulnerabilità di un server.

### [Complete-AzSqlInstanceDatabaseLogReplay](Complete-AzSqlInstanceDatabaseLogReplay.md)
Completa il servizio di riproduzione del log per il database specificato.

### [Convert-AzSqlDatabaseVulnerabilityAssessmentScan](Convert-AzSqlDatabaseVulnerabilityAssessmentScan.md)
Converte i risultati di un'analisi di valutazione delle vulnerabilità nel formato di Excel.
...
Abilita i suggerimenti di riservatezza per le colonne (i suggerimenti sono abilitati per impostazione predefinita in tutte le colonne) nel database SQL istanza gestita di Azure.

### [Enable-AzSqlServerActiveDirectoryOnlyAuthentication](Enable-AzSqlServerActiveDirectoryOnlyAuthentication.md)
Abilita l'autenticazione di Azure AD solo per uno specifico SQL Server.

### [Enable-AzSqlServerAdvancedDataSecurity](Enable-AzSqlServerAdvancedDataSecurity.md)
Abilita Advanced Data Security in un server.

### [Enable-AzSqlServerAdvancedThreatProtection](Enable-AzSqlServerAdvancedThreatProtection.md)
Abilita Advanced Threat Protection in un server.

### [Get-AzSqlCapability](Get-AzSqlCapability.md)
Recupera SQL funzionalità di database per l'abbonamento corrente.

### [Get-AzSqlDatabase](Get-AzSqlDatabase.md)
Ottiene uno o più database.

### [Get-AzSqlDatabaseActivity](Get-AzSqlDatabaseActivity.md)
Ottiene lo stato delle operazioni di database.
...
Ottiene uno o più consulenti per un database SQL Azure.

### [Get-AzSqlDatabaseAudit](Get-AzSqlDatabaseAudit.md)
Ottiene le impostazioni di controllo di un database di SQL Azure.

### [Get-AzSqlDatabaseBackupLongTermRetentionPolicy](Get-AzSqlDatabaseBackupLongTermRetentionPolicy.md)
Ottiene i criteri di conservazione a lungo termine del database.
...
Ottiene i criteri di maschera dati per un database.
...
Recupera le operazioni di indice consigliate per un server o un database.
...
Recupera una o più azioni consigliate per un amministratore di Azure SQL Database Advisor.
...
Recupera i diversi punti di ripristino da cui è possibile ripristinare SQL data warehouse.

### [Get-AzSqlDatabaseSensitivityClassification](Get-AzSqlDatabaseSensitivityClassification.md)
Recupera i tipi di informazioni correnti e le etichette di riservatezza delle colonne nel database.

### [Get-AzSqlDatabaseSensitivityRecommendation](Get-AzSqlDatabaseSensitivityRecommendation.md)
Recupera i tipi di informazioni consigliati e le etichette di riservatezza delle colonne nel database.

### [Get-AzSqlDatabaseTransparentDataEncryption](Get-AzSqlDatabaseTransparentDataEncryption.md)
Ottiene lo stato TDE per un database.

### [Get-AzSqlDatabaseTransparentDataEncryptionActivity](Get-AzSqlDatabaseTransparentDataEncryptionActivity.md)
Recupera lo stato di un'analisi TDE di un database.
...
Recupera la linea di base della regola di valutazione delle vulnerabilità.

### [Get-AzSqlDatabaseVulnerabilityAssessmentScanRecord](Get-AzSqlDatabaseVulnerabilityAssessmentScanRecord.md)
Recupera tutti i record di analisi di valutazione delle vulnerabilità associati a un determinato database.

### [Get-AzSqlDatabaseVulnerabilityAssessmentSetting](Get-AzSqlDatabaseVulnerabilityAssessmentSetting.md)
Recupera le impostazioni di valutazione della vulnerabilità di un database.

### [Get-AzSqlDeletedDatabaseBackup](Get-AzSqlDeletedDatabaseBackup.md)
Recupera un database eliminato che è possibile ripristinare.
...
Ottiene una o più esecuzioni di destinazione del processo

### [Get-AzSqlElasticJobTargetGroup](Get-AzSqlElasticJobTargetGroup.md)
Ottiene uno o più gruppi di destinazione dei processi

### [Get-AzSqlElasticPool](Get-AzSqlElasticPool.md)
Recupera i pool elastici e i relativi valori di proprietà in un database SQL Azure.

### [Get-AzSqlElasticPoolActivity](Get-AzSqlElasticPoolActivity.md)
Ottiene lo stato delle operazioni in un pool elastico.
...
Recupera i database elastici in un pool flessibile e i relativi valori di proprietà.
...
Recupera una o più azioni consigliate per un consulente del pool SQL di Azure.

### [Get-AzSqlInstance](Get-AzSqlInstance.md)
Restituisce informazioni su Azure SQL istanza di database gestita.

### [Get-AzSqlInstanceActiveDirectoryAdministrator](Get-AzSqlInstanceActiveDirectoryAdministrator.md)
Ottiene informazioni su un amministratore di Azure AD per SQL gestita.

### [Get-AzSqlInstanceActiveDirectoryOnlyAuthentication](Get-AzSqlInstanceActiveDirectoryOnlyAuthentication.md)
Recupera l'autenticazione di Azure AD solo per una SQL gestita specifica.
...
Restituisce informazioni sul backup ridondante del database SQL istanza gestita di Azure.

### [Get-AzSqlInstanceDatabaseLogReplay](Get-AzSqlInstanceDatabaseLogReplay.md)
Ottiene lo stato del servizio di riproduzione del log.

### [Get-AzSqlInstanceDatabaseLongTermRetentionBackup](Get-AzSqlInstanceDatabaseLongTermRetentionBackup.md)
Ottiene backup di conservazione a lungo termine.

### [Get-AzSqlInstanceDatabaseSensitivityClassification](Get-AzSqlInstanceDatabaseSensitivityClassification.md)
Recupera i tipi di informazioni correnti e le etichette di riservatezza delle colonne nel database SQL istanza gestita di Azure.

### [Get-AzSqlInstanceDatabaseSensitivityRecommendation](Get-AzSqlInstanceDatabaseSensitivityRecommendation.md)
Recupera i tipi di informazioni consigliati e le etichette di riservatezza delle colonne nel database SQL istanza gestita di Azure.
...
Recupera tutti i record di analisi della valutazione delle vulnerabilità associati a un determinato database gestito.

### [Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting](Get-AzSqlInstanceDatabaseVulnerabilityAssessmentSetting.md)
Recupera le impostazioni di valutazione della vulnerabilità di un database gestito.

### [Get-AzSqlInstanceKeyVaultKey](Get-AzSqlInstanceKeyVaultKey.md)
Ottiene le SQL Vault delle chiavi di un'istanza gestita.
...
Restituisce informazioni sul pool di istanze SQL Azure.

### [Get-AzSqlInstancePoolUsage](Get-AzSqlInstancePoolUsage.md)
Restituisce informazioni sull'utilizzo di un pool SQL istanza di Azure.

### [Get-AzSqlInstanceTransparentDataEncryptionProtector](Get-AzSqlInstanceTransparentDataEncryptionProtector.md)
Ottiene la protezione TDE (Transparent Data Encryption) per un'SQL gestita.

### [Get-AzSqlInstanceVulnerabilityAssessmentSetting](Get-AzSqlInstanceVulnerabilityAssessmentSetting.md)
Recupera le impostazioni di valutazione della vulnerabilità di un'istanza gestita.

### [Get-AzSqlServer](Get-AzSqlServer.md)
Restituisce informazioni sui server SQL database.

### [Get-AzSqlServerActiveDirectoryAdministrator](Get-AzSqlServerActiveDirectoryAdministrator.md)
Recupera informazioni su un amministratore di Azure AD per SQL Server.

### [Get-AzSqlServerActiveDirectoryOnlyAuthentication](Get-AzSqlServerActiveDirectoryOnlyAuthentication.md)
Recupera l'autenticazione di Azure AD solo per una SQL Server.

### [Get-AzSqlServerAdvancedDataSecurityPolicy](Get-AzSqlServerAdvancedDataSecurityPolicy.md)
Recupera i criteri di Sicurezza avanzata dei dati di un server.

### [Get-AzSqlServerAdvancedThreatProtectionSetting](Get-AzSqlServerAdvancedThreatProtectionSetting.md)
Ottiene le impostazioni di Protezione dalle minacce avanzate per un server.

### [Get-AzSqlServerAdvisor](Get-AzSqlServerAdvisor.md)
Ottiene uno o più consulenti per un servizio di SQL Server Azure.

### [Get-AzSqlServerAudit](Get-AzSqlServerAudit.md)
Ottiene le impostazioni di controllo di un server SQL Azure.

### [Get-AzSqlServerCommunicationLink](Get-AzSqlServerCommunicationLink.md)
Recupera i collegamenti di comunicazione per le transazioni di database elastiche tra i server di database.

### [Get-AzSqlServerMSSupportAudit](Get-AzSqlServerMSSupportAudit.md)
Recupera le impostazioni di controllo delle operazioni di supporto Microsoft di un server SQL Azure.
...
Ottiene o elenca l'alias DNS SQL Server Azure.

### [Get-AzSqlServerFirewallRule](Get-AzSqlServerFirewallRule.md)
Recupera le regole del firewall per un SQL server di database.
...
Recupera una o più azioni consigliate per un amministratore di Azure SQL Server Advisor.

### [Get-AzSqlServerServiceObjective](Get-AzSqlServerServiceObjective.md)
Ottiene gli obiettivi del servizio per un server di SQL Azure.

### [Get-AzSqlServerTransparentDataEncryptionProtector](Get-AzSqlServerTransparentDataEncryptionProtector.md)
Ottiene la protezione TDE (Transparent Data Encryption)

### [Get-AzSqlServerUpgradeHint](Get-AzSqlServerUpgradeHint.md)
Ottiene suggerimenti per i prezzi per l'aggiornamento di un server di SQL Azure.

### [Get-AzSqlServerVirtualNetworkRule](Get-AzSqlServerVirtualNetworkRule.md)
Ottiene o elenca una regola per SQL Server rete virtuale di Azure.

### [Get-AzSqlServerVulnerabilityAssessmentSetting](Get-AzSqlServerVulnerabilityAssessmentSetting.md)
Recupera le impostazioni di valutazione della vulnerabilità di un server.

### [Get-AzSqlSyncAgent](Get-AzSqlSyncAgent.md)
Restituisce informazioni sugli agenti di sincronizzazione SQL Azure.

### [Get-AzSqlSyncAgentLinkedDatabase](Get-AzSqlSyncAgentLinkedDatabase.md)
Restituisce informazioni su SQL Server database collegati da un agente di sincronizzazione.

### [Get-AzSqlSyncGroup](Get-AzSqlSyncGroup.md)
Restituisce informazioni sui gruppi di sincronizzazione SQL database di Azure.

### [Get-AzSqlSyncGroupLog](Get-AzSqlSyncGroupLog.md)
Restituisce i log di un gruppo di sincronizzazione SQL database di Azure.

### [Get-AzSqlSyncMember](Get-AzSqlSyncMember.md)
Restituisce informazioni sui membri di Azure SQL di sincronizzazione del database.
...
Questo comando crea un nuovo gruppo di failover SQL database di Azure.

### [New-AzSqlDatabaseImport](New-AzSqlDatabaseImport.md)
Importa un file con estensione bacpac e crea un nuovo database nel server.

### [New-AzSqlDatabaseInstanceFailoverGroup](New-AzSqlDatabaseInstanceFailoverGroup.md)
Questo comando crea un nuovo gruppo di failover dell SQL di database di Azure.

### [New-AzSqlDatabaseRestorePoint](New-AzSqlDatabaseRestorePoint.md)
Crea un nuovo punto di ripristino da cui è possibile SQL un database.

### [New-AzSqlDatabaseSecondary](New-AzSqlDatabaseSecondary.md)
Crea un database secondario per un database esistente e avvia la replica dei dati.

### [New-AzSqlElasticJob](New-AzSqlElasticJob.md)
Crea un nuovo processo

### [New-AzSqlElasticJobAgent](New-AzSqlElasticJobAgent.md)
Crea un nuovo agente di processo flessibile

### [New-AzSqlElasticJobCredential](New-AzSqlElasticJobCredential.md)
Crea nuove credenziali di processo

### [New-AzSqlElasticJobTargetGroup](New-AzSqlElasticJobTargetGroup.md)
Crea un nuovo gruppo di destinazione
...
Crea un'istanza gestita SQL database di Azure.

### [New-AzSqlInstanceDatabase](New-AzSqlInstanceDatabase.md)
Crea un database SQL istanza gestita di Azure.

### [New-AzSqlInstancePool](New-AzSqlInstancePool.md)
Crea un pool di SQL azure.

### [New-AzSqlServer](New-AzSqlServer.md)
Crea un SQL server di database.

### [New-AzSqlServerCommunicationLink](New-AzSqlServerCommunicationLink.md)
Crea un collegamento di comunicazione per le transazioni di database elastiche tra due SQL server di database.

### [New-AzSqlServerDisasterRecoveryConfiguration](New-AzSqlServerDisasterRecoveryConfiguration.md)
Crea una configurazione di ripristino del sistema del server di database.

### [New-AzSqlServerDnsAlias](New-AzSqlServerDnsAlias.md)
Questo comando crea un nuovo alias DNS SQL Server Azure.
...
Crea una regola di rete SQL Server virtuale di Azure. 

### [New-AzSqlSyncAgent](New-AzSqlSyncAgent.md)
Crea un agente di sincronizzazione SQL Azure.

### [New-AzSqlSyncAgentKey](New-AzSqlSyncAgentKey.md)
Crea una chiave dell'SQL di sincronizzazione di Azure.
...
Rimuove un database SQL Azure.

### [Remove-AzSqlDatabaseAudit](Remove-AzSqlDatabaseAudit.md)
Rimuove le impostazioni di controllo di un database SQL Azure.

### [Remove-AzSqlDatabaseDataMaskingRule](Remove-AzSqlDatabaseDataMaskingRule.md)
Rimuove una regola di maschera dati da un database.

### [Remove-AzSqlDatabaseFailoverGroup](Remove-AzSqlDatabaseFailoverGroup.md)
Rimuove un gruppo di failover SQL database di Azure.

### [Remove-AzSqlDatabaseFromFailoverGroup](Remove-AzSqlDatabaseFromFailoverGroup.md)
Rimuove uno o più database da un gruppo di failover SQL database di Azure.
...
Rimuove i tipi di informazioni e le etichette di riservatezza delle colonne nel database SQL istanza gestita di Azure.
...
Rimuove un pool di SQL azure.

### [Remove-AzSqlServer](Remove-AzSqlServer.md)
Rimuove un server di SQL azure.
...
Elimina un collegamento di comunicazione per le transazioni di database elastiche tra due server.

### [Remove-AzSqlServerDisasterRecoveryConfiguration](Remove-AzSqlServerDisasterRecoveryConfiguration.md)
Rimuove una configurazione SQL ripristino del sistema del server di database.

### [Remove-AzSqlServerDnsAlias](Remove-AzSqlServerDnsAlias.md)
Rimuove l'alias DNS SQL Server Azure.

### [Remove-AzSqlServerFirewallRule](Remove-AzSqlServerFirewallRule.md)
Elimina una regola del firewall da un server SQL database.

### [Remove-AzSqlServerKeyVaultKey](Remove-AzSqlServerKeyVaultKey.md)
Rimuove una chiave del Vault chiave da un SQL server.

### [Remove-AzSqlServerMSSupportAudit](Remove-AzSqlServerMSSupportAudit.md)
Rimuove le impostazioni di controllo delle operazioni di supporto Microsoft di un server SQL Azure.

### [Remove-AzSqlServerVirtualNetworkRule](Remove-AzSqlServerVirtualNetworkRule.md)
Elimina una regola di Rete SQL Server virtuale di Azure.

### [Remove-AzSqlSyncAgent](Remove-AzSqlSyncAgent.md)
Rimuove un agente di sincronizzazione SQL Azure.

### [Remove-AzSqlSyncGroup](Remove-AzSqlSyncGroup.md)
Rimuove un gruppo di sincronizzazione SQL database di Azure.

### [Remove-AzSqlSyncMember](Remove-AzSqlSyncMember.md)
Rimuove un membro di sincronizzazione SQL database di Azure.

### [Remove-AzSqlVirtualCluster](Remove-AzSqlVirtualCluster.md)
Rimuove un cluster virtuale SQL Azure.

### [Restore-AzSqlDatabase](Restore-AzSqlDatabase.md)
Ripristina un database SQL dati.
...
Riprende un database SQL Data Warehouse.

### [Set-AzSqlDatabase](Set-AzSqlDatabase.md)
Imposta le proprietà per un database o sposta un database esistente in un pool flessibile.

### [Set-AzSqlDatabaseAdvisorAutoExecuteStatus](Set-AzSqlDatabaseAdvisorAutoExecuteStatus.md)
Modifica lo stato di esecuzione automatica di un avviso di SQL database di Azure.

### [Set-AzSqlDatabaseAudit](Set-AzSqlDatabaseAudit.md)
Modifica le impostazioni di controllo per un database di SQL Azure.
...
Imposta la maschera dati per un database.
...
Modifica la configurazione di un gruppo di failover del SQL database di Azure.
...
Stato di esecuzione automatica degli aggiornamenti di un consulente SQL di Azure.
...
Esegue il provisioning di un amministratore di Azure AD SQL'istanza gestita.
...
Imposta i tipi di informazioni e le etichette di riservatezza delle colonne nel database SQL istanza gestita di Azure.
...
Imposta le proprietà per un pool di SQL azure.

### [Set-AzSqlInstanceTransparentDataEncryptionProtector](Set-AzSqlInstanceTransparentDataEncryptionProtector.md)
Imposta la protezione di TDE (Transparent Data Encryption) per un'SQL gestita.

### [Set-AzSqlServer](Set-AzSqlServer.md)
Modifica le proprietà di un server SQL database.

### [Set-AzSqlServerActiveDirectoryAdministrator](Set-AzSqlServerActiveDirectoryAdministrator.md)
Esegue il provisioning di un amministratore di Azure AD per SQL Server.

### [Set-AzSqlServerAdvisorAutoExecuteStatus](Set-AzSqlServerAdvisorAutoExecuteStatus.md)
Aggiorna lo stato di esecuzione automatica di un avviso SQL Server azure.

### [Set-AzSqlServerAudit](Set-AzSqlServerAudit.md)
Modifica le impostazioni di controllo di un server SQL Azure.
...
Modifica una regola del firewall in Azure SQL server di database.

### [Set-AzSqlServerMSSupportAudit](Set-AzSqlServerMSSupportAudit.md)
Modifica le impostazioni di controllo delle operazioni di supporto Microsoft per un database SQL Azure.

### [Set-AzSqlServerRecommendedActionState](Set-AzSqlServerRecommendedActionState.md)
Aggiorna lo stato di un'azione consigliata SQL Server azure.

### [Set-AzSqlServerTransparentDataEncryptionProtector](Set-AzSqlServerTransparentDataEncryptionProtector.md)
Imposta la protezione di TDE (Transparent Data Encryption) per un SQL server.

### [Set-AzSqlServerVirtualNetworkRule](Set-AzSqlServerVirtualNetworkRule.md)
Modifica la configurazione di una regola di azure SQL Server rete virtuale.

### [Start-AzSqlDatabaseExecuteIndexRecommendation](Start-AzSqlDatabaseExecuteIndexRecommendation.md)
Avvia il flusso di lavoro che esegue un'operazione di indicizzazione consigliata.

### [Start-AzSqlDatabaseVulnerabilityAssessmentScan](Start-AzSqlDatabaseVulnerabilityAssessmentScan.md)
Avvia un'analisi di valutazione delle vulnerabilità.

### [Start-AzSqlElasticJob](Start-AzSqlElasticJob.md)
Avvia un processo, restituisce un ID di esecuzione del processo che può essere polled per visualizzarne lo stato

### [Start-AzSqlInstanceDatabaseLogReplay](Start-AzSqlInstanceDatabaseLogReplay.md)
Avvia un servizio di riproduzione del log con i parametri specificati.
...
Avvia la sincronizzazione di un gruppo di sincronizzazione.

### [Stop-AzSqlDatabaseActivity](Stop-AzSqlDatabaseActivity.md)
Annulla l'operazione di aggiornamento asincrono sul database.
...
Interrompe un processo dato l'ID di esecuzione del processo

### [Stop-AzSqlElasticPoolActivity](Stop-AzSqlElasticPoolActivity.md)
Annulla l'operazione di aggiornamento asincrono in un pool elastico.

### [Stop-AzSqlInstanceDatabaseLogReplay](Stop-AzSqlInstanceDatabaseLogReplay.md)
Annulla il servizio di riproduzione del log eliminando il database.

### [Stop-AzSqlInstanceOperation](Stop-AzSqlInstanceOperation.md)
Interrompe le SQL di un'istanza gestita.

### [Stop-AzSqlSyncGroupSync](Stop-AzSqlSyncGroupSync.md)
Interrompe la sincronizzazione di un gruppo di sincronizzazione.

### [Suspend-AzSqlDatabase](Suspend-AzSqlDatabase.md)
Sospende un SQL data warehouse.
...
Esegue il failover di un gruppo di failover delle istanze.

### [Update-AzSqlDatabaseAdvancedThreatProtectionSetting](Update-AzSqlDatabaseAdvancedThreatProtectionSetting.md)
Configura le impostazioni di Protezione avanzata dalle minacce in un database.
...
Aggiorna le impostazioni di valutazione della vulnerabilità di un database gestito.

### [Update-AzSqlInstanceVulnerabilityAssessmentSetting](Update-AzSqlInstanceVulnerabilityAssessmentSetting.md)
Aggiorna le impostazioni di valutazione della vulnerabilità di un'istanza gestita.
...
Aggiorna le impostazioni di valutazione della vulnerabilità di un server.

### [Update-AzSqlSyncGroup](Update-AzSqlSyncGroup.md)
Aggiorna un gruppo di sincronizzazione SQL database di Azure.

### [Update-AzSqlSyncMember](Update-AzSqlSyncMember.md)
Aggiorna un membro di sincronizzazione SQL database di Azure.

### [Update-AzSqlSyncSchema](Update-AzSqlSyncSchema.md)
Aggiornare lo schema di sincronizzazione per un database dei membri di sincronizzazione o un database hub di sincronizzazione.
Il database otterrà lo schema di database più recente dal database reale e lo userà per aggiornare lo schema memorizzato nella cache dal database dei metadati di sincronizzazione.
Se è specificato "SyncMemberName", aggiorna lo schema di database dei membri; in caso contrario, lo schema del database hub verrà aggiornato.
