...
## DESCRIZIONE
Il cmdlet **Get-AzSqlServerAudit** ottiene le impostazioni di controllo di un server SQL Azure.
Specificare i *parametri ResourceGroupName* e *ServerName* per identificare il server.

## ESEMPI

### Esempio 1: Ottenere le impostazioni di controllo di un server SQL Azure
```
...
### Esempio 2: Ottenere, tramite pipeline, le impostazioni di controllo di un server SQL Azure
```
...
### Esempio 3: Ottenere le impostazioni di controllo di un server SQL Azure
```
PS C:\>Get-AzSqlServerAudit -ResourceGroupName "resourcegroup01" -ServerName "server01"
ServerName                          : server01
ResourceGroupName                   : resourcegroup01
