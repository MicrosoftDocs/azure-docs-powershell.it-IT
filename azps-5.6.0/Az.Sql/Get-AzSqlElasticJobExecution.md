...
## DESCRIZIONE
Il cmdlet Get-AzSqlElasticJobExecution riceve una o più esecuzioni di processi
...
### Esempio 2: ottiene una o più esecuzioni di un processo
```powershell
PS C:\> $agent = Get-AzSqlElasticJobAgent -ResourceGroupName rg -ServerName elasticjobserver -Name agent
...
Ottiene una o più esecuzioni di processi. (autogenerati)
