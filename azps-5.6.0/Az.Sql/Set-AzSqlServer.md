...
## DESCRIZIONE
Il cmdlet **Set-AzSqlServer** modifica le proprietà di un server di database SQL Azure.
...
Questo comando reimposta la password dell'amministratore nel server AzureSQL denominato server01.

### Esempio 2

Modifica le proprietà di un server SQL database. (autogenerati)
...
### -ServerName
Specifica il nome del server modificato dal cmdlet.
...
### -Tag
Specifica un dizionario di tag associati al server da questo cmdlet. Coppie chiave-valore sotto forma di tabella hash impostata come tag nel server. Ad esempio: @{key0="value0";key1=$null;key2="value2"}
