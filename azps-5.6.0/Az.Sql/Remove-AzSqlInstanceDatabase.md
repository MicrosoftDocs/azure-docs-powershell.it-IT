...
## DESCRIZIONE
Il cmdlet **Remove-AzSqlInstanceDatabase** rimuove un database SQL istanza gestita di Azure.
...
### -InputObject
L'oggetto Database di istanza da rimuovere
...
### -Name
Nome del database delle istanze SQL Azure da rimuovere.
...
### -ResourceId
ID risorsa dell'oggetto database di istanza da rimuovere
