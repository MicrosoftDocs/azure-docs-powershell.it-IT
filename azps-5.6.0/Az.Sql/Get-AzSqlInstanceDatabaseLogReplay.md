...
## DESCRIZIONE
Il **cmdlet Get-AzSqlInstanceDatabaseLogReplay** ottiene lo stato del servizio di riproduzione del log nel database specificato.
...
Questo comando ottiene lo stato del servizio di riproduzione del log nel database specificato.
