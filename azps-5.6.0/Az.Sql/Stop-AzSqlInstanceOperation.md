...
## DESCRIZIONE
Il cmdlet Stop-AzSqlInstanceOperation interrompe l'operazione con il nome dell'operazione fornito in un'SQL gestita.
...
Questo comando interrompe l'operazione con il nome 'd0f5bef5-e2b1-4ef8-bb42-2e54073874f9' in un'istanza SQL gestita.

### Esempio 2: Uso dell'ID risorsa dell'operazione
```powershell
...
Questo comando interrompe l'operazione con gli oggetti $managedInstanceOperation.
...
### -ResourceId
ID risorsa dell'oggetto operazione da interrompere
