...
## DESCRIZIONE
Il cmdlet Disable-AzSqlInstanceDatabaseSensitivityRecommendation disabilita (elimina) i suggerimenti di riservatezza per le colonne nel database SQL istanza gestita di Azure.

## ESEMPI

### Esempio 1: Disabilitare i suggerimenti di riservatezza per una determinata colonna in un database SQL istanza gestita di Azure.
```powershell
...
### Esempio 2: Disabilitare i suggerimenti di riservatezza per le colonne che hanno suggerimenti di riservatezza in un database di istanze gestite di Azure SQL con Piping.
```powershell
...
### Esempio 3: Disabilitare i suggerimenti di riservatezza per una determinata colonna in un database di istanze gestite di Azure SQL con Piping.
```powershell
...
### -InstanceName
Nome dell SQL istanza gestita di Azure.
