...
## DESCRIZIONE
Crea un nuovo alias DNS SQL Server Azure che fa riferimento al server specificato.
...
Questo comando crea l'alias DNS SQL Server Azure con il nome aliasName che fa riferimento a serverName
