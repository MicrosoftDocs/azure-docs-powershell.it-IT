...
## DESCRIZIONE
Il cmdlet **Get-AzSqlInstanceActiveDirectoryOnlyAuthentication** ottiene il requisito di autenticazione di Azure Active Directory (Azure AD) solo per un'istanza gestita di AzureSQL nella sottoscrizione corrente.
...
Questo comando ottiene solo il requisito di autenticazione di Azure Active Directory (Azure AD) per un'istanza gestita di AzureSQL denominata ManagedInstance01 associata a un gruppo di risorse denominato ResourceGroup01.
