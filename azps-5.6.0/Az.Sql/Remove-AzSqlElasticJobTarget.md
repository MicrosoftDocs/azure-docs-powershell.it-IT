...
## DESCRIZIONE
Il cmdlet Remove-AzSqlElasticJobTarget rimuove una risorsa di destinazione a un gruppo di destinazione

## ESEMPI

### Esempio 1: Rimuovere una destinazione del server
```powershell
...
### Esempio 2: Rimuovere una destinazione di database
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Esempio 3: Rimuovere una destinazione del pool flessibile
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
### Esempio 4: Rimuovere una destinazione della mappa partizionata
```powershell
PS C:\> $tg = Get-AzSqlElasticJobTargetGroup -ResourceGroupName rg -ServerName elasticjobserver -Name tg1
...
Rimuove una destinazione (server, pool flessibile, database e mappa partizionata) da un gruppo di destinazione

## PARAMETERS

### -AgentName
SQL agente di database.
...
### -ElasticPoolName
Nome di destinazione del pool flessibile
...
### -ParentResourceId
ID della risorsa del gruppo di destinazione.
...
### -ShardMapName
Nome destinazione mappa partizionata
