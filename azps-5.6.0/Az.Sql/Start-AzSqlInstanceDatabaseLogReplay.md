...
Questo comando crea un nuovo database gestito e avvia il ripristino dei backup dal contenitore specificato finché Complete-AzSqlInstanceDatabaseLogReplay chiamata con l'ultimo backup desiderato.
