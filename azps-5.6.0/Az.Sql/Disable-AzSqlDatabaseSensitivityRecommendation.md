...
## DESCRIZIONE
Il cmdlet Disable-AzSqlDatabaseSensitivityRecommendation disabilita (elimina) i suggerimenti di riservatezza per le colonne del database.

## ESEMPI

### Esempio 1: Disabilitare i suggerimenti di riservatezza per una determinata colonna in un database SQL Azure.
```powershell
...
### Esempio 2: Disabilitare i suggerimenti di riservatezza per le colonne che hanno suggerimenti di riservatezza in un database SQL Azure con Piping.
```powershell
...
### Esempio 3: Disabilitare i suggerimenti di riservatezza per una determinata colonna in un database SQL Azure tramite Piping.
```powershell
...
### -InputObject
Oggetto che rappresenta una classificazione SQL riservatezza del database.
