...
## DESCRIZIONE
Il cmdlet **Clear-AzSqlDatabaseAdvancedThreatProtectionSetting** rimuove le impostazioni di Protezione avanzata dalle minacce da un database SQL AzureAzure.
Per usare questo cmdlet, specificare i *parametri ResourceGroupName* e *ServerName* per identificare il database da cui il cmdlet rimuove le impostazioni.
...
Questo comando rimuove le impostazioni di Protezione avanzata dalle minacce da un database denominato Database01 nel server denominato Server01.

## PARAMETERS

### -DatabaseName
Specifica il nome di un database in cui devono essere rimosse le impostazioni di Protezione avanzata dalle minacce.
