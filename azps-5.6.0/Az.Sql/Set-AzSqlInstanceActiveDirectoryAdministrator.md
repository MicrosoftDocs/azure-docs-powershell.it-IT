...
Questo comando esegue il provisioning di un utente di Azure AD come amministratore dall'oggetto dell'istanza gestita.

### Esempio 3: Eseguire il provisioning di un amministratore usando l'identificatore di risorsa dell'istanza gestita
```
