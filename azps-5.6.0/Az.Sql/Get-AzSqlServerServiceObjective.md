...
### ByLocation (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Get-AzSqlServerServiceObjective** ottiene gli obiettivi del servizio disponibili per un server di database SQL Azure.

## ESEMPI

### Esempio 1: Ottenere gli obiettivi del servizio
```
...
Questo comando ottiene gli obiettivi del servizio per il server denominato Server01.

### Esempio 2: Ottenere gli obiettivi del servizio con i filtri
```
...
Questo comando ottiene gli obiettivi del servizio per il server denominato Server01 che inizia con "Sistema".

### Esempio 3: Ottenere gli obiettivi del servizio per una località
```
...
Questo comando ottiene gli obiettivi del servizio per un'area geografica di Azure specificata.
...
### -Location
Nome della posizione per cui ottenere gli obiettivi del servizio.
...
Questo cmdlet ottiene gli obiettivi del servizio per un server SQL database assegnato alla risorsa.
...
### -ServerName
Specifica il nome di un server di SQL database SQL server di database.
...
Specifica il nome di un obiettivo del servizio per un server di database SQL Azure.
I valori accettabili per questo parametro sono: Base, S0, S1, S2, P1, P2 e P3.
