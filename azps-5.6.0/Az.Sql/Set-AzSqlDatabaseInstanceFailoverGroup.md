...
Durante l'anteprima della funzionalità Gruppi di failover delle istanze, per il parametro '-GracePeriodWithDataLossHours' sono supportati solo i valori maggiori o uguali a 1 ora.
...
Imposta il criterio di failover di un gruppo di failover dell'istanza su "Manuale" tramite piping nel gruppo di failover.
...
### -FailoverPolicy
Criteri di failover del gruppo di failover delle istanze.
...
### -ResourceId
ID risorsa del gruppo di failover dell'istanza da impostare.
