...
## DESCRIZIONE
Il cmdlet **Update-AzSqlSyncSchema** aggiorna lo schema di sincronizzazione per un database dei membri di sincronizzazione o un database dell'hub di sincronizzazione.
...
### Esempio 2: Aggiornare lo schema di sincronizzazione per un database membro
```
...
Questo comando aggiorna lo schema di sincronizzazione per il database dei membri nel membro di sincronizzazione syncMember01
...
### -PassThru
Definisce se restituire il gruppo di sincronizzazione su cui funziona questo cmdlet
