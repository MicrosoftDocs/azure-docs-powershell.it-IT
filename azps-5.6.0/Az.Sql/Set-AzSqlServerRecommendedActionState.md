...
## DESCRIZIONE
Il cmdlet **Set-AzSqlServerRecommendedActionState** aggiorna lo stato di un'azione SQL Server azure consigliata.
Questo cmdlet applica, ripristina o elimina l'azione consigliata in base al nuovo stato.

## ESEMPI

### Esempio1: Aggiornare lo stato dell'azione consigliata specificata in In sospeso
```
...
Aggiorna lo stato dell'azione consigliata del server denominata "IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893" in \] "In sospeso"

## PARAMETERS

### -AdvisorName
Specifica il nome dell'consulente che contiene l'azione consigliata.
