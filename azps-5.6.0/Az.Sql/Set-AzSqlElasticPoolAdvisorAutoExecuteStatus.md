...
## DESCRIZIONE
Il cmdlet **Set-AzSqlElasticPoolAdvisorAutoExecuteStatus** imposta la proprietà di esecuzione automatica per un consulente SQL pool flessibile di Azure.
...
Questo comando imposta lo stato di esecuzione automatica di un consulente denominato CreateIndex su abilitato.

## PARAMETERS

### -AdvisorName
Specifica il nome dell'consulente per cui questo cmdlet aggiorna lo stato di esecuzione automatica.
