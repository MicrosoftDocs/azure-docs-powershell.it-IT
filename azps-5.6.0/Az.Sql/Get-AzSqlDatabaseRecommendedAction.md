...
## DESCRIZIONE
Il **cmdlet Get-AzSqlDatabaseRecommendedAction** ottiene una o più azioni consigliate per un'utilità di SQL database di Azure.
...
Questo comando ottiene un elenco di tutte le azioni consigliate dell'consulente denominato CreateIndex disponibile per il database denominato wi-runner-australia-east.
...
Questo comando recupera l'azione consigliata IR_ \[ test_schema \] _ \[ test_table_0.0361551 _6C7AE8CC9C87E7FD5893 per l'consulente \] denominato CreateIndex.
...
### -DatabaseName
Specifica il nome del database per cui questo cmdlet richiede le azioni consigliate.
