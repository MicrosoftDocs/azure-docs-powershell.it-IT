...
### Esempio 3: Ottenere un membro member member di member member
```powershell
...
Questo comando recupera un membro di base in un gruppo di risorse.

### Esempio 4: Ottenere un membro member member di member member
```powershell
