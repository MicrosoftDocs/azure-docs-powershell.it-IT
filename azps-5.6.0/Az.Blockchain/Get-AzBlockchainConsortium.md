...
### Esempio 1: Creare un consorzio Dieresi.
```powershell
PS C:\> Get-AzBlockchainConsortium -Location eastus

```

Questo comando elenca i consorzi nell'ambito di una sottoscrizione per una località specifica.
...
### Microsoft.Azure.PowerShell.Cmdlets.Gateway.Models.Api20180601Preview.IConsortium
