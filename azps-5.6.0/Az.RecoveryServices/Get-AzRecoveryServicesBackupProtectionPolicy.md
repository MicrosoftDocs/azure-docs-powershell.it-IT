...
## DESCRIZIONE
Il cmdlet **Get-AzRecoveryServicesBackupProtectionPolicy** ottiene i criteri di protezione di Azure Backup per un vault.
...
Questo comando recupera tutti i criteri di protezione creati nel Vault.
...
Questo comando recupera il criterio di protezione denominato DefaultPolicy e quindi lo archivia nella $Pol variabile.

## PARAMETERS

### -BackupManagementType
Classe di risorse protetta. Attualmente i valori supportati per questo cmdlet sono AzureVM, AzureStorage, AzureWorkload
...
### -WorkloadType
Tipo di carico di lavoro della risorsa. I valori correnti supportati sono AzureVM, AzureFiles, MSSQL
