...
Il primo comando recupera l'oggetto vault in base a vaultName. Il secondo comando recupera la data di sette giorni fa e quindi la archivia nella $StartDate variabile.
