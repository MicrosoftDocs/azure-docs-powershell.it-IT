...
## DESCRIZIONE
Il cmdlet **Get-AzRecoveryServicesAsrReplicationProtectedItem** ottiene le proprietà di tutti gli elementi protetti dalla replica ASR o dell'elemento specificato dal contenitore di protezione ASR specificato.
...
Elenco di tutti gli elementi protetti da replica nel contenitore di protezione ASR specificato.

### Esempio 2

Ottiene le proprietà di elementi protetti da replica di Azure Site Recovery. (autogenerati)
...
### -FriendlyName
Specifica il nome descrittivo dell'elemento protetto da replica da ottenere.
...
### -Name
Specifica il nome dell'elemento protetto da replica da ottenere.
...
### -ProtectableItem
Specifica un oggetto elemento protetto da ASR. Il cmdlet ottiene l'elemento protetto da replica ASR corrispondente all'elemento protetto da ASR specificato, se l'elemento è protetto.
