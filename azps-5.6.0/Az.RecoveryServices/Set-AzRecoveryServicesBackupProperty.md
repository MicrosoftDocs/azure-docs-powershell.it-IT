...
## DESCRIZIONE
Il cmdlet **Set-AzRecoveryServicesBackupProperty** imposta le proprietà di archiviazione di backup per un vault dei servizi di ripristino.
...
Il primo comando recupera il vault denominato TestVault e quindi lo archivia nella variabile $Vault 01.
