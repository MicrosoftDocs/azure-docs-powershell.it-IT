...
### Registra (impostazione predefinita)
```
...
Il cmdlet registra una macchina virtuale di Azure come contenitore per il carico di lavoro MSSQL.
...
### -Force
Forzare la registrazione del contenitore (impedisce la finestra di dialogo di conferma). Questo parametro è facoltativo.
...
### -WorkloadType
Tipo di carico di lavoro della risorsa. Il valore corrente supportato è AzureVM, WindowsServer, AzureFiles, MSSQL
