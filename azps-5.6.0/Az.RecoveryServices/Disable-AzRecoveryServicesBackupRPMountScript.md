...
## DESCRIZIONE
Il cmdlet Disable-AzRecoveryServicesBackupRPMountScript rimuovere i file del punto di ripristino che sono stati montati in precedenza con il cmdlet Get-AzRecoveryServicesBackupRPMountScript.

## ESEMPI

### Esempio 1: Dismount a recovery point
```powershell
...
Importo di tutti i file del punto di ripristino. (autogenerati)
