...
## SYNOPSIS
Rimuove i dischi dall'elemento protetto da replica.
...
## DESCRIZIONE
Il cmdlet **Remove-AzRecoveryServicesAsrReplicationProtectedItemDisk** rimuove il disco dall'elemento protetto da replica ASR.
...
Avviare l'operazione di rimozione del disco specificato dalla macchina virtuale di protezione per il disco non danneggiato.
...
Avviare l'operazione per rimuovere il disco specificato dalla macchina virtuale di protezione per il disco gestito.
...
Avvia l'operazione di rimozione del disco specificato e restituisce il processo ASR usato per tenere traccia dell'operazione di rimozione del disco protetto.
...
### -DiskId
Specifica l'elenco di ID disco gestiti.
...
### -InputObject
Oggetto di input per il cmdlet: oggetto elemento protetto da replica ASR corrispondente al disco da rimuovere.
