...
Questo comando consente agli utenti di proteggere automaticamente tutti i database db non protetti esistenti e quelli che verranno aggiunti in un secondo momento con il criterio specificato. (autogenerati)
...
### -InputItem
Specifica l'oggetto elemento proteggibile che può essere passato come input. Il valore corrente supportato è un oggetto protectableItem di tipo "SQLInstance". 
