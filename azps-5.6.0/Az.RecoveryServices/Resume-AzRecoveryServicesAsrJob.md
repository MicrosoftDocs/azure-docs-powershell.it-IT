...
## DESCRIZIONE
Il cmdlet **Resume-AzRecoveryServicesAsrJob** riprende un processo sospeso di Azure Site Recovery.
...
Riprendere il processo specificato se è in stato di attesa o sospeso e restituire l'oggetto processo ASR aggiornato corrispondente al processo ASR.

## PARAMETERS

### -Comment
Commenti per il log di processo.
...
### -InputObject
Oggetto di input per il cmdlet: oggetto Processo ASR corrispondente al processo da riprendere.
