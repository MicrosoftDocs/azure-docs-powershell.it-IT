...
## SYNOPSIS
Ottiene informazioni sulle reti gestite da Ripristino siti per il vault corrente.
...
## DESCRIZIONE
Il cmdlet **Get-AzRecoveryServicesAsrNetwork** ottiene informazioni sulle reti di Ripristino siti di Azure per l'attuale vault di Azure Site Recovery.
...
Recupera tutte le reti note nel tessuto specificato.
