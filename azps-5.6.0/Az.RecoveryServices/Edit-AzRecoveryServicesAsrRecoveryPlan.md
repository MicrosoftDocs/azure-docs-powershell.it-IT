...
Modifica un piano di ripristino del sito. (autogenerati)
...
### -InputObject
Oggetto piano di ripristino asr da modificare (in operazione in memoria. Per aggiornare il piano di ripristino, esegui Update-AzASRRecoveryPlan con l'oggetto del piano di ripristino modificato.
