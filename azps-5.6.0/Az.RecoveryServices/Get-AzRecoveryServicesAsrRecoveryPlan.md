...
### -Path
Specifica il percorso del file in cui questo cmdlet salva la definizione json del piano di ripristino. La definizione json può essere modificata per modificare il piano di ripristino e usata per aggiornare il piano di ripristino tramite il cmdlet Update-AzRecoveryServicesASRRecoveryPlan
