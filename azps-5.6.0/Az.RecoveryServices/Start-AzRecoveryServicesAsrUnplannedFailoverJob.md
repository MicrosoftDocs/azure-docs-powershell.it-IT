...
È possibile verificare se il processo ha avuto esito positivo usando il cmdlet Get-AzRecoveryServicesAsrJob processo.
...
Avvia un'operazione di failover non pianificata. (autogenerati)
