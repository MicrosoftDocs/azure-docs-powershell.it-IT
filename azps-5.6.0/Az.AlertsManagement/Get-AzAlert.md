...
## DESCRIZIONE
Il cmdlet **Get-AzAlert ottiene** le istanze di avvisi di avviso di avviso.
...
Elencare tutti gli avvisi con gravità sev2 e condizione di monitor monitor smersi. Se si imposta IncludeContext su true, includere il payload personalizzato dell'avviso.
...
Ottieni informazioni sugli avvisi. (autogenerati)
