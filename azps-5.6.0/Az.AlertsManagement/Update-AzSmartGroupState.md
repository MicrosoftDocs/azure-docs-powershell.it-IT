...
## SYNOPSIS
Aggiorna lo stato smart del gruppo
...
## DESCRIZIONE
Il cmdlet **Update-AzSmartGroupState** aggiorna lo stato smart group.
...
Questo cmdlet aggiorna lo stato del gruppo smart ad Acknowleged.
...
### -SmartGroupId
Identificatore univoco di gruppo intelligente/ID risorsa del gruppo intelligente.
...
### -State
Stato del gruppo smart aggiornato
