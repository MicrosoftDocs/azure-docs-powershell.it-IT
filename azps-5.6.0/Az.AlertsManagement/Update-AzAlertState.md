...
## SYNOPSIS
Aggiorna lo stato di avviso

## SINTASSI

### ByAlertId (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Update-AzAlertState** aggiorna lo stato di avviso.
...
Questo cmdlet aggiorna lo stato dell'avviso in Chiuso.
