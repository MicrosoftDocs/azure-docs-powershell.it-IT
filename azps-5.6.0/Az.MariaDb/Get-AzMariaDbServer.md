...
### Esempio 1: Elencare tutte le mariaDB sotto un abbonamento
```powershell
...
Questo comando elenca tutti i database di MariaDB sotto un abbonamento.

### Esempio 2: Elencare tutte le mariaDB in un gruppo di risorse
```powershell
...
Questo comando elenca tutte le mariaDB in un gruppo di risorse.

### Esempio 3: Ottenere un database di MariaDB
```powershell
...
Questo comando ottiene un oggetto Db.
