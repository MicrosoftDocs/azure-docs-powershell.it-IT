...
### Esempio 1: Aggiornare la regola del firewall MariaDB
```powershell
...
### Esempio 2: Aggiornare la regola del firewall MariaDB in base all'identità.
```powershell
...
### Esempio 3: Aggiornare la regola del firewall MariaDB per -ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/mariadb-test-qu5ov0/providers/Microsoft.DBforMariaDB/servers/mariadb-test-4rmtig/firewallRules/fr-cfgl3y"
...
Il cmdlet aggiorna la regola del firewall MariaDB per -ClientIPAddress.
