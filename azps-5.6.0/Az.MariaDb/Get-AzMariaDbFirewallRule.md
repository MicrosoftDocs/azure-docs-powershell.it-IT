...
### Esempio 1: Elencare tutte le regole del firewall in un database di MariaDB
```powershell
...
Questo comando elenca tutte le regole del girewall in un database di MariaDB.

### Esempio 2: Ottenere una regola del firewall in un database di MariaDB
```powershell
...
Questo comando ottiene una regola del firewall in un database di MariaDB.
