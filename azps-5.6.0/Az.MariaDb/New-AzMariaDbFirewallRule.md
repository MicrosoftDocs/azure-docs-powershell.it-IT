...
### Esempio 1: Creare una regola del firewall in un database di MariaDB
```powershell
...
Questo comando crea una regola del firewall in un database di MariaDB.

### Esempio 2: Creare una nuova regola del firewall MariaDB usando -ClientIPAddress.
```powershell
...
Questo cmdlet crea una regola del firewall MariaDB usando -ClientIPAddress.

### Esempio 3: Creare una nuova regola firewall MariaDB per consentire tutti gli IP
```powershell
...
Questo cmdlet crea una nuova regola del firewall MariaDB per consentire tutti gli IP.
