...
### Esempio 1: Elencare tutte le regole di rete virtuale in un database di MariaDB
```powershell
...
Questo comando elenca tutte le regole di rete virtuale in un database di MariaDB.

### Esempio 2: Ottenere una regola di rete virtuale in un database di MariaDB
```powershell
...
Questo comando recupera la regola della rete virtuale in un database di MariaDB.
