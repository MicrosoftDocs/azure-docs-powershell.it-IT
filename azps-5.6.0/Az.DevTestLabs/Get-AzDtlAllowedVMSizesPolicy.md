...
## DESCRIZIONE
Il cmdlet **Get-AzDtlAllowedVMSizesPolicy** ottiene il criterio di dimensioni delle macchine virtuali consentite, che consente di specificare un elenco delle dimensioni di macchine virtuali consentite nel lab.
