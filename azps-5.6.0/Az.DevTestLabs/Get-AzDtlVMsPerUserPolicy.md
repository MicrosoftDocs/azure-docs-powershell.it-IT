...
## DESCRIZIONE
Il cmdlet **Get-AzDtlVMsPerUserPolicy** ottiene le macchine virtuali per criterio utente di un lab, che consente di impostare il numero massimo di macchine virtuali consentite per ogni utente.
Il cmdlet restituisce lo stato abilitato o disabilitato del criterio e il numero massimo di macchine virtuali consentito per ogni utente che è stato impostato nel criterio.
...
### -LabName
Specifica il nome del lab per cui questo cmdlet ottiene la macchina virtuale per ogni criterio utente.
