...
## DESCRIZIONE
Il cmdlet **Set-AzDtlVMsPerLabPolicy** imposta le macchine virtuali per criterio lab di un lab, che imposta il numero totale di macchine virtuali consentite in un lab.
...
### -LabName
Specifica il nome del lab per cui questo cmdlet imposta le macchine virtuali per ogni criterio lab.
