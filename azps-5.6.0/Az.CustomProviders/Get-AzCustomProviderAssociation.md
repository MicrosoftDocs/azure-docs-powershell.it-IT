...
### Esempio 1: Elencare le associazioni di provider personalizzate
```powershell
...
Elencare tutte le associazioni di provider personalizzate per un determinato ambito.
...
Ottenere i dettagli per una singola associazione CustomProvider
...
INPUTOBJECT <ICustomProvidersIdentity> : parametro Identity
  ...
  - `[SubscriptionId <String>]`: ID sottoscrizione di Azure. Stringa in formato GUID, ad esempio 00000000-0000-0000-0000-0000-00000000000000
