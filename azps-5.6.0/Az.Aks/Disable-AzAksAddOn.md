...
## SYNOPSIS
Disabilitare i componenti aggiuntivi per gli aks.
...
Disabilitare i `HttpApplicationRouting` componenti `Monitoring` `AzurePolicy` aggiuntivi, , e per gli `VirtualNode` `KubeDashboard` aks.
