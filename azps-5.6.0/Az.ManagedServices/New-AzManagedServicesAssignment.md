...
Aggiorna un'assegnazione di registrazione con un nome e un identificatore di definizione di registrazione.
...
Oggetto di input della definizione di registrazione.
...
ID di risorsa completo della definizione di registrazione.
