...
Crea una definizione di registrazione per i valori roleDefinitionId e principalId specificati direttamente.
...
Crea o aggiorna una definizione di registrazione con i dettagli di autorizzazione.
...
Aggiorna una definizione di registrazione con i dettagli di autorizzazione e il nome della definizione di registrazione.
...
### -PrincipalId
Identificatore dell'entità ManagedBy.
...
### -RoleDefinitionId
L'identificatore della definizione di ruolo per concedere le autorizzazioni all'identificatore dell'entità.
