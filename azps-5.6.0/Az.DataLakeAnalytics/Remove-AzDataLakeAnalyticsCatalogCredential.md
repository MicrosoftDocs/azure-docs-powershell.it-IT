...
## DESCRIZIONE
Il Remove-AzDataLakeAnalyticsCatalogCredential cmdlet elimina le credenziali del catalogo di Azure Data Lake Analytics.

## ESEMPI

### Esempio 1: Rimuovere le credenziali
```
...
Questo comando rimuove le credenziali del catalogo di Data Lake Analytics specificate.
...
### -Name
Specifica il nome delle credenziali.
...
### -PassThru
Indica che questo cmdlet non attende il completamento dell'operazione.
...
### -Password
La password per le credenziali.
Questa operazione è necessaria se il chiamante non è il proprietario dell'account.
...
### -Ricorrenza
Indica che l'operazione di eliminazione deve essere completata ed eliminare anche tutte le risorse che dipendono da queste credenziali.
