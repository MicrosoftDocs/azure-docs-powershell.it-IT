...
### -MaxAnalyticsUnits
Le unità di analisi massime supportate facoltative con cui aggiornare l'account.
...
### -QueryStoreRetention
Numero facoltativo di giorni per cui i metadati del processo vengono conservati per essere impostati nell'account.
...
### -Tag
Stringa, dizionario stringa di tag associati all'account che deve sostituire il set di tag corrente
