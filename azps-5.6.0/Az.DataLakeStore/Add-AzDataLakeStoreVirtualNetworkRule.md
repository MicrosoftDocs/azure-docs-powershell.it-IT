...
## DESCRIZIONE
Il cmdlet **Add-AzDataLakeStoreVirtualNetworkRule** aggiunge una regola di rete virtuale all'account Data Lake Store specificato.
...
Viene creata una nuova regola di rete virtuale denominata "myVNET" nell'account "dls" con un ID subnet "testId"

## PARAMETERS

### -Account
Account Data Lake Store a cui aggiungere la regola di rete virtuale
