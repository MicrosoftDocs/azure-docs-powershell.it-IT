...
Questo comando recupera il contenuto del file MyFile.txt'account ContosoADL.
...
Questo comando separa le prime due righe separate da righe nel file MyFile.txt nell'account ContosoADL.
...
### -Head
Il numero di righe (nuove righe delimitate) dall'inizio del file per l'anteprima. Se nei primi 4 mb di dati non viene rilevata alcuna nuova riga, verranno restituiti solo questi dati.
...
### -Path
Specifica il percorso Data Lake Store di un file, a partire dalla directory radice (/).
...
### -Tail
Il numero di righe (nuove righe delimitate) dalla fine del file per l'anteprima. Se nei primi 4 mb di dati non viene rilevata alcuna nuova riga, verranno restituiti solo questi dati.
