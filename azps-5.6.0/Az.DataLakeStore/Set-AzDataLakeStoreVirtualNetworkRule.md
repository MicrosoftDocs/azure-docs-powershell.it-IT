...
## DESCRIZIONE
Il cmdlet **Set-AzDataLakeStoreVirtualNetworkRule** modifica la regola di rete virtuale specificata nel data lake store specificato.
...
### -Account
Account Data Lake Store in cui aggiornare la regola di rete virtuale in
