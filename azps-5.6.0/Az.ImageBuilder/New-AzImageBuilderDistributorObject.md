...
### Esempio 3: Creare un distributore di immagini condiviso
```powershell
...
Questo comando crea un distributore di immagini condiviso.

## PARAMETERS

### -ArtifactTag
Tag che verranno applicati all'elemento dopo che è stato creato/aggiornato dal distributore.
...
### -ExcludeFromLatest
Contrassegno che indica se la versione dell'immagine creata deve essere esclusa dalla versione più recente.
Ometti di usare il valore predefinito (false).
...
### -GalleryImageId
ID risorsa dell'immagine raccolta immagini condivise.
...
Distribuisci come immagine disco gestito.
...
### -ReplicaRegione
Elenco di aree geografiche in cui verrà replicata l'immagine.
...
### -RunOutputName
Nome da usare per il runOutput associato.
...
### -SharedImageDistributor
Distribuisci tramite raccolta immagini condivisa.
...
Ometti di usare il valore predefinito (Standard_LRS).
...
### Microsoft.Azure.PowerShell.Cmdlets.ImageMag.Models.Api20200214.IImageTemplateDistributor
