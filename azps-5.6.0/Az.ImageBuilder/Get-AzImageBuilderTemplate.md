...
## SYNOPSIS
Ottenere informazioni su un modello di immagine di una macchina virtuale
...
### Esempio 1: Elencare tutto il modello in un abbonamento
```powershell
...
Questo comando elenca tutti i modelli di un abbonamento.

### Esempio 2: Elencare tutto il modello in un gruppo di risorse
```powershell
...
Questo comando elenca tutti i modelli in un gruppo di risorse.

### Esempio 3: Ottenere un modello in un gruppo di risorse
```powershell
...
Questo comando recupera un modello in un gruppo di risorse.

### Esempio 4: Ottenere un modello in un gruppo di risorse
```powershell
...
### Microsoft.Azure.PowerShell.Cmdlets.ImageMag.Models.IImageImageImageIdentity
