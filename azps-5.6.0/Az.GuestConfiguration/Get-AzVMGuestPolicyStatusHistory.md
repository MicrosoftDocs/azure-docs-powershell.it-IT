...
## DESCRIZIONE
Il cmdlet Get-AzVMGuestPolicyStatusHistory la cronologia dello stato di conformità dei criteri di configurazione guest per un'iniziativa di tipo "Configurazione guest" assegnata a una macchina virtuale.
Un'iniziativa è una politica di definizione di tipo "Iniziativa".
