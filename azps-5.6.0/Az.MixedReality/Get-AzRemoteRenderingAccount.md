...
## SYNOPSIS
Ottenere l'account per il rendering remoto
...
Elencare tutti gli account per il rendering remoto nel gruppo di risorse "rg1". 
...
Ottenere l'account di rendering remoto "example" nel gruppo di risorse "rg1". 
