...
Nome del contesto di Azure predefinito per questo accesso. Per altre informazioni sui contesti di Azure, vedere [gli oggetti di contesto di Azure PowerShell.](/powershell/azure/context-persistence)
