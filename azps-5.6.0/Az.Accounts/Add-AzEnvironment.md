...
Specifica il gruppo di destinatari per token che autenticano le richieste agli endpoint di Gestione risorse o Gestione servizi (RDFE) di Azure.
...
### -AzureDataLakeStoreFileSystemEndpointSuffix
Suffisso Dns del fileSystem Azure Data Lake Store. Esempio: azuredatalake.net
...
### -AzureOperationalInsightsEndpointResourceId
Destinatari per l'autenticazione dei token con l'API di Analisi log di Azure.
...
### -PublishSettingsFileUrl
Specifica l'URL da cui è possibile scaricare i file con estensione publishsettings.
