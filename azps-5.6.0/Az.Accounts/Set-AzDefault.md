...
## DESCRIZIONE
Il Set-AzDefault cmdlet aggiunge o modifica le impostazioni predefinite nel contesto corrente.
...
Questo comando imposta il gruppo di risorse predefinito sul gruppo di risorse specificato dall'utente.
...
### -Force
Creare un nuovo gruppo di risorse se il valore predefinito specificato non esiste
