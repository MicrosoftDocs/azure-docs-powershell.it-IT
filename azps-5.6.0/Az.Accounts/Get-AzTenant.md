...
## DESCRIZIONE
Il Get-AzTenant cmdlet ottiene i tenant autorizzati per l'utente corrente.

## ESEMPI

### Esempio 1: Ottenere tutti i tenant
```
...
Questo esempio mostra come ottenere un tenant autorizzato specifico di un account azure.
...
### -TenantId
Specifica l'ID del tenant che riceve questo cmdlet.
