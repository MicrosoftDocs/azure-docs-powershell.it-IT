...
Prima di tutto è necessario creare un oggetto Percorso hub virtuale e usarlo per creare una risorsa Tabella percorso hub virtuale. Quindi, si imposta la risorsa tabella di route sull'hub virtuale usando il comando Set-AzVirtualHub route.
