...
## DESCRIZIONE
Il cmdlet **New-AzVirtualNetworkSubnetConfig crea** una configurazione subnet della rete virtuale.

## ESEMPI

### Esempio 1: Creare una rete virtuale con due subnet e un gruppo di sicurezza di rete
```powershell
...
Questo esempio crea due nuove configurazioni di subnet usando il cmdlet New-AzVirtualSubnetConfig e quindi le usa per creare una rete virtuale. Il New-AzVirtualSubnetConfig di rete crea solo una rappresentazione in memoria della subnet. In questo esempio frontendSubnet include il codice CIDR 10.0.1.0/24 e fa riferimento a un gruppo di sicurezza di rete che consente l'accesso RDP. Il backendSubnet ha CIDR 10.0.2.0/24 e fa riferimento allo stesso gruppo di sicurezza di rete.
...
### -InputObject
Specifica il gateway NAT associato alla configurazione subnet
...
### -Name
Specifica il nome della configurazione subnet da creare.
...
### -RouteTable
Specifica la tabella di route associata alla configurazione della subnet.
...
### -RouteTableId
Specifica l'ID della tabella di route associata alla configurazione della subnet.
