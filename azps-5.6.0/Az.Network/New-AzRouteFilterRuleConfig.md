...
## DESCRIZIONE
Il cmdlet New-AzRouteFilterRuleConfig crea una regola di filtro delle route per un filtro delle route di Azure.
...
Il comando crea una nuova regola di filtro delle route e la archivia in $rule 1.

## PARAMETERS

### -Access
Accesso per la regola di filtro delle route.
I valori validi sono Consenti o Nega.
...
### -Name
Specifica un nome per la regola di filtro delle route.
...
### -RouteFilterRuleType
Tipo di regola del filtro della route.
