...
## DESCRIZIONE
New-AzNetworkWatcherConnectionMonitorEndpointObject cmdlet crea l'endpoint del monitor di connessione.
...
Nome : workspaceEndpoint Type : MMAWorkspaceMachine ResourceId : /subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace Address : Scope : { "Include": [ { "Address": "WIN-P0HGNDO2S1B" } ] } }

## PARAMETERS

### -Address
Indirizzo dell'endpoint del monitor di connessione (IP o nome di dominio).
...
### -AzureSubnet
Passaggio all'endpoint della subnet di Azure.
...
### -AzureVM
Parametro dell'endpoint della macchina virtuale di Azure.
...
### -AzureVNet
Passaggio all'endpoint Azure Vnet.
...
### -CoverageLevel
Copertura del test per l'endpoint.
I valori supportati sono Default, Low, BelowAverage, Average, AboveAvergae, Full.
...
### -ExcludeItem
Elenco degli elementi da escludere dall'ambito dell'endpoint.
...
### -ExternalAddress
Parametro endpoint Indirizzo esterno.
...
### -IncludeItem
Elenco degli elementi da includere nell'ambito end scope.
...
### -MMAWorkspaceMachine
Parametro endpoint MMA Workspace Machine.
...
### -MMAWorkspaceNetwork
Passaggio endpoint rete area di lavoro MMA.
...
### -Name
Nome dell'endpoint del monitor di connessione.
...
### -ResourceId
ID risorsa dell'endpoint del monitor di connessione.
