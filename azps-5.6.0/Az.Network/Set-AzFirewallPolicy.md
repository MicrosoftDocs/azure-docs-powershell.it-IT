...
## DESCRIZIONE
Il cmdlet **Set-AzFirewallPolicy** aggiorna un criterio del firewall di Azure.
...
Questo esempio imposta il criterio del firewall con il nuovo valore del criterio firewall
...
Questo esempio imposta i criteri del firewall con la nuova modalità Threat Intel
...
Questo esempio imposta i criteri del firewall con la nuova minaccia intel whitelist
