...
Questo comando crea un nuovo tag IP con tagtype come "FirstPartyUsage" e tag like "/Sql". Viene usato nella creazione di publicIpAddress con questi tag specifici per l'allocazione.
