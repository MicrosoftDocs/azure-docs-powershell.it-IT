...
## DESCRIZIONE
Il cmdlet **Set-AzVirtualNetworkGatewayConnection** configura una connessione a un gateway di rete virtuale.
...
### Esempio 2: Aggiungere/aggiornare tag a un'istanza esistente di VirtualNetworkGatewayConnection
```
$conn = Get-AzVirtualNetworkGatewayConnection -Name 1 -ResourceGroupName myRG
...
### -EnableBgp
Se usare una sessione BGP su un tunnel VPN S2S
...
### -ConnectionMode
Modalità connessione Gateway di rete virtuale
...
Se usare selettori del traffico basati su criteri per una connessione S2S
...
Specifica l'oggetto PSVirtualNetworkGatewayConnection che questo cmdlet usa per modificare la connessione al gateway di rete virtuale.
