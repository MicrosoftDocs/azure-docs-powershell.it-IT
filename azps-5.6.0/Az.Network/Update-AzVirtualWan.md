...
La procedura precedente consente di creare un gruppo di risorse "testRG" nell'area "Stati Uniti occidentali" e una WAN virtuale di Azure in tale gruppo di risorse in Azure. VirtualWan viene aggiornato con nuove proprietà.
...
### -InputObject
L'oggetto Wan virtuale da modificare
