...
- Indirizzi IP pubblici: indirizzi IP privati che usano il bilanciamento del carico interno (ILB, Internal Load Balancing).
...
Il secondo comando usa $PublicIP per creare una nuova configurazione IP front-end denominata FrontEndIP01 e la archivia nella variabile $FrontEnd iniziale.
...
Se si specifica il *parametro Subnet,* significa che il gateway usa un indirizzo IP privato.
