...
## DESCRIZIONE
Il cmdlet **Get-AzNetworkInterfaceTapConfig** ottiene una configurazione di Azure Tap per un determinato gruppo di risorse, un'interfaccia di rete e un nome di configurazione o un elenco di configurazioni di tocco in un gruppo di risorse e un'interfaccia di rete.
...
Questo comando viene aggiunto alla configurazione tocco specifica per l'interfaccia di rete specificata.
