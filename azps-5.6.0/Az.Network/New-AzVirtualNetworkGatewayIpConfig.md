...
## DESCRIZIONE
Il cmdlet **New-AzVirtualNetworkGatewayIpConfig** crea una configurazione assegnata a un Gateway di rete virtuale con un indirizzo IP pubblico (creato in precedenza) in base all'ID subnet.
