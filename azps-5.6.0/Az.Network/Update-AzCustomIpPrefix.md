...
## SYNOPSIS
Aggiorna un formato CustomIpPrefix
...
## DESCRIZIONE
Il cmdlet **Update-AzCustomIpPrefix** consente all'utente di commissionare o rimuovere il proprio nome CustomIpPrefix oppure di modificare i tag della risorsa.

## ESEMPI

### Esempio 1: Commissione del suffisso CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Commission
```

Il comando precedente avvia il processo di commissioning di CustomIpPrefix.

### Esempio 2: Rimuovere lo strumento CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Decommission
```

Il comando precedente avvia il processo di de-commissioning di CustomIpPrefix.

### Esempio 3: Tag di aggiornamento per CustomIpPrefix
```powershell
PS C:\> Update-AzCustomIpPrefix -Name $prefixName -ResourceGroupName $rgName -Tag $tags
```

Il comando precedente aggiornerà i tag per CustomIpPrefix.
...
### -InputObject
Lo strumento CustomIpPrefix da impostare.
