...
## DESCRIZIONE
Il cmdlet **New-AzServiceEndpointPolicy** crea un criterio dell'endpoint del servizio.

## ESEMPI

### Esempio 1: Crea un criterio endpoint di servizio
```
$serviceEndpointPolicy = New-AzServiceEndpointPolicy -Name "Policy1" -ServiceEndpointPolicyDefinition $serviceEndpointDefinition -Location "location";
```

Questo comando crea un criterio endpoint di servizio denominato Criterio1 con le definizioni definite dall'oggetto $serviceEndpointDefinition e lo archivia nella variabile $serviceEndpointPolicy servizio.
...
Elenco delle definizioni degli endpoint del servizio
