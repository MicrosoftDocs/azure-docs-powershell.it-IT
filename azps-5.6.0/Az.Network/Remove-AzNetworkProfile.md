...
## DESCRIZIONE
Il cmdlet **Remove-AzNetworkProfile** rimuove un profilo di rete se non sono state create interfacce di rete dei contenitori, a differenza di una configurazione dell'interfaccia di rete dei contenitori.
...
Verrà rimosso il profilo di rete con nome np1 dal gruppo di risorse rg1.
...
### -ResourceId
ID risorsa di Gestione risorse di Azure del profilo di rete.
