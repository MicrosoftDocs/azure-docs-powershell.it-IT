...
Questo comando rimuove un criterio endpoint di servizio con nome PolicyDef1
...
### -InputObject
Oggetto definizione dei criteri dell'endpoint del servizio.
...
### -Name
Nome della definizione dell'endpoint del servizio
...
### -ResourceId
ID della definizione dell'endpoint del servizio.
