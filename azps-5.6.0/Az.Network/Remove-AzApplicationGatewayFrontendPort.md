...
## DESCRIZIONE
Il cmdlet **Remove-AzApplicationGatewayFrontendPort** rimuove una porta front-end da un gateway applicazione di Azure.

## ESEMPI

### Esempio: Rimuovere una porta front-end da un gateway applicazioni
```
PS C:\>$AppGw = Get-AzApplicationGateway -Name "ApplicationGateway01" -ResourceGroupName "ResourceGroup01"
PS C:\> Remove-AzApplicationGatewayFrontendPort -ApplicationGateway $AppGw -Name "FrontEndPort02"
```

Il primo comando ottiene un gateway applicazione denominato ApplicationGateway01 che appartiene al gruppo di risorse denominato ResourceGroup01 e archivia il gateway in $AppGw variabile.
Il secondo comando rimuove la porta denominata FrontEndPort02 dal gateway applicazione.

## PARAMETERS

### -ApplicationGateway
Specifica il gateway applicazione da cui rimuovere una porta front-end.
