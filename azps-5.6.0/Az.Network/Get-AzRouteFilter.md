...
## DESCRIZIONE
Il cmdlet **Get-AzRouteFilter** ottiene un filtro delle route.
...
Questo comando recupera il filtro della route denominato RouteFilter01 che appartiene al gruppo di risorse denominato ResourceGroup01.
...
Questo comando recupera tutti i filtri di route che iniziano con "RouteFilter".
