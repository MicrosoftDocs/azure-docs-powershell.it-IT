...
ExpressRouteGateway si posizionerà nella stessa posizione del virtualhub a cui si fa riferimento.
...
### -MinScaleUnits
Numero minimo di unità di scala per questo ExpressRouteGateway. Intervallo valido > 2
