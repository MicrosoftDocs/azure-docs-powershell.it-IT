...
## DESCRIZIONE
Il New-AzNetworkWatcherNetworkConfigurationDiagnosticProfile cmdlet crea un nuovo oggetto profilo di diagnostica. Questo oggetto viene usato per limitare la configurazione di rete durante una sessione di diagnostica della configurazione di rete usando i criteri specificati.
