...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayFrontendPort** aggiunge una porta front-end a un gateway applicazione.
...
Il secondo comando aggiunge la porta 80 come porta front-end per il gateway applicazione archiviata in $AppGw e la porta FrontEndPort01.

## PARAMETERS

### -ApplicationGateway
Specifica il gateway applicazione a cui questo cmdlet aggiunge una porta front-end.
