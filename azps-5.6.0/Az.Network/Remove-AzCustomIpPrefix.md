...
## SYNOPSIS
Rimuove un suffisso CustomIpPrefix
...
## DESCRIZIONE
Il cmdlet **Remove-AzCustomIpPrefix** rimuove un suffisso CustomIpPrefix.
...
Rimuove lo strumento CustomIpPrefix con nome $prefixName gruppo di risorse $rgName
