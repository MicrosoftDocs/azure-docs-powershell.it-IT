...
## SYNOPSIS
Crea una risorsa tabella delle route hub associata a un virtualhub.
...
## DESCRIZIONE
Crea la tabella di route specificata associata all'hub virtuale specificato con le route e le etichette specificate.
...
Questo comando crea una tabella della route hub dell'hub virtuale.
...
### -ParentResourceId
ID della risorsa dell'hub virtuale.
