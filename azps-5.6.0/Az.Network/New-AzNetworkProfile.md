...
Viene creata una nuova risorsa di primo livello del profilo di rete

### Esempio 2

Crea un nuovo profilo di rete. (autogenerati)
...
### -ContainerNicConfig
Le configurazioni dell'interfaccia di rete dei contenitori da aggiungere a questo profilo di rete.
