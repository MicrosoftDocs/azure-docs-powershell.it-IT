...
## SYNOPSIS
Recupera una risorsa della tabella delle route dell'hub associata a un virtualhub.
...
## DESCRIZIONE
Ottiene la tabella delle route dell'hub specificata associata all'hub virtuale specificato.
...
Questo comando recupera la tabella delle route dell'hub virtuale.
...
Questo comando elenca tutte le tabelle delle route dell'hub in VirtualHub specificato.
...
### -ParentObject
Oggetto hub virtuale padre della risorsa.
...
### -ResourceId
ID risorsa della risorsa vhubroutetable per Ottenere.
