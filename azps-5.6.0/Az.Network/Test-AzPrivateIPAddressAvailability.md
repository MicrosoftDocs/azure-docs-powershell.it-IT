...
Questo cmdlet restituisce un elenco di indirizzi IP privati disponibili se viene restituito l'indirizzo IP privato richiesto.

## ESEMPI

### Esempio 1: Verificare se un indirizzo IP è disponibile usando la pipeline
```
PS C:\>Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $rgname | Test-AzPrivateIPAddressAvailability -IPAddress "10.0.1.10"
```

Questo comando ottiene una rete virtuale e usa l'operatore della pipeline per passare la rete **a Test-AzPrivateIPAddressAvailability,** che verifica se l'indirizzo IP privato specificato è disponibile.
