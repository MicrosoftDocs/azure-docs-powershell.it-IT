...
## DESCRIZIONE
Il cmdlet **Get-AzAvailableServiceDelegation** consente di recuperare tutte le delegazioni del servizio disponibili per una subnet nella posizione specificata. Questo cmdlet non *descrive* le delegazioni che possono coesistere in una singola subnet.

## ESEMPI

### 1: Ottenere tutte le delegazioni dei servizi disponibili
```powershell
