...
## DESCRIZIONE
Il cmdlet **Get-AzPrivateDnsZoneGroup** ottiene uno o più gruppi di zona DNS privati.

## ESEMPI

### Esempio 1: Recuperare un gruppo di zona DNS privato
```powershell
...
L'esempio precedente recupera un gruppo di zona DNS privato denominato dnsgroup1 nel gruppo di risorse rg.
