...
### ByVirtualWanNameByVpnSiteIpAddress (impostazione predefinita)
```
...
Come descritto in precedenza verrà creato un gruppo di risorse, WAN virtuale negli Stati Uniti orientali, nel gruppo di risorse "nonlinkSite" in Azure. 

Viene quindi creato un sito Vpn che rappresenta un ramo del cliente e lo collega alla WAN virtuale.

È quindi possibile configurare una connessione IPSec con questo branch e una VpnGateway usando il comando New-AzVpnConnection.
...
In questo modo verrà creato un gruppo di risorse, una WAN virtuale e un sito Vpn con 1 VpnSiteLinks negli Stati Uniti orientali in un gruppo di risorse "multilink" in Azure.

### Esempio 3

Crea una nuova risorsa VpnSite di Azure. (autogenerati)
...
### -AddressSpace
Prefissi di indirizzo della rete virtuale.
...
Indirizzo peering BGP per questo sito Vpn.
...
### -BgpWeight
Peso del peering BGP per questo sito Vpn.
...
### -DeviceModel
Il modello di dispositivo del dispositivo VPN remoto.
...
### -DeviceVendor
Il fornitore del dispositivo VPN remoto.
...
### -O365Policy
Criteri di interruzione del traffico di Office 365 per questo Sito Vpn.
...
### -VirtualWan
L'account VirtualWan a cui deve essere connesso questo sito Vpn.
...
### -VirtualWanId
Il resourceId VirtualWan a cui deve essere connesso questo sito Vpn.
...
### -VirtualWanName
Nome del virtualwan a cui deve essere connesso questo sito Vpn.
...
Il nome del gruppo di risorse di VirtualWan a cui deve essere connesso questo sito Vpn.
...
### -VpnSiteLink
Elenco di VpnSiteLinks disponibili in questo sito Vpn.
