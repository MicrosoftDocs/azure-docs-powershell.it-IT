...
Il secondo comando modifica la configurazione di reindirizzamento per il gateway applicazione in modo che reindirizza il tipo Permanente e usi un URL di destinazione.

### Esempio 2

Imposta la configurazione di reindirizzamento in un Gateway applicazioni esistente. (autogenerati)
