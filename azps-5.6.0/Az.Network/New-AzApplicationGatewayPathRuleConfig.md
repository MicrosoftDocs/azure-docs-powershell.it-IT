...
Questo comando crea una regola percorso con il nome "base", i percorsi "/base", BackendAddressPool come $AddressPool, BackendHttpSettings come $HttpSettings e FirewallPolicy come $firewallPolicy.ngs e la nuova regola del percorso contenuta in queste impostazioni in ContosoApplicationGateway.
...
Ad esempio: -FirewallPolicyId "/subscriptions/<subscription-id>/resourceGroups/<resource-group-id>/providers/Microsoft.Network/ApplicationGatewayWebApplicationFirepolicies/ <firewallPolicyName> "
