...
## DESCRIZIONE
Il cmdlet **Set-AzApplicationGatewayIdentity** aggiorna un'identità assegnata al gateway applicazioni.
...
In questo esempio viene assegnata un'identità assegnata a un gateway applicazione esistente.
Nota: questa identità deve avere accesso alla chiave da cui si fa riferimento ai certificati/segreti.
