...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayWebApplicationFirewallConfiguration** crea una configurazione WAF (Web Application Firewall) per un gateway applicazione di Azure.
