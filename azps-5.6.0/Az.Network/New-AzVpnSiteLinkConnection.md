...
### -ConnectionBandwidth
Larghezza di banda che deve essere gestita da questa connessione di collegamento in mbps.
...
### -EgressNatRule
Elenco delle regole NAT in uscita associate a questa connessione di collegamento.
...
### -EnableBgp
Abilitare BGP per questa connessione di collegamento
...
### -IpSecPolicy
Criterio IpSec da considerare per questa connessione di collegamento.
...
### -SharedKey
Chiave condivisa necessaria per impostare la connessione al collegamento.
...
Usare l'indirizzo IP azure locale come ip di origine per questa connessione di collegamento.
...
Usare selettori del traffico basati su criteri per questa connessione di collegamento.
...
### -VpnSiteLink
Oggetto collegamento di sito VPN a cui connettersi.
