...
In questo modo verrà creato un gruppo di risorse, una WAN virtuale, una rete virtuale, un hub virtuale e un sito Vpn negli Stati Uniti occidentali nel gruppo di risorse "testRG" in Azure. Successivamente verrà creato un gateway VPN nell'hub virtuale con 2 unità di scala.

Una volta creato, il gateway viene connesso a VpnSite usando il comando New-AzVpnConnection>
...
In questo modo verrà creato un gruppo di risorse, una WAN virtuale, una rete virtuale, un hub virtuale e un sito Vpn con 1 VpnSiteLinks negli Stati Uniti occidentali nel gruppo di risorse "testRG" in Azure.
Successivamente verrà creato un gateway VPN nell'hub virtuale.
Una volta creato, il gateway viene connesso a VpnSite usando il comando New-AzVpnConnection con 1 VpnSiteLinkConnections a VpnSiteLink del sito Vpn.
...
La larghezza di banda che deve essere gestita da questa connessione in mbps.
...
### -EnableBgp
Abilita BGP per questa connessione
...
Abilita la sicurezza Internet per questa connessione
...
### -ParentObject
VpnGateway padre per questa connessione.
...
### -ParentResourceId
ID risorsa di VpnGateway padre per questa connessione.
...
### -SharedKey
Chiave condivisa necessaria per configurare la connessione.
...
Usare l'indirizzo IP azure locale come indirizzo di origine durante l'avvio della connessione.
...
Usare selettori del traffico basati su criteri per questa connessione.
...
### -VpnSite
Sito vpn remoto a cui è connessa questa connessione di rete virtuale dell'hub.
...
Elenco di VpnSiteLinkConnections di cui dispone questa VpnConnection.
