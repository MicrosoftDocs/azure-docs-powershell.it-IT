...
## DESCRIZIONE
Il cmdlet **New-AzFirewallPolicyThreatIntelWhitelist** crea un oggetto threat intel whitelist, che può essere usato per creare o impostare un criterio del firewall di Azure.
...
In questo esempio viene creata una lista bianca di informazioni sulle minacce che contiene un elenco di voci FQDN di una voce e un elenco indirizzi Ip di due voci
...
### -FQDN
FQDN della threat Intel Whitelist
...
### -IpAddress
Indirizzi IP della minaccia Intel Whitelist
