...
## DESCRIZIONE
Il Add-AzApplicationGatewayBackendHttpSetting cmdlet aggiunge le impostazioni HTTP back-end a un gateway applicazione.
Le impostazioni HTTP di back-end vengono applicate a tutti i server back-end nel pool.

## ESEMPI

### Esempio 1: Aggiungere le impostazioni HTTP back-end a un gateway applicazione
```powershell
...
### -ApplicationGateway
Specifica il nome del gateway applicazione per cui questo cmdlet aggiunge le impostazioni.
...
### -Name
Specifica il nome delle impostazioni HTTP back-end aggiunte dal cmdlet.
...
### -Snodato
Specifica un elemento da associare a un server back-end.
...
### -LambdaId
Specifica l'ID del database da associare al server back-end.
...
### -Protocol
Specifica il protocollo per la comunicazione tra gateway applicazione e server back-end.
