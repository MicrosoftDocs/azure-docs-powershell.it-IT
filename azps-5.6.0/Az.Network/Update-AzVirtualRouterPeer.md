...
### VirtualRouterParameterNameParameterSet
```
...
### VirtualRouterParameobjectParameterSet
```
...
## DESCRIZIONE
Il cmdlet **Update-AzVirtualRouter Commutr Consente** di aggiornare un peer VirtualRouter a un peer Azure VirtualRouter
...
### -InputObject
Oggetto di input peer del router virtuale.
...
### -ResourceGroupName
Nome del gruppo di risorse del router/peer virtuale.
...
### -ResourceId
ID della risorsa peer del router virtuale.
...
### -VirtualRouterName
Router virtuale in cui esiste il peer.
...
### Microsoft.Azure.Commands.Network.Models.PSVirtualRouter Enterprise
