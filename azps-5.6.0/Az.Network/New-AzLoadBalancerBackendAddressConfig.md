...
## SYNOPSIS
Restituisce una configurazione di indirizzo back-end di bilanciamento del carico. 
...
### Esempio 1: Nuova configurazione dell'indirizzo di bilanciamento del carico con riferimento alla rete virtuale
```powershell
PS C:\> $virtualNetwork = Get-AzVirtualNetwork -Name $vnetName -ResourceGroupName $resourceGroup
New-AzLoadBalancerBackendAddressConfig -IpAddress "10.0.0.5" -Name "TestVNetRef" -VirtualNetworkId $virtualNetwork.Id
```

### Esempio 2: Nuova configurazione dell'indirizzo caricore con riferimento alla configurazione ip di loadbalancer frontend
```powershell
...
Configurazione IP frontend della bilanciamento del carico associata alla configurazione dell'indirizzo Backend
...
### -VirtualNetworkId
Rete virtuale associata alla configurazione dell'indirizzo back-end
