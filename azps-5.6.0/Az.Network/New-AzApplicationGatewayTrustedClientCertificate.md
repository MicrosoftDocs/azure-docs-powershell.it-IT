...
## SYNOPSIS
Crea una catena di certificati CA client attendibili per un gateway applicazioni.
...
## DESCRIZIONE
Il cmdlet New-AzApplicationGatewayTrustedClientCertificate crea una catena di certificati CA del client attendibile per un gateway applicazione.
...
```
Il comando crea un nuovo oggetto catena di certificati CA del client attendibile che prende come input il percorso del certificato CA client.
