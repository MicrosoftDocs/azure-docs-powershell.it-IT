...
## DESCRIZIONE
Il cmdlet **Get-AzRouteTable** ottiene le tabelle delle route di Azure.
È possibile ottenere una singola tabella di route oppure tutte le tabelle di route in un gruppo di risorse o nella sottoscrizione.
...
Questo comando recupera la tabella di route denominata RouteTable01 nel gruppo di risorse denominato ResourceGroup11.

### Esempio 2: Elencare le tabelle delle route usando i filtri
```
...
Questo comando recupera tutte le tabelle di route il cui nome inizia con "Tabella Route"
...
### -Name
Specifica il nome della tabella di route che riceve questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene le tabelle di route recuperate da questo cmdlet.
