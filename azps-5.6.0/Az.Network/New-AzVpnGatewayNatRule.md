...
In questo modo verrà creato un gruppo di risorse, una WAN virtuale, una rete virtuale e un hub virtuale. Verrà quindi creato VpnGateway nell'hub virtuale. Quindi, usando questo comando: New-AzVpnGatewayNatRule, è possibile creare una regola NAT e associarle a VpnGateway create.
