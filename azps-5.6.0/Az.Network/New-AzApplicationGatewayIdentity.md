...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayIdentity** crea un oggetto identità del gateway di applicazione.
...
In questo esempio viene creata un'identità assegnata a un utente a cui viene fatto riferimento nell'oggetto identità usato con Gateway applicazione.
