...
## DESCRIZIONE
New-AzVpnGateway crea un Gateway VPN scalabile.
Connettività definita dal software per le connessioni da sito a sito all'interno di VirtualHub.

Il gateway viene ridimensionato e ridimensionato in base all'unità di scala specificata in questo o nel cmdlet Set-AzVpnGateway gateway.

Viene impostata una connessione da un ramo/sito noto come VPNSite al gateway scalabile.
Ogni connessione comprende 2 Active-Active tunnel.

VpnGateway si posizionerà nella stessa posizione del virtualhub a cui si fa riferimento.
...
La procedura precedente consente di creare un gruppo di risorse, WAN virtuale, rete virtuale, hub virtuale negli Stati Uniti occidentali nel gruppo di risorse "testRG" in Azure. Successivamente verrà creato un gateway VPN nell'hub virtuale con 2 unità di scala.
