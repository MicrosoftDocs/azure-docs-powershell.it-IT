...
## SYNOPSIS
Rimuove un peer da un Azure RouteServer

## SINTASSI

### RouteServerNParameterNameParameterSet (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet **Remove-AzRouteServerRoute rimuove** un peer RouteServer da un Azure RouteServer
