...
## DESCRIZIONE
Il Stop-AzNetworkWatcherConnectionMonitor cmdlet interrompe il monitor di connessione specificato.

## ESEMPI

### Esempio 1: Interrompere un monitor di connessione
```powershell
PS C:\> Stop-AzNetworkWatcherConnectionMonitor -NetworkWatcher $nw -Name cm
```

In questo esempio si interrompe il monitor di connessione specificato per nome e network watcher

### Esempio 2

Arrestare un monitor di connessione. (autogenerati)
