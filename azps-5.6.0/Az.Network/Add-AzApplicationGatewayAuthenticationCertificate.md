...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayAuthenticationCertificate aggiunge** un certificato di autenticazione a un gateway applicazione di Azure.

## ESEMPI

### Esempio 1: Aggiungere il certificato di autenticazione a un gateway applicazioni
```
...
Il secondo comando aggiunge il certificato di autenticazione denominato cert01 al gateway applicazione.
Il terzo comando aggiorna il gateway applicazione.

## PARAMETERS

### -ApplicationGateway
Specifica il nome del gateway applicazione per cui questo cmdlet aggiunge un certificato di autenticazione.
...
### -Name
Specifica il nome di un certificato che questo cmdlet aggiunge al gateway applicazioni.
