...
## DESCRIZIONE
Il cmdlet **New-AzLoadBalancerRuleConfig crea** una configurazione di regola per una bilanciamento del carico di Azure.

## ESEMPI

### Esempio 1: Creazione di una configurazione di regole per un servizio di bilanciamento del carico di Azure
```powershell
...
I primi tre comandi configurano un indirizzo IP pubblico, un front-end e un altro per la configurazione delle regole nel forth comando. Il forth comando crea una nuova regola denominata MyLBrule con specifiche specifiche.

## PARAMETERS

### -BackendAddressPool
Specifica un oggetto **BackendAddressPool** da associare a una configurazione di regola di bilanciamento del carico.
...
### -BackendPort
Specifica la porta back-end per il traffico corrispondente a questa configurazione della regola di bilanciamento del carico.
...
### -Protocol
Specifica il protocollo a cui corrisponde una configurazione di regola di bilanciamento del carico.
