...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayRequestRoutingRule** aggiunge una regola di routing delle richieste a un gateway applicazione.

## ESEMPI

### Esempio 1: Aggiungere una regola di routing delle richieste a un gateway applicazione
```
...
Il secondo comando aggiunge la regola di routing delle richieste al gateway applicazione.

## PARAMETERS

### -ApplicationGateway
Specifica un gateway applicazione a cui questo cmdlet aggiunge una regola di routing delle richieste.
...
### -BackendAddressPool
Specifica un oggetto pool di indirizzi back-end del gateway applicazione.
...
Specifica un ID pool di indirizzi back-end del gateway applicazioni.
...
### -BackendHttpSettings
Specifica un oggetto impostazioni HTTP back-end per un gateway applicazione.
...
Specifica un ID di impostazioni HTTP back-end per un gateway applicazione.
...
### -Http Listener
Specifica l'oggetto listener HTTP del gateway di applicazione.
...
### -Name
Specifica il nome della regola di routing delle richieste che questo cmdlet aggiunge.
...
### -UrlPathMapId
Specifica l'ID mappa del percorso URL per la regola di routing.
