...
## DESCRIZIONE
Il Test-AzNetworkWatcherConnectivity di rete restituisce le informazioni sulla connettività per una macchina virtuale di origine specificata e una destinazione. Se non è possibile stabilire la connettività tra l'origine e la destinazione, il cmdlet restituisce dettagli sul problema.
...
Restituisce le informazioni sulla connettività per una macchina virtuale di origine specificata e una destinazione. (autogenerati)
...
### -DestinationId
ID della risorsa a cui verrà eseguito un tentativo di connessione.
