...
## DESCRIZIONE
Il cmdlet **Get-AzP2sVpnGatewayVpnProfile** consente di generare e ottenere un URL della firma di accesso condiviso per il cliente per scaricare il profilo Vpn per la configurazione del client point-to-site in modo che punti alla connettività del sito a P2SVpnGateway. Puntare alla configurazione del client del sito usando questo profilo Vpn può connettersi solo a questo specifico P2SVpnGateway.
...
Il cmdlet **Get-AzP2sVpnGatewayVpnProfile** consente di generare e ottenere un URL della firma di accesso condiviso per il cliente per scaricare il profilo Vpn per la configurazione del client point-to-site in modo che punti alla connettività del sito a P2SVpnGateway. ProfileUrl mostra l'URL della firma di accesso condiviso da cui il cliente può scaricare il profilo Vpn per la configurazione del client point-to-site.
