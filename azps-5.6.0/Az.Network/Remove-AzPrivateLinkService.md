...
Questo esempio rimuove un servizio di collegamento privato denominato TestPrivateLinkService.
...
### -ResourceGroupName
Nome del gruppo di risorse del servizio di collegamento privato.
