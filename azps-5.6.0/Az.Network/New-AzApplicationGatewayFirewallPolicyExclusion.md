...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayFirewallPolicyExapplication è** un nuovo elenco di regole di esclusione per i criteri del firewall.
...
Questo comando crea una nuova voce di esclusione per la variabile denominata RequestHeaderNames e l'operatore StartsWith e Selector denominati xyz. La voce di esclusione viene salvata in $exclusionEntry.
...
### -Selettore
Quando la variabile è una raccolta, l'operatore usato per specificare a quali elementi della raccolta si applica questa esclusione.
...
Quando la variabile è una raccolta, usare il selettore per specificare a quali elementi della raccolta si applica questa esclusione.
...
### Microsoft.Azure.Commands.Network.Models.PSApplicationGatewayFirewallPolicyExapplication
