...
### -IkeIntegrity
Algoritmo di integrità IKE di VpnClient (Fase IKE 2)
...
### -SADataSize
Dimensioni del payload della modalità rapida o sa della fase 2 in KB per l'associazione di sicurezza IPSec vpn
...
### -SALifeTime
Durata in secondi dell'associazione di sicurezza IPSec di VpnClient (chiamata anche modalità rapida o SA di fase 2)
