...
## DESCRIZIONE
Il cmdlet **New-AzLoadBalancerOutboundRuleConfig crea** una configurazione della regola in uscita per una bilanciamento del carico di Azure.

## ESEMPI

### Esempio 1: Creare una configurazione di regola in uscita per un servizio di bilanciamento del carico
```powershell
...
Il terzo comando crea una configurazione del pool di indirizzi back-end denominata BackendAddressPool01, che viene quindi archiviata nella variabile $backend back-end.
...
Crea una configurazione della regola in uscita per una bilanciamento del carico. (autogenerati)
