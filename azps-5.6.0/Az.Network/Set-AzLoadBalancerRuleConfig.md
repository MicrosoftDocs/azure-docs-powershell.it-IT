...
Specifica l'intervallo di tempo, in minuti, per cui lo stato delle conversazioni viene gestito in una bilanciamento del carico.
...
Questo cmdlet aggiorna una configurazione della regola per la bilanciamento del carico specificata da questo parametro.
