...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayRedirectConfiguration aggiunge** una configurazione di reindirizzamento a un Gateway applicazione.
...
Il secondo comando aggiunge la configurazione di reindirizzamento al gateway applicazione.

### Esempio 2

Aggiunge una configurazione di reindirizzamento a un Gateway applicazioni. (autogenerati)
