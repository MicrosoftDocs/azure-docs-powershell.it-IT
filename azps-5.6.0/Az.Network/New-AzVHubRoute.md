...
Il comando precedente crea un oggetto VHubRoute con nextHop come firewall specificato, che può quindi essere aggiunto a una risorsa VHubRouteTable.
...
Il comando precedente crea un oggetto VHubRoute con nextHop come hubVnetConnection specificato, che può quindi essere aggiunto a una risorsa VHubRouteTable.
...
```
I comandi precedenti otterrà la RoutingConfiguration di un AzVHubRoute già esistente e quindi aggiungeranno una route statica nella connessione. In alternativa, se si desidera creare una nuova connessione con la route statica al suo interno, vedere l'esempio 1 [qui.](New-AzRoutingConfiguration.md)
## PARAMETERS
