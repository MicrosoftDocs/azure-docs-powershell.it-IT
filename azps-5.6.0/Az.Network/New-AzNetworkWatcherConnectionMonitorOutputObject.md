...
## DESCRIZIONE
Il cmdlet New-AzNetworkWatcherConnectionMonitorOutputObject crea l'oggetto di destinazione di output del monitor di connessione.
...
Tipo: "area di lavoro" WorkspaceSettings: { "WorkspaceResourceId": "MyWSResourceId" }
...
### -OutputType
Tipo di destinazione di output del monitor di connessione. Attualmente è supportata \" solo \" l'area di lavoro.
...
### -WorkspaceResourceId
ID risorsa area di lavoro analisi log.
