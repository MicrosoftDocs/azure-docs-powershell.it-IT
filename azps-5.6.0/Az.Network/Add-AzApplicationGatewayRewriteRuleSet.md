...
## SYNOPSIS
Aggiunge un set di regole di riscrittura a un gateway applicazioni.
...
## DESCRIZIONE
Il cmdlet **Add-AzApplicationGatewayRewriteRuleSet** aggiunge un set di regole di riscrittura a un gateway applicazione.
...
Il secondo comando aggiunge il set di regole di riscrittura al gateway applicazione.
