...
Questo comando aggiorna la definizione di un criterio endpoint del servizio denominato Policydef1 nel criterio dell'endpoint di servizio definito dall'oggetto $ServiceEndpointPolicy.
