...
## DESCRIZIONE
Il cmdlet **Get-AzVirtualNetwork** ottiene una o più reti virtuali n un gruppo di risorse.
...
Questo comando recupera la rete virtuale denominata MyVirtualNetwork nel gruppo di risorse TestResourceGroup

### 2: elencare le reti virtuali con il filtro
```
...
Questo comando recupera tutte le reti virtuali che iniziano con "MyVirtualNetwork".
...
### -Name
Specifica il nome della rete virtuale a cui questo cmdlet è stato fatto.
