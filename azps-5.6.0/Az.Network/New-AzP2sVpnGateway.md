...
## SYNOPSIS
Creare un nuovo P2SVpnGateway in VirtualHub per la connettività del sito punto a punto.

## SINTASSI

### ByVirtualHubNameByVpnServerConfigurationObject (impostazione predefinita)
```
...
## DESCRIZIONE
Il cmdlet New-AzP2sVpnGateway consente di creare un nuovo P2SVpnGateway in VirtualHub per la connettività del punto al sito dai client dei punti al sito ad Azure VirtualWan.
...
Il cmdlet New-AzP2sVpnGateway consente di creare un nuovo P2SVpnGateway in VirtualHub per la connettività del sito point to site.
...
### -VirtualHub
VirtualHub a cui deve essere associato questo P2SVpnGateway.
...
### -VirtualHubId
ID di VirtualHub a cui deve essere associato questo P2SVpnGateway.
...
Flag per abilitare la preferenza di routing Internet in questo P2SVpnGateway.
