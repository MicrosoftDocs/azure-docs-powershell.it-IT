...
## DESCRIZIONE
Il cmdlet New-AzNetworkWatcherConnectionMonitor crea una risorsa di monitoraggio della connessione per il monitor di connessione specificato di origine e destinazione (monitor di connessione SingleSourcedestination) o set di gruppi di test (MultiEndpointConnectionMonitor).
