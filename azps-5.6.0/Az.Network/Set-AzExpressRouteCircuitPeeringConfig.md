...
## DESCRIZIONE
I cmdlet **Set-AzExpressRouteCircuit DigitaingConfig** salvano una configurazione peering di ExpressRoute modificata in Azure.

## ESEMPI

### Esempio 1: Modificare una configurazione di peering esistente
```powershell
...
Salva una configurazione peering expressRoute modificata. (autogenerati)
...
### -ExpressRouteCircuit
Oggetto circuito ExpressRoute contenente la configurazione di peering da modificare.
...
### -Name
Nome della configurazione di peering da modificare.
