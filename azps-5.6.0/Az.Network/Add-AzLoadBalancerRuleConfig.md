...
## DESCRIZIONE
Il cmdlet **Add-AzLoadBalancerRuleConfig aggiunge** una configurazione della regola a una bilanciamento del carico di Azure.

## ESEMPI

### Esempio 1: Aggiungere una configurazione di regole a un servizio di bilanciamento del carico
```
...
Il secondo comando usa l'operatore della pipeline per passare la bilanciamento del carico in $slb **ad Add-AzLoadBalancerRuleConfig,** che aggiunge la configurazione della regola denominata NewRule.
Il terzo comando aggiornerà la bilanciamento del carico in Azure con la nuova configurazione della regola di bilanciamento del carico.

## PARAMETERS

### -BackendAddressPool
Specifica il pool di indirizzi back-end da associare a una configurazione di regola di bilanciamento del carico.
...
### -BackendPort
Specifica la porta back-end per il traffico a cui corrisponde una configurazione della regola di bilanciamento del carico.
...
Specifica per l'intervallo di tempo, in minuti, che lo stato delle conversazioni viene mantenuto nella bilanciamento del carico.
...
Questo cmdlet aggiunge una configurazione della regola al servizio di bilanciamento del carico specificato da questo parametro.
