...
## SYNOPSIS
Aggiungere un peer a un RouteServer di Azure
...
## DESCRIZIONE
Il cmdlet **Add-AzRouteServerRoute aggiunge** un peer RouteServer a un Azure RouteServer
...
### -PeerAsn
ASN del peer del server del percorso remoto.
