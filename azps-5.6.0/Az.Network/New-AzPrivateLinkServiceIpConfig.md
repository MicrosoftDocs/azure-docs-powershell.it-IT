...
## DESCRIZIONE
Il cmdlet **New-AzPrivateLinkServiceIpConfig crea** una configurazione IP del servizio di collegamento privato. Questa configurazione viene usata per NAT di origine che imposta il traffico in ingresso dall'endpoint privato. 
...
Creare una configurazione IP del servizio di collegamento privato. (autogenerati)
...
### -PrivateIpAddress
Indirizzo IP privato della ipConfiguration se è specificata l'allocazione statica.
...
### -Principale
Indicare che la configurazione IP corrente è principale o meno.
