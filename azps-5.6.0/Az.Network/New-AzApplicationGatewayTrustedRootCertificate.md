...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayTrustedRootCertificate crea** un certificato radice attendibile per un gateway applicazione di Azure.
...
Questo comando crea un certificato radice attendibile denominato Elenco "trc1" e archivia il risultato nella variabile $trc.
