...
La connessione viene quindi rimossa con il nome della connessione.
...
Come l'esempio 1, ma ora rimuove la connessione usando l'oggetto piped da Get-AzVpnConnection.
