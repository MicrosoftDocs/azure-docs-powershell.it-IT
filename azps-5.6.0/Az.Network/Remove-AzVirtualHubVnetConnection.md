...
Dopo la creazione, la connessione alla rete virtuale dell'hub viene rimossa usando il nome del gruppo di risorse, il nome dell'hub e il nome della connessione.
...
Dopo la creazione, la connessione alla rete virtuale dell'hub viene rimossa usando i piping di PowerShell sull'output di Get-AzHubVirtualNetworkConnection.
...
### -ResourceId
ID della risorsa hubvirtualnetworkconnection da modificare.
