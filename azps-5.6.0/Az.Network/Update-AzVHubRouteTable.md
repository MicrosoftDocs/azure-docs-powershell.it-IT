...
## SYNOPSIS
Eliminare una risorsa tabella delle route dell'hub associata a un VirtualHub.
...
## DESCRIZIONE
Aggiorna la tabella di route specificata associata all'hub virtuale specificato con le route o le etichette specificate.
...
Questo comando elimina la tabella delle route dell'hub virtuale.
...
### -InputObject
La risorsa vhubroute per Update.
...
### -ResourceId
ID risorsa della risorsa vhubroutetable da aggiornare.
...
### -Route
Elenco dei percorsi per questa tabella di route.
