...
## DESCRIZIONE
Il cmdlet **New-AzSecurityPartnerProvider crea** un Provider SecurityPartner di Azure
...
### -VirtualHub
ID hub virtuale a cui è collegato il provider del partner di sicurezza
