...
## DESCRIZIONE
Elimina la tabella di route specificata associata all'hub virtuale specificato.
...
Questo comando elimina la routeTable1 dell'hub virtuale westushub.
...
### -ResourceId
ID risorsa della risorsa di virtualhubroute da rimuovere.
