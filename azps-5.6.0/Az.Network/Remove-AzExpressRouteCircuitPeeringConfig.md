...
## DESCRIZIONE
Il cmdlet **Remove-AzExpressRouteCircuitConfigingConfig** rimuove una configurazione di peering del circuito ExpressRoute.

## ESEMPI

### Esempio 1: Rimuovere una configurazione di peering da un circuito ExpressRoute
```
