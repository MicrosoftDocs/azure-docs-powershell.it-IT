...
## DESCRIZIONE
Il cmdlet **New-AzIpAllocation** crea una ipAllocation di Azure
...
### -Force
Non chiedere conferma se si vuole ignorare una risorsa
...
### -IpamAllocationId
ID di assegnazione ipam dell'allocazione IP
...
### -PrefixLength
Lunghezza prefisso dell'allocazione IP
