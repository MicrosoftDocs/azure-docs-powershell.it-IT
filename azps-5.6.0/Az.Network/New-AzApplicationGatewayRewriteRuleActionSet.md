...
## DESCRIZIONE
Il cmdlet **New-AzApplicationGatewayRewriteRuleActionSet crea** un set di azioni della regola di riscrittura per un gateway applicazione di Azure.
...
Questo comando crea un set di azioni della regola di riscrittura e archivia il risultato nella variabile $action.
...
Elenco delle configurazioni delle intestazioni delle risposte
...
### -UrlConfiguration
Configurazione url per il set di azioni
