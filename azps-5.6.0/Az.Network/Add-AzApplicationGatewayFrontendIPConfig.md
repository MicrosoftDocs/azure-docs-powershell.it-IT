...
Il secondo comando recupera il gateway applicazione denominato ApplicationGateway01 che appartiene al gruppo di risorse denominato ResourceGroup01 e lo archivia nella variabile $AppGw locale.
...
Se si specifica il parametro *PrivateIPAddress,* questo deve appartenere alla subnet.
In caso contrario, uno degli indirizzi IP da questa subnet viene scelto dinamicamente come INDIRIZZO IP front-end del gateway applicazione.
