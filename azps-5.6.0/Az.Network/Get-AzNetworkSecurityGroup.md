...
## DESCRIZIONE
Il cmdlet **Get-AzNetworkSecurityGroup** ottiene un gruppo di sicurezza di rete di Azure.

## ESEMPI

### Esempio 1: Recuperare un gruppo di sicurezza di rete esistente
```powershell
...
### Esempio 2: Elencare i gruppi di sicurezza di rete esistenti usando i filtri
```powershell
...
Questo comando restituisce i contenuti dei gruppi di sicurezza di rete Azure che iniziano con "nsg"
...
### -Name
Specifica il nome del gruppo di sicurezza di rete che riceve questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse a cui appartiene il gruppo di sicurezza di rete.
