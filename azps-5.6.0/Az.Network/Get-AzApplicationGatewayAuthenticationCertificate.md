...
## DESCRIZIONE
Il cmdlet **Get-AzApplicationGatewayAuthenticationCertificate ottiene** un certificato di autenticazione per un gateway applicazione di Azure.
...
Il primo comando recupera il gateway applicazione denominato appGwName e lo archivia nella $appgw variabile.
Il secondo comando recupera il certificato di autenticazione denominato cert01 e lo archivia nella $cert variabile.

## PARAMETERS

### -ApplicationGateway
Specifica il nome del gateway applicazione per cui questo cmdlet riceve un certificato di autenticazione.
...
### -Name
Specifica il nome del certificato di autenticazione che riceve questo cmdlet.
