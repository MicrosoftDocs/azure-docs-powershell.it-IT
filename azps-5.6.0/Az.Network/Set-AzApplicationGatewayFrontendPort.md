...
## DESCRIZIONE
Il cmdlet **Set-AzApplicationGatewayFrontendPort** modifica una porta front-end per un gateway applicazione.

## ESEMPI

### Esempio 1: Impostare una porta front-end di un gateway applicazione su 80
```
...
Il secondo comando modifica il gateway in $AppGw usa la porta 80 per la porta front-end denominata FrontEndPort01.

## PARAMETERS

### -ApplicationGateway
Specifica l'oggetto gateway applicazione a cui questo cmdlet associa la porta front-end.
