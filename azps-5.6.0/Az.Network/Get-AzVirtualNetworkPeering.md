...
## DESCRIZIONE
Il **cmdlet Get-AzVirtualNetworkEndoing** ottiene il peering della rete virtuale.
...
### Esempio 2: Ottenere tutti i peering in una rete virtuale
```
...
### -VirtualNetworkName
Specifica il nome della rete virtuale che riceve questo cmdlet.
