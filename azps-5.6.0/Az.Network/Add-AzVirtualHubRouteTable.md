...
## DESCRIZIONE
La risorsa tabella delle route dell'hub virtuale contiene l'elenco dei percorsi e un elenco delle connessioni a cui può essere collegata e usata per instradare il traffico in un hub virtuale.
...
Il comando precedente crea una risorsa Tabella route hub virtuale dalle route passate a essa e questo oggetto può essere usato per il routing del traffico in un hub virtuale.  

## PARAMETERS

### -Connessione
Elenco delle connessioni a cui è collegata questa tabella di route.
...
### -Route
Elenco delle route dell'hub virtuale.
