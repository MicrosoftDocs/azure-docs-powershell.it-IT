...
Per distribuire una soluzione di bilanciamento del carico è necessario creare prima diversi oggetti e i primi sette comandi mostrano come creare tali oggetti.
...
Si noti che questo esempio illustra solo come creare una bilanciamento del carico. È anche necessario configurarla usando il cmdlet Add-AzNetworkInterfaceIpConfig per assegnare le nicchie a macchine virtuali diverse.
