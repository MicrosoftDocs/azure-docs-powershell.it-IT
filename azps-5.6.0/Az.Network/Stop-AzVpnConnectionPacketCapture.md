...
## SYNOPSIS
Interrompe l'operazione Packet Capture su una connessione Vpn
...
## DESCRIZIONE
Interrompe l'operazione di acquisizione pacchetti in una connessione Vpn e carica il risultato su un determinato valore SasUrl del contenitore di archiviazione.
...
### -InputObject
Oggetto connessione Vpn in cui iniziare l'acquisizione dei pacchetti.
...
### -Name
Nome della connessione Vpn in cui deve essere avviata l'acquisizione dei pacchetti.
...
### -ResourceId
ID della risorsa Azure di VpnConnection da cui iniziare l'acquisizione dei pacchetti.
...
### -SasUrl
URL della firma di accesso condiviso per l'interruzione dell'acquisizione di pacchetti in Vpn.
