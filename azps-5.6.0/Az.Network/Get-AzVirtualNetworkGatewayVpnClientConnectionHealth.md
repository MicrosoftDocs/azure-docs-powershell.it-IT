...
Per il gateway di rete virtuale di Azure denominato nome gateway nel gruppo di risorse ResourceGroup, recupera la connessione al client VPN attualmente connesso tramite OpenVpn. 

### Esempio 2

Ottenere l'elenco delle informazioni sull'integrità della connessione del client VPN di un gateway di rete virtuale di Azure per ogni connessione client VPN. (autogenerati)
