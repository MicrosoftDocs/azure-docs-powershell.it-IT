...
## SYNOPSIS
Rimuove l'oggetto della catena di certificati della CA del client attendibile da un gateway applicazioni.
...
Il primo comando ottiene un gateway applicazione e lo archivia nella $gw variabile. Il secondo comando rimuove la catena di certificati CA del client attendibile denominata "TrustedClientCertificate01" dal gateway applicazione archiviato in $gw.
