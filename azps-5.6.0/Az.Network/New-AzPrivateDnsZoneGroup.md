...
## DESCRIZIONE
Il cmdlet **New-AzPrivateDnsZoneGroup** consente di creare un nuovo gruppo di zona DNS privato.
...
Dopo aver creato `test-pr-endpoint` l'endpoint privato, nell'esempio precedente viene creato un gruppo di zona DNS in tale endpoint privato.
