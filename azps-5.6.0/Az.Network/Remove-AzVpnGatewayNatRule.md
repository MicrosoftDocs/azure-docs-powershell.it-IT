...
In questo modo verrà creato un gruppo di risorse, una WAN virtuale, una rete virtuale, un hub virtuale, una VpnGateway e una regola NAT associata a VpnGateway.
