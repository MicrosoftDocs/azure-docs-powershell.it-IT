...
La procedura descritta sopra consente di creare un gruppo di risorse "testRG", una WAN virtuale e un hub virtuale negli Stati Uniti occidentali in tale gruppo di risorse in Azure. L'hub virtuale avrà lo spazio di indirizzi "10.0.1.0/24" e una tabella di route allegata.
...
### -VirtualWan
Oggetto wan virtuale a cui è collegato questo hub.
