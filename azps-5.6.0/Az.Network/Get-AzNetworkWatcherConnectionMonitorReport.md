...
## DESCRIZIONE
Il Get-AzNetworkWatcherConnectionMonitorReport cmdlet di connessione restituisce il report sugli stati di connessione più recenti.

## ESEMPI

### Esempio 1: Ottenere lo snapshot di connessione più recente del monitor di connessione in base al nome nella posizione specificata
```
...
In questo esempio vengono e queryti gli stati di connessione più recenti del monitor di connessione specificato.
...
## NOTE
Parole chiave: azure, azurerm, arm, risorsa, connettività, gestione, manager, rete, rete, network watcher, monitor connessione
