...
## DESCRIZIONE
Il cmdlet **Get-AzConsumptionReservationSummary** ottiene i riepiloghi di prenotazione per le granularità giornaliera o mensile.
...
### Esempio 3: Ottenere i riepiloghi di prenotazione con ID ordine di prenotazione per l'intervallo di date per le granularità giornaliere fornite
```powershell
...
### -ReservationId
Identificatore di una prenotazione all'interno di un ordine di prenotazione.
