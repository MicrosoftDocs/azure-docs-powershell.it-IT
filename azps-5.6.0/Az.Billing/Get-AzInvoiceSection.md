...
## DESCRIZIONE
Il cmdlet **Get-AzInvoiceSection** ottiene le sezioni di fattura nel profilo di fatturazione specificato. 
...
Ottieni tutte le sezioni delle fatture nel profilo di fatturazione specificato.
...
Recuperare la sezione della fattura con il nome specificato.
...
### -Name
Nome di una sezione specifica della fattura.
