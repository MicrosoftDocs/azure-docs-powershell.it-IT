...
### Esempio 1: Ottenere l'utilizzo dei marketplace
```powershell
...
### -BillingPeriodName
Nome di un periodo di fatturazione specifico per ottenere il marketplace a cui associare.
...
### -EndDate
Data di fine (in UTC) dei mercati da filtrare.
...
### -ResourceGroup
Gruppo di risorse dei marketplace da filtrare.
...
### -StartDate
Data di inizio (in UTC) dei mercati da filtrare.
