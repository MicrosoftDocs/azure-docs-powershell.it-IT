...
## DESCRIZIONE
Il Set-AzConsumptionBudget cmdlet aggiorna un preventivo in una sottoscrizione o in un gruppo di risorse.

## ESEMPI

### Esempio 1: Aggiornare un budget in base a un nuovo importo con un nome di budget a livello di abbonamento
```powershell
...
### Esempio 2: Aggiornare un budget con una notifica quando il costo o l'utilizzo raggiunge una soglia del 90% dell'importo a livello di abbonamento
```powershell
...
### Esempio 3: Aggiornare un preventivo di un nuovo importo con un nome di preventivo a livello di gruppo di risorse
```powershell
...
Se non viene specificato, la notifica è disabilitata per impostazione predefinita.
