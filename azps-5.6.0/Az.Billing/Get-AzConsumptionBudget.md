...
## DESCRIZIONE
Il Get-AzConsumptionBudget cmdlet ottiene un elenco di preventivi in una sottoscrizione o in un gruppo di risorse.

## ESEMPI

### Esempio 1: Ottenere un elenco dei budget a livello di abbonamento
```powershell
...
### Esempio 2: Ottenere un elenco di preventivi a livello di gruppo di risorse
```powershell
...
### Esempio 3: Ottenere un budget con il nome del budget a livello di abbonamento
```powershell
...
### Esempio 4: Creare un preventivo con il nome del preventivo a livello di gruppo di risorse
```powershell
