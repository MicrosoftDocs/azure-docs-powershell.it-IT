...
- Ora di inizio e fine della registrazione dell'utilizzo.
- Precisione dell'aggregazione, giornaliera o oraria.
- Dettagli del livello di istanza per più istanze della stessa risorsa.
Per risultati coerenti, i dati restituiti si basano sulla data in cui la risorsa Azure ha riportato i dettagli sull'utilizzo.
