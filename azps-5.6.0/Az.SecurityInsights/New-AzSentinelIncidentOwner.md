...
## DESCRIZIONE
Il cmdlet **New-AzSentinelIncidentOwner** crea un oggetto Incident Owner in memoria per aggiornare un evento imprevisto.
...
Questo esempio crea **un proprietario incident** e aggiorna un evento imprevisto al nuovo proprietario.

## PARAMETERS

### -AssignedTo
Proprietario evento - Assegnato a
...
### -E-mail
Proprietario dell'evento - Posta elettronica
...
### -UserPrincipalName
Proprietario evento - Nome entità utente
