...
È possibile passare un **oggetto Evento** imprevisto usando l'operatore della pipeline oppure in alternativa è possibile specificare i parametri obbligatori.
