...
È possibile passare un **oggetto DataConnector** come parametro o usando l'operatore pipeline oppure in alternativa è possibile specificare i parametri obbligatori.
