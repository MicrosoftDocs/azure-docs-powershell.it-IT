...
È possibile passare un **oggetto AlertRuleAction usando** l'operatore della pipeline oppure in alternativa è possibile specificare i parametri obbligatori.
