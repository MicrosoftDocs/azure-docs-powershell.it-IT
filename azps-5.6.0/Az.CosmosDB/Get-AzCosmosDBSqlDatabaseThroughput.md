...
## SYNOPSIS
Recupera le impostazioni di velocità effettiva corrispondenti a un database Sql diDbDb.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBSqlDatabaseThroughput** ottiene le impostazioni di velocità effettiva corrispondenti a un database Sql diSqlsDB.
