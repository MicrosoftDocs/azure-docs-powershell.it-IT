...
## SYNOPSIS
Elimina il trigger sqldb del database.
...
## DESCRIZIONE
Il cmdlet **Remove-AzCosmosDBSqlTrigger** elimina il trigger sql Codb corrispondenti ai valori ResourceGroupName, AccountName e DatabaseName.
