...
## SYNOPSIS
Ottiene il valore di velocità effettiva di Cassandra Keyspace.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBCassandraKeyspaceThroughput** ottiene l'oggetto velocità effettiva corrispondente a un determinato keyspace.
