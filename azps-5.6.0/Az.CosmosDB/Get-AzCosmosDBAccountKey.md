...
## SYNOPSIS
Ottenere keys{"ConnectionKeys", "PrimaryReadOnly" o "Keys"} per l'account Dib3 specificato. 
...
## DESCRIZIONE
Ottenere l'elenco delle chiavi di connessione.
...
Elenca le chiavi dell'account Dieresdb. Il tipo di chiave può essere un valore compreso tra: ConnectionStrings, Keys e ReadOnlyKeys. L'impostazione predefinita è Chiavi.
...
### -Type
Valore da: {ConnectionStrings, Keys, ReadOnlyKeys}.
L'impostazione predefinita è Chiavi.
