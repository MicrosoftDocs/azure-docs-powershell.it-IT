...
## SYNOPSIS
Aggiorna la funzione Sql UserDefinedFunction di DatabaseDb. Esegue un'operazione di patch sul lato client leggendo la funzione UserDefinedFunction esistente.
