...
## SYNOPSIS
Elimina il database Sql database DatabaseDb.
...
## DESCRIZIONE
Il cmdlet **Remove-AzCosmosDBSqlDatabase** elimina il database Sql Della BancaDb corrispondente ai valori di ResourceGroupName, AccountName e DatabaseName.
