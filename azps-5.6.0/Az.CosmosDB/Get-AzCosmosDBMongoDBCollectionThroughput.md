...
## SYNOPSIS
Ottiene le proprietà di velocità effettiva diDbDb per la raccolta di MongoDB.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBMongoDBCollectionThroughput** ottiene le proprietà di velocità effettiva della raccolta di MongoDB.
...
### -InputObject
Se viene specificato, il cmdlet restituisce la raccolta con il valore di velocità effettiva corrispondente.
