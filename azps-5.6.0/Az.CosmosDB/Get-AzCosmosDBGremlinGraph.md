...
## SYNOPSIS
Recupera il diagramma di Gremlin della AMMORT.
...
## DESCRIZIONE
Il cmdlet **Get-AzCosmosDBGremlinGraph** ottiene le proprietà DieresDB Gremlin Graph.
...
L'oggetto risorsa contiene IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
