...
## SYNOPSIS
Ottiene la raccolta MongoDBdbdb del DatabaseDb.
...
## DESCRIZIONE
Il **cmdlet Get-AzCosmosDBMongoDBCollection** ottiene la raccolta Deidb MongoDB.
...
L'oggetto risorsa contiene proprietà MongoIndexes, _rid, _ts e _etag risorsa.
...
Questo esempio recupera la chiave ShardKey della raccolta recuperata
