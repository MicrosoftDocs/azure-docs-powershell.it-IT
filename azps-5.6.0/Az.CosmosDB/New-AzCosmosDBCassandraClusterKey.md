...
## SYNOPSIS
Crea una nuova chiave cluster CassammasDB Cassandra.
...
## DESCRIZIONE
La **nuova chiave cluster New-AzCosmosDBCassandraClusterKey** crea una nuova chiave cluster Diedb Cassandra.
...
### -Name
Nome della chiave cluster Cassandra.
...
### -OrderBy
Ordinamento della chiave cluster Cassandra.
...
### Microsoft.Azure.Commands.EnterpriseDb.Models.PSClusterKey
