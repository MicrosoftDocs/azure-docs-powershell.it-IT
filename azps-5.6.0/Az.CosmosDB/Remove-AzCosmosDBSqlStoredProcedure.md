...
## SYNOPSIS
Elimina l'istruzione Sql StoredProcedure sql diDbDb.
...
## DESCRIZIONE
Il cmdlet **Remove-AzCosmosDBSqlStoredProcedure** elimina il cmdletSqlDb Sql StoredProcedure corrispondente ai valori ResourceGroupName, AccountName e DatabaseName.
