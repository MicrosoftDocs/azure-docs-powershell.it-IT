...
## DESCRIZIONE
Il **cmdlet Get-AzAutoscaleSetting** ottiene tutte le impostazioni di scala automatica associate a un gruppo di risorse o a un'impostazione di gradazione automatica specificata.

## ESEMPI

### Esempio 1: Ottenere le impostazioni di scala automatica
```
...
Questo comando ottiene le impostazioni di scala automatica assegnate al gruppo di risorse Default-Web-EastUS.

### Esempio 2: Ottenere un'impostazione di scala automatica in base al nome
```
...
Questo comando recupera l'impostazione di scala automatica denominata DefaultServerFarm-Default-Web-EastUS.
