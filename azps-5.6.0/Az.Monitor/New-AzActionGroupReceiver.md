...
## DESCRIZIONE
Il cmdlet **New-AzActionGroupReceiver** crea un nuovo ricevitore di gruppi di azioni in memoria.
...
Questo comando crea un nuovo destinatario di posta elettronica in memoria.
...
l'URI in cui devono essere inviati gli webhook
...
### -ConnectionId
l'ID di connessione itsm di questo ricevitore
...
### -CountryCode
Specifica il codice paese per il ricevente SMS.
...
### -EmailAddress
Specifica l'indirizzo del destinatario della posta elettronica.
...
### -EmailReceiver
Specifica di creare un destinatario di posta elettronica
...
### -IdentifierUri
URI identificatore per l'autenticazione aad
...
### -IsGlobalRunbook
che indica se questa istanza è un runbook globale
...
### -ObjectId
ID oggetto app webhook per l'autenticazione aad
...
### -Region
l'area geografica di questo ricevitore
...
### -SmsReceiver
Specifica di creare un ricevitore SMS
...
### -TenantId
l'ID tenant per l'autenticazione aad
...
### -UseAadAuth
il contrassegno da usare per aggiungere l'autenticazione
...
Il contrassegno indica se usare lo schema di avviso comune. Questo valore sarà trascurato per i recimi SMS, Azure App push, ITSM e Voice.
...
### -VoiceCountryCode
Il codice paese del ricevitore vocale
...
### -VoicePhoneNumber
Il numero di telefono del ricevitore vocale
...
### -WebhookReceiver
Specifica di creare un ricevitore webhook
...
### -WorkspaceId
ID area di lavoro itsm di questo ricevitore
