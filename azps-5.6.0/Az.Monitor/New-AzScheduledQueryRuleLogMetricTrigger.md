...
Questa è la condizione di attivazione per la regola della query metrica, da usare quando è necessario descrizione del tipo di misura metrica dell'avviso.
