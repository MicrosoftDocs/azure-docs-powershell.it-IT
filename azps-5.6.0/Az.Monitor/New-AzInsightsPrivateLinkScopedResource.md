...
## DESCRIZIONE
creare per una risorsa con ambito collegamento privato, la risorsa con ambito potrebbe essere un'area di lavoro Analisi log o un componente Application Insights
