...
## DESCRIZIONE
Crea un oggetto di tipo Azione avviso Questo oggetto deve essere passato al comando che crea la regola di avviso
...
### -ThrottlingInMinutes
La durata in minuti per cui deve essere limitato l'avviso
...
### -Trigger
Condizione di attivazione dell'avviso
