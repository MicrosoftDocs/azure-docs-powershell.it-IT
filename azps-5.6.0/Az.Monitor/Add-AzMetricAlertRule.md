...
Se la regola non esiste, viene creata e disabilitata.
Se la regola esiste, viene semplicemente disabilitata.

### Esempio 3: Aggiungere una regola con azioni
```
...
### -Action
Specifica un elenco di azioni separato da virgole.
...
Se non si specifica questo parametro, la regola viene abilitata.
...
Specificare questo parametro solo per le regole basate su metriche.
...
### -TargetResourceId
Specifica l'ID della risorsa che la regola sta monitorando. NOTA: questa proprietà non può essere aggiornata per una regola di avviso esistente.
...
Specifica l'operatore di aggregazione da applicare al periodo di tempo durante la valutazione della regola.
...
### -WindowSize
Specifica le dimensioni dell'intervallo di tempo per il calcolo dei dati da parte della regola.
