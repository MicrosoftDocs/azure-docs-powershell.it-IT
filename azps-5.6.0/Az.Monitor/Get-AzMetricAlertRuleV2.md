...
## DESCRIZIONE
Il cmdlet **Get-AzMetricAlertRuleV2** ottiene una regola di avviso metrica in base al nome o all'URI oppure a tutte le regole di avviso metrico da un abbonamento o un gruppo di risorse specificato.

## ESEMPI

### Esempio 1: Ottenere tutte le regole di avviso metriche nella sottoscrizione corrente
```powershell
...
Questo comando recupera tutte le regole di avviso della metrica nella sottoscrizione corrente.

### Esempio 2: Ottenere tutte le regole di avviso metrica in un gruppo di risorse
...
Questo comando recupera tutte le regole di avviso metriche nel gruppo di risorse denominato metricAlertsRG.

### Esempio 3: Ottenere una regola di avviso metrica in base al nome
...
Questo comando recupera la regola di avviso metrica denominata PS3182019 nel gruppo di risorse denominato metricAlertsRG.

### Esempio 4: Ottenere una regola di avviso metrica per ruleID
...
Questo comando ottiene la regola di avviso metrica con l'ID risorsa specificato.
