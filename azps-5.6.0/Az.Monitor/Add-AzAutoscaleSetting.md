...
### Esempio 1: Creare un'impostazione di scala automatica
```
...
I primi due comandi usano [Nuovo-AzAutoscaleRule](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscalerule) per creare due regole di scala $Rule 1 e $Rule 2.
Il terzo e il quarto comando usano [New-AzAutoscaleProfile](https://docs.microsoft.com/powershell/module/az.monitor/new-azautoscaleprofile) per creare profili di gradazione automatica, $Profile 1 e $Profile 2, usando $Rule 1 e $Rule 2.
