...
### -MetricMetricMetric
Specifica lo spazio dei nomi della metrica per cui eseguire query sulle metriche.
...
Altre informazioni sulle metriche supportate sono disponibili all'indirizzo: https://docs.microsoft.com/azure/azure-monitor/platform/metrics-supported
