...
### Esempio 1: Creare un nuovo oggetto condizione di avviso nel log attività in memoria.
```
...
**NOTA:** quando questo cmdlet viene usato con [Set-AzActivityLogAlert](https://docs.microsoft.com/powershell/module/az.monitor/set-azactivitylogalert) almeno uno di questi oggetti, passato come parametri, deve avere il campo uguale a "Category". In caso contrario, il back-end risponde con un valore 400 (BadRequest.)
