...
ms.locfileid: "101980173"
---
# Get-AzAlertHistory

## SYNOPSIS
Recupera la cronologia delle regole di avviso classiche.
...
## DESCRIZIONE
Il cmdlet **Get-AzAlertHistory** recupera la cronologia delle regole di avviso classiche quando sono abilitate, disabilitate, risolte e così via.
...
### -ResourceId
Specifica l'ID risorsa a cui è associata la regola.
