...
### -Force
Indica che il cmdlet non richiede conferma. Per impostazione predefinita, questo cmdlet chiede di confermare la rimozione della cache.
...
### -ResourceGroupName
Nome del gruppo di risorse da cui si vuole rimuovere la cache.
