...
### -Force
Indica che il cmdlet non richiede conferma. Per impostazione predefinita, questo cmdlet chiede di confermare lo svuotamento della cache.
...
### -ResourceGroupName
"Nome del gruppo di risorse in cui si vuole creare una destinazione di archiviazione per una determinata cache.
