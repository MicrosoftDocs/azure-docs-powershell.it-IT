...
- Ascoltare
- Invia
- La gestione dei client viene indirizzata a uno di questi URI in base al livello di autorizzazione appropriato.
...
Questo comando ottiene informazioni su tutte le regole di autorizzazione assegnate allo spazio dei nomi Contoso Dello spazio dei nomi e al gruppo di risorse ContosoNotificationsGroup.
