...
Ottieni l'app Cloud Spring per nome.

### Esempio 2: elencare tutte le app in un determinato servizio cloud primaverile.
```powershell
...
Elencare tutte le app in un determinato servizio cloud primaverile.
...
### -SyncStatus
Indica se lo stato di sincronizzazione
