...
### Esempio 1: Distribuire il jar compilato locale nel servizio in base al nome.
```powershell
...
Distribuire il jar compilato locale al servizio in base al nome.
...
### -JarPath
Il percorso del barattolo deve essere ammortidato.
