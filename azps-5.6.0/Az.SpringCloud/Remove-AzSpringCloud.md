...
### Esempio 1: Rimuovere il servizio cloud Spring in base al nome.
```powershell
PS C:\> Remove-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service
```

Rimuovere il servizio Cloud Spring in base al nome.

### Esempio 2: Rimuovere il servizio cloud Spring dalla pipe.
```powershell
PS C:\> Get-AzSpringCloud -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service | Remove-AzSpringCloud
```

Rimuovi Spring Cloud Service dalla pipe.
