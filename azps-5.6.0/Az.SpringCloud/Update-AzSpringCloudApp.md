...
### Esempio 1: Aggiornare l'app Cloud Spring in base al nome.
```powershell
...
Aggiorna l'app Cloud Spring in base al nome.

### Esempio 2: Aggiornare l'app Cloud Spring da pipe.
```powershell
...
Aggiorna l'app Cloud Spring da pipe.

## PARAMETERS

### -ActiveDeploymentName
Nome della distribuzione attiva dell'app
...
### -HttpsOnly
Indicare se è consentito solo https.
...
### -Location
Posizione GEO dell'applicazione, sempre uguale alla relativa risorsa padre
...
Percorso di montaggio del disco permanente
...
Dimensioni del disco permanente in GB
...
### -Public
Indica se l'app espone l'endpoint pubblico
...
Percorso di montaggio del disco temporaneo
...
Dimensioni del disco temporaneo in GB
