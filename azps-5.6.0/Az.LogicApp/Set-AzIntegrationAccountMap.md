...
## DESCRIZIONE
Il cmdlet **Set-AzIntegrationAccountMap** modifica una mappa dell'account di integrazione.
...
### Esempio 1: Modificare una mappa di un account di integrazione
```powershell
...
Modifica una mappa dell'account di integrazione. (autogenerati)
...
### -MapFilePath
Specifica il percorso file di una definizione per la mappa dell'account di integrazione.
