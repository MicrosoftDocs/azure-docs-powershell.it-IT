...
## DESCRIZIONE
Il cmdlet **Get-AzLogicAppUpgradedDefinition** ottiene la definizione aggiornata per l'app per la versione e la logica dello schema da un gruppo di risorse.
Questo cmdlet restituisce un oggetto che rappresenta la definizione dell'app per la logica aggiornata.
Specificare il nome del gruppo di risorse, il nome dell'app per la logica e la versione dello schema di destinazione.
...
### Esempio 1: Ottenere una definizione aggiornata di un'app per la logica
```
...
Il primo comando ottiene la definizione per l'app logica aggiornata alla versione dello schema di destinazione specificata.
Il comando archivia la definizione nella $UpgradedDefinition variabile.
Il secondo comando visualizza il contenuto della $UpgradedDefinition come stringa.
...
### -Name
Specifica il nome di un'app per la logica.
