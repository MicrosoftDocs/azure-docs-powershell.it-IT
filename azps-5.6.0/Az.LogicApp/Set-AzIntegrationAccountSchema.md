...
## DESCRIZIONE
Il cmdlet **Set-AzIntegrationAccountSchema** modifica uno schema dell'account di integrazione.
...
### Esempio 1: Modificare lo schema di un account di integrazione
```
...
Questo comando modifica lo schema dell'account di integrazione denominato IntegrationAccountSchema43.
...
### -Metadata
Specifica un oggetto metadati per lo schema.
...
### -SchemaDefinition
Specifica un oggetto definizione per lo schema dell'account di integrazione.
...
### -SchemaFilePath
Specifica il percorso file di una definizione per lo schema dell'account di integrazione.
