...
## DESCRIZIONE
Il cmdlet **New-AzLogicApp** crea un'app per la logica usando la funzionalità App logica.
...
### Esempio 2: Creare un'app per la logica usando oggetti definizione e parametro
```
