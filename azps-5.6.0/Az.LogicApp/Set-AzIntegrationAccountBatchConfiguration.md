...
## DESCRIZIONE
Il cmdlet **Set-AzIntegrationAccountBatchConfiguration** modifica una configurazione batch dell'account di integrazione.
...
### Esempio 2: Modificare una configurazione batch usando una stringa JSON
```powershell
...
Modificare una configurazione batch denominata "sampleBatchConfig" usando una stringa JSON contenuta in "$batchConfigurationContent".

### Esempio 3: Modificare una configurazione batch usando parametri
```powershell
...
### -BatchSize
Dimensioni del batch di configurazione batch dell'account di integrazione.
...
### -InputObject
Configurazione batch dell'account di integrazione.
...
### -Name
Nome di configurazione batch dell'account di integrazione.
...
### -ScheduleFrequency
Frequenza della pianificazione della configurazione batch dell'account di integrazione.
