...
## DESCRIZIONE
Il cmdlet **New-AzIntegrationAccountPartner crea** un partner dell'account di integrazione.
Questo cmdlet restituisce un oggetto che rappresenta il partner dell'account di integrazione.
Specificare il nome dell'account di integrazione, il nome del gruppo di risorse, il nome del partner e le identità del partner.
...
### Esempio 1: Creare un partner account di integrazione
```
...
### -BusinessIdentities
Specifica le identità aziendali per il partner dell'account di integrazione.
...
### -Metadata
Specifica un oggetto metadati per il partner.
