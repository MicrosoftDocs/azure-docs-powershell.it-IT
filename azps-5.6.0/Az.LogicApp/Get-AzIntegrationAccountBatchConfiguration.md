...
### Esempio 1: Ottenere una configurazione batch in base ai parametri
```powershell
...
Ottenere una configurazione batch denominata "sampleBatchConfig" che si trova nell'account di integrazione "sampleIntegrationAccount" contenuto nel gruppo di risorse "sampleResourceGroup".

### Esempio 2: Elencare tutte le configurazioni di batch in un account di integrazione in base ai parametri
```powershell
...
Ottenere tutte le configurazioni batch nell'account di integrazione "sampleIntegrationAccount" contenuto nel gruppo di risorse "sampleResourceGroup".
