...
Il cmdlet **Get-AzLogicAppRunHistory** ottiene la cronologia di esecuzione di un'app per la logica.
Questo cmdlet restituisce una raccolta di oggetti **WorkflowRun.**
Specificare l'app logica e il gruppo di risorse.
...
### Esempio 1: Ottenere la cronologia di esecuzione di un'app per la logica
...
Questo comando ottiene la cronologia di esecuzione di un'app per la logica denominata LogicApp03.

### Esempio 2: Eseguire un'app per la logica
...
Questo comando ottiene una specifica app per la logica eseguita per l'app logica denominata LogicApp03.
...
Questo comando ottiene l'intera cronologia di esecuzione di un'app per la logica denominata LogicApp03 seguendo NextPageLink.
...
Questo comando ottiene le prime due pagine della cronologia di esecuzione di un'app per la logica denominata LogicApp03, seguendo NextPageLink e limitando le dimensioni dei risultati a due pagine.
...
Specifica il nome dell'app per la logica per cui viene eseguita la cronologia di esecuzione del cmdlet.
...
Specifica il nome eseguito di un'app per la logica.
