...
## DESCRIZIONE
Il cmdlet **Remove-AzIntegrationAccountCertificate** rimuove un certificato dell'account di integrazione da un gruppo di risorse.
...
### Esempio 1: Rimuovere un certificato di account di integrazione
```
