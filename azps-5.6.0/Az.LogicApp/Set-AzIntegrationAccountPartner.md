...
## DESCRIZIONE
Il cmdlet **Set-AzIntegrationAccountPartner modifica** un partner dell'account di integrazione.
...
Modifica un partner dell'account di integrazione. (autogenerati)
