...
### Esempio 1: Ottenere uno schema dell'account di integrazione
```
...
### Esempio 2: Ottenere schemi dell'account di integrazione per un gruppo di risorse
```
...
Questo comando recupera gli schemi dell'account di integrazione per il gruppo di risorse denominato ResourceGroup11.
...
### -SchemaName
Specifica il nome di uno schema dell'account di integrazione.
