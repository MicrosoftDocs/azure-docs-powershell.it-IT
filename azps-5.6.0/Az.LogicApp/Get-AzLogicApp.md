...
## DESCRIZIONE
Il cmdlet **Get-AzLogicApp** ottiene un'app per la logica.
...
### Esempio 1: Ottenere un'app per la logica da un gruppo di risorse
```
...
Questo comando ottiene un'app per la logica dal gruppo di risorse denominato ResourceGroup11.
...
### -Name
Specifica il nome dell'app per la logica che riceve questo cmdlet.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse in cui questo cmdlet ottiene un'app per la logica.
...
### -Version
Specifica la versione di un'app per la logica.
