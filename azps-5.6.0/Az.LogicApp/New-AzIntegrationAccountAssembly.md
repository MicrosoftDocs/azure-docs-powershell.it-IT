...
## DESCRIZIONE
Il cmdlet **Get-AzIntegrationAccountAccountAccount Consente** di creare un nuovo assembly in un account di integrazione.
...
### Esempio 2: Creare un nuovo assembly usando dati di tipo byte
```powershell
...
### Esempio 3: Creare un nuovo assembly usando un collegamento di contenuto
```powershell
...
Crea un nuovo assembly usando i dati di byte che si trovano nell'URL "$assemblyUrl". Questo è il metodo suggerito per la creazione di assembly di grandi dimensioni.
