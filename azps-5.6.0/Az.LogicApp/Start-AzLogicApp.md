...
## DESCRIZIONE
Il cmdlet **Start-AzLogicApp** esegue un'app di logica usando la funzionalità App logica.
...
### Esempio 1: Eseguire un'app per la logica
```
PS C:\>Start-AzLogicApp -ResourceGroupName "ResourceGroup11" -Name "LogicApp03" -TriggerName "Trigger22"
```

Questo comando esegue l'app per la logica nel gruppo di risorse denominato ResourceGroup11.
...
### -Name
Specifica il nome dell'app per la logica avviata dal cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene l'app per la logica avviata dal cmdlet.
...
### -TriggerName
Specifica il nome del trigger dell'app per la logica che viene avviato dal cmdlet.
