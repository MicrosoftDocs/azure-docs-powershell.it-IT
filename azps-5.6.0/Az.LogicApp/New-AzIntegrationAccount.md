...
Questo cmdlet restituisce un oggetto che rappresenta l'account di integrazione. Specificare un nome, una posizione, un nome di gruppo di risorse e un nome SKU.
