...
## DESCRIZIONE
Usare **Remove-AzServiceFabricNode** per rimuovere i nodi da uno specifico tipo di nodo da un cluster. La rimozione procede solo se soddisfa le metriche di integrità dei cluster.
