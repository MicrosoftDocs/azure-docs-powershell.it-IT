...
Rimuovere un tipo di applicazione da un tipo di applicazione del servizio dal cluster. In questo modo verranno rimuovono tutte le versioni dei tipi in questa risorsa.
...
Aggiungere o aggiornare una o più impostazioni di Tessuto di servizio al cluster.

### [Set-AzServiceFabricUpgradeType](Set-AzServiceFabricUpgradeType.md)
Modificare il tipo di aggiornamento Service Fabric del cluster.

### [Update-AzServiceFabricApplication](Update-AzServiceFabricApplication.md)
Aggiornare un'applicazione di tessuto di servizio. In questo modo è possibile aggiornare i parametri dell'applicazione e/o aggiornare la versione del tipo di applicazione che attiverà l'aggiornamento dell'applicazione.
