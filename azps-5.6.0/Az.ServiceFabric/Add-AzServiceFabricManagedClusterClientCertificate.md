...
## SYNOPSIS
Aggiungere il nome comune del certificato o l'impronta digitale al cluster. Il certificato verrà registrato di nuovo nel cluster ai fini dell'autenticazione client.
...
Questo comando aggiungerà un certificato client di sola lettura con nome comune "Contoso.com" e 2 autorità di certificazione.
