...
### ClientCertByTp (impostazione predefinita)
```
...
## DESCRIZIONE
Questo cmdlet creerà una risorsa cluster gestita senza tipi di nodo. Per avviare il programma di avvio del cluster È necessario aggiungere un tipo di nodo primario con [New-AzServiceFabricManagedNodeType.](./New-AzServiceFabricManagedNodeType.md)
...
Questo comando crea una risorsa cluster con SKU di base predefinite.
...
Questo comando crea una risorsa cluster in centraluseuap con un certificato client di amministrazione iniziale e una SKU standard.

## PARAMETERS

### -AdminPassword
Password di amministratore usata per le macchine virtuali.
...
### -AdminUserName
Password di amministratore usata per le macchine virtuali.
Impostazione predefinita: vmadmin.
...
Nome comune certificato client.
...
### -ClientCertIsAdmin
Consente di specificare se il certificato client ha il livello di amministratore.
...
Elenco delle identificazioni in pollice dell'autorità di certificazione per il certificato client.
Da usare solo in combinazione con ClientCertCommonName.
...
Pollice in pollice del certificato client.
...
Porta utilizzata per le connessioni client al cluster.
Impostazione predefinita: 19000.
...
### -CodeVersion
Versione del codice dell'infrastruttura del servizio cluster.
Usare questa opzione solo se la modalità di aggiornamento è manuale.
...
Porta utilizzata per le connessioni http al cluster.
Impostazione predefinita: 19080.
...
### -SKU
SKU del cluster, le opzioni sono di base: avrà un minimo di 3 nodi di seed e consente solo 1 tipo di nodo e Standard: avrà un minimo di 5 nodi seed e consente più tipi di nodo.
...
### -UpgradeMode
Modalità di aggiornamento della versione del codice dell'infrastruttura del servizio cluster.
...
### -UseTestExtension
Se si specifica, il cluster verrà associato all'estensione vmss di test del servizio.
