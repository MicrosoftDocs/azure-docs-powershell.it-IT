...
## DESCRIZIONE
Usare **Remove-AzServiceFabricNodeType** per rimuovere tutti i nodi da uno specifico tipo di nodo e il tipo di nodo da un cluster. Questo comando non può essere usato per eliminare il tipo di nodo primario.
...
Questo comando rimuove nodeType 'nt1' dal cluster.
