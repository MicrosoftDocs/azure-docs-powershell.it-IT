...
### DeleteNodeTypeByObj (impostazione predefinita)
```
...
## DESCRIZIONE
Rimuovere il tipo di nodo o nodi specifici all'interno del tipo di nodo. Se si usa il paremter -NodeName, verranno rimossi solo i nodi specificati.
...
Rimuovi tipo di nodo, con piping.
...
Rimuovere 2 nodi dal tipo di nodo.
...
Rimuovere 2 nodi dal tipo di nodo, con piping.
...
Usare con cautela perché ciò potrebbe causare la perdita di dati se nei nodi sono in esecuzione carichi di lavoro con stato oppure potrebbe causare il downing del cluster se dopo l'opearion non ci sono abbastanza nodi di proprietà.
