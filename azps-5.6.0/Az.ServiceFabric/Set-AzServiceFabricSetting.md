...
## DESCRIZIONE
Usare **Set-AzServiceFabricSetting** per aggiungere o aggiornare le impostazioni di Service Fabric in un cluster.
...
Questo comando imposta 'MaxFileOperationTimeout' sul valore '5000' nella sezione 'NamingService'.
...
Questo comando attiverà un aggiornamento per impostare più impostazioni di tessuto usando il parametro SettingsSectionDescription.
...
### -Parameter
Nome parametro dell'impostazione tessuto
...
### -Section
Nome della sezione dell'impostazione del tessuto
...
Una serie di impostazioni dei tessuto
...
### -Value
Valore parametro dell'impostazione del tessuto
