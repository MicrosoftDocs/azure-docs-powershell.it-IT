...
## SYNOPSIS
Rimuovere un tipo di applicazione da un tipo di applicazione del servizio dal cluster. In questo modo verranno rimuovono tutte le versioni dei tipi in questa risorsa. Supporta solo i ARM di applicazioni distribuiti.
...
## DESCRIZIONE
Questo cmdlet rimuove un tipo di applicazione dal cluster e rimuove tutta la versione tipo in questa risorsa, ma tutte le applicazioni in esso installate devono essere rimosse prima di eseguire questo comando.
...
Questo esempio rimuove il tipo di applicazione "testAppType" e tutte le versioni al di sotto. Se sono presenti applicazioni create con questo tipo, il comando genera un'eccezione.
...
### -Force
Rimuovere senza richiesta di conferma.
