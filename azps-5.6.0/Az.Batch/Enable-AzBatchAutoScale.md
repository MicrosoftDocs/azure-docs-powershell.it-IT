...
## DESCRIZIONE
Il cmdlet **Enable-AzBatchAutoScale** abilita il ridimensionamento automatico del pool specificato.

## ESEMPI

### Esempio 1: Abilitare il ridimensionamento automatico per un pool
```
...
Il primo comando definisce una formula e quindi la salva nella $Formula variabile.
Il secondo comando abilita il ridimensionamento automatico nel pool denominato MyPool usando la formula in $Formula.
...
### -AutoScaleFormula
Specifica la formula per il numero desiderato di nodi di calcolo nel pool.
