...
## DESCRIZIONE
Il cmdlet **Stop-AzBatchCertificateDeletion** annulla l'eliminazione non riuscita di un certificato nel servizio batch di Azure.
È possibile interrompere un'eliminazione solo se il certificato è in **stato DeleteFailed.**
Questo cmdlet ripristina lo stato Attivo **del** certificato.
...
Questo comando annulla l'eliminazione del certificato con l'immagine thumbprint specificata.
...
### -Thumbprint
Specifica l'immagine thumbprint del certificato ripristinato da questo cmdlet sullo **stato** Attivo.
