...
Questo cmdlet richiede conferma, a meno che non si specifica il *parametro Force.*
...
Questo comando elimina un'attività il cui ID Attività23 è presente nel processo con ID Processo-000001.
...
Questo comando recupera l'attività batch con ID Attività26 nel processo che contiene l'ID Processo-000001 usando il cmdlet **Get-AzBatchTask.**
...
### -Id
Specifica l'ID dell'attività che il cmdlet elimina.
...
### -InputObject
Specifica l'attività che il cmdlet elimina.
