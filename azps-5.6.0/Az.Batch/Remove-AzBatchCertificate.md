...
Questo comando rimuove il certificato con l'impronta digitale specificata.
...
Questo comando recupera tutti i certificati attivi con il cmdlet Get-AzBatchCertificate certificato.
Il comando passa i certificati attivi al cmdlet corrente usando l'operatore della pipeline.
...
### -Thumbprint
Specifica l'immagine thumbprint del certificato eliminato dal cmdlet.
