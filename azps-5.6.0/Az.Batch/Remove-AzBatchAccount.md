...
## DESCRIZIONE
Il cmdlet **Remove-AzBatchAccount** rimuove un account batch di Azure.
Questo cmdlet chiede di confermare la rimozione di un account, a meno che non si specifica *il parametro Force.*
...
Questo comando rimuove l'account batch denominato pio.
Questo comando richiede conferma prima di eliminare l'account.

## PARAMETERS

### -AccountName
Specifica il nome dell'account batch rimosso dal cmdlet.
...
### -ResourceGroupName
Specifica il gruppo di risorse dell'account rimosso dal cmdlet.
