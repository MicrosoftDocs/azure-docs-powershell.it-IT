...
Il primo comando ottiene un contesto di account batch contenente le chiavi di accesso per l'abbonamento usando **Get-AzBatchAccountKey.**
...
Il comando recupera le impostazioni di accesso remoto per ogni nodo di calcolo.
