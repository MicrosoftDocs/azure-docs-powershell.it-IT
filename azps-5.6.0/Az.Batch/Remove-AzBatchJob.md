...
Questo cmdlet richiede conferma prima di rimuovere un processo, a meno che non si specifica *il parametro Force.*
...
Questo comando elimina il processo il cui ID è Job-000001.
...
Questo comando recupera il processo con l'ID Processo-000002 usando il cmdlet Get-AzBatchJob processo.
...
### -Id
Specifica l'ID del processo eliminato dal cmdlet.
