...
Usare il cmdlet Get-AzBatchJob per ottenere un **oggetto PSCloudJob.**
Modificare le proprietà dell'oggetto e quindi usare il cmdlet corrente per eseguire il commit delle modifiche nel servizio batch.
...
Il primo comando ottiene un processo con **Get-AzBatchJob** e quindi lo archivia nella $Job variabile.
Il secondo comando modifica la specifica della priorità per l'$Job o object.
Il comando finale aggiorna il servizio batch in modo che corrisponda all'oggetto locale in $Job.
