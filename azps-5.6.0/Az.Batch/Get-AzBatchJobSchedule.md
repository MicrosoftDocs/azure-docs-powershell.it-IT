...
## DESCRIZIONE
Il cmdlet **Get-AzBatchJobSchedule** ottiene le pianificazioni dei processi batch di Azure per l'account batch specificato dal *parametro BatchContext.*
Specificare un ID per ottenere una pianificazione per un singolo processo.
Specificare il *parametro Filter* per ottenere le pianificazioni dei processi corrispondenti a un filtro OData (Open Data Protocol).

## ESEMPI

### Esempio 1: Ottenere la pianificazione di un processo specificando un ID
```
...
Questo comando recupera la pianificazione del processo con l'ID JobSchedule23.
Usare il cmdlet Get-AzBatchAccountKey per assegnare un contesto alla $Context variabile.

### Esempio 2: Ottenere le pianificazioni dei processi con un filtro
```
...
Questo comando recupera tutte le pianificazioni di processo che hanno ID che iniziano con Job specificando il *parametro Filter.*
...
Questo cmdlet restituisce le pianificazioni dei processi che corrispondono al filtro specificato da questo parametro.
Se non si specifica un filtro, questo cmdlet restituisce tutte le pianificazioni dei processi per il contesto Batch.
...
### -Id
Specifica l'ID della pianificazione del processo che riceve questo cmdlet.
...
### -MaxCount
Specifica il numero massimo di pianificazioni di processi da restituire.
