...
## DESCRIZIONE
Il cmdlet **Get-AzBatchApplicationPackage** ottiene informazioni su un pacchetto dell'applicazione in un account batch di Azure.

## ESEMPI

### Esempio 1: Ottenere i dettagli di un pacchetto dell'applicazione in un account batch
```
...
Questo comando recupera i dettagli della versione 1.0 del pacchetto Litware.

## PARAMETERS

### -AccountName
Specifica il nome dell'account batch da cui il cmdlet riceve informazioni.
