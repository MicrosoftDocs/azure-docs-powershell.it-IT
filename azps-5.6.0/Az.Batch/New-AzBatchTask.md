...
Questo comando recupera il processo batch con l'ID Job-000001 usando il cmdlet **Get-AzBatchJob.**
...
Il comando finale recupera il processo batch con l'ID Job-000001 usando **Get-AzBatchJob.**
...
### -AffinityInformation
Specifica un suggerimento sulla localizzazione che il servizio batch usa per selezionare un nodo in cui eseguire l'attività.
