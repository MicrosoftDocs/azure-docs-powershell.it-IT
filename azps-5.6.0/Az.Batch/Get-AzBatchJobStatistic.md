...
## SYNOPSIS
Recupera le statistiche di riepilogo del processo per un account batch.
...
## DESCRIZIONE
Il cmdlet **Get-AzBatchJobStatistic** ottiene le statistiche di riepilogo della durata per tutti i processi in un account batch di Azure.
Le statistiche vengono aggregate per tutti i processi che sono mai stati esistiti nell'account, dalla creazione dell'account all'ultima ora di aggiornamento delle statistiche.
...
Il secondo comando recupera le statistiche di riepilogo per tutti i processi.
Il comando usa il $Context del primo comando.
