...
Crea un riferimento `PSResourceFile` a un URL del contenitore di archiviazione di Azure. Tutti i file nel contenitore verranno scaricati nella cartella specificata.
