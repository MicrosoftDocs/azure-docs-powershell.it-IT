...
Il secondo comando usa quindi il riferimento all'oggetto e il cmdlet **Get-AzBatchSubtask** per restituire tutte le sottoattività per myTask, un'attività che viene eseguita come parte del processo Job-01.
...
### -Attività
Specifica un riferimento a un oggetto all'attività che contiene le sottoattività restituite da questo cmdlet.
