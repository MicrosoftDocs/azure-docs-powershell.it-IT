...
## DESCRIZIONE
Aggiornare una definizione di progetto e salvarla all'interno della sottoscrizione o del gruppo di gestione specificato.
...
Aggiornare la definizione di una progetto con nuovi parametri.
...
### -SubscriptionId
ID sottoscrizione in cui verrà o sarà salvata la definizione del progetto.
