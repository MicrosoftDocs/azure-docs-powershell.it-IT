...
## DESCRIZIONE
Rimuovi una progetto progetto che è stata assegnata a un abbonamento.
...
Rimuovere l'assegnazione di progetto specificata dal nome dalla sottoscrizione specificata. Il cmdlet richiederà conferma prima di eseguire il comando.
...
### -PassThru
Quando è impostato, il cmdlet restituisce un oggetto che rappresenta l'assegnazione del progetto rimossa. Per impostazione predefinita, questo cmdlet non genera alcun output.
