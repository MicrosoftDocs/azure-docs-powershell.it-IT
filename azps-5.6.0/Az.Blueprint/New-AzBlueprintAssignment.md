...
Creare una nuova assegnazione della progetto della definizione del progetto all'interno della sottoscrizione specificata usando il dizionario del parametro definito e del `$blueprintObject` gruppo di risorse. Usa le identità assegnate dal sistema. La posizione definisce l'area geografica per la creazione dell'identità gestita.
...
Creare una nuova assegnazione della progetto della definizione del progetto all'interno della sottoscrizione specificata usando il dizionario del parametro definito e del gruppo di risorse e configurando il blocco delle risorse `$blueprintObject` **su AllResources.** Per impostazione predefinita, viene utilizzato l'uso delle identità assegnate dal sistema.  La posizione definisce l'area geografica per la creazione dell'identità gestita.
