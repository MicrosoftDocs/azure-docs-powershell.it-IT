...
### Esempio 2: Rimuovere un gruppo di contenitori tramite piping
```
PS C:\> Get-AzContainerGroup -ResourceGroupName MyResourceGroup -Name MyContainer | Remove-AzContainerGroup
```

Questo comando rimuove un gruppo di contenitori tramite l'esecuzione di piping.
...
Questo comando rimuove un gruppo di contenitori in base all'ID risorsa.
...
### -InputObject
Il gruppo di contenitori da rimuovere.
