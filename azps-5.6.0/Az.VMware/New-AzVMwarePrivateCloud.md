...
Creare cloud privato

## PARAMETERS

### -AcceptEULA
Accettare il contratto di licenza di AVS, il termine legale verrà visualizzato senza questo parametro fornito
...
### -NetworkBlock
Il blocco di indirizzi deve essere univoco sia in VNet nell'abbonamento che in locale.
Assicurarsi che il formato CIDR sia conforme a (A.B.C.D/X) in cui A,B,C,D è compreso tra 0 e 255 e X è compreso tra 0 e 22
...
### -NsxtPassword
Facoltativamente, impostare la password di Gestione NSX-T al momento della creazione del cloud privato
...
### -VcenterPassword
Facoltativamente, impostare la password di amministratore vCenter al momento della creazione del cloud privato
