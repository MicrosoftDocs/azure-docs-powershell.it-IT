...
## DESCRIZIONE
Il Invoke-AzDataMigrationCommand cmdlet crea una nuova attività di comando da eseguire su un'attività di migrazione esistente.
...
Negli esempi precedenti viene utilizzato il cmdlet Invoke-AzDataMigrationCommand per creare un comando per un servizio, un progetto e un'attività esistenti
...
### -TaskName
Nome dell'attività su cui viene eseguito il comando.
...
```
### -ObjectName
Nome dell'oggetto di database su cui verrà eseguito il comando.
