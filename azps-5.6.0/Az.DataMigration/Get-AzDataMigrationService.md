...
## DESCRIZIONE
Il cmdlet Get-AzDataMigrationService recupera le proprietà associate a un'istanza del servizio di migrazione del database di Azure in base al nome del servizio e al nome del gruppo di risorse di Azure come parametri di input. 
...
L'esempio precedente recupera i servizi di migrazione del database di Azure nel gruppo di risorse denominato testResourceGroup. 
