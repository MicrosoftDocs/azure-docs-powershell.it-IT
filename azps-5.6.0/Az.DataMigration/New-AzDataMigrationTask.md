...
### -Wait
Se aspettare il completamento dell'attività. Se il contrassegno è impostato, controlla ogni un secondo finché l'attività non viene completata e torna alle proprietà dell'attività in cui è possibile controllare l'output o l'errore. 
```yaml
