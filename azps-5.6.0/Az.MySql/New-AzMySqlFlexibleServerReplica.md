...
MASTER: <IServerAutoGenerated> oggetto server di origine da cui creare la replica.
  ...
  - `[AdministratorLoginPassword <SecureString>]`: password dell'accesso dell'amministratore (necessaria per la creazione del server).
  ...
  - `[SourceServerId <String>]`: l'ID server MySQL di origine.
