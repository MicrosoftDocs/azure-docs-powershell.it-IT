...
Il primo comando ottiene un gruppo di risorse denominato ResourceGroup11 usando il cmdlet Get-AzureRMResourceGroup e lo archivia nella variabile $ResourceGroup.
Il secondo comando ottiene la definizione dei criteri denominata VirtualMachinePolicy usando il cmdlet Get-AzureRmPolicyDefinition e lo archivia nella variabile $Policy.
...
Il primo comando ottiene un gruppo di risorse denominato ResourceGroup11 usando il cmdlet Get-AzureRMResourceGroup e lo archivia nella variabile $ResourceGroup.
Il secondo comando ottiene la definizione dei criteri predefinita per i percorsi consentiti usando il cmdlet Get-AzureRmPolicyDefinition e lo archivia nella variabile $Policy.
...
### -SKU
Tabella hash che rappresenta le proprietà SKU. Per impostazione predefinita, il codice SKU gratuito contiene i valori: `@{Name = 'A0'; Tier = 'Free'}` . Per usare l'USK standard, usare i valori: `@{Name = 'A1'; Tier = 'Standard'}` .
