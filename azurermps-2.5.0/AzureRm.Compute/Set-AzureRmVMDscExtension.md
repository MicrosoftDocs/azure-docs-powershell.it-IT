...
Il file Sample.ps1.zip è stato precedentemente caricato tramite **Publish-AzureRmVMDscConfiguration**.
...
La Sample.ps1.zip è stata precedentemente caricata usando **Publish-AzureRmVMDscConfiguration**.
