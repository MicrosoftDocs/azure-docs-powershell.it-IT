...
## Descrizione
Il cmdlet Get-AzureRmNetworkWatcherConnectionMonitorReport restituisce il report sugli stati di connessione più recenti.

## ESEMPI

### ---------------Esempio 1: ottenere lo snapshot della connessione più recente del monitor di connessione per nome nella posizione specificata---------------
```
...
In questo esempio vengono interrogati gli Stati di connessione più recenti del monitor di connessione specificato.
