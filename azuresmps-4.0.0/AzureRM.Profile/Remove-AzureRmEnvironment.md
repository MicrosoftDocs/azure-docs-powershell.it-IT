...
## Descrizione
Il cmdlet Remove-AzureRmEnvironment rimuove gli endpoint e le informazioni sui metadati per la connessione a una determinata istanza di Azure.
...
Questo esempio Mostra come creare un ambiente usando Add-AzureRmEnvironment e quindi come eliminare l'ambiente tramite Remove-AzureRmEnvironment.
