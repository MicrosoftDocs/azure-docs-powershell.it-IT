...
### -AbsoluteUri
URI assoluto per l'origine.
Notare che le credenziali devono essere fornite nell'URI, se l'origine ne richiede.
...
### -CloudBlob
Oggetto CloudBlob dalla raccolta client di archiviazione di Azure.
Puoi crearlo o usare Get-AzureStorageBlob cmdlet.
...
Puoi crearlo o usare Get-AzureStorageContainer cmdlet.
...
### -Contesto
Contesto di archiviazione di Azure di origine.
...
### -DestContext
Contesto di archiviazione di Azure di destinazione.
Puoi crearla tramite il cmdlet New-AzureStorageContext.
