...
## Sinossi
Associa un gruppo di sicurezza di rete a una subnet.
...
## Descrizione
Il cmdlet **set-AzureNetworkSecurityGroupToSubnet** associa un gruppo di sicurezza di rete Azure a una subnet.
...
### -Force
Indica che questo cmdlet non chiede di confermare la rimozione di un gruppo di sicurezza di rete precedente dalla subnet.
...
### -Nome
Specifica il nome del gruppo di sicurezza della rete che questo cmdlet associa a una subnet.
...
### -SubnetName
Specifica il nome di una subnet a cui questo cmdlet associa un gruppo di sicurezza di rete.
...
Questo cmdlet associa un gruppo di sicurezza di rete a una subnet nella rete virtuale specificata da questo parametro.
