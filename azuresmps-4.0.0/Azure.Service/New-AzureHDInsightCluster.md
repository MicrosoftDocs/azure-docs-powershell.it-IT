...
### Cluster per configurazione (con credenziali di sottoscrizione specifiche) (impostazione predefinita)
```
...
Il cmdlet **New-AzureHDInsightCluster** crea un cluster HDInsight di Azure usando i parametri specificati o usando un oggetto Configuration creato usando il cmdlet **New-AzureHDInsightClusterConfig** .
...
Questo esempio crea un cluster HDInsight per l'abbonamento corrente.
...
### -Config
Specifica un oggetto Configuration creato usando il cmdlet **New-AzureHDInsightClusterConfig** .
...
### -Credenziale
Specifica le credenziali utente per HDInsight da usare per l'account predefinito usato per accedere in remoto a un cluster Hadoop.
Queste credenziali sono distinte dalle credenziali di sottoscrizione dell'utente.
...
### -Posizione
Specifica l'area geografica in cui creare un cluster HDInsight.
...
### -Nome
Specifica il nome del cluster di Azure HDInsight da creare.
...
### -SshCredential
Specifica il nome utente e la password di Secure Shell (SSH) per il cluster HDInsight.
Questo parametro è valido solo per i cluster Linux.
...
### -SshPublicKey
Specifica la chiave pubblica SSH per un cluster HDInsight.
Questo parametro è valido solo per i cluster Linux.
...
### -Sottoscrizione
Specifica l'abbonamento a Azure in cui creare un cluster HDInsight.
