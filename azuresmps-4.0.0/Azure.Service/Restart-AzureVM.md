...
## Descrizione
Il cmdlet **Restart-AzureVM** richiede il riavvio di una macchina virtuale di Azure.
...
Questo comando Riavvia la macchina virtuale VirtualMachine27 in uso in Azure Service denominata Service01.

### Esempio 2: riavviare una macchina virtuale usando un oggetto macchina virtuale
```
PS C:\> Get-AzureVM -ServiceName "MyService01" -Name "VirtualMachine27" | Restart-AzureVM
```

Questo comando Recupera l'oggetto macchina virtuale per la macchina virtuale denominato MyVM e lo riavvia.
...
### -InitiateMaintenance
Avviare la manutenzione nella macchina virtuale
...
### -Nome
Specifica il nome della macchina virtuale da riavviare.
...
### -Ridistribuire
Indica che il cmdlet ridistribuisce la macchina virtuale.
...
### -ServiceName
Specifica il nome del servizio Azure che contiene la macchina virtuale da riavviare.
...
### -VM
Specifica un oggetto macchina virtuale che identifica la macchina virtuale da riavviare.
