...
## Descrizione
Il cmdlet **Send-AzureRemoteAppSessionMessage** Invia un messaggio a un utente connesso a una sessione RemoteApp di Azure.

## ESEMPI

### Esempio 1: inviare un messaggio a un utente
```
...
Questo comando Invia un messaggio all'utente il cui UPN è PattiFuller@contoso.com .
