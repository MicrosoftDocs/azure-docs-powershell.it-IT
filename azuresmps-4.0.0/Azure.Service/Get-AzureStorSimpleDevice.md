...
## Sinossi
Ottiene i dispositivi allegati alla risorsa.
...
## Descrizione
Il cmdlet **Get-AzureStorSimpleDevice** ottiene un elenco dei dispositivi StorSimple allegati alla risorsa.
Puoi specificare ID dispositivo, nome, ID modello e tipo.
Usa la proprietà **DeviceID** ottenuta usando questo cmdlet per specificare i dispositivi per altri cmdlet di StorSimple.

## ESEMPI

### Esempio 1: ottenere i dispositivi disponibili in una risorsa
```
...
Questo comando consente di ottenere tutti i dispositivi disponibili in una risorsa.
In questo esempio è disponibile un solo dispositivo.

### Esempio 2: ottenere specifici dispositivi disponibili in una risorsa
```
...
Questo comando consente di ottenere tutti i dispositivi disponibili in una risorsa che ha il nome, il tipo e l'ID del modello specificati.

### Esempio 3: ottenere informazioni dettagliate per un dispositivo
```
...
Questo comando consente di ottenere tutti i dispositivi disponibili in una risorsa con il nome e il tipo specificati.
Questo comando specifica il parametro *detailed* .
Il comando fornisce dettagli aggiuntivi sui dispositivi restituiti.

## PARAMETRI

### -Dettagli
Indica che questo cmdlet restituisce i dettagli del dispositivo per i dispositivi ottenuti.
...
### -DeviceId
Specifica l'ID istanza del dispositivo da ottenere.
...
### -DeviceName
Specifica il nome del dispositivo StorSimple da ottenere.
...
### -ModelID
Specifica l'ID del modello di dispositivi StorSimple da ottenere.
...
### -Digitare
Specifica il tipo di dispositivo StorSimple.
I valori validi sono: Appliance e VirtualAppliance.
...
Questo cmdlet restituisce un **oggetto \<DeviceDetails\> List** , se specifichi il parametro *detailed* .
Se non specifichi tale parametro, restituisce un oggetto **IEnumerable \<DeviceInfo\>** .
