...
## Sinossi
Modifica le proprietà delle dimensioni di una macchina virtuale.
...
Il cmdlet **set-WAPackVM** modifica le proprietà delle dimensioni di una macchina virtuale.

## ESEMPI

### Esempio 1: specificare le dimensioni per una macchina virtuale
```
...
Il secondo comando ottiene il profilo di dimensione denominato MediumSizeVM usando il cmdlet **Get-WAPackVMSizeProfile** e quindi archivia tale oggetto nella variabile $SizeProfile.

Il comando finale assegna il profilo di dimensione archiviato in $SizeProfile alla macchina virtuale archiviata in $VirtualMachine.
