...
## Sinossi
Avvia la diagnostica del gateway per un gateway VPN.
...
## Descrizione
Il cmdlet **Start-AzureVNetGatewayDiagnostics** avvia una nuova sessione di diagnostica del gateway per un gateway VPN (Virtual Private Network).
...
### -VNetName
Specifica la rete virtuale che contiene un gateway di rete virtuale per cui questo cmdlet esegue la diagnostica.
