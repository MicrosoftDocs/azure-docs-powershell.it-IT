...
Il cmdlet **New-AzureAutomationSchedule** crea una pianificazione in Microsoft Azure Automation.

## ESEMPI

### Esempio 1: creare una pianificazione una tantum
```
PS C:\> New-AzureAutomationSchedule -AutomationAccountName "Contoso17" -Name "Schedule01" -StartTime "23:00" -OneTime
```

Il comando seguente crea una programmazione che viene eseguita una volta alla data corrente alle 11:00 PM.
...
I comandi seguenti creano una nuova pianificazione che viene eseguita a 1:00 PM ogni giorno per un anno a partire dal giorno corrente.
...
### -ExpiryTime
Specifica il periodo di scadenza di una programmazione.
Può essere fornita una stringa se può essere convertita in un valore **DateTime** valido.
...
### -Una tantum
Indica che questa operazione crea una pianificazione una tantum.
...
### -StartTime
Specifica l'ora di inizio di una pianificazione.
Può essere fornita una stringa se può essere convertita in un valore **DateTime** valido.
