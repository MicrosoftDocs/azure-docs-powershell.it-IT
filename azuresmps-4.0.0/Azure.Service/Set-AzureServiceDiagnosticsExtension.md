...
## Sinossi
Abilita l'estensione di diagnostica di Azure nei ruoli specificati o in tutti i ruoli in un servizio distribuito o alla distribuzione.
...
## Descrizione
Il cmdlet **set-AzureServiceDiagnosticsExtension** Abilita l'estensione di Azure Diagnostics nei ruoli specificati o in tutti i ruoli in un servizio distribuito o alla distribuzione.

## ESEMPI

### Esempio 1: Enable Azure Diagnostics Extension
```
...
Questo comando Abilita l'estensione di diagnostica di Azure per tutti i ruoli.

### Esempio 2: abilitare l'estensione di diagnostica Azure per un ruolo specificato
```
...
Questo comando Abilita l'estensione di diagnostica di Azure per un ruolo specificato.
...
Specifica una matrice di configurazione per la diagnostica Azure.
...
Specifica la configurazione per la diagnostica Azure.
Per scaricare lo schema, è possibile usare il comando seguente: 
...
### -Ruolo
Specifica una matrice facoltativa di ruoli per cui specificare la configurazione di Azure Diagnostics.
Se non specifichi questo parametro, la configurazione di diagnostica viene applicata come configurazione predefinita per tutti i ruoli.
