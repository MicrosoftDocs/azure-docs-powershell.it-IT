...
## Sinossi
Riavvia un processo di ripristino del sito.
...
## Descrizione
Il cmdlet **Restart-AzureSiteRecoveryJob riavvia** un processo di ripristino del sito di Azure.

## ESEMPI

### Esempio 1: riavviare un processo
```
...
Questo comando Riavvia il processo con l'ID specificato.

## PARAMETRI

### -ID
Specifica l'ID del processo da riavviare.
...
### -Job
Specifica il processo da riavviare.
