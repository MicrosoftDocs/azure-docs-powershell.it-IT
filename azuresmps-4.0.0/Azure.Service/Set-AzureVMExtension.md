...
## Sinossi
Imposta le estensioni delle risorse per le macchine virtuali.

## SINTASSI

### SetByExtensionName (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **set-AzureVMExtension** imposta le estensioni delle risorse per le macchine virtuali.

## ESEMPI

### Esempio 1: creare una macchina virtuale con le estensioni delle risorse applicate
```
...
Questo comando crea una macchina virtuale con le estensioni delle risorse applicate.
...
### -ExtensionName
Specifica il nome dell'estensione della macchina virtuale.
...
### -PrivateConfigKey
Specifica una chiave di configurazione privata.
...
### -PrivateConfigPath
Specifica il percorso di configurazione privato.
...
### -PublicConfigKey
Specifica la chiave di configurazione pubblica.
...
### -PublicConfigPath
Specifica il percorso di configurazione pubblica.
...
Si tratta di una stringa definita dall'utente che può essere usata per fare riferimento a un'estensione.
È necessario specificarlo quando l'estensione viene aggiunta alla macchina virtuale per la prima volta.
...
### -Disinstalla
Indica che questo cmdlet Disinstalla l'estensione della risorsa dalla macchina virtuale.
