...
## Sinossi
Ottiene informazioni sulle più recenti estensioni disponibili per le macchine virtuali.
...
## Descrizione
Il cmdlet **Get-AzureVMAvailableExtension** ottiene informazioni sulle più recenti estensioni disponibili per le macchine virtuali.

## ESEMPI

### Esempio 1: ottenere informazioni sulle più recenti estensioni disponibili
```
...
Questo comando consente di ottenere informazioni sulle più recenti estensioni disponibili per tutte le macchine virtuali.

### Esempio 2: ottenere informazioni da un nome di estensione specificato
```
...
Questo comando consente di ottenere informazioni da tutte le versioni dell'estensione denominate VMAccessAgent e dal server di pubblicazione denominato Microsoft. computer.

### Esempio 3: ottenere informazioni da una specifica estensione di una macchina virtuale in base al numero di versione
```
...
Questo comando ottiene le informazioni per l'estensione denominata VMAccessAgent e il server di pubblicazione denominato Microsoft. COMPUTE per l'estensione della versione 1.0.3.

## PARAMETRI

### -AllVersions
Indica che questo cmdlet elenca tutte le versioni di un'estensione.
...
### -ExtensionName
Specifica il nome dell'estensione disponibile.
...
### -Publisher
Specifica l'editore dell'estensione.
