...
## Sinossi
Esporta l'immagine del modello di una raccolta RemoteApp di Azure nell'account di archiviazione di Azure specificato.
...
## Descrizione
Il cmdlet **Export-AzureRemoteAppTemplateImage** Esporta l'immagine del modello di una raccolta RemoteApp di Azure nell'account di archiviazione di Azure specificato.

## ESEMPI

### Esempio 1: esportare un'immagine modello nell'account di archiviazione di Azure
```
...
Questo comando Esporta l'immagine del modello della raccolta denominata Contoso in un contenitore denominato ContainerName nell'account di archiviazione di Azure specificato con nome AccountName e Key AccountKey.
...
Indica che il cmdlet sovrascrive l'immagine del modello esistente.
