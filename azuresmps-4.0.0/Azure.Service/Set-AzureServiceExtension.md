...
## Sinossi
Aggiunge un'estensione del servizio cloud a una distribuzione.
...
## Descrizione
Il cmdlet **set-AzureServiceExtension** aggiunge un'estensione del servizio cloud a una distribuzione.

## ESEMPI

### Esempio 1: aggiungere un servizio cloud a una distribuzione
```
...
Questo comando aggiunge un servizio cloud a una distribuzione.

### Esempio 2: aggiungere un servizio cloud a una distribuzione per un ruolo specificato
```
...
Questo comando aggiunge un servizio cloud a una distribuzione per un ruolo specificato.
...
### -ThumbprintAlgorithm
Specifica l'algoritmo di hash delle identificazioni personali usato con l'identificazione personale per identificare il certificato.
