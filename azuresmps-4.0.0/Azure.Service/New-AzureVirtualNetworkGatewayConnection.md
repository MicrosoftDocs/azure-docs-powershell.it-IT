...
## Sinossi
Crea una connessione di rete Virtual gateway Azure.
...
## Descrizione
Il cmdlet **New-AzureVirtualNetworkGatewayConnection** crea una connessione di rete Virtual gateway Azure.
...
### -EnableBgp
Abilita il protocollo BGP (Border Gateway Protocol).
...
Specifica un nome per la connessione al gateway.
...
Specifica il tipo di connessione del gateway.
...
Specifica l'ID di un gateway di rete virtuale.
