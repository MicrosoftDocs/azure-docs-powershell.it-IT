...
## Sinossi
Imposta la chiave per un gateway di rete virtuale di Azure.
...
## Descrizione
Il cmdlet **set-AzureVirtualNetworkGatewayKey** imposta la chiave per un gateway di rete virtuale di Azure.
