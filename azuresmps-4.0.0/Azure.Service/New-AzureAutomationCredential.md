...
Crea una credenziale nell'automazione.
...
Il cmdlet **New-AzureAutomationCredential** crea una credenziale come oggetto **PSCredential** in Microsoft Azure Automation.
...
Questi comandi creano una credenziale denominata Credential.
Viene prima creato un oggetto Credential che include un nome utente e una password.
Questo viene quindi usato nell'ultimo comando per creare le credenziali di automazione.
