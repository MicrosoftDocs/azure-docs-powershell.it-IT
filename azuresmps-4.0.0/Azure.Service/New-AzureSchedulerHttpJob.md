...
## Sinossi
Crea un processo di pianificazione con un'azione HTTP.
...
Il cmdlet **New-AzureSchedulerHttpJob** crea un processo di pianificazione con un'azione http.

## ESEMPI

### Esempio 1: creare un processo HTTP
```
...
Questo comando crea un processo HTTP di pianificazione nella raccolta processi denominata JobCollection01.
Il comando specifica un URI e specifica GET come metodo.

### Esempio 2: creare un processo HTTP per un conteggio eseguito specifico
```
...
Questo comando crea il processo http dello scheduler nella raccolta processi denominata JobCollection01.
Il comando specifica un URI e specifica GET come metodo.
Questo comando causa l'esecuzione del processo 20 volte.
...
### -EndTime
Specifica un'ora, come oggetto **DateTime** , per l'utilità di pianificazione per interrompere l'avvio dei processi.
