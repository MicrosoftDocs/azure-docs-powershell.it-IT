...
## Sinossi
Ottiene i parametri IPsec per un gateway di rete virtuale di Azure.
...
## Descrizione
Il cmdlet **Get-AzureVirtualNetworkGatewayIPsecParameters** ottiene i parametri IPSec per un gateway di rete virtuale di Azure.
...
### -ConnectedEntityId
Specifica l'ID di una connessione connessa.
