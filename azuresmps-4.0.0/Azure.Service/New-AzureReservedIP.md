...
Questo comando crea un nuovo indirizzo IP riservato nell'abbonamento, che può essere usato per creare servizi cloud che includono computer Web, Worker e Virtual Machine.
