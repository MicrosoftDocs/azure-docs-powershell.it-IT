...
Il cmdlet **Start-AzureAutomationRunbook** avvia un processo di Runbook di automazione di Microsoft Azure.
...
Questo comando avvia un processo Runbook per la runbook denominata Runbk01 nell'account di automazione denominato Contoso17.
