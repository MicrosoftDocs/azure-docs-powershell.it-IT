...
## Sinossi
Ottiene le estensioni delle risorse applicate alle macchine virtuali.

## SINTASSI

### ListByReferenceName (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzureVMExtension** ottiene le estensioni delle risorse applicate alle macchine virtuali.

## ESEMPI

### Esempio 1: ottenere le estensioni delle risorse applicate a una macchina virtuale
```
PS C:\> Get-AzureVM -ServiceName $SVC -Name $VM | Get-AzureVMExtension;
```

Questo comando consente di ottenere le estensioni delle risorse applicate alla macchina virtuale specificata come archiviate nella variabile $VM.
