...
## SYNOPSIS
Crea un oggetto profilo di protezione di Ripristino siti.
...
## DESCRIZIONE
Il cmdlet **New-AzureSiteRecoveryProtectionProfileObject** crea un oggetto profilo di Azure Site Recovery.
...
Indica che il profilo di protezione consente l'eliminazione di entità replica.
...
I valori accettabili per questo parametro sono: Certificato e Kerberos.
...
### -CompressionEnabled
Indica che il profilo di protezione abilita la compressione.
...
Specifica il nome di un account di archiviazione di Azure in cui archiviare l'entità replica di Azure.
...
Specifica l'ID di una sottoscrizione di Azure per un account di archiviazione.
Questo parametro fa riferimento all'account in cui archiviare l'entità replica di Azure.
...
### -RecoveryPoints
Specifica il numero di ore per cui conservare i punti di ripristino.
...
Specifica l'intervallo di frequenza, in secondi, per la replica. I valori accettabili per questo parametro sono:
...
### -ReplicationMethod
Specifica il metodo di replica. I valori accettabili per questo parametro sono:
...
### -ReplicationPort
Specifica il numero di porta su cui si verifica la replica.
...
Specificare un tempo compreso tra 24 ore dopo l'avvio del processo.
