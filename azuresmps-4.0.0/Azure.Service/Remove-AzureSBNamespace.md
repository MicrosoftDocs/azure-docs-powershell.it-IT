...
Il cmdlet **Remove-AzureSBNamespace** rimuove uno spazio dei nomi del servizio per Service Bus.
...
### -Force
Se abilitato, rimuove lo spazio dei nomi senza richiedere conferma.
...
### -Nome
Specifica il nome dello spazio dei nomi da rimuovere.
...
### -PassThru
Fa sì che l'operazione restituisca true se riesce.
