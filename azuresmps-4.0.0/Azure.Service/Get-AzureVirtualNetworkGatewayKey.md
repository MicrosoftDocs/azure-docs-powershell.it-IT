...
## Sinossi
Ottiene la chiave per un gateway di rete virtuale di Azure.
...
## Descrizione
Il cmdlet **Get-AzureVirtualNetworkGatewayKey** ottiene la chiave per un gateway di rete virtuale di Azure.
