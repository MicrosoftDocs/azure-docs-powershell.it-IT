...
## Sinossi
Consente il download di immagini con estensione vhd.
...
## Descrizione
Il cmdlet **Save-AzureVhd** consente il download di immagini con estensione VHD da un BLOB in cui sono archiviate in un file.
Include parametri per configurare il processo di download specificando il numero di thread di Downloader usati o sovrascrivendo il file già esistente nel percorso di file specificato.

**Save-AzureVhd** non esegue alcuna conversione di formato VHD e il BLOB viene scaricato così com'è.

## ESEMPI

### Esempio 1: scaricare un file VHD
```
...
Questo comando Scarica un file con estensione vhd.

### Esempio 2: scaricare un file VHD e sovrascrivere il file locale
```
...
Questo comando Scarica un file con estensione vhd e sovrascrive qualsiasi file nel percorso di destinazione.

### Esempio 3: scaricare un file VHD e specificare il numero di thread
```
...
Questo comando Scarica un file con estensione vhd e specifica il numero di thread.

### Esempio 4: scaricare un file VHD e specificare la chiave di archiviazione
```
...
### -LocalFilePath
Specifica il percorso del file locale.
...
### -Sovrascrivere
Specifica che questo cmdlet elimina il file specificato dal file *LocalFilePath* , se esistente.
...
Se non è disponibile, **Salva-AzureVhd** tenta di determinare la chiave di archiviazione dell'account in *SourceUri* da Azure.
