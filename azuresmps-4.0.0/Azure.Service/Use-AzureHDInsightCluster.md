...
## Sinossi
Seleziona un cluster HDInsight per il cmdlet Invoke-AzureHDInsightHiveJob da usare per inviare i processi.
...
Il cmdlet **use-AzureHDInsightCluster** seleziona il cluster Azure HDInsight per il cmdlet **Invoke-AzureHDInsightHiveJob** da usare per inviare i processi.
...
Se non specifichi questo parametro, viene usato lo spazio dei nomi predefinito.
...
### -Nome
Specifica il nome del cluster usato dal cmdlet **Invoke-AzureHDInsightHiveJob** .
...
### -Sottoscrizione
Specifica l'abbonamento che contiene i cluster HDInsight da usare.
