...
## Descrizione
Il cmdlet **Get-AzureSiteRecoveryVM** ottiene informazioni sulle macchine virtuali gestite in Azure Site Recovery.

## ESEMPI

### Esempio 1: ottenere informazioni su una macchina virtuale
```
...
Il secondo comando recupera le informazioni sulle macchine virtuali in $ProtectionContainer.

## PARAMETRI

### -ID
Specifica l'ID della macchina virtuale che consente di ottenere informazioni.
...
Specifica l'ID di un contenitore protetto per cui ottenere informazioni.
