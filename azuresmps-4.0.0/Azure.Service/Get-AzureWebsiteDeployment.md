...
## Sinossi
Ottiene le distribuzioni per un sito Web.
...
Ottiene le distribuzioni per un sito Web in Azure.
...
### -Commitid
Specifica l'ID univoco per la distribuzione.
...
### -Dettagli
Mostra informazioni dettagliate sulle distribuzioni.
...
### -MaxResults
Specifica il numero più grande di risultati che si desidera venga restituito dal comando.
...
### -Nome
Specifica il nome del sito Web per cui si vogliono ottenere informazioni sulla distribuzione.
