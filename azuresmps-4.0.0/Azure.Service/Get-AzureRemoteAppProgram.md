...
## Sinossi
Recupera le proprietà di una o più applicazioni di Azure RemoteApp pubblicate per una raccolta.

## SINTASSI

### FilterByName (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzureRemoteAppProgram** recupera le proprietà di una o più applicazioni RemoteApp di Azure pubblicate per una raccolta.

## ESEMPI

### Esempio 1: recuperare le proprietà di un programma
```
...
Questo comando Visualizza le proprietà di un programma RemoteApp di Azure.
Il programma, denominato app Finance, si trova nella raccolta RemoteApp di Azure denominata ContosoApps.

## PARAMETRI

### -Alias
Specifica l'alias del programma per cui recuperare le proprietà.
...
### -RemoteAppProgram
Specifica il nome del programma per cui recuperare le proprietà.
