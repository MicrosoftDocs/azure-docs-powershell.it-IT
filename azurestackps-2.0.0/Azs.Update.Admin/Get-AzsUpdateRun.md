...
## Sinossi
Ottieni un'istanza di Update Run usando l'ID.
...
Se non viene specificato un valore UpdateName, Get-UpdateRun richiederà sempre l'input.
Una volta forniti, emetterà tutte le istanze di UpdateRun non riuscite o di successo

### Esempio 2: Get-AzsUpdateRun di UpdateName
```powershell
...
Recupererà tutti i UpdateRuns associati a un aggiornamento specifico

### Esempio 2: Get-AzsUpdateRun per nome
```powershell
...
Recupererà tutti i UpdateRuns associati a un aggiornamento specifico e a un nome specifico
