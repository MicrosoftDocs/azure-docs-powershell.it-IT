...
## Sinossi
Crea o aggiorna una quota di calcolo con i parametri di quota forniti.
...
### Esempio 1: creare una quota di calcolo con parametri predefiniti
```powershell
...
Tutti i parametri non specificati verranno impostati sul parametro predefinito, mostrato sopra.

### Esempio 2: creare una quota di calcolo con parametri personalizzati
```powershell
...
Personalizzare la quota con parametri. Tutti i parametri non specificati avranno un valore predefinito.

## PARAMETRI

### -AvailabilitySetCount
Numero massimo di set di disponibilità consentiti.
...
### -CoresCount
Numero massimo di core consentiti.
...
### -NewQuota
Contiene le informazioni sulle quote di calcolo usate per controllare l'allocazione delle risorse.
...
Numero massimo di dischi gestiti ed istantanee di tipo Premium consentiti.
...
Numero massimo di dischi gestiti ed istantanee di tipo standard consentiti.
...
### -VirtualMachineCount
Numero massimo di macchine virtuali consentite.
...
### -VMScaleSetCount
Numero massimo di set di scala consentiti.
...
NEWQUOTA <IQuota> : contiene le informazioni sulle quote di calcolo usate per controllare l'allocazione delle risorse.
