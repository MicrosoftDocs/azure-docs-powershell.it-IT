...
## Descrizione
Il cmdlet **New-AzureRmDeploymentManagerStep** crea un passaggio di distribuzione a cui è possibile fare riferimento in rollout.
Specificare il *nome* , *ResourceGroupName* e le proprietà obbligatorie.

Puoi modificare l'oggetto restituito localmente e quindi applicare le modifiche apportate al passaggio usando il cmdlet Set-AzureRmDeploymentManagerStep.
