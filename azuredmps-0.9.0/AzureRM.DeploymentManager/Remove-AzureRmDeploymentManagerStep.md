...
## Descrizione
Il cmdlet **Remove-AzureRmDeploymentManagerStep** Elimina un passaggio.
...
### Esempio 3: rimuovere un passaggio usando un oggetto restituito da New-AzureRmDeploymentManagerStep
```powershell
