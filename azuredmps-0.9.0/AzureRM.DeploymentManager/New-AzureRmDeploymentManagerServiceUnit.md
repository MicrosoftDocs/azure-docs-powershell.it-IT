...
## Descrizione
Il cmdlet **New-AzureRmDeploymentManagerServiceUnit** crea un servizio in un servizio in una topologia di servizio e restituisce un oggetto che rappresenta tale unità di servizio.
...
Il cmdlet restituisce un oggetto ServiceUnit. Puoi modificare l'oggetto localmente e quindi applicare le modifiche al servizio usando il cmdlet Set-AzureRmDeploymentManagerService.
