...
Nome host per il servizio gestito.
...
Numero di porta per il servizio gestito.
...
Token per l'accesso al servizio gestito.
...
Usa l'autenticazione del codice del dispositivo invece di un controllo browser. Questo è il tipo di autenticazione predefinito per PowerShell versione 6 e successive.
