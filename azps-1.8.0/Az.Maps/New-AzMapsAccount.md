...
## Descrizione
Il cmdlet New-AzMapsAccount crea un account di mappe Azure con l'USK specificata.
...
Crea un nuovo account di Azure Maps denominato account nel gruppo di risorse MyResourceGroup con il SKU S0 e un tag.
