...
## Descrizione
Il cmdlet **Get-AzSearchAdminKeyPair** ottiene la coppia di chiavi di amministrazione del servizio di ricerca di Azure.
...
L'esempio ottiene una coppia di chiavi di amministrazione del servizio di ricerca di Azure.
