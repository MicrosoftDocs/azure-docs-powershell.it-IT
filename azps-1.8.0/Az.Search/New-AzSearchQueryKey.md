...
## Descrizione
Il cmdlet **New-AzSearchQueryKey** crea una nuova chiave di query per il servizio di ricerca Azure.
...
L'esempio crea una nuova chiave di query per il servizio di ricerca di Azure.
...
### -Nome
Nome della chiave query del servizio di ricerca.
