...
Il primo cmdlet Disabilita i criteri di protezione del backup.

## PARAMETRI

### -BackupManagementType
Tipo di gestione di backup della risorsa (ad esempio: MAB, DPM).
...
### -WorkloadType
Tipo di carico di lavoro della risorsa (ad esempio: AzureVM, WindowsServer, AzureFiles).
