...
## Descrizione
Il cmdlet **New-AzAutomationCredential** crea una credenziale come oggetto **PSCredential** in Azure Automation.
...
Il comando finale crea una credenziale di automazione denominata ContosoCredential che usa $Credential.
...
### -ResourceGroupName
Specifica una descrizione per il gruppo di risorse per cui questo cmdlet crea una credenziale.
