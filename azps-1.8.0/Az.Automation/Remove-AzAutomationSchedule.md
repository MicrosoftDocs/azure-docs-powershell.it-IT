...
## Descrizione
Il cmdlet **Remove-AzAutomationSchedule** Elimina una programmazione da Azure Automation.
...
Questo comando Elimina la pianificazione denominata Schedule01 in account di automazione Contoso17 nel gruppo risorse ResourceGroup01.

## PARAMETRI

### -AutomationAccountName
Specifica il nome di un account di automazione per cui questo cmdlet rimuove una programmazione.
...
### -Nome
Specifica il nome per la pianificazione rimossa da questo cmdlet.
...
### -ResourceGroupName
Specifica il nome di un gruppo di risorse per cui questo cmdlet rimuove una programmazione.
