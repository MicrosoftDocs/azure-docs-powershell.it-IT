...
## Sinossi
Ottenere le chiavi dell'account degli ancoraggi spaziali
...
Ottenere le chiavi dello sviluppatore dell'account degli ancoraggi spaziali "esempio" dall'abbonamento corrente e dal gruppo di risorse "RG1".
...
Ottenere le chiavi dello sviluppatore dell'account degli ancoraggi spaziali "esempio" dall'abbonamento corrente e dal gruppo di risorse "RG1" con piping.
