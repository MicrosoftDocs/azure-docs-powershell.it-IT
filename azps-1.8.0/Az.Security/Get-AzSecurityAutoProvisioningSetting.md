...
## Descrizione
Le impostazioni di provisioning automatico consentono di decidere se si vuole che in Azure Security Center proviosion automaticamente un agente di sicurezza che verrà installato nella propria VM.
