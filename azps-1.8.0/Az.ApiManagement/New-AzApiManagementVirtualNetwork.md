...
Questo comando viene usato con il cmdlet **Update-AzApiManagementDeployment** .
...
Questo esempio crea una rete virtuale e quindi chiama il cmdlet **Update-AzApiManagementDeployment** .
