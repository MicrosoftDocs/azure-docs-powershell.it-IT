...
## Descrizione
Il cmdlet New-AzAnalysisServicesServer crea un nuovo server di Analysis Services
...
Crea un server denominato TestServer in Azure Region West-US e nel gruppo di risorse testresrourcegroup. Il livello SKU per il server sarà S1.

## PARAMETRI

### -Amministratore
Stringa che rappresenta un elenco delimitato da virgole di utenti o gruppi da impostare come amministratori nel server. Gli utenti o i gruppi devono essere specificati come formato user@contoso.com UPN, ad esempio groups@contoso.com
...
### -GatewayResourceId
ID risorsa gateway per assocaite in un server di analisi
...
### -Posizione
Area di Azure in cui è ospitato il server Analysis Services
