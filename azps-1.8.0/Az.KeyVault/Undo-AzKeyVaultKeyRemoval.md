...
## Descrizione
Il cmdlet **Undo-AzKeyVaultKeyRemoval** recupererà una chiave eliminata in precedenza.
...
Questo comando recupererà la chiave "MyKey" eliminata in precedenza in uno stato attivo e utilizzabile.
