...
Disabilitare un certificato se il valore è false.
Se non specificato, il valore esistente dello stato abilitato/disabilitato del certificato rimane invariato.
...
### -Tag
Hashtable che rappresenta i tag di certificato.
Se non specificato, i tag esistenti di Sertificate rimarranno invariati.
...
Cmdlet costruisce l'FQDN di un certificato dal nome del Vault, l'ambiente attualmente selezionato, il nome del certificato e la versione del certificato.
