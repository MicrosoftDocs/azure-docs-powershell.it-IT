...
### Esempio 2: creare una factory di dati con i dettagli di repoconfiguration usando un oggetto factory esistente.
```
...
### -HostName
Nome host per la configurazione di repo.
...
### -ProjectName
Nome del progetto per la configurazione di repo.
...
### -ID tenant
ID tenant per la configurazione dei repo.
