...
## Descrizione
Il cmdlet **New-AzDataFactoryGateway** crea un gateway in Azure Data Factory.
...
Questo comando crea un gateway denominato ContosoGateway nella data factory denominata WikiADF nel gruppo di risorse denominato ADF.

## PARAMETRI

### -DataFactory
Specifica un oggetto **PSDataFactory** .
Questo cmdlet crea un gateway per il Factory di dati specificato da questo parametro.
