...
## Descrizione
Il cmdlet **Update-AzDataFactoryV2IntegrationRuntime** aggiorna le proprietà di Integration Runtime. Attualmente il cmdlet supporta solo l'aggiornamento di "AutoUpdate" e "AutoUpdateDelayOffset" per l'integrazione autonoma di Runtime.

## ESEMPI

### Esempio 1: aggiorna un runtime di integrazione
```
...
L'ora in ore del giorno per l'aggiornamento automatico di runtime self-hosted Integration.
