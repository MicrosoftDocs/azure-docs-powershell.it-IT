...
## Descrizione
USA **Remove-AzServiceFabricNode** per rimuovere i nodi da un tipo di nodo specifico da un cluster. La rimozione procede solo se soddisfa le metriche di integrità del cluster.
