...
## Descrizione
Il cmdlet **Enable-AzSqlServerAdvancedThreatProtection** consente la protezione avanzata delle minacce in un server.

## ESEMPI

### Esempio 1-abilitare la protezione avanzata delle minacce del server
```powershell
...
### Esempio 2-abilitare il server Advanced Threat Protection da Resource Server
```powershell
