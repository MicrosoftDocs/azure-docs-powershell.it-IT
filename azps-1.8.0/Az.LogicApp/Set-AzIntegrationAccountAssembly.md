...
## Descrizione
Il cmdlet **set-AzIntegrationAccountAssembly** modifica un assembly dell'account di integrazione.
...
Modifica l'assembly denominato "sampleAssembly" usando il file locale che si trova nel percorso del file contenuto in "$localAssemblyFilePath".

### Esempio 2: modificare un assembly usando i dati di byte
```powershell
...
Modifica l'assembly denominato "sampleAssembly" usando la matrice di byte contenuta in "$assemblyContent".

### Esempio 3: modificare un assembly usando un collegamento contenuto
```powershell
...
Modifica l'assembly denominato "sampleAssembly" usando i dati a byte presenti nell'URL "$assemblyUrl". Questo è il metodo suggerito per la creazione di assembly di grandi dimensioni.

## PARAMETRI

### -AssemblyData
Dati del byte dell'assembly dell'account di integrazione.
...
### -AssemblyFilePath
Percorso del file dell'assembly dell'account di integrazione.
...
### -ContentLink
Un collegamento accessibile pubblicamente ai dati dell'assembly dell'account di integrazione.
