...
## Descrizione
Il cmdlet **Get-AzIntegrationAccountAssembly** ottiene un assembly da un account di integrazione.

## ESEMPI

### Esempio 1: ottenere un assembly in base a parametri
```powershell
...
Ottenere un assembly denominato "sampleAssembly" situato nell'account di integrazione "sampleIntegrationAccount" contenuto nel gruppo di risorse "sampleResourceGroup".

### Esempio 2: elencare tutti gli assembly in un account di integrazione per parametri
```powershell
...
Ottenere tutti gli assembly presenti nell'account di integrazione "sampleIntegrationAccount" contenuto nel gruppo di risorse "sampleResourceGroup".
