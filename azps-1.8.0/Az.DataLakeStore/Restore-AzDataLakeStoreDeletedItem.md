...
## Descrizione
Il cmdlet **Restore-AzDataLakeStoreDeletedItem** ripristina un file o una cartella eliminata in data Lake Store. Richiede il percorso dell'elemento eliminato nel cestino retunred da Get-AzDataLakeStoreDeletedItem.
