...
Questo comando crea un'origine dati Application-Insights di una determinata applicazione in un workpsace di analisi del log specifico. In questo modo, la raccolta di log da un'applicazione specificata alla workpsace analisi log.
