...
## Descrizione
Il cmdlet **Add-AzWebtestAlertRule** aggiunge o aggiorna una regola di avviso di tipo Metric, Event o WebTest.
...
### Esempio 1: aggiungere una regola di avviso di WebTest
```
...
Questo comando aggiunge o aggiorna una regola di avviso di WebTest.
...
### -FailedLocationCount
Specifica il conteggio della posizione non riuscito per le regole di WebTest.
Questa operazione è simile alla soglia degli altri tipi di regole.
...
### -MetricNamespace
Specifica lo spazio dei nomi Metric per Rule.
...
### -TargetResourceUri
Specifica l'ID risorsa del WebTest.
