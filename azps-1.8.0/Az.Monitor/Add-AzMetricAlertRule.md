...
## Descrizione
Il cmdlet **Add-AzMetricAlertRule** aggiunge o aggiorna una regola di avviso basata su metriche.
...
### Esempio 1: aggiungere una regola di avviso metrica a un sito Web
```
...
Questo comando crea una regola di avviso metrica per un sito Web.

### Esempio 2: disabilitare una regola
```
...
Questo comando Disabilita una regola.
Se la regola non esiste, la crea disabilitata.
Se la regola esiste, viene semplicemente disabilitata.

### Esempio 3: aggiungere una regola con le azioni
```
...
### -Posizione
Specifica la posizione in cui è definita la regola.
...
### -Metricname
Specifica il nome della metrica che la regola sta monitorando.
Specifica questo parametro solo per le regole basate su metriche.
...
### -Operator
Specifica l'operatore relazionale per la condizione della regola.
...
### -TargetResourceId
Specifica l'ID della risorsa che la regola sta monitorando. Nota: non è possibile aggiornare questa proprietà per una regola di avviso esistente.
...
### -Soglia
Specifica la soglia della regola.
...
Specifica l'operatore di aggregazione da applicare alla finestra temporale quando la regola viene valutata.
...
### -WindowSize
Specifica le dimensioni della finestra temporale per la regola per calcolare i dati.
...
### System. Nullable ' 1 [[Microsoft. Azure. Management. monitor. Management. Models. TimeAggregationOperator, Microsoft. Azure. PowerShell. cmdlet. monitor, versione = 1.0.0.0, Culture = neutral, PublicKeyToken = null]]

### System. Management. Automation. SwitchParameter

### System. Collections. Generic. list ' 1 [[Microsoft. Azure. Management. monitor. Management. Models. RuleAction, Microsoft. Azure. PowerShell. cmdlet. monitor, versione = 1.0.0.0, Culture = neutral, PublicKeyToken = null]]
