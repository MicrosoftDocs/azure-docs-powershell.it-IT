...
## Descrizione
Questo comando consente di modificare i parametri regolabili di un endpoint server. Per i criteri di tiering cloud di esempio e di livelli cloud, è possibile modificarli in qualsiasi momento. Diversi aspetti di un endpoint server, ad esempio il percorso locale, non possono essere modificati dopo la creazione dell'endpoint del server.
