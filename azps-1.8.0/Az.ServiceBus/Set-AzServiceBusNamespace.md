...
## Descrizione
Il cmdlet **set-AzServiceBusNamespace** aggiorna la descrizione dello spazio dei nomi Service Bus specificato all'interno del gruppo di risorse.
...
Aggiorna lo spazio dei nomi Service Bus con una nuova descrizione.
...
### -SkuCapacity
Capacità SKU dello spazio dei nomi.
...
### -Confermare
Aggiorna lo spazio dei nomi Service Bus con le informazioni specificate.
