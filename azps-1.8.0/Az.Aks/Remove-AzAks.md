...
### Eliminare un cluster Kubernetes gestito esistente
```
...
### -Force
Rimuovere il cluster gestito di Kubernetes senza richiesta
...
### -PassThru
Restituisce vero se l'eliminazione è riuscita
