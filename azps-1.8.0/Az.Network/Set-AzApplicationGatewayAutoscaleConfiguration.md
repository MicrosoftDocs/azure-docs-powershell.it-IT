...
Il secondo comando Aggiorna la configurazione di scala automatica dal gateway applicationg.
...
### -MaxCapacity
Portata massimo per il gateway applicazione.
...
### -MinCapacity
Portata minima per gateway applicazione.
