...
Ottiene tutte le variabili del server disponibili, le intestazioni di richiesta e risposta.
...
Il cmdlet Get-AzInterfaceEndpoint ottiene un endpoint di interfaccia.
