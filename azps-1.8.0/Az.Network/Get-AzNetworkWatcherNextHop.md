...
## DESCRIZIONE
Il Get-AzNetworkWatcherNextHop cmdlet ottiene l'hop successivo da una macchina virtuale.
L'hop successivo consente di visualizzare il tipo di risorsa azure, l'indirizzo IP associato della risorsa e la regola della tabella di routing responsabile della route.
...
Ottenere l'hop successivo per le comunicazioni in uscita dall'interfaccia di rete primaria nell'intervallo virtuale specificato per la porta 204.79.197.200 (www.bing.com)
