...
## SYNOPSIS
Crea un nuovo oggetto profilo di diagnostica della configurazione di rete. Questo oggetto viene usato per limitare l'accesso di rete durante una sessione di diagnostica usando i criteri specificati.
...
## DESCRIZIONE
Il cmdlet New-AzNetworkWatcherNetworkConfigurationDiagnosticProfile crea un nuovo oggetto profilo di diagnostica. Questo oggetto viene usato per limitare l'accesso alla rete durante una sessione di diagnostica di configurazione di rete usando i criteri specificati.
