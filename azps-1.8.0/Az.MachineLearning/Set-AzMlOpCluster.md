...
### SetByIndividualParameters (impostazione predefinita)
```
...
## Descrizione
Imposta tutte le proprietà di un cluster di operatività. Poiché imposta tutte le proprietà quando si usa un oggetto cluster, è necessario che venga passato un oggetto di input completamente valido. Le proprietà di sola lettura verranno ignorate. Solo alcune proprietà sono attualmente aggiornabili, come illustrato nei set di parametri.

## ESEMPI

### Esempio 1
Aggiornare un cluster usando singoli parametri.
...
### Esempio 2
Aggiornare un cluster usando un oggetto di input.
...
### -SslCertificate
Dati del certificato SSL in formato PEM.
...
### -SslKey
Dati della chiave SSL in formato PEM.
