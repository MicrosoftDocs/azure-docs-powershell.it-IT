...
## Sinossi
Aggiorna un pool di file di Azure NetApp (ANF) con il nuovo set di dati.
...
## Descrizione
Il cmdlet **Update-AzNetAppFilesPool** modifica un pool di ANF.

## ESEMPI

### Esempio 1: modificare un pool di ANF
```
...
Questo comando modifica il pool di ANF "MyAnfPool" per avere le dimensioni e il ServiceLevel specificati.
...
### -AccountObject
L'oggetto account che contiene il pool da aggiornare
...
### -ServiceLevel
Livello di servizio del pool di ANF
