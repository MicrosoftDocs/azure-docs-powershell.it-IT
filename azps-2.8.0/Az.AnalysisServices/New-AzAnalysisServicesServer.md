...
Crea un server denominato TestServer in Azure Region West-US e nel gruppo di risorse testresourcegroup. Il livello SKU per il server sarà S1.
...
### -GatewayResourceId
ID risorsa gateway da associare a un server di analisi
