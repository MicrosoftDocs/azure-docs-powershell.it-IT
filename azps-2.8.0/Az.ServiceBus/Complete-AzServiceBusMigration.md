...
## Descrizione
I cmdlet **complete-AzServiceBusMigration** impostano la migrazione dallo spazio dei nomi standard a Premium come le stringhe complete e di connessione dello spazio dei nomi standard ora puntano allo spazio dei nomi Premium
...
### -InputObject
Configurazione della migrazione di Service Bus-oggetto standard dello spazio dei nomi
...
### -ResourceId
Migrazione di Service Bus-ID standard delle risorse dello spazio dei nomi
