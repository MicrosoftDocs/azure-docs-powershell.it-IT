...
## Sinossi
Genera una regola di autorizzazione SAS Tolen for Azure ServiceBus di Namespace/Queue/Topic. 
...
## Descrizione
Il cmdlet New-AzServiceBusAuthorizationRuleSASToken genera un token SAS (Shared Access Signature) per un file Azure Eventhub o un Eventhub di Azure
