...
## Descrizione
Il cmdlet **Remove-AzServiceBusMigration** Elimina la configurazione di migrazione per gli spazi dei nomi premium standard
...
Elimina la configurazione di migrazione "TestingNamespaceStandardMigration"
...
### -InputObject
Oggetto spazio dei nomi standard di migrazione Service Bus
...
### -ResourceId
ID risorsa dello spazio dei nomi standard di migrazione Service Bus
