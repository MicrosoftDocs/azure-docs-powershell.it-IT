...
## DESCRIZIONE
Il cmdlet **New-AzActionGroup** crea un oggetto riferimento al gruppo di azioni in memoria.

## ESEMPI

### Esempio 1: Creare un oggetto riferimento a un gruppo di azioni in memoria
```
