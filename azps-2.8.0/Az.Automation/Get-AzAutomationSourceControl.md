...
## Descrizione
Il cmdlet Get-AzAutomationSourceControl ottiene i controlli di origine di automazione.
Per ottenere uno specifico controllo del codice sorgente, specificarne il nome.

## ESEMPI

### Esempio 1
Questo comando ottiene un controllo origine di automazione denominato VSTSNative nell'account denominato devAccount.
