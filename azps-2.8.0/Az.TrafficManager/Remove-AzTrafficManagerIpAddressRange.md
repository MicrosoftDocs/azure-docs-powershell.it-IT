...
## Descrizione
Il cmdlet **Remove-AzTrafficManagerIpAddressRange** rimuove un intervallo di indirizzi IP da un oggetto endpoint di Azure Traffic Manager locale.
...
### Esempio 1: rimuovere gli intervalli di indirizzi IP da un endpoint
```
...
### -Primo
Specifica il primo indirizzo IP nell'intervallo da rimuovere.
