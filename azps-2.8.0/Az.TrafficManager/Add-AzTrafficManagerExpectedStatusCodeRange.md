...
## Descrizione
Il cmdlet **Add-AzTrafficManagerExpectedStatusCodeRange** aggiunge un intervallo di codici di stato previsti a un oggetto profilo di Azure Traffic Manager locale.
...
Il secondo comando aggiunge un intervallo di codice di stato previsto al profilo archiviato in $TrafficManagerProfile.
...
### -Max
Specifica il valore massimo nell'intervallo di codice di stato da aggiungere.
...
### -Min
Specifica il valore più basso nell'intervallo di codice di stato da aggiungere.
