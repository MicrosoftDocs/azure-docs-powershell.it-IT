...
Puoi aggiornare l'oggetto profilo locale usando il cmdlet Add-AzTrafficManagerEndpointConfig.
Quindi carica le modifiche a Traffic Manager usando il cmdlet Set-AzTrafficManagerProfile.
...
Elenco degli intervalli di codice di stato HTTP previsti per le richieste di probe.
...
### -MaxReturn
Numero massimo di risposte restituite per i profili con un metodo di routing multivalore.
