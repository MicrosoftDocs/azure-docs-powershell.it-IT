...
## Descrizione
Il cmdlet Set-AzEventHubNamespace aggiorna le proprietà dello spazio dei nomi degli hub eventi specificati.
...
Aggiorna i tag per lo spazio dei nomi NamespaceName \` \` in created.
...
Aggiorna lo stato dello spazio dei nomi MyNamespace \` \` con AutoInflate = Enabled e MaximumThroughputUnits = 10
...
### -Tag
Hashtable che rappresenta il tag di risorsa.
