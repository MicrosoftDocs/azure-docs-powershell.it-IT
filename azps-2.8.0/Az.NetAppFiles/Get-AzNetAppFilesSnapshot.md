...
### Esempio 1: ottenere uno snapshot di ANF
```
...
Questo comando ottiene lo snapshot denominato MyAnfSnapshot dal volume "MyAnfVolume".
...
### -VolumeObject
Oggetto volume che contiene lo snapshot da restituire
