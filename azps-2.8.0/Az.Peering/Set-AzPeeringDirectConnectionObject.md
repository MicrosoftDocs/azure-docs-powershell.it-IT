...
## Descrizione
Usato in combinazione con Update-AzPeering, si tratta di un'operazione in memoria che verrà mantenuta solo con `Update-AzPeering` . 

## ESEMPI

### Larghezza di banda di aggiornamento
```powershell
...
### Aggiornare l'uso per il servizio peering
```powershell
...
Aggiorna la connessione per l'utilizzo con il servizio peering
