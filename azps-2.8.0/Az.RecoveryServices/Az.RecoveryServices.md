...
Abilita il backup automatico per un elemento protetto con un criterio di protezione del backup specificato.
...
Ottenere gli elementi protetti da un contenitore.
...
Ottenere intervalli di tempo per un elemento di cui è stato eseguito il backup.
...
Ottenere piano di ripristino per un elemento di backup.
...
Chiede informazioni per la nuova DBs nel carico di lavoro.
...
Registra un contenitore protetto.
