...
# Modulo AZ. LogicApp
## Descrizione
Questo argomento Mostra gli argomenti della Guida per i cmdlet delle app logiche.

## Cmdlet AZ. LogicApp
### [Get-AzIntegrationAccount](Get-AzIntegrationAccount.md)
Ottiene gli account di integrazione.
...
Ottiene un assembly dell'account di integrazione.
...
Ottiene i certificati degli account di integrazione da un gruppo di risorse.
...
Ottiene una mappa degli account di integrazione.

### [Get-AzIntegrationAccountPartner](Get-AzIntegrationAccountPartner.md)
Ottiene partner account di integrazione.
...
Ottiene gli schemi dell'account di integrazione.
...
Ottiene la cronologia di esecuzione di un'app logica.

### [Get-AzLogicAppTrigger](Get-AzLogicAppTrigger.md)
Ottiene i trigger di un'app logica.

### [Get-AzLogicAppTriggerCallbackUrl](Get-AzLogicAppTriggerCallbackUrl.md)
Ottiene un URL di callback del trigger dell'app logica.

### [Get-AzLogicAppTriggerHistory](Get-AzLogicAppTriggerHistory.md)
Ottiene la cronologia dei trigger in un'app logica.
...
Crea un assembly dell'account di integrazione.

### [New-AzIntegrationAccountBatchConfiguration](New-AzIntegrationAccountBatchConfiguration.md)
Crea una configurazione batch account di integrazione.
...
Rimuove un contratto per l'account di integrazione.
...
Rimuove la configurazione batch di un account di integrazione.
...
Rimuove un partner account di integrazione.

### [Remove-AzIntegrationAccountReceivedIcn](Remove-AzIntegrationAccountReceivedIcn.md)
Questo cmdlet rimuove un numero di controllo di interscambio ricevuto specifico per contratto e valore numerico di controllo.

### [Remove-AzIntegrationAccountSchema](Remove-AzIntegrationAccountSchema.md)
Rimuove uno schema di account di integrazione.

### [Remove-AzLogicApp](Remove-AzLogicApp.md)
Rimuove un'app logica da un gruppo di risorse.
...
Modifica un assembly dell'account di integrazione.
...
Esegue un'app logica in un gruppo di risorse.
