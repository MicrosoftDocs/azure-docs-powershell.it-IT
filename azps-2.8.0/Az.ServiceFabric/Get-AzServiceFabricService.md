...
Questo esempio consente di ottenere i dettagli delle risorse del servizio per il servizio "testApp ~ testService".
...
Questo esempio consente di ottenere un elenco dei servizi sotto il applicazione "testApp".
