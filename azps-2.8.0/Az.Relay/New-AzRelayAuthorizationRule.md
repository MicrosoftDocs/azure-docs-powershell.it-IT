...
## Descrizione
Il cmdlet **New-AzRelayAuthorizationRule** crea una nuova regola di autorizzazione per le entità di inoltro specificate (Namespace/WcfRelay/HybridConnection).
...
Crea `AuthoRule1` con i diritti di **ascolto** per la connessione ibrida `TestHybridConnection` .
