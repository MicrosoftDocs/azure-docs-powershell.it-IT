...
Il comando precedente crea un nuovo cluster di Kusto denominato "mykustocluster" nel gruppo di risorse "testrg".
...
### -Posizione
Area di Azure in cui deve essere creato il cluster.
...
### -ResourceGroupName
Nome del gruppo di risorse in cui si vuole creare il cluster.
...
### -Tag
Stringa, dizionario di stringhe di tag associati al cluster
