...
Ottiene le impostazioni di restrizione di Access di un'app Azure Web.

### [Update-AzWebAppAccessRestrictionConfig](Update-AzWebAppAccessRestrictionConfig.md)
Aggiornare la configurazione dell'ereditarietà del sito SCM per una Web App Azure.

### [Add-AzWebAppAccessRestrictionRule](Add-AzWebAppAccessRestrictionRule.md)
Aggiunge una restrizione di Access a un'app Azure Web.

### [Remove-AzWebAppAccessRestrictionRule](Remove-AzWebAppAccessRestrictionRule.md)
Rimuove una restrizione di Access a un'app Azure Web