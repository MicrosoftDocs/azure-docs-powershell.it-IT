...
## Sinossi
Ottiene un elenco delle assegnazioni di registrazione.
...
Ottiene tutte le assegnazioni di registrazione nell'ambito predefinito.
...
Ottiene tutte le assegnazioni di registrazione con i dettagli della definizione di registrazione.
...
Ottiene un'assegnazione di registrazione senza i dettagli della definizione di registrazione.
...
Ottiene un'assegnazione di registrazione con i dettagli della definizione di registrazione.
...
Ottiene tutte le assegnazioni di registrazione.
...
Ottiene l'assegnazione di registrazione in base all'ID risorsa completo.
...
Se includere i dettagli della definizione di registrazione.
...
### -ID
Identificatore dell'assegnazione di registrazione (ad esempio, b0c052e5-c437-4771-A476-8b1201158a57).
```yaml
Type: System.String
Parameter Sets: ById
Aliases:
...
### -ResourceId
ResourceId assegnazione di registrazione (ad esempio,/subscriptions/bb6d49b2-603d-489f-b6ca-ca4dc497c749/providers/Microsoft.ManagedServices/registrationAssignments/b0c052e5-c437-4771-a476-8b1201158a57)
```yaml
Type: System.String
...
### -Ambito
Ambito in cui viene creata l'assegnazione di registrazione.
