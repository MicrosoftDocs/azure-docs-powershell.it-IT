...
### Esempio 1: aggiungere una configurazione di regola in uscita a un bilanciamento del carico
```powershell
...
Il secondo comando usa l'operatore pipeline per passare il bilanciamento del carico in $slb a **Add-AzLoadBalancerOutboundRuleConfig** , che aggiunge una configurazione della regola in uscita al bilanciamento del carico.
