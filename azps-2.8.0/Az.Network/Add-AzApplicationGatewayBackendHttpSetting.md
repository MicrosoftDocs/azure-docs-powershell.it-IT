...
## Descrizione
Il cmdlet Add-AzApplicationGatewayBackendHttpSetting aggiunge le impostazioni HTTP di back-end a un gateway dell'applicazione.
Le impostazioni HTTP di back-end vengono applicate a tutti i server back-end nel pool.

## ESEMPI

### Esempio 1: aggiungere le impostazioni HTTP di back-end a un gateway dell'applicazione
```
...
### -ApplicationGateway
Specifica il nome del gateway dell'applicazione per cui questo cmdlet aggiunge le impostazioni.
...
I valori accettabili per questo parametro sono: disabled, Enabled.
...
### -Nome
Specifica il nome delle impostazioni HTTP di back-end aggiunte da questo cmdlet.
...
### -Probe
Specifica una sonda da associare a un server back-end.
...
### -ProbeId
Specifica l'ID del Probe da associare al server back-end.
...
### -Protocollo
Specifica il protocollo per la comunicazione tra il gateway dell'applicazione e i server back-end.
...
### -RequestTimeout
Specifica il valore di timeout della richiesta.
