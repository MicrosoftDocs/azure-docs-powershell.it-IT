...
## Descrizione
Il cmdlet **Remove-AzRouteConfig** consente di rimuovere una route da una tabella di route di Azure.
...
Questo comando ottiene la tabella route denominata RouteTable01 usando il cmdlet **Get-AzRouteTable** .
Il comando passa la tabella al cmdlet corrente usando l'operatore pipeline.
Il cmdlet corrente rimuove la route denominata Route02 e passa il risultato al cmdlet **set-AzRouteTable** , che aggiorna la tabella per riflettere le modifiche.
