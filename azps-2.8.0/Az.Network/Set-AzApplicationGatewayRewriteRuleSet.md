...
Il secondo comando modifica il set di regole di riscrittura per il gateway dell'applicazione per usare le regole di riscrittura specificate nella variabile $rule.
