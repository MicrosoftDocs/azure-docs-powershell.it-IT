...
La configurazione viene quindi scaricata usando questo unifiedgroup.

Se il unifiedgroup è riuscito, la configurazione del download verrà scritta nel BLOB indicato da SignedSasUrl.
...
### -StorageSasUrl
URL SAS per il percorso di archiviazione in cui deve essere generata la configurazione.
...
### -VpnSite
Elenco di ID delle risorse di VpnSite per cui generare la configurazione.
