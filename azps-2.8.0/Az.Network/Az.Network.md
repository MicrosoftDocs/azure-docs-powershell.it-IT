...
Ottenere una connessione di endpoint privato
...
Ottiene l'integrità della connessione client VPN di rete virtuale per ogni connessione client VPN.
...
Crea un criterio di selezione del traffico IPSec.
...
Controlla se un servizio di collegamento privato è visibile per l'uso corrente.
