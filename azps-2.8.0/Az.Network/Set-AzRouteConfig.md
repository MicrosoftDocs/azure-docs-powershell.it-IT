...
## Descrizione
Il cmdlet **set-AzRouteConfig** aggiorna una configurazione della route per una tabella di route.

## ESEMPI

### Esempio 1: modificare una route
```
...
Il cmdlet Current modifica la route denominata Route02 e quindi passa il risultato al cmdlet **set-AzRouteTable** , che aggiorna la tabella in base alle modifiche apportate.
...
### -Nome
Specifica il nome della route che questo cmdlet modifica.
...
Un gateway di rete privata virtuale Azureserver-to-server. 
- VnetLocal.
...
### -RouteTable
Specifica la tabella route a cui è associata questa route.
