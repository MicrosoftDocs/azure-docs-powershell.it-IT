...
## Descrizione
Il cmdlet **Remove-AzPrivateEndpoint** rimuove un endpoint privato. 
...
In questo esempio viene rimosso un endpoint privato denominato MyPrivateEndpoint1.
...
### -ResourceGroupName
Il nome del gruppo di risorse dell'endpoint privato.
