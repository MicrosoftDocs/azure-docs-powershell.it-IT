...
### -IpSecPolicy
Criteri IpSec da considerare per questa connessione di collegamento.
...
### -SharedKey
Chiave condivisa necessaria per impostare la connessione del collegamento.
...
Usa l'indirizzo IP locale di Azure come IP di origine per questa connessione di collegamento.
...
Usare i selettori del traffico basati su criteri per questa connessione di collegamento.
...
### -VpnSiteLink
L'oggetto collegamento al sito VPN a cui connettersi.
