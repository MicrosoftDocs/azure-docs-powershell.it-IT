...
### Esempio 2: elencare le tabelle di routing tramite filtri
```
...
Questo comando consente di ottenere tutte le tabelle di route il cui nome inizia con "RouteTable"
