...
Generazione per questo gateway VPN di VirtualNetwork. Deve essere None se GatewayType non è VPN. Una volta impostata, questa proprietà non può essere modificata per la durata del gateway.
