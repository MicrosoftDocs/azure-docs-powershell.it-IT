...
## Descrizione
Il cmdlet **set-AzSearchService** modifica un servizio di ricerca Azure.
...
L'esempio cambia il conteggio delle partizioni e il conteggio delle repliche del servizio di ricerca di Azure su 2.
