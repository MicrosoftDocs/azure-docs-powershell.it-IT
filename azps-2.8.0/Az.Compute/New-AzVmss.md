...
### -Priorità
Priorità per il set di scale della macchina virtuale.  Solo i valori supportati sono "regolari" e "bassi".
...
Nome o ID risorsa del gruppo di posizionamento di prossimità da usare con questo set di proporzioni.
