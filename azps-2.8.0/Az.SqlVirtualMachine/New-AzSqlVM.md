...
## Descrizione
Il cmdlet New-AzSqlVM crea una macchina virtuale di Azure SQL.
...
Crea una nuova macchina virtuale di Azure SQL con il nome VM nel gruppo di risorse ResourceGroup01 
...
### -LicenseType
Tipo di licenza per la macchina virtuale SQL.
...
### -Posizione
Posizione della macchina virtuale SQL.
...
### -SKU
Tipo SQL Virtual Machine Edition.
...
### -SqlManagementType
Tipo di gestione della macchina virtuale SQL.
...
### -Tag
Tag da associare alla macchina virtuale SQL
