...
### Esempio 1: crea un oggetto regola ManagementPolicy e quindi impostato su un account di archiviazione
```
...
Questo comando crea un oggetto regola ManagementPolicy, con un oggetto gruppo di azioni ManagementPolicy contiene 4 azioni, un oggetto filtro di regola ManagementPolicy, quindi imposta la regola su un account di archiviazione.

## PARAMETRI

### -Azione
Oggetto che definisce il set di azioni.
Ottenere l'oggetto con cmdlet Add-AzureStorageAccountManagementPolicyAction
...
Ottenere l'oggetto con cmdlet New-AzureStorageAccountManagementPolicyFilter
...
### -Nome
Un nome di regola può contenere qualsiasi combinazione di caratteri numerici alfa.
Il nome della regola è maiuscole/minuscole.
