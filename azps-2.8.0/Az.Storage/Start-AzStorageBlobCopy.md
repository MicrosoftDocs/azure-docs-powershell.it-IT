...
### Esempio 6: copiare un BLOB di blocco nel contenitore di destinazione con un nuovo nome BLOB e impostare la destinazione BLOB StandardBlobTier come archivio, RehydratePriority come in alto
```
...
Questo comando avvia l'operazione di copia di un BLOB di blocco nel contenitore di destinazione con un nuovo nome BLOB e imposta BLOB di destinazione StandardBlobTier come archivio, RehydratePriority come alto
