...
## Descrizione
Il cmdlet **New-AzPrivateDnsZone** crea una nuova area DNS (private Domain Name System) nel gruppo di risorse specificato. Devi specificare un nome di zona DNS privato univoco per il parametro *Name* o il cmdlet restituirà un errore. Dopo aver creato la zona, usare il cmdlet New-AzPrivateDnsRecordSet per creare set di record nella zona.
...
### Esempio 1: creare una zona DNS privata
```
