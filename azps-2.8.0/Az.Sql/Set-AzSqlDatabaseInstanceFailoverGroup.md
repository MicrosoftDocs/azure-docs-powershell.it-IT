...
### SetIFGDefault (impostazione predefinita)
```
...
### Impostare un gruppo di failover di istanze dall'ID risorsa
```
...
### Impostare un gruppo di failover delle istanze dalla definizione dell'istanza di AzureSqlInstanceFailoverGroupModel
```
