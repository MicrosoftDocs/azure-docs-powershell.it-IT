...
### SwitchIFGDefault (impostazione predefinita)
```
...
### Cambiare un gruppo di failover di istanze dall'ID risorsa
```
Switch-AzSqlDatabaseInstanceFailoverGroup [-Location] <String> [-ResourceId] <String> [-AllowDataLoss]
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Cambiare un gruppo di failover di istanza dalla definizione dell'istanza di AzureSqlInstanceFailoverGroupModel
```
