...
## Descrizione
Il cmdlet **set-AzSqlDatabaseBackupShortTermRetentionPolicy** ottiene i criteri di conservazione a breve termine registrati nel database.
...
### -RetentionDays
Impostazione di conservazione del backup in giorni.
