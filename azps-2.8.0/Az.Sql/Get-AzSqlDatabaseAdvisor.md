...
## Descrizione
Il cmdlet **Get-AzSqlDatabaseAdvisor** ottiene uno o più consulenti di database SQL di Azure per un database SQL di Azure.

## ESEMPI

### Esempio 1: elencare tutti gli Advisor per il database specificato
```
...
Questo comando ottiene elenca tutti gli Advisor per il database denominato WIRunner che appartiene al server denominato Wi-Runner-Australia-Est.

### Esempio 2: ottenere un singolo consulente per il database specificato
```
...
Questo comando consente di ottenere il consulente denominato CreateIndex per il database denominato WIRunner.
...
Questo comando consente di ottenere tutti gli Advisor per il database denominato ' WIRunner ' con le azioni consigliate incluse nella risposta.
Poiché il comando usa il parametro *ExpandRecommendedActions* , il cmdlet ottiene le azioni consigliate con la risposta.
...
Questo comando ottiene il consulente denominato CreateIndex dal database denominato WIRunner con le azioni consigliate incluse nella risposta.
Poiché il comando usa il parametro *ExpandRecommendedActions* , il cmdlet ottiene le azioni consigliate con la risposta.

### Esempio 5: elencare tutti i consulenti per il database specificato tramite filtro
```
...
Questo comando ottiene l'elenco di tutti i consulenti per il database denominato WIRunner che appartiene al server denominato Wi-Runner-Australia-Est e inizia con la lettera "d".
...
### -DatabaseName
Specifica il nome del database per cui questo cmdlet richiede il consulente.
...
Indica che questo cmdlet ottiene le azioni consigliate con la risposta.
...
## Note
* Parole chiave: Azure, azurerm, ARM, Resource, Management, Manager, SQL, database, MSSQL, Advisor
