...
## Descrizione
Il cmdlet **Clear-AzSqlDatabaseAdvancedThreatProtectionSettings** rimuove le impostazioni avanzate di protezione dalle minacce da un database SQL di AzureAzure.
