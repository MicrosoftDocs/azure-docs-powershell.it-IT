...
## Descrizione
Il cmdlet **Update-AzSqlDatabaseAdvancedThreatProtectionSettings** imposta le impostazioni avanzate per la protezione delle minacce in un database SQL di Azure.
