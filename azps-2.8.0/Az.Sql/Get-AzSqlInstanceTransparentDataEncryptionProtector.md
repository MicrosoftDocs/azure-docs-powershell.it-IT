...
## Descrizione
Il cmdlet Get-AzSqlInstanceTransparentDataEncryptionProtector ottiene la protezione di Transparent per l'istanza di SQL Managed specificata.
...
Questo comando consente di ottenere la protezione di Transparent per l'istanza gestita denominata ContosoManagedInstanceName nel gruppo di risorse denominato ContosoResourceGroup.
