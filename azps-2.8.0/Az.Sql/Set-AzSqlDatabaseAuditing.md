...
## Sinossi
**Importante: questo cmdlet è deprecato, [set-AzSqlDatabaseAudit](https://docs.microsoft.com/en-us/powershell/module/az.sql/set-azsqldatabaseaudit) la sostituisce.**
...
## Descrizione
Il cmdlet **set-AzSqlDatabaseAuditing** modifica le impostazioni di controllo di un database SQL di Azure.
...
Se il cmdlet riesce e si usa il parametro *PassThru* , viene restituito un oggetto che descrive le impostazioni di controllo correnti oltre agli identificatori del database.
Gli identificatori di database includono, ma non sono limitati a, **ResourceGroupName** , **nomeserver** e **DatabaseName**.

## ESEMPI

### Esempio 1: abilitare i criteri di controllo archiviazione BLOB di un database SQL di Azure
```
...
### Esempio 2: disabilitare i criteri di controllo dello spazio di archiviazione BLOB di un database SQL di Azure
```
...
### Esempio 3: abilitare i criteri di controllo dello spazio di archiviazione BLOB di un database SQL di Azure usando un account di archiviazione da un abbonamento diverso
```
...
### Esempio 4: abilitare i criteri di controllo dello spazio di archiviazione BLOB di un database SQL di Azure con filtro avanzato usando un predicato T-SQL
```
...
### Esempio 5: rimuovere l'impostazione di filtro avanzato dai criteri di controllo archiviazione BLOB di un database SQL di Azure
```
...
### Esempio 6: abilitare i criteri di controllo Hub eventi di un database SQL di Azure
```
...
### Esempio 7: disabilitare i criteri di controllo Hub eventi di un database SQL di Azure
```
PS C:\>Set-AzSqlDatabaseAuditing -State Disabled -ResourceGroupName "ResourceGroup01" -ServerName "Server01" -EventHub
```

### Esempio 8: abilitare i criteri di controllo del log Analytics di un database SQL di Azure
```
...
### Esempio 9: disabilitare i criteri di controllo del log Analytics di un database SQL di Azure
```
...
### Esempio 10: disabilitare, tramite pipeline, i criteri di controllo di analisi del log di un database SQL di Azure
```
