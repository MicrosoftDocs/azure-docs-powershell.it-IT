...
## Descrizione
Il cmdlet **set-AzSqlInstanceDatabaseBackupShortTermRetentionPolicy** ottiene i criteri di conservazione a breve termine registrati nel database.
...
Questo comando imposta i criteri di conservazione a breve termine per Database01 in 35 giorni.
...
Questo comando imposta i criteri di conservazione a breve termine per Database01 in 35 giorni tramite piping in un oggetto di database.
...
Questo comando imposta i criteri di conservazione a breve termine per tutti i database eliminati denominati DB1 tramite piping in un oggetto di database eliminato. Nota è possibile ridurre il periodo di conservazione solo nei database eliminati.
...
### -InputObject
L'oggetto di database Live o Deleted per ottenere o impostare i criteri per.
