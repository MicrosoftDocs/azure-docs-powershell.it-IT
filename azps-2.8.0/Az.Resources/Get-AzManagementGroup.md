...
## Descrizione
Il cmdlet Get-AzManagementGroup ottiene tutti o un gruppo di gestione specifico.
...
Con il `Expand` contrassegno, si può esplorare la `Children` matrice e ottenere i dettagli per ogni bambino. Ad esempio, fornirà i `Children[0]` Dettagli per il gruppo con il nome visualizzato `TestGroup1DisplayName` .
...
### -Recurse
Elenca ricorsivamente gli elementi figlio del gruppo di gestione
