...
## Descrizione
Il cmdlet **Remove-AzDataFactoryV2Trigger** rimuove un trigger da una data factory. Se il parametro _Force_ viene specificato, il cmdlet non viene richiesto prima di rimuovere il trigger.
