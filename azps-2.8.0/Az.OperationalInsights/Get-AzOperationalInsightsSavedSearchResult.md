...
## Descrizione
Il cmdlet **Get-AzOperationalInsightsSavedSearchResult** restituisce i risultati della query specificata dall'ID ricerca.

## ESEMPI

### Esempio 1: ottenere tutti i risultati della ricerca per una ricerca salvata
```
...
Questo comando consente di ottenere tutti i risultati della ricerca per una ricerca salvata.
