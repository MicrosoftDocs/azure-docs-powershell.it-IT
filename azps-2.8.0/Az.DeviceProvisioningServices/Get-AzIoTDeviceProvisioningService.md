...
### ListIotDpsByResourceGroup (impostazione predefinita)
```
...
Elenca tutti i servizi di provisioning del dispositivo hub di Azure molto in un abbonamento.
...
Elenca tutti i servizi di provisioning del dispositivo hub di Azure molto nel gruppo di risorse "myresourcegroup".
...
Mostra i dettagli di un servizio di provisioning del dispositivo hub di Azure molto "myiotdps".
