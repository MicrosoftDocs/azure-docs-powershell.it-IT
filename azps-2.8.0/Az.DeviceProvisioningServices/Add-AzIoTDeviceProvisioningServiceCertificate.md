...
## Descrizione
Carica un nuovo certificato o sostituisce il certificato esistente con lo stesso nome.
...
Caricare un file CER certificato CA in un servizio di provisioning del dispositivo hub Azure molto.
...
Aggiorna un certificato CA in un servizio di provisioning del dispositivo hub molto utile caricando un nuovo file CER. 
