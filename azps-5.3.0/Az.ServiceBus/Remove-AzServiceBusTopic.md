...
## Descrizione
Il cmdlet **Remove-AzServiceBusTopic** rimuove l'argomento dallo spazio dei nomi Service Bus specificato.
...
Rimuove l'argomento `SB-Topic_exampl1` dallo spazio dei nomi `SB-Example1` .
...
### Esempio 5: ResourceId con il valore stringa
```powershell
...
### -ResourceId
ID risorsa argomento Service Bus
