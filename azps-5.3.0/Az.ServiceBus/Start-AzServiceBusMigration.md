...
## Descrizione
Il cmdlet **Start-AzServiceBusMigration** crea una nuova configurazione di migrazione e avvia la migrazione delle entità da standard a spazi dei nomi Premium
...
Crea una nuova configurazione di migrazione per gli spazi dei nomi "TestingNamespaceStandardMigration" in "TestingNamespacePremiumMigration"
...
### -Postmigrationname
Pubblicare il nome della migrazione per lo spazio dei nomi standard nella migrazione
