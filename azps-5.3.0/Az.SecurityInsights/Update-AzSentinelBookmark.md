...
Puoi passare un oggetto **Bookmark** come parametro o usando l'operatore pipeline o in alternativa puoi specificare i parametri *BookmarkID* necessari.
...
Il comando Aggiorna il segnalibro impostando la proprietà *Note* .  Tutti gli altri propreties rimangono invariati.
...
Il primo comando ottiene il segnalibro in base a *BookmarkID* dall'area di lavoro specificata e lo archivia nella variabile $Bookmark.
Il secondo comando Aggiorna la proprietà note.   Tutti gli altri propreties rimangono invariati.
