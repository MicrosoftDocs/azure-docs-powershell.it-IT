...
## Sinossi
Creare un oggetto proprietario Incident per aggiornare un proprietario dell'evento.
...
## Descrizione
Il cmdlet **New-AzSentinelIncidentOwner** crea un oggetto Incident Owner in memory per aggiornare un evento Incident.
...
Questo esempio crea un **IncidentOwner** e aggiorna un evento Incident nel nuovo proprietario.

## PARAMETRI

### -AssignedTo
Proprietario dell'evento-assegnato a
...
### -Posta elettronica
Proprietario incidente-posta elettronica
...
### -ObjectId
Proprietario dell'evento-ObjectId
...
### -UserPrincipalName
Proprietario incidente-nome dell'entità utente
