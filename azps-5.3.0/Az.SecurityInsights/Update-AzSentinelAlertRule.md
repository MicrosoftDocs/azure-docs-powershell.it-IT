...
## Descrizione
Il cmdlet **Update-AzSentinelAlertRule** aggiorna una regola analitica (Alert Rule) nell'area di lavoro specificata.
Puoi usare an-InputObject oppure-ResourceId o-AlertId.  È possibile aggiornare 1 o più proprtery parmaters.
...
Questo esempio aggiorna un **AlertRule** impostandolo su *disabled* e Rinomina in *disabled-AlertRuleDisplayName*.  Tutte le altre proprietà rimarranno invariate.
...
Questo esempio aggiorna un **AlertRule** usando un InputObject impostandolo su *disabled*.  Tutte le altre proprietà rimarranno invariate.
...
### -SuppressionDisabled
Soppressione della regola di avviso disabilitata.
