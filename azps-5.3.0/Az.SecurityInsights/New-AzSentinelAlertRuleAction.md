...
## Sinossi
Aggiungere una risposta automatica a un Analatic.
...
## Descrizione
Il cmdlet **New-AzSentinelAlertRuleAction** crea una risposta automatica per una regola di avviso nell'area di lavoro specificata.
Devi specificare l'ID resorce dell'app logica e l'URI trigger che puoi trovare usando il modulo app Logic.
...
Questo esempio crea un **AlertRuleAction** per la regola di avviso specificata usando le proprietà dell'app logica e lo archivia nella variabile $AlertRuleAction.
