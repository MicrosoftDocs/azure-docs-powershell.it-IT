...
## Descrizione
Il cmdlet **Get-AzSentinelIncident** ottiene un evento incidentato dall'area di lavoro specificata.
Se specifichi il parametro *IncidentId* , viene restituito un singolo oggetto **Incident** .
Se non specifichi il parametro *IncidentId* , viene restituita una matrice contenente tutti gli eventi imprevisti nell'area di lavoro specificata.
Puoi usare l'oggetto **Incident** per aggiornare l'evento Incident, ad esempio puoi aggiungere note all' **evento Incident**.
...
Questo esempio recupera tutti gli **eventi imprevisti** nell'area di lavoro specificata e lo archivia nella variabile $Incidents.
...
Questo esempio ottiene un **evento Incident** nell'area di lavoro specificata e lo archivia nella variabile $Incident.
