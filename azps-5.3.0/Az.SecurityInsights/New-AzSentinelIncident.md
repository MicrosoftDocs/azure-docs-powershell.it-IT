...
## Descrizione
Il cmdlet **New-AzSentinelIncident** crea un incidente dall'area di lavoro specificata.
...
Questo esempio crea un **evento Incident** nell'area di lavoro specificata e lo archivia nella variabile $Incident.
