...
## Descrizione
Il cmdlet **Remove-AzIntegrationAccountSchema** rimuove uno schema di account di integrazione da un gruppo di risorse.
...
### Esempio 1: rimuovere uno schema dell'account di integrazione
```
...
Questo comando rimuove uno schema di account di integrazione denominato IntegrationAccountSchema43.
