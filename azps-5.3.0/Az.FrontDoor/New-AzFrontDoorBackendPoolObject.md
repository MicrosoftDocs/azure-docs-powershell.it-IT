...
### -Backend
Il set di backend per questo pool.
...
Nome delle impostazioni della sonda di integrità per il pool di backend
...
Nome delle impostazioni di bilanciamento del carico per il pool back-end
