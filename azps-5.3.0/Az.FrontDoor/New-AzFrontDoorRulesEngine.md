...
Usa il cmdlet "New-AzFrontDoorRulesEngineRule" per creare regole del motore di regole per passare al parametro "-Rules" di questo cmdlet.
...
Creare una nuova configurazione del motore regole per la porta anteriore specificata.
