...
## Descrizione
Il cmdlet **Update-AzFrontDoorWafPolicy** aggiorna un criterio WAF esistente. Se non vengono forniti parametri di input, verranno usati i parametri obsoleti dei criteri di WAF esistenti.
