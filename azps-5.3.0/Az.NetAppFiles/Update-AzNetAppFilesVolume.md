...
## Descrizione
Il cmdlet **Update-AzNetAppFilesVolume** aggiorna un volume di ANF.

## ESEMPI

### Esempio 1: aggiornare un volume di ANF
```
...
Questo comando Aggiorna il volume ANF "MyAnfVolume" con le nuove dimensioni di UsageThreshold.
...
### -PoolObject
Oggetto pool che contiene il volume da aggiornare
