...
Questo comando sospende la connessione di replica ANF nel volume "MyDestinationAnfVolume".

## PARAMETRI

### -AccountName
Nome dell'account di ANF del volume di replica
...
### -ForceBreak
Se la replica è in stato di trasferimento e si vuole forzare l'interruzione della replica, impostare su true
...
### -PassThru
Restituisce se l'interruzione della replica del volume specificata è stata eseguita
...
### -PoolName
Nome del pool di ANF del volume di replica
