...
Questo comando modifica il pool di ANF "MyAnfPool" per avere le dimensioni e il QosType specificati.
...
### -QosType
Tipo QoS del pool. I valori possibili includono:' auto ',' manual '
