...
## Descrizione
Approva la connessione di replica nel volume di origine
...
### -AccountName
Nome dell'account di ANF del volume di origine della replica
...
ID del file System del volume di protezione dei dati di destinazione
...
### -InputObject
L'oggetto volume di origine ANF per autorizzare la destinazione della replica
...
### -Nome
Nome del volume di origine della replica di ANF
...
### -PoolName
Nome del pool di ANF del volume di origine della replica
...
### -ResourceGroupName
Gruppo risorse del volume di origine della replica di ANF
...
### -ResourceId
ID risorsa del volume di origine della replica di ANF
