...
## Descrizione
Il cmdlet **New-AzOperationalInsightsSavedSearch** crea una nuova ricerca salvata con i parametri specificati per l'area di lavoro.

## ESEMPI

### Esempio 1: creare una nuova ricerca salvata
```
...
Questo comando crea una nuova ricerca salvata.

## PARAMETRI

### -Categoria
Specifica il nome della categoria.
...
### -DisplayName
Specifica il nome visualizzato della ricerca salvato.
...
### -FunctionAlias
L'alias di funzione se query funge da funzione.
...
### -FunctionParameter
I parametri di funzione facoltativi se query funge da funzione. Il valore deve essere il formato seguente:' param-name1: tipo1 = default_value1, param-name2: tipo2 = default_value2'. Per altri esempi e per la sintassi corretta, fare riferimento a https://docs.microsoft.com/en-us/azure/kusto/query/functions/user-defined-functions .
...
### -Query
Specifica l'espressione di query per la ricerca salvata.
...
### -SavedSearchId
Specifica l'ID ricerca salvato.
