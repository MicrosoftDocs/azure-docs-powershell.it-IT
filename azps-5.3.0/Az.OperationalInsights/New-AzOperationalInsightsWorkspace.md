...
## Sinossi
Crea un'area di lavoro o ripristina un'area di lavoro eliminata in modo soft.
...
## Descrizione
Il cmdlet **New-AzOperationalInsightsWorkspace** crea un'area di lavoro nel gruppo di risorse e nella posizione specificati. O ripristinare un'area di lavoro eliminata in un piano.
