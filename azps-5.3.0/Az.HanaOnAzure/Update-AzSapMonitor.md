...
### Esempio 1: aggiornare un monitor SAP per nome
```powershell
...
Questo comando aggiorna un monitor SAP per nome.

### Esempio 2: aggiornare un monitor SAP per oggetto
```powershell
...
Questo comando aggiorna un monitor SAP per oggetto.
