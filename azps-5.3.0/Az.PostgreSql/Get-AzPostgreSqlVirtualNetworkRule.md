...
### Esempio 2: ottenere la regola di rete virtuale per nome
```powershell
...
Questo cmdlet ottiene la regola di rete virtuale per nome.

### Esempio 3: ottenere la regola di rete virtuale per identità
```powershell
...
Questo cmdlet ottiene la regola di rete virtuale per identità.
