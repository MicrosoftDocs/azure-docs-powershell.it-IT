...
### Esempio 1: aggiornare la configurazione di PostgreSql per nome
```powershell
...
Questo cmdlet aggiorna la configurazione di PostgreSql per nome.

### Esempio 2: aggiornare la configurazione di PostgreSql per identità.
```powershell
...
Questi cmdlet aggiornano la configurazione di PostgreSql per identità.
