...
## Descrizione
Imposta le proprietà di un argomento della griglia di eventi. Questa operazione può essere usata per sostituire i tag di un argomento della griglia di eventi.
...
Imposta le proprietà dell'argomento griglia dell'evento \` Topic1 \` nel gruppo \` di risorse MyResourceGroupName \` per sostituire i tag con i tag specificati "reparto" e "ambiente".
