...
## Sinossi
Ottenere comunicazioni di ticket di supporto.
...
## Descrizione
Ottiene le comunicazioni per un ticket di supporto. Recupererà tutte le comunicazioni per un ticket se non specifichi altri parametri. Puoi anche filtrare le comunicazioni tramite I valori CreatedDate o CommunicationType usando il parametro Filter. Ecco alcuni esempi di valori di filtro che puoi specificare.


| Scenario                                                        | Filtro                                                     |
|-----------------------------------------------------------------|------------------------------------------------------------|
| Ottenere comunicazioni Web                                          | "CommunicationType EQ" Web "                               |
| Ottenere comunicazioni telefoniche                                        | "Telefono ' EQ CommunicationType '"                             |
| Ottenere comunicazioni create durante o dopo il 20 dicembre, 2019 | "I valori CreatedDate GE 2019-12-20"                                |
| Ottenere comunicazioni create dopo il 20 dicembre 2019       | "I valori CreatedDate gt 2019-12-20"                                |
| Ottiene le comunicazioni Web create dopo il 20 dicembre 2019            | "I valori CreatedDate gt 2019-12-20 e CommunicationType EQ" Web " |


Questo cmdlet supporta il paging tramite i parametri First e Skip.

È anche possibile recuperare una singola comunicazione ticket di supporto specificando il nome della comunicazione. 

## ESEMPI

### Esempio 1: recuperare tutte le comunicazioni per un ticket di supporto
```powershell
...
### Esempio 2: recuperare una singola comunicazione per il nome di un ticket di supporto
```powershell
...
### Esempio 3: recuperare le prime 2 comunicazioni per un ticket di supporto
```powershell
...
### Esempio 4: recuperare le 2 comunicazioni successive dopo aver saltato le prime 2 comunicazioni per un ticket di supporto
```powershell
...
### Esempio 5: recuperare tutte le comunicazioni Web per un ticket di supporto
```powershell
...
### Esempio 6: recuperare tutte le comunicazioni create in o dopo il 20 dicembre 2019 per un ticket di supporto
```powershell
...
### Esempio 7: recuperare tutte le comunicazioni Web create o dopo il 20 dicembre 2019 per un ticket di supporto
```powershell
...
### Esempio 8: recuperare tutte le comunicazioni per un ticket di supporto tramite l'oggetto ticket di supporto piping
```powershell
