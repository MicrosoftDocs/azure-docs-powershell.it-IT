...
Questo comando verifica una distribuzione presso il gruppo di gestione "myMG" usando il file di modello e il file di parametri specificati.
...
Questo comando verifica una distribuzione presso il gruppo di gestione "myMG" usando la tabella hash in memoria creata dal file di modello e un file di parametro.
