...
## Descrizione
Il cmdlet **Get-AzResourceLock** ottiene blocchi di risorse Azure.
...
Questo comando ottiene il blocco delle risorse denominato ContosoSiteLock.
...
Questo comando consente di ottenere i blocchi delle risorse nel gruppo di risorse o nell'abbonamento.
...
### -AtScope
Indica che questo cmdlet restituisce tutti i blocchi al di sopra dell'ambito specificato.
Se non specifichi questo parametro, il cmdlet restituirà tutti i blocchi sopra o sotto l'ambito.
...
### -LockId
Specifica l'ID del blocco ottenuto da questo cmdlet.
...
### -LockName
Specifica il nome del blocco ottenuto da questo cmdlet.
...
Questo cmdlet ottiene i blocchi per il gruppo di risorse.
...
Questo cmdlet ottiene i blocchi per la risorsa.
