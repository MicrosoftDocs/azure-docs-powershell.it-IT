...
## Descrizione
Il cmdlet **Remove-AzPolicyDefinition** rimuove una definizione di criteri.
...
### -InputObject
Oggetto definizione dei criteri da rimuovere che è stato restituito da un altro cmdlet.
...
### -ManagementGroupName
Nome del gruppo di gestione della definizione di criteri da eliminare.
...
### -SubscriptionId
ID sottoscrizione della definizione di criterio da eliminare.
