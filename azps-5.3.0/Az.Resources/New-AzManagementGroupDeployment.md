...
Questo comando crea una nuova distribuzione nel gruppo di gestione "myMG" usando un modello personalizzato e un file modello su disco, con il parametro di tag definito.
