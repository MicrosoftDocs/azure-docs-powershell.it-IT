...
## Descrizione
Il cmdlet **Get-AzPolicySetDefinition** ottiene una raccolta di definizioni di set di criteri o una definizione specifica del set di criteri identificata per nome o ID.
...
Questo comando consente di ottenere tutte le definizioni di set di criteri nella categoria "macchina virtuale".
