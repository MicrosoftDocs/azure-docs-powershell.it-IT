...
## Sinossi
Aggiornare un'assegnazione di ruolo esistente.

## SINTASSI

### RoleAssignmentParameterSet (impostazione predefinita)
```
...
## Descrizione
Usare il comando New-AzRoleAssignment per modificare un'assegnazione esistente.  
Le descrizioni possono essere qualsiasi stringa valida, che può essere usata per diferentiate l'una dall'altra.  
Se la condizione è impostata anche la versione della condizione deve essere impostata, ma se si sta aggiornando una condizione che non è necessaria.
La versione della condizione può essere aggiornata da 1,0 a 2,0, ma non può essere retroceduta. Essere prudenti dato che 2,0 non è retrocompatible con 1,0.
...
Aggiornare un'assegnazione di ruolo esistente modificando un oggetto
...
Aggiornare un'assegnazione di ruolo esistente usando un file
...
### -PassThru
Se specificato, Visualizza l'assegnazione di ruolo aggiornata
