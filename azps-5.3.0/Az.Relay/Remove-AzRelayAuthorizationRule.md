...
## Descrizione
Il cmdlet **Remove-AzRelayAuthorizationRule** rimuove la regola di autorizzazione delle entità di inoltro specificate (Namespace/WcfRelay/HybridConnection).
...
Rimuove la regola `AuthoRule1` di autorizzazione dello spazio dei nomi `TestNameSpace-Relay1` .
...
Rimuove la regola `AuthoRule1` di autorizzazione di WcfRelay `TestWcfRelay` dallo spazio dei nomi `TestNameSpace-Relay1` .
...
Rimuove la regola `AuthoRule1` di autorizzazione di HybridConnection `TestHybridConnection` dallo spazio dei nomi `TestNameSpace-Relay1` .
