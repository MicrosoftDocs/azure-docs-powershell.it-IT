...
## Descrizione
Il cmdlet **set-AzRelayNamespace** aggiorna la descrizione dello spazio dei nomi Relay specificato all'interno del gruppo di risorse.
...
Aggiorna lo spazio dei nomi Relay con una nuova descrizione.
...
### -InputObject
Oggetto dello spazio dei nomi Relay.
