...
### Esempio 1: aggiornare la regola del firewall MySql per nome
```powershell
...
Questo cmdlet aggiorna la regola del firewall MySql per nome.
...
### Esempio 3: aggiornare la regola del firewall di MySql da-ClientIPAddress.
```powershell
PS C:\> $ID = "/subscriptions/<SubscriptionId>/resourceGroups/PowershellMySqlTest/providers/Microsoft.DBforMySQL/servers/mysql-test/firewallRules/rule"
...
Questi cmdlet aggiornano la regola del firewall di MySql da-ClientIPAddress.
