...
### Esempio 1: rimuovere la regola della rete virtuale del server MySql per nome
```powershell
PS C:\> Remove-AzMySqlVirtualNetworkRule -Name vnet -ResourceGroupName PowershellMySqlTest-ServerName mysql-test

```

Questo cmdlet rimuove la regola di rete virtuale del server MySql per nome.

### Esempio 2: rimuovere la regola della rete virtuale del server MySql per identità
```powershell
...
Questi cmdlet eliminano la regola della rete virtuale di MySql Server per identità.
