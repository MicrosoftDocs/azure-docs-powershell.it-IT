...
### Esempio 1: aggiornare un database del server MySql per nome
```powershell
...
Aggiornare un database per nome risorsa.

### Esempio 2: aggiornare il database MySql tramite il parametro.
```powershell
...
Aggiornare un database per parametro
...
### -Charset
Il set di caratteri del database.
