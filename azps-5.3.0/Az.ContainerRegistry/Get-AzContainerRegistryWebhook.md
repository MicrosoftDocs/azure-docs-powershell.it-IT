...
## Descrizione
Il cmdlet Get-AzContainerRegistryWebhook ottiene un webhook specificato di registro del contenitore o di tutti i webhook di un registro di sistema contenitore.
...
### Esempio 2: ottenere tutti i webhook di un contenitore del registro di sistema
```powershell
...
Ottenere tutti i webhook di un contenitore del registro di sistema

### Esempio 3: ottenere un webhook specificato di un registro dei contenitori con i dettagli di configurazione
```powershell
...
Ottenere un webhook specificato di un registro dei contenitori con i dettagli di configurazione
