...
## Descrizione
Il cmdlet Update-AzContainerRegistry aggiorna un registro di sistema contenitore.
...
Questo comando imposta il registro di sistema del contenitore specificato per l'uso di un account di archiviazione esistente \` mystorageaccount \` nella stessa sottoscrizione.
...
### -NetworkRuleSet
Set di regole di rete per un registro di sistema contenitore.
