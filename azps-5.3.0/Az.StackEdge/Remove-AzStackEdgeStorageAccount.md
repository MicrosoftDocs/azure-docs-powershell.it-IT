...
## Descrizione
Il cmdlet **Remove-AzStackEdgeStorageAccount** consente di rimuovere un account di archiviazione Edge associato per un dispositivo di bordo dello stack. È possibile specificare il nome dell'account di archiviazione Edge da rimuovere come parametro nel cmdlet.
