...
## Descrizione
Il cmdlet **New-AzStackEdgeOrder** crea un nuovo ordine per un dispositivo Edge dello stack. Prima di creare un ordine, è necessario creare una risorsa per il dispositivo Edge dello stack. Puoi specificare i dettagli come i parametri di contatto, nome società, posta elettronica, indirizzo e così via come per la creazione dell'ordine.
