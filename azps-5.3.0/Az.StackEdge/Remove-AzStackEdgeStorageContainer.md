...
## Descrizione
Il cmdlet **Remove-AzStackEdgeStorageContainer** rimuove un contenitore di archiviazione associato per l'account di archiviazione perimetrale in un dispositivo di bordo dello stack. Puoi specificare il nome del contenitore di archiviazione da rimuovere come parametro.
