...
## Descrizione
Il cmdlet **Get-AzStackEdgeStorageContainer** ottiene il contenitore di archiviazione per un account di archiviazione perimetrale in un dispositivo di bordo dello stack. Puoi specificare il nome come parametro nel cmdlet per recuperare i dettagli di un contenitore di archiviazione specifico. 
...
Fornisci l'oggetto EdgeStorageAccount esistente
