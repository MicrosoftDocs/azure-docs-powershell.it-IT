...
### Esempio 1: elenca tutti i set di dati di riferimento nell'ambiente specificato
```powershell
...
Questo comando elenca tutti i set di dati di riferimento nell'ambiente specificato.

### Esempio 2: ottenere i dati di riferimento specificati impostati per nome
```powershell
...
Questo comando ottiene un set di dati di riferimento specificato.

### Esempio 3: ottenere un set di dati di riferimento specificato dall'oggetto
```powershell
...
### -Nome
Nome del set di dati di riferimento per gli approfondimenti della serie temporale associato all'ambiente specificato.
