...
### Esempio 1: elenca tutti i criteri di accesso in un ambiente specificato
```powershell
...
### Esempio 2: ottenere un criterio di accesso specificato per nome
```powershell
...
### Esempio 3: ottenere un criterio di accesso specificato per oggetto
```powershell
