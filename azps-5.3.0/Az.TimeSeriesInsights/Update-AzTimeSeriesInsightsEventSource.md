...
### Esempio 1: aggiornare un'origine eventi specificata per nome
```powershell
...
Questo comando aggiorna una specifica origine eventi.

### Esempio 3: aggiornare un'origine eventi specificata per oggetto
```powershell
...
### -Tag
Coppie chiave-valore di proprietà aggiuntive per l'origine eventi.
