...
## Descrizione
Il cmdlet **New-AzFirewallApplicationRule** crea una regola dell'applicazione per Azure firewall.
...
### -FqdnTag
Specifica un elenco di tag FQDN per la regola. I tag disponibili possono essere recuperati usando il cmdlet [Get-AzFirewallFqdnTag](./Get-AzFirewallFqdnTag.md) .
...
Il carattere asterisco,'*', viene accettato solo come primo carattere di un nome di dominio completo nell'elenco. Quando viene usato, l'asterisco corrisponde a qualsiasi numero di caratteri. (ad esempio, "* MSN.com" corrisponderà a MSN.com e a tutti i relativi sottodomini)
