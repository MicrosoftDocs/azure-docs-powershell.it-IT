...
## Descrizione
New-AzNetworkWatcherConnectionMonitorEndpointObject cmdlet crea endpoint di monitoraggio connessione.
...
Nome: workspaceEndpoint tipo: MMAWorkspaceMachine ResourceId:/subscriptions/00000000-0000-0000-0000-000000000000/resourcegroups/myresourceGroup/providers/Microsoft.OperationalInsights/workspaces/myworkspace Indirizzo: ambito: {"Includi": [{"indirizzo": "WIN-P0HGNDO2S1B"}]}

## PARAMETRI

### -Address
Indirizzo dell'endpoint di monitoraggio della connessione (IP o nome di dominio).
...
### -AzureSubnet
Interruttore di endpoint della subnet di Azure.
...
### -AzureVM
Interruttore endpoint di Azure VM.
...
### -AzureVNet
Interruttore endpoint di Azure vnet.
...
### -CoverageLevel
Verificare la copertura per l'endpoint.
...
### -ExcludeItem
Elenco di elementi che devono essere esclusi dall'ambito dell'endpoint.
...
### -ExternalAddress
Opzione endpoint indirizzo esterno.
...
### -IncludeItem
Elenco di elementi che devono essere inclusi nell'ambito endpont.
...
### -MMAWorkspaceMachine
Interruttore dell'endpoint della macchina dell'area di lavoro MMA.
...
### -MMAWorkspaceNetwork
Switch endpoint di rete dell'area di lavoro MMA.
...
### -Nome
Nome dell'endpoint di monitoraggio della connessione.
