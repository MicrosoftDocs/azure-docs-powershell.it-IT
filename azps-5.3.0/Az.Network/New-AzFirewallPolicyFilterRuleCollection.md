...
## Descrizione
Il cmdlet **New-AzFirewallPolicyFilterRuleCollection** crea una raccolta di regole di filtro per un criterio di Azure firewall.
...
### -Nome
Nome della raccolta di regole applicazione
...
### -Regola
Elenco delle regole dell'applicazione
