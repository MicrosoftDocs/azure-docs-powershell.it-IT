...
## Sinossi
Modifica una configurazione PrivateLink per un gateway dell'applicazione.
...
## Descrizione
Il cmdlet **set-AzApplicationGatewayPrivateLinkConfiguration** modifica una configurazione privateLink per un gateway dell'applicazione Azure.

## ESEMPI

### Esempio 1: impostare una configurazione di PrivateLink
```
...
Il secondo comando imposta la configurazione di privateLink con il nome privateLinkConfig01 per usare la configurazione IP archiviata in $privateLinkIpConfiguration 01
