...
Questo cmdlet recupera una risorsa della tabella di route usando il nome del gruppo di risorse, il nome Hub e il nome della tabella route.
...
Questo cmdlet elenca tutte le tabelle di route presenti in un hub virtuale usando il nome del gruppo di risorse e il nome dell'hub.
