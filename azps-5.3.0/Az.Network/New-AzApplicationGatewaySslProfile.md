...
## Sinossi
Crea il profilo SSL per un gateway dell'applicazione.
...
## Descrizione
Il cmdlet **New-AzApplicationGatewaySslProfile** crea il profilo SSL per un gateway dell'applicazione. Il profilo SSL è configurato nei listener HTTPS.
...
```
Il primo comando crea un nuovo criterio SSL e lo archivia nella variabile $sslPolicy.
Il secondo comando crea una catena di certificati CA del client attendibile e li archivia nella variabile $ClientCert 01.
Il terzo comando crea un nuovo profilo SSL con i criteri SSL e la catena di certificati CA del client attendibile.
