...
## Descrizione
Il cmdlet **Get-AzVirtualNetworkTap** ottiene un tocco di rete virtuale di Azure o un elenco di rubinetti di rete virtuali Azure in un gruppo di risorse.
...
### Esempio 2: ottenere tutti i rubinetti di rete virtuale tramite filtro
```
PS C:\> Get-AzVirtualNetworkTap -Name "VirtualTap*"
```

Questo comando ottiene tutti i riferimenti di VirtualNetwork tap che iniziano con "VirtualTap".
