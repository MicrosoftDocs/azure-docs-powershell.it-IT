...
## Sinossi
Rimuovere un sito di Virtual Appliance da una risorsa di Virtual Appliance di rete.
...
## Descrizione
Il comando Remove-AzVirtualApplianceSite rimuove un sito Virtual Appliance da una risorsa di Virtual Appliance di rete.
...
Eliminare una risorsa sito di Virtual Appliance. 
...
ID risorsa dell'appliance virtuale di rete associato al sito.
...
Oggetto sito Virtual Appliance.
