...
### Esempio 3: creare un gateway di rete virtuale con le impostazioni di P2S
```powershell
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
$subnet = New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### Esempio 4: creare un gateway di rete virtuale con la configurazione di autenticazione AAD per VpnClient di Virtual Network Gateway.
```powershell
New-AzResourceGroup -Location "UK West" -Name "vnet-gateway"
New-AzVirtualNetworkSubnetConfig -Name 'gatewaysubnet' -AddressPrefix '10.254.0.0/27'
...
### -GatewayType
Il tipo di questo gateway di rete virtuale: VPN, ExpressRoute
