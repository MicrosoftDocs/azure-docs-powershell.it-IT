...
Il comando precedente consente di rimuovere un VpnServerConfiguration esistente.
...
### -Nome
Il nome vpnServerConfiguration.
...
### -ResourceId
ID risorsa di Azure per l'vpnServerConfiguration da eliminare.
