...
## Sinossi
Crea un oggetto VHubRoute che può essere passato come parametro al comando New-AzVHubRouteTable.
...
Il comando precedente creerà un oggetto VHubRoute con nextHop come firewall specificato, che potrà quindi essere aggiunto a una risorsa VHubRouteTable.
...
Il comando precedente creerà un oggetto VHubRoute con nextHop come hubVnetConnection specificato, che potrà quindi essere aggiunto a una risorsa VHubRouteTable.
...
```
I comandi descritti sopra otterranno la RoutingConfiguration di un AzVHubRoute già esistente e quindi aggiungeranno una route statica alla connessione. In alternativa, se si spera di creare una nuova connessione con la route statica al suo interno, vedere l'esempio 1 [qui.](New-AzRoutingConfiguration.md)
## PARAMETRI
