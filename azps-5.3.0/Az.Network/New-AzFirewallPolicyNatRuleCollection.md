...
## Descrizione
Il cmdlet **New-AzFirewallPolicyNatRuleCollection** crea una raccolta di regole NAT per un criterio di Azure firewall.
...
### -Nome
Nome della raccolta regole di rete
...
### -Priorità
Priorità della raccolta regole
