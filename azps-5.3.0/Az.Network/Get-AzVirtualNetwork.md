...
## Descrizione
Il cmdlet **Get-AzVirtualNetwork** ottiene uno o più reti virtuali n un gruppo di risorse.
...
### 2: elencare reti virtuali tramite filtro
```
...
Questo comando consente di ottenere tutte le reti virtuali che iniziano con "MyVirtualNetwork".
