...
Ottenere le chiavi dello sviluppatore dell'account di rendering remoto "esempio" dall'abbonamento corrente e dal gruppo di risorse "RG1".
...
Ottenere le chiavi dello sviluppatore dell'account di rendering remoto "esempio" dall'abbonamento corrente e dal gruppo di risorse "RG1" con piping.
