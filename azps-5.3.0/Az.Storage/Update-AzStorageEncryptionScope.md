...
Questo comando consente di abilitare un ambito di crittografia.

### Esempio 3: aggiornare un ambito di crittografia per usare la crittografia dello spazio di archiviazione
```
...
Questo comando aggiorna un ambito di crittografia per l'uso della crittografia dello spazio di archiviazione.

### Esempio 4: aggiornare un ambito di crittografia per l'uso della crittografia con il Vault
```
...
Questo comando updtaes un ambito di crittografia per l'uso della crittografia con il Vault.
...
### -Stato
Aggiornare lo stato dell'ambito di crittografia, i possibili valori includono:' Enabled ',' disabled '.
