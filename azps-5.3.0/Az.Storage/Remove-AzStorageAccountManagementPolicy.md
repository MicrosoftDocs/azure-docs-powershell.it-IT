...
## Descrizione
Il cmdlet **Remove-AzStorageAccountManagementPolicy** rimuove i criteri di gestione di un account di archiviazione di Azure.

## ESEMPI

### Esempio 1: rimuovere i criteri di gestione di un account di archiviazione.
```
PS C:\>Remove-AzStorageAccountManagementPolicy -ResourceGroupName "MyResourceGroup" -AccountName "mystorageaccount"
```

Questo comando rimuove i criteri di gestione di un account di archiviazione.
...
### -InputObject
Oggetto di gestione da rimuovere
