...
### Esempio 3: creare un contenitore di archiviazione di Azure con l'ambito di crittografia
```
...
Questo comando crea un contenitore di archiviazione con l'ambito di crittografia predefinito come myencryptscope e il caricamento BLOB Prevert con un ambito di crittografia diverso per questo contenitore.
...
Predefinito il contenitore per usare l'ambito di crittografia specificato per tutte le Scritture.
...
Bloccare l'override dell'ambito di crittografia dal contenitore default.
