...
### Esempio 5: ottenere tutti i BLOB in un contenitore includere la versione BLOB
```
...
Questo comando ottiene tutti i BLOB in un contenitore include la versione BLOB.
...
Questo comando ottiene un singolo BLOB verion con VersionId.
...
Se viene specificato un valore per questo parametro, il cmdlet elenca tutti i BLOB con i nomi che corrispondono a questo parametro. Questo parametro supporta i caratteri jolly in qualsiasi punto della stringa.
...
### -IncludeVersion
Le versioni BLOB verranno elencate solo se questo parametro è presente, per impostazione predefinita Get BLOB non includerà versioni BLOB.
