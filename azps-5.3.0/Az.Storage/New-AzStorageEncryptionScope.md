...
### Esempio 1: creare un ambito di crittografia con la crittografia dello spazio di archiviazione
```
...
Questo comando crea un ambito di crittografia con crittografia dello spazio di archiviazione.

### Esempio 2: creare un ambito di crittografia con la crittografia di un Vault
```
...
Questo comando crea un ambito di crittografia con la crittografia di un Vault.
L'identità dell'account di archiviazione deve avere le autorizzazioni Get, wrapkey, unwrapkey per la chiave del Vault.
...
### -EncryptionScopeName
Nome EncryptionScope di archiviazione di Azure
...
### -KeyvaultEncryption
Creare un ambito di crittografia con la sorgente di origine come Microsoft. Vault
...
### -StorageEncryption
Creare l'ambito di crittografia con la fonte di risorse come Microsoft. storage.
