...
Aggiunge tag di blocco legale a un contenitore di archiviazione BLOB
...
### [Chiudi-AzStorageFileHandle](Close-AzStorageFileHandle.md)
...
Abilitare l'eliminazione dei criteri di conservazione per il servizio BLOB di archiviazione di Azure.
...
Elenca le sottodirectory e i file da una directory o da una radice di filesystem.

### [Get-AzDataLakeGen2Item](Get-AzDataLakeGen2Item.md)
Ottiene i dettagli di un file o di una directory in un filesystem.
...
Elenca gli handle di file di una condivisione file, una directory di file o un file.
...
### [Blocco-AzRmStorageContainerImmutabilityPolicy](Lock-AzRmStorageContainerImmutabilityPolicy.md)
...
Crea un criterio di accesso archiviato per un contenitore di archiviazione di Azure.
...
Crea una regola di criteri di replica degli oggetti.
...
Crea un criterio di accesso archiviato in una condivisione di archiviazione.
...
Rimuove ImmutabilityPolicy di un contenitore BLOB di archiviazione con un criterio sbloccato
...
### [Ripristinare-AzRmStorageShare](Restore-AzRmStorageShare.md)
Ripristina una condivisione file eliminata.

### [Ripristinare-AzStorageBlobRange](Restore-AzStorageBlobRange.md)
...
Revocare tutte le chiavi di delega degli utenti di un account di archiviazione.
...
Impostare gli ACL ricorsivamente nel percorso specificato. 
