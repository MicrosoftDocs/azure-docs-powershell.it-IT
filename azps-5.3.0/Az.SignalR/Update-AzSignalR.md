...
### Aggiornare un servizio di segnalazione specifico.
```powershell
...
Impostazione predefinita per "Standard_S1".
...
### -UnitCount
Conteggio unità di servizio del segnalatore, valore solo da {1, 2, 5, 10, 20, 50, 100}.
Impostazione predefinita su 1.
