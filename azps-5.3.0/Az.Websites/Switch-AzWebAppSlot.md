...
## Descrizione
L' **opzione Switch-AzWebAppSlot** passa due slot associati a un'app Web di Azure.
...
Questo comando commuta lo slot "sourceslot" con "destinationslot" l'app Web ContosoWebApp associata al gruppo di risorse predefinito-Web-Westus
...
Scambiare con l'azione anteprima
