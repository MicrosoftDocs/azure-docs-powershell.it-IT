...
## Descrizione
Il cmdlet **New-AzWebApp** crea un'app Web di Azure in un gruppo di risorse specificato che usa il piano di servizio app e il Data Center specificati.
...
### -AppServicePlan
Nome piano servizio app o ID piano servizio app. Se un piano di servizio Web App e app si trova in gruppi di risorse diversi, usare l'ID al posto del nome. L'ID piano di servizio app può essere recuperato usando: $asp = Get-AzAppServicePlan-ResourceGroup myRG-Name MyWebapp $asp. ID restituisce l'ID del piano di servizio app.
