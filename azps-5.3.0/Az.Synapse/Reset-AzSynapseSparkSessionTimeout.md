...
### ResetByNameParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Remove-AzSynapseSparkSessionTimeout** Reimposta il timeout di una sessione di Spark di analisi sinapsi.
...
Questo comando Reimposta il timeout della sessione di Spark Analytics con l'ID Livio specificato.
...
Questo comando Reimposta il timeout della sessione di Spark Analytics con l'ID Livio specificato tramite pipeline.
