...
### GetSparkJobsByIdParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzSynapseSparkJob** ottiene un processo Spark di analisi di Azure sinapsi.
...
Questo comando consente di ottenere tutti i processi in un pool di scintille.
...
Questo comando ottiene il processo con l'ID applicazione specificato.
...
Questo comando consente di ottenere tutti i processi sotto un pool di scintille tramite pipeline.
