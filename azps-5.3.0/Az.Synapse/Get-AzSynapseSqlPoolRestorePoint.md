...
## Descrizione
Il cmdlet **Get-AzSynapseSqlPoolRestorePoint** recupera i punti di ripristino distinti a cui può essere ripristinato un pool di analisi SQL di Azure sinapsi.
...
Questo comando restituisce tutti i punti di ripristino disponibili per il pool SQL sinapsi di analisi di Azure denominato ContosoSqlPool.
...
### Microsoft. Azure. Management. sinapsi. Models. RestorePoint
