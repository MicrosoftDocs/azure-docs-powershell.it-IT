...
## Sinossi
Elimina un punto di ripristino del pool di analisi di sinapsi SQL.
...
## Descrizione
Il cmdlet **Remove-AzSynapseSqlPoolRestorePoint** Elimina definitivamente un punto di ripristino di Azure sinapsi di analisi del pool SQL.
...
Questo comando Elimina un punto di ripristino del pool SQL di Azure sinapsi Analytics.
...
Questo comando Elimina un punto di ripristino di un pool di analisi di Azure sinapsi per la pipeline.
...
Questo comando Elimina un punto di ripristino del pool SQL di Azure sinapsi Analytics con l'ID risorsa specificato.
...
### -InputObject
Oggetto di input data di creazione del punto di ripristino di SQL pool, in genere passato alla pipeline.
...
Nome della data di creazione del punto di ripristino di SQL sinapsi.
