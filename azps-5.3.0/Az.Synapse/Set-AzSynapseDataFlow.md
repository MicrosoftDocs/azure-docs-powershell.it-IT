...
## Descrizione
Il cmdlet **set-AzSynapseDataFlow** crea un flusso di dati o aggiorna un flusso di dati esistente nell'area di lavoro.
...
Questo comando crea un flusso di dati denominato ContosoDataFlow nell'area di lavoro denominata ContosoWorkspace.
Il comando basa il flusso di dati sulle informazioni nella DataFlow.jssu file.
