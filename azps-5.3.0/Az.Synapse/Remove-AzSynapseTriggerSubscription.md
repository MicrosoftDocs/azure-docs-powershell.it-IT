...
## Descrizione
Il cmdlet **Remove-AzSynapseTriggerSubscription** Annulla la sottoscrizione del trigger di evento agli eventi del servizio esterno specificati dal trigger definizione.
...
Questo comando consente di annullare la sottoscrizione del trigger denominato ContosoTrigger agli eventi specificati dal trigger definizione.
...
Questo comando Annulla la sottoscrizione del trigger denominato ContosoTrigger agli eventi specificati dal trigger definizione tramite pipeline.
