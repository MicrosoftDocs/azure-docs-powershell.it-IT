...
## Descrizione
Il cmdlet **Get-AzSynapseActivityRun** ottiene le informazioni sulle esecuzioni nell'area di lavoro per l'esecuzione della pipeline specificata avvenuta nell'intervallo di tempo specificato. È inoltre possibile specificare i filtri per il nome dell'attività e lo stato dell'esecuzione.
...
Questo comando consente di ottenere informazioni dettagliate su tutte le attività eseguite nella pipeline denominata ContosoPipeline Run with ID "f288712d-FB08-4cb8-96ef-82d3b9b30621" che si è verificato tra "2018-09-01T21:00" e "2018-09-30T21:00".
...
Questo comando consente di ottenere informazioni dettagliate su tutte le attività eseguite nella pipeline denominata ContosoPipeline eseguita con ID "f288712d-FB08-4cb8-96ef-82d3b9b30621" che si è verificato tra "2018-09-01T21:00" e "2018-09-30T21:00" tramite pipeline.
...
### -RunStartedAfter
Intervallo di tempo in cui l'evento di esecuzione è stato aggiornato in formato "ISO 8601".
...
### -RunStartedBefore
Il periodo di tempo in cui l'evento Run è stato aggiornato in formato "ISO 8601".
...
### -Stato
Lo stato dell'esecuzione della pipeline.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSActivityRunsQueryResponse
