...
## Sinossi
Rimuove i tipi di informazioni e le etichette di sensitività delle colonne nel pool SQL.
...
## Descrizione
Il cmdlet Remove-AzSynapseSqlPoolSensitivityClassification consente di rimuovere i tipi di informazioni e le etichette di sensitività delle colonne nel pool SQL.

## ESEMPI

### Esempio 1: rimuovere il tipo di informazioni e l'etichetta di sensitività di una colonna in un pool di SQL sinapsi di Azure.
```powershell
...
### Esempio 2: rimuovere i tipi di informazioni correnti e le etichette di sensitività delle colonne in un pool di SQL sinapsi di Azure tramite piping.
```powershell
...
### Esempio 3: rimuovere il tipo di informazioni e l'etichetta di sensitività di una colonna in un pool di SQL sinapsi di Azure tramite piping.
```powershell
