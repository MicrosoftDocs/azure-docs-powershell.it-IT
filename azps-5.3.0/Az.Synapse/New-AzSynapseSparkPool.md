...
### CreateByNameAndEnableAutoScaleParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **New-AzSynapseSparkPool** crea un pool di Spark di analisi di Azure sinapsi.
...
Questo comando crea un pool di Spark di analisi di Azure sinapsi.
...
Questo comando crea un pool di Spark di analisi di Azure sinapsi con scala automatica abilitata.
...
Questo comando crea un pool di scintille di analisi di Azure sinapsi tramite pipeline.
...
Questo comando crea un pool di Spark di analisi di Azure sinapsi con scala automatica abilitata tramite pipeline.
