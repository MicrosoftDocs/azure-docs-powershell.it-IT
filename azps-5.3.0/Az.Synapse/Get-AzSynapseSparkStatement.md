...
### GetSparkStatementsByIdParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzSynapseSparkStatement** ottiene le informazioni su un'istruzione Spark di Azure sinapsi analitica.
...
Questo comando ottiene tutte le istruzioni Spark in una sessione di Spark.
...
Questo comando ottiene l'istruzione Spark con l'ID Livio specificato.
...
Questo comando consente di ottenere tutte le istruzioni Spark in una sessione di Spark tramite pipeline.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSSynapseSparkStatement
