...
## Descrizione
Il cmdlet **Get-AzSynapseIntegrationRuntime** ottiene le informazioni sui runtime di integrazione in un'area di lavoro.
...
Se non specifichi un nome, questo cmdlet recupera informazioni su tutti i runtime di integrazione in un'area di lavoro.
...
Elenca tutti i runtime di integrazione nell'area di lavoro denominata ContosoWorkspace.
...
Questo comando Visualizza le informazioni sul runtime di integrazione denominato "test-SelfHost-IR" nell'area di lavoro denominata ContosoWorkspace.
...
Questo comando Visualizza lo stato dei dettagli relativi al runtime di integrazione denominato "test-SelfHost-IR" nell'area di lavoro denominata ContosoWorkspace.
