...
## Descrizione
Il cmdlet **Invoke-AzSynapseIntegrationRuntimeUpgrade** aggiorna il runtime di integrazione ospitata autonomamente se la nuova versione è disponibile.
...
Il cmdlet aggiorna il runtime di integrazione ospitale denominato "test-SelfHost-IR" nell'area di lavoro ContosoWorkspace.
