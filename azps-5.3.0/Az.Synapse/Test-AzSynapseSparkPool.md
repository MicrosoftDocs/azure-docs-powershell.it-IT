...
## Descrizione
Il cmdlet **test-AzSynapseSparkPool** controlla l'esistenza di un pool di Spark di analisi sinapsi.
...
Questo comando controlla l'esistenza del pool di scintille specificato.
