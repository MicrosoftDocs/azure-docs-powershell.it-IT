...
## Descrizione
Il cmdlet **New-AzSynapseSqlPoolRestorePoint** crea un nuovo punto di ripristino a cui può essere ripristinato un pool di analisi SQL di Azure sinapsi.
...
Questo comando crea un punto di ripristino per il pool SQL denominato ContosoSqlPool nell'area di lavoro ContosoWorkspace.
...
### -RestorePointLabel
L'etichetta con cui associamo un punto di ripristino può non essere univoca.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSRestorePoint
