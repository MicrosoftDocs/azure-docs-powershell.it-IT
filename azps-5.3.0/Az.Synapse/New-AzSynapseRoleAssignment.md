...
### NewByWorkspaceNameAndNameParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **New-AzSynapseRoleAssignment** crea un'assegnazione di ruolo di analisi di Azure sinapsi.
...
Questo comando assegna ContosoRole all'utente il cui nome principale è Contosoname tramite pipeline.
