...
Questo comando crea una pipeline denominata ContosoPipeline nell'area di lavoro denominata ContosoWorkspace.
Il comando basa la pipeline sulle informazioni nella pipeline.jssu file.
...
Questo comando crea una pipeline denominata ContosoPipeline nell'area di lavoro denominata ContosoWorkspace tramite pipeline.
Il comando basa la pipeline sulle informazioni nella pipeline.jssu file.
Questo file include informazioni sulle attività.
