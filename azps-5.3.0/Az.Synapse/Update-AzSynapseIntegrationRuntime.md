...
## Descrizione
Il cmdlet **Update-AzSynapseIntegrationRuntime** aggiorna le proprietà di Integration Runtime. Attualmente il cmdlet supporta solo l'aggiornamento di "AutoUpdate" e "AutoUpdateDelayOffset" per l'integrazione autonoma di Runtime.
...
Il cmdlet aggiorna l'integrazione di runtime indipendente denominata "test-SelfHost-IR".

## PARAMETRI

### -AutoUpdate
Abilitare o disabilitare l'aggiornamento automatico di runtime self-hosted Integration.
...
L'ora del giorno per l'aggiornamento automatico di runtime self-hosted Integration.
...
### Microsoft. Azure. Commands. sinapsi. Models. PSSelfHostedIntegrationRuntimeStatus
