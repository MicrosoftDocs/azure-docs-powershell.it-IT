...
## Descrizione
Il cmdlet **Update-AzSynapseIntegrationRuntimeNode** aggiorna le proprietà del nodo runtime di integrazione ospitata in un'area di lavoro. Attualmente supporta solo l'aggiornamento di "ConcurrentJobsLimit".
