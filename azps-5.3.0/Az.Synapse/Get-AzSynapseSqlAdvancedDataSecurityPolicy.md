...
## Sinossi
Ottiene i criteri avanzati per la sicurezza dei dati di un'area di lavoro.
...
## Descrizione
Il cmdlet **Get-AzSynapseSqlAdvancedDataSecurityPolicy** recupera i criteri avanzati per la sicurezza dei dati di un'area di lavoro.
...
Questo comando consente di ottenere la sicurezza dei dati avanzata nell'area di lavoro denominata ContosoWorkspace.
...
Questo comando consente di ottenere la sicurezza dei dati avanzata nell'area di lavoro denominata ContosoWorkspace tramite pipeline.
