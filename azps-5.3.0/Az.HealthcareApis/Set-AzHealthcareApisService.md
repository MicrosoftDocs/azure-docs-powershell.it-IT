...
## Sinossi
Aggiorna un servizio Fhir healthcareApis esistente.
...
### Esempio 1: aggiorna il servizio healthcareapis esistente denominato servizio nel gruppo di risorse MyResourceGroup con il cosmosdb OfferThroughput = 500.
...
### Esempio 2: aggiorna il servizio healthcareapis esistente denominato servizio nel gruppo di risorse MyResourceGroup con il cosmosdb OfferThroughput = 500 e l'URI della chiave del Vault Key "https:// \<my-keyvault> . Vault.Azure.NET/Keys/ \<my-key> "
...
### -CorsHeader
HealthcareApis FhirService elenco delle intestazioni di CORS.
...
### -CorsMethod
HealthcareApis FhirService elenco dei metodi CORS.
...
### -CorsOrigin
HealthcareApis FhirService elenco delle origini di CORS.
...
HealthcareApis FhirService CorsCredentials non consentito.
...
### -InputObject
HealthcareApis Fhir servizio inviato tramite pipe da Get-AzHealthcareApisFhirService.
...
### -ResourceGroupName
Nome del gruppo di risorse del servizio HealthcareApis.
...
### -ResourceId
HealthcareApis Fhir servizio ResourceId.
