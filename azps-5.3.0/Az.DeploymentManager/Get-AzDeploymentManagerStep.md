...
## Descrizione
Il cmdlet **Get-AzDeploymentManagerStep** ottiene un passaggio e restituisce un oggetto che rappresenta questo passaggio.
...
Puoi modificare l'oggetto localmente e quindi applicare le modifiche apportate all'origine dell'elemento usando il cmdlet Set-AzDeploymentManagerStep.
...
### Esempio 3: ottenere un passaggio usando un oggetto restituito da New-AzDeploymentManagerStep
```powershell
