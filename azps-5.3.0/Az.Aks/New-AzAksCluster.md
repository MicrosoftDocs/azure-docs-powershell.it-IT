...
La password di amministratore da usare per le VM di Windows, la cui lunghezza deve essere di almeno 12, che contiene almeno un carattere maiuscolo inferiore, vale a dire `[a-z]` uno `[A-Z]` e uno speciale `[!@#$%^&_()]` .
