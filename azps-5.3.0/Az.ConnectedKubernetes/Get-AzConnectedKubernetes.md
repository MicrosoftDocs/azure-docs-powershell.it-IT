...
## Sinossi
Restituisce le proprietà del cluster connesso specificato, inclusi nome, identità, proprietà e dettagli del cluster aggiuntivi.
...
### Esempio 1: ottenere tutti i kubernetes connessi in una sottoscrizione
```powershell
...
Questo comando ottiene tutti i kubernetes connessi in un abbonamento.

### Esempio 2: ottenere tutte le kubernetes connesse nel gruppo risorse
```powershell
...
Questo comando ottiene tutti i kubernetes connessi nel gruppo risorse.

### Esempio 3: ottenere un kubernetes connesso
```powershell
...
Questo comando ottiene un kubernetes connesso.

### Esempio 4: ottenere un kubernetes connesso per oggetto
```powershell
...
Questo comando consente di ottenere un oggetto kubernetes connesso.
...
INPUTOBJECT <IConnectedKubernetesIdentity> : parametro Identity
  - `[ClusterName <String>]`: Nome del cluster Kubernetes in cui viene chiamato Get.
