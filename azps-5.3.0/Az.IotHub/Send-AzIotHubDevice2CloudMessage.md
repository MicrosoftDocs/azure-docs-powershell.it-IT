...
## Descrizione
Il comando supporta l'invio di messaggi con le proprietà dell'applicazione e del sistema.
...
Invio del messaggio del dispositivo al cloud tramite il tipo di trasporto predefinito.
...
Invio di un dispositivo MQTT al messaggio cloud.
...
### -Messaggio
Corpo del messaggio da inviare all'hub di un sacco.
