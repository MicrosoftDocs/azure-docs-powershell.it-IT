...
## Descrizione
Il cmdlet **Import-AzKeyVaultCertificate** importa un certificato in un Vault chiave.
Puoi creare il certificato da importare usando uno dei metodi seguenti:
- Consente `Add-AzKeyVaultCertificate` di creare una richiesta di firma del certificato e inviarla a un'autorità di certificazione. Vedere https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request
...
[Creazione e Unione di RSI in Key Vault](https://docs.microsoft.com/en-us/azure/key-vault/certificates/create-certificate-signing-request)