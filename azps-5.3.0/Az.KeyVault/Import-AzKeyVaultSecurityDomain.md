...
## Descrizione
Questo cmdlet importa i dati del dominio di sicurezza esportati in precedenza in un HSM gestito.
...
Prima di tutto, è necessario fornire le chiavi per decrittografare i dati del dominio di sicurezza.
Quindi, il comando **Import-AzKeyVaultSecurityDomain** Ripristina i dati del dominio di sicurezza di backup precedenti in un HSM gestito usando questi tasti.
