...
Tieni presente che non è possibile usare qualsiasi intervallo IP all'interno `10.0.0.0-10.255.255.255` (indirizzi IP privati) per aggiungere regole di rete.
