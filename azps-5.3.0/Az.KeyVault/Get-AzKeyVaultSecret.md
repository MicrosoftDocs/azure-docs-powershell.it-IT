...
Il cmdlet restituisce il segreto come stringa quando `-AsPlainText` viene applicato.
...
### -AsPlainText
Quando è impostato, il cmdlet converte il segreto in una stringa sicura nella stringa di testo in chiaro decrittografato come output.
