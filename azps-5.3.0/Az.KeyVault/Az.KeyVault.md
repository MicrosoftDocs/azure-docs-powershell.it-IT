...
Esporta i dati del dominio di sicurezza di un HSM gestito.
...
Importa i dati del dominio di sicurezza esportati in precedenza in un HSM gestito.
...
### [Ripristinare-AzKeyVault](Restore-AzKeyVault.md)
