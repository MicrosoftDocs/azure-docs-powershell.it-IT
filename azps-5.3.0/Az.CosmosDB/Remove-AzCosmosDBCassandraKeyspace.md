...
## Sinossi
Elimina uno spazio di CosmosDB Cassandra.
...
## Descrizione
Il cmdlet **Remove-AzCosmosDBCassandraKeyspace** Elimina uno spazio delle CosmosDB Cassandra esistente.
...
Il cmdlet restituisce un oggetto di tipo bool (quando viene passato-PassThru), che è true se l'eliminazione ha avuto esito positivo.
