...
## Sinossi
Crea un nuovo oggetto di tipo PSIncludedPath. Può essere passato come valore di parametro per set-AzCosmosDBGremlinGraph.
...
## Descrizione
Oggetto corrispondente alla IncludedPath dell'API Gremlin.
