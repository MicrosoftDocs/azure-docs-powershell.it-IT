...
Elenca le chiavi per l'account di CosmosDB. Il tipo di chiave può essere valore da: connectionStrings, Keys e ReadOnlyKeys. Il valore predefinito è Keys.
