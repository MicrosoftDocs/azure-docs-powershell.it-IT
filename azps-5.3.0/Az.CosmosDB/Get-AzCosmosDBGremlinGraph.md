...
## Sinossi
Ottiene il grafico Gremlin CosmosDB.
...
## Descrizione
Il cmdlet **Get-AzCosmosDBGremlinGraph** ottiene le proprietà del grafico Gremlin di CosmosDB.
...
Oggetto Resource contiene IndexingPolicy, PartitionKey, DefaultTtl, UniqueKeyPolicy, ConflictResolutionPolicy, _rid, _ts, _etag.
