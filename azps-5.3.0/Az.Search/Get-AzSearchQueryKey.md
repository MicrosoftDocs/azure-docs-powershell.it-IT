...
## Descrizione
Il cmdlet **Get-AzSearchQueryKey** ottiene le chiavi di query del servizio di ricerca Azure.
...
L'esempio ottiene tutte le chiavi di query del servizio di ricerca di Azure.
