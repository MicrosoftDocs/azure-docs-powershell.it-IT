...
## Descrizione
Il cmdlet Suspend-AzAnalysisServicesServer sospende un'istanza di Analysis Services server
...
Questo comando sospenderà un server attivo denominato TestServer nel ResourceGroup TestGroup
