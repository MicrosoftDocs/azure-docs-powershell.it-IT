...
Il comando precedente aggiunge le autorizzazioni per le entità di database
...
### -Valore
Elenco delle entità di database di Kusto.
...
VALUE <IDatabasePrincipal [] >: l'elenco delle entità di database di Kusto.
  - `Name <String>`: Nome dell'entità database.
  - `Role <DatabasePrincipalRole>`: Ruolo principale database.
  - `Type <DatabasePrincipalType>`: Tipo di entità database.
  - `[AppId <String>]`: ID applicazione-rilevante solo per il tipo di entità Application.
  - `[Email <String>]`: Messaggio di posta elettronica principale del database se esistente.
