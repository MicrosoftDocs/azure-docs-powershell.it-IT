...
## Descrizione
Il cmdlet **set-AzSqlServerRecommendedActionState** aggiorna lo stato di un'azione consigliata di Azure SQL Server.
Questo cmdlet applica, ripristina o Elimina l'azione consigliata in base al nuovo stato.

## ESEMPI

### Esempio1: aggiornare lo stato dell'azione consigliata specificata in sospeso
```
...
Stato aggiornamenti dell'azione consigliata del server denominata "IR_ \[ test_schema \] _ \[ test_table_0 .0361551 \] _6C7AE8CC9C87E7FD5893" a "in sospeso"

## PARAMETRI

### -Advisorname
Specifica il nome del consulente che contiene l'azione consigliata.
