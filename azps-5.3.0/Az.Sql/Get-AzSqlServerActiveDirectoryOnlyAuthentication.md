...
## Descrizione
Il cmdlet **Get-AzSqlServerActiveDirectoryOnlyAuthentication** ottiene solo Azure Active Directory (Azure ad) solo un requisito di autenticazione per un server AzureSQL nell'abbonamento corrente.
...
Questo comando ottiene solo Azure Active Directory (Azure AD) solo il requisito di autenticazione per un server AzureSQL denominato Server01 associato a un gruppo di risorse denominato ResourceGroup01.
