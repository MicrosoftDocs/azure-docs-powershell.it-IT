...
## Descrizione
Il cmdlet **set-AzSqlServerFirewallRule** modifica una regola del firewall in un server di database SQL di Azure.

## ESEMPI

### Esempio 1: modificare una regola del firewall
```
...
Questo comando consente di modificare una regola del firewall denominata Rule01 nel server denominato Server01.
Il comando modifica gli indirizzi IP di inizio e fine.
...
### -FirewallRuleName
Specifica il nome della regola del firewall che questo cmdlet modifica.
