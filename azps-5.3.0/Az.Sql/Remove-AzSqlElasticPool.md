...
## Descrizione
Il cmdlet **Remove-AzSqlElasticPool** Elimina un pool di dati di Azure SQL.

## ESEMPI

### Esempio 1: eliminare un pool elastico
```
...
### -ElasticPoolName
Specifica il nome del pool elastico eliminato da questo cmdlet.
