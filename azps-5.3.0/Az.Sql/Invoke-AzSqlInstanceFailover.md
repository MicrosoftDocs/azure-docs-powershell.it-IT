...
## Descrizione
Il cmdlet **Invoke-AzSqlInstanceFailover** failover un'istanza gestita di Azure SQL.
...
Questo comando eseguirà il failover della replica primaria dell'istanza denominata "ManagedInstance01".
...
Questo comando eseguirà il failover della replica secondaria leggibile dell'istanza gestita "ManagedInstance01".
...
### -Nome
Nome dell'istanza di Azure SQL da rimuovere.
