...
## Descrizione
Il cmdlet **Get-AzSqlInstanceActiveDirectoryOnlyAuthentication** ottiene solo Azure Active Directory (Azure ad) solo il requisito di autenticazione per un'istanza gestita di AzureSQL nell'abbonamento corrente.
...
Questo comando ottiene il requisito di autenticazione di Azure Active Directory (Azure AD) solo per un'istanza gestita AzureSQL denominata ManagedInstance01 associata a un gruppo di risorse denominato ResourceGroup01.
