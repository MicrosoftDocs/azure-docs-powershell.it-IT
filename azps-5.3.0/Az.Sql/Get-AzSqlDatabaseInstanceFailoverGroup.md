...
Per eseguire il comando, è possibile che l'area del gruppo di failover dell'istanza sia usata. I valori restituiti riflettono lo stato delle istanze gestite in quell'area rispetto al gruppo di failover dell'istanza.
