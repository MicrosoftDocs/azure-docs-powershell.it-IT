...
## Descrizione
Il cmdlet Stop-AzSqlElasticJob arresta un processo con un'esecuzione in esecuzione.
Restituisce lo stato corrente dell'esecuzione del processo

## ESEMPI

### Esempio 1: arresta un processo con l'esecuzione di un processo in esecuzione
```powershell
...
Interrompe l'esecuzione di un processo in esecuzione e restituisce lo stato corrente
...
### -ParentObject
Oggetto database controllo agente
