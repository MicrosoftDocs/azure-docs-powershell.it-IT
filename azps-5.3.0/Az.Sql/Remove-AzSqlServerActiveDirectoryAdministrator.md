...
## Descrizione
Il cmdlet **Remove-AzSqlServerActiveDirectoryAdministrator** rimuove un amministratore di Azure Active Directory (Azure ad) per il server AzureSQL nell'abbonamento corrente.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse a cui è assegnato SQL Server.
