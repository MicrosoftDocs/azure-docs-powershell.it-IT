...
## Descrizione
Il cmdlet **Get-AzSqlInstance** restituisce informazioni su una o più istanze gestite da SQL Azure.
Specificare il nome di un'istanza per visualizzare le informazioni solo per quell'istanza.

## ESEMPI

### Esempio 1: ottenere tutte le istanze assegnate a un gruppo di risorse
```powershell
...
Questo comando consente di ottenere informazioni su tutte le istanze assegnate al gruppo di risorse ResourceGroup01.

### Esempio 2: ottenere informazioni su un'istanza
```powershell
...
Questo comando ottiene informazioni sull'istanza denominata managedInstance1.

### Esempio 3: ottenere tutte le istanze assegnate a un gruppo di risorse tramite il filtro
```powershell
...
Questo comando consente di ottenere informazioni su tutte le istanze assegnate al gruppo di risorse ResourceGroup01 che iniziano con "managedInstance".

### Esempio 4: ottenere tutte le istanze all'interno di un pool di istanze
```powershell
...
Questo comando consente di ottenere informazioni su tutte le istanze nel pool di istanze "instancePool0".

### Esempio 5: ottenere tutte le istanze all'interno di un pool di istanze tramite l'oggetto pool di istanze
```powershell
...
### Esempio 6: ottenere tutte le istanze all'interno di un pool di istanze tramite l'identificatore delle risorse del pool di istanze
```powershell
...
### Esempio 7: ottenere un'istanza gestita usando il relativo identificatore di risorsa
```powershell
...
### -ResourceId
Identificatore delle risorse dell'istanza gestita.
