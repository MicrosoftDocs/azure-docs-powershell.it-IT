...
## Descrizione
Il cmdlet **Get-AzSqlElasticPoolAdvisor** ottiene uno o più consulenti di Azure SQL Elastic pool Advisor per un pool di Azure SQL Elastic.

## ESEMPI

### Esempio 1: elencare tutti gli Advisor per il pool elastico specificato
```
...
Il comando ottiene elenca tutti gli Advisor per il pool elastico denominato WIRunnerPool.

### Esempio 2: ottenere un singolo consulente per il pool elastico specificato
```
...
Questo comando consente di ottenere il consulente denominato CreateIndex per il pool elastico denominato WIRunnerPool.
...
Questo comando consente di ottenere tutti gli Advisor per il pool elastico con le azioni consigliate incluse nella risposta.
...
### Esempio 5: elencare tutti gli Advisor per il pool elastico specificato tramite filtro
```
...
Il comando ottiene elenca tutti gli Advisor per il pool elastico denominato WIRunnerPool che iniziano con la lettera "d".
...
### -ElasticPoolName
Specifica il nome del pool elastico per il quale questo cmdlet richiede il consulente.
...
Indica che il cmdlet include le azioni consigliate del consulente nella risposta.
...
## Note
* Parole chiave: Azure, azurerm, ARM, Resource, Management, Manager, SQL, elasticpool, MSSQL, Advisor
