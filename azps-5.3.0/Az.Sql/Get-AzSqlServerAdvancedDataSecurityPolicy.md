...
## Descrizione
Il cmdlet **Get-AzSqlServerAdvancedDataSecurityPolicy** recupera i criteri avanzati per la sicurezza dei dati di un server.

## ESEMPI

### Esempio 1: ottiene la sicurezza dei dati avanzata del server
```powershell
...
### Esempio 2: ottiene la sicurezza dei dati avanzata del server dalla risorsa server
```powershell
