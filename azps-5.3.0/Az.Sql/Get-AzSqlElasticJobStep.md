...
## Descrizione
Il cmdlet Get-AzSqlElasticJobStep ottiene uno o più passaggi da un processo

## ESEMPI

### Esempio 1: ottiene un passaggio di processo da un processo
```powershell
...
Ottiene un passaggio di processo da un processo
