...
### LogReplayInstanceDatabaseFromInputParameters (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Start-AzSqlInstanceDatabaseLogReplay** avvia l'avvio del servizio di riproduzione del log.
...
Questo comando creerà un nuovo database gestito e inizierà a ripristinare i backup dal contenitore dato fino a quando non viene ripristinato last_backup. bak.
...
Questo comando creerà un nuovo database gestito e inizierà a ripristinare i backup dal contenitore dato fino a quando non viene chiamato Complete-AzSqlInstanceDatabaseLogReplay con l'ultimo backup desiderato.

## PARAMETRI

### -AutoCompleteRestore
L'indicatore se eseguire o meno il ripristino automatico al completamento.
...
### -Regole di confronto
Regole di confronto del database dell'istanza da usare.
...
### -LastBackupName
Nome dell'ultimo file di backup da ripristinare.
...
### -Nome
Nome del database dell'istanza.
...
### -PassThru
Definisce se restituire il gruppo di sincronizzazione.
...
### -StorageContainerUri
URI del contenitore di archiviazione.
