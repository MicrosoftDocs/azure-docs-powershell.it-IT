...
## Descrizione
Il cmdlet Remove-AzSqlInstanceDatabaseSensitivityClassification rimuove i tipi di informazioni e le etichette di sensitività delle colonne nel database di istanze gestite di Azure SQL.

## ESEMPI

### Esempio 1: rimuovere il tipo di informazioni e l'etichetta di sensitività di una colonna in un database di istanze gestite di Azure SQL.
```powershell
...
### Esempio 2: rimuovere i tipi di informazioni correnti e le etichette di sensitività delle colonne in un database di istanze gestite di Azure SQL con piping.
```powershell
...
### Esempio 3: rimuovere il tipo di informazioni e l'etichetta di sensitività di una colonna in un database di istanze gestite di Azure SQL con piping.
```powershell
