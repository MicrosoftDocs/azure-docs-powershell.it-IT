...
## Descrizione
Il cmdlet Remove-AzSqlInstanceKeyVaultKey rimuove la chiave di volta chiave dall'istanza gestita specificata. Tieni presente che le autorizzazioni dell'istanza di SQL Managed per il Vault della chiave non vengono modificate. Per modificare le autorizzazioni, usare set-AzKeyVaultAccessPolicy. Tieni presente che questo cmdlet non apporta alcuna modifica alla chiave Vault. Per rimuovere una chiave da Vault chiave, usare Remove-AzureKeyVaultKey.
...
Questo comando rimuove la chiave di volta chiave con ID ' https://contoso.vault.azure.net/keys/contosokey/01234567890123456789012345678901 ' dall'istanza gestita specificata. 
