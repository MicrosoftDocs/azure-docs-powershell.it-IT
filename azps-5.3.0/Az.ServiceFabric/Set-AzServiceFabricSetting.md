...
## Descrizione
Usare **set-AzServiceFabricSetting** per aggiungere o aggiornare le impostazioni del tessuto del servizio in un cluster.
...
Questo comando imposterà "MaxFileOperationTimeout" sul valore "5000" nella sezione "NamingService".
...
Questo comando attiverà un aggiornamento per impostare l'impostazione di più fabric usando il parametro SettingsSectionDescription.
...
### Parametro-
Nome parametro dell'impostazione del tessuto
...
### -Sezione
Nome sezione dell'impostazione del tessuto
...
Matrice di impostazioni del tessuto
...
### -Valore
Valore di parametro dell'impostazione del tessuto
