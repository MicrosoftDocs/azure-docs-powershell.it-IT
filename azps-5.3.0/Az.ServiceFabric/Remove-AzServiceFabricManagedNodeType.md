...
## Descrizione
Rimuovere il tipo di nodo o i nodi specifici all'interno del tipo di nodo. Se paremter-nodeName viene usato, verranno rimossi solo i nodi specificati.
...
USA con cautela poiché questo può causare perdite di dati se i carichi di lavoro con stato sono in esecuzione nei nodi o se il cluster non contiene abbastanza nodi di inizializzazione dopo opearion.
