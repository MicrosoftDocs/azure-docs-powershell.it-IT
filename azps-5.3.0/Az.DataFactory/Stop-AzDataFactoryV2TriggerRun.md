...
## Sinossi
Interrompe l'esecuzione di un trigger in una data factory.
...
## Descrizione
Il cmdlet **Stop-AzDataFactoryV2TriggerRun** interrompe l'esecuzione di un trigger in una factory di dati specificata con il nome del trigger e l'ID esecuzione del trigger.
Attualmente supportato solo per TumblingWindowTriggers nello stato WaitingOnDependency.
...
Questo comando interrompe l'esecuzione del trigger con l'ID ' 08586002468005888497807248799CU16' nella Factory WikiADF.
