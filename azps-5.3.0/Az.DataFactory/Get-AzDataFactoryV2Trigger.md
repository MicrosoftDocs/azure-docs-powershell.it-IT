...
## Descrizione
Il cmdlet **Get-AzDataFactoryV2Trigger** ottiene le informazioni sui trigger in una data factory. Se specifichi il nome di un trigger, il cmdlet otterrà le informazioni sul trigger. Se non specifichi un nome, il cmdlet riceverà informazioni su tutti i trigger nella data factory.
