...
## Descrizione
Questo comando esegue Data Preview/stats Preview/Expression Preview per un flusso diverso di flusso di dati nella sessione di debug.
...
Questo esempio richiama il comando Anteprima dati per la sessione di debug "fd76cd0d-8b37-4DC0-A370-3f9d43ac686d" in Factory di dati "WiKiADF" e quindi converte l'output JSON in una stringa leggibile.
...
### -Colonne
Elenco colonne per statistiche flusso di dati in anteprima.
...
### -Comando
Comando debug flusso di dati. Le opzioni sono executePreviewQuery, executeStatisticsQuery e executeExpressionQuery
...
### -Expression
Espressione per l'anteprima dell'espressione flusso di dati.
...
### -RowLimits
Limite di riga per l'anteprima dei dati del flusso di dati.
...
### -StreamName
Nome flusso del flusso di dati per il debug.
...
## Note
Parole chiave: Azure, azurerm, ARM, Resource, Management, Manager, data, factoriesKeywords: Azure, azurerm, ARM, Resource, Management, Manager, data, Factory
