...
### Esempio 3: creare un cluster di Azure HDInsight che consente la crittografia in transito
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 4: creare un cluster Azure HDInsight con la caratteristica inoltro in uscita e collegamento privato
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 5: creare un cluster di Azure HDInsight che consente la crittografia in host
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 6: creare un cluster di Azure HDInsight che Abilita la scalabilità verticale.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 7: creare un cluster di Azure HDInsight con il proxy REST di Kafka.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 8: creare un cluster di Azure HDInsight con l'archiviazione di Azure Data Lake Gen2 storage.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
### Esempio 9: creare un cluster di Azure HDInsight con ESP (Enterprise Security Package) e abilitare HDInsight ID Broker.
```
PS C:\&gt; # Primary storage account info
        $storageAccountResourceGroupName = "Group"
        $storageAccountResourceId = "yourstorageaccountresourceid"
...
Ottiene o imposta la configurazione di scala automatica
...
### -EnableIDBroker
Abilita la caratteristica di HDInsight Identity Broker.
...
### -EncryptionAtHost
Ottiene o imposta il contrassegno che indica se abilitare la crittografia in host o meno.
...
### -EncryptionInTransit
Ottiene o imposta il contrassegno che indica se abilitare la crittografia in transito o meno.
...
### -KafkaClientGroupId
Ottiene o imposta l'ID del gruppo client per l'accesso al proxy REST di Kafka.
...
Ottiene o imposta il nome del gruppo client per l'accesso al proxy REST di Kafka.
...
### -StorageAccountKey
Ottiene o imposta il codice di accesso dell'account di archiviazione per l'account di archiviazione.
...
Ottiene o imposta l'ID risorsa di archiviazione per l'account di archiviazione.
...
### -StorageFileSystem
Ottiene o imposta il file System per l'account di archiviazione di Gen2 di Azure Data Lake predefinito.
...
### -StorageRootPath
Ottiene o imposta il percorso della radice del cluster nell'account predefinito di data Lake Store.
...
### -SubnetName
Ottiene o imposta il nome della subnet per il cluster HDInsight.
