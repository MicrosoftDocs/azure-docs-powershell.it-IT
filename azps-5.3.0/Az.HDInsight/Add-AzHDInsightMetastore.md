...
## Descrizione
Il cmdlet **Add-AzHDInsightMetastore** aggiunge un hive o oozie Metastore all'oggetto di configurazione HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.
Un Metastore è un database SQL che può essere usato per archiviare metadati per hive, oozie o entrambi.

## ESEMPI

### Esempio 1: aggiungere un Metastore di database SQL all'oggetto di configurazione del cluster
```
...
Questo comando aggiunge un Metastore di database SQL al cluster denominato your-Hadoop-001.

### Esempio 2: aggiungere un database di Ambari personalizzato all'oggetto di configurazione del cluster
```
PS C:\># Primary storage account info
PS C:\> $storageAccountResourceGroupName = "Group"
PS C:\> $storageAccountResourceId = "yourstorageaccountresourceid"
...
Questo comando aggiunge un database di Ambari personalizzato al cluster denominato your-Hadoop-002.
...
### -Credenziale
Specifica le credenziali da usare per il database del server AzureSQL.
...
### -DatabaseName
Specifica il database nell'istanza del server AzureSQL da usare per questo Metastore.
...
### -MetastoreType
Specifica il tipo di Metastore.
I valori possibili sono HiveMetastore o OozieMetastore.
...
### -SqlAzureServerName
Specifica l'istanza del server AzureSQL da usare per questo Metastore.
