...
## Descrizione
Il cmdlet **Remove-AzDataLakeAnalyticsDataSource** consente di rimuovere un'origine dati da un account di analisi di Azure Data Lake.
...
### -BLOB
Specifica il nome dell'account di archiviazione di AzureBlob da rimuovere.
...
### -DataLakeStore
Specifica il nome dell'account di AzureData Lake Store da rimuovere.
