...
## Descrizione
Il cmdlet **Invoke-AzDataBoxEdgeShare** richiama l'azione per aggiornare i dati in una condivisione in un dispositivo Edge della casella dati.
...
### -RefreshData
Aggiornare i metadati di condivisione con i dati del cloud
