...
## Descrizione
Il cmdlet **Remove-AzDataBoxEdgeStorageAccountCredential** rimuove le credenziali dell'account di archiviazione per un dispositivo Edge della casella dati.
