...
## Descrizione
Il cmdlet **Start-AzHpcCache** avvia una cache HPC di Azure.
...
### -Force
Indica che il cmdlet non chiede conferma. Per impostazione predefinita, questo cmdlet richiede di confermare che si vuole avviare la cache.
...
### -ResourceGroupName
Nome del gruppo di risorse in cui si vuole avviare la cache.
