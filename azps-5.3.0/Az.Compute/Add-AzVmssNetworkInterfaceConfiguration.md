...
## Descrizione
Il cmdlet **Add-AzVmssNetworkInterfaceConfiguration** aggiunge una configurazione di interfaccia di rete al set di scale della macchina virtuale (VMSS).
...
Specifica se l'interfaccia di rete è abilitata per l'accelerazione della rete.
...
### -EnableIPForwarding
Specifica se l'inoltro IP è abilitato in questa scheda di scelta.
