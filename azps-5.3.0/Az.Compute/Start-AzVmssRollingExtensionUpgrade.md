...
## Sinossi
Questo cmdlet avvia un aggiornamento a rotazione per tutte le estensioni nella scala della macchina virtuale specificata impostata sulla versione più recente disponibile. 
...
## Descrizione
Avvia un aggiornamento a rotazione per trasferire tutte le estensioni in questa scala della macchina virtuale impostata sulla versione più recente disponibile.
Le estensioni già in esecuzione dell'ultima versione disponibile non sono interessate.
...
Questo esempio ottiene l'impostazione della scala VM esistente "MyVmssName" e aggiunge un'estensione. Il comando finale esegue il processo di aggiornamento a rotazione dell'estensione. 
...
### -ResourceId
ID risorsa dell'oggetto set di scale VM. 
