...
# Modulo AZ. Compute
## Descrizione
In questo argomento vengono visualizzati gli argomenti della Guida per i cmdlet COMPUTE di Azure.
...
Aggiunge un disco di dati a un oggetto Image.
...
Ottiene le proprietà degli accessi su disco
...
Ottenere o elencare le raccolte.
...
Ottiene tutte le versioni di un VMImage.
...
Ottiene le impostazioni per un'estensione di SQL Server in una macchina virtuale.
...
Valutare lo stato di patch di una macchina virtuale.

### [Invoke-AzVMReimage](Invoke-AzVMReimage.md)
Riimmagine di una macchina virtuale di Azure.
...
Crea una risorsa di Access su disco
...
Crea un oggetto set di crittografia del disco configurabile.
...
Crea un oggetto di aggiornamento istantaneo configurabile.
...
Rimuove un set di crittografia disco.
...
### [Rimuovi-AzImo](Remove-AzImage.md)
Rimuove un'immagine.
...
Rimuove un disco di dati da VMSS.
...
Rimuove un disco dati da una scala macchina virtuale set VM
...
Revoca un accesso a un disco.

### [Revoke-AzSnapshotAccess](Revoke-AzSnapshotAccess.md)
Revoca un accesso a uno snapshot.
...
Imposta le proprietà della chiave di crittografia del disco in un oggetto di aggiornamento del disco.
...
Imposta le proprietà della chiave di crittografia del disco in un oggetto snapshot.

### [Set-AzSnapshotImageReference](Set-AzSnapshotImageReference.md)
Imposta le proprietà di riferimento dell'immagine in un oggetto snapshot.
...
Imposta le proprietà della chiave di crittografia del disco in un oggetto aggiornamento snapshot.

### [Set-AzSnapshotUpdateKeyEncryptionKey](Set-AzSnapshotUpdateKeyEncryptionKey.md)
Imposta le proprietà chiave di crittografia chiave in un oggetto Update di snapshot.
...
Imposta le proprietà delle estensioni di backup in una macchina virtuale.
...
Imposta lo stato del servizio di orchestrazione per VMSS.
...
Aggiorna un set di crittografia disco.
