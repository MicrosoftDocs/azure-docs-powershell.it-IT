...
## Descrizione
Il cmdlet **Update-AzContainerService** aggiorna lo stato di un servizio contenitore in base a un'istanza locale del servizio.
...
Questo comando ottiene il servizio contenitore denominato CSResourceGroup17 usando il cmdlet Get-AzContainerService.
Il comando passa l'oggetto al cmdlet Remove-AzContainerServiceAgentPoolProfile usando l'operatore pipeline.
**Remove-AzContainerServiceAgentPoolProfile** rimuove il profilo denominato AgentPool01.
Il comando passa il risultato al cmdlet Add-AzContainerServiceAgentPoolProfile.
**Add-AzContainerServiceAgentPoolProfile** aggiunge un profilo con il nome AgentPool01 e ha le proprietà specificate.
