...
### -EncryptionType
Usare questa impostazione per impostare il tipo di crittografia del set di crittografia disco. I valori disponibili sono: "EncryptionAtRestWithPlatformKey", "EncryptionAtRestWithCustomerKey".
...
### -KeyUrl
URL che punta alla chiave attiva in Key Vault
...
### -SourceVaultId
ID risorsa del caveau contenente il tasto attivo.
