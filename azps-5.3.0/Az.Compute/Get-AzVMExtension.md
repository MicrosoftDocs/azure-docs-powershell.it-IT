...
### Esempio 3: ottenere tutte le estensioni installate in una VM
```
...
Questo comando consente di ottenere l'elenco delle estensioni installate nella macchina virtuale denominata VirtualMachine22 nel gruppo di risorse ResourceGroup11.
