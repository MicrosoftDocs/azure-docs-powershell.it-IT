...
Creare una versione di immagine della raccolta con crittografia immagine disco.
...
### -DataDiskImage
Immagini disco dati.   ad esempio, @ {source = @ {ID =<source_id>}; Lun = 1; SizeInGB = 100; HostCaching = "ReadOnly"}
...
### -OSDiskImage
Immagine del disco OS ad esempio @ {source = @ {ID =<source_id>}; SizeInGB = 100; HostCaching = "ReadOnly"}
...
Data di fine della durata della versione dell'immagine della raccolta.
...
Se è impostato, le macchine virtuali distribuite dalla versione più recente della definizione di immagine non utilizzeranno questa versione di immagine.
...
### -ReplicaCount
Numero di repliche della versione di immagine da creare per area geografica.
...
### -SourceImageId
ID dell'immagine di origine da cui verrà creata la versione di immagine.
...
### -StorageAccountType
Specifica il tipo di account di archiviazione da usare per archiviare l'immagine. Questa proprietà non è aggiornabile. I valori disponibili sono Standard_LRS, Standard_ZRS e Premium_LRS.
