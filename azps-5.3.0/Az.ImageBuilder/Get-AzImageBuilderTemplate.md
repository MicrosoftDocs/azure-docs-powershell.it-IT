...
### Esempio 1: elenca tutti i modelli in una sottoscrizione
```powershell
...
Questo comando elenca tutti i modelli in un abbonamento.

### Esempio 2: elenca tutti i modelli in un gruppo di risorse
```powershell
...
Questo comando ottiene un modello in un gruppo di risorse.
