...
## Descrizione
Richiama una richiesta di accesso temporaneo alla rete.
La richiesta viene convalidata rispetto ai criteri di accesso alla rete JIT configurati e, se consentito, apre una connessione di rete in base alla richiesta dell'utente.
La richiesta verrà registrata nel criterio per la revisione successiva e verrà terminata quando verrà superata la durata specificata.
...
Apre una connessione di rete per 1 ora sulla porta 22 dall'IP pubblico (non visualizzato).
