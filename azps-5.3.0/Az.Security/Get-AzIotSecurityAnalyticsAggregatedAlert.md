...
## Descrizione
Il cmdlet Get-AzIotSecurityAnalyticsAggregatedAlert restituisce uno o più avvisi aggregati nei dispositivi di hub.
Il nome degli avvisi aggregati è una combinazione del tipo di avviso e della data di aggragted di avviso, separati da "/".
...
Ottenere l'avviso aggregato "IoT_Bruteforce_Fail/2019-02-02" (il nome combinato dal tipo di avviso e la data aggregata) nella soluzione "soluzione" e il gruppo di risorse "MyResourceGroup"
...
Ottenere un elenco di tutti gli avvisi aggregati in soluzione "soluzione" e gruppo risorse "MyResourceGroup"
