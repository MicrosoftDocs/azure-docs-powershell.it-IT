...
## Descrizione
Il cmdlet New-AzDeviceSecurityGroupAllowlistCustomAlertRuleObject crea un nuovo elenco di regole di avviso personalizzate consentite per il gruppo di sicurezza dei dispositivi nella soluzione di sicurezza degli articoli.
...
Creare un nuovo elenco di avvisi Rull da tipo "LocalUserNotAllowed" con stato impostato su Disabilita

## PARAMETRI

### -AllowlistValue
Consenti valori elenco.
