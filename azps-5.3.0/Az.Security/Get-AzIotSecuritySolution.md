...
## Descrizione
Il cmdlet Get-AzIotSecuritySolution restituisce una o più soluzioni di sicurezza per gli altri. La soluzione per la sicurezza degli argomenti raccoglie i dati di sicurezza e gli eventi provenienti da dispositivi molto e hub per evitare e rilevare le minacce.
...
Ottenere la soluzione "esempio" nel gruppo di risorse "MyResourceGroup"
...
Ottenere l'elenco di tutte le soluzioni di sicurezza nel gruppo di risorse "MyResourceGroup"
