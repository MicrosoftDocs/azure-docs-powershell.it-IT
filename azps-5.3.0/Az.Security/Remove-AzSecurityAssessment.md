...
## Sinossi
Elimina un risultato di valutazione della sicurezza da un abbonamento.
...
## Descrizione
Elimina un risultato della valutazione di sicurezza da un abbonamento, in genere usato quando viene eliminato un resoruce o quando la valutazione non è più pertinente per una risorsa specifica
...
Elimina un risultato di valutazione in un abbonamento
