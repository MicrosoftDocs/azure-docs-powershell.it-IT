...
## Sinossi
Elimina un servizio bot dal gruppo risorse.
...
### Esempio 1: eliminare il BotService per nome e ResourceGroupName
```powershell
PS C:\> Remove-AzBotService -Name youri-bot -ResourceGroupName youriBotTest

```

Eliminare il BotService per nome e ResourceGroupName

### Esempio 2: eliminare il BotService da InputObject
```powershell
...
Eliminare il BotService da InputObject
