...
### Esempio 1: ottenere tutti BotServices
```powershell
...
Ottenere tutti BotServices

### Esempio 2: ottenere il BotService in base a ResourceGroupName e Name
```powershell
...
Ottenere il BotService per ResourceGroupName e nome

### Esempio 3: ottenere tutte le BotServices da ResourceGroupName
```powershell
...
Ottenere tutti i BotServices da ResourceGroupName

### Esempio 4: ottenere il BotService da inputObject
```powershell
...
Ottenere il BotService da inputObject
