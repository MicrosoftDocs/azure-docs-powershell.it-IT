...
### Esempio 1: eliminare un desktop di Windows Virtual SessionHost per nome
```powershell
PS C:\> Remove-AzWvdSessionHost -ResourceGroupName ResourceGroupName -HostPoolName HostPoolName -Name SessionHostName
```

Questo comando Elimina un SessionHost desktop virtuale di Windows in un pool host.
...
### -Force
Imponi flag per forzare l'eliminazione di sessionHost anche quando userSession esiste.
