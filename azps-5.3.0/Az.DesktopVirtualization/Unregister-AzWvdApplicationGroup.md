...
### Esempio 1: annullare la registrazione di un gruppo di applicazioni desktop virtuale di Windows
```powershell
...
Questo comando Annulla la registrazione di un gruppo di applicazioni desktop virtuale di Windows in un'area di lavoro.

## PARAMETRI

### -ApplicationGroupPath
Percorso ResourceGroupName
