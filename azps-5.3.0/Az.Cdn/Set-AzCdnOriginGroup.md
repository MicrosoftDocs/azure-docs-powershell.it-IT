...
## Sinossi
Aggiorna il gruppo origine CDN
...
## Descrizione
Set-AzCdnOriginGroup aggiornerà il gruppo di origine specificato nell'endpoint specificato. 
...
```
Questo cmdlet aggiornerà la proprietà ProbeIntervalInSeconds nel gruppo Origin. 
