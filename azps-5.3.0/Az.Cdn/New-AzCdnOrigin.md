...
## Descrizione
L'New-AzCdnOrigin creerà una nuova origine CDN nell'endpoint specificato.
...
Questo cmdlet creerà una nuova origine CDN per l'endpoint specificato. Userà il nome host specificato come origine. 
...
### -HostName
Nome host di origine CDN di Azure.
...
### -HttpPort
Porta http di origine CDN di Azure.
...
### -HttpsPort
Porta HTTPS di origine CDN di Azure.
...
### -OriginHostHeader
Intestazione dell'host della rete CDN di Azure.
