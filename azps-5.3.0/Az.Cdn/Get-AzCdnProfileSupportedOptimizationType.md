...
## Descrizione
Il cmdlet **Get-AzCdnProfileSupportedOptimizationType** ottiene i tipi di ottimizzazione supportati per il profilo corrente. Un utente può creare un endpoint con un tipo di ottimizzazione dei valori elencati.
