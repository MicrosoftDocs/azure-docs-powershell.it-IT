...
Ottenere una risorsa con ambito collegamento privato
...
Ottiene le regole di avviso metriche V2 (non classiche)

### [Get-AzMetricDefinition](Get-AzMetricDefinition.md)
Ottiene le definizioni metriche.

### [Get-AzScheduledQueryRule](Get-AzScheduledQueryRule.md)
Ottiene le risorse di query pianificate
...
Creare un oggetto PSDiagnosticDetailSetting, digitare può essere Metric o log

### [New-AzDiagnosticSetting](New-AzDiagnosticSetting.md)
Creare un oggetto PSServiceDiagnosticSettings.
...
creare per la risorsa con ambito collegamento privato
...
Crea un oggetto di selezione della dimensione locale che può essere usato per creare criteri di avviso metrici.
...
Crea una regola di avviso del log (tipo di regola di query pianificato)

### [New-AzScheduledQueryRuleAlertingAction](New-AzScheduledQueryRuleAlertingAction.md)
Crea un oggetto di tipo azione di avviso
...
Crea un oggetto del trigger di metrica log di tipo.

### [New-AzScheduledQueryRuleSchedule](New-AzScheduledQueryRuleSchedule.md)
Crea un oggetto di tipo Schedule
...
Crea un oggetto di tipo condizione trigger
...
Elimina per la risorsa con ambito collegamento privato
...
Aggiorna una regola di avviso del log

### [Update-AzInsightsPrivateLinkScope](Update-AzInsightsPrivateLinkScope.md)
Aggiornamento per l'ambito dei collegamenti privati
