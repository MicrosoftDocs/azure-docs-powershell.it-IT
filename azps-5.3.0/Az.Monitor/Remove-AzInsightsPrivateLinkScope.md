...
eliminare l'ambito dei collegamenti privati con il nome "scope_name" in gruppo risorse "rg_name"
...
eliminare l'ambito dei collegamenti privati con ID risorsa
...
eliminare l'ambito dei collegamenti privati con l'oggetto ambito del collegamento privato di input
