...
Ottenere tutti i server in un progetto di migrazione.
...
Ottenere un server in un progetto di migrazione per nome.
Name è un paramenter univoco per un server.
...
Elenca tutti i server di un dispositivo in un progetto.

### Esempio 4: entrare in un appliance
```powershell
...
Ottenere un server per un dispositivo in un progetto.
Name è un paramenter univoco per un server.
...
### Esempio 6: elenco in un dispositivo e filtro in base al nome visualizzato
```powershell
...
Elencare i server per un dispositivo in un progetto di migrazione e filtrare le risposte con il nome visualizzato.

## PARAMETRI

### -Appliancename
Specifica il nome dell'appliance.
Questa mappa internamente a un sito.
...
### -DisplayName
Specifica il nome visualizzato della macchina VMware.
...
Per gli utenti, USA nome visualizzato.
