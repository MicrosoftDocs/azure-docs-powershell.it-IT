...
## Sinossi
Crea un nuovo mapping del disco
...
Ottenere l'oggetto dischi per specificare l'input per New-AzMigrateServerReplication
...
### -DiskID
Specifica l'ID disco del disco collegato al server individuato di cui eseguire la migrazione.
...
### -IsOSDisk
Specifica se il disco contiene il sistema operativo per il server di origine di cui eseguire la migrazione.
