...
### Esempio 1: ottenere i tasti di scelta del database
```powershell
...
Questo comando consente di ottenere le chiavi di accesso segrete usate per l'autenticazione delle connessioni al database della cache di redis Enterprise denominata cache.
