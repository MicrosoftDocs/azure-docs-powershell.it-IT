...
### Esempio 1: ottenere una cache di redis Enterprise per nome
```powershell
...
Questo comando consente di ottenere la cache di redis Enterprise denominata cache.

### Esempio 2: ottenere ogni cache di redis Enterprise in un gruppo di risorse
```powershell
...
Questo comando consente di ottenere tutte le cache di redis Enterprise nel gruppo di risorse specificato.
