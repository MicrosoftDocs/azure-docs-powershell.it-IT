...
### Esempio 1: aggiornare la cache di redis Enterprise
```powershell
...
Questo comando Aggiorna la versione minima di TLS e aggiunge un contrassegno alla cache di redis Enterprise denominata cache.
