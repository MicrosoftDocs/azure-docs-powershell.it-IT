...
Questo comando importa un file di database nel database della cache di redis Enterprise denominata cache.

### Esempio 2: importare database (con l'esempio filename)
```powershell
#[SuppressMessage("Microsoft.Security", "CS002:SecretInNextLine", Justification="Invalid SAS token")]
...
### -SasUri
URI SAS per il BLOB di destinazione da cui importare
