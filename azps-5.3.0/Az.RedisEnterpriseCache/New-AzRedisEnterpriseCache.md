...
## Sinossi
Crea un cluster di cache Redis Enterpise e un database associato
...
### Esempio 1: creare una cache aziendale di redis
```powershell
...
Questo comando crea una cache di redis Enterprise denominata cache.

### Esempio 2: creare una cache di redis Enterprise usando alcuni parametri facoltativi
```powershell
...
Questo comando crea una cache di redis Enterprise denominata cache con alcuni parametri facoltativi.
...
I valori predefiniti sono 2 o 3 a seconda della SKU.
I valori validi sono (2, 4, 6,...) per gli SKU aziendali e (3, 9, 15,...) per le SKU Flash.
...
### -MinimumTlsVersion
Versione TLS minima per il cluster da supportare, ad esempio 1,2
...
### -SKU
Tipo di cluster RedisEnterprise da distribuire.
...
### -Zona
Aree in cui verrà distribuito il cluster.
