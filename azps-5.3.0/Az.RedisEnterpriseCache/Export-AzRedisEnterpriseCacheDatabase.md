...
### Esempio 1: esportare il database
```powershell
...
Questo comando Esporta il database della cache di redis Enterprise denominata cache in un file di database.
...
### -SasUri
URI SAS per la directory di destinazione da esportare in
