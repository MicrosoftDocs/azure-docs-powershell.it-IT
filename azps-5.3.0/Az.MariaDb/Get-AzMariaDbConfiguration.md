...
ms.locfileid: "98486880"
---
# <span data-ttu-id="0f383-101">Get-AzMariaDbConfiguration</span><span class="sxs-lookup"><span data-stu-id="0f383-101">Get-AzMariaDbConfiguration</span></span>

## <span data-ttu-id="0f383-102">Sinossi</span><span class="sxs-lookup"><span data-stu-id="0f383-102">SYNOPSIS</span></span>
<span data-ttu-id="0f383-103">Ottiene informazioni su una configurazione di server.</span><span class="sxs-lookup"><span data-stu-id="0f383-103">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="0f383-104">SINTASSI</span><span class="sxs-lookup"><span data-stu-id="0f383-104">SYNTAX</span></span>

### <span data-ttu-id="0f383-105">Elenco (impostazione predefinita)</span><span class="sxs-lookup"><span data-stu-id="0f383-105">List (Default)</span></span>
```
Get-AzMariaDbConfiguration -ResourceGroupName <String> -ServerName <String> [-SubscriptionId <String[]>]
 [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="0f383-106">Ottieni</span><span class="sxs-lookup"><span data-stu-id="0f383-106">Get</span></span>
```
Get-AzMariaDbConfiguration -Name <String> -ResourceGroupName <String> -ServerName <String>
 [-SubscriptionId <String[]>] [-DefaultProfile <PSObject>] [<CommonParameters>]
```

### <span data-ttu-id="0f383-107">GetViaIdentity</span><span class="sxs-lookup"><span data-stu-id="0f383-107">GetViaIdentity</span></span>
```
Get-AzMariaDbConfiguration -InputObject <IMariaDbIdentity> [-DefaultProfile <PSObject>] [<CommonParameters>]
```

## <span data-ttu-id="0f383-108">Descrizione</span><span class="sxs-lookup"><span data-stu-id="0f383-108">DESCRIPTION</span></span>
<span data-ttu-id="0f383-109">Ottiene informazioni su una configurazione di server.</span><span class="sxs-lookup"><span data-stu-id="0f383-109">Gets information about a configuration of server.</span></span>

## <span data-ttu-id="0f383-110">ESEMPI</span><span class="sxs-lookup"><span data-stu-id="0f383-110">EXAMPLES</span></span>

### <span data-ttu-id="0f383-111">Esempio 1: elencare tutta la configurazione in un MariaDB</span><span class="sxs-lookup"><span data-stu-id="0f383-111">Example 1: List all configuration under a MariaDB</span></span>
```powershell
...
<span data-ttu-id="0f383-112">Questo comando elenca tutta la configurazione in un MariaDB.</span><span class="sxs-lookup"><span data-stu-id="0f383-112">This command lists all configuration under a MariaDB.</span></span>

### <span data-ttu-id="0f383-113">Esempio 2: ottenere una configurazione di MariaDB</span><span class="sxs-lookup"><span data-stu-id="0f383-113">Example 2: Get a configuration of MariaDB</span></span>
```powershell
...
<span data-ttu-id="0f383-114">Questo comando ottiene una configurazione di MariaDB.</span><span class="sxs-lookup"><span data-stu-id="0f383-114">This command gets a configuration of MariaDB.</span></span>

## <span data-ttu-id="0f383-115">PARAMETRI</span><span class="sxs-lookup"><span data-stu-id="0f383-115">PARAMETERS</span></span>

### <span data-ttu-id="0f383-116">-DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="0f383-116">-DefaultProfile</span></span>
<span data-ttu-id="0f383-117">Le credenziali, l'account, il tenant e l'abbonamento usati per la comunicazione con Azure.</span><span class="sxs-lookup"><span data-stu-id="0f383-117">The credentials, account, tenant, and subscription used for communication with Azure.</span></span>
...
### <span data-ttu-id="0f383-118">-InputObject</span><span class="sxs-lookup"><span data-stu-id="0f383-118">-InputObject</span></span>
<span data-ttu-id="0f383-119">Parametro Identity da costruire, vedere la sezione Note per le proprietà di INPUTOBJECT e creare una tabella hash.</span><span class="sxs-lookup"><span data-stu-id="0f383-119">Identity Parameter To construct, see NOTES section for INPUTOBJECT properties and create a hash table.</span></span>
...
### <span data-ttu-id="0f383-120">-Nome</span><span class="sxs-lookup"><span data-stu-id="0f383-120">-Name</span></span>
<span data-ttu-id="0f383-121">Nome della configurazione del server.</span><span class="sxs-lookup"><span data-stu-id="0f383-121">The name of the server configuration.</span></span>
...
### <span data-ttu-id="0f383-122">-ResourceGroupName</span><span class="sxs-lookup"><span data-stu-id="0f383-122">-ResourceGroupName</span></span>
<span data-ttu-id="0f383-123">Nome del gruppo di risorse che contiene la risorsa.</span><span class="sxs-lookup"><span data-stu-id="0f383-123">The name of the resource group that contains the resource.</span></span>
<span data-ttu-id="0f383-124">Puoi ottenere questo valore dall'API di gestione risorse di Azure o dal portale.</span><span class="sxs-lookup"><span data-stu-id="0f383-124">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
...
### <span data-ttu-id="0f383-125">-Nomeserver</span><span class="sxs-lookup"><span data-stu-id="0f383-125">-ServerName</span></span>
<span data-ttu-id="0f383-126">Nome del server.</span><span class="sxs-lookup"><span data-stu-id="0f383-126">The name of the server.</span></span>
...
### <span data-ttu-id="0f383-127">-SubscriptionId</span><span class="sxs-lookup"><span data-stu-id="0f383-127">-SubscriptionId</span></span>
<span data-ttu-id="0f383-128">ID sottoscrizione che identifica un abbonamento a Azure.</span><span class="sxs-lookup"><span data-stu-id="0f383-128">The subscription ID that identifies an Azure subscription.</span></span>
...
### <span data-ttu-id="0f383-129">CommonParameters</span><span class="sxs-lookup"><span data-stu-id="0f383-129">CommonParameters</span></span>
<span data-ttu-id="0f383-130">Questo cmdlet supporta i parametri comuni:-debug,-ErrorAction,-ErrorVariable,-InformationAction,-InformationVariable,-OutVariable,-OutBuffer,-PipelineVariable,-Verbose,-WarningAction e-WarningVariable.</span><span class="sxs-lookup"><span data-stu-id="0f383-130">This cmdlet supports the common parameters: -Debug, -ErrorAction, -ErrorVariable, -InformationAction, -InformationVariable, -OutVariable, -OutBuffer, -PipelineVariable, -Verbose, -WarningAction, and -WarningVariable.</span></span> <span data-ttu-id="0f383-131">Per altre informazioni, Vedi [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span><span class="sxs-lookup"><span data-stu-id="0f383-131">For more information, see [about_CommonParameters](http://go.microsoft.com/fwlink/?LinkID=113216).</span></span>

## <span data-ttu-id="0f383-132">INGRESSI</span><span class="sxs-lookup"><span data-stu-id="0f383-132">INPUTS</span></span>

### <span data-ttu-id="0f383-133">Microsoft. Azure. PowerShell. Cmdlets. MariaDb. Models. IMariaDbIdentity</span><span class="sxs-lookup"><span data-stu-id="0f383-133">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.IMariaDbIdentity</span></span>

## <span data-ttu-id="0f383-134">OUTPUT</span><span class="sxs-lookup"><span data-stu-id="0f383-134">OUTPUTS</span></span>

### <span data-ttu-id="0f383-135">Microsoft. Azure. PowerShell. Cmdlets. MariaDb. Models. Api20180601Preview. IConfiguration</span><span class="sxs-lookup"><span data-stu-id="0f383-135">Microsoft.Azure.PowerShell.Cmdlets.MariaDb.Models.Api20180601Preview.IConfiguration</span></span>

## <span data-ttu-id="0f383-136">Note</span><span class="sxs-lookup"><span data-stu-id="0f383-136">NOTES</span></span>

<span data-ttu-id="0f383-137">ALIAS</span><span class="sxs-lookup"><span data-stu-id="0f383-137">ALIASES</span></span>

<span data-ttu-id="0f383-138">PROPRIETÀ COMPLESSE DI PARAMETRI</span><span class="sxs-lookup"><span data-stu-id="0f383-138">COMPLEX PARAMETER PROPERTIES</span></span>

<span data-ttu-id="0f383-139">Per creare i parametri descritti di seguito, Costruisci una tabella hash contenente le proprietà appropriate.</span><span class="sxs-lookup"><span data-stu-id="0f383-139">To create the parameters described below, construct a hash table containing the appropriate properties.</span></span> <span data-ttu-id="0f383-140">Per informazioni sulle tabelle hash, eseguire Get-Help about_Hash_Tables.</span><span class="sxs-lookup"><span data-stu-id="0f383-140">For information on hash tables, run Get-Help about_Hash_Tables.</span></span>


<span data-ttu-id="0f383-141">INPUTOBJECT <IMariaDbIdentity> : parametro Identity</span><span class="sxs-lookup"><span data-stu-id="0f383-141">INPUTOBJECT <IMariaDbIdentity>: Identity Parameter</span></span>
  - <span data-ttu-id="0f383-142">`[ConfigurationName <String>]`: Nome della configurazione del server.</span><span class="sxs-lookup"><span data-stu-id="0f383-142">`[ConfigurationName <String>]`: The name of the server configuration.</span></span>
  - <span data-ttu-id="0f383-143">`[DatabaseName <String>]`: Nome del database.</span><span class="sxs-lookup"><span data-stu-id="0f383-143">`[DatabaseName <String>]`: The name of the database.</span></span>
  - <span data-ttu-id="0f383-144">`[FirewallRuleName <String>]`: Nome della regola del firewall del server.</span><span class="sxs-lookup"><span data-stu-id="0f383-144">`[FirewallRuleName <String>]`: The name of the server firewall rule.</span></span>
  - <span data-ttu-id="0f383-145">`[Id <String>]`: Percorso identità risorse</span><span class="sxs-lookup"><span data-stu-id="0f383-145">`[Id <String>]`: Resource identity path</span></span>
  - <span data-ttu-id="0f383-146">`[LocationName <String>]`: Nome della posizione.</span><span class="sxs-lookup"><span data-stu-id="0f383-146">`[LocationName <String>]`: The name of the location.</span></span>
  - <span data-ttu-id="0f383-147">`[ResourceGroupName <String>]`: Nome del gruppo di risorse che contiene la risorsa.</span><span class="sxs-lookup"><span data-stu-id="0f383-147">`[ResourceGroupName <String>]`: The name of the resource group that contains the resource.</span></span> <span data-ttu-id="0f383-148">Puoi ottenere questo valore dall'API di gestione risorse di Azure o dal portale.</span><span class="sxs-lookup"><span data-stu-id="0f383-148">You can obtain this value from the Azure Resource Manager API or the portal.</span></span>
  - <span data-ttu-id="0f383-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: Nome del criterio di avviso per la sicurezza.</span><span class="sxs-lookup"><span data-stu-id="0f383-149">`[SecurityAlertPolicyName <SecurityAlertPolicyName?>]`: The name of the security alert policy.</span></span>
  - <span data-ttu-id="0f383-150">`[ServerName <String>]`: Nome del server.</span><span class="sxs-lookup"><span data-stu-id="0f383-150">`[ServerName <String>]`: The name of the server.</span></span>
  - <span data-ttu-id="0f383-151">`[SubscriptionId <String>]`: ID sottoscrizione che identifica un abbonamento a Azure.</span><span class="sxs-lookup"><span data-stu-id="0f383-151">`[SubscriptionId <String>]`: The subscription ID that identifies an Azure subscription.</span></span>
  - <span data-ttu-id="0f383-152">`[VirtualNetworkRuleName <String>]`: Nome della regola di rete virtuale.</span><span class="sxs-lookup"><span data-stu-id="0f383-152">`[VirtualNetworkRuleName <String>]`: The name of the virtual network rule.</span></span>

## <span data-ttu-id="0f383-153">COLLEGAMENTI CORRELATI</span><span class="sxs-lookup"><span data-stu-id="0f383-153">RELATED LINKS</span></span>
