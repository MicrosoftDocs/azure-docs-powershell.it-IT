...
Usare Update-AzMariaDbServer invece se si vuole aggiornare AdministratorLoginPassword, SKU e così via.
...
### Esempio 1: aggiornare la configurazione di MariaDB
```powershell
...
Questo comando aggiorna una configurazione MariaDB.
