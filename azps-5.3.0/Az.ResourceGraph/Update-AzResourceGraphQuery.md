...
## Sinossi
Aggiorna una query di grafico già aggiunta.
...
### Esempio 1: aggiornare la query di parametro e contrassegnare per nome
```powershell
...
Questo comando Aggiorna la query di parametro e contrassegna per nome.

### Esempio 2: aggiornare il file di parametro per oggetto
```powershell
...
Questo comando Aggiorna la query di parametro e contrassegna per oggetto.
