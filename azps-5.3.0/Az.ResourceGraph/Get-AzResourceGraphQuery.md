...
## Sinossi
Ottenere una query a singolo grafico in base alla relativa resourceName.
...
### Esempio 1: ottenere tutte le query del grafico risorse in un gruppo di risorse
```powershell
...
Questo comando consente di ottenere tutte le query del grafico risorse in un gruppo di risorse.

### Esempio 2: ottenere una query del grafico delle risorse per nome
```powershell
...
Questo comando ottiene una query per il grafico delle risorse per nome.

### Esempio 2: ottenere una query del grafico delle risorse in base a objecy
```powershell
...
Questo comando ottiene una query del grafico delle risorse per oggetto.
