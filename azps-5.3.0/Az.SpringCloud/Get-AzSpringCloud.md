...
### Esempio 1: ottenere il servizio cloud primaverile in base al nome
```powershell
...
Ottenere il servizio cloud primaverile in base al nome

### Esempio 2: elencare tutto il servizio cloud primaverile sotto il gruppo risorse.
```powershell
...
Elencare tutto il servizio cloud primaverile sotto il gruppo risorse.
