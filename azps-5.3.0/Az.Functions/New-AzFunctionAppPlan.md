...
### Esempio 1: creare un piano di app Windows Premium in Europa occidentale con una capacità di uscita fino a 10 istanze.
```powershell
...
Questo comando crea un piano per l'app Windows Premium in Europa occidentale con una capacità massima di 10 istanze.
