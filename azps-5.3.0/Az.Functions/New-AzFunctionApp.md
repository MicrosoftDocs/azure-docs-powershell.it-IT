...
### Esempio 1: creare un'app per la funzione consumer PowerShell in Central US.
```powershell
...
Questo comando crea un'app per la funzione consumer PowerShell in Central US.

### Esempio 2: creare un'app di funzione di PowerShell che verrà ospitata in un piano di servizio.
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Questo comando crea un'app di funzione di PowerShell che verrà ospitata in un piano di servizio.

### Esempio 3: creare un'app funzione usando un'immagine di ACR privata.
```powershell
PS C:\> New-AzFunctionApp -Name MyUniqueFunctionAppName `
                          -ResourceGroupName MyResourceGroupName `
                          -PlanName MyPlanName `
...
Questo comando crea un'app di funzione usando un'immagine di ACR privata.
...
### -AppSetting
Impostazioni dell'app funzione.
...
Disabilitare la creazione di risorse di Insight per l'applicazione durante la creazione di App funzione.
Nessun log sarà disponibile.
...
### -DockerImageName
Solo Linux.
Nome immagine contenitore da registro di sistema mobile, ad esempio Publisher/nome immagine: Tag.
...
Nome utente e password del registro di sistema contenitore.
...
### -Posizione
Posizione per il piano di consumo.
...
### -OSType
Il sistema operativo per ospitare l'app funzione.
