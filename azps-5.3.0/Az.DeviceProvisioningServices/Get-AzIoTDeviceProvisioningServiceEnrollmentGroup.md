...
## Descrizione
Ottenere i dettagli di un gruppo di registrazione o un elenco di tutti i gruppi di registrazione in un servizio di provisioning del dispositivo hub Azure molto.
...
Ottenere un gruppo di registrazione del dispositivo in un servizio di provisioning del dispositivo hub Azure molto.
...
Elenca tutti i gruppi di registrazione dei dispositivi in un servizio di provisioning del dispositivo hub Azure molto.
