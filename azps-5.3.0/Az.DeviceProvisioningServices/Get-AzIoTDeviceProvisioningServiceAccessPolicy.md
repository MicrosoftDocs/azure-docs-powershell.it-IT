...
Elenca tutti i criteri di accesso condiviso in "myiotdps".
...
Mostra i dettagli del criterio di accesso condiviso "criteri" in un servizio di provisioning di un dispositivo hub Azure molto.
