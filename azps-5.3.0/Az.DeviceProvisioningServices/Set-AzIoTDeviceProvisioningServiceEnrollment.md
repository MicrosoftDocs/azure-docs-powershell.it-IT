...
## Descrizione
Aggiornare una registrazione del dispositivo in un servizio di provisioning del dispositivo hub di Azure molto.
...
Aggiornare i criteri di allocazione e gli hub per un record di registrazione.
...
Aggiornare lo stato Twin iniziale di una registrazione.
