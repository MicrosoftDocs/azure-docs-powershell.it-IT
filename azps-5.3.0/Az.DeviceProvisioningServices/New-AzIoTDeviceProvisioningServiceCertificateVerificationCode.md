...
## Descrizione
Questo codice di verifica viene usato per completare il passaggio della prova del possesso per un certificato. Usare questo codice di verifica come CN di un nuovo certificato firmato con la chiave privata certificati radice.
...
Genera un codice di verifica per "certificato".
...
Genera un codice di verifica per "certificato" usando pipeline.
