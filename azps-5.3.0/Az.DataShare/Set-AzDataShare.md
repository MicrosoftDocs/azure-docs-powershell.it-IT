...
## Descrizione
Il cmdlet **set-AzDataShare** aggiorna una condivisione di dati che esiste all'interno di un account di condivisione dati Azure specificato.
...
Questo comando aggiorna una condivisione dati esistente denominata AdsShare
...
### -Descrizione
Descrizione della condivisione dati
...
### -InputObject
Oggetto condivisione dati di Azure
...
### -TermsOfUse
Condizioni per l'uso della condivisione dati
