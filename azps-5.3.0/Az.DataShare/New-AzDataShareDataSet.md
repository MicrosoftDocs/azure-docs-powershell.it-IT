...
## Descrizione
Il cmdlet **New-AzDataShareDataSet** aggiunge set di dati in Azure Data Share of Data Share account. È possibile aggiungere set di dati di tipo BLOB, ADL Gen2 e ADL Gen1.
...
Questo comando aggiunge un DataSet denominato AdsDataSet di tipo contenitore BLOB in Azure Data Share AdsShare.
...
### -AdlsGen1FolderPath
Percorso cartella di ADL Gen1 di Azure Storage
...
### -Nomefile
Nome file di Azure Storage ADL Gen1
