...
## Descrizione
Il cmdlet **Remove-AzDataShareDataSetMapping** rimuove i mapping di un DataSet.
...
Questo comando rimuove il DataSet denominato DSM da sharesubscription WikiAds. 
...
### -InputObject
Oggetto mapping set di dati di Azure
