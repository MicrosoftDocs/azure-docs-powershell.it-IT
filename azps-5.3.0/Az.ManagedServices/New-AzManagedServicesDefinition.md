...
Crea una definizione di registrazione per i valori roleDefinitionId e principalId forniti direttamente.
...
Crea o aggiorna una definizione di registrazione con i dettagli dell'autorizzazione.
...
Aggiorna una definizione di registrazione con i dettagli dell'autorizzazione e il nome della definizione di registrazione.

## PARAMETRI

### -Autorizzazione
Elenco di mapping delle autorizzazioni con principalId-roleDefinitionId.
...
### -DisplayName
Nome visualizzato della definizione di registrazione.
...
### -ManagedByTenantId
Identificatore del tenant di ManagedBy.
...
### -PrincipalId
Identificatore principale di ManagedBy.
...
### -RoleDefinitionId
Identificatore della definizione del ruolo per concedere le autorizzazioni all'identificatore principale.
