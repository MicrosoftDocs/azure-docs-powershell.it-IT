...
### Esempio 1: rigenerare le chiavi API per un nodo transazione tramite Name.
```powershell
...
Questo comando genera le chiavi API per un nodo transazione tramite nome, gruppo risorse.
...
Questo comando genera le chiavi API per un nodo di transazione usando l'identità.
