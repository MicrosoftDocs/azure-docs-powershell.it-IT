...
### Esempio 1: rimuovere un membro di blockchain
```powershell
PS C:\> Remove-AzBlockchainMember -Name dolauli001 -ResourceGroupName testgroup

```

Questo comando rimuove un membro blockchain.

### Esempio 2: rimuovere un membro di blockchain
```powershell
