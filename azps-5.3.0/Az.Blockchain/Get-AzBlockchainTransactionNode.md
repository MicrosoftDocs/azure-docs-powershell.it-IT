...
### Esempio 1: elencare i nodi delle transazioni per un membro di blockchain
```powershell
...
Questo comando elenca i nodi delle transazioni per un membro di blockchain.
...
Questo comando ottiene un nodo transazione.
