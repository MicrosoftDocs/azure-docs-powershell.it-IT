...
## Descrizione
Il cmdlet **set-AzMarketplaceTerms** Salva l'oggetto termini per l'ID di Publisher (Publisher), l'ID offerta (Product) e la tupla ID piano (nome).

## ESEMPI

### Esempio 1
Ottenere il contratto Marketplace Publisher
...
### Esempio 2
Impostare il contratto di Publisher su "accetta". Ottenere il valore per il parametro "termini" dal cmdlet "Get-AzMarketplaceTerms"
...
### -InputObject
Oggetto termini restituito nel cmdlet Get-AzMarketplaceTerms. Si tratta di un parametro obbligatorio se il parametro accepted è true.
