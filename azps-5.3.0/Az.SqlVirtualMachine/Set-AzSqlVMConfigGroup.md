...
## Descrizione
Il cmdlet Set-AzSqlVMConfigGroup imposta le informazioni necessarie per partecipare a un gruppo di macchine virtuali SQL per una configurazione di una macchina virtuale SQL.
...
Aggiornare le informazioni di gruppo di una configurazione di una macchina virtuale SQL.

## PARAMETRI

### -ClusterBootstrapAccountPassword
Password per l'account di avvio del cluster
...
Password per l'account operatore cluster
...
Password per l'account del servizio SQL
...
### -SqlVM
Configurazione della macchina virtuale SQL a cui verrà aggiunta l'appartenenza al gruppo
...
### -SqlVMGroup
Gruppo di cui la macchina virtuale SQL farà parte
