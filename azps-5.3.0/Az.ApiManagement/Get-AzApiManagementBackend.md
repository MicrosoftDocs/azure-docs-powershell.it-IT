...
### Esempio 1: ottenere tutti i backend
```
...
### Esempio 2: ottenere il backend specificato dall'identificatore 123
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
...
### -ResourceId
Identificatore delle risorse ARM del backend. Se specificato cercherà di trovare il backend dall'identificatore. Questo parametro è obbligatorio.
