...
### Esempio 1: creare un nuovo schema per l'API estesa petstore di spavalderia
```powershell
...
Il cmdlet **New-AzApiManagementApiSchema** crea o aggiorna lo schema dell' `swagger-petstore-extensive` API.
...
Percorso file del documento dello schema API. Questo parametro è obbligatorio-SchemaDocument non è specificato.
