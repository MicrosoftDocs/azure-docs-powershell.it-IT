...
## Descrizione
Il cmdlet **set-AzApiManagementProduct** imposta i dettagli del prodotto di gestione delle API.

## ESEMPI

### Esempio 1: aggiornare i dettagli del prodotto
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Set-AzApiManagementProduct -Context $apimContext -ProductId "0123456789" -Title "Starter" -Description "Starter Product" -LegalTerms "Free for all" -SubscriptionRequired $True -State "NotPublished"
```

Questo comando Aggiorna i dettagli del prodotto per la gestione delle API, richiede un abbonamento e quindi Annulla la pubblicazione.

## PARAMETRI

### -ApprovalRequired
Indica se l'abbonamento al prodotto richiede l'approvazione.
...
### -LegalTerms
Specifica le condizioni legali per l'uso del prodotto.
...
Il valore predefinito per questo parametro è **$true**.
...
Il valore predefinito per questo parametro è None.
...
### -Titolo
Specifica il titolo del prodotto impostato da questo cmdlet.
