...
#### <a name="azurermcompute"></a><span data-ttu-id="6627e-111">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-111">AzureRM.Compute</span></span>
...
## <a name="6100---october-2018"></a><span data-ttu-id="6627e-126">6.10.0 - Ottobre 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-126">6.10.0 - October 2018</span></span>
...
* <span data-ttu-id="6627e-148">Aggiunta del collegamento di associazione di servizio nel modello di subnet</span><span class="sxs-lookup"><span data-stu-id="6627e-148">Added service association link on Subnet Model</span></span>
...
## <a name="690---september-2018"></a><span data-ttu-id="6627e-165">6.9.0 - Settembre 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-165">6.9.0 - September 2018</span></span>
...
#### <a name="azurermdns"></a><span data-ttu-id="6627e-183">AzureRM.Dns</span><span class="sxs-lookup"><span data-stu-id="6627e-183">AzureRM.Dns</span></span>
...
* <span data-ttu-id="6627e-204">Aggiunta di nuovi cmdlet per la funzionalità Firewall di Azure tramite ARM</span><span class="sxs-lookup"><span data-stu-id="6627e-204">Added new cmdlets for feature: Azure Firewall via ARM</span></span>
...
* <span data-ttu-id="6627e-215">Aggiunta del supporto per il certificato radice attendibile e la configurazione della scalabilità automatica nel gateway applicazione</span><span class="sxs-lookup"><span data-stu-id="6627e-215">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  ...
  - <span data-ttu-id="6627e-226">Aggiornamento dei cmdlet con il parametro facoltativo -TrustedRootCertificate</span><span class="sxs-lookup"><span data-stu-id="6627e-226">Cmdlets updated with optonal parameter -TrustedRootCertificate</span></span>
      ...
      - <span data-ttu-id="6627e-228">Set-AzureRmApplicationGateway</span><span class="sxs-lookup"><span data-stu-id="6627e-228">Set-AzureRmApplicationGateway</span></span>
...
* <span data-ttu-id="6627e-256">Aggiunta di cmdlet per la delega di subnet.</span><span class="sxs-lookup"><span data-stu-id="6627e-256">Adding cmdlets for subnet delegation.</span></span>
  - <span data-ttu-id="6627e-257">New-AzureRmDelegation: crea una nuova delega che può essere aggiunta a una subnet</span><span class="sxs-lookup"><span data-stu-id="6627e-257">New-AzureRmDelegation: Creates a new delegation, which can be added to a subnet</span></span>
...
#### <a name="azurermsignalr"></a><span data-ttu-id="6627e-274">AzureRM.SignalR</span><span class="sxs-lookup"><span data-stu-id="6627e-274">AzureRM.SignalR</span></span>
...
## <a name="681---august-2018"></a><span data-ttu-id="6627e-294">6.8.1 - Agosto 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-294">6.8.1 - August 2018</span></span>
...
* <span data-ttu-id="6627e-326">Aggiunta del supporto per il metodo di routing Subnet</span><span class="sxs-lookup"><span data-stu-id="6627e-326">Added Support for the Subnet routing method</span></span>
    - <span data-ttu-id="6627e-327">Supporto per gli intervalli di indirizzi IP (subnet) negli endpoint</span><span class="sxs-lookup"><span data-stu-id="6627e-327">Support for IP address ranges (subnets) in endpoints</span></span>
...
#### <a name="azurermpowerbiembedded"></a><span data-ttu-id="6627e-344">AzureRM.PowerBIEmbedded</span><span class="sxs-lookup"><span data-stu-id="6627e-344">AzureRM.PowerBIEmbedded</span></span>
...
## <a name="670---august-2018"></a><span data-ttu-id="6627e-360">6.7.0 - Agosto 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-360">6.7.0 - August 2018</span></span>
...
#### <a name="azurermapplicationinsights"></a><span data-ttu-id="6627e-375">AzureRM.ApplicationInsights</span><span class="sxs-lookup"><span data-stu-id="6627e-375">AzureRM.ApplicationInsights</span></span>
...
#### <a name="azurermcompute"></a><span data-ttu-id="6627e-389">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-389">AzureRM.Compute</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="6627e-403">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="6627e-403">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermeventhub"></a><span data-ttu-id="6627e-418">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="6627e-418">AzureRM.EventHub</span></span>
...
#### <a name="azurermmarketplaceordering"></a><span data-ttu-id="6627e-434">AzureRM.MarketplaceOrdering</span><span class="sxs-lookup"><span data-stu-id="6627e-434">AzureRM.MarketplaceOrdering</span></span>
...
#### <a name="azurermoperationalinsights"></a><span data-ttu-id="6627e-449">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="6627e-449">AzureRM.OperationalInsights</span></span>
...
#### <a name="azurermrecoveryservicessiterecovery"></a><span data-ttu-id="6627e-465">AzureRM.RecoveryServices.SiteRecovery</span><span class="sxs-lookup"><span data-stu-id="6627e-465">AzureRM.RecoveryServices.SiteRecovery</span></span>
...
#### <a name="azurermscheduler"></a><span data-ttu-id="6627e-484">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="6627e-484">AzureRM.Scheduler</span></span>
...
* <span data-ttu-id="6627e-493">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="6627e-493">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermstreamanalytics"></a><span data-ttu-id="6627e-494">AzureRM.StreamAnalytics</span><span class="sxs-lookup"><span data-stu-id="6627e-494">AzureRM.StreamAnalytics</span></span>
* <span data-ttu-id="6627e-495">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="6627e-495">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="6627e-496">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="6627e-496">AzureRM.Tags</span></span>
* <span data-ttu-id="6627e-497">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="6627e-497">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="6627e-498">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="6627e-498">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="6627e-499">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="6627e-499">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermusageaggregates"></a><span data-ttu-id="6627e-500">AzureRM.UsageAggregates</span><span class="sxs-lookup"><span data-stu-id="6627e-500">AzureRM.UsageAggregates</span></span>
* <span data-ttu-id="6627e-501">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="6627e-501">Updated to the latest version of the Azure ClientRuntime.</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="6627e-502">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="6627e-502">AzureRM.Websites</span></span>
* <span data-ttu-id="6627e-503">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="6627e-503">Updated to the latest version of the Azure ClientRuntime.</span></span>

## <a name="660---july-2018"></a><span data-ttu-id="6627e-504">6.6.0 - Luglio 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-504">6.6.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="6627e-505">Generale</span><span class="sxs-lookup"><span data-stu-id="6627e-505">General</span></span>
* <span data-ttu-id="6627e-506">Aggiornamento di tutti i file della Guida in modo da includere tipi di parametri completi e correggere i tipi di input/output.</span><span class="sxs-lookup"><span data-stu-id="6627e-506">Updated all help files to include full parameter types and correct input/output types.</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="6627e-507">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="6627e-507">AzureRM.Profile</span></span>
* <span data-ttu-id="6627e-508">Aggiornamento della libreria Common.Strategy per consentire di confermare che il file di configurazione corrente per una risorsa è compatibile con la risorsa di destinazione.</span><span class="sxs-lookup"><span data-stu-id="6627e-508">Updated Common.Strategy library to be able to validate that the current config for a resource is compatible with the target resource.</span></span>
* <span data-ttu-id="6627e-509">Aggiunta dei tipi ps1xml a Common.Storage</span><span class="sxs-lookup"><span data-stu-id="6627e-509">Added ps1xml types to Common.Storage</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="6627e-510">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="6627e-510">Azure.Storage</span></span>
* <span data-ttu-id="6627e-511">Aggiunta del supporto per l'ottenimento del contesto di archiviazione da DefaultProfile</span><span class="sxs-lookup"><span data-stu-id="6627e-511">Added support for getting Storage Context from DefaultProfile</span></span>
* <span data-ttu-id="6627e-512">Aggiunta di Ps1XmlAttribute alle proprietà dei tipi di output dei cmdlet.</span><span class="sxs-lookup"><span data-stu-id="6627e-512">Added Ps1XmlAttribute to cmdlets output types properties.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="6627e-513">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="6627e-513">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="6627e-514">Risoluzione del problema https://github.com/Azure/azure-powershell/issues/6370</span><span class="sxs-lookup"><span data-stu-id="6627e-514">Fixed issue https://github.com/Azure/azure-powershell/issues/6370</span></span>
    - <span data-ttu-id="6627e-515">Correzione del bug in Automapper per la conversione di PsApiManagementApi in ApiContract</span><span class="sxs-lookup"><span data-stu-id="6627e-515">Fixed bug in Automapper to translate PsApiManagementApi to ApiContract</span></span>
* <span data-ttu-id="6627e-516">Risoluzione del problema https://github.com/Azure/azure-powershell/issues/6515</span><span class="sxs-lookup"><span data-stu-id="6627e-516">Fixed issue https://github.com/Azure/azure-powershell/issues/6515</span></span>
    - <span data-ttu-id="6627e-517">Correzione del bug in File.Save per evitare l'overload con il tipo di codifica</span><span class="sxs-lookup"><span data-stu-id="6627e-517">Fixed bug in File.Save to not overload with Encoding Type</span></span>
* <span data-ttu-id="6627e-518">Risoluzione del problema https://github.com/Azure/azure-powershell/issues/6560</span><span class="sxs-lookup"><span data-stu-id="6627e-518">Fixed issue https://github.com/Azure/azure-powershell/issues/6560</span></span>
    - <span data-ttu-id="6627e-519">Aggiornamento alla versione 4.0.3 di Nuget per correggere l'eccezione del criterio in apiId</span><span class="sxs-lookup"><span data-stu-id="6627e-519">Upgraded to 4.0.3 Nuget version which fixes the pattern exception on apiId</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="6627e-520">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-520">AzureRM.Compute</span></span>
* <span data-ttu-id="6627e-521">Correzione del problema relativo all'impossibilità di creare una VM con DiskFileParameterSet in New-AzureRmVm a causa della ridenominazione del tipo di account di archiviazione PremiumLRS.</span><span class="sxs-lookup"><span data-stu-id="6627e-521">Fix issue with creating a vm using DiskFileParameterSet in New-AzureRmVm failing because of PremiumLRS storage account type renaming.</span></span>
* <span data-ttu-id="6627e-522">Correzione del cmdlet Invoke-AzureRmVMRunCommand</span><span class="sxs-lookup"><span data-stu-id="6627e-522">Fix Invoke-AzureRmVMRunCommand cmdlet</span></span>
* <span data-ttu-id="6627e-523">Aggiornamento di Get-AzureRmAvailabilitySet per abilitare l'elenco di tutti i set di disponibilità in una sottoscrizione.</span><span class="sxs-lookup"><span data-stu-id="6627e-523">Update Get-AzureRmAvailabilitySet to enable list all availability sets in a subscription.</span></span>  <span data-ttu-id="6627e-524">Il parametro ResouceGroupName è ora facoltativo.</span><span class="sxs-lookup"><span data-stu-id="6627e-524">(ResouceGroupName parameter is now optional.)</span></span>
* <span data-ttu-id="6627e-525">Aggiornamento di SimpleParameterSet di 'New-AzureRmVm' per abilitare la rete accelerata nelle VM idonee.</span><span class="sxs-lookup"><span data-stu-id="6627e-525">Update SimpleParameterSet of 'New-AzureRmVm' to enable Accelerated Network on qualifying vms.</span></span>
* <span data-ttu-id="6627e-526">Aggiornamento del semplice set di parametri New-AzureRmVmss in modo da generare un errore di creazione del set di scalabilità di macchine virtuali quando il bilanciamento del carico specificato da un utente esiste già.</span><span class="sxs-lookup"><span data-stu-id="6627e-526">Update New-AzureRmVmss simple parameter set to fail creating the vmss when a user specified LB already exists.</span></span>
* <span data-ttu-id="6627e-527">Aggiornamento dell'esempio per New-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="6627e-527">Update example for New-AzureRmDisk</span></span>
* <span data-ttu-id="6627e-528">Aggiunta dell'esempio per 'New-AzureRmVM'</span><span class="sxs-lookup"><span data-stu-id="6627e-528">Add example for 'New-AzureRmVM'</span></span>
* <span data-ttu-id="6627e-529">Aggiornamento della descrizione per Set-AzureRmVMOSDisk</span><span class="sxs-lookup"><span data-stu-id="6627e-529">Update description for Set-AzureRmVMOSDisk</span></span>
* <span data-ttu-id="6627e-530">Aggiornamento dell'esempio 1 per Set-AzureRmVMBginfoExtension in modo da correggere l'ortografia e il prefisso.</span><span class="sxs-lookup"><span data-stu-id="6627e-530">Update Example 1 for Set-AzureRmVMBginfoExtension to correct spelling and prefix.</span></span> 

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="6627e-531">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="6627e-531">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="6627e-532">Aggiornamento della versione di ADF .Net SDK a 1.1.0.</span><span class="sxs-lookup"><span data-stu-id="6627e-532">Updated the ADF .Net SDK version to 1.1.0.</span></span>
* <span data-ttu-id="6627e-533">Supporto per la condivisione del runtime di integrazione self-hosted tra data factory.</span><span class="sxs-lookup"><span data-stu-id="6627e-533">Support self-hosted integration runtime sharing across data factories.</span></span>
     - <span data-ttu-id="6627e-534">Aggiunta del nuovo parametro -SharedIntegrationRuntimeResourceId al cmdlet Set-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="6627e-534">Add new parameter -SharedIntegrationRuntimeResourceId to Set-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>
     - <span data-ttu-id="6627e-535">Aggiunta del nuovo parametro facoltativo -LinkedDataFactoryName al cmdlet Remove-AzureRmDataFactoryV2IntegrationRuntime.</span><span class="sxs-lookup"><span data-stu-id="6627e-535">Add new optional parameter -LinkedDataFactoryName to Remove-AzureRmDataFactoryV2IntegrationRuntime cmdlet.</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="6627e-536">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6627e-536">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="6627e-537">Aggiornamento della versione di DataPlane SDK (Microsoft.Azure.DataLake.Store) a 1.1.9</span><span class="sxs-lookup"><span data-stu-id="6627e-537">Updated the DataPlane SDK (Microsoft.Azure.DataLake.Store) version to 1.1.9</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="6627e-538">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="6627e-538">AzureRM.EventHub</span></span>
* <span data-ttu-id="6627e-539">Aggiornamento del piping per InputObject e ResourceId nei cmdlet di rimozione</span><span class="sxs-lookup"><span data-stu-id="6627e-539">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>

#### <a name="azurerminsights"></a><span data-ttu-id="6627e-540">AzureRM.Insights</span><span class="sxs-lookup"><span data-stu-id="6627e-540">AzureRM.Insights</span></span>
* <span data-ttu-id="6627e-541">Correzione della formattazione di OutputType nei file della Guida</span><span class="sxs-lookup"><span data-stu-id="6627e-541">Fixed formatting of OutputType in help files</span></span>
* <span data-ttu-id="6627e-542">Uso della versione di anteprima di Microsoft.Azure.Management.Monitor SDK 0.19.1</span><span class="sxs-lookup"><span data-stu-id="6627e-542">Using Microsoft.Azure.Management.Monitor SDK 0.19.1-preview</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="6627e-543">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6627e-543">AzureRM.KeyVault</span></span>
* <span data-ttu-id="6627e-544">Correzione del problema di piping in Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="6627e-544">Fix piping issue in Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="6627e-545">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="6627e-545">AzureRM.Network</span></span>
* <span data-ttu-id="6627e-546">Aggiunta di esempi per i cmdlet LoadBalancerInboundNatPoolConfig.</span><span class="sxs-lookup"><span data-stu-id="6627e-546">Added examples for LoadBalancerInboundNatPoolConfig cmdlets.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="6627e-547">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="6627e-547">AzureRM.Resources</span></span>
* <span data-ttu-id="6627e-548">Correzione del problema relativo alla presenza di nome di tag e valore per 'Get-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="6627e-548">Fix issue when providing both tag name and value for 'Get-AzureRmResource'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6765
* <span data-ttu-id="6627e-549">Correzione dello scenario di piping con 'Set-AzureRmResource'</span><span class="sxs-lookup"><span data-stu-id="6627e-549">Fix piping scenario with 'Set-AzureRmResource'</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="6627e-550">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="6627e-550">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="6627e-551">Aggiornamento del piping per InputObject e ResourceId nei cmdlet di rimozione</span><span class="sxs-lookup"><span data-stu-id="6627e-551">Updated piping for InputObject and ResourceId in remove cmdlets</span></span>
* <span data-ttu-id="6627e-552">Correzione di alcuni problemi</span><span class="sxs-lookup"><span data-stu-id="6627e-552">fixed few issues</span></span>
    - https://github.com/Azure/azure-powershell/issues/3780
    - https://github.com/Azure/azure-powershell/issues/4340

#### <a name="azurermsql"></a><span data-ttu-id="6627e-553">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="6627e-553">AzureRM.Sql</span></span>
* <span data-ttu-id="6627e-554">Aggiunta del supporto per Advanced Threat Protection per il server con i cmdlet seguenti:</span><span class="sxs-lookup"><span data-stu-id="6627e-554">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="6627e-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="6627e-555">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="6627e-556">Aggiunta del supporto per la valutazione della vulnerabilità con i cmdlet seguenti:</span><span class="sxs-lookup"><span data-stu-id="6627e-556">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="6627e-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="6627e-557">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="6627e-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="6627e-558">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="6627e-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="6627e-559">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="6627e-560">Correzione dell'esempio in Remove-AzureRmSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="6627e-560">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="6627e-561">Correzione della gestione non corretta di data e ora per impostazioni cultura non degli Stati Uniti in Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="6627e-561">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="6627e-562">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="6627e-562">AzureRM.Storage</span></span>
* <span data-ttu-id="6627e-563">Aggiunta di Ps1XmlAttribute alle proprietà dei tipi di output dei cmdlet</span><span class="sxs-lookup"><span data-stu-id="6627e-563">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="6627e-564">Visualizzazione dell'output del cmdlet StorageAccount nella vista tabella</span><span class="sxs-lookup"><span data-stu-id="6627e-564">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="6627e-565">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="6627e-565">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="6627e-566">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="6627e-566">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="6627e-567">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="6627e-567">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="6627e-568">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="6627e-568">AzureRM.Tags</span></span>
* <span data-ttu-id="6627e-569">Rimozione dell'istruzione non corretta dalla Guida del cmdlet Tag</span><span class="sxs-lookup"><span data-stu-id="6627e-569">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="6627e-570">6.5.0 - Luglio 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-570">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="6627e-571">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="6627e-571">AzureRM.Profile</span></span>
* <span data-ttu-id="6627e-572">Aggiornamento della Guida per 'Get-AzureRmContextAutosaveSetting'</span><span class="sxs-lookup"><span data-stu-id="6627e-572">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="6627e-573">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="6627e-573">Azure.Storage</span></span>
* <span data-ttu-id="6627e-574">Supporto del caricamento di BLOB o file con token di firma di accesso condiviso a sola scrittura</span><span class="sxs-lookup"><span data-stu-id="6627e-574">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="6627e-575">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="6627e-575">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="6627e-576">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="6627e-576">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="6627e-577">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="6627e-577">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="6627e-578">Aggiunta della proprietà obbligatoria ResourceGroupName ad AS.</span><span class="sxs-lookup"><span data-stu-id="6627e-578">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="6627e-579">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="6627e-579">AzureRM.Automation</span></span>
* <span data-ttu-id="6627e-580">Aggiornamento della Guida e aggiunta di un esempio per 'New-AzureRMAutomationSchedule'</span><span class="sxs-lookup"><span data-stu-id="6627e-580">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="6627e-581">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-581">AzureRM.Compute</span></span>
* <span data-ttu-id="6627e-582">Aggiunta del parametro -Tag a Update/New-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="6627e-582">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="6627e-583">Aggiunta di un esempio per 'Add-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="6627e-583">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="6627e-584">Aggiunta di esempi per 'Remove-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="6627e-584">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="6627e-585">Aggiornamento della Guida per 'Set-AzureRmVMAccessExtension'</span><span class="sxs-lookup"><span data-stu-id="6627e-585">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="6627e-586">Aggiornamento di SimpleParameterSet per New-AzureRmVmmss per l'impostazione di SinglePlacementGroup su false per impostazione predefinita e aggiunta del parametro opzionale 'SinglePlacementGroup' che consente all'utente di creare il set di scalabilità di macchine virtuali in un singolo gruppo di selezione host.</span><span class="sxs-lookup"><span data-stu-id="6627e-586">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="6627e-587">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="6627e-587">AzureRM.EventHub</span></span>
* <span data-ttu-id="6627e-588">Aggiunta di una proprietà 'PendingReplicationOperationsCount' di sola lettura alla classe PSEventHubDRConfigurationAttributes, che fornisce il conteggio delle operazioni di replica in sospeso mentre la replica è in corso</span><span class="sxs-lookup"><span data-stu-id="6627e-588">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="6627e-589">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6627e-589">AzureRM.KeyVault</span></span>
* <span data-ttu-id="6627e-590">Aggiornamento del messaggio di errore per Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="6627e-590">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="6627e-591">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="6627e-591">AzureRM.LogicApp</span></span>
* <span data-ttu-id="6627e-592">Correzione dell'errore "Impossibile risolvere set di parametri" in New-AzureRmLogicApp</span><span class="sxs-lookup"><span data-stu-id="6627e-592">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="6627e-593">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="6627e-593">AzureRM.Network</span></span>
* <span data-ttu-id="6627e-594">Abilitazione del peering di reti virtuali in più tenant per Set/Add-AzureRmVirtualNetworkPeering</span><span class="sxs-lookup"><span data-stu-id="6627e-594">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="6627e-595">Aggiornamento dei cmdlet seguenti per il gateway applicazione</span><span class="sxs-lookup"><span data-stu-id="6627e-595">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="6627e-596">New-AzureRmApplicationGateway: aggiunta del flag EnableFIPS e del supporto delle zone</span><span class="sxs-lookup"><span data-stu-id="6627e-596">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="6627e-597">New-AzureRmApplicationGatewaySku: aggiunta dei nuovi SKU Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="6627e-597">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="6627e-598">Set-AzureRmApplicationGatewaySku: aggiunta dei nuovi SKU Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="6627e-598">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="6627e-599">Rigenerazione del cmdlet RouteTable con la versione più recente del generatore</span><span class="sxs-lookup"><span data-stu-id="6627e-599">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="6627e-600">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="6627e-600">AzureRM.Relay</span></span>
* <span data-ttu-id="6627e-601">Aggiornamento dei file markdown, correzione del problema relativo al nome del parametro nell'esempio</span><span class="sxs-lookup"><span data-stu-id="6627e-601">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="6627e-602">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="6627e-602">AzureRM.Resources</span></span>
* <span data-ttu-id="6627e-603">Aggiornamento dei cmdlet roleassignment e roledefinition:</span><span class="sxs-lookup"><span data-stu-id="6627e-603">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="6627e-604">Rimozione delle chiamate roledefinition aggiuntive eseguite nell'ambito del paging.</span><span class="sxs-lookup"><span data-stu-id="6627e-604">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="6627e-605">Correzione del cmdlet Get-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="6627e-605">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="6627e-606">Correzione della funzionalità dei parametri del comando -ExpandPrincipalGroups</span><span class="sxs-lookup"><span data-stu-id="6627e-606">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="6627e-607">Correzione del problema con 'Get-AzureRmResource', in cui il parametro '-ResourceType' faceva distinzione tra maiuscole e minuscole</span><span class="sxs-lookup"><span data-stu-id="6627e-607">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="6627e-608">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="6627e-608">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="6627e-609">Aggiunta del parametro top e skip ai cmdlet list</span><span class="sxs-lookup"><span data-stu-id="6627e-609">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="6627e-610">Aggiunta di cmdlet di migrazione dello spazio dei nomi da Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="6627e-610">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="6627e-611">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="6627e-611">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="6627e-612">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="6627e-612">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="6627e-613">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="6627e-613">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="6627e-614">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="6627e-614">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="6627e-615">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="6627e-615">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="6627e-616">Aggiunta di una proprietà 'PendingReplicationOperationsCount' di sola lettura alla classe PSServiceBusDRConfigurationAttributes, che fornisce il conteggio delle operazioni di replica in sospeso mentre la replica è in corso</span><span class="sxs-lookup"><span data-stu-id="6627e-616">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="6627e-617">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="6627e-617">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="6627e-618">Aggiornamento dell'esempio per 'New-AzureRmServiceFabricCluster'</span><span class="sxs-lookup"><span data-stu-id="6627e-618">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="6627e-619">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="6627e-619">AzureRM.Sql</span></span>
* <span data-ttu-id="6627e-620">Aggiunta di nuovi cmdlet per Management.Sql per consentire ai clienti di aggiungere il certificato TDE all'istanza di SQL Server o a un'istanza gestita</span><span class="sxs-lookup"><span data-stu-id="6627e-620">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="6627e-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="6627e-621">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="6627e-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="6627e-622">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="6627e-623">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="6627e-623">AzureRM.Websites</span></span>
* <span data-ttu-id="6627e-624">Se impostati su false, `Set-AzureRmWebApp -AssignIdentity` e `Set-AzureRmWebAppSlot -AssignIdentity` rimuovono ora la proprietà Identity anche dal tag di anteprima object.Removing del sito.</span><span class="sxs-lookup"><span data-stu-id="6627e-624">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="6627e-625">Aggiornamento dell'esempio `Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics`</span><span class="sxs-lookup"><span data-stu-id="6627e-625">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="6627e-626">`Set-AzureRmWebApp -PhpVersion` supporta off come versione php valida</span><span class="sxs-lookup"><span data-stu-id="6627e-626">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="6627e-627">6.4.0 - Luglio 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-627">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="6627e-628">Generale</span><span class="sxs-lookup"><span data-stu-id="6627e-628">General</span></span>
* <span data-ttu-id="6627e-629">Correzione della formattazione di OutputType nei file della Guida per la maggior parte dei moduli</span><span class="sxs-lookup"><span data-stu-id="6627e-629">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="6627e-630">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="6627e-630">AzureRM.Profile</span></span>
* <span data-ttu-id="6627e-631">Aggiunta dell'attributo Ps1Xml ai tipi di output di base</span><span class="sxs-lookup"><span data-stu-id="6627e-631">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="6627e-632">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-632">AzureRM.Compute</span></span>
* <span data-ttu-id="6627e-633">Funzionalità tag IP per VMSS</span><span class="sxs-lookup"><span data-stu-id="6627e-633">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="6627e-634">Aggiunta del cmdlet 'New-AzureRmVmssIpTagConfig'</span><span class="sxs-lookup"><span data-stu-id="6627e-634">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="6627e-635">Aggiunta del parametro IpTag a New-AzureRmVmssIpConfig</span><span class="sxs-lookup"><span data-stu-id="6627e-635">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="6627e-636">Funzionalità di ripristino dello stato precedente automatico del sistema operativo per VMSS</span><span class="sxs-lookup"><span data-stu-id="6627e-636">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="6627e-637">Aggiunta dei parametri DisableAutoRollback a New-AzureRmVmssConfig e Update-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-637">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="6627e-638">Funzionalità Cronologia degli aggiornamenti del sistema operativo per Vmss</span><span class="sxs-lookup"><span data-stu-id="6627e-638">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="6627e-639">Aggiunta del parametro opzionale OSUpgradeHistory a Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-639">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="6627e-640">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="6627e-640">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="6627e-641">Aggiunta del supporto per gli elenchi di controllo di accesso del catalogo tramite i comandi seguenti:</span><span class="sxs-lookup"><span data-stu-id="6627e-641">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="6627e-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="6627e-642">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="6627e-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="6627e-643">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="6627e-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="6627e-644">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="6627e-645">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6627e-645">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="6627e-646">Aggiunta del supporto per l'annullamento e della verifica dello stato per Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span><span class="sxs-lookup"><span data-stu-id="6627e-646">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="6627e-647">Aggiunta del supporto per l'annullamento per Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="6627e-647">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="6627e-648">Correzione dello scaricamento dei messaggi di debug per i cmdlet che eseguono operazioni ricorsive</span><span class="sxs-lookup"><span data-stu-id="6627e-648">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="6627e-649">Correzione della posizione del test dei cmdlet di DataLake</span><span class="sxs-lookup"><span data-stu-id="6627e-649">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="6627e-650">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="6627e-650">AzureRM.EventHub</span></span>
* <span data-ttu-id="6627e-651">Aggiunta del parametro facoltativo MaxCount al cmdlet per le operazioni dell'elenco Get-AzureRmEventHub e Get-AzureRmEventHubConsumerGroup</span><span class="sxs-lookup"><span data-stu-id="6627e-651">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="6627e-652">Risoluzione del problema nel cmdlet New-AzureRmEventHub che richiede almeno un parametro durante la creazione di un nuovo hub eventi.</span><span class="sxs-lookup"><span data-stu-id="6627e-652">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="6627e-653">Aggiunta di un set di parametri predefinito.</span><span class="sxs-lookup"><span data-stu-id="6627e-653">Provided Default Parameter set.</span></span>
* <span data-ttu-id="6627e-654">Aggiunta del parametro facoltativo -KeyValue al cmdlet New-AzureRmEventHubKey, che consente all'utente di fornire KeyValue.</span><span class="sxs-lookup"><span data-stu-id="6627e-654">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="6627e-655">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6627e-655">AzureRM.KeyVault</span></span>
* <span data-ttu-id="6627e-656">Correzione di un problema relativo alla restituzione di tutte le risorse da parte di Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="6627e-656">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="6627e-657">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="6627e-657">AzureRM.Network</span></span>
* <span data-ttu-id="6627e-658">Esposizione di nuovi SKU per VirtualNetworkGateways con ridondanza della zona</span><span class="sxs-lookup"><span data-stu-id="6627e-658">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="6627e-659">Aggiunta di nuovi comandi per la funzionalità delle API partner di ExpressRoute tramite ARM</span><span class="sxs-lookup"><span data-stu-id="6627e-659">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="6627e-660">Aggiunta di Get-AzureRmExpressRouteCrossConnection</span><span class="sxs-lookup"><span data-stu-id="6627e-660">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="6627e-661">Aggiunta di Set-AzureRmExpressRouteCrossConnection</span><span class="sxs-lookup"><span data-stu-id="6627e-661">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="6627e-662">Aggiunta di Add-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="6627e-662">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="6627e-663">Aggiunta di Get-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="6627e-663">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="6627e-664">Aggiunta di Remove-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="6627e-664">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="6627e-665">Aggiunta di Get-AzureRMExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="6627e-665">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="6627e-666">Aggiunta di Get-AzureRMExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="6627e-666">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="6627e-667">Aggiunta di Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="6627e-667">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="6627e-668">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="6627e-668">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="6627e-669">Aggiunta del cmdlet Get-AzureRmRecoveryServicesBackupStatus.</span><span class="sxs-lookup"><span data-stu-id="6627e-669">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="6627e-670">Questo cmdlet accetta un ID di macchina virtuale e verifica se la VM è protetta da un insieme di credenziali nella sottoscrizione.</span><span class="sxs-lookup"><span data-stu-id="6627e-670">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="6627e-671">Se tale insieme di credenziali esiste, il cmdlet restituisce i dettagli dell'insieme di credenziali.</span><span class="sxs-lookup"><span data-stu-id="6627e-671">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="6627e-672">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="6627e-672">AzureRM.Resources</span></span>
* <span data-ttu-id="6627e-673">Aggiornamento dei cmdlet Get-AzureRmPolicyAssignment:</span><span class="sxs-lookup"><span data-stu-id="6627e-673">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="6627e-674">Aggiunta del supporto per elencare i valori -Scope a livello di gruppo di gestione</span><span class="sxs-lookup"><span data-stu-id="6627e-674">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="6627e-675">Aggiunta del supporto per il recupero di singole assegnazioni con valori -Scope a livello di gruppo di gestione</span><span class="sxs-lookup"><span data-stu-id="6627e-675">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="6627e-676">Aggiunta delle opzioni -Effective e -All al parametro di controllo</span><span class="sxs-lookup"><span data-stu-id="6627e-676">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="6627e-677">Aggiornamento dei cmdlet Get/New/Remove/Set-AzureRmPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="6627e-677">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="6627e-678">Aggiunta del parametro -ManagementGroupName per l'applicazione di operazioni a un gruppo di gestione specifico</span><span class="sxs-lookup"><span data-stu-id="6627e-678">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="6627e-679">Aggiunta del parametro -SubscriptionId per l'applicazione di operazioni a una sottoscrizione specifica</span><span class="sxs-lookup"><span data-stu-id="6627e-679">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="6627e-680">Aggiornamento dei cmdlet Get/New/Remove/Set-AzureRmPolicySetDefinition</span><span class="sxs-lookup"><span data-stu-id="6627e-680">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="6627e-681">Aggiunta del parametro -ManagementGroupName per l'applicazione di operazioni a un gruppo di gestione specifico</span><span class="sxs-lookup"><span data-stu-id="6627e-681">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="6627e-682">Aggiunta del parametro -SubscriptionId per l'applicazione di operazioni a una sottoscrizione specifica</span><span class="sxs-lookup"><span data-stu-id="6627e-682">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="6627e-683">Aggiunta del supporto per i riferimenti segreti di KeyVault nei parametri quando si usa 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span><span class="sxs-lookup"><span data-stu-id="6627e-683">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="6627e-684">Risoluzione del problema a causa del quale il parametro '-EndDate' viene ignorato per 'New-AzureRmADAppCredential'</span><span class="sxs-lookup"><span data-stu-id="6627e-684">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="6627e-685">Risoluzione del problema relativo all'uso di un URL non corretto da parte di 'Add-AzureRmADGroupMember' per l'effettuazione di una richiesta</span><span class="sxs-lookup"><span data-stu-id="6627e-685">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="6627e-686">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="6627e-686">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="6627e-687">Aggiunta del parametro facoltativo -KeyValue al cmdlet New-AzureRmServiceBusKey, che consente all'utente di fornire KeyValue.</span><span class="sxs-lookup"><span data-stu-id="6627e-687">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="6627e-688">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="6627e-688">AzureRM.Sql</span></span>
* <span data-ttu-id="6627e-689">Chiarimento dei punti di ripristino definiti dall'utente per SQLDW nella Guida di New-AzureRmSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="6627e-689">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="6627e-690">Aggiornamento della documentazione del parametro -ComputeGeneration in alcuni cmdlet</span><span class="sxs-lookup"><span data-stu-id="6627e-690">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="6627e-691">6.3.0 - Giugno 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-691">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="6627e-692">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="6627e-692">AzureRM.Profile</span></span>
* <span data-ttu-id="6627e-693">Aggiornamento dei messaggi di errore per Enable-AzureRmContextAutoSave</span><span class="sxs-lookup"><span data-stu-id="6627e-693">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="6627e-694">Creare un contesto per ogni sottoscrizione quando si esegue 'Connect-AzureRmAccount' senza contesto precedente</span><span class="sxs-lookup"><span data-stu-id="6627e-694">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="6627e-695">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="6627e-695">Azure.Storage</span></span>
* <span data-ttu-id="6627e-696">Aggiunta di altre informazioni sul parametro -Permissions nei file della Guida.</span><span class="sxs-lookup"><span data-stu-id="6627e-696">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="6627e-697">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-697">AzureRM.Compute</span></span>
* <span data-ttu-id="6627e-698">'Get-AzureRmVmDiskEncryptionStatus' risolve un problema riscontrato per le VM senza dischi dati</span><span class="sxs-lookup"><span data-stu-id="6627e-698">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="6627e-699">Aggiornamento della versione della libreria del client di calcolo per la correzione dei cmdlet seguenti</span><span class="sxs-lookup"><span data-stu-id="6627e-699">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="6627e-700">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="6627e-700">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="6627e-701">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="6627e-701">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="6627e-702">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="6627e-702">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="6627e-703">Correzione dei cmdlet seguenti per la corretta visualizzazione di 'operation ID' e 'operation status':</span><span class="sxs-lookup"><span data-stu-id="6627e-703">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="6627e-704">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="6627e-704">Start-AzureRmVM</span></span>
    - <span data-ttu-id="6627e-705">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="6627e-705">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="6627e-706">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="6627e-706">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="6627e-707">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="6627e-707">Set-AzureRmVM</span></span>
    - <span data-ttu-id="6627e-708">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="6627e-708">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="6627e-709">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-709">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="6627e-710">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="6627e-710">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="6627e-711">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="6627e-711">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="6627e-712">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-712">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="6627e-713">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-713">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="6627e-714">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-714">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="6627e-715">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="6627e-715">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="6627e-716">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="6627e-716">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="6627e-717">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="6627e-717">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="6627e-718">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="6627e-718">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="6627e-719">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="6627e-719">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="6627e-720">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="6627e-720">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="6627e-721">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="6627e-721">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="6627e-722">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="6627e-722">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="6627e-723">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="6627e-723">AzureRM.EventGrid</span></span>
* <span data-ttu-id="6627e-724">Rimozione delle condizioni di convalida ValidateNotNullOrEmpty per SubjectBeginsWith/SubjectEndsWith nel cmdlet Update-AzureRmEventGridSubscription per consentire la modifica di questi parametri in una stringa vuota, se necessario.</span><span class="sxs-lookup"><span data-stu-id="6627e-724">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="6627e-725">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6627e-725">AzureRM.KeyVault</span></span>
* <span data-ttu-id="6627e-726">Correzione del problema per il quale non venivano restituiti tag con l'esecuzione di Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="6627e-726">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="6627e-727">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="6627e-727">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="6627e-728">Versione pubblica dei cmdlet di Policy Insights</span><span class="sxs-lookup"><span data-stu-id="6627e-728">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="6627e-729">Uso della versione API 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="6627e-729">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="6627e-730">Aggiunta di PolicyDefinitionReferenceId ai risultati di Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="6627e-730">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="6627e-731">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="6627e-731">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="6627e-732">Aggiunta del parametro -Vault ai cmdlet RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="6627e-732">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="6627e-733">Quando viene passato, sostituisce il cmdlet Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="6627e-733">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="6627e-734">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="6627e-734">AzureRM.Sql</span></span>
* <span data-ttu-id="6627e-735">Aggiornamento dell'esempio nel file della Guida per Get-AzureRmSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="6627e-735">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="6627e-736">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="6627e-736">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="6627e-737">Aggiornamento del file della Guida per Add-AzureRmTrafficManagerEndpointConfig</span><span class="sxs-lookup"><span data-stu-id="6627e-737">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="6627e-738">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="6627e-738">AzureRM.Websites</span></span>
* <span data-ttu-id="6627e-739">'Set-AzureRmWebApp' è stato aggiornato in modo da non sovrascrive AppSettings quando si usa -AssignIdentity</span><span class="sxs-lookup"><span data-stu-id="6627e-739">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="6627e-740">'New-AzureRmWebAppSlot' è stato aggiornato per tenere conto di AppServicePlan come parametro facoltativo</span><span class="sxs-lookup"><span data-stu-id="6627e-740">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="6627e-741">6.2.1 - Giugno 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-741">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="6627e-742">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="6627e-742">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="6627e-743">Aggiornamento del modello PSWorkspace per consentire alla rete di usare il tipo come parametro</span><span class="sxs-lookup"><span data-stu-id="6627e-743">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="6627e-744">6.2.0 - Giugno 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-744">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="6627e-745">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="6627e-745">AzureRM.Profile</span></span>
* <span data-ttu-id="6627e-746">Risoluzione del problema relativo al mancato caricamento della versione 10.0.3 di Newtonsoft.Json durante l'importazione del modulo</span><span class="sxs-lookup"><span data-stu-id="6627e-746">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="6627e-747">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="6627e-747">AzureRM.Compute</span></span>
* <span data-ttu-id="6627e-748">Funzionalità di aggiornamento delle VM di set di scalabilità di macchine virtuali</span><span class="sxs-lookup"><span data-stu-id="6627e-748">VMSS VM Update feature</span></span>
    - <span data-ttu-id="6627e-749">Aggiunta dei cmdlet "Update-AzureRmVmssVM" e "New-AzureRmVMDataDisk"</span><span class="sxs-lookup"><span data-stu-id="6627e-749">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="6627e-750">Aggiunta del parametro VirtualMachineScaleSetVM al cmdlet "Add-AzureRmVMDataDisk" per supportare l'aggiunta di un disco dati a una VM di un set di scalabilità di macchine virtuali</span><span class="sxs-lookup"><span data-stu-id="6627e-750">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="6627e-751">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="6627e-751">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="6627e-752">Aggiornamento di ADF .Net SDK alla versione 0.8.0-preview contenente le modifiche seguenti:</span><span class="sxs-lookup"><span data-stu-id="6627e-752">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="6627e-753">Aggiunta dell'operazione di configurazione del repository della factory</span><span class="sxs-lookup"><span data-stu-id="6627e-753">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="6627e-754">Aggiornamento del servizio collegato QuickBooks per l'esposizione delle proprietà consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="6627e-754">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="6627e-755">Aggiornamento di diversi tipi di modello da SecretBase a Object</span><span class="sxs-lookup"><span data-stu-id="6627e-755">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="6627e-756">Aggiunta del trigger di eventi BLOB</span><span class="sxs-lookup"><span data-stu-id="6627e-756">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="6627e-757">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="6627e-757">AzureRM.KeyVault</span></span>
* <span data-ttu-id="6627e-758">Aggiornamento della documentazione con output di esempio</span><span class="sxs-lookup"><span data-stu-id="6627e-758">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="6627e-759">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="6627e-759">AzureRM.Network</span></span>
* <span data-ttu-id="6627e-760">Abilitazione dei parametri di Analisi del traffico nei cmdlet di Network Watcher</span><span class="sxs-lookup"><span data-stu-id="6627e-760">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="6627e-761">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="6627e-761">AzureRM.Resources</span></span>
* <span data-ttu-id="6627e-762">Risoluzione del problema relativo alla proprietà "Properties" degli oggetti "PSResource" restituiti da "Get-AzureRmResource"</span><span class="sxs-lookup"><span data-stu-id="6627e-762">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="6627e-763">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="6627e-763">AzureRM.Scheduler</span></span>
* <span data-ttu-id="6627e-764">Risoluzione del problema relativo alla mancata impostazione dei nuovi valori di autenticazione con l'aggiornamento di ServiceBusQueueJob</span><span class="sxs-lookup"><span data-stu-id="6627e-764">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="6627e-765">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="6627e-765">AzureRM.Sql</span></span>
* <span data-ttu-id="6627e-766">Aggiornamento dei cmdlet seguenti con il parametro LicenseType facoltativo</span><span class="sxs-lookup"><span data-stu-id="6627e-766">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="6627e-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="6627e-767">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="6627e-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="6627e-768">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="6627e-769">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="6627e-769">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="6627e-770">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="6627e-770">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="6627e-771">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="6627e-771">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="6627e-772">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="6627e-772">AzureRM.Websites</span></span>
* <span data-ttu-id="6627e-773">Aggiornamento di "New-AzureRMWebApp" per l'uso di algoritmi comuni della libreria Strategy</span><span class="sxs-lookup"><span data-stu-id="6627e-773">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="6627e-774">6.1.0 - Maggio 2018</span><span class="sxs-lookup"><span data-stu-id="6627e-774">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="6627e-775">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="6627e-775">AzureRM.Profile</span></span>
* <span data-ttu-id="6627e-776">Risoluzione del problema relativo all'esecuzione di 'Clear-AzureRmContext' che mantiene un contesto vuoto con il nome del contesto predefinito precedente, impedendo all'utente di creare un nuovo contesto con il nome precedente</span><span class="sxs-lookup"><span data-stu-id="6627e-776">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="6627e-777">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="6627e-777">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="6627e-778">Abilitazione delle operazioni di associazione/disassociazione del gateway in Analysis Services.</span><span class="sxs-lookup"><span data-stu-id="6627e-778">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="6627e-779">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="6627e-779">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="6627e-780">Aggiunta di supporto per ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="6627e-780">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="6627e-781">Aggiunta di supporto per il back-end di Service Fabric</span><span class="sxs-lookup"><span data-stu-id="6627e-781">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="6627e-782">Aggiunta di supporto per il logger di Application Insights</span><span class="sxs-lookup"><span data-stu-id="6627e-782">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="6627e-783">Aggiunta di supporto per il riconoscimento dello SKU 'Basic' come SKU valido del servizio Gestione API</span><span class="sxs-lookup"><span data-stu-id="6627e-783">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="6627e-784">Aggiunta di supporto per l'installazione di certificati rilasciati da un'autorità di certificazione privata come radice o CA</span><span class="sxs-lookup"><span data-stu-id="6627e-784">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="6627e-785">Aggiunta di supporto per l'accettazione di certificati SSL personalizzati tramite KeyVault e più nomi host proxy</span><span class="sxs-lookup"><span data-stu-id="6627e-785">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="6627e-786">Aggiunta di supporto per identità di MSI</span><span class="sxs-lookup"><span data-stu-id="6627e-786">Added support for MSI identity</span></span>
* <span data-ttu-id="6627e-787">Aggiunta di supporto per l'accettazione di criteri tramite URL. NOTA: i cmdlet seguenti verranno deprecati nelle versioni future</span><span class="sxs-lookup"><span data-stu-id="6627e-787">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="6627e-788">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="6627e-788">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="6627e-789">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="6627e-789">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="6627e-790">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="6627e-790">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="6627e-791">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="6627e-791">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="6627e-792">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="6627e-792">AzureRM.Batch</span></span>
* <span data-ttu-id="6627e-793">Rilascio del nuovo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="6627e-793">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="6627e-794">Rilascio del nuovo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="6627e-794">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="6627e-795">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="6627e-795">AzureRM.Consumption</span></span>
* <span data-ttu-id="6627e-796">Aggiunta di nuovi parametri Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top nel cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="6627e-796">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="6627e-797">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="6627e-797">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="6627e-798">Correzione dell'esempio per Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="6627e-798">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="6627e-799">Correzione dell'eccezione del parametro Null in caso di ricorsione in Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="6627e-799">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="6627e-800">Correzione dei file della Guida per Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="6627e-800">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="6627e-801">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="6627e-801">AzureRM.Network</span></span>
* <span data-ttu-id="6627e-802">Incremento della versione di Network SDK da 18.0.0-preview a 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="6627e-802">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="6627e-803">Aggiunta di un cmdlet per la creazione della configurazione del protocollo</span><span class="sxs-lookup"><span data-stu-id="6627e-803">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="6627e-804">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="6627e-804">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="6627e-805">Aggiunta di un cmdlet per aggiungere una nuova connessione a circuito a un circuito di ExpressRoute esistente.</span><span class="sxs-lookup"><span data-stu-id="6627e-805">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="6627e-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="6627e-806">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="6627e-807">Aggiunta di un cmdlet per la rimozione di una connessione a circuito da un circuito di ExpressRoute esistente.</span><span class="sxs-lookup"><span data-stu-id="6627e-807">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="6627e-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="6627e-808">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="6627e-809">Aggiunta di un cmdlet per il recupero di una connessione a circuito</span><span class="sxs-lookup"><span data-stu-id="6627e-809">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="6627e-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="6627e-810">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="6627e-811">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="6627e-811">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="6627e-812">Correzione dell'utilizzo dell'autenticazione del server con certificati generati (problema #5998)</span><span class="sxs-lookup"><span data-stu-id="6627e-812">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="6627e-813">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="6627e-813">AzureRM.Sql</span></span>
* <span data-ttu-id="6627e-814">Aggiornamento dei cmdlet di controllo per consentire la rimozione di AuditActions o AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="6627e-814">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="6627e-815">Correzione del problema relativo a Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy durante l'impostazione di un nuovo criterio di conservazione flessibile che provocava l'errore del comando con un messaggio analogo al seguente: 'La configurazione dei criteri di conservazione a lungo termine con l'insieme di credenziali del servizio di ripristino di Azure e i criteri non è più supportata.</span><span class="sxs-lookup"><span data-stu-id="6627e-815">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="6627e-816">Inviare la richiesta con i nuovi criteri di conservazione flessibili'.</span><span class="sxs-lookup"><span data-stu-id="6627e-816">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="6627e-817">Aggiornamento di tutti i cmdlet correlati a database SQL di Azure/creazione di pool elastici/aggiornamento in modo che venga usata la nuova API del database che supporta la proprietà SKU per il ridimensionamento e le proprietà correlate ai livelli.</span><span class="sxs-lookup"><span data-stu-id="6627e-817">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="6627e-818">I cmdlet aggiornati includono:</span><span class="sxs-lookup"><span data-stu-id="6627e-818">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="6627e-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="6627e-819">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="6627e-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="6627e-820">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="6627e-821">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="6627e-821">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="6627e-822">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="6627e-822">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="6627e-823">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="6627e-823">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="6627e-824">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="6627e-824">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="6627e-825">Aggiornamento dei parametri per 'Get-AzureRmTrafficManagerProfile' in modo che il parametro -ResourceGroupName sia necessario quando si usa il parametro -Name.</span><span class="sxs-lookup"><span data-stu-id="6627e-825">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
