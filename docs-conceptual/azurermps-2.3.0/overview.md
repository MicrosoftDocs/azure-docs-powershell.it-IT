...
---
# <a name="azurerm-module-230"></a>Modulo AzureRM 2.3.0
...
* La versione 2.3.0 contiene un elenco di modifiche di rilievo. Per eseguire l'aggiornamento dalla versione 1.2.11, è stata creata una Guida alla migrazione disponibile all'indirizzo https://aka.ms/azspowershellmigration
* Questa versione corrisponde al profilo di API specifico di Azure Stack 2018-03-01-hybrid
