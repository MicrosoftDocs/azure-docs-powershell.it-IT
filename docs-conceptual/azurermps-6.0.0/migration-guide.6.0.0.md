...
- [Modifiche di rilievo di carattere generale](#general-breaking-changes)
    ...
    - [Salvataggio automatico del contesto abilitato per impostazione predefinita](#context-autosaved-enabled-by-default)
...
_Nota_: questa modifica non riguarderà gli utenti che in precedenza avevano disabilitato il salvataggio automatico del contesto oppure gli utenti con salvataggio automatico del contesto abilitato e contesti esistenti
...
- Il parametro `Certificate` è diventato obbligatorio.
...
- Il cmdlet `IKeyVaultDataServiceClient` è stato aggiornato in modo che tutte le operazioni relative ai certificati restituiscano PSTypes invece di tipi SDK. Sono inclusi:
