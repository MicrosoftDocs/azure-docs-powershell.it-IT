...
#### <a name="azurestorage"></a><span data-ttu-id="a030a-112">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="a030a-112">Azure.Storage</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="a030a-131">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="a030a-131">AzureRM.Network</span></span>
...
* <span data-ttu-id="a030a-155">Aggiunta del supporto per il certificato radice attendibile e la configurazione della scalabilità automatica nel gateway applicazione</span><span class="sxs-lookup"><span data-stu-id="a030a-155">Added support for Trusted Root certificate and Autoscale configuration in Application Gateway</span></span>
  - <span data-ttu-id="a030a-156">Aggiunta di nuovi cmdlet:</span><span class="sxs-lookup"><span data-stu-id="a030a-156">New Cmdlets added:</span></span>
...
* <span data-ttu-id="a030a-175">Aggiunta del supporto per più prefissi di indirizzi in una sottorete.</span><span class="sxs-lookup"><span data-stu-id="a030a-175">Added support for multiple address prefixes in a subnet.</span></span> <span data-ttu-id="a030a-176">Aggiornamento dei cmdlet:</span><span class="sxs-lookup"><span data-stu-id="a030a-176">Updated cmdlets:</span></span>
  ...
  - <span data-ttu-id="a030a-181">Add-AzureRmApplicationGatewayAuthenticationCertificate</span><span class="sxs-lookup"><span data-stu-id="a030a-181">Add-AzureRmApplicationGatewayAuthenticationCertificate</span></span>
...
#### <a name="azurermrediscache"></a><span data-ttu-id="a030a-204">AzureRM.RedisCache</span><span class="sxs-lookup"><span data-stu-id="a030a-204">AzureRM.RedisCache</span></span>
...
* <span data-ttu-id="a030a-218">Supporto dei criteri di immutabilità in AzureRm.Storage</span><span class="sxs-lookup"><span data-stu-id="a030a-218">Support Immutability Policy in AzureRm.Storage</span></span> 
    ...
    - <span data-ttu-id="a030a-226">Set-AzureRmStorageContainerImmutabilityPolicy</span><span class="sxs-lookup"><span data-stu-id="a030a-226">Set-AzureRmStorageContainerImmutabilityPolicy</span></span>
...
#### <a name="azurermprofile"></a><span data-ttu-id="a030a-274">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="a030a-274">AzureRM.Profile</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="a030a-290">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="a030a-290">AzureRM.TrafficManager</span></span>
...
#### <a name="azurestorage"></a><span data-ttu-id="a030a-306">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="a030a-306">Azure.Storage</span></span>
...
#### <a name="azurermbatch"></a><span data-ttu-id="a030a-321">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="a030a-321">AzureRM.Batch</span></span>
...
#### <a name="azurermcontainerinstance"></a><span data-ttu-id="a030a-337">AzureRM.ContainerInstance</span><span class="sxs-lookup"><span data-stu-id="a030a-337">AzureRM.ContainerInstance</span></span>
...
#### <a name="azurermdevtestlabs"></a><span data-ttu-id="a030a-352">AzureRM.DevTestLabs</span><span class="sxs-lookup"><span data-stu-id="a030a-352">AzureRM.DevTestLabs</span></span>
...
#### <a name="azurermlogicapp"></a><span data-ttu-id="a030a-368">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="a030a-368">AzureRM.LogicApp</span></span>
...
* <span data-ttu-id="a030a-385">Rigenerazione dei cmdlet per ApplicationSecurityGroup, RouteTable e Usage con il generatore di codice più recente</span><span class="sxs-lookup"><span data-stu-id="a030a-385">Re-generated cmdlets for ApplicationSecurityGroup, RouteTable and Usage using latest code generator</span></span>
...
* <span data-ttu-id="a030a-401">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="a030a-401">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
* <span data-ttu-id="a030a-423">Aggiornamento alla versione più recente del runtime del client di Azure.</span><span class="sxs-lookup"><span data-stu-id="a030a-423">Updated to the latest version of the Azure ClientRuntime.</span></span>
...
#### <a name="azurermtrafficmanager"></a><span data-ttu-id="a030a-438">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="a030a-438">AzureRM.TrafficManager</span></span>
...
#### <a name="azurermapimanagement"></a><span data-ttu-id="a030a-453">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="a030a-453">AzureRM.ApiManagement</span></span>
...
#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="a030a-471">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="a030a-471">AzureRM.DataFactoryV2</span></span>
...
#### <a name="azurermnetwork"></a><span data-ttu-id="a030a-485">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="a030a-485">AzureRM.Network</span></span>
...
* <span data-ttu-id="a030a-494">Aggiunta del supporto per Advanced Threat Protection per il server con i cmdlet seguenti:</span><span class="sxs-lookup"><span data-stu-id="a030a-494">Adding Server Advanced Threat Protection support with the following cmdlets:</span></span>
    - <span data-ttu-id="a030a-495">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span><span class="sxs-lookup"><span data-stu-id="a030a-495">Enable-AzureRmSqlServerAdvancedThreatProtection; Disable-AzureRmSqlServerAdvancedThreatProtection; Get-AzureRmSqlServerAdvancedThreatProtectionPolicy</span></span>
* <span data-ttu-id="a030a-496">Aggiunta del supporto per la valutazione della vulnerabilità con i cmdlet seguenti:</span><span class="sxs-lookup"><span data-stu-id="a030a-496">Adding Vulnerability Assessment support with the following cmdlets:</span></span>
    - <span data-ttu-id="a030a-497">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span><span class="sxs-lookup"><span data-stu-id="a030a-497">Update-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Get-AzureRmSqlDatabaseVulnerabilityAssessmentSettings; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentSettings</span></span>
    - <span data-ttu-id="a030a-498">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span><span class="sxs-lookup"><span data-stu-id="a030a-498">Set-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Get-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline; Clear-AzureRmSqlDatabaseVulnerabilityAssessmentRuleBaseline</span></span>
    - <span data-ttu-id="a030a-499">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span><span class="sxs-lookup"><span data-stu-id="a030a-499">Convert-AzureRmSqlDatabaseVulnerabilityAssessmentScan; Get-AzureRmSqlDatabaseVulnerabilityAssessmentScanRecord; Start-AzureRmSqlDatabaseVulnerabilityAssessmentScan</span></span>
* <span data-ttu-id="a030a-500">Correzione dell'esempio in Remove-AzureRmSqlServerFirewallRule</span><span class="sxs-lookup"><span data-stu-id="a030a-500">Fixed example in Remove-AzureRmSqlServerFirewallRule</span></span>
* <span data-ttu-id="a030a-501">Correzione della gestione non corretta di data e ora per impostazioni cultura non degli Stati Uniti in Get-AzureSqlSyncGroupLog</span><span class="sxs-lookup"><span data-stu-id="a030a-501">Fix datetime handling incorrectly for non-us base culture in Get-AzureSqlSyncGroupLog</span></span>

#### <a name="azurermstorage"></a><span data-ttu-id="a030a-502">AzureRM.Storage</span><span class="sxs-lookup"><span data-stu-id="a030a-502">AzureRM.Storage</span></span>
* <span data-ttu-id="a030a-503">Aggiunta di Ps1XmlAttribute alle proprietà dei tipi di output dei cmdlet</span><span class="sxs-lookup"><span data-stu-id="a030a-503">Add Ps1XmlAttribute to cmdlets output types properties</span></span>
* <span data-ttu-id="a030a-504">Visualizzazione dell'output del cmdlet StorageAccount nella vista tabella</span><span class="sxs-lookup"><span data-stu-id="a030a-504">Show StorageAccount cmdlet output in table view</span></span>
    - <span data-ttu-id="a030a-505">Get-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="a030a-505">Get-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="a030a-506">New-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="a030a-506">New-AzureRmStorageAccount</span></span>
    - <span data-ttu-id="a030a-507">Set-AzureRmStorageAccount</span><span class="sxs-lookup"><span data-stu-id="a030a-507">Set-AzureRmStorageAccount</span></span>

#### <a name="azurermtags"></a><span data-ttu-id="a030a-508">AzureRM.Tags</span><span class="sxs-lookup"><span data-stu-id="a030a-508">AzureRM.Tags</span></span>
* <span data-ttu-id="a030a-509">Rimozione dell'istruzione non corretta dalla Guida del cmdlet Tag</span><span class="sxs-lookup"><span data-stu-id="a030a-509">Remove incorrect statement from Tag cmdlet help</span></span>
    - https://github.com/Azure/azure-powershell/issues/3878

## <a name="650---july-2018"></a><span data-ttu-id="a030a-510">6.5.0 - Luglio 2018</span><span class="sxs-lookup"><span data-stu-id="a030a-510">6.5.0 - July 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="a030a-511">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="a030a-511">AzureRM.Profile</span></span>
* <span data-ttu-id="a030a-512">Aggiornamento della Guida per 'Get-AzureRmContextAutosaveSetting'</span><span class="sxs-lookup"><span data-stu-id="a030a-512">Updated help for 'Get-AzureRmContextAutosaveSetting'</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="a030a-513">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="a030a-513">Azure.Storage</span></span>
* <span data-ttu-id="a030a-514">Supporto del caricamento di BLOB o file con token di firma di accesso condiviso a sola scrittura</span><span class="sxs-lookup"><span data-stu-id="a030a-514">Support Upload Blob or File with write only Sas token</span></span>
- <span data-ttu-id="a030a-515">Set-AzureStorageBlobContent</span><span class="sxs-lookup"><span data-stu-id="a030a-515">Set-AzureStorageBlobContent</span></span>
- <span data-ttu-id="a030a-516">Set-AzureStorageFileContent</span><span class="sxs-lookup"><span data-stu-id="a030a-516">Set-AzureStorageFileContent</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="a030a-517">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="a030a-517">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="a030a-518">Aggiunta della proprietà obbligatoria ResourceGroupName ad AS.</span><span class="sxs-lookup"><span data-stu-id="a030a-518">Add required property ResourceGroupName to AS.</span></span>

#### <a name="azurermautomation"></a><span data-ttu-id="a030a-519">AzureRM.Automation</span><span class="sxs-lookup"><span data-stu-id="a030a-519">AzureRM.Automation</span></span>
* <span data-ttu-id="a030a-520">Aggiornamento della Guida e aggiunta di un esempio per 'New-AzureRMAutomationSchedule'</span><span class="sxs-lookup"><span data-stu-id="a030a-520">Update help and add example for 'New-AzureRMAutomationSchedule'</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="a030a-521">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="a030a-521">AzureRM.Compute</span></span>
* <span data-ttu-id="a030a-522">Aggiunta del parametro -Tag a Update/New-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="a030a-522">Add -Tag parameter to Update/New-AzureRmAvailabilitySet</span></span>
* <span data-ttu-id="a030a-523">Aggiunta di un esempio per 'Add-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="a030a-523">Add example for 'Add-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="a030a-524">Aggiunta di esempi per 'Remove-AzureRmVmssExtension'</span><span class="sxs-lookup"><span data-stu-id="a030a-524">Add examples for 'Remove-AzureRmVmssExtension'</span></span>
* <span data-ttu-id="a030a-525">Aggiornamento della Guida per 'Set-AzureRmVMAccessExtension'</span><span class="sxs-lookup"><span data-stu-id="a030a-525">Update help for 'Set-AzureRmVMAccessExtension'</span></span>
* <span data-ttu-id="a030a-526">Aggiornamento di SimpleParameterSet per New-AzureRmVmmss per l'impostazione di SinglePlacementGroup su false per impostazione predefinita e aggiunta del parametro opzionale 'SinglePlacementGroup' che consente all'utente di creare il set di scalabilità di macchine virtuali in un singolo gruppo di selezione host.</span><span class="sxs-lookup"><span data-stu-id="a030a-526">Update SimpleParameterSet for New-AzureRmVmss to set SinglePlacementGroup to false by default and add switch parameter 'SinglePlacementGroup' that enables the user to create the VMSS in a single placement group.</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="a030a-527">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="a030a-527">AzureRM.EventHub</span></span>
* <span data-ttu-id="a030a-528">Aggiunta di una proprietà 'PendingReplicationOperationsCount' di sola lettura alla classe PSEventHubDRConfigurationAttributes, che fornisce il conteggio delle operazioni di replica in sospeso mentre la replica è in corso</span><span class="sxs-lookup"><span data-stu-id="a030a-528">Added a readonly property 'PendingReplicationOperationsCount' to PSEventHubDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="a030a-529">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="a030a-529">AzureRM.KeyVault</span></span>
* <span data-ttu-id="a030a-530">Aggiornamento del messaggio di errore per Set-AzureRmKeyVaultAccessPolicy</span><span class="sxs-lookup"><span data-stu-id="a030a-530">Update error message for Set-AzureRmKeyVaultAccessPolicy</span></span>

#### <a name="azurermlogicapp"></a><span data-ttu-id="a030a-531">AzureRM.LogicApp</span><span class="sxs-lookup"><span data-stu-id="a030a-531">AzureRM.LogicApp</span></span>
* <span data-ttu-id="a030a-532">Correzione dell'errore "Impossibile risolvere set di parametri" in New-AzureRmLogicApp</span><span class="sxs-lookup"><span data-stu-id="a030a-532">Fixed "parameter set could not be resolved" error in New-AzureRmLogicApp</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="a030a-533">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="a030a-533">AzureRM.Network</span></span>
* <span data-ttu-id="a030a-534">Abilitazione del peering di reti virtuali in più tenant per Set/Add-AzureRmVirtualNetworkPeering</span><span class="sxs-lookup"><span data-stu-id="a030a-534">Enable peering across Virtual Networks in multiple Tenants for Set/Add-AzureRmVirtualNetworkPeering</span></span>
* <span data-ttu-id="a030a-535">Aggiornamento dei cmdlet seguenti per il gateway applicazione</span><span class="sxs-lookup"><span data-stu-id="a030a-535">Updated below cmdlets for Application Gateway</span></span>
    - <span data-ttu-id="a030a-536">New-AzureRmApplicationGateway: aggiunta del flag EnableFIPS e del supporto delle zone</span><span class="sxs-lookup"><span data-stu-id="a030a-536">New-AzureRmApplicationGateway : Added EnableFIPS flag and Zones support</span></span>
    - <span data-ttu-id="a030a-537">New-AzureRmApplicationGatewaySku: aggiunta dei nuovi SKU Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="a030a-537">New-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
    - <span data-ttu-id="a030a-538">Set-AzureRmApplicationGatewaySku: aggiunta dei nuovi SKU Standard_v2 e WAF_v2</span><span class="sxs-lookup"><span data-stu-id="a030a-538">Set-AzureRmApplicationGatewaySku : Added new skus Standard_v2 and WAF_v2</span></span>
* <span data-ttu-id="a030a-539">Rigenerazione del cmdlet RouteTable con la versione più recente del generatore</span><span class="sxs-lookup"><span data-stu-id="a030a-539">Regenerated RouteTable cmdlets with the latest generator version</span></span>

#### <a name="azurermrelay"></a><span data-ttu-id="a030a-540">AzureRM.Relay</span><span class="sxs-lookup"><span data-stu-id="a030a-540">AzureRM.Relay</span></span>
* <span data-ttu-id="a030a-541">Aggiornamento dei file markdown, correzione del problema relativo al nome del parametro nell'esempio</span><span class="sxs-lookup"><span data-stu-id="a030a-541">Updated markdown files, fix for the parameter name issue in example</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="a030a-542">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="a030a-542">AzureRM.Resources</span></span>
* <span data-ttu-id="a030a-543">Aggiornamento dei cmdlet roleassignment e roledefinition:</span><span class="sxs-lookup"><span data-stu-id="a030a-543">Update Roleassignment and roledefinition cmdlets:</span></span>
    - <span data-ttu-id="a030a-544">Rimozione delle chiamate roledefinition aggiuntive eseguite nell'ambito del paging.</span><span class="sxs-lookup"><span data-stu-id="a030a-544">Remove extra roledefinition calls done as part of paging.</span></span>
* <span data-ttu-id="a030a-545">Correzione del cmdlet Get-AzureRmRoleAssignment</span><span class="sxs-lookup"><span data-stu-id="a030a-545">Fix Get-AzureRmRoleAssignment cmdlet</span></span>
    - <span data-ttu-id="a030a-546">Correzione della funzionalità dei parametri del comando -ExpandPrincipalGroups</span><span class="sxs-lookup"><span data-stu-id="a030a-546">Fix -ExpandPrincipalGroups command parameter functionality</span></span>
* <span data-ttu-id="a030a-547">Correzione del problema con 'Get-AzureRmResource', in cui il parametro '-ResourceType' faceva distinzione tra maiuscole e minuscole</span><span class="sxs-lookup"><span data-stu-id="a030a-547">Fix issue with 'Get-AzureRmResource' where '-ResourceType' parameter was case sensitive</span></span>

#### <a name="azurermservicebus"></a><span data-ttu-id="a030a-548">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="a030a-548">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="a030a-549">Aggiunta del parametro top e skip ai cmdlet list</span><span class="sxs-lookup"><span data-stu-id="a030a-549">Added top and skip parameter to list cmdlets</span></span>
* <span data-ttu-id="a030a-550">Aggiunta di cmdlet di migrazione dello spazio dei nomi da Standard a Premium:</span><span class="sxs-lookup"><span data-stu-id="a030a-550">Added Standard to Premium NameSpace migration cmdlets :</span></span>
    - <span data-ttu-id="a030a-551">Start-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="a030a-551">Start-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="a030a-552">Get-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="a030a-552">Get-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="a030a-553">Complete-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="a030a-553">Complete-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="a030a-554">Stop-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="a030a-554">Stop-AzureRmServiceBusMigration</span></span>
    - <span data-ttu-id="a030a-555">Remove-AzureRmServiceBusMigration</span><span class="sxs-lookup"><span data-stu-id="a030a-555">Remove-AzureRmServiceBusMigration</span></span>
* <span data-ttu-id="a030a-556">Aggiunta di una proprietà 'PendingReplicationOperationsCount' di sola lettura alla classe PSServiceBusDRConfigurationAttributes, che fornisce il conteggio delle operazioni di replica in sospeso mentre la replica è in corso</span><span class="sxs-lookup"><span data-stu-id="a030a-556">Added a readonly property 'PendingReplicationOperationsCount' to PSServiceBusDRConfigurationAttributes class, which gives the pending replication operations count while replication is in progress</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="a030a-557">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="a030a-557">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="a030a-558">Aggiornamento dell'esempio per 'New-AzureRmServiceFabricCluster'</span><span class="sxs-lookup"><span data-stu-id="a030a-558">Update example for 'New-AzureRmServiceFabricCluster'</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="a030a-559">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="a030a-559">AzureRM.Sql</span></span>
* <span data-ttu-id="a030a-560">Aggiunta di nuovi cmdlet per Management.Sql per consentire ai clienti di aggiungere il certificato TDE all'istanza di SQL Server o a un'istanza gestita</span><span class="sxs-lookup"><span data-stu-id="a030a-560">Adding new Cmdlets for Management.Sql to allow customers to add TDE Certificate to Sql Server instance or a Managed Instance</span></span>
    - <span data-ttu-id="a030a-561">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="a030a-561">Add-AzureRmSqlServerTransparentDataEncryptionCertificate</span></span>
    - <span data-ttu-id="a030a-562">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span><span class="sxs-lookup"><span data-stu-id="a030a-562">Add-AzureRmSqlManagedInstanceTransparentDataEncryptionCertificate</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="a030a-563">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="a030a-563">AzureRM.Websites</span></span>
* <span data-ttu-id="a030a-564">Se impostati su false, `Set-AzureRmWebApp -AssignIdentity` e `Set-AzureRmWebAppSlot -AssignIdentity` rimuovono ora la proprietà Identity anche dal tag di anteprima object.Removing del sito.</span><span class="sxs-lookup"><span data-stu-id="a030a-564">`Set-AzureRmWebApp -AssignIdentity` and  `Set-AzureRmWebAppSlot -AssignIdentity` when set to false will now remove the Identity property from the site object.Removing preview tag as well.</span></span>
* <span data-ttu-id="a030a-565">Aggiornamento dell'esempio `Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics`</span><span class="sxs-lookup"><span data-stu-id="a030a-565">`Get-AzureRmWebAppMetrics`,`Get-AzureRmAppServicePlanMetrics` example updated</span></span>
* <span data-ttu-id="a030a-566">`Set-AzureRmWebApp -PhpVersion` supporta off come versione php valida</span><span class="sxs-lookup"><span data-stu-id="a030a-566">`Set-AzureRmWebApp -PhpVersion` supports off as a valid php version</span></span>

## <a name="640---july-2018"></a><span data-ttu-id="a030a-567">6.4.0 - Luglio 2018</span><span class="sxs-lookup"><span data-stu-id="a030a-567">6.4.0 - July 2018</span></span>
#### <a name="general"></a><span data-ttu-id="a030a-568">Generale</span><span class="sxs-lookup"><span data-stu-id="a030a-568">General</span></span>
* <span data-ttu-id="a030a-569">Correzione della formattazione di OutputType nei file della Guida per la maggior parte dei moduli</span><span class="sxs-lookup"><span data-stu-id="a030a-569">Fixed formatting of OutputType in help files for most modules</span></span>

#### <a name="azurermprofile"></a><span data-ttu-id="a030a-570">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="a030a-570">AzureRM.Profile</span></span>
* <span data-ttu-id="a030a-571">Aggiunta dell'attributo Ps1Xml ai tipi di output di base</span><span class="sxs-lookup"><span data-stu-id="a030a-571">Ps1Xml attribute added to the basic output types</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="a030a-572">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="a030a-572">AzureRM.Compute</span></span>
* <span data-ttu-id="a030a-573">Funzionalità tag IP per VMSS</span><span class="sxs-lookup"><span data-stu-id="a030a-573">IP Tag feature for VMSS</span></span>
    - <span data-ttu-id="a030a-574">Aggiunta del cmdlet 'New-AzureRmVmssIpTagConfig'</span><span class="sxs-lookup"><span data-stu-id="a030a-574">'New-AzureRmVmssIpTagConfig' cmdlet is added</span></span>
    - <span data-ttu-id="a030a-575">Aggiunta del parametro IpTag a New-AzureRmVmssIpConfig</span><span class="sxs-lookup"><span data-stu-id="a030a-575">IpTag parameter is added to New-AzureRmVmssIpConfig</span></span>
* <span data-ttu-id="a030a-576">Funzionalità di ripristino dello stato precedente automatico del sistema operativo per VMSS</span><span class="sxs-lookup"><span data-stu-id="a030a-576">Auto OS Rollback feature for VMSS</span></span>
    - <span data-ttu-id="a030a-577">Aggiunta dei parametri DisableAutoRollback a New-AzureRmVmssConfig e Update-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-577">DisableAutoRollback parameters are added to New-AzureRmVmssConfig and Update-AzureRmVmss</span></span>
* <span data-ttu-id="a030a-578">Funzionalità Cronologia degli aggiornamenti del sistema operativo per Vmss</span><span class="sxs-lookup"><span data-stu-id="a030a-578">OS Upgrade History feature for Vmss</span></span>
    - <span data-ttu-id="a030a-579">Aggiunta del parametro opzionale OSUpgradeHistory a Get-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-579">OSUpgradeHistory switch parameter is added to Get-AzureRmVmss</span></span>

#### <a name="azurermdatalakeanalytics"></a><span data-ttu-id="a030a-580">AzureRM.DataLakeAnalytics</span><span class="sxs-lookup"><span data-stu-id="a030a-580">AzureRM.DataLakeAnalytics</span></span>
* <span data-ttu-id="a030a-581">Aggiunta del supporto per gli elenchi di controllo di accesso del catalogo tramite i comandi seguenti:</span><span class="sxs-lookup"><span data-stu-id="a030a-581">Add support for Catalog ACLs through the following commands:</span></span>
    - <span data-ttu-id="a030a-582">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="a030a-582">Get-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="a030a-583">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="a030a-583">Set-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>
    - <span data-ttu-id="a030a-584">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="a030a-584">Remove-AzureRmDataLakeAnalyticsCatalogItemAclEntry</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="a030a-585">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a030a-585">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="a030a-586">Aggiunta del supporto per l'annullamento e della verifica dello stato per Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span><span class="sxs-lookup"><span data-stu-id="a030a-586">Add cancellation support and progress tracking for Set-AzureRmDataLakeStoreItemAclEntry, Remove-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl</span></span>
* <span data-ttu-id="a030a-587">Aggiunta del supporto per l'annullamento per Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="a030a-587">Add cancellation support for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="a030a-588">Correzione dello scaricamento dei messaggi di debug per i cmdlet che eseguono operazioni ricorsive</span><span class="sxs-lookup"><span data-stu-id="a030a-588">Fix flushing of debug messages for cmdlets that does recursive operations</span></span>
* <span data-ttu-id="a030a-589">Correzione della posizione del test dei cmdlet di DataLake</span><span class="sxs-lookup"><span data-stu-id="a030a-589">Fix location of test of DataLake cmdlets</span></span>

#### <a name="azurermeventhub"></a><span data-ttu-id="a030a-590">AzureRM.EventHub</span><span class="sxs-lookup"><span data-stu-id="a030a-590">AzureRM.EventHub</span></span>
* <span data-ttu-id="a030a-591">Aggiunta del parametro facoltativo MaxCount al cmdlet per le operazioni dell'elenco Get-AzureRmEventHub e Get-AzureRmEventHubConsumerGroup</span><span class="sxs-lookup"><span data-stu-id="a030a-591">Added Optional MaxCount parameter to List Operations cmdlet Get-AzureRmEventHub and Get-AzureRmEventHubConsumerGroup</span></span>
* <span data-ttu-id="a030a-592">Risoluzione del problema nel cmdlet New-AzureRmEventHub che richiede almeno un parametro durante la creazione di un nuovo hub eventi.</span><span class="sxs-lookup"><span data-stu-id="a030a-592">Fixed issue in New-AzureRmEventHub cmdlet where at least one parameter needed while creating New EventHub.</span></span> <span data-ttu-id="a030a-593">Aggiunta di un set di parametri predefinito.</span><span class="sxs-lookup"><span data-stu-id="a030a-593">Provided Default Parameter set.</span></span>
* <span data-ttu-id="a030a-594">Aggiunta del parametro facoltativo -KeyValue al cmdlet New-AzureRmEventHubKey, che consente all'utente di fornire KeyValue.</span><span class="sxs-lookup"><span data-stu-id="a030a-594">Added optional Parameter -KeyValue to New-AzureRmEventHubKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="a030a-595">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="a030a-595">AzureRM.KeyVault</span></span>
* <span data-ttu-id="a030a-596">Correzione di un problema relativo alla restituzione di tutte le risorse da parte di Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="a030a-596">Fix issue where all resources were being returned by Get-AzureRmKeyVault -Tag</span></span>

#### <a name="azurermnetwork"></a><span data-ttu-id="a030a-597">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="a030a-597">AzureRM.Network</span></span>
* <span data-ttu-id="a030a-598">Esposizione di nuovi SKU per VirtualNetworkGateways con ridondanza della zona</span><span class="sxs-lookup"><span data-stu-id="a030a-598">Expose new Skus for Zone-Redundant VirtualNetworkGateways</span></span>
* <span data-ttu-id="a030a-599">Aggiunta di nuovi comandi per la funzionalità delle API partner di ExpressRoute tramite ARM</span><span class="sxs-lookup"><span data-stu-id="a030a-599">Added new commands for feature: ExpressRoute Partner APIs via ARM</span></span>
    - <span data-ttu-id="a030a-600">Aggiunta di Get-AzureRmExpressRouteCrossConnection</span><span class="sxs-lookup"><span data-stu-id="a030a-600">Added Get-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="a030a-601">Aggiunta di Set-AzureRmExpressRouteCrossConnection</span><span class="sxs-lookup"><span data-stu-id="a030a-601">Added Set-AzureRmExpressRouteCrossConnection</span></span>
    - <span data-ttu-id="a030a-602">Aggiunta di Add-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="a030a-602">Added Add-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="a030a-603">Aggiunta di Get-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="a030a-603">Added Get-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="a030a-604">Aggiunta di Remove-AzureRmExpressRouteCrossConnectionPeering</span><span class="sxs-lookup"><span data-stu-id="a030a-604">Added Remove-AzureRmExpressRouteCrossConnectionPeering</span></span>
    - <span data-ttu-id="a030a-605">Aggiunta di Get-AzureRMExpressRouteCrossConnectionArpTable</span><span class="sxs-lookup"><span data-stu-id="a030a-605">Added Get-AzureRMExpressRouteCrossConnectionArpTable</span></span>
    - <span data-ttu-id="a030a-606">Aggiunta di Get-AzureRMExpressRouteCrossConnectionRouteTable</span><span class="sxs-lookup"><span data-stu-id="a030a-606">Added Get-AzureRMExpressRouteCrossConnectionRouteTable</span></span>
    - <span data-ttu-id="a030a-607">Aggiunta di Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span><span class="sxs-lookup"><span data-stu-id="a030a-607">Added Get-AzureRMExpressRouteCrossConnectionRouteTableSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="a030a-608">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="a030a-608">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="a030a-609">Aggiunta del cmdlet Get-AzureRmRecoveryServicesBackupStatus.</span><span class="sxs-lookup"><span data-stu-id="a030a-609">Added Get-AzureRmRecoveryServicesBackupStatus cmdlet.</span></span> <span data-ttu-id="a030a-610">Questo cmdlet accetta un ID di macchina virtuale e verifica se la VM è protetta da un insieme di credenziali nella sottoscrizione.</span><span class="sxs-lookup"><span data-stu-id="a030a-610">This cmdlet takes a VM ID and checks if the VM is protected by some vault in the subscription.</span></span> <span data-ttu-id="a030a-611">Se tale insieme di credenziali esiste, il cmdlet restituisce i dettagli dell'insieme di credenziali.</span><span class="sxs-lookup"><span data-stu-id="a030a-611">If there exists such a vault, the cmdlet outputs the vault details.</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="a030a-612">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="a030a-612">AzureRM.Resources</span></span>
* <span data-ttu-id="a030a-613">Aggiornamento dei cmdlet Get-AzureRmPolicyAssignment:</span><span class="sxs-lookup"><span data-stu-id="a030a-613">Update Get-AzureRmPolicyAssignment cmdlets:</span></span>
    - <span data-ttu-id="a030a-614">Aggiunta del supporto per elencare i valori -Scope a livello di gruppo di gestione</span><span class="sxs-lookup"><span data-stu-id="a030a-614">Add support for listing -Scope values at management group level</span></span>
    - <span data-ttu-id="a030a-615">Aggiunta del supporto per il recupero di singole assegnazioni con valori -Scope a livello di gruppo di gestione</span><span class="sxs-lookup"><span data-stu-id="a030a-615">Add support for retrieving individual assignments with -Scope values at management group level</span></span>
    - <span data-ttu-id="a030a-616">Aggiunta delle opzioni -Effective e -All al parametro di controllo</span><span class="sxs-lookup"><span data-stu-id="a030a-616">Add -Effective and -All switches to control  parameter</span></span>
* <span data-ttu-id="a030a-617">Aggiornamento dei cmdlet Get/New/Remove/Set-AzureRmPolicyDefinition</span><span class="sxs-lookup"><span data-stu-id="a030a-617">Update Get/New/Remove/Set-AzureRmPolicyDefinition cmdlets</span></span>
    - <span data-ttu-id="a030a-618">Aggiunta del parametro -ManagementGroupName per l'applicazione di operazioni a un gruppo di gestione specifico</span><span class="sxs-lookup"><span data-stu-id="a030a-618">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="a030a-619">Aggiunta del parametro -SubscriptionId per l'applicazione di operazioni a una sottoscrizione specifica</span><span class="sxs-lookup"><span data-stu-id="a030a-619">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="a030a-620">Aggiornamento dei cmdlet Get/New/Remove/Set-AzureRmPolicySetDefinition</span><span class="sxs-lookup"><span data-stu-id="a030a-620">Update Get/New/Remove/Set-AzureRmPolicySetDefinition cmdlets</span></span>
    - <span data-ttu-id="a030a-621">Aggiunta del parametro -ManagementGroupName per l'applicazione di operazioni a un gruppo di gestione specifico</span><span class="sxs-lookup"><span data-stu-id="a030a-621">Add -ManagementGroupName parameter to apply operations to a given management group</span></span>
    - <span data-ttu-id="a030a-622">Aggiunta del parametro -SubscriptionId per l'applicazione di operazioni a una sottoscrizione specifica</span><span class="sxs-lookup"><span data-stu-id="a030a-622">Add -SubscriptionId parameter to apply operations to a given subscription</span></span>
* <span data-ttu-id="a030a-623">Aggiunta del supporto per i riferimenti segreti di KeyVault nei parametri quando si usa 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span><span class="sxs-lookup"><span data-stu-id="a030a-623">Add KeyVault secret reference support in parameters when using 'TemplateParameterObject' in 'New-AzureRmResourceGroupDeployment'</span></span>
* <span data-ttu-id="a030a-624">Risoluzione del problema a causa del quale il parametro '-EndDate' viene ignorato per 'New-AzureRmADAppCredential'</span><span class="sxs-lookup"><span data-stu-id="a030a-624">Fix issue where '-EndDate' parameter was ignored for 'New-AzureRmADAppCredential'</span></span>
    - https://github.com/Azure/azure-powershell/issues/6505
* <span data-ttu-id="a030a-625">Risoluzione del problema relativo all'uso di un URL non corretto da parte di 'Add-AzureRmADGroupMember' per l'effettuazione di una richiesta</span><span class="sxs-lookup"><span data-stu-id="a030a-625">Fix issue where 'Add-AzureRmADGroupMember' used incorrect URL to make request</span></span>
    - https://github.com/Azure/azure-powershell/issues/6485

#### <a name="azurermservicebus"></a><span data-ttu-id="a030a-626">AzureRM.ServiceBus</span><span class="sxs-lookup"><span data-stu-id="a030a-626">AzureRM.ServiceBus</span></span>
* <span data-ttu-id="a030a-627">Aggiunta del parametro facoltativo -KeyValue al cmdlet New-AzureRmServiceBusKey, che consente all'utente di fornire KeyValue.</span><span class="sxs-lookup"><span data-stu-id="a030a-627">Added optional Parameter -KeyValue to New-AzureRmServiceBusKey cmdlet, which enables user to provide KeyValue.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="a030a-628">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="a030a-628">AzureRM.Sql</span></span>
* <span data-ttu-id="a030a-629">Chiarimento dei punti di ripristino definiti dall'utente per SQLDW nella Guida di New-AzureRmSqlDatabaseRestorePoint</span><span class="sxs-lookup"><span data-stu-id="a030a-629">Clarified User-Defined Restore Points for SQLDW in New-AzureRmSqlDatabaseRestorePoint help</span></span>
* <span data-ttu-id="a030a-630">Aggiornamento della documentazione del parametro -ComputeGeneration in alcuni cmdlet</span><span class="sxs-lookup"><span data-stu-id="a030a-630">Updated documentation of -ComputeGeneration parameter in several cmdlets</span></span>

## <a name="630---june-2018"></a><span data-ttu-id="a030a-631">6.3.0 - Giugno 2018</span><span class="sxs-lookup"><span data-stu-id="a030a-631">6.3.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="a030a-632">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="a030a-632">AzureRM.Profile</span></span>
* <span data-ttu-id="a030a-633">Aggiornamento dei messaggi di errore per Enable-AzureRmContextAutoSave</span><span class="sxs-lookup"><span data-stu-id="a030a-633">Updated error messages for Enable-AzureRmContextAutoSave</span></span>
* <span data-ttu-id="a030a-634">Creare un contesto per ogni sottoscrizione quando si esegue 'Connect-AzureRmAccount' senza contesto precedente</span><span class="sxs-lookup"><span data-stu-id="a030a-634">Create a context for each subscription when running 'Connect-AzureRmAccount' with no previous context</span></span>

#### <a name="azurestorage"></a><span data-ttu-id="a030a-635">Azure.Storage</span><span class="sxs-lookup"><span data-stu-id="a030a-635">Azure.Storage</span></span>
* <span data-ttu-id="a030a-636">Aggiunta di altre informazioni sul parametro -Permissions nei file della Guida.</span><span class="sxs-lookup"><span data-stu-id="a030a-636">Added additional information about -Permissions parameter in help files.</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="a030a-637">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="a030a-637">AzureRM.Compute</span></span>
* <span data-ttu-id="a030a-638">'Get-AzureRmVmDiskEncryptionStatus' risolve un problema riscontrato per le VM senza dischi dati</span><span class="sxs-lookup"><span data-stu-id="a030a-638">'Get-AzureRmVmDiskEncryptionStatus' fixes an issue observed for VMs with no data disks</span></span> 
* <span data-ttu-id="a030a-639">Aggiornamento della versione della libreria del client di calcolo per la correzione dei cmdlet seguenti</span><span class="sxs-lookup"><span data-stu-id="a030a-639">Update Compute client library version to fix following cmdlets</span></span>
    - <span data-ttu-id="a030a-640">Grant-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="a030a-640">Grant-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="a030a-641">Grant-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="a030a-641">Grant-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="a030a-642">Save-AzureRmVMImage</span><span class="sxs-lookup"><span data-stu-id="a030a-642">Save-AzureRmVMImage</span></span>
* <span data-ttu-id="a030a-643">Correzione dei cmdlet seguenti per la corretta visualizzazione di 'operation ID' e 'operation status':</span><span class="sxs-lookup"><span data-stu-id="a030a-643">Fixed following cmdlets to show 'operation ID' and 'operation status' correctly:</span></span>
    - <span data-ttu-id="a030a-644">Start-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="a030a-644">Start-AzureRmVM</span></span>
    - <span data-ttu-id="a030a-645">Stop-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="a030a-645">Stop-AzureRmVM</span></span>
    - <span data-ttu-id="a030a-646">Restart-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="a030a-646">Restart-AzureRmVM</span></span>
    - <span data-ttu-id="a030a-647">Set-AzureRmVM</span><span class="sxs-lookup"><span data-stu-id="a030a-647">Set-AzureRmVM</span></span>
    - <span data-ttu-id="a030a-648">Remove-AzuerRmVM</span><span class="sxs-lookup"><span data-stu-id="a030a-648">Remove-AzuerRmVM</span></span>
    - <span data-ttu-id="a030a-649">Set-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-649">Set-AzureRmVmss</span></span>
    - <span data-ttu-id="a030a-650">Start-AzureRmVmssRollingOSUpgrade</span><span class="sxs-lookup"><span data-stu-id="a030a-650">Start-AzureRmVmssRollingOSUpgrade</span></span>
    - <span data-ttu-id="a030a-651">Stop-AzureRmVmssRollingUpgrade</span><span class="sxs-lookup"><span data-stu-id="a030a-651">Stop-AzureRmVmssRollingUpgrade</span></span>
    - <span data-ttu-id="a030a-652">Start-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-652">Start-AzureRmVmss</span></span>
    - <span data-ttu-id="a030a-653">Restart-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-653">Restart-AzureRmVmss</span></span>
    - <span data-ttu-id="a030a-654">Stop-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-654">Stop-AzureRmVmss</span></span>
    - <span data-ttu-id="a030a-655">Remove-AzureRmVmss</span><span class="sxs-lookup"><span data-stu-id="a030a-655">Remove-AzureRmVmss</span></span>
    - <span data-ttu-id="a030a-656">ConvertTo-AzureRmVMManagedDisk</span><span class="sxs-lookup"><span data-stu-id="a030a-656">ConvertTo-AzureRmVMManagedDisk</span></span>
    - <span data-ttu-id="a030a-657">Revoke-AzureRmSnapshotAccess</span><span class="sxs-lookup"><span data-stu-id="a030a-657">Revoke-AzureRmSnapshotAccess</span></span>
    - <span data-ttu-id="a030a-658">Remove-AzureRmSnapshot</span><span class="sxs-lookup"><span data-stu-id="a030a-658">Remove-AzureRmSnapshot</span></span>
    - <span data-ttu-id="a030a-659">Revoke-AzureRmDiskAccess</span><span class="sxs-lookup"><span data-stu-id="a030a-659">Revoke-AzureRmDiskAccess</span></span>
    - <span data-ttu-id="a030a-660">Remove-AzureRmDisk</span><span class="sxs-lookup"><span data-stu-id="a030a-660">Remove-AzureRmDisk</span></span>
    - <span data-ttu-id="a030a-661">Remove-AzureRmContainerService</span><span class="sxs-lookup"><span data-stu-id="a030a-661">Remove-AzureRmContainerService</span></span>
    - <span data-ttu-id="a030a-662">Remove-AzureRmAvailabilitySet</span><span class="sxs-lookup"><span data-stu-id="a030a-662">Remove-AzureRmAvailabilitySet</span></span>

#### <a name="azurermeventgrid"></a><span data-ttu-id="a030a-663">AzureRM.EventGrid</span><span class="sxs-lookup"><span data-stu-id="a030a-663">AzureRM.EventGrid</span></span>
* <span data-ttu-id="a030a-664">Rimozione delle condizioni di convalida ValidateNotNullOrEmpty per SubjectBeginsWith/SubjectEndsWith nel cmdlet Update-AzureRmEventGridSubscription per consentire la modifica di questi parametri in una stringa vuota, se necessario.</span><span class="sxs-lookup"><span data-stu-id="a030a-664">Remove ValidateNotNullOrEmpty validation conditions for SubjectBeginsWith/SubjectEndsWith in Update-AzureRmEventGridSubscription cmdlet to allow changing these parameters to empty string if needed.</span></span>

#### <a name="azurermkeyvault"></a><span data-ttu-id="a030a-665">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="a030a-665">AzureRM.KeyVault</span></span>
* <span data-ttu-id="a030a-666">Correzione del problema per il quale non venivano restituiti tag con l'esecuzione di Get-AzureRmKeyVault -Tag</span><span class="sxs-lookup"><span data-stu-id="a030a-666">Fix issue where no Tags are being returned when Get-AzureRmKeyVault -Tag is run</span></span>

#### <a name="azurermpolicyinsights"></a><span data-ttu-id="a030a-667">AzureRM.PolicyInsights</span><span class="sxs-lookup"><span data-stu-id="a030a-667">AzureRM.PolicyInsights</span></span>
* <span data-ttu-id="a030a-668">Versione pubblica dei cmdlet di Policy Insights</span><span class="sxs-lookup"><span data-stu-id="a030a-668">Public release of Policy Insights cmdlets</span></span>
    - <span data-ttu-id="a030a-669">Uso della versione API 2018-04-04</span><span class="sxs-lookup"><span data-stu-id="a030a-669">Use API version 2018-04-04</span></span>
    - <span data-ttu-id="a030a-670">Aggiunta di PolicyDefinitionReferenceId ai risultati di Get-AzureRmPolicyStateSummary</span><span class="sxs-lookup"><span data-stu-id="a030a-670">Add PolicyDefinitionReferenceId to the results of Get-AzureRmPolicyStateSummary</span></span>

#### <a name="azurermrecoveryservicesbackup"></a><span data-ttu-id="a030a-671">AzureRM.RecoveryServices.Backup</span><span class="sxs-lookup"><span data-stu-id="a030a-671">AzureRM.RecoveryServices.Backup</span></span>
* <span data-ttu-id="a030a-672">Aggiunta del parametro -Vault ai cmdlet RecoveryServices.Backup.</span><span class="sxs-lookup"><span data-stu-id="a030a-672">Added -Vault parameter to RecoveryServices.Backup cmdlets.</span></span> <span data-ttu-id="a030a-673">Quando viene passato, sostituisce il cmdlet Set-AzureRmRecoveryServicesContext.</span><span class="sxs-lookup"><span data-stu-id="a030a-673">When passed, this will override the Set-AzureRmRecoveryServicesContext cmdlet.</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="a030a-674">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="a030a-674">AzureRM.Sql</span></span>
* <span data-ttu-id="a030a-675">Aggiornamento dell'esempio nel file della Guida per Get-AzureRmSqlDatabaseExpanded</span><span class="sxs-lookup"><span data-stu-id="a030a-675">Updated example in the help file for Get-AzureRmSqlDatabaseExpanded</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="a030a-676">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="a030a-676">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="a030a-677">Aggiornamento del file della Guida per Add-AzureRmTrafficManagerEndpointConfig</span><span class="sxs-lookup"><span data-stu-id="a030a-677">Updated the help file for Add-AzureRmTrafficManagerEndpointConfig</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="a030a-678">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="a030a-678">AzureRM.Websites</span></span>
* <span data-ttu-id="a030a-679">'Set-AzureRmWebApp' è stato aggiornato in modo da non sovrascrive AppSettings quando si usa -AssignIdentity</span><span class="sxs-lookup"><span data-stu-id="a030a-679">'Set-AzureRmWebApp' is updated to not overwrite the AppSettings when using -AssignIdentity</span></span>
* <span data-ttu-id="a030a-680">'New-AzureRmWebAppSlot' è stato aggiornato per tenere conto di AppServicePlan come parametro facoltativo</span><span class="sxs-lookup"><span data-stu-id="a030a-680">'New-AzureRmWebAppSlot' is updated to honor AppServicePlan as an optional parameter</span></span>

## <a name="621---june-2018"></a><span data-ttu-id="a030a-681">6.2.1 - Giugno 2018</span><span class="sxs-lookup"><span data-stu-id="a030a-681">6.2.1 - June 2018</span></span>
### <a name="azurermoperationalinsights"></a><span data-ttu-id="a030a-682">AzureRM.OperationalInsights</span><span class="sxs-lookup"><span data-stu-id="a030a-682">AzureRM.OperationalInsights</span></span>
* <span data-ttu-id="a030a-683">Aggiornamento del modello PSWorkspace per consentire alla rete di usare il tipo come parametro</span><span class="sxs-lookup"><span data-stu-id="a030a-683">Updated PSWorkspace model to allow Network to use type as a parameter</span></span>

## <a name="620---june-2018"></a><span data-ttu-id="a030a-684">6.2.0 - Giugno 2018</span><span class="sxs-lookup"><span data-stu-id="a030a-684">6.2.0 - June 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="a030a-685">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="a030a-685">AzureRM.Profile</span></span>
* <span data-ttu-id="a030a-686">Risoluzione del problema relativo al mancato caricamento della versione 10.0.3 di Newtonsoft.Json durante l'importazione del modulo</span><span class="sxs-lookup"><span data-stu-id="a030a-686">Fix issue where version 10.0.3 of Newtonsoft.Json wasn't being loaded on module import</span></span>

#### <a name="azurermcompute"></a><span data-ttu-id="a030a-687">AzureRM.Compute</span><span class="sxs-lookup"><span data-stu-id="a030a-687">AzureRM.Compute</span></span>
* <span data-ttu-id="a030a-688">Funzionalità di aggiornamento delle VM di set di scalabilità di macchine virtuali</span><span class="sxs-lookup"><span data-stu-id="a030a-688">VMSS VM Update feature</span></span>
    - <span data-ttu-id="a030a-689">Aggiunta dei cmdlet "Update-AzureRmVmssVM" e "New-AzureRmVMDataDisk"</span><span class="sxs-lookup"><span data-stu-id="a030a-689">Added 'Update-AzureRmVmssVM' and 'New-AzureRmVMDataDisk' cmdlets</span></span>
    - <span data-ttu-id="a030a-690">Aggiunta del parametro VirtualMachineScaleSetVM al cmdlet "Add-AzureRmVMDataDisk" per supportare l'aggiunta di un disco dati a una VM di un set di scalabilità di macchine virtuali</span><span class="sxs-lookup"><span data-stu-id="a030a-690">Add VirtualMachineScaleSetVM parameter to 'Add-AzureRmVMDataDisk' cmdlet to support adding a data disk to Vmss VM.</span></span>

#### <a name="azurermdatafactoryv2"></a><span data-ttu-id="a030a-691">AzureRM.DataFactoryV2</span><span class="sxs-lookup"><span data-stu-id="a030a-691">AzureRM.DataFactoryV2</span></span>
* <span data-ttu-id="a030a-692">Aggiornamento di ADF .Net SDK alla versione 0.8.0-preview contenente le modifiche seguenti:</span><span class="sxs-lookup"><span data-stu-id="a030a-692">Updated the ADF .Net SDK version to 0.8.0-preview containing following changes:</span></span>
    - <span data-ttu-id="a030a-693">Aggiunta dell'operazione di configurazione del repository della factory</span><span class="sxs-lookup"><span data-stu-id="a030a-693">Added Configure factory repository operation</span></span>
    - <span data-ttu-id="a030a-694">Aggiornamento del servizio collegato QuickBooks per l'esposizione delle proprietà consumerKey e consumerSecret</span><span class="sxs-lookup"><span data-stu-id="a030a-694">Updated QuickBooks LinkedService to expose consumerKey and consumerSecret properties</span></span>
    - <span data-ttu-id="a030a-695">Aggiornamento di diversi tipi di modello da SecretBase a Object</span><span class="sxs-lookup"><span data-stu-id="a030a-695">Updated Several model types from SecretBase to Object</span></span>
    - <span data-ttu-id="a030a-696">Aggiunta del trigger di eventi BLOB</span><span class="sxs-lookup"><span data-stu-id="a030a-696">Added Blob Events trigger</span></span>

### <a name="azurermkeyvault"></a><span data-ttu-id="a030a-697">AzureRM.KeyVault</span><span class="sxs-lookup"><span data-stu-id="a030a-697">AzureRM.KeyVault</span></span>
* <span data-ttu-id="a030a-698">Aggiornamento della documentazione con output di esempio</span><span class="sxs-lookup"><span data-stu-id="a030a-698">Update documentation with example output</span></span>

### <a name="azurermnetwork"></a><span data-ttu-id="a030a-699">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="a030a-699">AzureRM.Network</span></span>
* <span data-ttu-id="a030a-700">Abilitazione dei parametri di Analisi del traffico nei cmdlet di Network Watcher</span><span class="sxs-lookup"><span data-stu-id="a030a-700">Enable Traffic Analytics parameters on Network Watcher cmdlets</span></span>

#### <a name="azurermresources"></a><span data-ttu-id="a030a-701">AzureRM.Resources</span><span class="sxs-lookup"><span data-stu-id="a030a-701">AzureRM.Resources</span></span>
* <span data-ttu-id="a030a-702">Risoluzione del problema relativo alla proprietà "Properties" degli oggetti "PSResource" restituiti da "Get-AzureRmResource"</span><span class="sxs-lookup"><span data-stu-id="a030a-702">Fix issue with 'Properties' property of 'PSResource' object(s) returned from 'Get-AzureRmResource'</span></span>

#### <a name="azurermscheduler"></a><span data-ttu-id="a030a-703">AzureRM.Scheduler</span><span class="sxs-lookup"><span data-stu-id="a030a-703">AzureRM.Scheduler</span></span>
* <span data-ttu-id="a030a-704">Risoluzione del problema relativo alla mancata impostazione dei nuovi valori di autenticazione con l'aggiornamento di ServiceBusQueueJob</span><span class="sxs-lookup"><span data-stu-id="a030a-704">Fix issue with update ServiceBusQueueJob not setting new Auth values</span></span>

### <a name="azurermsql"></a><span data-ttu-id="a030a-705">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="a030a-705">AzureRM.Sql</span></span>
* <span data-ttu-id="a030a-706">Aggiornamento dei cmdlet seguenti con il parametro LicenseType facoltativo</span><span class="sxs-lookup"><span data-stu-id="a030a-706">Updated the following cmdlets with optional LicenseType parameter</span></span>
    - <span data-ttu-id="a030a-707">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="a030a-707">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="a030a-708">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="a030a-708">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="a030a-709">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="a030a-709">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="a030a-710">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="a030a-710">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="a030a-711">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="a030a-711">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermwebsites"></a><span data-ttu-id="a030a-712">AzureRM.Websites</span><span class="sxs-lookup"><span data-stu-id="a030a-712">AzureRM.Websites</span></span>
* <span data-ttu-id="a030a-713">Aggiornamento di "New-AzureRMWebApp" per l'uso di algoritmi comuni della libreria Strategy</span><span class="sxs-lookup"><span data-stu-id="a030a-713">'New-AzureRMWebApp' is updated to use common algorithms from the Strategy library.</span></span>

## <a name="610---may-2018"></a><span data-ttu-id="a030a-714">6.1.0 - Maggio 2018</span><span class="sxs-lookup"><span data-stu-id="a030a-714">6.1.0 - May 2018</span></span>
#### <a name="azurermprofile"></a><span data-ttu-id="a030a-715">AzureRM.Profile</span><span class="sxs-lookup"><span data-stu-id="a030a-715">AzureRM.Profile</span></span>
* <span data-ttu-id="a030a-716">Risoluzione del problema relativo all'esecuzione di 'Clear-AzureRmContext' che mantiene un contesto vuoto con il nome del contesto predefinito precedente, impedendo all'utente di creare un nuovo contesto con il nome precedente</span><span class="sxs-lookup"><span data-stu-id="a030a-716">Fix issue where running 'Clear-AzureRmContext' would keep an empty context with the name of the previous default context, which prevented the user from creating a new context with the old name</span></span>

#### <a name="azurermanalysisservices"></a><span data-ttu-id="a030a-717">AzureRM.AnalysisServices</span><span class="sxs-lookup"><span data-stu-id="a030a-717">AzureRM.AnalysisServices</span></span>
* <span data-ttu-id="a030a-718">Abilitazione delle operazioni di associazione/disassociazione del gateway in Analysis Services.</span><span class="sxs-lookup"><span data-stu-id="a030a-718">Enable Gateway assocaite/disassociate operations on AS.</span></span>

#### <a name="azurermapimanagement"></a><span data-ttu-id="a030a-719">AzureRM.ApiManagement</span><span class="sxs-lookup"><span data-stu-id="a030a-719">AzureRM.ApiManagement</span></span>
* <span data-ttu-id="a030a-720">Aggiunta di supporto per ApiVersions, ApiReleases e ApiRevisions</span><span class="sxs-lookup"><span data-stu-id="a030a-720">Added support for ApiVersions, ApiReleases and ApiRevisions</span></span>
* <span data-ttu-id="a030a-721">Aggiunta di supporto per il back-end di Service Fabric</span><span class="sxs-lookup"><span data-stu-id="a030a-721">Added suppport for ServiceFabric Backend</span></span>
* <span data-ttu-id="a030a-722">Aggiunta di supporto per il logger di Application Insights</span><span class="sxs-lookup"><span data-stu-id="a030a-722">Added support for Application Insights Logger</span></span>
* <span data-ttu-id="a030a-723">Aggiunta di supporto per il riconoscimento dello SKU 'Basic' come SKU valido del servizio Gestione API</span><span class="sxs-lookup"><span data-stu-id="a030a-723">Added support for recognizing 'Basic' sku as a valid sku of Api Management service</span></span>
* <span data-ttu-id="a030a-724">Aggiunta di supporto per l'installazione di certificati rilasciati da un'autorità di certificazione privata come radice o CA</span><span class="sxs-lookup"><span data-stu-id="a030a-724">Added support for installing Certificates issued by private CA as Root or CA</span></span>
* <span data-ttu-id="a030a-725">Aggiunta di supporto per l'accettazione di certificati SSL personalizzati tramite KeyVault e più nomi host proxy</span><span class="sxs-lookup"><span data-stu-id="a030a-725">Added support for accepting Custom SSL certificates via KeyVault and Multiple proxy hostnames</span></span>
* <span data-ttu-id="a030a-726">Aggiunta di supporto per identità di MSI</span><span class="sxs-lookup"><span data-stu-id="a030a-726">Added support for MSI identity</span></span>
* <span data-ttu-id="a030a-727">Aggiunta di supporto per l'accettazione di criteri tramite URL. NOTA: i cmdlet seguenti verranno deprecati nelle versioni future</span><span class="sxs-lookup"><span data-stu-id="a030a-727">Added support for accepting Policies via Url NOTE: The following cmdlets will be deprecated in future release</span></span>
   - <span data-ttu-id="a030a-728">Import-AzureRmApiManagementHostnameCertificate</span><span class="sxs-lookup"><span data-stu-id="a030a-728">Import-AzureRmApiManagementHostnameCertificate</span></span>
   - <span data-ttu-id="a030a-729">New-AzureRmApiManagementHostnameConfiguration</span><span class="sxs-lookup"><span data-stu-id="a030a-729">New-AzureRmApiManagementHostnameConfiguration</span></span>
   - <span data-ttu-id="a030a-730">Set-AzureRmApiManagementHostnames</span><span class="sxs-lookup"><span data-stu-id="a030a-730">Set-AzureRmApiManagementHostnames</span></span>
   - <span data-ttu-id="a030a-731">Update-AzureRmApiManagementDeployment</span><span class="sxs-lookup"><span data-stu-id="a030a-731">Update-AzureRmApiManagementDeployment</span></span>

#### <a name="azurermbatch"></a><span data-ttu-id="a030a-732">AzureRM.Batch</span><span class="sxs-lookup"><span data-stu-id="a030a-732">AzureRM.Batch</span></span>
* <span data-ttu-id="a030a-733">Rilascio del nuovo cmdlet Get-AzureBatchPoolNodeCounts</span><span class="sxs-lookup"><span data-stu-id="a030a-733">Release new cmdlet Get-AzureBatchPoolNodeCounts</span></span>
* <span data-ttu-id="a030a-734">Rilascio del nuovo cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span><span class="sxs-lookup"><span data-stu-id="a030a-734">Release new cmdlet Start-AzureBatchComputeNodeServiceLogUpload</span></span>

#### <a name="azurermconsumption"></a><span data-ttu-id="a030a-735">AzureRM.Consumption</span><span class="sxs-lookup"><span data-stu-id="a030a-735">AzureRM.Consumption</span></span>
* <span data-ttu-id="a030a-736">Aggiunta di nuovi parametri Expand, ResourceGroup, InstanceName, InstanceId, Tags e Top nel cmdlet Get-AzureRmConsumptionUsageDetail</span><span class="sxs-lookup"><span data-stu-id="a030a-736">Add new parameters Expand, ResourceGroup, InstanceName, InstanceId, Tags, and Top on Cmdlet Get-AzureRmConsumptionUsageDetail</span></span>

#### <a name="azurermdatalakestore"></a><span data-ttu-id="a030a-737">AzureRM.DataLakeStore</span><span class="sxs-lookup"><span data-stu-id="a030a-737">AzureRM.DataLakeStore</span></span>
* <span data-ttu-id="a030a-738">Correzione dell'esempio per Export-AzureRmDataLakeStoreChildItemProperties</span><span class="sxs-lookup"><span data-stu-id="a030a-738">Fix example for Export-AzureRmDataLakeStoreChildItemProperties</span></span>
* <span data-ttu-id="a030a-739">Correzione dell'eccezione del parametro Null in caso di ricorsione in Set-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="a030a-739">Fix null parameter exception for Recurse case in Set-AzureRmDataLakeStoreItemAclEntry</span></span> 
* <span data-ttu-id="a030a-740">Correzione dei file della Guida per Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span><span class="sxs-lookup"><span data-stu-id="a030a-740">Fix the help files for Set-AzureRmDataLakeStoreItemAclEntry, Set-AzureRmDataLakeStoreItemAcl, Remove-AzureRmDataLakeStoreItemAclEntry</span></span> 

#### <a name="azurermnetwork"></a><span data-ttu-id="a030a-741">AzureRM.Network</span><span class="sxs-lookup"><span data-stu-id="a030a-741">AzureRM.Network</span></span>
* <span data-ttu-id="a030a-742">Incremento della versione di Network SDK da 18.0.0-preview a 19.0.0-preview</span><span class="sxs-lookup"><span data-stu-id="a030a-742">Bump up Network SDK version from 18.0.0-preview to 19.0.0-preview</span></span>
* <span data-ttu-id="a030a-743">Aggiunta di un cmdlet per la creazione della configurazione del protocollo</span><span class="sxs-lookup"><span data-stu-id="a030a-743">Added cmdlet to create protocol configuration</span></span>
    - <span data-ttu-id="a030a-744">New-AzureRmNetworkWatcherProtocolConfiguration</span><span class="sxs-lookup"><span data-stu-id="a030a-744">New-AzureRmNetworkWatcherProtocolConfiguration</span></span>
* <span data-ttu-id="a030a-745">Aggiunta di un cmdlet per aggiungere una nuova connessione a circuito a un circuito di ExpressRoute esistente.</span><span class="sxs-lookup"><span data-stu-id="a030a-745">Added cmdlet to add a new circuit connection to an existing express route circuit.</span></span>
    - <span data-ttu-id="a030a-746">Add-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="a030a-746">Add-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="a030a-747">Aggiunta di un cmdlet per la rimozione di una connessione a circuito da un circuito di ExpressRoute esistente.</span><span class="sxs-lookup"><span data-stu-id="a030a-747">Added cmdlet to remove a circuit connection from an existing express route circuit.</span></span>
    - <span data-ttu-id="a030a-748">Remove-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="a030a-748">Remove-AzureRmExpressRouteCircuitConnectionConfig</span></span>
* <span data-ttu-id="a030a-749">Aggiunta di un cmdlet per il recupero di una connessione a circuito</span><span class="sxs-lookup"><span data-stu-id="a030a-749">Added cmdlet to retrieve a circuit connection</span></span>
    - <span data-ttu-id="a030a-750">Get-AzureRmExpressRouteCircuitConnectionConfig</span><span class="sxs-lookup"><span data-stu-id="a030a-750">Get-AzureRmExpressRouteCircuitConnectionConfig</span></span>

#### <a name="azurermservicefabric"></a><span data-ttu-id="a030a-751">AzureRM.ServiceFabric</span><span class="sxs-lookup"><span data-stu-id="a030a-751">AzureRM.ServiceFabric</span></span>
* <span data-ttu-id="a030a-752">Correzione dell'utilizzo dell'autenticazione del server con certificati generati (problema #5998)</span><span class="sxs-lookup"><span data-stu-id="a030a-752">Fixed server authentication usage with generated certificates (Issue #5998)</span></span>

#### <a name="azurermsql"></a><span data-ttu-id="a030a-753">AzureRM.Sql</span><span class="sxs-lookup"><span data-stu-id="a030a-753">AzureRM.Sql</span></span>
* <span data-ttu-id="a030a-754">Aggiornamento dei cmdlet di controllo per consentire la rimozione di AuditActions o AuditActionGroups</span><span class="sxs-lookup"><span data-stu-id="a030a-754">Updated Auditing cmdlets to allow removing AuditActions or AuditActionGroups</span></span>
* <span data-ttu-id="a030a-755">Correzione del problema relativo a Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy durante l'impostazione di un nuovo criterio di conservazione flessibile che provocava l'errore del comando con un messaggio analogo al seguente: 'La configurazione dei criteri di conservazione a lungo termine con l'insieme di credenziali del servizio di ripristino di Azure e i criteri non è più supportata.</span><span class="sxs-lookup"><span data-stu-id="a030a-755">Fixed issue with Set-AzureRmSqlDatabaseBackupLongTermRetentionPolicy when setting a new flexible retention policy where the command would fail with 'Configure long term retention policy with azure recovery service vault and policy is no longer supported.</span></span> <span data-ttu-id="a030a-756">Inviare la richiesta con i nuovi criteri di conservazione flessibili'.</span><span class="sxs-lookup"><span data-stu-id="a030a-756">Please submit request with the new flexible retention policy'.</span></span>
* <span data-ttu-id="a030a-757">Aggiornamento di tutti i cmdlet correlati a database SQL di Azure/creazione di pool elastici/aggiornamento in modo che venga usata la nuova API del database che supporta la proprietà SKU per il ridimensionamento e le proprietà correlate ai livelli.</span><span class="sxs-lookup"><span data-stu-id="a030a-757">Update all Azure Sql Database/ElasticPool Creation/Update related cmdlets to use the new Database API, which support Sku property for scale and tier-related properties.</span></span>
* <span data-ttu-id="a030a-758">I cmdlet aggiornati includono:</span><span class="sxs-lookup"><span data-stu-id="a030a-758">The updated cmdlets including:</span></span> 
    - <span data-ttu-id="a030a-759">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="a030a-759">New-AzureRmSqlDatabase; Set-AzureRmSqlDatabase</span></span>
    - <span data-ttu-id="a030a-760">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span><span class="sxs-lookup"><span data-stu-id="a030a-760">New-AzureRmSqlElasticPool; Set-AzureRmSqlElasticPool</span></span>
    - <span data-ttu-id="a030a-761">New-AzureRmSqlDatabaseCopy</span><span class="sxs-lookup"><span data-stu-id="a030a-761">New-AzureRmSqlDatabaseCopy</span></span>
    - <span data-ttu-id="a030a-762">New-AzureRmSqlDatabaseSecondary</span><span class="sxs-lookup"><span data-stu-id="a030a-762">New-AzureRmSqlDatabaseSecondary</span></span>
    - <span data-ttu-id="a030a-763">Restore-AzureRmSqlDatabase</span><span class="sxs-lookup"><span data-stu-id="a030a-763">Restore-AzureRmSqlDatabase</span></span>

#### <a name="azurermtrafficmanager"></a><span data-ttu-id="a030a-764">AzureRM.TrafficManager</span><span class="sxs-lookup"><span data-stu-id="a030a-764">AzureRM.TrafficManager</span></span>
* <span data-ttu-id="a030a-765">Aggiornamento dei parametri per 'Get-AzureRmTrafficManagerProfile' in modo che il parametro -ResourceGroupName sia necessario quando si usa il parametro -Name.</span><span class="sxs-lookup"><span data-stu-id="a030a-765">Update the parameters for 'Get-AzureRmTrafficManagerProfile' so that -ResourceGroupName parameter is required when using -Name parameter.</span></span>
