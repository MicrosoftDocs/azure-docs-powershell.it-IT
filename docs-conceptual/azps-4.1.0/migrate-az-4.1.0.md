...
Il cmdlet `Get-AzApiManagementProperty` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.

### `New-AzApiManagementProperty`

Il cmdlet `New-AzApiManagementProperty` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.

### `Remove-AzApiManagementProperty`

Il cmdlet `Remove-AzApiManagementProperty` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.

### `Set-AzApiManagementProperty`

Il cmdlet `Set-AzApiManagementProperty` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.
...
Il cmdlet `Get-AzOperationalInsightsSavedSearchResult` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.

### `Get-AzOperationalInsightsSearchResult`

Il cmdlet `Get-AzOperationalInsightsSearchResult` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.
...
Il cmdlet `Get-AzOperationalInsightsLinkTarget` è stato rimosso e non è stato trovato alcun alias per il nome del cmdlet originale.
