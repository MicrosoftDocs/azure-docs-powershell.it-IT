...
1. Eseguire l'aggiornamento a [Windows PowerShell 5.1](/powershell/scripting/install/installing-windows-powershell#upgrading-existing-windows-powershell).
...
Per impostazione predefinita, PowerShell Gallery non è configurato come archivio attendibile per PowerShellGet e viene visualizzato il seguente messaggio:
