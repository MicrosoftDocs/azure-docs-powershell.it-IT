...
L'alias `Get-AzSqlDatabaseIndexRecommendations` è stato rimosso. Usare invece `Get-AzSqlDatabaseIndexRecommendation`.

### `Get-AzSqlDatabaseRestorePoints`
L'alias `Get-AzSqlDatabaseRestorePoints` è stato rimosso. Usare invece `Get-AzSqlDatabaseRestorePoint`.
