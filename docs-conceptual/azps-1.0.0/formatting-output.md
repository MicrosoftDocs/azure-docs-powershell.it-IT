...
In questo esempio si ottiene un elenco delle VM di Azure nella sottoscrizione predefinita.  Per impostazione predefinita, il comando `Get-AzVM` genera l'output in formato tabella.
