...
Azure PowerShell è compatibile con PowerShell 5.x in Windows 7 o versioni superiori oppure con PowerShell 6.x in qualsiasi piattaforma.
...
Se si usa PowerShell 5.x in Windows, è necessario che sia installato anche .NET Framework 4.7.2. Per istruzioni su come aggiornare o installare una nuova versione di .NET Framework, vedere la [Guida all'installazione di .NET Framework](/dotnet/framework/install).
