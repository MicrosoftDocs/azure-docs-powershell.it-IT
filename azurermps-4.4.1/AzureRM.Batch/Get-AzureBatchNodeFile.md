...
## Descrizione
Il cmdlet **Get-AzureBatchNodeFile** ottiene le proprietà dei file di nodo batch di Azure di un'attività o di un nodo COMPUTE.
...
### -Nome
Specifica il nome del file di nodo per cui questo cmdlet recupera le proprietà.
...
Per ottenere un oggetto Task, usare il cmdlet Get-AzureBatchTask.
