...
## Descrizione
Il cmdlet **set-AzureRmBatchApplication** modifica le impostazioni per l'applicazione batch Azure specificata.
...
Questo comando cambia se l'applicazione Llitware nell'account ContosoBatch consente gli aggiornamenti.
