...
## Descrizione
Il cmdlet **Remove-AzureRmServiceBusNamespaceAuthorizationRule** rimuove la regola di autorizzazione di uno spazio dei nomi Service Bus per il gruppo di risorse specificato.
...
### -Nome
Nome AuthorizationRule dello spazio dei nomi.
