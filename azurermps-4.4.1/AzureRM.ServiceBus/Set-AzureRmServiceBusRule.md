...
## Descrizione
Il cmdlet **set-AzureRmServiceBusRule** aggiorna la descrizione per la regola specificata dell'abbonamento specificato.
...
Aggiorna la SqlExpression **mysqlexpression =' condition '** della regola `SBEule` della sottoscrizione `SBSubscription` in argomento `SBTopic`
...
### -InputObject
Definizione regole di ServiceBus.
