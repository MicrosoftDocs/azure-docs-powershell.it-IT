...
## Descrizione
Il cmdlet **New-AzureRmServiceBusQueueAuthorizationRule** crea una nuova regola di autorizzazione per la coda di Service Bus specificata.
...
Crea una regola `SBAuthoRule1` di autorizzazione con i diritti di **ascolto e invio** per la coda `SB-Queue_exampl1` .
...
### -Diritti
Specifica i diritti; Per esempio  
@ ("Ascolta", "Invia", "Gestisci")
