...
## Descrizione
Il cmdlet **Remove-AzureRmServiceBusQueueAuthorizationRule** rimuove la regola di autorizzazione di una coda dallo spazio dei nomi Service Bus specificato.
...
Rimuove la regola `SBAuthoRule1` di autorizzazione della coda `SB-Queue_exampl1` dallo spazio dei nomi `SB-Example1` .
