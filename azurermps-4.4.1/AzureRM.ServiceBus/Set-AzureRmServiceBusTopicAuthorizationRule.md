...
## Descrizione
Il cmdlet **set-AzureRmServiceBusTopicAuthorizationRule** aggiorna la descrizione per la regola di autorizzazione specificata dell'argomento Service Bus specificato.
...
Aggiunge **Manage** ai diritti di accesso della regola di autorizzazione `SBTopicAuthoRule1` in argomento `SB-Topic_exampl1` .
...
### -Diritti
Diritti ad esempio, @ ("Listen", "Send", "Manage"). Obbligatorio se non è specificato **-AuthruleObj** .
...
### -Nome
AuthorizationRule nome-obbligatorio se ' AuthruleObj ' non specificato.
