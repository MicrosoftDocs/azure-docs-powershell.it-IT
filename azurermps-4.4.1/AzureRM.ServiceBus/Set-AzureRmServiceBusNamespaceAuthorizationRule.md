...
## Descrizione
Il cmdlet **set-AzureRmServiceBusNamespaceAuthorizationRule** aggiorna la descrizione della regola di autorizzazione specificata nello spazio dei nomi di Service Bus specificato.
...
### -Diritti
Diritti ad esempio @ ("Listen", "Send", "Manage"). Obbligatorio se **AuthruleObj** non è specificato.
...
### -InputObj
Oggetto AuthorizationRule dello spazio dei nomi ServiceBus.
