...
## Descrizione
Il cmdlet **set-AzureRmSchedulerServiceBusTopicJob** modifica un processo di argomento di Service Bus in Azure Scheduler.
...
### -ServiceBusMessage
Specifica un messaggio di argomento Service Bus.
...
### -ServiceBusTopicPath
Specifica il percorso di un argomento di Service Bus.
