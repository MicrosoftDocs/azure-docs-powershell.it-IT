...
## Descrizione
Il cmdlet **set-AzureRmVirtualNetworkPeering** configura un peering di rete virtuale.
...
Il parametro ' VirtualNetworkPeering ' accetta il valore di tipo ' PSVirtualNetworkPeering ' dalla pipeline
