...
## Descrizione
Il cmdlet Test-AzureRmNetworkWatcherConnectivity restituisce le informazioni di connettività per una VM di origine specificata e una destinazione. Se non è possibile stabilire la connettività tra l'origine e la destinazione, il cmdlet restituisce i dettagli sul problema.

## ESEMPI

### ---------------Esempio 1: testare la connettività di monitoraggio di rete da una VM a un sito Web---------------
@ {Paragraph = PS C: \\ \> }
