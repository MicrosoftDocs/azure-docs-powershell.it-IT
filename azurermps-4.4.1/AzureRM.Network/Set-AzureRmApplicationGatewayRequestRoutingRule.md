...
## Descrizione
Il cmdlet **set-AzureRmApplicationGatewayRequestRoutingRule** modifica una regola di routing delle richieste.
...
Il secondo comando modifica la regola di routing delle richieste per il gateway dell'applicazione per l'uso delle impostazioni HTTP di back-end specificate nella variabile $Setting, un listener HTTP specificato nella variabile $Listener e un pool di indirizzi back-end specificato nella variabile $Pool.

## PARAMETRI

### -ApplicationGateway
Specifica l'oggetto gateway dell'applicazione con cui questo cmdlet associa una regola di routing delle richieste.
...
### -BackendAddressPool
Specifica il pool di indirizzi back-end del gateway applicazione.
...
Specifica l'ID del pool di indirizzi back-end del gateway applicazione.
...
### -BackendHttpSettings
Specifica le impostazioni HTTP di backend del gateway applicazione.
...
Specifica l'ID delle impostazioni HTTP di back-end del gateway applicazione.
...
### -HttpListener
Specifica il listener HTTP del gateway dell'applicazione.
...
### -HttpListenerId
Specifica l'ID del listener HTTP gateway dell'applicazione.
...
### -Nome
Specifica il nome della regola di routing delle richieste modificata da questo cmdlet.
