...
## Descrizione
Il cmdlet **Update-AzureRmContainerRegistryCredential** rigenera una credenziale di accesso per un registro dei contenitori.
...
Questo comando rigenera una credenziale di accesso per il registro di sistema contenitore specificato. L'utente di amministratore deve essere abilitato per il registro `MyRegistry` di sistema contenitore per rigenerare le credenziali di accesso.
