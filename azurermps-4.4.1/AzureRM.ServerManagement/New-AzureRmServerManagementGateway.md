...
## Descrizione
Il cmdlet **New-AzureRmServerManagementGateway** crea un gateway di gestione di Azure server.
...
### -Autoupgrade
Indica che il gateway si aggiornerà automaticamente quando viene rilasciata una nuova versione.
...
### -GatewayName
Specifica il nome del gateway creato da questo cmdlet.
...
### -Posizione
Specifica la posizione in cui creare il gateway.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse in cui questo cmdlet crea il gateway.
...
Puoi usare i tag per identificare un gateway da altre risorse di Azure.
