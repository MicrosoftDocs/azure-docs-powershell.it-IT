...
Accettare o rifiutare le condizioni legali per un ID autore specifico (Publisher), ID offerta (prodotto) e ID piano (nome). Usare Get-AzureRmMarketplaceTerms per ottenere le condizioni per il contratto.
