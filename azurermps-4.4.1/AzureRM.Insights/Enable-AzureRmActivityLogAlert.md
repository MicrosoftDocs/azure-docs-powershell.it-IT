...
### Parametri predefiniti per l'attivazione di un avviso del log attività
```
Enable-AzureRmActivityLogAlert -Name <String> -ResourceGroupName <String>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parametri per abilitare gli avvisi del log attività che prendono valore dalla pipe
```
Enable-AzureRmActivityLogAlert -InputObject <PSActivityLogAlertResource>
 [-DefaultProfile <IAzureContextContainer>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

### Parametri per abilitare gli avvisi del log attività che impiegano il valore di ResourceId dalla pipe
```
