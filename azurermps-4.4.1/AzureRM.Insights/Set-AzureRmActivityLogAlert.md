...
### Parametri predefiniti per l'avviso imposta log attività
```
...
### Parametri per impostare gli avvisi del log attività che impiegano il valore di ResourceId dalla pipe
```
...
### Parametri per impostare gli avvisi del log attività che prendono valore dalla pipe
```
...
## Descrizione
Il cmdlet **set-AzureRmActivityLogAlert** crea un nuovo o imposta un avviso del log attività esistente.
