...
### Parametri per New-AzureRmAutoscaleProfile cmdlet senza orari pianificati
```
...
### Parametri per New-AzureRmAutoscaleProfile cmdlet tramite la pianificazione della data di correzione
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
### Parametri per New-AzureRmAutoscaleProfile cmdlet tramite la programmazione ricorrente
```
New-AzureRmAutoscaleProfile -Name <String> -DefaultCapacity <String> -MaximumCapacity <String>
...
## Descrizione
Il cmdlet **New-AzureRmAutoscaleProfile** crea un profilo di scalabilità verticale.
...
Non tutti questi valori sono supportati.
