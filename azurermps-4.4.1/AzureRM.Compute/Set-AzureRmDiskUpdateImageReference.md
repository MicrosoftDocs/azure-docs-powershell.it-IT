...
## Descrizione
Il cmdlet **set-AzureRmDiskUpdateImageReference** imposta le proprietà di riferimento dell'immagine in un oggetto di aggiornamento del disco.
...
Il primo comando crea un oggetto di aggiornamento del disco locale con dimensioni 10GB in Premium_LRS tipo di account di archiviazione.  Imposta anche il tipo di sistema operativo Windows.
Il secondo comando imposta l'ID immagine e l'unità logica numero 0 per l'oggetto di aggiornamento del disco.
