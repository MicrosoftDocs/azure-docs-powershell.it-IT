...
## Descrizione
Il cmdlet **set-AzureRmVMAccessExtension** aggiunge l'estensione della macchina virtuale VMAccess (Virtual Machine Access) a una macchina virtuale.
VMAccess può reimpostare il nome utente e la password della macchina virtuale.
