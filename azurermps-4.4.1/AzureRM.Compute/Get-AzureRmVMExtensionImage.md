...
## Descrizione
Il cmdlet **Get-AzureRmVMExtensionImage** ottiene tutte le versioni per un'estensione di Azure.
...
Per ottenere un tipo di estensione, usare il cmdlet Get-AzureRmVMExtensionImageType.
