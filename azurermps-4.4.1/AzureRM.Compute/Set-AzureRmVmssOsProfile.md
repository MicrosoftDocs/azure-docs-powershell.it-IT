...
## Descrizione
Il cmdlet **set-AzureRmVmssOsProfile** imposta la scala della macchina virtuale imposta le proprietà del profilo del sistema operativo.
...
Puoi usare la Add-AzureRmVMAdditionalUnattendContent per creare l'oggetto.
...
### -AdminUsername
Specifica il nome dell'account di amministratore da usare per tutte le istanze della macchina virtuale in VMSS.
...
Puoi usare il cmdlet Add-AzureRmVmssWinRMListener per creare il listener.
...
Puoi usare il cmdlet Add-AzureRmVMSshPublicKey per creare l'oggetto.
...
Puoi usare il cmdlet Add-AzureRmVmssSecret per creare l'oggetto Secrets.
