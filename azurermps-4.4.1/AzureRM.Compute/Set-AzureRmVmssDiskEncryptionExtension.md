...
## Descrizione
Il cmdlet **set-AzureRmVmssDiskEncryptionExtension** Abilita la crittografia su un set di proporzioni VM.
Questo cmdlet consente la crittografia installando l'estensione di crittografia disco nel set di proporzioni VM.
...
Questo comando consente la crittografia in tutti i dischi di tutte le VM nel set di scale VM.
