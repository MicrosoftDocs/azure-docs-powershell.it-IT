...
## Descrizione
Il cmdlet **set-AzureRmVMOperatingSystem** imposta le proprietà del sistema operativo per una macchina virtuale.
...
Poiché puoi specificare queste stringhe direttamente nel comando **set-AzureRmVMOperatingSystem** , questo approccio viene usato solo per la leggibilità.
...
Creare un oggetto macchina virtuale usando il cmdlet New-AzureRmVMConfig.
