...
### Esempio 3: creare un nuovo cluster usando un modello personalizzato. Specificare il nome RG diverso per il Vault chiave e far caricare al sistema il certificato
```
...
Questo comando crea un nuovo cluster usando un modello personalizzato. Specificare il nome RG diverso per il Vault chiave e far caricare il certificato dal sistema.
