...
## Descrizione
Il cmdlet **Get-AzureRmSiteRecoveryProtectionContainer** ottiene i contenitori di protezione per il Vault di ripristino del sito Azure corrente.
...
### -FriendlyName
Specifica il nome descrittivo del contenitore di protezione.
...
### -Nome
Specifica il nome del contenitore di protezione.
