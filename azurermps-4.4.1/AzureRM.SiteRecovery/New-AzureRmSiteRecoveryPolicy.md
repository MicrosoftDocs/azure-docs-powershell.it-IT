...
## Descrizione
Il cmdlet **New-AzureRmSiteRecoveryPolicy** crea un criterio di replica del ripristino di Azure site.
...
Specifica la frequenza dello snapshot coerente dell'applicazione in ore.
...
### -Nome
Specifica un nome descrittivo che identifica i criteri di replica del ripristino del sito.
...
Specifica l'ID dell'account di archiviazione di Azure della destinazione di replica.
...
### -RecoveryPoints
Specifica il numero di ore per mantenere i punti di ripristino.
...
### -ReplicationProvider
Specifica il provider di replica.
I valori validi sono:
