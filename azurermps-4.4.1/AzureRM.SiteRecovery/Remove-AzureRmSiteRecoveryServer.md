...
## Descrizione
Il cmdlet **Remove-AzureRmSiteRecoveryServer** Annulla la registrazione di un server di ripristino del sito di Azure che lo rimuove dalla volta corrente.
...
### -Server
Specifica l'oggetto server di ripristino del sito.
