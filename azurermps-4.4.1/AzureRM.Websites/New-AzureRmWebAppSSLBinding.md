...
### Esempio 2: caricare un certificato e associarlo a un'app Web
```
...
L'esempio 2 associa anche il certificato E3A38EBA60CAA1C162785A2E1C44A15AD450199C3 all'app Web denominata ContosoWebApp.
In questo caso, tuttavia, il certificato non è stato ancora caricato in Azure.
Per questo motivo, il parametro *CertificateFilePath* viene usato per specificare la copia locale del certificato. File PFX.
Questo certificato verrà caricato in Azure e verranno creati i nuovi binding SSL.
