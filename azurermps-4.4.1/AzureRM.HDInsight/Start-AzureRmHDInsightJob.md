...
## Descrizione
Il cmdlet **Start-AzureRMHDInsightJob** avvia un processo di Azure HDInsight definito in un cluster specificato.
Può trattarsi di un processo MapReduce, di un processo di MapReduce in streaming, di un processo hive o di un processo di maiale.

## ESEMPI

### Esempio 1: avviare un processo nel cluster specificato
```
PS C:\># Cluster info
...
Questo comando avvia un processo nel cluster denominato your-Hadoop-001.
...
### -JobDefinition
Specifica il processo da avviare nel cluster di Azure HDInsight.
...
Il parametro ' JobDefinition ' accetta il valore di tipo ' AzureHDInsightJobDefinition ' dalla pipeline
