...
## Descrizione
Il cmdlet Add-AzureRmHDInsightComponentVersion aggiunge una versione per un servizio in esecuzione in un cluster all'oggetto di configurazione di Azure HDInsight creato dal cmdlet New-AzureRmHDInsightClusterConfig.

## ESEMPI

### --------------------------Esempio 1: aggiungere una versione per Spark all'oggetto di configurazione del cluster.  --------------------------
@ {Paragraph = PS C: \\ \> }
...
Questo comando aggiunge la versione di Spark al cluster HDInsight denominato "Your-Spark-001".
