...
## Descrizione
Il cmdlet **New-AzureRmOperationalInsightsSavedSearch** crea una nuova ricerca salvata con i parametri specificati per l'area di lavoro.
...
### -Tag
Specifica i tag delle risorse per la ricerca salvata.
