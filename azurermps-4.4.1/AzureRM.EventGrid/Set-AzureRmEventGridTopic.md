...
## Sinossi
Impostare le proprietà di un argomento griglia eventi.
...
## Descrizione
Impostare le proprietà di un argomento griglia eventi. Questa operazione può essere usata per sostituire i tag di un argomento della griglia di eventi.
