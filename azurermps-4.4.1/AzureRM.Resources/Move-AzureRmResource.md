...
## Descrizione
Il cmdlet **Move-AzureRmResource** sposta le risorse esistenti in un gruppo di risorse diverso.
...
Con il primo comando viene ottenuta una risorsa denominata ContosoStorageAccount tramite il cmdlet Get-AzureRmResource e la risorsa viene archiviata nella variabile $Resource.
...
### Stringa []
Il parametro ' ResourceId ' accetta il valore di tipo ' String []' dalla pipeline
