...
### Un blocco, per ID. (impostazione predefinita)
```
...
### Un blocco nell'ambito del gruppo di risorse.
```
...
### Un blocco nell'ambito delle risorse del gruppo di risorse.
```
...
### Un blocco nell'ambito specificato.
```
...
### Un blocco nell'ambito dell'abbonamento.
```
...
### Un blocco nell'ambito delle risorse dell'abbonamento.
```
Remove-AzureRmResourceLock -LockName <String> [-Force] -ResourceName <String> -ResourceType <String>
...
### Un blocco nell'ambito delle risorse del tenant.
```
Remove-AzureRmResourceLock -LockName <String> [-Force] -ResourceName <String> -ResourceType <String>
...
## Descrizione
Il cmdlet **Remove-AzureRmResourceLock** rimuove un blocco di risorse Azure.
