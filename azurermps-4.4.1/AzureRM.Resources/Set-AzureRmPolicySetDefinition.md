...
### Set di parametri del nome della definizione del set di criteri. Predefinita
```
...
## Descrizione
Il cmdlet **set-AzureRmPolicySetDefinition** modifica una definizione di criteri.
...
Il primo comando ottiene una definizione di set di criteri usando il cmdlet Get-AzureRmPolicySetDefinition.
