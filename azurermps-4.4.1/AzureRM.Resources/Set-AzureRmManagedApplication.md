...
### Set di parametri del nome dell'applicazione gestita. Predefinita
```
...
### Set di parametri ID applicazione gestita.
```
...
## Descrizione
Il cmdlet **set-AzureRmManagedApplication** aggiorna le applicazioni gestite
...
### -Tipo
Tipo di applicazione gestita.
Uno di Marketplace o servicecatalog
...
### Parametro-
Stringa formattata JSON di parametri per l'applicazione gestita.
Può trattarsi di un percorso di un nome file o di un URI che contiene i parametri oppure i parametri come stringa.
...
### -Piano
Tabella hash che rappresenta le proprietà del piano applicazione gestite.
...
### -ID
ID applicazione gestita completo, incluso l'abbonamento. ad esempio/subscriptions/{subscriptionId}/resourcegroups/{resourceGroupName}
