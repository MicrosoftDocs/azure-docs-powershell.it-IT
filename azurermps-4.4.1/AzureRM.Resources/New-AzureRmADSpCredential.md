...
Una nuova credenziale password viene aggiunta a un'entità di servizio esistente.
In questo esempio, il valore della password fornito viene aggiunto all'entità servizio tramite il parametro objectId.
...
Una nuova credenziale chiave viene aggiunta a un'entità di servizio esistente.
In questo esempio, il certificato X509 pubblico con codifica Base64 ("MyApp. cer") viene aggiunto all'entità del servizio usando il relativo nome SPN.
