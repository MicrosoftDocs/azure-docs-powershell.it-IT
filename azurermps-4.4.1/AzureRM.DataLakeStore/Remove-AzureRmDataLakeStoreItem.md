...
## Descrizione
Il cmdlet **Remove-AzureRmDataLakeStoreItem** Elimina un file o una cartella in data Lake Store.

## ESEMPI

### Esempio 1: rimuovere più elementi
```
...
### -Pulisci
Indica che questa operazione rimuove tutto il contenuto della cartella di destinazione e mantiene la cartella.
Usa questo parametro con il parametro *recurse* .
...
### -Percorsi
Specifica una matrice di percorsi di archiviazione dei dati del lago per i file da rimuovere, a partire dalla directory radice (/).
...
A meno che non specifichi il parametro *Clean* , viene eliminata anche la cartella di destinazione.
...
### bool
Se PassThru è specificato, restituisce il risultato dell'operazione.
