...
## Descrizione
Il cmdlet **set-AzureRmDataLakeStoreFirewallRule** modifica la regola del firewall specificata nello Store Data Lake.
...
Dettagli della regola del firewall aggiornata.
