...
### Rimuovere le voci ACL usando l'oggetto ACL (impostazione predefinita)
```
...
Il parametro "ACL" accetta il valore di tipo "DataLakeStoreItemAce []" dalla pipeline

## OUTPUT

### bool
Se PassThru è specificato, restituisce vero al completamento corretto.
