...
## Descrizione
Il cmdlet **set-AzureRmDataLakeStoreItemOwner** modifica il proprietario di un file o di una cartella in data Lake Store.

## ESEMPI

### Esempio 1: impostare il proprietario per un elemento
```
...
### -ID
Specifica l'ID oggetto dell'utente della directory AzureActive, del gruppo o dell'entità del servizio da usare come proprietario.
...
### -PassThru
Indica che deve essere restituito il proprietario aggiornato risultante.
...
### stringa
Se PassThru è specificato, restituisce il proprietario aggiornato.
