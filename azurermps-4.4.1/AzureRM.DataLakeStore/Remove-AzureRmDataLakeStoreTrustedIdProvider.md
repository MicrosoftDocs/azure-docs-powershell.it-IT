...
## Descrizione
Il cmdlet **Remove-AzureRmDataLakeStoreTrustedIdProvider** rimuove il provider di identità attendibile specificato nell'archivio dati specificato del lago.
...
Rimuove il provider "fornitore" dall'account "ContosoADL"

## PARAMETRI

### -Account
L'account di data Lake Store per rimuovere il provider di identità attendibile da
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene l'account per cui rimuovere il provider di identità attendibile.
