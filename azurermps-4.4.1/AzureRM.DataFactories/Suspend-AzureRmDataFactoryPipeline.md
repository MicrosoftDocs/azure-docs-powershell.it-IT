...
## Descrizione
Il cmdlet **Suspend-AzureRmDataFactoryPipeline** sospende una pipeline in Azure Data Factory.
Puoi riprendere la pipeline usando il cmdlet Resume-AzureRmDataFactoryPipeline.
