...
## Descrizione
Il cmdlet **Start-AzureRmDataFactoryV2IntegrationRuntime** avvia un runtime di Integration dedicato gestito. La risorsa viene provisionata e dopo l'operazione lo stato è "iniziato".
...
Questo cmdlet avvia un runtime di integrazione dedicata gestito denominato test-Dedicated-IR.
