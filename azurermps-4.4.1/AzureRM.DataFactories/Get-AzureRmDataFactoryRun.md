...
## Descrizione
Il cmdlet **Get-AzureRmDataFactoryRun** Ottiene l'esecuzione di una sezione di dati di un DataSet in Azure Data Factory.
...
Per ottenere l'ora di inizio di una sezione, usare il cmdlet Get-AzureRmDataFactorySlice.
...
*StartDateTime* deve essere specificato nel formato ISO8601, come negli esempi seguenti: 
