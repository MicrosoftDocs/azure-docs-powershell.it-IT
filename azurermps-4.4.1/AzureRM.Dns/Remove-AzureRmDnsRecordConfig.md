...
## Descrizione
Il cmdlet **Remove-AzureRmDnsRecordConfig** rimuove un record DNS (Domain Name System) da un set di record.
...
Per rimuovere completamente un set di record, vedere Remove-AzureRmDnsRecordSet.
...
Si tratta di una rappresentazione offline del set di record e gli aggiornamenti non cambiano le risposte DNS fino a quando non si esegue set-AzureRmDnsRecordSet.
