...
## Descrizione
Il cmdlet **Get-AzureRMCdnProfile** ottiene un profilo CDN (Azure Content Delivery Network) e le relative informazioni correlate.
...
###  
Questo cmdlet restituisce un oggetto profile.
