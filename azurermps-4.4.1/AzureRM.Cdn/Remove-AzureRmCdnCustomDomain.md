...
## Descrizione
Il cmdlet **Remove-AzureRmCdnCustomDomain** rimuove il dominio personalizzato da un endpoint della rete di distribuzione del contenuto di Azure (CDN).
...
### -CdnCustomDomain
Specifica il dominio personalizzato rimosso da questo cmdlet.
...
### -CustomDomainName
Specifica il nome della risorsa del dominio personalizzato rimosso da questo cmdlet.
...
### -EndpointName
Specifica il nome dell'endpoint da cui questo cmdlet rimuove un dominio personalizzato.
...
### -ProfileName
Specifica il nome del profilo da cui questo cmdlet rimuove un dominio personalizzato.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse da cui questo cmdlet rimuove un dominio personalizzato.
...
### PSCustomDomain
Il parametro ' CdnCustomDomain ' accetta il valore di tipo ' PSCustomDomain ' dalla pipeline
