...
## Descrizione
Il cmdlet **New-AzureStorageContainerStoredAccessPolicy** crea un criterio di accesso archiviato per un contenitore di archiviazione di Azure.

## ESEMPI

### Esempio 1: creare un criterio di accesso archiviato in un contenitore di archiviazione
```
PS C:\>New-AzureStorageContainerStoredAccessPolicy -Container "MyContainer" -Policy "Policy01"
```

Questo comando crea un criterio di accesso denominato Policy01 nel contenitore di archiviazione denominato concontainer.
...
### -Autorizzazione
Specifica le autorizzazioni nei criteri di accesso archiviati per accedere al contenitore.
...
Il parametro "container" accetta il valore di tipo "String" dalla pipeline
