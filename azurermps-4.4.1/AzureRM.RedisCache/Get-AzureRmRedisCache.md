...
## Descrizione
Il cmdlet **Get-AzureRmRedisCache** ottiene la cache di Azure Redis specificata.
Se non si specificano parametri, questa operazione ottiene ogni cache di redis per l'abbonamento corrente.

## ESEMPI

### Esempio 1: ottenere una cache Redis per nome
```
...
Questo comando consente di ottenere la cache Redis denominata esisto.

### Esempio 2: ottenere ogni cache di redis in un gruppo di risorse
```
...
Questo comando consente di ottenere ogni cache di redis nel gruppo di risorse specificato.

### Esempio 3: ottenere ogni cache di redis nell'abbonamento corrente
```
...
Questo comando ottiene ogni cache di redis nell'abbonamento corrente.

## PARAMETRI

### -Nome
Specifica il nome della cache Redis da ottenere.
Usare il parametro *ResourceGroupName* .
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse che contiene la cache Redis da ottenere.

Se specifichi solo il parametro *ResourceGroupName* , questa operazione ottiene ogni cache Redis nel gruppo di risorse specificato.
...
Restituisce una matrice di oggetti **RedisCacheAttributes** .
