...
## Descrizione
Il cmdlet **New-AzureRmRedisCacheKey** rigenera il tasto di scelta di una cache di Azure Redis.
...
Questo cmdlet restituisce il tasto di scelta principale e secondario di una cache Redis.
