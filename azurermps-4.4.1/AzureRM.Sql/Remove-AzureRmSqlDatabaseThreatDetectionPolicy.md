...
## Descrizione
Il cmdlet **Remove-AzureRmSqlDatabaseThreatDetectionPolicy** rimuove i criteri di rilevamento delle minacce da un database SQL di AzureAzure.
...
Questo cmdlet restituisce un oggetto **DatabaseThreatDetectionPolicyModel** .
