...
## Descrizione
Il cmdlet **New-AzureRmSqlServerDisasterRecoveryConfiguration** crea una configurazione di ripristino di sistema di database di SQL Server.
...
### -FailoverPolicy
Specifica i criteri di failover.
...
### -PartnerServerName
Specifica il nome del server partner.
