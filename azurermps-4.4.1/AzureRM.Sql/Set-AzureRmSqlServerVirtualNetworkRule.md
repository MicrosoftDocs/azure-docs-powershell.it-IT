...
Per controllare il set di regole di rete virtuale nel server, USA invece ' Add-AzureRmSqlServerVirtualNetworkRule ' è Remove-AzureRmSqlServerVirtualNetworkRule '.
