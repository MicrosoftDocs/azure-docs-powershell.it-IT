...
## Descrizione
Il cmdlet **set-AzureRmSqlServer** modifica le proprietà di un server di database SQL di Azure.
...
### -Tag
Specifica un dizionario di tag che questo cmdlet associa al server. Coppie chiave-valore nella forma di una tabella hash impostata come tag nel server. Per esempio:
