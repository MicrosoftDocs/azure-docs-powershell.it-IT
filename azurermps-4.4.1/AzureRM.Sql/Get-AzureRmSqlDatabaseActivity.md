...
## Sinossi
Ottiene lo stato di spostamento dei database elastici.
...
## Descrizione
Il cmdlet **Get-AzureRmSqlDatabaseActivity** ottiene lo stato dei database elastici che si spostano all'interno o all'esterno di un pool di database elastico in Azure SQL database.
...
### -Nomeserver
Specifica il nome di Microsoft SQL Server che ospita il pool di database elastici.
