...
## Descrizione
Il cmdlet **set-AzureRmAutomationRunbook** modifica la configurazione di un Runbook di automazione di Azure in APS.
...
Questo comando consente di abilitare la registrazione dettagliata per i processi del Runbook specificato nell'account di automazione di Azure denominato Contoso17.

## PARAMETRI

### -AutomationAccountName
Specifica il nome dell'account di automazione in cui questo cmdlet modifica un Runbook.
...
### -Nome
Specifica il nome del Runbook modificato da questo cmdlet.
...
### -ResourceGroupName
Specifica il nome del gruppo di risorse per cui questo cmdlet modifica un Runbook.
...
### -Tag
Specifica un dizionario di tag per sostituire i tag correnti della Runbook modificata.
