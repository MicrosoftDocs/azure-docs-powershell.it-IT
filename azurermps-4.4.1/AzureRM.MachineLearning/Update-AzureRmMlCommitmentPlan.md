...
## Descrizione
Aggiorna una risorsa del piano di impegni esistente. Tieni presente che la maggior parte delle proprietà del piano di impegni non è modificabile e non può essere modificata. Le proprietà che possono essere modificate includono SKU (che consente di eseguire la migrazione del piano di impegno da una SKU a un'altra) e i contrassegni.

## ESEMPI

### --------------------------Esempio 1: aggiornare un piano di impegni--------------------------
@ {Paragraph = PS C: \\ \> }
...
### -SkuCapacity
Capacità dell'USK da usare quando si aggiorna il piano di impegni di Azure ML.
...
### -SkuName
Nome dell'USK da usare per l'aggiornamento del piano di impegni di Azure ML.
...
### -SkuTier
Livello dell'USK da usare per l'aggiornamento del piano di impegni di Azure ML.
...
### -Tag
Tag per la risorsa piano di impegno.
