...
## Descrizione
Il cmdlet **set-AzureRmDtlAutoShutdownPolicy** imposta i criteri di arresto automatico di un Lab, che arresta automaticamente tutte le macchine virtuali nel Lab in un determinato momento della giornata.
...
### -Disable
Indica che il cmdlet disabilita il criterio in Lab.
...
### -Enable
Indica che il cmdlet Abilita i criteri in Lab.
...
### -LabName
Specifica il nome del Lab per il quale questo cmdlet imposta il criterio di arresto automatico.
...
### -Ora
Specifica il tempo, come oggetto **DateTime** , per il momento in cui le macchine virtuali in laboratorio devono essere arrestate.
...
Questo cmdlet restituisce la programmazione che specifica quando deve essere chiusa la macchina virtuale in laboratorio.
