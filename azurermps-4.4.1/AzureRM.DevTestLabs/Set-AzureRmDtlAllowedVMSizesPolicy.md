...
## Descrizione
Il cmdlet **set-AzureRmDtlAllowedVMSizesPolicy** imposta i criteri per le dimensioni della macchina virtuale consentiti, che specifica un elenco delle dimensioni della macchina virtuale consentite in un Lab.
...
Questo cmdlet restituisce i criteri che specificano l'elenco delle dimensioni della macchina virtuale consentite in Lab.
