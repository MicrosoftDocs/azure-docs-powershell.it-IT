...
## Descrizione
Il cmdlet **Stop-AzureRmStreamAnalyticsJob** arresta in modo asincrono un processo di analisi del flusso da eseguire in Azure e rilascia le risorse che erano in uso.
La definizione del processo e i metadati restano disponibili all'interno dell'abbonamento tramite le API di gestione e portale di Azure, in modo che il processo possa essere modificato e riavviato.
Non verrà addebitato un processo nello stato Stopped.

## ESEMPI

### ESEMPIO 1: arrestare un processo in uso
```
...
### -Nome
Specifica il nome del processo di analisi di Azure Stream da interrompere.
