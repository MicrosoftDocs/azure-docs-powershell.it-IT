...
### -EnableSoftDelete
Se specificato, la funzionalità' Elimina soft ' è abilitata per il Vault chiave.
...
### -Posizione
Specifica l'area di Azure in cui creare il Vault chiave. Usa il comando Get-AzureLocation ( https://msdn.microsoft.com/ Library/Azure/mt589064. aspx) per vedere le tue scelte. Per altre informazioni, digitare `Get-Help Get-AzureLocation` .
