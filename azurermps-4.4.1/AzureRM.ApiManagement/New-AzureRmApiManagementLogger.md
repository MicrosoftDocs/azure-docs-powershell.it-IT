...
## Descrizione
Il cmdlet **New-AzureRmApiManagementLogger** crea un **logger** di gestione API di Azure.
...
### -ConnectionString
Specifica una stringa di connessione hub eventi di Azure che inizia con le operazioni seguenti: 
