...
## Descrizione
Il cmdlet **Remove-AzureRmDataLakeAnalyticsAccount** Elimina definitivamente un account di analisi di Azure Data Lake.
...
Questo comando rimuove l'account di analisi dei dati del lago specificato.
