...
## Descrizione
Il cmdlet **Resume-AzureRmDataFactoryPipeline** riprende una pipeline sospesa in Azure Data Factory.
...
Usa il cmdlet **Suspend-AzureRmDataFactoryPipeline** per sospendere una pipeline.
