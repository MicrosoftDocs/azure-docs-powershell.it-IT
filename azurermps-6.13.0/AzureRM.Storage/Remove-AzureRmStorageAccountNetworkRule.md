...
## Descrizione
Il cmdlet **Remove-AzureRmStorageAccountNetworkRule** rimuove IpRules o VirtualNetworkRules dalla proprietà NetWorkRule di un account di archiviazione

## ESEMPI

### Esempio 1: rimuovere più IpRules con IPAddressOrRange
```
...
Questo comando rimuove diversi IpRules con IPAddressOrRange.

### Esempio 2: rimuovere un VirtualNetworkRule con l'input di oggetti VirtualNetworkRule con JSON
```
...
Questo comando rimuove un VirtualNetworkRule con l'input di oggetti VirtualNetworkRule con JSON.

### Esempio 3: rimuovere First IpRule con pipeline
```
...
Questo comando rimuove prima IpRule con pipeline.

### Esempio 4: rimuovere più VirtualNetworkRules con VirtualNetworkResourceID
```
...
Questo comando rimuove diversi VirtualNetworkRules con VirtualNetworkResourceID.
...
### -IPAddressOrRange
La matrice di IpAddressOrRange eliminerà IpRule con lo stesso IpAddressOrRange dalla proprietà NetWorkRule.
...
### -IPRule
Matrice di oggetti IpRule da rimuovere dalla proprietà NetWorkRule.
...
La matrice di VirtualNetworkResourceId eliminerà VirtualNetworkRule con lo stesso VirtualNetworkResourceId dalla proprietà NetWorkRule.
...
### -VirtualNetworkRule
Matrice di oggetti VirtualNetworkRule da rimuovere dalla proprietà NetWorkRule.
...
Parametri: IPRule (ByValue)

### Microsoft. Azure. Commands. Management. storage. Models. PSVirtualNetworkRule []
Parametri: VirtualNetworkRule (ByValue)
