...
## Descrizione
USA **Remove-AzureRmServiceFabricNode** per rimuovere i nodi da un tipo di nodo specifico da un cluster. La rimozione procede solo se soddisfa le metriche di integrità del cluster.
...
Questo comando consente di rimuovere 2 nodi da NodeType ' NT1'.
...
### System. Int32
Parametri: NumberOfNodesToRemove (ByValue)

### System. String
Parametri: NodeType (ByValue)
