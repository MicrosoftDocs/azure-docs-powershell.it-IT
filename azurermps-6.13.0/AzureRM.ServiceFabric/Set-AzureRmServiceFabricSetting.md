...
## Descrizione
Usare **set-AzureRmServiceFabricSetting** per aggiungere o aggiornare le impostazioni del tessuto del servizio in un cluster.
...
Parametri: SettingsSectionDescription (ByValue)
