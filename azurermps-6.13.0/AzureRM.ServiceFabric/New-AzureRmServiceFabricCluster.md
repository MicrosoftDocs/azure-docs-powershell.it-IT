...
### System. String
Parametri: CertificateFile (ByValue), CertificateOutputFolder (ByValue), CertificateSubjectName (ByValue), VAULTNAME (ByValue), KeyVaultResouceGroupName (ByValue), location (ByValue), Name (ByValue), ParameterFile (ByValue), SecondaryCertificateFile (ByValue), SecretIdentifier (ByValue), TemplateFile (ByValue), VmUserName (ByValue)

### System. Security. SecureString
Parametri: CertificatePassword (ByValue), SecondaryCertificatePassword (ByValue)

### System. Int32
Parametri: ClusterSize (ByValue)
