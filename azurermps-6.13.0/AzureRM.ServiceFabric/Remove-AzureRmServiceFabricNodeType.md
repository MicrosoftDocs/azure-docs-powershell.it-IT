...
## Descrizione
Usa il **Remove-AzureRmServiceFabricNodeType** per rimuovere tutti i nodi da un tipo di nodo specifico e il tipo di nodo da un cluster. Questo comando non può essere usato per eliminare il tipo di nodo primario.
