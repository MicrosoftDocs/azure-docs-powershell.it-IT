...
## Descrizione
Usare **Remove-AzureRmServiceFabricClientCertificate** per rimuovere un certificato client o i nomi di oggetto del certificato da usare per l'autenticazione del client nel cluster.
...
### System. String
Parameters: CommonName (ByValue), IssuerThumbprint (ByValue), identificazione digitale (ByValue)

### System. String []
Parametri: AdminClientThumbprint (ByValue), ReadonlyClientThumbprint (ByValue)
