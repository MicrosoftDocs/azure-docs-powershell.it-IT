...
## Descrizione
Il cmdlet **Get-AzureRmSchedulerJob** ottiene i processi di pianificazione di Azure.
...
### -JobCollectionName
Specifica il nome di una raccolta processo che contiene i processi da ottenere.
...
### -JobName
Specifica il nome di un processo da ottenere.
...
### -JobState
Specifica uno stato di lavoro per ottenere i processi.
...
### -ResourceGroupName
Specifica il gruppo di risorse dei processi da ottenere.
