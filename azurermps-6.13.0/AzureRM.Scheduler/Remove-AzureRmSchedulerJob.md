...
## Descrizione
Il cmdlet **Remove-AzureRmSchedulerJob** rimuove un processo di pianificazione di Azure.
...
### -JobCollectionName
Specifica il nome di una raccolta processi contenente il processo da rimuovere.
...
### -JobName
Specifica il nome di un processo da rimuovere.
...
### -PassThru
Indica che questo cmdlet restituisce il valore Success per Success.
...
### -ResourceGroupName
Specifica il gruppo di risorse del processo da rimuovere.
