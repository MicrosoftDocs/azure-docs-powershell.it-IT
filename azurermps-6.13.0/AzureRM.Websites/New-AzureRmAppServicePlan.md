...
## Descrizione
Il cmdlet **New-AzureRmAppServicePlan** crea un piano di servizio app Azure in una determinata posizione geo con il livello specificato, le dimensioni dei lavoratori e il numero di dipendenti.
...
Questo comando crea un piano di servizio app denominato ContosoASP nel gruppo risorse denominato Default-Web-Westus in Geo location West US.
Il comando specifica un livello di base e assegna due piccoli lavoratori.
...
### -HyperV
Specifica questo, il piano di servizio app eseguirà i contenitori Windows
...
### -PerSiteScaling
Se abilitare o meno l'attivazione per scala per sito
...
Parametri: AppServicePlan (ByValue)
