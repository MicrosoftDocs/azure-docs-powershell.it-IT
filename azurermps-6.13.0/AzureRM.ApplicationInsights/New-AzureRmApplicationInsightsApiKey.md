...
## Descrizione
Creare un App Insights Keys API per una risorsa Insights applicazione

## ESEMPI

### Esempio 1 creare una nuova chiave API per una risorsa Insights applicazione
```
...
Creare una descrizione della chiave API per l'applicazione Insights come "testapiKey" con le autorizzazioni "ReadTelemetry", "WriteAnnotations" per la risorsa "test" nel gruppo di risorse "testGroup".
...
### -Descrizione
Descrizione che consente di identificare questa chiave API.
...
### -Autorizzazioni
Autorizzazioni che la chiave API consente alle app di eseguire.
...
Parametri: ApplicationInsightsComponent (ByValue)
