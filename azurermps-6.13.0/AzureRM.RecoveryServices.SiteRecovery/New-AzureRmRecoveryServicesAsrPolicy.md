...
## Descrizione
Il cmdlet **New-AzureRmRecoveryServicesAsrPolicy** crea un criterio di replica del ripristino di Azure site.
Il criterio di replica viene usato per specificare le impostazioni di replica, ad esempio la frequenza di replica e il numero di punti di ripristino.
...
### -AzureToAzure
Parametro switch che specifica che i criteri di replica da creare verranno usati per la replica delle macchine virtuali di Azure tra due aree di Azure.
...
### -AzureToVMware
Parametro switch che specifica che i criteri di replica da creare verranno usati per invertire la replica non riuscita sulle macchine virtuali VMware e sui server fisici in cui è in uso Azure di nuovo in un sito VMware locale.
...
Mantenere i punti di ripristino per un periodo di tempo specifico in ore.
...
### -VmmToVmm
Il parametro switch per specificare i criteri deve essere usato per la replica tra i siti Hyper-V gestiti da un server VMM.
...
### -VMwareToAzure
Parametro switch che specifica che i criteri di replica da creare verranno usati per replicare le macchine virtuali VMware e/o i server fisici in Azure.
