...
### -AzureToAzure
Parametro switch che specifica che la direzione di replica viene aggiornata per le macchine virtuali di Azure replicate tra due aree di Azure.
...
### -AzureToVMware
Aggiornare la direzione della replica da Azure a VMware.
