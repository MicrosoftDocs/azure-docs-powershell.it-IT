...
## Descrizione
Il cmdlet **Export-AzureRmApiManagementApi** Esporta un'API di gestione API di Azure in un file in uno dei formati supportati.
...
psdx_paramvalues Wadl e spavalderia.
...
### System. String
Questo cmdlet restituisce il contenuto dell'API esportato come stringa.
