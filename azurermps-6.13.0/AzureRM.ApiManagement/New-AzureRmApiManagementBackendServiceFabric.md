...
Il cmdlet **New-AzureRmApiManagementBackendServiceFabric** crea un oggetto `PsApiManagementServiceFabric` da usare in cmdlet **New-AzureRmApiManagementBackend** e **set-AzureRmApiManagementBackend**.
