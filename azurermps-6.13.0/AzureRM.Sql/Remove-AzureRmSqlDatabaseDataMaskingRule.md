...
## Descrizione
Il cmdlet **Remove-AzureRmSqlDatabaseDataMaskingRule** rimuove una specifica regola di mascheramento dei dati da un database SQL di Azure.
Puoi rimuovere una regola di mascheramento dei dati usando i parametri *ResourceGroupName* , *nomeserver* , *DatabaseName* e *RuleId* per identificare la regola rimossa da questo cmdlet.
Questo cmdlet è supportato anche dal servizio database stretch di SQL Server in Azure.

## ESEMPI

### Esempio 1: rimuovere una regola di mascheramento dei dati del database
```
...
Questo comando rimuove il nome della regola Rule01 definito per il database Database01.
Il database si trova in Server01 e assegnato al gruppo di risorse ResourceGroup01.
