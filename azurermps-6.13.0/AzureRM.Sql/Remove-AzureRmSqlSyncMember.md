...
## Descrizione
Il cmdlet **Remove-AzureRmSqlSyncMember** rimuove un membro di sincronizzazione di database SQL di Azure.

## ESEMPI

### Esempio 1: rimuovere un membro di sincronizzazione
```
...
Questo comando rimuove il membro di sincronizzazione di database SQL di Azure denominato syncMember01.
...
### -PassThru
Definisce se restituire il membro di sincronizzazione rimosso
