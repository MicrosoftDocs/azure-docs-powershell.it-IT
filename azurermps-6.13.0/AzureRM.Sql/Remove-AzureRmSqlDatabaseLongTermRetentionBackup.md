...
## Descrizione
Il cmdlet **Remove-AzureRmSqlDatabaseLongTermRetentionBackup** Elimina il backup specificato.

## ESEMPI

### Esempio 1: eliminare un singolo backup
```powershell
...
### Esempio 2: eliminare tutti i backup per una posizione
```powershell
