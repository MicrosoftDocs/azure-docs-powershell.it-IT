...
### GetInstanceByResourceGroup (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzureRmSqlInstance** restituisce informazioni su una o più istanze gestite da SQL Azure.
