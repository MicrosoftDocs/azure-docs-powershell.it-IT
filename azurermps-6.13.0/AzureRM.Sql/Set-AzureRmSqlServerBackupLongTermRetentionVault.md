...
## Descrizione
Il cmdlet **set-AzureRmSqlServerBackupLongTermRetentionVault** imposta il Vault di conservazione a lungo termine registrato nel server.
...
### -Nomeserver
Specifica il server per cui questo cmdlet imposta un Vault.
