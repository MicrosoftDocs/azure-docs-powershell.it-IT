...
Hub molto collegato a un servizio di provisioning del dispositivo hub di Azure molto con AllocationWeight e ApplyAllocationPolicy.

## PARAMETRI

### -AllocationWeight
Peso dell'allocazione dell'hub
...
### -ApplyAllocationPolicy
Valore booleano che indica se applicare i criteri di allocazione all'hub molto
...
Stringa di connessione della risorsa Hub molto.
