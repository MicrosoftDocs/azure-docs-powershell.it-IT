...
Mostra i dettagli su "certificato" in un servizio di provisioning del dispositivo hub di Azure molto.
...
Elenca tutti i certificati in "myiotdps" usando pipeline.
