...
## Descrizione
Il cmdlet **New-AzureRmCognitiveServicesAccount** crea un account di servizi cognitivi con il tipo e SKU specificati.
...
### -Digitare
Specifica il tipo di account da creare. USA `Get-AzureRmCognitiveServicesAccountType` cmdlet per ottenere i valori accettabili correnti.
