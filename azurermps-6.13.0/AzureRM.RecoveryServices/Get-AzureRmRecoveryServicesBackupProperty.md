...
## Descrizione
Il cmdlet **Get-AzureRmRecoveryServicesBackupProperty** ottiene le proprietà di backup per un Vault di servizi di ripristino.
...
Ottenere la proprietà backup Vault per Vault.
