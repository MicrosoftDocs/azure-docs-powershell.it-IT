...
## Descrizione
Il cmdlet New-AzureRmAutomationSourceControl crea una configurazione per collegare l'account di automazione di Azure con il mio VSTS TFVC, VST git o GitHub.
