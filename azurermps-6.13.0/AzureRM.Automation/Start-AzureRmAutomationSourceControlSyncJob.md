...
## Descrizione
Il cmdlet Start-AzureRmAutomationSourceControlSyncJob avvia un processo di sincronizzazione del controllo di origine di Azure Automation per il nome del controllo del codice sorgente indicato.
