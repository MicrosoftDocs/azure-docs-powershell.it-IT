...
## Descrizione
Crea una configurazione di aggiornamento software che viene eseguita in una programmazione per aggiornare un elenco di computer. I computer includono sia le macchine virtuali Azure che i computer non Azure.
