...
## Descrizione
Il cmdlet New-AzureRmDataMigrationSelectedDB crea un oggetto info database che contiene informazioni sui database di origine e di destinazione, oltre ai mapping delle tabelle, per la migrazione. Questo cmdlet può essere usato come parametro con il cmdlet New-AzureRmDataMigrationTask.
