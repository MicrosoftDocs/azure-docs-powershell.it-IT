...
Il cmdlet **Get-AzureRmResource** ottiene le risorse Azure.
...
### -ExpandProperties
Se specificato, espande le proprietà della risorsa.
...
### -ResourceGroupName
Gruppo risorse in cui appartiene la risorsa o le risorse retireved. Questo parametro supporta i caratteri jolly all'inizio e/o alla fine della stringa.
...
### -ResourceId
Specifica l'ID risorsa completo, come nell'esempio seguente `/subscriptions/xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx/providers/Microsoft.Compute/virtualMachines`
