...
## Descrizione
Il cmdlet **Get-AzureRmIntegrationAccount** ottiene gli account di integrazione da un gruppo di risorse. Specificare il nome di un account di integrazione e il nome del gruppo di risorse.
