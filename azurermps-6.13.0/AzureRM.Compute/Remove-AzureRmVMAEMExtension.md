...
## Descrizione
Il cmdlet **Remove-AzureRmVMAEMExtension** rimuove l'estensione AEM (Azure Enhanced Monitoring) da una macchina virtuale.

## ESEMPI

### Esempio 1: rimuovere l'estensione AEM
```
PS C:\> Remove-AzureRmVMAEMExtension -ResourceGroupName "ResourceGroup11" -VMName "contoso-server"
```

Questo comando rimuove l'estensione AEM per la macchina virtuale denominata Contoso-server.
...
### -Nome
Specifica il nome della macchina virtuale da cui questo cmdlet rimuove l'estensione AEM.
...
Questo cmdlet rimuove l'estensione AEM da tale macchina virtuale.
...
Questo cmdlet consente di rimuovere l'estensione AEM per la macchina virtuale specificata da questo parametro.
