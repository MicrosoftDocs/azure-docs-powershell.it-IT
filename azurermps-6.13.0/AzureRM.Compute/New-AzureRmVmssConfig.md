...
## Descrizione
Il cmdlet **New-AzureRmVmssConfig** crea un oggetto vmss (Virtual Manager scale set) configurabile. Altri cmdlet sono necessari per configurare l'oggetto VMSS. Questi cmdlet sono:
...
Questo esempio crea un oggetto di configurazione VMSS. Il primo comando usa il cmdlet **New-AzureRmVmssConfig** per creare un oggetto di configurazione vmss e archivia il risultato nella variabile denominata $vmss. Il secondo comando usa il cmdlet **New-AzureRmVmss** per creare un vmss che usa l'oggetto di configurazione vmss creato nel primo comando.

## PARAMETRI

### -AssignIdentity
Specifica l'identità di sistema assegnata per il set di scale della macchina virtuale.
...
### -Extension
Specifica l'oggetto informazioni sull'estensione per VMSS. Puoi usare il cmdlet **Add-AzureRmVmssExtension** per aggiungere questo oggetto.
...
Puoi usare il cmdlet **Add-AzureRmVmssNetworkInterfaceConfiguration** per aggiungere questo oggetto.
...
Puoi usare il cmdlet **set-AzureRmVmssOsProfile** per impostare questo oggetto.
...
### -Priorità
Specifica la priorità per le macchine virtuali nel set di proporzioni.
...
Puoi usare il cmdlet **set-AzureRmVmssStorageProfile** per impostare questo oggetto.
