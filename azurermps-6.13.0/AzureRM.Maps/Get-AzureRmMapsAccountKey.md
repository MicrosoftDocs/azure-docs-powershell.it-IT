...
## Descrizione
Il cmdlet Get-AzureRmMapsAccountKey ottiene le chiavi API per un account di mappe di Azure con provisioning.
...
USA New-AzureRmMapsAccountKey (New-AzureRmMapsAccountKey. MD) per rigenerare una chiave.
