...
## Descrizione
Il cmdlet **Stop-AzureRmHDInsightJob** interrompe un processo in uso specificato in un cluster di Azure HDInsight.
...
Questo comando Arresta un processo nel cluster denominato your-Hadoop-001.
