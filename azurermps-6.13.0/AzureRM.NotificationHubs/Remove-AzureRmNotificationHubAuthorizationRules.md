...
## Descrizione
Il cmdlet **Remove-AzureRmNotificationHubAuthorizationRules** rimuove una regola di autorizzazione della firma di accesso condiviso (SAS) da un hub di notifica.
