...
## Descrizione
Il cmdlet **Stop-AzureRmDataFactoryV2Trigger** arresta un trigger in una data factory. Se il trigger si trova nello stato "iniziato", il cmdlet interrompe il trigger e non richiama più le pipeline. Se il trigger è già nello stato "Stopped", questo cmdlet non ha alcun effetto. Se il parametro Force viene specificato, il cmdlet non viene richiesto prima di arrestare il trigger.

## ESEMPI

### Esempio 1: arrestare un trigger
```
...
Interrompe un trigger denominato "ScheduledTrigger" nella Factory di dati "WikiADF".
