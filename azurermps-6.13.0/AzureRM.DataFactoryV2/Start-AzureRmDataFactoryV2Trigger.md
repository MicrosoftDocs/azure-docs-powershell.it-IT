...
## Descrizione
Il cmdlet **Start-AzureRmDataFactoryV2Trigger** avvia un trigger in una data factory. Se il trigger si trova nello stato "Stopped", il cmdlet avvia il trigger e infine richiama le pipeline in base alla relativa definizione. Se il trigger è già nello stato "Started", questo cmdlet non ha alcun effetto. Se il parametro Force viene specificato, il cmdlet non viene richiesto prima di avviare il trigger.
...
Avvia un trigger denominato "ScheduledTrigger" nella Factory di dati "WikiADF".
