...
## Descrizione
Il cmdlet **Start-AzureRmPolicyRemediation** crea un criterio di correzione per una specifica assegnazione di criteri. Tutte le risorse non conformi a o sotto l'ambito del correttivo verranno risanate. Il risanamento è supportato solo per i criteri con l'effetto ' deployIfNotExists '.
