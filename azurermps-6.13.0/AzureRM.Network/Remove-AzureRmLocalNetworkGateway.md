...
Elimina l'oggetto del gateway di rete locale con il nome "myLocalGW" nel gruppo di risorse "myRG" Nota: per prima cosa è necessario eliminare tutte le connessioni al gateway di rete locale usando il cmdlet **Remove-AzureRmVirtualNetworkGatewayConnection** .
