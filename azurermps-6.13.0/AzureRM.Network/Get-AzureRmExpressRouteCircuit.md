...
## Descrizione
Il cmdlet **Get-AzureRmExpressRouteCircuit** viene usato per recuperare un oggetto Circuit ExpressRoute dall'abbonamento. L'oggetto Circuit restituito può essere usato come input per altri cmdlet che operano su circuiti ExpressRoute.

## ESEMPI

### Esempio 1: ottenere il circuito ExpressRoute da eliminare
```
