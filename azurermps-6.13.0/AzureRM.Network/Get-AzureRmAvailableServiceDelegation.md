...
## Descrizione
Il cmdlet **Get-AzureRmAvailableServiceDelegation** consente di recuperare tutte le delegazioni di servizi disponibili per una subnet nella posizione specificata. Questo cmdlet *non* descrive le delegazioni che possono coesistere in una singola subnet.
