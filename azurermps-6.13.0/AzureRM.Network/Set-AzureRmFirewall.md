...
## Descrizione
Il cmdlet **set-AzureRmFirewall** aggiorna un firewall di Azure.
...
In questo esempio, un firewall viene creato per primo senza insiemi di regole applicative. In seguito vengono create una regola dell'applicazione e una raccolta regole applicazione, quindi l'oggetto firewall viene modificato in memoria, senza influire sulla configurazione reale nel cloud. Per il riflesso delle modifiche nel cloud, Set-AzureRmFirewall deve essere chiamato.
...
### PSAzureFirewall
Il parametro ' AzureFirewall ' accetta il valore di tipo ' PSAzureFirewall ' dalla pipeline
