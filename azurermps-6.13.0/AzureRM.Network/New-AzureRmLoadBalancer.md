...
## Descrizione
Il cmdlet **New-AzureRmLoadBalancer** crea un bilanciamento del carico di Azure.
...
Tieni presente che questo esempio Mostra solo come creare un bilanciamento del carico. Devi anche configurarlo usando il cmdlet Add-AzureRmNetworkInterfaceIpConfig per assegnare le NIC a macchine virtuali diverse.
