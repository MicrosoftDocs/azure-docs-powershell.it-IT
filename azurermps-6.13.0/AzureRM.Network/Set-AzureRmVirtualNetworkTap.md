...
## Sinossi
Imposta lo stato obiettivo per un tocco di rete virtuale.
...
## Descrizione
**Set-AzureRmVirtualNetworkTap** imposta lo stato obiettivo per un tocco di rete virtuale di Azure.
