...
## Sinossi
Imposta lo stato obiettivo di una configurazione di tocco
...
## Descrizione
**Set-AzureRmNetworkInterfaceTapConfig** imposta lo stato dell'obiettivo per un'interfaccia di rete Azure.
