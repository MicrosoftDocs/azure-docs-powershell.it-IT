...
## Descrizione
Il cmdlet **Add-AzureRmLoadBalancerOutboundRuleConfig** aggiunge una configurazione della regola in uscita a un bilanciamento del carico di Azure.
...
Il secondo comando usa l'operatore pipeline per passare il bilanciamento del carico in $slb a **Add-AzureRmLoadBalancerOutboundRuleConfig** , che aggiunge una configurazione della regola in uscita al bilanciamento del carico.
