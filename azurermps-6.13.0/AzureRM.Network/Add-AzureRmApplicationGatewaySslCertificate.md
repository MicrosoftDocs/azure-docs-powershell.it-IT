...
## Descrizione
Il cmdlet **Add-AzureRmApplicationGatewaySslCertificate** aggiunge un certificato SSL a un gateway dell'applicazione.

## ESEMPI

### Esempio 1: aggiungere un certificato SSL a un gateway dell'applicazione.
```
