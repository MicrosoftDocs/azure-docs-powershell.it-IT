...
Dopo aver creato il sito, viene immediatamente rimosso tramite il comando Remove-AzureRmVpnSite.
...
Come l'esempio 1, ma qui la rimozione avviene usando l'output tramite pipe di Get-AzureRmVpnSite.
