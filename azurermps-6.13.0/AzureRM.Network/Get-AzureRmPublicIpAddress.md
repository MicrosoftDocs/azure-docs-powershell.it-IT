...
## Descrizione
Il cmdlet **Get-AzureRmPublicIPAddress** ottiene uno o più indirizzi IP pubblici in un gruppo di risorse.
...
Questo comando consente di ottenere una risorsa indirizzo IP pubblico con nome $publicIPName nel gruppo risorse $rgName.
