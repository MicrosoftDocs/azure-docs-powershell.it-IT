...
## Descrizione
Il cmdlet **Remove-AzureRmRelayAuthorizationRule** rimuove la regola di autorizzazione delle entità di inoltro specificate (Namespace/WcfRelay/HybridConnection).
