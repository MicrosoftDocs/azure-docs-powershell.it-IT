...
## Descrizione
Il cmdlet Get-AzureRmContainerRegistryReplication ottiene una replica specificata di un registro di sistema contenitore o di tutte le repliche di un registro di sistema contenitore.

## ESEMPI

### Esempio 1: ottiene una replica specificata di un registro di sistema contenitore
```powershell
...
Ottiene una replica specificata di un registro di sistema contenitore

### Esempio 2: ottiene tutte le repliche di un registro di sistema contenitore
```powershell
...
Ottiene tutte le repliche di un registro di sistema contenitore
...
### -ResourceId
ID risorsa di replica del registro di sistema contenitore
...
Parametri: Registro di sistema (ByValue)
