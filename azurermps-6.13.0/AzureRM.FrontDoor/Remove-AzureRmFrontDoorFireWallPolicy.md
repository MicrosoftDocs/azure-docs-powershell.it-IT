...
## Descrizione
Il cmdlet **Remove-AzureRmFrontDoor** rimuove un criterio WAF sotto la sottoscrizione corrente
...
Rimuovere i criteri di WAF denominati $name in $resourceGroup.
...
Rimuovere tutti i criteri di WAF in $resourceGroup.
