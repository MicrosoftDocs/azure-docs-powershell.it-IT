...
## Descrizione
Il cmdlet **test-AzureRmCdnCustomDomain** controlla se un dominio personalizzato può essere aggiunto a un endpoint convalidando il mapping CNAME.
...
### -CdnEndpoint
Specifica l'endpoint a cui si vuole aggiungere il dominio personalizzato.
...
### -EndpointName
Specifica il nome dell'endpoint a cui si vuole aggiungere il dominio personalizzato.
