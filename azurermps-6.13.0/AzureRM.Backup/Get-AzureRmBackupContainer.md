...
- Una macchina virtuale dell'infrastruttura Azure come servizio (IaaS) prima del backup può eseguire il backup di un'origine dati o di un elemento, è necessario registrare il contenitore che lo contiene con il servizio di backup di Azure.
