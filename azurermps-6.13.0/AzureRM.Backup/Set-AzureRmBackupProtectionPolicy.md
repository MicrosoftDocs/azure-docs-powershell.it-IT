...
- Criteri di conservazione qualsiasi modifica può influire sul backup e sulla conservazione degli elementi associati al criterio.
...
Parametri: ProtectionPolicy (ByValue)
