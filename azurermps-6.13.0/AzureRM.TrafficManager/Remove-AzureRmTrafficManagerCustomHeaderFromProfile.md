...
## Descrizione
Il cmdlet **Remove-AzureRmTrafficManagerCustomHeaderFromProfile** rimuove le informazioni di intestazione personalizzate da un oggetto profilo di Azure Traffic Manager locale.
...
### Esempio 1: rimuovere le informazioni di intestazione personalizzate da un profilo
```
...
Il secondo comando rimuove le informazioni di intestazione personalizzate dal profilo archiviato in $TrafficManagerProfile.
