...
## Descrizione
Il cmdlet **Move-AzureRmDataLakeStoreItem** sposta o rinomina un file o una cartella in data Lake Store.

## ESEMPI

### Esempio 1: modificare e rinominare un elemento
```
...
Questo comando Rinomina l'elemento File.txt in RenamedFile.txt e lo sposta in una cartella diversa.
...
### -Destinazione
Specifica il percorso dello Store Data Lake a cui trasferire l'elemento, a partire dalla directory radice (/).
...
### -Path
Specifica il percorso dello Store Data Lake dell'elemento da trasferire o rinominare, a partire dalla directory radice (/).
...
### System. String
Percorso completo per il file o la cartella spostata.
