...
## Descrizione
Il cmdlet **Update-AzureKeyVaultSecret** aggiorna gli attributi modificabili di un segreto in un Vault chiave.
...
I primi tre comandi definiscono le variabili di stringa da usare per i parametri *VAULTNAME* , *Name* e *ContentType* . Il quarto comando usa il cmdlet Get-AzureKeyVaultKey per ottenere le chiavi specificate e convoglia le chiavi al cmdlet Update-AzureKeyVaultSecret per impostare il tipo di contenuto su XML.
