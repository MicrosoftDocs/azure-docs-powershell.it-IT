...
## Descrizione
Il cmdlet **Update-AzureKeyVaultKey** aggiorna gli attributi modificabili di una chiave in un Vault chiave.
...
### -Nome
Nome chiave.
Cmdlet costruisce il nome di dominio completo di una chiave dal nome del Vault, l'ambiente selezionato e il cognome della chiave.
...
### -Versione
Versione chiave.
Cmdlet crea l'FQDN di una chiave dal nome del Vault, l'ambiente attualmente selezionato, il nome della chiave e la versione chiave.
