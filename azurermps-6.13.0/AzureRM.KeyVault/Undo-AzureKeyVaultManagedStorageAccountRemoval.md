...
## Descrizione
Il comando **Undo-AzureKeyVaultManagedStorageAccountRemoval** recupera un account di archiviazione gestita precedentemente eliminato, a condizione che l'eliminazione soft sia abilitata per il Vault e che il tentativo di ripristino si verifichi durante l'intervallo di recupero.
