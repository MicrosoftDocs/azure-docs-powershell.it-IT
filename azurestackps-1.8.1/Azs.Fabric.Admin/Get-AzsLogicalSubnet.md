...
Ottenere un elenco di tutte le subnet logiche per una determinata rete logica e posizione.
...
Ottenere una subnet logica specifica per una data rete logica e una posizione in base al nome.

## PARAMETRI

### -Nome
Nome della subnet logica.
