...
## Descrizione
Acquistare un'istanza di prenotazione e ottenere vantaggi
...
Dopo il calcolo del prezzo, il cliente può Purcahse che RI offre calculatePrice
...
### -ReservationOrderId
ID dell'ordine di prenotazione per l'acquisto, genera da AZ prenotazione prenotazioni-calcola ordine.
