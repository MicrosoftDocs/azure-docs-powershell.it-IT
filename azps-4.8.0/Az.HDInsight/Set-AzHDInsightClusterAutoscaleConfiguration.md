...
## Descrizione
Questo cmdlet **set-AzHDInsightClusterAutoscaleConfiguration** imposta la configurazione di scala automatica di un cluster di Azure HDInsight.

## ESEMPI

### Esempio 1: impostare la configurazione della scala automatica basata sul caricamento del cluster HDInsight
```powershell
...
Questo comando imposta la configurazione della scala automatica basata sul caricamento di un cluster di Azure HDInsight.
...
### Esempio 3: impostare la configurazione di scala automatica del cluster HDInsight basato su un altro cluster che ha impostato la configurazione di scala automatica
```powershell
...
Questo comando imposta la configurazione di scala automatica del cluster HDInsight basato su un altro cluster.
...
### -Programmazione
Impostare i parametri basati sulla pianificazione
