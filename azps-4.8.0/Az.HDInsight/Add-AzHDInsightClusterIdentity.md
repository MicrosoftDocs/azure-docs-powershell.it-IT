...
## Descrizione
Il cmdlet **Add-AzHDInsightClusterIdentity** aggiunge un'identità cluster all'oggetto di configurazione di Azure HDInsight creato dal cmdlet New-AzHDInsightClusterConfig.
...
### -ApplicationId
ID applicazione dell'entità servizio per l'accesso a Azure Data Lake.
