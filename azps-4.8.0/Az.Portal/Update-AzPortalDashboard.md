...
I tag sono rappresentati come Hashtable inline.
...
Aggiornare i tag in un dashboard riprovati usando Get-AzPortalDashboard.
Può essere usato per aggiornare i tag in un singolo dashboard o in più dashboardfs.
