...
### Esempio 1: creare un dashboard usando un file modello di dashboard
```powershell
...
Creare un nuovo dashboard usando il file del modello di dashboard specificato.

## PARAMETRI

### -Dashboard
Definizione della risorsa dashboard condivisa.
Per costruire, vedere la sezione Note per le proprietà del DASHBOARD e creare una tabella hash.
...
DASHBOARD <IDashboard> : definizione della risorsa dashboard condivisa.
  - `Location <String>`: Percorso delle risorse
  - `[Lens <IDashboardPropertiesLenses>]`: Gli obiettivi del dashboard.
    - `[(Any) <IDashboardLens>]`: Indica che qualsiasi proprietà può essere aggiunta a questo oggetto.
  - `[Metadata <IDashboardPropertiesMetadata>]`: I metadati del dashboard.
    - `[(Any) <Object>]`: Indica che qualsiasi proprietà può essere aggiunta a questo oggetto.
  - `[Tag <IDashboardTags>]`: Tag delle risorse
