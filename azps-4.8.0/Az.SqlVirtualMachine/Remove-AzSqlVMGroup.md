...
### Paramaterico (impostazione predefinita)
```
...
## Descrizione
Il cmdlet Remove-AzSqlVMGroup Elimina un gruppo di macchine virtuali SQL.
...
Elimina il gruppo "test-Group" di Azure SQL Virtual Machine nel gruppo di risorse ResourceGroup01.
