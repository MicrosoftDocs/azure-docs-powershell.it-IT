...
## Descrizione
Il cmdlet New-AzAutomationSourceControl crea una configurazione per collegare l'account di automazione di Azure con il mio VSTS TFVC, VST git o GitHub.

## ESEMPI

### Esempio 1
Creare una configurazione del controllo del codice sorgente per collegare l'account di automazione di Azure con il progetto VSTS TFVC. I progetti di TFVC non hanno rami e quindi il parametro Branch non è specificato.
...
### Esempio 2
Creare una configurazione del controllo del codice sorgente per collegare l'account di automazione di Azure con il progetto Git di VSTS.
...
### Esempio 3
Creare una configurazione del controllo del codice sorgente per collegare l'account di automazione di Azure con il mio progetto GitHub.
...
Se DoNotPublishRunbook è impostato, significa che manuali operativi utente verrà importato come "bozza".
