...
## Descrizione
Crea una configurazione di aggiornamento software che viene eseguita in una programmazione per aggiornare un elenco di computer. I computer includono sia le macchine virtuali Azure che i computer non AZ.

## ESEMPI

### Esempio 1
Crea una configurazione di aggiornamento software per installare gli aggiornamenti critici in due macchine virtuali di Windows Azure una volta ogni sabato 9. La durata dell'aggiornamento è impostata su 2 ore in questo esempio.
...
### -ExcludedKbNumber
KB numero di aggiornamenti esclusi.
...
Maschere di pacchetti Linux escluse.
...
### -IncludedKbNumber
KB numeri di aggiornamenti inclusi.
...
Classificazioni pacchetto Linux incluse.
...
Maschere di pacchetti Linux incluse.
...
Incluse le classificazioni di Windows Update.
...
### -Linux
Indica che la configurazione di aggiornamento software è destinata ai computer del sistema operativo Linux.
...
### -Programmazione
Pianificare l'oggetto usato per la configurazione dell'aggiornamento software.
...
### -Windows
Indica che la configurazione di aggiornamento software è destinata ai computer per sistemi operativi Windows.
