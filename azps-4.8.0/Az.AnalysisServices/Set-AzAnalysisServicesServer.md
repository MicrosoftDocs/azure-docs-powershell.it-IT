...
## Descrizione
Il cmdlet Set-AzAnalysisServicesServer modifica un'istanza di Analysis Services server
...
### -DisassociateGateway
Dissocia risorsa gateway da un server di analisi
...
I valori supportati sono 0',' s 1',' s 2',' s 4',' s 8',' s 9',' s 8V2',' s 9V2' per il livello standard; ' B1',' B2' per il livello di base è da 1' per il livello di sviluppo.
