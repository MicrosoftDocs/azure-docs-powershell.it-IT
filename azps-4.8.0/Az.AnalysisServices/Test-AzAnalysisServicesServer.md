...
## Descrizione
Il cmdlet Test-AzAnalysisServicesServer verifica l'esistenza di un'istanza di Analysis Services server
...
Questo comando testerà se esiste un server denominato TestServer nel ResourceGroup TestGroup
