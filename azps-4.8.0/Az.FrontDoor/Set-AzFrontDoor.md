...
## Descrizione
Il cmdlet **set-AzFrontDoor** aggiorna un bilanciamento del carico di porta anteriore. Se non vengono forniti parametri di input, verranno usati i vecchi parametri della porta anteriore esistente.

## ESEMPI

### Esempio 1: aggiornare uno sportello anteriore esistente con FrontDoorName e ResourceGroupName.
```powershell
...
### Esempio 2: aggiornare uno sportello anteriore esistente con l'oggetto PSFrontDoor.
```powershell
...
### Esempio 4: aggiornare la proprietà BackendPoolSetting EnforceCertificateNameCheck di uno sportello anteriore esistente con il parametro-switch di DisableCertificateNameCheck
Lo sportello anteriore da aggiornare può essere identificato usando FrontoorName e ResourceGroupName, PSFrontDoor Object o ResourceId. (Vedi sopra 3 esempi ad esempio) L'esempio seguente usa l'oggetto PSFrontDoor.
...
### -BackendPoolsSetting
Impostazioni per tutti i backendPools.
...
Se disabilitare il controllo nome certificato per le richieste HTTPS a tutti i pool back-end. Nessun effetto sulle richieste non HTTPS.
...
### -EnabledState
Stato operativo del servizio di bilanciamento del carico della porta anteriore.
...
### -InputObject
L'oggetto porta principale da aggiornare.
...
### -ResourceId
ID risorsa della porta principale da aggiornare
