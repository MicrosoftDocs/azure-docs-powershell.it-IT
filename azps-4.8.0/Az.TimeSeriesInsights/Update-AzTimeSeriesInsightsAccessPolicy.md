...
### Esempio 1: aggiornare un criterio di accesso specificato per nome
```powershell
...
Questo comando aggiorna un criterio di accesso specificato.

### Esempio 2: aggiornare un criterio di accesso specificato per oggetto
```powershell
...
### -Nome
Il nome della serie temporale approfondisce i criteri di accesso associati all'ambiente specificato.
...
### -Ruolo
Elenco dei ruoli assegnati all'oggetto Principal nell'ambiente.
