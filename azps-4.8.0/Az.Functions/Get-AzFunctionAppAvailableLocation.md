...
### Esempio 1: ottenere le posizioni in cui Premium è disponibile per Windows. Se non sono specificati parametri, PlanType è impostato su "Premium" e OSType è impostato su "Windows".
```powershell
...
### Esempio 2: ottenere le posizioni in cui Premium è disponibile per Linux.
```powershell
...
Questo comando consente di ottenere le posizioni in cui Premium è disponibile per Linux.

### Esempio 3: ottenere le posizioni in cui il consumo è disponibile per Windows.
```powershell
...
Questo comando consente di ottenere le posizioni in cui il consumo è disponibile per Windows.
...
### -PlanType
Tipo di piano.
Input validi: consumi o Premium
