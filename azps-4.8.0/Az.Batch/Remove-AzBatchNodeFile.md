...
## Descrizione
Il cmdlet **Remove-AzBatchNodeFile** Elimina un file di nodo batch di Azure per un'attività o un nodo COMPUTE.
...
Questo comando ottiene il file del nodo utilizzando **Get-AzBatchNodeFile**.
Il file è associato all'attività che contiene l'ID Task26 sotto il processo di lavoro-000001.
...
### -Path
Percorso del file del nodo da eliminare.
