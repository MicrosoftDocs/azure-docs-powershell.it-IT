...
Usa il cmdlet Get-AzBatchPool per ottenere un oggetto **PSCloudPool** .
...
Il primo comando ottiene un pool utilizzando **Get-AzBatchPool** e lo archivia nella variabile $pool.
