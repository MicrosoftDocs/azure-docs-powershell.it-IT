...
Specificare un ID per ottenere una singola pianificazione del processo.
Specifica il parametro *Filter* per ottenere le pianificazioni dei processi che corrispondono a un filtro OData (Open Data Protocol).

## ESEMPI

### Esempio 1: ottenere una pianificazione del processo specificando un ID
```
...
Questo comando consente di ottenere la pianificazione del processo con ID JobSchedule23.
Usa il cmdlet Get-AzBatchAccountKey per assegnare un contesto alla variabile $Context.

### Esempio 2: ottenere le pianificazioni dei processi usando un filtro
```
...
Questo comando consente di ottenere tutte le pianificazioni dei processi con ID che iniziano con Job specificando il parametro *Filter* .
...
Se non specifichi un filtro, questo cmdlet restituisce tutte le pianificazioni dei processi per il contesto batch.
...
### -ID
Specifica l'ID della pianificazione del processo ottenuta da questo cmdlet.
...
### -MaxCount
Specifica il numero massimo di pianificazioni di lavoro da restituire.
