...
### Esempio 1: modificare un account di ANF
```
...
Questo comando esegue un aggiornamento per l'account specifico. L'assenza di Active Directory significa che verrà rimossa dall'account.
