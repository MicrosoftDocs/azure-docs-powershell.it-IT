...
## Descrizione
Il cmdlet **Remove-AzNetAppFilesPool** Elimina un pool di ANF.
...
Questo comando Elimina il pool di ANF "MyAnfPool".
...
### -AccountObject
Oggetto account che contiene il pool da rimuovere
...
### -PassThru
Restituisce se il pool specificato è stato rimosso correttamente
