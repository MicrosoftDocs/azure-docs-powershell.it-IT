...
## Sinossi
Ottenere o elencare i siti connessi alle risorse di Virtual Appliance di rete.
...
## Descrizione
La Get-AzVirtualApplianceSite Ottiene o elenca i siti connessi a una o più risorse di Virtual Appliance di rete.
...
Ottenere una risorsa sito Virtual Appliance.
...
Elencare le risorse del sito di Virtual Appliance in una appliance virtuale di rete.
...
L'appliance virtuale di rete a cui è associato il sito.
...
### -ResourceId
ID risorsa del sito Virtual Appliance.
