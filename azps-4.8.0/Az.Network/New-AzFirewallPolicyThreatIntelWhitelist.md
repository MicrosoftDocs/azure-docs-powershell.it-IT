...
## Descrizione
Il cmdlet **New-AzFirewallPolicyThreatIntelWhitelist** crea un oggetto di tipo whitelist di Intel, che può essere usato per la creazione o l'impostazione di un criterio di Azure firewall.
...
In questo esempio viene creato un elenco di informazioni di base di un elenco di un elenco di indirizzi IP di un elenco e un elenco di due voci
