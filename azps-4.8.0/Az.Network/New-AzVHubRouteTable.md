...
## Sinossi
Crea una risorsa della tabella route Hub associata a un VirtualHub.
...
## Descrizione
Crea la tabella di route specificata associata all'hub virtuale specificato con le route e le etichette fornite.
...
Questo comando crea una tabella di route Hub dell'hub virtuale.
...
### -ParentResourceId
ID risorsa della risorsa hub virtuale.
