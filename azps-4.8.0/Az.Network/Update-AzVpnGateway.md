...
Un gateway di Azure VPN è una connettività definita dal software per le connessioni sito-sito all'interno di VirtualHub. Questo gateway viene ridimensionato e ridimensionato in base all'unità di scala specificata dall'utente. Una connessione può essere configurata da un ramo/sito noto come sito VPN al gateway scalabile. Ogni connessione è costituita da due tunnel Active-Active
...
Dopo aver creato il gateway, USA Update-AzVpnGateway per aggiornare il gateway a 3 unità di scala.
...
Dopo aver creato il gateway, USA Set-AzVpnGateway per aggiornare BgpPeeringAddress.
...
### -BgpPeeringAddress
Gli indirizzi di peering BGP per questo VpnGateway bgpsettings.
...
### -ResourceId
ID risorsa di Azure della VpnGateway da modificare.
...
### -VpnConnection
L'elenco di VpnConnections che deve avere questo VpnGateway.
...
### -VpnGatewayScaleUnit
Unità di misura per questo VpnGateway.
