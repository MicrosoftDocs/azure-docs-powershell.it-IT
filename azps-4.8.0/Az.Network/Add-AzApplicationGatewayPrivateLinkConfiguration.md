...
## Sinossi
Aggiunge una configurazione di collegamento privato a un gateway dell'applicazione.
...
## Descrizione
Il cmdlet **Add-AzApplicationGatewayPrivateLinkConfiguration** aggiunge una configurazione di collegamento privato a un gateway dell'applicazione.
...
Il primo comando crea un privateLinkIpConfiguration e lo archivia nella variabile $PrivateLinkIpConfiguration.
...
Il terzo comando aggiunge la configurazione del collegamento privato denominata privateLinkConfig01, per il gateway in $AppGw
