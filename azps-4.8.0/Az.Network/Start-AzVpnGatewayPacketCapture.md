...
## Sinossi
Avvia l'operazione di acquisizione di pacchetti in un gateway VPN.
...
### -FilterData
Opzioni di filtro per avviare l'acquisizione di pacchetti nel gateway VPN.
...
### -Nome
Il nome del gateway VPN in cui deve essere avviata l'acquisizione di pacchetti.
