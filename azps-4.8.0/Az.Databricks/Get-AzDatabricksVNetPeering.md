...
### Esempio 1: elenca tutti i peering di VNET in un databricks
```powershell
...
Questo comando elenca tutti i peering di VNET in un databricks.

### Esempio 2: ottenere un peering di VNET
```powershell
...
### Esempio 3: ottenere un peering di VNET per oggetto
```powershell
