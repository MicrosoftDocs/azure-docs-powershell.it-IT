...
### Esempio 1: arrestare il servizio cloud primaverile in base al nome.
```powershell
PS C:\> Stop-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default
```

Arrestare il servizio cloud primaverile in base al nome.

### Esempio 2: arrestare il servizio cloud primaverile dalla pipe.
```powershell
PS C:\> Get-AzSpringCloudAppDeployment -ResourceGroupName spring-cloud-rg -ServiceName spring-cloud-service -AppName gateway -DeploymentName default | Stop-AzSpringCloud
```

Interrompi servizio cloud primaverile da pipe.
