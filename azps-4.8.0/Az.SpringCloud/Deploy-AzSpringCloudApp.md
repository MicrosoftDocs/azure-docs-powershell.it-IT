...
### Esempio 1: distribuire il jar compilato locale in servizio per nome.
```powershell
...
Distribuire il jar compilato locale in servizio per nome.
...
### -JarPath
Il percorso del jar deve essere deploied.
