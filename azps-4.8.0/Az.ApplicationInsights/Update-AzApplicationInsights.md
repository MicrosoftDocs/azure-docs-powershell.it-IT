...
### Esempio 1 componente approfondimenti dell'applicazione di aggiornamento
```powershell
Update-AzApplicationInsights -ResourceGroupName "rgName" -Name "aiName" -PublicNetworkAccessForIngestion "Disabled" -PublicNetworkAccessForQuery "Disabled"
```

aggiornare il componente Insights applicazione "aiName" PublicNetworkAccessForIngestion/PublicNetworkAccessForQuery sia per "disabled"
...
Tipo di accesso alla rete per l'accesso all'ingestione di Insight per l'applicazione.
Il valore deve essere "Enabled" o "disabled"
...
Tipo di accesso alla rete per l'accesso alla query Insights dell'applicazione.
Il valore deve essere "Enabled" o "disabled"
