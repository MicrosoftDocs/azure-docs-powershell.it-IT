...
### Esempio 1 rimuovere una configurazione di esportazione continua in un'applicazione Insights Resource
```
PS C:\> Remove-AzApplicationInsightsContinuousExport -ResourceGroupName "testgroup" -Name "test" -ExportId "uGOoki0jQsyEs3IdQ83Q4QsNr4=" -PassThru
True
```

Rimuovere le informazioni approfondite dell'applicazione configurazione di esportazione continua con l'ID esportazione "uGOoki0jQsyEs3IdQ83Q4QsNr4 =" per la risorsa denominata "test" nel gruppo risorse "testgroup"
...
### -PassThru
Se specificato scriverà true nel caso in cui l'operazione venga eseguita correttamente. Questo parametro è facoltativo. Il valore predefinito è false.
