...
## Sinossi
Ottiene le credenziali di databox di un processo specifico
...
## Descrizione
Il cmdlet **Get-AzDataBoxCredential** ottiene le credenziali della databox di un processo specifico. Le proprietà interne dell'oggetto credenziali restituite saranno diverse per i diversi tipi di SKU.
...
Questo restituisce il JobSecrets del processo specificato
