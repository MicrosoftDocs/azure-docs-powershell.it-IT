...
## Descrizione
Il cmdlet Update-AzIotSecuritySolution updayes una o più delle proprietà seguenti in una specifica soluzione di sicurezza per gli utenti: Tag, configurazione della raccomandazione, risorse definite dall'utente.
Solo le proprietà specificate verranno aggiornate all'interno della soluzione di sicurezza molto.
La soluzione per la sicurezza degli argomenti raccoglie i dati di sicurezza e gli eventi provenienti da dispositivi molto e hub per evitare e rilevare le minacce.
...
Aggiornamento della soluzione di sicurezza per gli utenti "esempio" dal gruppo di risorse "MyResourceGroup" con la configurazione delle raccomandazioni e le risorse definite dall'utente
