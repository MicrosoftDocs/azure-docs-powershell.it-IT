...
## Descrizione
Il cmdlet New-AzDeviceSecurityGroupTimeWindowRuleObject crea un nuovo elenco di regole di avviso per le finestre temporali per il gruppo sicurezza dispositivi nella soluzione di sicurezza degli articoli.
...
Creare una nuova regola per la finestra temporale da "ActiveConnectionsNotInAllowedRange"
