...
## Sinossi
Ottiene un gruppo di VM/Server di controllo applicazione.
...
## Descrizione
I controlli di applicazione adattiva vengono calcolati automaticamente da Azure Security Center, usa questo cmdlet per ottenere un gruppo di VM/Server di controllo applicazione.
...
### -AscLocation
Posizione in cui ASC archivia i dati dell'abbonamento. può essere recuperato da Get locations.
...
### -GroupName
Nome di un gruppo di VM/Server di controllo applicazione.
