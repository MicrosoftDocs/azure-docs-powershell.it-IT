...
## Descrizione
Il comando viene usato per visualizzare le risorse peer legacy che vengono convertite in risorse di gestione delle risorse di Azure (ARM).
...
Ottiene il peering legacy per Seattle
