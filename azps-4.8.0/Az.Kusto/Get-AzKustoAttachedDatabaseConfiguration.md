...
### Esempio 1: elencare tutte le AttachedDatabaseConfigurations in un cluster
```powershell
...
Il comando precedente elenca tutti i AttachedDatabaseConfigurations nel cluster "testnewkustoclusterf".

### Esempio 2: ottenere un AttachedDatabaseConfiguration specifico in un cluster
```powershell
...
Il comando precedente restituisce il AttachedDatabaseConfigurations denominato "myfollowerconfiguration" nel cluster "testnewkustoclusterf".
...
### -Nome
Nome della configurazione del database allegato.
