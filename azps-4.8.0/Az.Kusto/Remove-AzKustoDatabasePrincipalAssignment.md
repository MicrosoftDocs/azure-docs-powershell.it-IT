...
### Esempio 1: eliminare un database di Kusto esistente PrincipalAssignment per nome
```powershell
...
Il comando precedente elimina la PrincipalAssignment denominata "kustoprincipal1" nel database kusto "mykustodatabase".
