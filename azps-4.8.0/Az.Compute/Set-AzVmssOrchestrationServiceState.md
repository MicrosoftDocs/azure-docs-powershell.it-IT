...
Questo comando sospende il servizio di riparazione automatica nel VMSS "vmss1" nel gruppo di risorse "RG".
...
Questo comando riprende il servizio di riparazione automatica nel VMSS "vmss1" nel gruppo di risorse "RG".

## PARAMETRI

### -Azione
Azione da eseguire.  I valori possibili sono: Resume, Suspend.
...
### -InputObject
Oggetto local del set di scale della macchina virtuale.
