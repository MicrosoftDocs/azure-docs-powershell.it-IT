...
## Descrizione
Il cmdlet **New-AzDataShareTrigger** crea un trigger per l'abbonamento alla condivisione per l'intervallo di ricorrenza e il tempo di sincronizzazione specificati in Azure Data Share account.
...
Questo comando crea un nuovo trigger AdsTrigger per la AdsShareSubscription della sottoscrizione di condivisione con un intervallo di ricorrenza giornaliera di 9 am.
