...
## Descrizione
Il cmdlet **New-AzDataShareDataSetMapping** crea un mapping del set di dati tra i set di dati di origine e l'account di archiviazione del sink in sottoscrizione di condivisione.
...
Questo comando crea un mapping del set di dati AdsDataSetMapping all'account di archiviazione AdsStorage per la condivisione dell'abbonamento AdsShareSubscription in WikiAdsAccount account di condivisione dati.
...
### -Contenitore
Nome del contenitore dell'account di archiviazione di Azure
...
### -FileSystem
Nome del file System di Azure ADL Gen2
...
### -FolderPath
Percorso della cartella di archiviazione di Azure
...
### -Nome
Nome del mapping set di dati di Azure
...
ResourceId account di archiviazione di Azure
