...
## Descrizione
Il cmdlet **Remove-AzDataShareInvitation** rimuove un invito DataShare.
...
Questo comando rimuove un invito denominato ADSInvite da Share AdsShare. 
...
### -InputObject
Oggetto invito di condivisione dati di Azure
