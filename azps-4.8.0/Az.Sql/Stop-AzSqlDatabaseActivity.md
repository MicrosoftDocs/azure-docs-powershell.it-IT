...
## Descrizione
Il cmdlet **Stop-AzSqlDatabaseActivity** Annulla l'operazione di aggiornamento asincrono nel database.

## ESEMPI

### Esempio 1: annullare l'operazione di aggiornamento asincrono nel database
```
...
Questo comando Annulla l'operazione di aggiornamento asincrono nel database.
