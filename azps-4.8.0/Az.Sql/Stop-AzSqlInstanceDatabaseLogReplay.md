...
## Descrizione
Il cmdlet **Stop-AzSqlInstanceDatabaseLogReplay** Elimina il database e quindi Annulla il servizio di riproduzione del log.
...
Questo comando cancellerà il servizio di riproduzione del log nel database specifico.
