...
## Descrizione
Il cmdlet **Enable-AzSqlInstanceActiveDirectoryOnlyAuthentication** Abilita l'autenticazione di Azure Active Directory (Azure ad) solo per un'istanza gestita di AzureSQL nell'abbonamento corrente.
...
Questo comando consente a Azure Active Directory (Azure AD) solo il requisito di autenticazione per un'istanza gestita AzureSQL denominata ManagedInstance01 associata a un gruppo di risorse denominato ResourceGroup01.
