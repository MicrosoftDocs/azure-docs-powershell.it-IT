...
## Descrizione
Il cmdlet **Get-AzSqlDatabaseTransparentDataEncryption** ottiene lo stato della crittografia dei dati trasparente (Transparent Data Encryption) per un database SQL di Azure.
...
Per visualizzare lo stato di analisi della crittografia, eseguire il cmdlet Get-AzSqlDatabaseTransparentDataEncryptionActivity.
