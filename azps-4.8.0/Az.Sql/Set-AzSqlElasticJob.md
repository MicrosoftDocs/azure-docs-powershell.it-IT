...
### Esempio 1: aggiorna un processo per iniziare un'ora da ora e ripetere ogni 1 ora
```powershell
...
### -Enable
Il contrassegno per indicare che il cliente vuole che questo processo sia abilitato.
...
### -EndTime
Ora di fine pianificazione processo
...
### -IntervalCount
Conteggio intervalli di programmazione ricorrente
...
### -IntervalType
Il tipo di intervallo di programmazione ricorrente-può essere minuto, ora, giorno, settimana, mese
...
### -RunOnce
Il contrassegno per indicare il processo verrà eseguito una sola volta
...
### -StartTime
Orario di inizio pianificazione processo
