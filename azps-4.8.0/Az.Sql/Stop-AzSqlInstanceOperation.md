...
### StopByNameAndManagedInstanceAndResourceGroupParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet Stop-AzSqlInstanceOperation interrompe l'operazione con il nome dell'operazione specificata in un'istanza di SQL Managed.
...
Questo comando interrompe l'operazione con il nome "d0f5bef5-e2b1-4ef8-BB42-2e54073874f9" in un'istanza di SQL Managed.
...
Questo comando interrompe l'operazione con ID risorsa $managedInstanceOperation. ID.

### Esempio 3: uso dell'oggetto Operation
```powershell
...
Questo comando interrompe l'operazione con l'oggetto $managedInstanceOperation.
...
### -ResourceId
ID risorsa dell'oggetto Operation da interrompere
