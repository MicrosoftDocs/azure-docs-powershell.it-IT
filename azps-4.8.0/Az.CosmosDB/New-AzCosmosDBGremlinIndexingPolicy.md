...
## Sinossi
Crea un nuovo oggetto IndexingPolicy CosmosDB.
...
### -CompositePath
Matrice di matrice di oggetti di tipo Microsoft. Azure. Commands. CosmosDB. PSCompositePath
...
### -ExcludedPath
Matrice di stringhe che contengono excludedPath (specifica un percorso all'interno di un documento JSON da escludere nel servizio Azure Cosmos DB).  elementi.
...
### -IncludedPath
Matrice di stringhe che contengono includedPath (specifica un percorso all'interno di un documento JSON da includere negli elementi di Azure Cosmos DB Service.).
...
I valori possibili includono: "coerente", "Lazy", "None"
...
### -SpatialSpec
Matrice di oggetti di tipo Microsoft. Azure. Commands. CosmosDB. PSSpatialSpec
