...
### ListRegistriesParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet Get-AzContainerRegistry ottiene un registro dei contenitori specificato o tutti i registri contenitore in un gruppo di risorse o nell'abbonamento.

## ESEMPI

### Esempio 1: ottenere un registro di sistema contenitore specificato
```powershell
...
Questo comando ottiene il registro di sistema del contenitore specificato.

### Esempio 2: ottenere tutti i registri dei contenitori in un gruppo di risorse
```powershell
...
Questo comando consente di ottenere tutti i registri contenitore in un gruppo di risorse.

### Esempio 3: ottenere tutti i registri contenitore nell'abbonamento
```powershell
...
Questo comando consente di ottenere tutti i registri contenitore nell'abbonamento.
...
### -IncludeDetail
Visualizzare altri dettagli sul Registro di sistema del contenitore.
