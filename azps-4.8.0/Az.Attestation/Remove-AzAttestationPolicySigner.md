...
## Sinossi
Rimuove un firmatario dei criteri attendibile per un tenant nell'attestazione di Azure.
...
## Descrizione
Il cmdlet Remove-AzAttestationPolicySigner rimuove un firmatario dei criteri attendibile per un tenant nell'attestazione di Azure.
...
Rimuovere un firmatario attendibile per il provider di attestazioni denominato *pshtest*.
...
### -Firmatario
Specifica il token Web JSON RFC7519 che contiene un'attestazione denominata "Maa-policyCertificate" il cui valore è una chiave Web JSON di RFC7517 che contiene una chiave di firma attendibile da rimuovere.
