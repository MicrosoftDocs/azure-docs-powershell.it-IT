...
## Descrizione
Il cmdlet **Get-AzIntegrationAccountSchema** ottiene gli schemi dell'account di integrazione.
...
### Esempio 1: ottenere uno schema di account di integrazione
```
...
Questo comando ottiene lo schema dell'account di integrazione denominato IntegrationAccountSchema43.

### Esempio 2: ottenere gli schemi degli account di integrazione per un gruppo di risorse
```
...
Questo comando consente di ottenere gli schemi dell'account di integrazione per il gruppo di risorse denominato ResourceGroup11.
...
### -SchemaName
Specifica il nome di uno schema di account di integrazione.
