...
## Descrizione
Creare un nuovo elemento. Esistono due modi per creare un elemento: tramite un elemento JSON come file di input o tramite la creazione di parametri inline per l'elemento. Mentre il metodo JSON non richiede il tipo di elemento per il metodo di parametro inline fornito richiede all'utente di fornire il tipo del parametro con tipo di elemento.
...
Creare un nuovo elemento tramite un file JSON di un elemento.
...
Creare un nuovo elemento tramite i parametri inline.
...
Creare un nuovo elemento tramite un file di modello ARM.
...
### Microsoft. Azure. Management. Blueprint. Models. artefatto
