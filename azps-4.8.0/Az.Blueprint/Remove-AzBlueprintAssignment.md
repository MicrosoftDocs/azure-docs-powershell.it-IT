...
### BySubscriptionAndName (impostazione predefinita)
```
...
## Descrizione
Rimuovere un modello assegnato a un abbonamento.
...
Rimuovere l'assegnazione Blueprint specificata per nome dall'abbonamento specificato. Il cmdlet richiederà la conferma prima di eseguire il comando.
...
### -InputObject
Oggetto assegnazione Blueprint.
...
### -PassThru
Quando viene impostato, il cmdlet restituirà un oggetto che rappresenta l'assegnazione del modello rimosso. Per impostazione predefinita, questo cmdlet non genera alcun output.
