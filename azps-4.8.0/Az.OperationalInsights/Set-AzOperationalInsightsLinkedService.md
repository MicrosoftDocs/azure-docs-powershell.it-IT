...
collegamento del cluster per l'area di lavoro
...
Questa operazione deve essere usata per collegare risorse che richiedono l'accesso in lettura
...
ID risorsa della risorsa che verrà collegata all'area di lavoro.
Questa operazione deve essere usata per collegare le risorse che richiedono l'accesso in scrittura.
Il cluster deve avere lo stato di provisioning "succeeded" e le proprietà di un Vault valido.
