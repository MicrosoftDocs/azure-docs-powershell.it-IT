...
Le autorizzazioni contenitore non verranno recuperate quando si usa un contesto di archiviazione creato dal token SAS, perché le autorizzazioni del contenitore di query richiedono l'autorizzazione dell'account di archiviazione.
