...
Il secondo comando usa il cmdlet **Get-AzStorageShare** per ottenere la condivisione di file denominata ContosoShare06 e lo archivia nella variabile $Container.
...
### Esempio 3: caricare un file locale in un file di Azure e Perserve le proprietà SMB del file locale (file Attributtes, ora di creazione del file, ultima ora di scrittura) nel file Azure.
```
PS C:\>Get-AzStorageFileContent -source $localFilePath -ShareName sample -Path "dir1/file1" -PreserveSMBAttribute
```

Questo esempio carica un file locale in un file di Azure e perserves le proprietà SMB del file locale (file Attributtes, ora di creazione del file, ultima ora di scrittura) nel file Azure.
