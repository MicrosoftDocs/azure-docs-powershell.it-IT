...
## Descrizione
Il cmdlet **Remove-AzDataLakeStoreVirtualNetworkRule** rimuove la regola di rete virtuale specificata nello Store Data Lake di dati specificato.
...
Rimuove la regola di rete virtuale "myVNET" dall'account "DLS"
