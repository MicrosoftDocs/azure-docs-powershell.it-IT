...
## Descrizione
Il cmdlet **Get-AzDataBoxEdgeShare** ottiene le condivisioni disponibili per un dispositivo Edge della casella dati. Se viene fornito il nome, otterrà il nome della condivisione.
