...
## Sinossi
Ottenere i metadati di un'istanza di servizio.
...
## Descrizione
Ottiene gli account di servizio di healthcareApis Fhir esistenti creati nell'abbonamento specificato o in un gruppo di risorse.
...
Ottiene i metadati per tutti i servizi di HealthcareApis nel gruppo di risorse fornito.
...
Ottiene i metadati per tutti i servizi di HealthcareApis nella sottoscrizione specificata
