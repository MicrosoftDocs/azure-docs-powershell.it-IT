...
## Sinossi
Aggiorna il tag per il cluster specifico
...
## Descrizione
Il cmdlet Set-AzEventHubCluster aggiorna i tag del cluster specifico
...
Aggiorna i tag del cluster specifico. 
...
### -Tag
Hashtable che rappresenta il tag delle risorse per i cluster
