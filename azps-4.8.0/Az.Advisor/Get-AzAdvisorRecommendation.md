...
## Sinossi
Ottiene un elenco di suggerimenti di Azure Advisor.
...
## Descrizione
Ottiene l'elenco di suggerimenti di Azure Advisor. Può essere filtrato per categoria, ID risorsa, nome e così via.
...
```
Ottiene l'elenco di tutti i suggerimenti.
...
Type                 : Microsoft.Advisor/recommendations
```
Ottiene l'elenco di tutti i suggerimenti filtrati in base alle prestazioni delle categorie.

## PARAMETRI

### -Categoria
Categoria della raccomandazione
...
### -ResourceGroupName
ResourceGroup il nome della raccomandazione
...
### -ResourceId
ResourceId della raccomandazione
