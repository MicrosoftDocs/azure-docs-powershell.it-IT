...
## Sinossi
Abilita le raccomandazioni di Azure Advisor.
...
## Descrizione
Questo cmdlet Abilita una raccomandazione precedentemente eliminata. È possibile rimuovere anche tutte le eliminazioni associate a una raccomandazione.
...
Rimuove tutte le eliminazioni per il suggerimento indicato con il nome "recommendation_id".
...
Rimuove tutte le eliminazioni per le singole raccomandazioni passate dalla pipeline.
