...
## Descrizione
Il cmdlet **set-AzDataLakeAnalyticsAccount** modifica un account di analisi di Azure Data Lake.
...
Questo comando modifica l'origine dati predefinita e la proprietà Tags dell'account.
...
### -MaxAnalyticsUnits
Le unità di analisi massime supportate facoltative per aggiornare l'account.
...
### -Tag
Una stringa, un dizionario di stringhe di tag associato a questo account che deve sostituire il set corrente di tag
