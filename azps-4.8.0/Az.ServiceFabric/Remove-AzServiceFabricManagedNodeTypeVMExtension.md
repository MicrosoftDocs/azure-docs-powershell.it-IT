...
## Descrizione
Rimuovere l'estensione VM dal tipo di nodo per nome. USA [Get-AzServiceFabricManagedNodeType](./Get-AzServiceFabricManagedNodeType.md) e osserva la proprietà VmExtensions per visualizzare l'estensione corrente nel tipo di nodo.
...
Rimuovi estensione dal tipo di nodo per nome.
...
Rimuovi estensione da tipo di nodo per nome, con piping.
