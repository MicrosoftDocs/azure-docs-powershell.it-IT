...
## DESCRIZIONE
Usare **Update-AzServiceFabricDurability per** aggiornare la durabilità o SKU del cluster.
...
### -DurabilityLevel
Specificare il livello di durabilità.
...
### -NodeType
Specificare il nome del tipo di nodo Service Fabric.
