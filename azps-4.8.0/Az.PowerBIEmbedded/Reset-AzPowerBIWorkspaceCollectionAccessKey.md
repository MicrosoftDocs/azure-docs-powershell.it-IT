...
## Descrizione
Il cmdlet **Reset-AzPowerBIWorkspaceCollectionAccessKey** Reimposta il codice di accesso specificato nella raccolta dell'area di lavoro di Power bi.

## ESEMPI

### Esempio 1: reimpostare il tasto di scelta principale
```
PS C:\>Reset-AzPowerBIWorkspaceCollectionAccessKey -ResourceGroupName "ResourceGroup17" -WorkspaceCollectionName "WCN11" -Key1
```

Questo comando Reimposta il codice di accesso principale per la raccolta dell'area di lavoro denominata WCN11 nel gruppo di risorse specificato.
...
### -Key1
Indica che questo cmdlet Reimposta il tasto di scelta principale.
...
### -Key2
Indica che questo cmdlet Reimposta il tasto di scelta secondario.
