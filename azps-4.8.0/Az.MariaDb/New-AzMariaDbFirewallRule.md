...
### Esempio 1: creare una regola del firewall in un MariaDB
```powershell
...
Questo comando crea una regola del firewall in un MariaDB.

### Esempio 2: creare una nuova regola del firewall di MariaDB con-ClientIPAddress.
```powershell
...
Questo cmdlet crea una regola del firewall MariaDB con-ClientIPAddress.

### Esempio 3: creare una nuova regola del firewall di MariaDB per consentire tutti gli IPs
```powershell
...
Questo cmdlet crea una nuova regola del firewall di MariaDB per consentire tutti gli IPs.
