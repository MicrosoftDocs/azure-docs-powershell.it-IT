...
### FlushParameterSet (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Update-AzHpcCache** aggiorna una cache HPC di Azure.
...
### -Force
Indica che il cmdlet non chiede conferma. Per impostazione predefinita, questo cmdlet richiede di confermare che si vuole aggiornare la cache.
...
### -ResourceGroupName
Nome del gruppo di risorse in cui si vuole aggiornare la cache.
