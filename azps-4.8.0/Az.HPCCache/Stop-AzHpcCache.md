...
## Descrizione
Il cmdlet **Stop-AzHpcCache** interrompe una cache HPC di Azure.
...
### -Force
Indica che il cmdlet non chiede conferma. Per impostazione predefinita, questo cmdlet richiede di confermare che si vuole arrestare la cache.
...
### -InputObject
L'oggetto cache da interrompere.
...
### -ResourceGroupName
Nome del gruppo di risorse in cui si vuole interrompere la cache.
