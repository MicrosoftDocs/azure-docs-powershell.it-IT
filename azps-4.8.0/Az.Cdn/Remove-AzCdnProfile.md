...
## Descrizione
Il cmdlet **Remove-AzCdnProfile** consente di rimuovere un profilo CDN (Azure Content delivering Network).
...
### -ProfileName
Specifica il nome del profilo rimosso da questo cmdlet.
