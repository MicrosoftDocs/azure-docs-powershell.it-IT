...
## Descrizione
Il cmdlet **Remove-AzApiManagementLogger** rimuove un **logger** di gestione delle API di Azure.

## ESEMPI

### Esempio 1: rimuovere un logger
```
...
### -LoggerId
Specifica l'ID del logger da rimuovere.
