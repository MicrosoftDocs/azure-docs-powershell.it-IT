...
## Descrizione
Il cmdlet **Get-AzApiManagementSubscription** ottiene un abbonamento specificato o tutti gli abbonamenti, se non è specificato alcun abbonamento.
I tasti non verranno inclusi nei dettagli dei risultati. Per ottenere le chiavi, USA **Get-AzApiManagementSubscriptionKey**.
...
### Esempio 6: ottenere tutti gli abbonamenti per un prodotto e un ambito utente
```powershell
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-East-US" -ServiceName "contoso"
