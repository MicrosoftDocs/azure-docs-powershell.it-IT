...
Questo comando viene usato con i cmdlet **set-AzApiManagement** e **New-AzApiManagement** .

## ESEMPI

### Esempio 1: creare una rete virtuale e aggiornare un servizio APIM esistente in VNET
```powershell
...
Questo esempio crea un nuovo servizio APIM in una rete virtuale in `External` modalità
