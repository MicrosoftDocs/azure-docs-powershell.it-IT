...
## Descrizione
Il cmdlet **Get-AzApiManagementGatewayKey** ottiene le chiavi del gateway esistente
...
Questo comando consente di ottenere le chiavi per un gateway "0123456789".
