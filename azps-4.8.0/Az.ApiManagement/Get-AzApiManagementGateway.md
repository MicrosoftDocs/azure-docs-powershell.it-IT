...
### GetAllGateways (impostazione predefinita)
```
...
## Descrizione
Il cmdlet **Get-AzApiManagementGateway** ottiene tutti o un gateway di gestione API specifico.

## ESEMPI

### Esempio 1: ottenere tutti i gateway
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext
```

Questo comando consente di ottenere tutti i gateway.

### Esempio 2: ottenere un gateway tramite ID
```
PS C:\>$apimContext = New-AzApiManagementContext -ResourceGroupName "Api-Default-WestUS" -ServiceName "contoso"
PS C:\>Get-AzApiManagementGateway -Context $apimContext -GatewayId "0123456789"
```

Questo comando ottiene il gateway 0123456789.
...
### -GatewayId
Identificatore di un gateway.
Se specificato cercherà di trovare il gateway dall'identificatore.
