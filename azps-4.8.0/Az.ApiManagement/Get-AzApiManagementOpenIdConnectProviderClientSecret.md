...
### Esempio 1: ottenere un segreto del client del provider utilizzando un ID
```
...
Questo comando ottiene un segreto client del provider con ID OICProvider01.
...
Identificatore di un provider di connessione OpenID.
Questo parametro è obbligatorio.
