...
## Descrizione
Il cmdlet **Get-AzApiManagementTenantAccess** ottiene la configurazione di accesso del tenant per un tenant.
I tasti non verranno inclusi nei dettagli dei risultati. Per ottenere il segreto del client, USA **Get-AzApiManagementTenantAccessSecret**.
