...
## Descrizione
Richiamare un metodo del modulo Edge. https://docs.microsoft.com/azure/iot-hub/iot-hub-devguide-direct-methodsPer altre informazioni, vedere.
...
### -ModuleId
ID modulo del dispositivo di destinazione.
...
### -Nome
Il nome del metodo da richiamare nel modulo del dispositivo.
...
### -Payload
Payload per il metodo da richiamare in questo modulo di dispositivo.
