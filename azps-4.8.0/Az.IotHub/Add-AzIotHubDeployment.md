...
## Descrizione
Le distribuzioni Edge possono essere create con le metriche definite dall'utente per la valutazione su richiesta.
...
Creare una distribuzione di Edge con metadati predefiniti.
...
Creare una distribuzione di Edge con una priorità di 3 che si applica alla condizione in cui un dispositivo è taggato nell'edificio 9 e l'ambiente è "test".
...
Creare una distribuzione di Edge con le metriche degli utenti.
...
Creare una distribuzione di Edge con etichette.
...
Creare una distribuzione di Edge con contenuto.
...
### -ModulesContent
Contenuto di distribuzione dei moduli per i dispositivi Edge molto.
