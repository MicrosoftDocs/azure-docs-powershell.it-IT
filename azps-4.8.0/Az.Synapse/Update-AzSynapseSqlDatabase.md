...
## Sinossi
Aggiorna un database SQL di analisi sinapsi.
...
## Descrizione
Il cmdlet **Update-AzSynapseSqlDatabase** aggiorna un database SQL di analisi delle sinapsi di Azure.
...
Questo comando aggiorna un database SQL di analisi delle sinapsi di Azure.
