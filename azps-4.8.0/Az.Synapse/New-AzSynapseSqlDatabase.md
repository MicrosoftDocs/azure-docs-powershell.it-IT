...
## Sinossi
Crea un database SQL di analisi sinapsi.
...
## Descrizione
Il cmdlet **Get-AzSynapseSqlDatabase** ottiene le informazioni su un database SQL di analisi delle sinapsi di Azure.
...
Questo comando crea un database SQL di analisi delle sinapsi di Azure.
...
### -Regole di confronto
La fascicolatura definisce le regole di ordinamento e confronto dei dati e non può essere modificata dopo la creazione del pool SQL.
Le regole di confronto predefinite sono SQL_Latin1_General_CP1_CI_AS.
