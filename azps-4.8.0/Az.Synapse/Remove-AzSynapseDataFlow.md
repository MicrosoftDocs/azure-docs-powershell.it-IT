...
## Descrizione
Il cmdlet **Remove-AzSynapseDataFlow** rimuove un flusso di dati dall'area di lavoro.
...
Questo comando rimuove il flusso di dati denominato ContosoDataFlow dall'area di lavoro denominata ContosoWorkspace.
