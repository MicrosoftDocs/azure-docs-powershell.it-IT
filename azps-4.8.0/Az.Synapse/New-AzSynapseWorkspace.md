...
## Descrizione
Il cmdlet **New-AzSynapseWorkspace** crea un'area di lavoro di Azure sinapsi Analytics.
...
Questo comando crea un'area di lavoro di analisi sinapsi denominata ContosoWorkspace che usa l'archivio dati ContosoAdlGenStorage, nel gruppo risorse denominato ContosoResourceGroup.
...
Nome dell'account di archiviazione predefinito di ADL Gen2.
...
Il file System ADL Gen2 predefinito.
...
Nome di una rete virtuale gestita da sinapsi dedicata per l'area di lavoro di Azure sinapsi.
