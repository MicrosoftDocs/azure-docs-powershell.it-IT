...
## Descrizione
Il cmdlet **Update-AzSynapseFirewallRule** modifica una regola del firewall di analisi di Azure sinapsi.
...
Questo comando Aggiorna la regola del firewall denominata ContosoFirewallRule in area di lavoro ContosoWorkspace con nome ContosoFirewallRule.
