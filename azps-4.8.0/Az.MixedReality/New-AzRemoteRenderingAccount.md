...
## Sinossi
Creare un account di rendering remoto
...
Creare un nuovo account di rendering remoto "esempio" nell'abbonamento corrente, gruppo risorse "RG1" e Central US.
...
### -Posizione
Posizione dell'account di rendering remoto.
