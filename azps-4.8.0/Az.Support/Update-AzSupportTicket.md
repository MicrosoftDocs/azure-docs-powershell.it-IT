...
## Sinossi
Ticket di supporto degli aggiornamenti.

## SINTASSI

### UpdateByNameWithContactDetailParameterSet (impostazione predefinita)
```
...
## Descrizione
Questo cmdlet consente di aggiornare il livello di gravità, lo stato o i dettagli di contatto del cliente di un ticket di supporto. Tieni presente che l'aggiornamento del livello di gravità o dello stato di un ticket di supporto non è consentito quando il ticket viene assegnato a un tecnico del supporto. Se si vuole aggiornare il livello di gravità o lo stato dopo l'assegnazione del biglietto, contattare il tecnico del supporto inviando una comunicazione sul biglietto.

## ESEMPI

### Esempio 1: aggiornare la gravità del ticket di supporto.
```powershell
...
### Esempio 2: aggiornare lo stato del ticket di supporto.
```powershell
...
### Esempio 3: aggiornare i dettagli dei contatti del ticket di supporto per specificare l'oggetto contatto.
```powershell
...
### Esempio 4: aggiornare la gravità del ticket di supporto tramite l'oggetto ticket di supporto piping.
```powershell
...
### Esempio 5: aggiornare i dettagli dei contatti del ticket di supporto specificando i singoli parametri di contatto.
```powershell
...
### Esempio 6: aggiornare lo stato del ticket di supporto tramite l'oggetto ticket di supporto piping.
```powershell
...
Aggiornare i dettagli di contatto in SupportTicket.
...
Lingua di supporto preferita dal cliente.
Questo deve essere un codice contabile della lingua valido per una delle lingue supportate elencate qui https://azure.microsoft.com/support/faq/ .
...
### -InputObject
Oggetto risorsa SupportTicket che questo cmdlet aggiorna.
...
### -Nome
Nome della risorsa SupportTicket che questo cmdlet aggiorna.
...
### -Gravità
Aggiornare la gravità di SupportTicket.
...
### -Stato
Aggiornare lo stato di SupportTicket.
