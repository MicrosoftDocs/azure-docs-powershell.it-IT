...
### Esempio 1: Add-AzsPlatformImage
```powershell
...
Aggiungere un'immagine della piattaforma da archiviazione BLOB. USA SasUri per specificare la posizione di PlatformImage oppure usa un URL accessibile pubblicamente.
...
### -BillingPartNumber
Il numero di parte viene usato per fatturare i costi del software.
...
### -DataDisk
Dischi di dati usati dall'immagine della piattaforma.
Per creare una tabella hash, vedere la sezione Note per le proprietà dei dischi DataDisk.
...
### -NewImage
Parametri usati per creare una nuova immagine della piattaforma.
Per costruire, vedere la sezione Note per le proprietà di NEWIMAGE e creare una tabella hash.
...
### -ProvisioningState
Stato di provisioning dell'immagine della piattaforma.
...
Datadisks <IDataDisk [] >: dischi di dati usati dall'immagine della piattaforma.
  - `[Lun <Int32?>]`: Numero di unità logica.
  - `[Uri <String>]`: Posizione del modello di disco.
...
NEWIMAGE <IPlatformImageParameters> : parametri usati per creare una nuova immagine della piattaforma.
  - `[DataDisk <IDataDisk[]>]`: Dischi di dati usati dall'immagine della piattaforma.
    - `[Lun <Int32?>]`: Numero di unità logica.
    - `[Uri <String>]`: Posizione del modello di disco.
  - `[DetailBillingPartNumber <String>]`: Il numero di parte viene usato per fatturare i costi del software.
  - `[OSDiskOstype <OSType?>]`: Tipo di sistema operativo.
  - `[OSDiskUri <String>]`: Posizione del disco.
  - `[ProvisioningState <ProvisioningState?>]`: Stato di provisioning dell'immagine della piattaforma.
