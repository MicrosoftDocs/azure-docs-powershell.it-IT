...
Ottiene l'elemento della raccolta in base al nome.

### Esempio 2: elementi della raccolta elenchi
```powershell
...
Elenca tutti gli elementi disponibili nella raccolta stack di Azure.
