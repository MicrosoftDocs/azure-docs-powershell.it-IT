...
## Sinossi
Ottenere un aggiornamento specifico in una posizione di aggiornamento.
...
### Esempio 1: ottenere tutti gli aggiornamenti
```powershell
PS C:\> Get-AzsUpdate
...
Senza parametri, Get-AzsUpdate elenca tutti gli aggiornamenti che il timbro può individuare

### Esempio 2: ottenere l'aggiornamento in base al nome
```powershell
...
Recupererà tutti gli aggiornamenti che corrispondono al nome specificato

### Esempio 3: ottenere tutti gli aggiornamenti in base alla posizione
```powershell
...
Recupererà tutti gli aggiornamenti in una posizione specificata.
Attualmente è supportata solo una posizione, quindi questo è l'equivalente solo Get-AzsUpdate
