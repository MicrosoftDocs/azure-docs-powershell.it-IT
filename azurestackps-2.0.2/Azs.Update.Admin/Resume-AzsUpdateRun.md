...
## Sinossi
Riprendere un aggiornamento non riuscito.

## SINTASSI

### Rieseguire (impostazione predefinita)
```
...
### Esempio 1: Resume-AzsUpdateRun per nome e UpdateName
```powershell
PS C:\> Resume-AzsUpdateRun -UpdateName northwest/Microsoft1.1907.0.10 -Name 45aaeb26-805b-495b-9c8c-d5da5542dbf4

```

Unifiedgroup consente di eseguire nuovamente una specifica operazione di aggiornamento non riuscita.
Tieni presente che è necessario che la versione dell'aggiornamento sia strettamente superiore alla versione corrente.
