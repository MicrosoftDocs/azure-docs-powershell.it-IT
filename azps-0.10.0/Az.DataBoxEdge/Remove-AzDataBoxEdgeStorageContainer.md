...
## Descrizione
Il cmdlet **Remove-AzDataBoxEdgeStorageContainer** rimuove un contenitore di archiviazione associato per l'account di archiviazione Edge in un dispositivo Edge della casella dati. Puoi specificare il nome del contenitore di archiviazione da rimuovere come parametro.
