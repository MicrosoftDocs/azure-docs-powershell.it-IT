...
## Descrizione
Il cmdlet **New-AzDataBoxEdgeStorageAccountCredential** crea una nuova credenziale dell'account di archiviazione Edge per un dispositivo Edge della casella dati.
...
### -StorageAccountType
Possibile tipo di accesso allo spazio di archiviazione GeneralPurposeStorage, BlockStorage
