...
## Descrizione
Il cmdlet **Invoke-AzDataBoxEdgeStorageContainer** richiama le azioni per aggiornare i dati in un contenitore di archiviazione in un dispositivo Edge della casella dati. 
...
### -RefreshData
Aggiornare i metadati del contenitore con i dati del cloud
