...
## Descrizione
Verifica un certificato caricando un certificato di verifica contenente il codice di verifica ottenuto dal cmdlet Get-AzIotHubCertificateVerificationCode. Questo è l'ultimo passaggio del processo di prova del possesso.
...
Verifica la proprietà della chiave privata del certificato. 
