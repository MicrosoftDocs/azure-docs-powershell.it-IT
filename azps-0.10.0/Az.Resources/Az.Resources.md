...
Ottiene una distribuzione nell'ambito dell'abbonamento.

### [Get-AzDeploymentOperation](Get-AzDeploymentOperation.md)
Ottiene le operazioni di distribuzione per una distribuzione in ambito di sottoscrizione.
...
Crea una nuova distribuzione nell'ambito dell'abbonamento.
...
Rimuove una distribuzione nell'ambito dell'abbonamento.
...
Ottiene il modello per una distribuzione nell'ambito dell'abbonamento.
...
Annulla una distribuzione in uso nell'ambito dell'abbonamento.

### [Stop-AzResourceGroupDeployment](Stop-AzResourceGroupDeployment.md)
Annulla la distribuzione di un gruppo di risorse.

### [Test-AzDeployment](Test-AzDeployment.md)
Convalida un modello di distribuzione e i parametri nell'ambito dell'abbonamento.
