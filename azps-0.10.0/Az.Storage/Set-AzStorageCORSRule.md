...
## Descrizione
Il cmdlet **set-AzStorageCORSRule** imposta le regole CORS (Cross-Origin Resource Sharing) per un tipo di servizio di archiviazione di Azure.
...
Per visualizzare le regole correnti, usare il cmdlet Get-AzStorageCORSRule.
...
Puoi recuperare le regole esistenti usando il cmdlet Get-AzStorageCORSRule.
